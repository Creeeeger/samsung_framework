...
public class PagerTitleStrip extends ViewGroup {
    ...
    final void updateAdapter(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2) {
    ...
    final void updateText(int i, PagerAdapter pagerAdapter) {
        if (pagerAdapter != null) {
    ...
    void updateTextPositions(float f, int i, boolean z) {
        int i2;
        int i3;
        int i4;
        int i5;
