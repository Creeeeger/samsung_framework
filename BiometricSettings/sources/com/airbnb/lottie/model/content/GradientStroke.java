...
public final class GradientStroke implements ContentModel {
    ...
    public final ShapeStroke.LineCapType getCapType() {
        return this.capType;
    }
    ...
    public final AnimatablePointValue getEndPoint() {
        return this.endPoint;
    }

    public final AnimatableGradientColorValue getGradientColor() {
    ...
    public final ShapeStroke.LineJoinType getJoinType() {
    ...
    public final AnimatablePointValue getStartPoint() {
