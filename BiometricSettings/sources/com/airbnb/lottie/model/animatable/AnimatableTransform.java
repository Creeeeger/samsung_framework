...
public final class AnimatableTransform implements ContentModel {
    ...
    public final AnimatablePathValue getAnchorPoint() {
        return this.anchorPoint;
    }

    public final AnimatableFloatValue getEndOpacity() {
    ...
    public final AnimatableScaleValue getScale() {
        return this.scale;
    }

    public final AnimatableFloatValue getSkew() {
        return this.skew;
    }

    public final AnimatableFloatValue getSkewAngle() {
        return this.skewAngle;
    }

    public final AnimatableFloatValue getStartOpacity() {
