...
public final class Utils {
    ...
    private static final ThreadLocal<PathMeasure> threadLocalPathMeasure = new AnonymousClass1();
    private static final ThreadLocal<Path> threadLocalTempPath = new AnonymousClass2();
    private static final ThreadLocal<Path> threadLocalTempPath2 = new AnonymousClass3();
    private static final ThreadLocal<float[]> threadLocalPoints = new AnonymousClass4();
    ...
    final class AnonymousClass1 extends ThreadLocal<PathMeasure> {
    ...
    final class AnonymousClass2 extends ThreadLocal<Path> {
        @Override // java.lang.ThreadLocal
    ...
    final class AnonymousClass3 extends ThreadLocal<Path> {
        @Override // java.lang.ThreadLocal
        protected final Path initialValue() {
            return new Path();
        }
    ...
    final class AnonymousClass4 extends ThreadLocal<float[]> {
        @Override // java.lang.ThreadLocal
