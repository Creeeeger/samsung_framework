...
public final class TransformKeyframeAnimation {
    ...
    public final boolean applyValueCallback(LottieValueCallback lottieValueCallback, Object obj) {
        ...
        if (obj == LottieProperty.TRANSFORM_START_OPACITY && (baseKeyframeAnimation2 = this.startOpacity) != null) {
            if (baseKeyframeAnimation2 == null) {
        ...
        if (obj == LottieProperty.TRANSFORM_END_OPACITY && (baseKeyframeAnimation = this.endOpacity) != null) {
            if (baseKeyframeAnimation == null) {
        ...
        if (obj == LottieProperty.TRANSFORM_SKEW && (floatKeyframeAnimation2 = this.skew) != null) {
            if (floatKeyframeAnimation2 == null) {
        ...
        if (obj != LottieProperty.TRANSFORM_SKEW_ANGLE || (floatKeyframeAnimation = this.skewAngle) == null) {
            return false;
        }
        if (floatKeyframeAnimation == null) {
    ...
    public final BaseKeyframeAnimation<?, Float> getEndOpacity() {
    ...
    public final Matrix getMatrix() {
        ...
        if (this.skew != null) {
            float cos = this.skewAngle == null ? 0.0f : (float) Math.cos(Math.toRadians((-r2.getFloatValue()) + 90.0f));
    ...
    public final BaseKeyframeAnimation<?, Integer> getOpacity() {
        return this.opacity;
    }

    public final BaseKeyframeAnimation<?, Float> getStartOpacity() {
