...
final class KeyframesParser {
    static JsonReader.Options NAMES = JsonReader.Options.of("k");

    static List parse(float f, LottieComposition lottieComposition, ValueParser valueParser, JsonReader jsonReader) throws IOException {
