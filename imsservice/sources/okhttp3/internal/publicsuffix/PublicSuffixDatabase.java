...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> list) {
        ...
        str3 = null;
        if (str3 != null) {
            split$default = StringsKt__StringsKt.split$default(Intrinsics.stringPlus("!", str3), new char[]{'.'}, false, 0, 6, null);
            return split$default;
        }
        if (str == null && str2 == null) {
            return PREVAILING_RULE;
        }
        List<String> split$default2 = str == null ? null : StringsKt__StringsKt.split$default(str, new char[]{'.'}, false, 0, 6, null);
        if (split$default2 == null) {
            split$default2 = CollectionsKt__CollectionsKt.emptyList();
        }
        List<String> split$default3 = str2 != null ? StringsKt__StringsKt.split$default(str2, new char[]{'.'}, false, 0, 6, null) : null;
