...
public final class HttpUrl {
    ...
    public HttpUrl(@NotNull String scheme, @NotNull String username, @NotNull String password, @NotNull String host, int i, @NotNull List<String> pathSegments, @Nullable List<String> list, @Nullable String str, @NotNull String url) {
        ...
        this.fragment = str;
        this.url = url;
        this.isHttps = Intrinsics.areEqual(scheme, OMAGlobalVariables.HTTPS);
    }
    ...
    public static final class Builder {
        ...
        public final Builder scheme(@NotNull String scheme) {
            ...
            boolean equals2;
            Intrinsics.checkNotNullParameter(scheme, "scheme");
            equals = StringsKt__StringsJVMKt.equals(scheme, OMAGlobalVariables.HTTP, true);
            if (equals) {
                setScheme$okhttp(OMAGlobalVariables.HTTP);
            } else {
                equals2 = StringsKt__StringsJVMKt.equals(scheme, OMAGlobalVariables.HTTPS, true);
                if (!equals2) {
        ...
        public final Builder username(@NotNull String username) {
            Intrinsics.checkNotNullParameter(username, "username");
            setEncodedUsername$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.Companion, username, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, MNO.SPARK, null));
            return this;
        }
        ...
        public final Builder password(@NotNull String password) {
            Intrinsics.checkNotNullParameter(password, "password");
            setEncodedPassword$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.Companion, password, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, MNO.SPARK, null));
            return this;
        }
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String str) {
            ...
            List<String> encodedQueryNamesAndValues$okhttp2 = getEncodedQueryNamesAndValues$okhttp();
            Intrinsics.checkNotNull(encodedQueryNamesAndValues$okhttp2);
            encodedQueryNamesAndValues$okhttp2.add(str == null ? null : Companion.canonicalize$okhttp$default(companion, str, 0, 0, " \"'<>#&=", true, false, true, false, null, 211, null));
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                getEncodedPathSegments$okhttp().set(i2, Companion.canonicalize$okhttp$default(HttpUrl.Companion, getEncodedPathSegments$okhttp().get(i2), 0, 0, "[]", true, true, false, false, null, 227, null));
            }
            List<String> encodedQueryNamesAndValues$okhttp = getEncodedQueryNamesAndValues$okhttp();
            if (encodedQueryNamesAndValues$okhttp != null) {
                ...
                while (i < size2) {
                    ...
                    encodedQueryNamesAndValues$okhttp.set(i, str == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, 0, 0, "\\^`{|}", true, true, true, false, null, MNO.TIGO_COLOMBIA, null));
                    i = i3;
                }
            }
            String encodedFragment$okhttp = getEncodedFragment$okhttp();
            setEncodedFragment$okhttp(encodedFragment$okhttp != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, encodedFragment$okhttp, 0, 0, " \"#<>\\^`{|}", true, true, false, true, null, MNO.NTEL_NIGERIA, null) : null);
            return this;
        }
        ...
        */
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl httpUrl, @NotNull String str) {
            ...
            if (schemeDelimiterOffset != -1) {
                if (StringsKt__StringsJVMKt.startsWith(input, "https:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = OMAGlobalVariables.HTTPS;
                    indexOfFirstNonAsciiWhitespace$default += 6;
                } else if (StringsKt__StringsJVMKt.startsWith(input, "http:", indexOfFirstNonAsciiWhitespace$default, true)) {
            ...
            if (delimiterOffset3 < i7 && input.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, delimiterOffset3 + 1, i7, "", true, false, false, true, null, MNO.ORANGE_SENEGAL, null);
            }
            return this;
        }
    ...
    public static final class Companion {
        ...
        public final int defaultPort(@NotNull String scheme) {
            Intrinsics.checkNotNullParameter(scheme, "scheme");
            if (Intrinsics.areEqual(scheme, OMAGlobalVariables.HTTP)) {
                return 80;
            }
            return Intrinsics.areEqual(scheme, OMAGlobalVariables.HTTPS) ? 443 : -1;
        }
