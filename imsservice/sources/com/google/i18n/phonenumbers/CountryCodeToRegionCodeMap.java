...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        HashMap hashMap = new HashMap(MNO.UNIFIQUE_BRAZIL);
        ...
        arrayList31.add(UserConsentProviderContract.UserConsentList.ID);
        ...
        arrayList81.add(ImConstants.MessageCreatorTag.SD);
        ...
        arrayList83.add("ET");
        hashMap.put(Integer.valueOf(MNO.SPARK), arrayList83);
        ...
        arrayList86.add("KE");
        hashMap.put(Integer.valueOf(MNO.TIGO_HONDURAS), arrayList86);
        ...
        arrayList89.add("BI");
        hashMap.put(Integer.valueOf(MNO.TIGO_NICARAGUA), arrayList89);
        ArrayList arrayList90 = new ArrayList(1);
        arrayList90.add("MZ");
        hashMap.put(Integer.valueOf(MNO.TIGO_ELSALVADOR), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf(MNO.ANTEL_URUGUAY), arrayList91);
        ArrayList arrayList92 = new ArrayList(1);
        arrayList92.add("MG");
        hashMap.put(Integer.valueOf(MNO.FIZ), arrayList92);
        ArrayList arrayList93 = new ArrayList(2);
        arrayList93.add("RE");
        arrayList93.add("YT");
        hashMap.put(Integer.valueOf(MNO.CBN), arrayList93);
        ArrayList arrayList94 = new ArrayList(1);
        arrayList94.add("ZW");
        hashMap.put(Integer.valueOf(MNO.XPLORE), arrayList94);
        ArrayList arrayList95 = new ArrayList(1);
        arrayList95.add("NA");
        hashMap.put(Integer.valueOf(MNO.H3G_IRELAND), arrayList95);
        ArrayList arrayList96 = new ArrayList(1);
        arrayList96.add("MW");
        hashMap.put(Integer.valueOf(MNO.VODAFONE_CY), arrayList96);
        ArrayList arrayList97 = new ArrayList(1);
        arrayList97.add("LS");
        hashMap.put(Integer.valueOf(MNO.VODAFONE_QATAR), arrayList97);
        ArrayList arrayList98 = new ArrayList(1);
        arrayList98.add("BW");
        hashMap.put(Integer.valueOf(MNO.TRUPHONE_HK), arrayList98);
        ArrayList arrayList99 = new ArrayList(1);
        arrayList99.add("SZ");
        hashMap.put(Integer.valueOf(MNO.ORANGE_JORDAN), arrayList99);
        ArrayList arrayList100 = new ArrayList(1);
        arrayList100.add("KM");
        hashMap.put(Integer.valueOf(MNO.TANGO_US), arrayList100);
        ...
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf(Id.REQUEST_IM_SENDMSG), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf(Id.REQUEST_IM_SEND_COMPOSING_STATUS), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("CR");
        hashMap.put(Integer.valueOf(Id.REQUEST_IM_SEND_NOTI_STATUS), arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PA");
        hashMap.put(Integer.valueOf(Id.REQUEST_IM_START_MEDIA), arrayList143);
        ArrayList arrayList144 = new ArrayList(1);
        arrayList144.add("PM");
        hashMap.put(Integer.valueOf(Id.REQUEST_REJECT_IM_SESSION), arrayList144);
        ArrayList arrayList145 = new ArrayList(1);
        arrayList145.add("HT");
        hashMap.put(Integer.valueOf(Id.REQUEST_SEND_MSG_REVOKE_REQUEST), arrayList145);
        ...
        arrayList149.add(DiagnosisConstants.RCSM_MTYP_EC);
        ...
        arrayList155.add("CW");
        arrayList155.add("BQ");
        hashMap.put(Integer.valueOf(OMAGlobalVariables.HTTP_NETWORK_CONNECT_TIMEOUT), arrayList155);
        ...
        hashMap.put(Integer.valueOf(Id.REQUEST_XDM_DELETE_CONTACT), arrayList178);
