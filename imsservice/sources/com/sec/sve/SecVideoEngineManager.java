...
public class SecVideoEngineManager {
    private final String LOG_TAG = SecVideoEngineManager.class.getSimpleName();
    private final ServiceConnection mConnection = new ServiceConnection() { // from class: com.sec.sve.SecVideoEngineManager.1
    ...
    private ISecVideoEngineService mService;
    ...
    public void notifyImsServiceReady(IBinder iBinder) {
        if (this.mService == null) {
            Log.e(this.LOG_TAG, "SVE service is not ready!");
            return;
        }
        Log.d(this.LOG_TAG, "notifyImsServiceReady");
        try {
            this.mService.notifyImsServiceReady(iBinder);
    ...
    public void bindToNetwork(Network network) {
        ...
        Log.d(this.LOG_TAG, "bindToNetwork " + network);
        try {
    ...
    public int sveSetMediaConfig(int i, boolean z, int i2, boolean z2, int i3, int i4, int i5, int i6) {
        ...
        Log.d(this.LOG_TAG, "sveSetMediaConfig keepAliveInterval " + i6);
        try {
