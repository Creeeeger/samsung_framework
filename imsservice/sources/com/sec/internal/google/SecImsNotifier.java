...
public class SecImsNotifier {
    ...
    public void updateMmTelCapabilities(int i, MmTelFeature.MmTelCapabilities mmTelCapabilities) {
        this.mEventLog.logAndAdd(i, "updateCapabilities: capabilities=" + mmTelCapabilities);
        ...
        if (mmTelFeatureImpl.queryCapabilityStatus().getMask() != mmTelCapabilities.getMask()) {
            try {
    ...
    public void updateRcsCapabilities(int i, RcsFeature.RcsImsCapabilities rcsImsCapabilities) {
        this.mEventLog.logAndAdd(i, "updateRcsCapabilities: capabilities=" + rcsImsCapabilities);
        RcsFeatureImpl rcsFeatureImpl = this.mSecImsServiceConnector.getRcsFeatureImpl(i);
        if (rcsFeatureImpl == null) {
            IMSLog.i(LOG_TAG, i, "updateRcsCapabilities: SecImsService not ready");
            return;
        }
        if (rcsFeatureImpl.queryCapabilityStatus().getMask() != rcsImsCapabilities.getMask()) {
            try {
    ...
    public void notifyRcsAutoConfigurationReceived(int i, byte[] bArr, boolean z) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyAcsReceived: size [%d], compressed [%s]", Integer.valueOf(bArr.length), Boolean.valueOf(z)));
    ...
    public void notifyRcsAutoConfigurationErrorReceived(int i, int i2, String str) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyAcsErrorReceived: error [%d %s]", Integer.valueOf(i2), str));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
    ...
    public void notifyProvisionedIntValueChanged(int i, int i2, int i3) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyProvisionedIntValueChanged: item=%d value=%d", Integer.valueOf(i2), Integer.valueOf(i3)));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
            this.mEventLog.logAndAdd(i, "notifyRcsPreConfigurationReceived: SecImsService not ready");
        } else {
    ...
    public void notifyProvisionedStringValueChanged(int i, int i2, String str) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyProvisionedStringValueChanged: item=%d value=%s", Integer.valueOf(i2), str));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
    ...
    public String getRcsClientConfiguration(int i, int i2) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "getRcsClientConfiguration: item=%d", Integer.valueOf(i2)));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
            this.mEventLog.logAndAdd(i, "notifyProvisionedStringValueChanged: SecImsService not ready");
            return null;
    ...
    public void notifyIntImsConfigChanged(int i, int i2, int i3) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyIntImsConfigChanged: item=%d value=%d", Integer.valueOf(i2), Integer.valueOf(i3)));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
    ...
    public void notifyStringImsConfigChanged(int i, int i2, String str) {
        this.mEventLog.logAndAdd(i, String.format(Locale.US, "notifyStringImsConfigChanged: item=%d value=%s", Integer.valueOf(i2), str));
        ImsConfigImpl imsConfigImpl = this.mSecImsServiceConnector.getImsConfigImpl(i);
        if (imsConfigImpl == null) {
    ...
    public void notifySipMessage(int i, SipMsg sipMsg) {
        this.mEventLog.logAndAdd(i, "notifySipMessage: " + sipMsg);
    ...
    public void updateAdhocProfile(int i, ImsProfile imsProfile, boolean z) {
        this.mEventLog.logAndAdd(i, "updateAdhocProfile: " + imsProfile);
    ...
    private Uri[] extractOwnUrisFromReg(ImsRegistration imsRegistration) {
        return (imsRegistration == null || CollectionUtils.isNullOrEmpty(imsRegistration.getImpuList())) ? new Uri[0] : (Uri[]) imsRegistration.getImpuList().stream().filter(new Predicate() { // from class: com.sec.internal.google.SecImsNotifier$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$extractOwnUrisFromReg$0;
                lambda$extractOwnUrisFromReg$0 = SecImsNotifier.lambda$extractOwnUrisFromReg$0((NameAddr) obj);
                return lambda$extractOwnUrisFromReg$0;
            }
        }).map(new Function() { // from class: com.sec.internal.google.SecImsNotifier$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Uri lambda$extractOwnUrisFromReg$1;
                lambda$extractOwnUrisFromReg$1 = SecImsNotifier.lambda$extractOwnUrisFromReg$1((NameAddr) obj);
                return lambda$extractOwnUrisFromReg$1;
            }
        }).toArray(new IntFunction() { // from class: com.sec.internal.google.SecImsNotifier$$ExternalSyntheticLambda2
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Uri[] lambda$extractOwnUrisFromReg$2;
                lambda$extractOwnUrisFromReg$2 = SecImsNotifier.lambda$extractOwnUrisFromReg$2(i);
                return lambda$extractOwnUrisFromReg$2;
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$extractOwnUrisFromReg$0(NameAddr nameAddr) {
        return UriUtil.hasMsisdnNumber(nameAddr.getUri());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Uri lambda$extractOwnUrisFromReg$1(NameAddr nameAddr) {
        return Uri.parse(nameAddr.getUri().toString());
    }
    ...
    public void onP2pRegCompleteEvent(int i) {
        ...
        if (mmTelFeatureImpl == null) {
            ...
            new Handler().post(new Runnable() { // from class: com.sec.internal.google.SecImsNotifier.1
    ...
    public void onP2pPushCallEvent(final DialogEvent dialogEvent) {
        ...
        if (mmTelFeatureImpl == null) {
            ...
            new Handler().post(new Runnable() { // from class: com.sec.internal.google.SecImsNotifier.2
                @Override // java.lang.Runnable
                public void run() {
                    try {
