...
public final class CloudMessageProviderContract {
    ...
    public static final int ALL_MMSPDU_SLOT2 = 61;
    public static final int ALL_SMS = 31;
    public static final int ALL_SMS_SLOT2 = 60;
    public static final int AMBS_VERSION = 98;
    ...
    public static final String CONTENTPRDR_AMBSFEATURE_VERSION = "ambs_feature_ver";
    public static final String CONTENTPRDR_FETCH_MCS_STATUS = "userdebugstatus";
    ...
    public static final String CONTENTPRDR_NOTIFICATION_IMDN = "notificationimdn";
    ...
    public static final String CONTENTPRDR_PREF_MAX_SMALL_FILE_SIZE = "max_small_file_size";
    ...
    public static final String CONTENTPRDR_USER_OPT_IN_STATUS = "useroptinflag";
    ...
    public static final String CONTENTPRDR_VVMQUOTA = "vvmquota";
    public static final int LATEST_MESSAGE = 33;
    public static final int LATEST_MESSAGE_SLOT2 = 62;
    public static final int MAX_ARR_SIZE = 2;
    public static final int MIGRATE_SUCCESS = 35;
    public static final int MMS_ADDR_MESSAGES = 5;
    public static final int MMS_ADDR_MESSAGES_SLOT2 = 45;
    public static final int MMS_PART_ID = 8;
    public static final int MMS_PART_ID_SLOT2 = 48;
    public static final int MMS_PART_MESSAGES = 6;
    public static final int MMS_PART_MESSAGES_SLOT2 = 46;
    public static final int MMS_PDU_MESSAGES = 4;
    public static final int MMS_PDU_MESSAGES_SLOT2 = 44;
    public static final int MULTI_LINE_STATUS = 23;
    public static final int MULTI_LINE_STATUS_SLOT2 = 71;
    public static final int NONE = 0;
    public static final int OPT_IN_STATUS = 37;
    public static final int OPT_IN_STATUS_SLOT2 = 64;
    public static final int PENDING_CHAT = 26;
    public static final int PENDING_CHAT_SLOT2 = 58;
    public static final int PENDING_FT = 27;
    public static final int PENDING_FT_SLOT2 = 59;
    public static final int PENDING_MMS = 25;
    public static final int PENDING_MMS_SLOT2 = 57;
    public static final int PENDING_SMS = 24;
    public static final int PENDING_SMS_SLOT2 = 56;
    public static final int PENDING_VVM = 28;
    public static final int PENDING_VVM_SLOT2 = 70;
    public static final int PREF_MAX_SMALL_FILE_SIZE = 40;
    public static final int PREF_MAX_SMALL_FILE_SIZE_SLOT2 = 73;
    public static final String PROVIDER_NAME = "com.samsung.rcs.cmstore";
    public static final int RCS_CONFERENCE_INFO = 38;
    public static final int RCS_GROUP_STATE = 34;
    public static final int RCS_GROUP_STATE_SLOT2 = 63;
    public static final int RCS_MESSAGES = 1;
    public static final int RCS_MESSAGES_CHAT = 11;
    public static final int RCS_MESSAGES_CHAT_SLOT2 = 51;
    public static final int RCS_MESSAGES_FT = 12;
    public static final int RCS_MESSAGES_FT_SLOT2 = 52;
    public static final int RCS_MESSAGES_IMDN = 13;
    public static final int RCS_MESSAGES_IMDN_SLOT2 = 53;
    public static final int RCS_MESSAGES_IMDN_USEIMDNID = 39;
    public static final int RCS_MESSAGES_IMDN_USEIMDNID_SLOT2 = 72;
    public static final int RCS_MESSAGES_QUERY_USEIMDN = 15;
    public static final int RCS_MESSAGES_QUERY_USEIMDN_SLOT2 = 55;
    public static final int RCS_MESSAGES_SLM = 14;
    public static final int RCS_MESSAGES_SLM_SLOT2 = 54;
    public static final int RCS_MESSAGES_SLOT2 = 41;
    public static final int RCS_MESSAGE_ID = 9;
    public static final int RCS_MESSAGE_ID_SLOT2 = 49;
    public static final int RCS_PARTICIPANT = 2;
    public static final int RCS_PARTICIPANT_SLOT2 = 42;
    public static final int RCS_SESSION = 10;
    public static final int RCS_SESSION_SLOT2 = 50;
    public static final int SMS_MESSAGES = 3;
    public static final int SMS_MESSAGES_SLOT2 = 43;
    public static final int SUMMARY_TABLE = 7;
    public static final int SUMMARY_TABLE_SLOT2 = 47;
    public static final int USER_DEBUG_FLAG = 99;
    public static final int USER_DEBUG_STATUS = 100;
    public static final int VVM_GREETING = 18;
    public static final int VVM_GREETING_SLOT2 = 66;
    public static final int VVM_MESSAGES = 17;
    public static final int VVM_MESSAGES_SLOT2 = 65;
    public static final int VVM_PIN = 19;
    public static final int VVM_PIN_SLOT2 = 67;
    public static final int VVM_PROFILE = 20;
    public static final int VVM_PROFILE_SLOT2 = 68;
    public static final int VVM_QUOTA = 36;
    public static final int VVM_QUOTA_SLOT2 = 69;
    ...
    public static class BufferDBExtensionBase {
        ...
        public static final String FILE_URI = "content_uri";
        ...
        public static final String INITUPLOADSTATUS = "initupload_status";
        ...
        public static final String REFERENCE_ID = "re_original_key";
        public static final String REFERENCE_TYPE = "re_type";
        public static final String REFERENCE_VALUE = "re_count_info";
        ...
        public static final String SYNCMESSAGESTATUS = "syncmessage_status";
    ...
    public static final class BufferDBSMS {
        ...
        public static final String FROM_ADDRESS = "from_address";
        public static final String GROUP_COTAG = "group_cotag";
        public static final String GROUP_ID = "group_id";
        public static final String GROUP_TYPE = "group_type";
        public static final String HIDDEN = "hidden";
        public static final String IM_CONTRIBUTION_ID = "im_contribution_id";
        public static final String IM_CONTRIBUTION_ID2 = "im_contribution_id2";
        public static final String IM_CONVERSATION_ID = "im_conversation_id";
        public static final String IM_CONVERSATION_ID2 = "im_conversation_id2";
        ...
        public static final String SAFE_MESSAGE = "safe_message";
        public static final String SEEN = "seen";
        public static final String SELF_PHONE_NUMBER = "self_phone_number";
        public static final String SERVICE_CENTER = "service_center";
        public static final String SESSION_ID = "session_id";
        public static final String SESSION_ID2 = "session_id2";
        public static final String SESSION_URI2 = "session_uri2";
        public static final String SIM_IMSI = "sim_imsi";
        ...
        public static final String SUBJECT_ALIAS = "alias";
    ...
    public static final class ConversationType {
        public static final int CHAT_CLOSED_THREAD = 3;
        public static final int GROUP_CHAT_THREAD = 2;
        public static final int NONE = 0;
    ...
    public static class DataTypes {
        ...
        public static final String ADHOC_V2TLANGUAGE = "ADHOCV2T";
        public static final String CHAT = "CHAT";
        public static final String DEACTIVATE = "DEACTIVATE";
        public static final String FT = "FT";
        public static final String GSO = "GSO";
        public static final String IMDN = "RCS_IMDN";
        public static final String MMS = "MMS";
        public static final String MSGAPP_ALL = "MSG_ALL";
        public static final String NUTOFF = "NUTOFF";
        public static final String NUTON = "NUTON";
        public static final String RCS_IMDN_CHAT = "RCS_IMDN_CHAT";
        public static final String RCS_IMDN_FT = "RCS_IMDN_FT";
        public static final String SESSION = "RCS_SESSION";
        public static final String SMS = "SMS";
        public static final String V2TLANGUAGE = "V2TLANGUAGE";
        public static final String V2T_EMAIL = "V2T_EMAIL";
        public static final String V2T_SMS = "V2T_SMS";
        ...
        public static final String VVMQUOTA = "VVMQUOTA";
    }
    ...
    public static final class JsonData {
        ...
        public static final String GROUP_SMS_BODY = "group_sms_body";
        public static final String GROUP_SMS_FROM = "group_sms_from";
        public static final String GROUP_SMS_RECIPIENTS = "group_sms_recipients";
        public static final String ID = "id";
        public static final String IMDN_MESSAGE_ID = "imdn_message_id";
        public static final String IMS_PARTID = "bufferDbId";
        public static final String IS_GROUP_SMS = "is_group_sms";
        ...
        public static final String REMOTE_ID = "remoteDbId";
    ...
    public static final class TrashBin {
    ...
    public static final class VVMAccountInfoColumns {
        ...
        public static final String V2T_EMAIL = "v2t_email";
        public static final String V2T_LANGUAGE = "v2t_language";
        public static final String V2T_SMS = "v2t_sms";
    ...
    public static final class VVMQuotaColumns {
