...
public class ATTConstants {
    ...
    public static final class CommonHttpHeaders {
        public static final String CLIENT_ID = "x-att-clientId";
        public static final String CLIENT_VERSION = "x-att-clientVersion";
        public static final String CONTEXT_INFO = "x-att-contextInfo";
        public static final String DEVICE_ID = "x-att-deviceId";
    }
    ...
    public enum AttAmbsUIScreenNames {
        ...
        RestartMenu_Enable_PrmptMsg15(115),
        RestartMenu_Disable_PrmptMsg16(116),
        ...
        AMBS_SERVICE_DISABLE(301),
        AMBS_SERVICE_ENABLE(302);

        private final int mId;

        AttAmbsUIScreenNames(int i) {
            this.mId = i;
        }
        ...
        public static AttAmbsUIScreenNames valueOf(int i) {
            for (AttAmbsUIScreenNames attAmbsUIScreenNames : values()) {
                if (attAmbsUIScreenNames.mId == i) {
                    return attAmbsUIScreenNames;
                }
            }
            return null;
        }
