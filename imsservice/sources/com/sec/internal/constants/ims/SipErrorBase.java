...
public class SipErrorBase extends SipError {
    ...
    public static final SipError MOVED_PERMANENTLY = new SipError(301, "Moved Permanently");
    public static final SipError MOVED_TEMPORARILY = new SipError(302, "Moved Temporarily");
    public static final SipError USE_PROXY = new SipError(305, "Use Proxy");
    ...
    public static final SipError METHOD_NOT_ALLOWED = new SipError(405, "Method Not Allowed");
    public static final SipError NOT_ACCEPTABLE = new SipError(RegistrationEvents.EVENT_DISCONNECT_PDN_BY_VOLTE_DISABLED, "Not Acceptable");
    ...
    public static final SipError CONDITIONAL_REQUEST_FAILED = new SipError(UtConstant.UtError.HTTP_412_PRECONDITION_FAILED, "Conditional Request Failed");
    ...
    public static final SipError PD_CALL_EXISTS_ON_THE_OTHER_SLOT = new SipError(NSDSNamespaces.NSDSHttpResponseCode.BUSY_HERE, "PD_CALL_EXISTS_ON_THE_OTHER_SLOT");
    ...
    public static final SipError NOTIFY_TERMINATED_PROBATION = new SipError(713, "Notify terminated probation");
    ...
    public static class END_REASON {
        ...
        public static final int NETWORK_ATTACH_FAIL = 30;
    ...
    public static boolean isImsForbiddenError(SipError sipError) {
        if (sipError == null || FORBIDDEN.getCode() != sipError.getCode() || TextUtils.isEmpty(sipError.getReason())) {
            return false;
        }
    ...
    public static boolean isRegiTerminatedError(SipError sipError) {
        return OK.equals(sipError) || NOTIFY_TERMINATED_DEACTIVATED.equals(sipError) || NOTIFY_TERMINATED_REJECTED.equals(sipError) || NOTIFY_TERMINATED_PROBATION.equals(sipError);
    }
}
