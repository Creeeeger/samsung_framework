...
public class SoftphoneNamespaces {
    ...
    public static final class SoftphoneCallHandling {
        ...
        public static String getCondition(int i) {
            return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 8 ? "unknown" : "not-registered" : "not-reachable" : "no-answer" : "busy" : "unconditional";
        }

        public static String getId(int i) {
            return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 8 ? "unknown" : "call-diversion-not-logged-in" : "call-diversion-not-reachable" : "call-diversion-no-reply" : "call-diversion-busy" : "call-diversion-unconditional";
        }
    }
