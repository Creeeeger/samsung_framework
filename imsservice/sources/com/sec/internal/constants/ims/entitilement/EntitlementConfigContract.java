...
public class EntitlementConfigContract {
    ...
    public static final int DEVICE_CONFIG_TAG = 9;
    ...
    public static final class DeviceConfig implements CommonColumns, DeviceConfigColumns {
        ...
        public static final String QUERY_PARAM_SLOT = "slot";
        ...
        public static final Uri buildXPathExprUri(String str) {
            Uri.Builder buildUpon = Uri.withAppendedPath(CONTENT_URI, "xpath").buildUpon();
