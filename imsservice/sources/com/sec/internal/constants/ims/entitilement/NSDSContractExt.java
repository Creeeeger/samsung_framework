...
public class NSDSContractExt {
    ...
    public static final class Lines implements CommonColumns, LineColumns {
        ...
        public static final Uri buildLinesUri(String str) {
            Uri.Builder buildUpon = Uri.withAppendedPath(NSDSContractExt.AUTHORITY_URI, "lines").buildUpon();
            buildUpon.appendQueryParameter("device_uid", str);
        ...
        public static final Uri buildActiveLinesWithServicveUri(String str) {
            Uri.Builder buildUpon = Uri.withAppendedPath(NSDSContractExt.AUTHORITY_URI, "active_lines_with_services").buildUpon();
            buildUpon.appendQueryParameter("device_uid", str);
            return buildUpon.build();
        }
        ...
        public static final Uri buildLineUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }

        public static final Uri buildServicesUri(long j, long j2) {
            return Uri.withAppendedPath(Uri.withAppendedPath(ContentUris.withAppendedId(Devices.CONTENT_URI, j), "lines/" + j2), GlobalSettingsConstants.Registration.EXTENDED_SERVICES);
        }

        public static final Uri buildRefreshSitUri(String str) {
            Uri.Builder buildUpon = Uri.withAppendedPath(CONTENT_URI, "refresh_sit").buildUpon();
            buildUpon.appendQueryParameter("msisdn", str);
            return buildUpon.build();
        }
    }
    ...
    public static final class Devices implements CommonColumns, DeviceColumns {
        ...
        public static final Uri buildDeviceUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }

        public static final Uri buildUpdateDeviceNameUri(long j) {
            return Uri.withAppendedPath(ContentUris.withAppendedId(CONTENT_URI, j), "update_device_name");
        }
    }
    ...
    public static final class ProvisioningParameters implements CommonColumns, ProvisioningParametersColumns {
        ...
        public static final Uri buildProvisioningParametersUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class Services implements CommonColumns, ServiceColumns {
        ...
        public static final Uri buildServiceUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class ConnectivityParameters implements CommonColumns, ConnectivityParamsColumns {
        ...
        public static final Uri buildConnectivityParamsUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class DeviceConfig implements CommonColumns, DeviceConfigColumns {
        ...
        public static final Uri buildDeviceConfigUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class ConnectivityParameterServiceNames implements CommonColumns, ConnectivityServicesColumns {
        ...
        public static final Uri buildServiceNamesUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class GcmTokens implements CommonColumns, GcmTokensColumns {
        ...
        public static Uri buildGcmTokensUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
    ...
    public static final class NsdsConfigs implements CommonColumns, NsdsConfigColumns {
        ...
        public static final Uri buildNsdsConfigUri(long j) {
            return ContentUris.withAppendedId(CONTENT_URI, j);
        }
    }
