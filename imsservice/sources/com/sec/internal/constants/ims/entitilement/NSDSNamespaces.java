...
public class NSDSNamespaces {
    ...
    public static final class ActionTrigger {
        public static final int CHANGE_URL = 6;
        public static final int ERASE_DB = 5;
        public static final int FIRST_BOOTUP = 0;
        public static final int NOT_SET = -1;
        public static final int PERIODIC = 3;
        public static final int PUSH_SMS = 7;
        public static final int REBOOT = 1;
        public static final int SIM_SWAP = 2;
        public static final int UPDATE_SW = 4;
    }
    ...
    public static final class DeviceConfigResult {
        public static final int FAILURE = 0;
        public static final int SUCCESS = 1;
        public static final int SUCCESS_CHANGED = 2;
    }
    ...
    public static final class NSDSEvents {
        ...
        public static final int EVT_ENTITLEMENT_CHECK = 15;
    ...
    public static final class NSDSExtras {
        public static final String CHANGED_CONFIG = "changed_config";
    ...
    public static final class NSDSSettings {
        public static final String CHANNEL_NAME_ASW = "ASW";
    ...
    public static final class NSDSSharedPref {
        ...
        public static final String PREF_ACTION_TRIGGER = "action_trigger";
    ...
    public static final class Packages {
        public static final String NSDS_WEBAPP = "com.sec.vsim.ericssonnsds.webapp";
    }
