...
public class ImsConstants {
    ...
    private static final String LOG_TAG = "ImsConstants";
    ...
    public static class SystemProperties {
        ...
        public static final String SIP_TEST_ENABLE = "persist.sip.test.enable";
    }
    ...
    public static class SystemSettings {
        ...
        public static final SettingsItem IMS_PROFILE_WITH_ID = new SettingsItem(Uris.AUTHORITY, IMS_PROFILE, "*");
        ...
        public static boolean isWiFiCallEnabled(Context context) {
            ...
            Log.d(ImsConstants.LOG_TAG, "isWiFiCallEnabled: wifi_call_enable [" + wiFiCallEnabled + "], wifi_call_enable2 [" + wiFiCallEnabled2 + "]");
            return wiFiCallEnabled == 1 || wiFiCallEnabled2 == 1;
        }

        public static int getWiFiCallEnabled(Context context, int i, int i2) {
            return i2 == Phone.SLOT_1 ? WIFI_CALL_ENABLE1.get(context, i) : WIFI_CALL_ENABLE2.get(context, i);
        }

        public static int getWiFiCallPreferred(Context context, int i, int i2) {
            return i2 == Phone.SLOT_1 ? WIFI_CALL_PREFERRED1.get(context, i) : WIFI_CALL_PREFERRED2.get(context, i);
        }

        public static int getWiFiCallWhenRoaming(Context context, int i, int i2) {
            return i2 == Phone.SLOT_1 ? WIFI_CALL_WHEN_ROAMING1.get(context, i) : WIFI_CALL_WHEN_ROAMING2.get(context, i);
        }
            ...
            */
            public int get(android.content.Context r9, int r10) {
                /*
                    ...
                    r7 = 0
                    java.lang.String r1 = com.sec.internal.constants.ims.ImsConstants.SystemSettings.m3$$Nest$sfgetSYSTEM()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mCategory     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    boolean r1 = r1.equalsIgnoreCase(r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r1 == 0) goto L26
                    android.content.ContentResolver r1 = r9.getContentResolver()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    int r10 = android.provider.Settings.System.getInt(r1, r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r1 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    android.net.Uri r1 = android.provider.Settings.System.getUriFor(r1)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                L24:
                    r2 = r1
                    goto L7b
                L26:
                    java.lang.String r1 = com.sec.internal.constants.ims.ImsConstants.SystemSettings.m1$$Nest$sfgetGLOBAL()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mCategory     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    boolean r1 = r1.equalsIgnoreCase(r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r1 == 0) goto L43
                    android.content.ContentResolver r1 = r9.getContentResolver()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    int r10 = android.provider.Settings.Global.getInt(r1, r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r1 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    android.net.Uri r1 = android.provider.Settings.Global.getUriFor(r1)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    goto L24
                L43:
                    java.lang.String r1 = com.sec.internal.constants.ims.ImsConstants.SystemSettings.m2$$Nest$sfgetSECURE()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mCategory     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    boolean r1 = r1.equalsIgnoreCase(r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r1 == 0) goto L60
                    android.content.ContentResolver r1 = r9.getContentResolver()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    int r10 = android.provider.Settings.Secure.getInt(r1, r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r1 = r8.mName     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    android.net.Uri r1 = android.provider.Settings.Secure.getUriFor(r1)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    goto L24
                L60:
                    java.lang.String r1 = com.sec.internal.constants.ims.ImsConstants.m0$$Nest$sfgetLOG_TAG()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    r2.<init>()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r4 = "Unknown Category : "
                    r2.append(r4)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r4 = r8.mCategory     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    r2.append(r4)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r2 = r2.toString()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    android.util.Log.e(r1, r2)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    r2 = r7
                L7b:
                    if (r2 == 0) goto La0
                    android.content.ContentResolver r1 = r9.getContentResolver()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    ...
                    r5 = 0
                    r6 = 0
                    android.database.Cursor r7 = r1.query(r2, r3, r4, r5, r6)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r7 == 0) goto La0
                    int r9 = r7.getCount()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r9 == 0) goto La0
                    boolean r9 = r7.moveToFirst()     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    if (r9 == 0) goto La0
                    int r9 = r7.getColumnIndex(r0)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    java.lang.String r9 = r7.getString(r9)     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                    r8.mPkg = r9     // Catch: java.lang.Throwable -> La6 java.lang.Throwable -> La8 android.provider.Settings.SettingNotFoundException -> Laf
                La0:
                    if (r7 == 0) goto Lce
                La2:
                    r7.close()
                ...
                La8:
                    ...
                    goto La2
                Laf:
                    java.lang.String r9 = com.sec.internal.constants.ims.ImsConstants.m0$$Nest$sfgetLOG_TAG()     // Catch: java.lang.Throwable -> La6
                    ...
                    java.lang.String r1 = r8.getPath()     // Catch: java.lang.Throwable -> La6
                    r0.append(r1)     // Catch: java.lang.Throwable -> La6
                    java.lang.String r0 = r0.toString()     // Catch: java.lang.Throwable -> La6
                    android.util.Log.d(r9, r0)     // Catch: java.lang.Throwable -> La6
                    if (r7 == 0) goto Lce
                    goto La2
                Lce:
                    java.lang.String r9 = com.sec.internal.constants.ims.ImsConstants.m0$$Nest$sfgetLOG_TAG()
            ...
            public int getbySubId(Context context, int i, int i2) {
                ...
                try {
                    ...
                    Log.d(ImsConstants.LOG_TAG, "SettingNotFound : " + getPath() + ",subId " + i2);
                }
                if (SystemSettings.GLOBAL.equalsIgnoreCase(this.mCategory)) {
                    i3 = Settings.Global.getInt(context.getContentResolver(), this.mName + i2);
                } else if (SystemSettings.SYSTEM.equalsIgnoreCase(this.mCategory)) {
                    i3 = Settings.System.getInt(context.getContentResolver(), this.mName + i2);
                } else if (SystemSettings.SECURE.equalsIgnoreCase(this.mCategory)) {
                    i3 = Settings.Secure.getInt(context.getContentResolver(), this.mName + i2);
                } else {
                    Log.e(ImsConstants.LOG_TAG, "Unknown Category : " + this.mCategory);
                    Log.d(ImsConstants.LOG_TAG, "getIntbySubId(" + getPath() + i2 + ") : " + i);
                    return i;
                }
                i = i3;
                Log.d(ImsConstants.LOG_TAG, "getIntbySubId(" + getPath() + i2 + ") : " + i);
            ...
            public void set(Context context, int i) {
                Log.d(ImsConstants.LOG_TAG, "setInt(" + getPath() + ") : " + i);
                ...
                if (SystemSettings.SECURE.equalsIgnoreCase(this.mCategory)) {
