...
public class IMSMediaEvent {
    ...
    public enum MEDIA_STATE {
        ...
        EMOJI_STOP_FAILURE,
        EMOJI_INFO_CHANGE,
        GENERAL_EVENT_VCID_FAILURE,
        GENERAL_EVENT_IDC_SCREEN_SHARE_START,
        GENERAL_EVENT_IDC_SCREEN_SHARE_STOP,
        GENERAL_EVENT_IDC_ARCALL_START,
        GENERAL_EVENT_IDC_ARCALL_STOP
    }
