...
public final class ImContract {
    ...
    public static final int MAKE_NEW_SYSTEM_USER_MESSAGE = 41;
    ...
    public static final class CsSession extends ChatItem {
        public static final String BYTES_TRANSFERRED = "bytes_transf";
    ...
    public static final class Message extends ChatItem {
        ...
        public static final String MSG_CREATOR = "creator";
