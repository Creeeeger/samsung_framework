...
public enum SipResponse implements IEnumerationWithId<SipResponse> {
    ...
    SIP_406_NOT_ACCEPTABLE(RegistrationEvents.EVENT_DISCONNECT_PDN_BY_VOLTE_DISABLED),
    SIP_407_PROXY_AUTHENTICATION_REQUIRED(RegistrationEvents.EVENT_CHECK_UNPROCESSED_OMADM_CONFIG),
    SIP_408_REQUEST_TIMEOUT(408),
    SIP_409_CONFLICT(RegistrationEvents.EVENT_UPDATE_REGI_CONFIG),
    SIP_410_GONE(410),
    SIP_411_LENGTH_REQUIRED(411),
    SIP_412_CONDITIONAL_REQUEST_FAILED(UtConstant.UtError.HTTP_412_PRECONDITION_FAILED),
    ...
    private static final ReverseEnumMap<SipResponse> map = new ReverseEnumMap<>(SipResponse.class);
    ...
    @Override // com.sec.internal.constants.ims.servicemodules.im.IEnumerationWithId
    public SipResponse getFromId(int i) {
        return fromId(i);
    }

    public static SipResponse fromId(int i) {
        SipResponse sipResponse = SIP_UNKNOWN_RESPONSE;
        try {
            return (SipResponse) map.get(Integer.valueOf(i));
