...
public class DiagnosisConstants {
    ...
    public static final List<String> REGI_COUNT_KEYS = new ArrayList<String>() { // from class: com.sec.internal.constants.ims.DiagnosisConstants.1
        {
            add("RGSN");
            add("RGS4");
            add("RGSL");
    ...
    public static int getPdnType(final String str) {
        ...
        return ((Integer) hashMap.entrySet().stream().filter(new Predicate() { // from class: com.sec.internal.constants.ims.DiagnosisConstants$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getPdnType$0;
                lambda$getPdnType$0 = DiagnosisConstants.lambda$getPdnType$0(str, (Map.Entry) obj);
                return lambda$getPdnType$0;
            }
        }).findFirst().map(new DiagnosisConstants$$ExternalSyntheticLambda1()).orElse(0)).intValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$getPdnType$0(String str, Map.Entry entry) {
        return ((String) entry.getKey()).equals(str);
    }

    public static int getPaniPrefix(final String str) {
        ...
        return ((Integer) hashMap.entrySet().stream().filter(new Predicate() { // from class: com.sec.internal.constants.ims.DiagnosisConstants$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getPaniPrefix$1;
                lambda$getPaniPrefix$1 = DiagnosisConstants.lambda$getPaniPrefix$1(str, (Map.Entry) obj);
                return lambda$getPaniPrefix$1;
            }
        }).findFirst().map(new DiagnosisConstants$$ExternalSyntheticLambda1()).orElse(0)).intValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$getPaniPrefix$1(String str, Map.Entry entry) {
    ...
    public static String intToHexStr(int i) {
        return String.format("0x%8s", Integer.toHexString(i).toUpperCase()).replace(' ', '0');
    }
}
