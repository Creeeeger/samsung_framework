...
public class RegistrationConstants {
    ...
    public static final String REASON_EPDG_CONNECTING = "ePDGConnecting";
    ...
    public static final class DetailedDeregiReason {
        ...
        public static final int ADS_CHANGED = 35;
        ...
        public static final int COUNTRY_BLOCKING = 53;
        ...
        public static final int EPSFB = 54;
    ...
    public static final class SuspendReason {
        public static final int IRAT = 1;
    ...
    public enum UpdateRegiReason {
        GENERAL,
        PENDING_UPDATE,
        FORCED_PENDING_UPDATE(true),
        FORCED_UPDATE(true),
        ADS_CHANGED,
        BOOT_COMPLETED,
        CAPABILITY_CHANGED,
        CAPABILITY_CHANGED_FORCED(true),
        CHATBOT_AGREEMENT_CHANGED(true),
        DATAUSAGE_LIMIT_REACHED,
        DATAUSAGE_LIMIT_REACHED_FORCED(true),
        DAILYREREGISTER,
        DSAC_MODE_CHANGED,
        EPDG_TIMEOUT,
        EPDG_CONNECTED(true),
        EPDG_DISCONNECTED(true),
        EPDG_VOICEPREFERENCE_CHANGED,
        GEOLOCATION_CHANGED,
        GEOLOCATION_CHANGED_FORCED(true),
        IMS_CONFIGURATION_CHANGED,
        NETWORK_EVENT_CHANGED,
        RCS_ALLOWED_CHANGED,
        SETTING_MOBILEDATA_CHANGED,
        SETTING_MOBILEDATA_CHANGED_FORCED(true),
        SETTING_ROAMINGDATA_CHANGED,
        SETTING_ECVBC_CHANGED,
        SETTING_VOLTECALLSTATE_CHANGED,
        SETTING_VIDEOCALLSTATE_CHANGED,
        SETTING_VIDEOCALLSTATE_CHANGED_FORCED(true),
        SETTING_RTTMODE_CHANGE(true),
        SETTING_TTYMODE_CHANGE,
        SETTING_VOWIFI_CHANGED,
        SETTING_RCSUSERSETTING_CHANGED,
        SIPDELEGATE_UPDATE,
        SIPERROR_FORCED(true),
        SSAC_UPDATED,
        THIRDPARTY_FEATURETAG_UPDATED(true);
        ...
        UpdateRegiReason(boolean z) {
            this.mForced = z;
        }

        public boolean isForceUpdateReason() {
            return this.mForced;
        }
    }
}
