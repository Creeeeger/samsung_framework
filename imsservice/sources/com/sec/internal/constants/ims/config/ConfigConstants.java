...
public class ConfigConstants {
    ...
    public static final float IID_TOKEN_MIN_CLIENT_VERSION = 8.5f;
    public static final long IID_TOKEN_MIN_GMS_CORE_VERSION = 210600000;
    ...
    public static final Map<String, String> APPID_MAP = new TreeMap<String, String>() { // from class: com.sec.internal.constants.ims.config.ConfigConstants.1
        {
            put(PVALUE.APP_ID_1, "0");
            put(PVALUE.APP_ID_2, "1");
            put("ap2003", "2");
            put("ap2004", DiagnosisConstants.RCSM_ORST_REGI);
            put("ap2005", DiagnosisConstants.RCSM_ORST_HTTP);
            put(PVALUE.APP_ID_3GPP_IMS, "0");
            put(PVALUE.APP_ID_3GPP_NAS, DiagnosisConstants.RCSM_ORST_ITER);
        }
    };
    ...
    public static class CAPABILITY_DISCOVERY_TYPE {
    ...
    public static final class ConfigPath {
        ...
        public static final String LBO_PCSCF_ADDRESSES_CHARACTERISTIC_UP10_PATH = "root/application/0/lbo_p-cscf_address/lbo_p-cscf_addresses/";
        ...
        public static final String PUBLIC_USER_IDENTITY_CHARACTERISTIC_UP10_PATH = "root/application/0/public_user_identity_list/public_user_identities/";
    ...
    public static final class ConfigTable {
        ...
        public static final String IM_SPAM_REPORTING_URI = "im-spam-reporting-uri";
        ...
        public static final String SERVICES_VBC_AUTH = "VBCAuth";
        ...
        public static final String UX_CANCEL_MESSAGE_UX = "cancelmessageux";
        ...
        public static final String UX_REALTIME_USER_ALIAS_AUTH = "ext/realtimeUserAliasAuth";
    ...
    public static class PATH {
        ...
        public static final String INFO_CLIENT_VENDOR = "info/client_vendor";
        public static final String INFO_CLIENT_VERSION = "info/client_version";
        ...
        public static final String INFO_RCS_ENABLED_BY_USER = "info/rcs_enabled_by_user";
        public static final String INFO_RCS_PROFILE = "info/rcs_profile";
        public static final String INFO_RCS_VERSION = "info/rcs_version";
    ...
    public static class PVALUE {
        public static final String APP_ID_1 = "ap2001";
        public static final String APP_ID_2 = "ap2002";
        public static final String APP_ID_3 = "ap2003";
        public static final String APP_ID_3GPP_IMS = "urn:oma:mo:ext-3gpp-ims:1.0";
        public static final String APP_ID_3GPP_NAS = "urn:oma:mo:ext-3gpp-nas-config:1.0";
        public static final String APP_ID_4 = "ap2004";
        public static final String APP_ID_5 = "ap2005";
        ...
        public static final int COMPOSER_AUTH_DISABLED = 0;
        public static final int COMPOSER_AUTH_ENABLED_BOTH = 3;
        public static final int COMPOSER_AUTH_ENABLED_MMTEL = 2;
        public static final int COMPOSER_AUTH_ENABLED_MSRP = 1;
        public static final String DEFAULT_SMS_APP = "1";
        public static final String GOOG_DEFAULT_CLIENT_VENDOR = "Goog";
        public static final String GOOG_DEFAULT_CLIENT_VERSION = "RCSAndr-8.5";
        public static final String GOOG_DEFAULT_RCS_ENABLED_BY_USER = "1";
        public static final String GOOG_DEFAULT_RCS_PROFILE = "UP_1.0";
        public static final String GOOG_DEFAULT_RCS_VERSION = "7.0";
        ...
        public static final String SEC_DEFAULT_RCS_PROFILE = "UP_1.0";
        public static final String TOKEN = "";
        public static final int VBC_AUTH_DISABLED = 0;
        public static final int VBC_AUTH_ENABLED = 1;
    ...
    public static class VALUE {
        ...
        public static final String INFO_CLIENT_VENDOR = "";
        public static final String INFO_CLIENT_VERSION = "";
        public static final String INFO_COMPLETED = "false";
        public static final String INFO_RCS_PROFILE = "";
        public static final String INFO_RCS_VERSION = "";
