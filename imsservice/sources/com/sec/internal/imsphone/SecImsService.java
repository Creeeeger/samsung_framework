...
public class SecImsService extends ImsService {
    ...
    public MmTelFeatureImpl getMmTelFeatureImpl(int i) {
        return (MmTelFeatureImpl) createMmTelFeatureForSubscription(i, -1);
    }
    ...
    public RcsFeatureImpl getRcsFeatureImpl(int i) {
        return (RcsFeatureImpl) createRcsFeatureForSubscription(i, -1);
    }
    ...
    public ImsRegistrationImpl getImsRegistrationImpl(int i) {
        return (ImsRegistrationImpl) getRegistrationForSubscription(i, -1);
    }
    ...
    public ImsConfigImpl getImsConfigImpl(int i) {
        return (ImsConfigImpl) getConfigForSubscription(i, -1);
    }
    ...
    public IBinder onBind(Intent intent) {
        IMSLog.i(LOG_TAG, "onBind: action [" + intent.getAction() + "], component [" + intent.getComponent() + "]");
