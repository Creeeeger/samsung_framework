...
public interface IHttpAdapter {
    ...
    public static class Response {
        ...
        private void debugPrint() {
            ...
            if (this.mBody != null) {
                String str3 = LOG_TAG;
                Log.d(str3, "+++ HTTP(S) response : body");
                sb2.append("\n");
                try {
                    String str4 = new String(this.mBody, CHARSET);
                    sb2.append(str4);
                    byte[] bArr = this.mBody;
                    if (bArr.length > 256) {
                        Log.d(str3, new String(bArr, 0, 128, CHARSET));
                        byte[] bArr2 = this.mBody;
                        Log.d(str3, new String(bArr2, bArr2.length - 128, 128, CHARSET));
                    } else {
                        Log.d(str3, str4);
                    }
