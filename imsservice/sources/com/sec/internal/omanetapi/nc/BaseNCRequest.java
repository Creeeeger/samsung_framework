...
public abstract class BaseNCRequest extends HttpRequestParams implements IHttpAPICommonInterface {
    ...
    public BaseNCRequest(String str, String str2, String str3, MessageStoreClient messageStoreClient) {
        this.TAG = BaseNCRequest.class.getSimpleName();
    ...
    private void buildBaseURL(String str, String str2, String str3) {
        ...
        IMSLog.i(this.TAG, "buildBaseURL: isCmsMcsEnabled: " + isMcsSupported);
    ...
    public void initCommonRequestHeaders(String str, String str2) {
        ...
        if (this.mStoreClient.getCloudMessageStrategyManager().getStrategy().isEnableATTHeader()) {
            ...
            this.mNCRequestHeaderMap.put(ATTConstants.CommonHttpHeaders.CLIENT_VERSION, ATTGlobalVariables.VERSION_NAME);
            this.mNCRequestHeaderMap.put(ATTConstants.CommonHttpHeaders.CLIENT_ID, ATTGlobalVariables.getHttpClientID());
            this.mNCRequestHeaderMap.put(ATTConstants.CommonHttpHeaders.CONTEXT_INFO, ATTGlobalVariables.BUILD_INFO);
            this.mNCRequestHeaderMap.put(ATTConstants.CommonHttpHeaders.DEVICE_ID, this.mStoreClient.getPrerenceManager().getDeviceId());
        }
    }
    ...
    public void initMcsCommonRequestHeaders(String str, String str2) {
        ...
        this.mNCRequestHeaderMap.put(McsConstants.CommonHttpHeaders.CLIENT_VERSION, this.mStoreClient.getCloudMessageStrategyManager().getStrategy().getClientVersion() + "/" + CmsUtil.getSmAppVersion(this.mContext));
    ...
    protected int checkRetryAfter(HttpResponseParams httpResponseParams, int i) {
        List<String> list;
        Log.d(this.TAG, " checkRetryAfter retryCount " + i);
        ...
        IMSLog.d(this.TAG, "retryAfter is " + str + "seconds retryAfterHeader: " + list);
        try {
    ...
    public boolean isErrorCodeSupported(int i) {
        ...
        IMSLog.i(this.TAG, "isErrorCodeSupported: " + isErrorCodeSupported);
    ...
    public void updateContactSyncHeader() {
        ...
        IMSLog.i(this.TAG, "updateContactSyncHeader hasPackage: " + hasPackage);
        if (hasPackage) {
