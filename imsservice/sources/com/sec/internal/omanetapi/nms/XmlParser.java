        ...
        try {
            ...
            for (int eventType = newPullParser.getEventType(); eventType != 1; eventType = newPullParser.next()) {
                if (eventType == 0) {
                    ...
                    if (TAG_GROUP_STATE.equals(lowerCase)) {
                        while (i < attributeCount) {
                            ...
                            if ("timestamp".equals(lowerCase2)) {
                                ...
                                Log.e(LOG_TAG, "Unknown attrName:" + lowerCase2);
                            }
                            i++;
                        }
                        ...
                        while (i < attributeCount) {
                            ...
                            System.out.println("attrname>" + lowerCase4 + ";attrValue>" + lowerCase5);
                            if ("name".equals(lowerCase4)) {
                                ...
                                Log.e(LOG_TAG, "Unknown attrName:" + lowerCase4);
                            }
                            i++;
                        }
                    ...
                    Log.i(LOG_TAG, "end tagName:" + lowerCase6);
                } else if (eventType == 4) {
