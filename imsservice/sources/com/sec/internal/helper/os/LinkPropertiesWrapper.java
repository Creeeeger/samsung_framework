...
public class LinkPropertiesWrapper {
    ...
    public LinkPropertiesWrapper() {
        try {
            this.mLinkProperties = (LinkProperties) LinkProperties.class.getConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    public boolean isIdenticalInterfaceName(LinkPropertiesWrapper linkPropertiesWrapper) {
        try {
            return ((Boolean) ReflectionUtils.invoke2(this.mLinkProperties.getClass().getMethod("isIdenticalInterfaceName", LinkProperties.class), this.mLinkProperties, new Object[]{linkPropertiesWrapper.getLinkProperties()})).booleanValue();
        } catch (IllegalStateException | NoSuchMethodException | SecurityException e) {
            e.printStackTrace();
            return false;
        }
