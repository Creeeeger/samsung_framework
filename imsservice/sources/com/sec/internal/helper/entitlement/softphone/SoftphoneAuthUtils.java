...
public final class SoftphoneAuthUtils {
    ...
    private static List<ImsProfile> getSoftphoneProfileList(Context context) {
        ...
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.sec.ims.settings/profile"), null, "mdmn_type=Softphone", null, null);
        if (query != null) {
    ...
    private static String getSccLabel(Context context, String str, int i) {
        ...
        Cursor query = context.getContentResolver().query(SoftphoneContract.SoftphoneAccount.buildAccountLabelUri(str, i), null, null, null, null);
        String str3 = "";
        if (query != null) {
