...
public final class NetworkUtil {
    ...
    public static boolean is3gppPsVoiceNetwork(int i) {
        ...
        return SipTestManagerFactory.isSipTest();
    }
    ...
    public static int getPreferredNetworkMode(Context context, int i) {
        return Settings.Global.getInt(context.getContentResolver(), ImsConstants.SystemSettings.PREFFERED_NETWORK_MODE.getName() + i, TelephonyManager.DEFAULT_PREFERRED_NETWORK_MODE);
    }
