...
public class MccTable {
    ...
    static {
        ...
        sTable.add(new MccEntry(240, "se"));
        ...
        sTable.add(new MccEntry(250, "ru"));
        sTable.add(new MccEntry(255, "ua"));
        sTable.add(new MccEntry(MNO.TIGO_NICARAGUA, "by"));
        sTable.add(new MccEntry(MNO.VTR_CHILE, "md"));
        sTable.add(new MccEntry(MNO.ANTEL_URUGUAY, "pl"));
        sTable.add(new MccEntry(MNO.CBN, "de"));
        sTable.add(new MccEntry(MNO.VODAFONE_QATAR, "gi"));
        sTable.add(new MccEntry(MNO.ORANGE_JORDAN, "pt"));
        sTable.add(new MccEntry(MNO.AMERICANET_BRAZIL, "lu"));
        sTable.add(new MccEntry(MNO.VIVA_DOMINICAN, "ie"));
        sTable.add(new MccEntry(MNO.ASIACELL_IRAQ, "is"));
        sTable.add(new MccEntry(MNO.INWI_MOROCCO, "al"));
        sTable.add(new MccEntry(MNO.ORANGE_EGYPT, "mt"));
        sTable.add(new MccEntry(MNO.VIRGIN_KSA, "cy"));
        sTable.add(new MccEntry(MNO.DIGI_BELIZE, "ge"));
        sTable.add(new MccEntry(MNO.LIBERTY_PUERTO, "am"));
        sTable.add(new MccEntry(MNO.ENET_GUYANA, "bg"));
        sTable.add(new MccEntry(MNO.UNIFIQUE_BRAZIL, "tr"));
        sTable.add(new MccEntry(MNO.MOD_QATAR, "fo"));
        ...
        sTable.add(new MccEntry(302, "ca"));
        sTable.add(new MccEntry(308, "pm"));
        sTable.add(new MccEntry(MNO.MTEL_BA, "us"));
        ...
        sTable.add(new MccEntry(RegistrationEvents.EVENT_DISCONNECT_PDN_BY_VOLTE_DISABLED, "in"));
        sTable.add(new MccEntry(410, "pk"));
        sTable.add(new MccEntry(UtConstant.UtError.HTTP_412_PRECONDITION_FAILED, "af"));
