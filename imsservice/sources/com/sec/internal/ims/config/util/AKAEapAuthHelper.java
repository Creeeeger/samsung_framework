        ...
        if (str.length() > 16) {
            ...
            if (TextUtils.isEmpty(str3) || TextUtils.isEmpty(str4)) {
                if (TextUtils.isEmpty(str4)) {
                    str2 = !TextUtils.isEmpty(str3) ? "autn" : "rand, autn";
                } else {
                    str2 = "rand";
                }
                throw new IllegalArgumentException("it is not possible to obtain " + str2 + " from the akaChallenge argument");
            }
