...
public class CustomizationManager {
    ...
    public static IWorkflow getConfigManager(Looper looper, Context context, ConfigModule configModule, int i, boolean z) {
        ...
        if (autoconfigSourceWithFeature == 3) {
