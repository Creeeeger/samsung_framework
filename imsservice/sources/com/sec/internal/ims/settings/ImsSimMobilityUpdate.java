...
public class ImsSimMobilityUpdate {
    ...
    public ImsProfile overrideImsProfileForSimMobilityUpdateOnDemand(ImsProfile imsProfile, int i) {
        ...
        try {
            ...
            if (imsProfile.getSimMobilityUpdate() == null || imsProfile.getSimMobilityUpdate().length() <= 0) {
                return imsProfile;
            }
    ...
    public JsonElement overrideGlobalSettingsForSimMobilityUpdateOnDemand(JsonElement jsonElement, int i) {
        ...
        try {
            ...
            this.mEventLog.logAndAdd(i, "update SimMobility GlobalSettings: " + asJsonObject.entrySet().stream().map(new SipMsg$$ExternalSyntheticLambda23()).collect(Collectors.toSet()));
            return JsonUtil.merge(jsonElement, asJsonObject);
        } catch (IllegalStateException | JsonParseException | NullPointerException e) {
            Log.e(TAG, "Failed to overrideGlobalSettingsForSimMobilityUpdateOnDemand : " + e);
            return jsonElement;
        }
    }
    ...
    public static boolean isAllowSimMobilityByImsprofile(ImsProfile imsProfile, int i) {
        ...
        IMSLog.i(TAG, i, "isAllowSimMobilityByImsprofile : Profile Name [" + imsProfile.getName() + "]");
    ...
    public static boolean isAllowSimMobilityByImsprofileForRcs(ImsProfile imsProfile, int i) {
        ...
        IMSLog.i(TAG, i, "isAllowSimMobilityByImsprofileForRcs : Profile Name [" + imsProfile.getName() + "]");
        return checkAllowListForSimMobility(split, split2, i);
    }

    public static boolean checkAllowListForSimMobility(String[] strArr, String[] strArr2, int i) {
        final String str = OmcCode.get();
        final String str2 = Mno.getRegionOfDevice().toString();
        String str3 = TAG;
        IMSLog.i(str3, i, "checkAllowListForSimMobility : deviceRegion [" + str2 + "], OMC_CODE [" + str + "]");
        if (Arrays.stream(strArr2).anyMatch(new Predicate() { // from class: com.sec.internal.ims.settings.ImsSimMobilityUpdate$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$checkAllowListForSimMobility$0;
                lambda$checkAllowListForSimMobility$0 = ImsSimMobilityUpdate.lambda$checkAllowListForSimMobility$0(str2, str, (String) obj);
                return lambda$checkAllowListForSimMobility$0;
            }
        })) {
            IMSLog.i(str3, i, "No mobility condition by blockList");
        } else if (Arrays.stream(strArr).anyMatch(new Predicate() { // from class: com.sec.internal.ims.settings.ImsSimMobilityUpdate$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$checkAllowListForSimMobility$1;
                lambda$checkAllowListForSimMobility$1 = ImsSimMobilityUpdate.lambda$checkAllowListForSimMobility$1(str2, str, (String) obj);
                return lambda$checkAllowListForSimMobility$1;
            }
        })) {
