...
public class ImsServiceSwitch {
    ...
    protected void dumpServiceSwitch() {
        ...
        sb.append((String) Stream.concat(this.mVolteServiceSwitch.entrySet().stream(), this.mRcsServiceSwitch.entrySet().stream()).map(new Function() { // from class: com.sec.internal.ims.settings.ImsServiceSwitch$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                String lambda$dumpServiceSwitch$0;
                lambda$dumpServiceSwitch$0 = ImsServiceSwitch.lambda$dumpServiceSwitch$0((Map.Entry) obj);
                return lambda$dumpServiceSwitch$0;
            }
    ...
    protected String getSwitchDump() {
        StringBuilder sb = new StringBuilder();
        sb.append(this.mVoLteEnabled ? "1" : "0");
        sb.append((String) Arrays.stream(ImsProfile.getVoLteServiceList()).map(new Function() { // from class: com.sec.internal.ims.settings.ImsServiceSwitch$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                String lambda$getSwitchDump$1;
                lambda$getSwitchDump$1 = ImsServiceSwitch.this.lambda$getSwitchDump$1((String) obj);
                return lambda$getSwitchDump$1;
            }
        }).collect(Collectors.joining("", "_", ",")));
        sb.append(this.mRcsEnabled ? "1" : "0");
        sb.append((String) Arrays.stream(ImsProfile.getRcsServiceList()).map(new Function() { // from class: com.sec.internal.ims.settings.ImsServiceSwitch$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                String lambda$getSwitchDump$2;
                lambda$getSwitchDump$2 = ImsServiceSwitch.this.lambda$getSwitchDump$2((String) obj);
                return lambda$getSwitchDump$2;
            }
        }).collect(Collectors.joining("", "_", "")));
        return sb.toString();
    }
    ...
    protected void saveImsSwitch(ContentValues contentValues) {
