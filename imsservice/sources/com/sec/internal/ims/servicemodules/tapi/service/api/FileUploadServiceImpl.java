...
public class FileUploadServiceImpl extends IFileUploadService.Stub implements IFileUploadTaskListener, IRegistrationStatusBroadcaster {
    ...
    public IFileUpload uploadFile(Uri uri, boolean z) throws ServerApiException {
        ...
        if (filePathFromUri == null) {
            Log.e(LOG_TAG, "Can't retrieve file path from uri: " + uri);
    ...
    @Override // com.sec.internal.ims.servicemodules.tapi.core.ims.service.upload.IFileUploadTaskListener
    ...
    public boolean isServiceRegistered() throws ServerApiException {
        ...
        return registrationManager != null && registrationManager.getRegistrationInfo().length > 0 && this.mImModule.getImConfig().getFtDefaultMech() == ImConstants.FtMech.HTTP;
    }
