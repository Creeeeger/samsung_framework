...
public final class BlockContactPersisit {
    ...
    public long insertBlockContactInfo(ContactInfo contactInfo, boolean z) {
        ...
        try {
            j = this.db.insert(BLOCKED_CONTACT_TABLE, null, contentValues);
        } catch (SQLException e) {
    ...
    private void notifyChanged(String str) {
        this.mContext.getContentResolver().notifyChange(Uri.parse("content://com.gsma.services.rcs.provider.blockedcontact").buildUpon().appendPath(str).build(), null);
    }
