...
public class IshProvider extends ContentProvider {
    ...
    private final String[] session_columns = {"_id", "sharing_id", ICshConstants.ShareDatabase.KEY_TARGET_CONTACT, "filename", "mime_type", "direction", "filesize", "transferred", "state"};
