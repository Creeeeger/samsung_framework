...
public class VshBinderFuntions extends IVshRemoteClient.Stub {
    private static final String LOG_TAG = VshBinderFuntions.class.getSimpleName();
    ...
    private int open(long j, Surface surface, int i, int i2, int i3, int i4) {
        ...
        this.mServiceModule.setVshVideoDisplay(new VshVideoDisplayParams(session.getSessionId(), vshViewType, videoDisplay, new ICshSuccessCallback() { // from class: com.sec.internal.ims.servicemodules.csh.VshBinderFuntions.1
    ...
    private int close(long j, Surface surface, boolean z) {
        ...
        this.mServiceModule.resetVshVideoDisplay(new VshVideoDisplayParams(session.getSessionId(), vshViewType, videoDisplay, new ICshSuccessCallback() { // from class: com.sec.internal.ims.servicemodules.csh.VshBinderFuntions.2
            @Override // com.sec.internal.ims.servicemodules.csh.event.ICshSuccessCallback
            public void onSuccess() {
            }
