...
public class PresenceIntentReceiver {
    ...
    private static PresenceModule mPresence;
    static BroadcastReceiver mIntentReceiver = new BroadcastReceiver() { // from class: com.sec.internal.ims.servicemodules.presence.PresenceIntentReceiver.1
    ...
    static BroadcastReceiver mSubscribeRetryIntentReceiver = new BroadcastReceiver() { // from class: com.sec.internal.ims.servicemodules.presence.PresenceIntentReceiver.2
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            Log.i(PresenceIntentReceiver.LOG_TAG, "onReceive: " + intent.getAction());
    ...
    IntentFilter getSubscribeRetryIntentFilter() {
        IntentFilter intentFilter = new IntentFilter();
