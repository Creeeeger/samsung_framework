...
public final class ChnStrategy extends DefaultRCSMnoStrategy {
    ...
    public IMnoStrategy.StrategyResponse checkCapability(Set<ImsUri> set, long j, ChatData.ChatType chatType, boolean z) {
        ...
        if (j == Capabilities.FEATURE_FT_SERVICE || j == Capabilities.FEATURE_FT_HTTP) {
    ...
    public RoutingType getMsgRoutingType(ImsUri imsUri, ImsUri imsUri2, ImsUri imsUri3, ImsUri imsUri4, boolean z) {
        String str = TAG;
        IMSLog.s(str, this.mPhoneId, "getMsgRoutingType->requestUri:" + imsUri + ", pAssertedId:" + imsUri2 + ", sender:" + imsUri3 + ", receiver:" + imsUri4 + ", isGroupChat:" + z);
        ...
        IMSLog.i(str, this.mPhoneId, "getMsgRoutingType routingType:" + routingType);
        return routingType;
    }
