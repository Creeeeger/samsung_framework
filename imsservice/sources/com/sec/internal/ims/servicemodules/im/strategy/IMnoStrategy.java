...
public interface IMnoStrategy {
    ...
    Capabilities getCapabilitiesInitialInfo(int i, ImsUri imsUri, String str, String str2, long j, String str3);
    ...
    StatusCode getFtMsrpRetryStrategy(int i, ImError imError, int i2);
    ...
    RcsPolicyType getPolicyType();

    StatusCode getRetryStrategy(int i, ImError imError, int i2, ChatData.ChatType chatType);
    ...
    StrategyResponse handleSendingFtMsrpMessageFailure(ImError imError, int i, int i2, ChatData.ChatType chatType, boolean z);

    StrategyResponse handleSendingMessageFailure(ImError imError, int i, int i2, ChatData.ChatType chatType, boolean z, boolean z2);

    StrategyResponse handleSendingMessageFailure(ImError imError, int i, int i2, ChatData.ChatType chatType, boolean z, boolean z2, boolean z3);

    ImSessionClosedReason handleSessionFailure(ImError imError, boolean z);
    ...
    void setPolicyType(RcsPolicyType rcsPolicyType);
    ...
    public static class HttpStrategyResponse {
        ...
        public HttpStrategyResponse(CancelReason cancelReason, int i) {
