...
class EucSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static class EucSQLiteCursor extends SQLiteCursor {
        ...
        public void close() {
            Log.v(LOG_TAG, "Closing cursor, thread=" + Thread.currentThread().getName());
            super.close();
            close(getDatabase());
        }
    ...
    private static class EucSQLiteCursorFactory implements SQLiteDatabase.CursorFactory {
        ...
        public Cursor newCursor(SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver sQLiteCursorDriver, String str, SQLiteQuery sQLiteQuery) {
            IMSLog.s(LOG_TAG, "newCursor, thread=" + Thread.currentThread().getName() + ", db=" + sQLiteDatabase.getPath());
