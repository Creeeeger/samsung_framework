...
public class ImsModifyRequested extends CallState {
    ...
    public boolean processMessage(Message message) {
        Log.i(this.LOG_TAG, "[ModifyRequested] processMessage " + message.what);
        int i = message.what;
        if (i == 3 || i == 4) {
            return false;
        }
    ...
    private void accept_IdcModifyRequested(IdcExtra idcExtra) {
        Log.i(this.LOG_IDC_FW_TAG, "accept_IdcModifyRequested");
