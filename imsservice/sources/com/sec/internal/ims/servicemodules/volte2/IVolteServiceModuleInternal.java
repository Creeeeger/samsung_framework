...
public interface IVolteServiceModuleInternal {
    ...
    public static final int EVT_AIRPLANE_MODE_CHANGED = 40;
    public static final int EVT_AUDIO_PATH_UPDATED = 39;
    ...
    public static final String LOG_IDC_FW_TAG;
    ...
    default ImsUri getActiveImpu() {
        return null;
    }

    default boolean getAutomaticMode() {
        return false;
    }

    default boolean getAutomaticMode(int i) {
        return false;
    }
    ...
    default ImsRegistration getRegInfo(int i) {
        return null;
    }

    long getRttDbrTimer(int i);

    default int getRttMode() {
        return 0;
    }

    default int getRttMode(int i) {
        return 0;
    }
    ...
    default int getTtyMode() {
        return 0;
    }

    default int getTtyMode(int i) {
        return 0;
    }
    ...
    default boolean isCallBarredBySSAC(int i, int i2) {
        return false;
    }
    ...
    default boolean isEcbmMode(int i) {
        return false;
    }

    default boolean isEmergencyRegistered(int i) {
        return false;
    }
    ...
    default boolean isProhibited(int i) {
        return false;
    }
    ...
    default boolean isRttCall(int i) {
        return false;
    }
    ...
    default void notifyOnCmcRecordingEvent(int i, int i2, int i3, int i4) {
    }

    default void notifyOnCmcRelayEvent(int i, int i2, int i3) {
    }

    void notifyOnIncomingCall(int i, int i2);

    default void notifyOnPulling(int i, int i2) {
    }

    default void onCallEnded(int i, int i2, int i3) {
    }
    ...
    default void setRttMode(int i) {
    }

    default void setRttMode(int i, int i2) {
    }
    ...
    static {
        ...
        NAME = simpleName;
        LOG_TAG = simpleName;
        LOG_IDC_FW_TAG = "[IDC][FW]" + simpleName;
    }
}
