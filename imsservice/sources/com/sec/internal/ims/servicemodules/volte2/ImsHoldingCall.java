...
public class ImsHoldingCall extends CallState {
                        ...
                        if (i == 3) {
                            ...
                            switch (i) {
                                ...
                                case 63:
                                    ...
                                    CallStateMachine callStateMachine32 = this.mCsm;
                                    callStateMachine32.transitionTo(callStateMachine32.mHeldCall);
                                    break;
                                default:
    ...
    private void error_HoldingCall(Message message) {
        ...
        if (sipError.getCode() == 491 && this.mModule.getTotalCallCount(this.mSession.getPhoneId()) > 1) {
        ...
        CallStateMachine callStateMachine3 = this.mCsm;
        if (callStateMachine3.mHoldBeforeTransfer) {
            callStateMachine3.notifyOnError(1119, "call transfer failed (" + message.arg1 + ")");
            this.mCsm.mHoldBeforeTransfer = false;
        } else {
            callStateMachine3.notifyOnError(NSDSNamespaces.NSDSResponseCode.ERROR_SERVER_ERROR, "Call hold failed");
        }
