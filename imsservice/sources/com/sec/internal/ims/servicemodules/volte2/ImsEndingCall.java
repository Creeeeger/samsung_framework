...
public class ImsEndingCall extends CallState {
    ...
    public void enter() {
        ...
        Log.i(this.LOG_TAG, "Enter [EndingCall], errorCode=" + this.mCsm.errorCode);
    ...
    private void ended_EndingCall(Message message) {
        ...
        if (callStateMachine.mCameraUsedAtOtherApp) {
            ...
            callStateMachine.sendMessageDelayed(3, 500L);
            return;
        }
        ...
        if (callStateMachine.mConfCallAdded) {
            ...
            if ((this.mMno.isChn() || this.mMno.isKor() || this.mMno.isJpn()) && this.mModule.getSessionCount() == 2) {
                ...
                if (foregroundSession != null) {
                    ...
                    Log.i(this.LOG_TAG, "setRemoteVideoCapa() : " + callProfile.getModifyHeader());
    ...
    private void error_EndingCall(Message message) {
        ...
        Log.i(this.LOG_TAG, "[EndingCall] err: " + sipError.getCode() + ", errorCode: " + this.mCsm.errorCode);
        CallStateMachine callStateMachine = this.mCsm;
    ...
    protected void handleCallLoggingOnEndingCall() {
        ...
        IMSLog.lazer(lazer_type, this.mSession.getCallId() + " - SIP REASON : " + this.mSession.getErrorMessage() + "(" + this.mSession.getErrorCode() + ")");
        IMSLog.lazer(lazer_type, this.mSession.getCallId() + " - INTERNAL REASON : " + this.mCsm.lazerErrorMessage + "(" + this.mCsm.lazerErrorCode + ")");
        if (this.mSession.getEndType() == 3) {
            IMSLog.lazer(lazer_type, this.mSession.getCallId() + " - LOCAL RELEASE");
        }
    }
