...
public class SsacInfo {
    ...
    SsacInfo(BarringInfo barringInfo) {
        ...
        Log.i(LOG_TAG, "voiceBarringInfo mConditionalBarringFactor:" + barringServiceInfo.getConditionalBarringFactor() + " mConditionalBarringTimeSeconds:" + barringServiceInfo.getConditionalBarringTimeSeconds());
        Log.i(LOG_TAG, "videoBarringInfo mConditionalBarringFactor:" + barringServiceInfo2.getConditionalBarringFactor() + " mConditionalBarringTimeSeconds:" + barringServiceInfo2.getConditionalBarringTimeSeconds());
        ...
        this.mKnownVideoBarringType = barringType2 == 1 || barringType2 == 2;
    }
