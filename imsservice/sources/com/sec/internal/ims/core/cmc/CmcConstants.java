...
public class CmcConstants {
    ...
    static {
        ...
        SHIP_BUILD = equals;
        IS_TEST_MODE = (equals || !TestConstants.TEST_MODE || TextUtils.isEmpty(TestConstants.TEST_LINEID) || TextUtils.isEmpty(TestConstants.TEST_PD_DEVICEID) || TextUtils.isEmpty(TestConstants.TEST_SD_DEVICEID)) ? false : true;
    }
    ...
    public static class SA {
        ...
        static {
            TOKEN_DEFAULT = CmcConstants.IS_TEST_MODE ? TestConstants.TEST_ACCESS_TOKEN : "default_token";
        }
    }
    ...
    public static class TestConstants {
        ...
        public static final String TEST_LINEID;
        public static final boolean TEST_MODE;
        public static final String TEST_PD_DEVICEID;
        public static final String TEST_SD_DEVICEID;

        static {
            TEST_MODE = SemSystemProperties.getInt("persist.cmc.testmode", 0) == 1;
            TEST_LINEID = SemSystemProperties.get("persist.cmc.lineid", "");
            TEST_PD_DEVICEID = SemSystemProperties.get("persist.cmc.pd_deviceid", "");
            TEST_SD_DEVICEID = SemSystemProperties.get("persist.cmc.sd_deviceid", "");
        }
    }
}
