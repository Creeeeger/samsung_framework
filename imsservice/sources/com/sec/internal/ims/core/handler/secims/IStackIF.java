...
public interface IStackIF {
    ...
    void answerCall(int i, int i2, int i3, String str, String str2);
    ...
    void enableQuantumSecurityService(int i, boolean z);
    ...
    void makeCall(int i, String str, String str2, int i2, String str3, String str4, String str5, int i3, AdditionalContents additionalContents, String str6, String str7, HashMap<String, String> hashMap, String str8, boolean z, List<String> list, int i4, Bundle bundle, String str9, int i5, String str10, Message message);
    ...
    void progressIncomingCall(int i, int i2, boolean z, HashMap<String, String> hashMap, String str, Message message);
    ...
    void register(int i, String str, int i2, int i3, List<String> list, List<String> list2, Capabilities capabilities, List<String> list3, String str2, String str3, boolean z, String str4, boolean z2, Message message);
    ...
    void replyWithIdc(int i, int i2, int i3, int i4, String str);
    ...
    void sendDtmfEvent(int i, int i2, String str);

    void sendEmergencyLocationPublish(int i);
    ...
    void sendSignDigestResponse(int i, String str);

    void sendSms(int i, String str, String str2, String str3, String str4, String str5, String str6, boolean z, Message message);
    ...
    void sendVcsInfo(int i, int i2, AdditionalContents additionalContents);

    void setPreferredImpu(int i, String str);

    void setQuantumSecurityInfo(int i, int i2, int i3, String str, String str2);

    void setVideoCrtAudio(int i, int i2, boolean z);

    void setVowifi5gsaMode(int i, int i2);
    ...
    void updateCmcHotspotState(int i, List<String> list);
    ...
    void updatePani(int i, List<String> list, Message message);
    ...
    void updateWithIdc(int i, int i2, String str);
}
