...
public final class ReqMsg {
    ...
    public static final byte request_accept_slm = 57;
    public static final byte request_accept_transfer_call = 20;
    public static final byte request_alarm_wake_up = 110;
    ...
    public static final byte request_clear_all_call_internal = 116;
    ...
    public static final byte request_emergency_location_publish = 122;
    public static final byte request_enable_quantum_security_service = 75;
    ...
    public static final byte request_handle_cmc_csfb = 93;
    public static final byte request_handle_dtmf = 97;
    ...
    public static final byte request_ish_accept_session = 95;
    public static final byte request_ish_start_session = 94;
    public static final byte request_ish_stop_session = 96;
    ...
    public static final byte request_ntp_time_offset = 113;
    public static final byte request_open_sip_dialog = 106;
    public static final byte request_options_cap_exchange = 81;
    public static final byte request_options_send_cmc_check_msg = 82;
    public static final byte request_options_send_error_response = 80;
    public static final byte request_options_send_response = 79;
    ...
    public static final byte request_reject_slm = 58;
    ...
    public static final byte request_rtp_stats_to_stack = 104;
    public static final byte request_send_cmc_info = 72;
    public static final byte request_send_dm_state = 121;
    public static final byte request_send_dtmf_event = 120;
    ...
    public static final byte request_send_media_event = 77;
    public static final byte request_send_message_revoke_request = 103;
    public static final byte request_send_msg = 33;
    public static final byte request_send_negotiated_local_sdp = 125;
    public static final byte request_send_relay_event = 78;
    public static final byte request_send_rp_ack_resp = 34;
    public static final byte request_send_sip = 105;
    public static final byte request_send_slm_file = 50;
    public static final byte request_send_text = 98;
    public static final byte request_send_vcs_info = 73;
    public static final byte request_set_own_capabilities = 61;
    public static final byte request_set_preferred_impu = 6;
    public static final byte request_set_quantum_security_info = 74;
    public static final byte request_set_text_mode = 9;
    public static final byte request_set_video_crt_audio = 119;
    public static final byte request_set_vowifi_5gsa_mode = 118;
    public static final byte request_silent_log_enabled = 112;
    public static final byte request_start_camera = 66;
    public static final byte request_start_cmc_record = 117;
    public static final byte request_start_ft_session = 46;
    public static final byte request_start_im_session = 39;
    public static final byte request_start_local_ring_back_tone = 107;
    public static final byte request_start_media = 42;
    public static final byte request_start_record = 114;
    public static final byte request_start_video_earlymedia = 92;
    public static final byte request_stop_camera = 67;
    public static final byte request_stop_local_ring_back_tone = 108;
    public static final byte request_stop_record = 115;
    ...
    public static final byte request_update_airplane_mode = 124;
    ...
    public static final byte request_update_cmc_ext_call_count = 76;
    public static final byte request_update_cmc_hotspot_state = 126;
    ...
    public static final byte request_update_geolocation = 91;
    public static final byte request_update_nr_sa_mode_on_start = 123;
    public static final byte request_update_pani = 68;
    public static final byte request_update_participants = 54;
    public static final byte request_update_rat = 83;
    public static final byte request_update_sign_digest_response = Byte.MAX_VALUE;
    public static final byte request_update_sim_info = 109;
    public static final byte request_update_srvcc_version = 10;
    public static final byte request_update_time_in_plani = 84;
    public static final byte request_update_vce_config = 102;
    public static final byte request_update_xq_enable = 11;
    public static final byte request_vsh_accept_session = 100;
    public static final byte request_vsh_start_session = 99;
    public static final byte request_vsh_stop_session = 101;
    public static final byte request_x509_cert_verify_result = 111;
    public static final byte request_xdm_fetch_document = 88;
    public static final byte request_xdm_update_aka_resp = 86;
    public static final byte request_xdm_update_gba_data = 85;
    public static final byte request_xdm_update_gba_key = 87;
    public static final byte request_xdm_upload_contacts = 90;
    public static final byte request_xdm_upload_pres_rules = 89;
