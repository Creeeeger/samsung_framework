...
public final class FeatureTag {
    ...
    public static final int CANCEL_MESSAGE = 47;
    ...
    public static final int CHATBOT_ROLE = 53;
    public static final int CHATBOT_STANDALONE_MSG = 45;
    public static final int CHATBOT_VERSION = 54;
    public static final int CHAT_CPM = 12;
    public static final int CLOUD_FILE = 32;
    public static final int CPIMEXT = 56;
    public static final int DATACHANNEL = 57;
    ...
    public static final int SRVCC = 51;
    ...
    public static final String[] names = {"IPCALL", "IPCALL_VIDEO", "IPCALL_VIDEO_ONLY", "VSH", CloudMessageProviderContract.DataTypes.SMS, "MMTEL_AUDIO", "MMTEL_VIDEO", "CDPN", "CDMALESS", "MMTEL", "STANDALONE_MSG", "DEFERRED_CPM", "CHAT_CPM", "FT_CPM", "CALL_COMPOSER", "SHARED_MAP", "POST_CALL", "SHARED_SKETCH", "ISH", "PRESENCE_DISCOVERY", CloudMessageProviderContract.DataTypes.CHAT, "SF_GROUP_CHAT", "FT", "FT_THUMBNAIL", "FT_STORE", "FT_HTTP", "VSH_OUTSIDE_CALL", "INTEGRATED_MSG", "SOCIAL_PRESENCE", "GEOLOCATION_PULL", "GEOLOCATION_PULL_FT", "GEOLOCATION_PUSH", "CLOUD_FILE", "FT_HTTP_EXTRA", "BURN_MSG", "VEMOTICON", "GROUP_MANAGEMENT", "STICKER", "FT_VIA_SMS", "GEO_VIA_SMS", "MSG_REVOKE", "CARD_MSG", "PUBLIC_MSG", "LAST_SEEN_ACTIVE", "CHATBOT_CHAT_SESSION", "CHATBOT_STANDALONE_MSG", "EXTENDED_BOT_MSG", "CANCEL_MESSAGE", "PLUG_IN", "RCS_TELEPHONY_VOLTE", "RCS_TELEPHONY_CS", "SRVCC", "TEXT", "CHATBOT_ROLE", "CHATBOT_VERSION", "MMTEL_CALL_COMPOSER", "CPIMEXT", "DATACHANNEL"};
