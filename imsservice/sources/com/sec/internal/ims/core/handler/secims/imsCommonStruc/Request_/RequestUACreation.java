...
public final class RequestUACreation extends Table {
    ...
    public long subscriberTimer() {
        if (__offset(MNO.TANGO_LUXEMBOURG) != 0) {
            return this.bb.getInt(r0 + this.bb_pos) & 4294967295L;
        }
        return 0L;
    }
    ...
    public CmcConfig cmcConfig() {
        return cmcConfig(new CmcConfig());
    }

    public CmcConfig cmcConfig(CmcConfig cmcConfig) {
        int __offset = __offset(MNO.VIRGIN_KSA);
        if (__offset != 0) {
            return cmcConfig.__assign(__indirect(__offset + this.bb_pos), this.bb);
        }
        return null;
    }
    ...
    public long vowifi5gsaMode() {
        if (__offset(MNO.UNIFIQUE_BRAZIL) != 0) {
            return this.bb.getInt(r0 + this.bb_pos) & 4294967295L;
        }
        return 0L;
    }
    ...
    public boolean isUpdateSaOnStartSupported() {
        int __offset = __offset(308);
        return (__offset == 0 || this.bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public boolean isUpdateSaOnAirplaneModeSupported() {
        int __offset = __offset(MNO.MTEL_BA);
        return (__offset == 0 || this.bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public boolean supportDatachannelWithFeatureCaps() {
    ...
    public boolean signDigestResponseEnabled() {
        int __offset = __offset(316);
        return (__offset == 0 || this.bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public boolean isRcsAsJibe() {
        int __offset = __offset(318);
        return (__offset == 0 || this.bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public static void startRequestUACreation(FlatBufferBuilder flatBufferBuilder) {
        flatBufferBuilder.startObject(MNO.STC_KSA);
    }
    ...
    public static void addNetId(FlatBufferBuilder flatBufferBuilder, long j) {
        flatBufferBuilder.addLong(66, j, 0L);
    }
    ...
    public static void addEnableVerstat(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(123, z, false);
    }
    ...
    public static void addRegRetryMaxTime(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addInt(125, i, 0);
    }
    ...
    public static void addTryReregisterFromKeepalive(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(128, z, false);
    }
    ...
    public static void addAcb(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addOffset(132, i, 0);
    }
    ...
    public static void addUse200offerWhenRemoteNotSupport100rel(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(136, z, false);
    }

    public static void addMediaConfig(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addOffset(137, i, 0);
    }

    public static void addCmcConfig(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addOffset(138, i, 0);
    }
    ...
    public static void addKeepAliveFactor(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addInt(146, i, 0);
    }
    ...
    public static void addUacSipList(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addOffset(MNO.SBERBANK_RUSSIA, i, 0);
    }
    ...
    public static void addImpuPreference(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addInt(151, i, 0);
    }

    public static void addIsUpdateSaOnStartSupported(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(152, z, false);
    }

    public static void addIsUpdateSaOnAirplaneModeSupported(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(153, z, false);
    }

    public static void addSupportDatachannelWithFeatureCaps(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(154, z, false);
    }

    public static void addSupportB2cCallcomposerWithoutFeaturetag(FlatBufferBuilder flatBufferBuilder, int i) {
        flatBufferBuilder.addInt(155, i, 0);
    }

    public static void addSignDigestResponseEnabled(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(MNO.TANGO_LUXEMBOURG, z, false);
    }

    public static void addIsRcsAsJibe(FlatBufferBuilder flatBufferBuilder, boolean z) {
        flatBufferBuilder.addBoolean(157, z, false);
    }
