...
class NetworkIdentifier {
    ...
    static class Builder {
        private static final List<String> LAB_SIM = Arrays.asList("00101", "001001", "001010", "00101f", "99999");
        private String mGid1;
        ...
        void setNext(XmlPullParser xmlPullParser) throws IOException, XmlPullParserException {
            ...
            if ("SPCode".equalsIgnoreCase(name)) {
        ...
        public String toString() {
            return String.format(Locale.US, "mccmnc: %s, networkName: %s, subset: %s, gid1: %s, spname: %s", this.mMccMnc, this.mNetworkName, this.mSubset, this.mGid1, this.mSpName);
        }
    }
    ...
    public int hashCode() {
        return Objects.hash(this.mMccMnc, this.mMnoName, this.mGid1, this.mGid2, this.mSubset, this.mSpName);
    }
