...
public class RegistrationGovernorSpr extends RegistrationGovernorBase {
    ...
    private final int LOCATION_REQUEST_TIMEOUT;
    protected IGeolocationController mGeolocationCon;
    protected BroadcastReceiver mIntentReceiverSPR;
    protected Message mLocationTimeoutMessage;
    protected int mPrevVolteUIDefault;
    ...
    public RegistrationGovernorSpr(RegistrationManagerInternal registrationManagerInternal, ITelephonyManager iTelephonyManager, RegisterTask registerTask, PdnController pdnController, IVolteServiceModule iVolteServiceModule, IConfigModule iConfigModule, Context context) {
        ...
        this.LOCATION_REQUEST_TIMEOUT = 45000;
        this.mLocationTimeoutMessage = null;
        this.mPrevVolteUIDefault = -1;
        this.mIntentReceiverSPR = new BroadcastReceiver() { // from class: com.sec.internal.ims.core.RegistrationGovernorSpr.1
    ...
    public Set<String> filterService(Set<String> set, int i) {
        ...
        if (!RcsUtils.DualRcs.isRegAllowed(this.mContext, this.mPhoneId)) {
            for (String str : ImsProfile.getRcsServiceList()) {
                removeService(applyMmtelUserSettings, str, "No DualRcs");
            }
        }
        return applyMmtelUserSettings;
    }

    protected boolean isVoWiFiPrefered(boolean z) {
        return !z ? VowifiConfig.getPrefMode(this.mContext, 1, this.mPhoneId) == 1 : VowifiConfig.getRoamPrefMode(this.mContext, 1, this.mPhoneId) == 1;
    }
    ...
    public SipError onSipError(String str, SipError sipError) {
        ...
        if ("mmtel".equals(str)) {
            ...
            if (code >= 400 && code <= 699) {
                ...
                this.mRegMan.deregister(this.mTask, false, true, 3000, code + " error");
    ...
    public boolean isLocationInfoLoaded(int i) {
        ...
        if (iGeolocationController != null) {
            ...
            if (this.mGeolocationCon.isLocationServiceEnabled()) {
    ...
    protected void startLocTimeoutTimer() {
        if (this.mLocationTimeoutMessage != null) {
            ...
            this.mLocationTimeoutMessage = this.mRegHandler.startLocationRequestTimer(this.mTask, 45000L);
        }
    }

    protected void stopLocTimeoutTimer() {
    ...
    public void onConfigUpdated() {
        ...
        IMSLog.i(LOG_TAG, this.mPhoneId, "isVoltePrefChangedFromApp: Changed by user [" + isUserToggledVoiceCallType + "]");
    ...
    protected Set<String> applyMmtelUserSettings(Set<String> set, int i) {
        ...
        if (i != 18) {
            ...
            if (this.mTelephonyManager.getCallState() == 0 && !isVoWiFiPrefered(this.mTelephonyManager.isNetworkRoaming())) {
                ...
                IMSLog.i(LOG_TAG, this.mPhoneId, "filterService: voiceRat [" + i2 + "] voiceInSvc [" + z + "] PsOnlyReg [" + z2 + "]");
                if (z && i2 != 0 && (i2 != 13 || !z2)) {
