...
public class IpcMessage {
    ...
    public static IpcMessage parseIpc(byte[] bArr, int i) {
        ...
        try {
            ...
            IilIpcMessage iilIpcMessage = readByte3 != 112 ? null : new IilIpcMessage();
    ...
    public boolean encodeGeneralResponse(int i, IpcMessage ipcMessage) {
        ...
        if ((i < 32768 || i > 32782) && ((i < 34049 || i > 34303) && i != 33298)) {
            IMSLog.e(LOG_TAG, "encodeGeneralResponse(): ipcErrorCause is out of range with value ( " + String.format("%04X ", Integer.valueOf(i)) + " ), but keep going. ");
