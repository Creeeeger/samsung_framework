...
public class AECStorage {
    ...
    public AECStorage(Context context, int i, String str) {
        ...
        this.mPhoneId = i;
        this.mSharedPreference = String.format(AECNamespace.Template.AEC_RESULT, Integer.valueOf(i));
    ...
    public void setDefaultValues(String str) {
        ...
        setStringValue(AECNamespace.Path.VOLTE_ENTITLEMENT_STATUS, equalsIgnoreCase ? "1" : "0");
        setStringValue(AECNamespace.Path.VOWIFI_ENTITLEMENT_STATUS, equalsIgnoreCase ? "1" : "0");
        if (equalsIgnoreCase) {
        ...
        setStringValue(AECNamespace.Path.SMSOIP_ENTITLEMENT_STATUS, equalsIgnoreCase ? "1" : "0");
    }
    ...
    protected int getVoWiFiActivationMode(int i, int i2, int i3, int i4) {
        if (getVersion() >= 0 && i != 2) {
            ...
            if (i == 1 && ((i2 == 1 || i2 == 2) && ((i3 == 1 || i3 == 2) && (i4 == 1 || i4 == 2)))) {
                return 3;
            }
        }
        return 0;
    ...
    public String getEntitlementVersion() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "1.0" : map.getOrDefault("entitlement_version", "1.0");
    }

    public String getEntitlementDomain() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "" : map.getOrDefault(AECNamespace.ProviderSettings.ENTITLEMENT_DOMAIN, "");
    }

    public String getEntitlementPort() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "" : map.getOrDefault(AECNamespace.ProviderSettings.ENTITLEMENT_PORT, "");
    }

    public String getEntitlementPath() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "" : map.getOrDefault(AECNamespace.ProviderSettings.ENTITLEMENT_PATH, "");
    }
    ...
    public String getNotifSenderId() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "" : map.getOrDefault(AECNamespace.ProviderSettings.NOTIF_SENDER_ID, "");
    }
    ...
    public String getNotifAction() {
        ...
        return "0".equals(orDefault) ? "" : orDefault;
    }
    ...
    public boolean isSupportOnlyVoWiFibyUserAction() {
        return (this.mProviderSettings == null || !getEntitlementForVoWiFi() || getEntitlementForVoLte() || !getEntitlementInitFromApp() || getVoWiFiAutoOn()) ? false : true;
    }

    protected String getDefaultEntitlement() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? AECNamespace.DefVal.ENTITLEMENT_STATUS : map.getOrDefault(AECNamespace.ProviderSettings.DEFAULT_ENTITLEMENT_STATUS, AECNamespace.DefVal.ENTITLEMENT_STATUS);
    }

    protected boolean getVoLTEAutoOn() {
        Map<String, String> map = this.mProviderSettings;
        if (map == null) {
            return false;
        }
    ...
    protected boolean getVoWiFiAutoOn() {
        Map<String, String> map = this.mProviderSettings;
        if (map == null) {
            return false;
        }
    ...
    protected String getServerVendor() {
        Map<String, String> map = this.mProviderSettings;
        return map == null ? "" : map.getOrDefault(AECNamespace.ProviderSettings.SERVER_VENDOR, "");
    }
}
