...
public class HttpStore {
    ...
    public void setUserAgent(String str) {
        this.mUserAgent = String.format(AECNamespace.Template.USER_AGENT, str, AECNamespace.Build.TERMINAL_VENDOR, AECNamespace.Build.TERMINAL_SW_VERSION, AECNamespace.Build.ANDROID_OS_VERSION);
    }
