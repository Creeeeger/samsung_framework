...
public class ATTCmStrategy extends DefaultCloudMessageStrategy {
    private final String ATT_API_VERSION;
    private final String ATT_STORE_NAME;
    ...
    ATTCmStrategy(MessageStoreClient messageStoreClient) {
        ...
        this.LOG_TAG = ATTCmStrategy.class.getSimpleName();
        this.ATT_API_VERSION = "v1";
        this.ATT_STORE_NAME = "base";
    ...
    public int getAdaptedRetrySchedule(int i) {
        ...
        if (i != 0) {
            return (i == 1 || i == 2 || i == 3 || i == 4) ? (((int) Math.floor(intValue * (ImsUtil.getRandom().nextFloat() + 1.0f))) / 1000) * 1000 : intValue;
        }
    ...
    private void initProvisionFailedCallFlowTranslator() {
        ...
        arrayList.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, id, provisionEventType2.getId(), null));
        ...
        arrayList.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, provisionEventType3.getId(), provisionEventType2.getId(), null));
        ArrayList arrayList2 = new ArrayList();
        this.mFailedCallFlowTranslator.put(ReqToken.class, arrayList2);
        arrayList2.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, provisionEventType3.getId(), provisionEventType2.getId(), null));
        arrayList2.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_ATS_TOKEN.getId(), provisionEventType2.getId(), null));
        ArrayList arrayList3 = new ArrayList();
        ...
        arrayList3.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, provisionEventType4.getId(), provisionEventType2.getId(), null));
        arrayList3.add(new ErrorRule(ATTConstants.ATTErrorNames.ERROR_CODE_201, retryAttribute2, provisionEventType3.getId(), provisionEventType2.getId(), null));
        arrayList3.add(new ErrorRule(ATTConstants.ATTErrorNames.ERROR_CODE_202, retryAttribute2, provisionEventType3.getId(), provisionEventType2.getId(), null));
        arrayList3.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, provisionEventType4.getId(), provisionEventType2.getId(), null));
        ArrayList arrayList4 = new ArrayList();
        ...
        arrayList4.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_CPS_DEFAULT, retryAttribute2, id2, provisionEventType5.getId(), null));
        EnumProvision.ProvisionEventType provisionEventType6 = EnumProvision.ProvisionEventType.CPS_PROVISION_SHUTDOWN;
        arrayList4.add(new ErrorRule(ATTConstants.ATTErrorNames.CPS_PROVISION_SHUTDOWN, retryAttribute, -1, provisionEventType6.getId(), errorMsg2));
        arrayList4.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_ACCOUNT_NOT_ELIGIBLE, retryAttribute, -1, EnumProvision.ProvisionEventType.ACCOUNT_NOT_ELIGIBLE.getId(), errorMsg2));
        EnumProvision.ProvisionEventType provisionEventType7 = EnumProvision.ProvisionEventType.REQ_ACCOUNT_ELIGIBILITY;
        arrayList4.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, provisionEventType7.getId(), provisionEventType5.getId(), null));
        ArrayList arrayList5 = new ArrayList();
        this.mFailedCallFlowTranslator.put(RequestAccount.class, arrayList5);
        ErrorMsg errorMsg3 = new ErrorMsg(errorType, 0);
        arrayList5.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_CPS_DEFAULT, retryAttribute2, provisionEventType4.getId(), provisionEventType5.getId(), null));
        arrayList5.add(new ErrorRule(ATTConstants.ATTErrorNames.CPS_PROVISION_SHUTDOWN, retryAttribute, -1, provisionEventType6.getId(), errorMsg3));
        arrayList5.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, provisionEventType4.getId(), provisionEventType5.getId(), null));
        arrayList5.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_SERVICE_ACCOUNT.getId(), provisionEventType5.getId(), null));
        ArrayList arrayList6 = new ArrayList();
        ...
        arrayList6.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_ENCORE_METASWITCH_ACCOUNT_NOT_PROVISIONED, retryAttribute2, id3, provisionEventType8.getId(), null));
        arrayList6.add(new ErrorRule(ATTConstants.ATTErrorNames.LAST_RETRY_CREATE_ACCOUNT, retryAttribute2, EnumProvision.ProvisionEventType.LAST_RETRY_CREATE_ACCOUNT.getId(), provisionEventType8.getId(), null));
        arrayList6.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_HUI_JSON, retryAttribute2, provisionEventType4.getId(), provisionEventType8.getId(), null));
        arrayList6.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, provisionEventType4.getId(), provisionEventType8.getId(), null));
        arrayList6.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_HUI_TOKEN.getId(), provisionEventType8.getId(), null));
        ArrayList arrayList7 = new ArrayList();
        this.mFailedCallFlowTranslator.put(RequestTC.class, arrayList7);
        arrayList7.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_CPS_DEFAULT, retryAttribute2, provisionEventType4.getId(), provisionEventType5.getId(), null));
        arrayList7.add(new ErrorRule(ATTConstants.ATTErrorNames.CPS_PROVISION_SHUTDOWN, retryAttribute, provisionEventType6.getId(), -1, null));
        EnumProvision.ProvisionEventType provisionEventType9 = EnumProvision.ProvisionEventType.REQ_GET_TC;
        arrayList7.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, provisionEventType9.getId(), provisionEventType5.getId(), null));
        ArrayList arrayList8 = new ArrayList();
        this.mFailedCallFlowTranslator.put(RequestCreateAccount.class, arrayList8);
        arrayList8.add(new ErrorRule(ATTConstants.ATTErrorNames.CPS_TC_ERROR_1007, retryAttribute2, provisionEventType9.getId(), provisionEventType5.getId(), null));
        arrayList8.add(new ErrorRule(ATTConstants.ATTErrorNames.CPS_TC_ERROR_1008, retryAttribute2, provisionEventType9.getId(), provisionEventType5.getId(), null));
        arrayList8.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_CPS_DEFAULT, retryAttribute2, provisionEventType4.getId(), provisionEventType5.getId(), null));
        arrayList8.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_CREATE_ACCOUNT.getId(), provisionEventType5.getId(), null));
        ...
        arrayList9.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, ordinal, provisionEventType10.getId(), null));
        arrayList9.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_DELETE_ACCOUNT.getId(), provisionEventType10.getId(), null));
        ArrayList arrayList10 = new ArrayList();
        this.mFailedCallFlowTranslator.put(RequestPat.class, arrayList10);
        arrayList10.add(new ErrorRule(CommonErrorName.DEFAULT_ERROR_TYPE, retryAttribute2, provisionEventType4.ordinal(), provisionEventType5.getId(), null));
        arrayList10.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_SESSION_ID, retryAttribute2, provisionEventType4.getId(), provisionEventType5.getId(), null));
        arrayList10.add(new ErrorRule(ATTConstants.ATTErrorNames.ERR_RETRY_AFTER, retryAttribute3, EnumProvision.ProvisionEventType.REQ_PAT.getId(), provisionEventType5.getId(), null));
    ...
    public String getNmsHost() {
        if (ATTGlobalVariables.isGcmReplacePolling()) {
            ...
            Log.d(this.LOG_TAG, "use host for gcm, NMS Host value=" + nmsHost);
    ...
    public String getNcHost() {
        if (ATTGlobalVariables.isGcmReplacePolling()) {
            ...
            Log.d(this.LOG_TAG, "NC Host value=" + ncHost);
            return ncHost;
        }
