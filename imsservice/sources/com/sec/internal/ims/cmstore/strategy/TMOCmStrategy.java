...
public class TMOCmStrategy extends DefaultCloudMessageStrategy {
    ...
    private boolean mPendingRequestVVMNotified;
    ...
    TMOCmStrategy(MessageStoreClient messageStoreClient) {
        ...
        this.TAG = TMOCmStrategy.class.getSimpleName();
        this.MSTORE_API_VERSION = "v1";
        this.MSTORE_STORE_NAME = "ums";
        this.MSTORE_SERVERROOT = "";
        this.WSG_URI = "";
    ...
    public long getTimerValue(int i) {
        if (this.mScheduledTimer.containsKey(Integer.valueOf(i))) {
            return this.mScheduledTimer.get(Integer.valueOf(i)).intValue();
        }
    ...
    public int getTypeUsingMessageContext(String str) {
        Log.d(this.TAG, "getTypeUsingMessageContext value: " + str);
    ...
    protected boolean isCarrierStrategyDiffFromCommonRuleByCode(IAPICallFlowListener iAPICallFlowListener, IHttpAPICommonInterface iHttpAPICommonInterface, int i) {
        ...
        Log.i(this.TAG, "API[" + iHttpAPICommonInterface.getClass().getSimpleName() + "], 401, CREDENTIAL_EXPIRED");
        iAPICallFlowListener.onFailedEvent(OMASyncEventType.CREDENTIAL_EXPIRED.getId(), null);
        return true;
    }
