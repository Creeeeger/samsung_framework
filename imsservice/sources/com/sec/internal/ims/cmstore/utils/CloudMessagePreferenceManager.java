...
public class CloudMessagePreferenceManager {
    ...
    public void removeKey(String str) {
        IMSLog.s(this.TAG, "remove key: " + str);
        SharedPreferences.Editor prefEditor = getPrefEditor();
    ...
    public void saveKeyStringValue(String str, String str2) {
        IMSLog.s(this.TAG, "save key: " + str + ",value: " + str2);
        SharedPreferences.Editor prefEditor = getPrefEditor();
    ...
    private void saveKeyIntegerValue(String str, int i) {
        IMSLog.s(this.TAG, "save key: " + str + ",value: " + i);
        SharedPreferences.Editor prefEditor = getPrefEditor();
    ...
    private void saveKeyBooleanValue(String str, boolean z) {
        IMSLog.s(this.TAG, "save key: " + str + ",value: " + z);
        SharedPreferences.Editor prefEditor = getPrefEditor();
    ...
    private void saveKeyLongValue(String str, long j) {
        IMSLog.s(this.TAG, "save key: " + str + ",value: " + j);
        SharedPreferences.Editor prefEditor = getPrefEditor();
    ...
    public String getOasisAuthRoot() {
        ...
        return !McsConstants.Auth.ROOT_URL.equals(keyStringValueOfUserDebug) ? keyStringValueOfUserDebug : McsConstants.Auth.ROOT_URL;
    }
    ...
    public long getMcsAccessTokenExpireTime() {
        return getKeyLongValue(McsConstants.McsSharedPref.PREF_ACCESS_TOKEN_EXPIRE_TIME, 0L);
    }
    ...
    public long getMcsRefreshTokenExpireTime() {
        return getKeyLongValue(McsConstants.McsSharedPref.PREF_REFRESH_TOKEN_EXPIRE_TIME, 0L);
    }
    ...
    public void saveCmsDataTtl(int i) {
        ...
        EventLogHelper.infoLogAndAddWoPhoneId(this.TAG, this.mPhoneID, "cmsDataTtl: " + i);
        if (i <= 0) {
    ...
    public void setForceInitFullSync(boolean z) {
        saveKeyBooleanValue(McsConstants.McsSharedPref.FORCE_INIT_FULL_SYNC, z);
    }

    public boolean isForceInitFullSync() {
        return getKeyBooleanValue(McsConstants.McsSharedPref.FORCE_INIT_FULL_SYNC, false);
    }
    ...
    public void saveMmsRevokeTtlSecs(int i) {
        ...
        EventLogHelper.infoLogAndAddWoPhoneId(this.TAG, this.mPhoneID, "mmsRevokeTtlSecs: " + i);
        if (i <= 0) {
            i = 86400;
        }
    ...
    public void saveSmsRevokeTtlSecs(int i) {
        ...
        EventLogHelper.infoLogAndAddWoPhoneId(this.TAG, this.mPhoneID, "smsRevokeTtlSecs: " + i);
        if (i <= 0) {
            i = 86400;
        }
    ...
    public void saveSimImsi(String str) {
        if (TextUtils.isEmpty(str)) {
            EventLogHelper.infoLogAndAddWoPhoneId(this.TAG, this.mPhoneID, "saveSimImsi is empty");
        } else {
    ...
    public void saveUserCtn(String str, boolean z) {
        if (TextUtils.isEmpty(str)) {
            EventLogHelper.infoLogAndAddWoPhoneId(this.TAG, this.mPhoneID, "saveUserCtn is empty");
        } else {
    ...
    public String getUserTelCtn() {
        ImsUri normalizedTelUri;
        String userCtn = getUserCtn();
        return (TextUtils.isEmpty(userCtn) || (normalizedTelUri = Util.getNormalizedTelUri(userCtn, Util.getSimCountryCode(this.mContext, this.mPhoneID))) == null) ? "" : normalizedTelUri.toString();
    }
    ...
    public boolean hasUserDeleteAccount() {
        ...
        Log.i(this.TAG, "hasUserDeleteAccount: " + keyBooleanValue);
    ...
    public String getAtsToken() {
        ...
        Log.i(this.TAG, "atsToken: " + keyStringValue);
    ...
    public String getValidPAT() {
        String keyStringValue = getKeyStringValue(PAT, null);
    ...
    public void saveAMBSStopService(boolean z) {
        Log.i(this.TAG, "saveAMBSStopService :" + z);
    ...
    public boolean getAMBSStopService() {
        ...
        Log.i(this.TAG, "getAMBSStopService :" + keyBooleanValue);
        return keyBooleanValue;
    }

    public void saveAMBSPauseService(boolean z) {
        Log.i(this.TAG, "saveAMBSPauseService :" + z);
    ...
    public boolean getAMBSPauseService() {
        ...
        Log.i(this.TAG, "getAMBSPauseService :" + keyBooleanValue);
        return keyBooleanValue;
    }
    ...
    public long getOMASubscriptionIndex() {
        return getKeyLongValue(OMA_SUBSCRIPTION_INDEX, 0L);
    }
    ...
    public String getOMASSubscriptionRestartToken() {
        return getKeyStringValue(OMA_SUBSCIRPTION_RESTART_TOKEN, null);
    }
    ...
    public long getOMASubscriptionTime() {
        return getKeyLongValue(OMA_SUBSCIRPTION_TIME, 0L);
    }
    ...
    public long getOMAChannelLifeTime() {
        return getKeyLongValue(OMA_CHANNEL_LIFETIME, 0L);
    }
    ...
    public long getOMAChannelCreateTime() {
        return getKeyLongValue(OMA_CHANNEL_CREATE_TIME, 0L);
    }
    ...
    public String getGcmTokenFromVsim() {
        ...
        String str = null;
        try {
            query = this.mContext.getContentResolver().query(Uri.parse("content://com.samsung.ims.nsds.provider/devices/push_token"), null, null, null, null);
        } catch (SQLException | IllegalArgumentException e) {
            Log.e(this.TAG, "!!!Could not get data from db " + e.toString());
        }
        if (query == null) {
            if (query != null) {
                query.close();
    ...
    public long getNetworkAvailableTime() {
        return getKeyLongValue(NETWORK_OK_TIME, -1L);
    }

    public void saveMigrateSuccessFlag(boolean z) {
        Log.d(this.TAG, "saveMigrateSuccess is " + z);
    ...
    public void initUserDebug() {
        ...
        Log.i(this.TAG, "debug preference :" + z);
        if (z) {
        ...
        IMSLog.s(this.TAG, "appId=" + ATTGlobalVariables.APP_ID + ", cpsHostName=" + ATTGlobalVariables.CPS_HOST_NAME + ", authHostName=" + ATTGlobalVariables.ACMS_HOST_NAME + ", ncHostName=" + ATTGlobalVariables.DEFAULT_PRODUCT_NC_HOST + "timeLine=" + DebugFlag.debugRetryTimeLine + ", mcsUrl=" + DebugFlag.DEBUG_MCS_URL + ", oasisVersion=" + DebugFlag.DEBUG_OASIS_VERSION);
    }

    public void saveUserDebug() {
        SharedPreferences sharedPreferences = mUserDebugPreference;
        if (sharedPreferences == null) {
            IMSLog.s(this.TAG, "mUserDebugPreference is null failed to save, debug:" + DebugFlag.DEBUG_RETRY_TIMELINE_FLAG);
            return;
        }
        SharedPreferences.Editor edit = sharedPreferences.edit();
