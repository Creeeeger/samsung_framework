...
public class ReSyncParam {
    ...
    public static void update(MessageStoreClient messageStoreClient) {
        ...
        Log.i(TAG, "ReSyncParam: mRestartToken:: " + IMSLog.checker(mRestartToken) + ",ReSyncParam: mNotifyURL:: " + IMSLog.checker(mNotifyURL) + ",ReSyncParam: mChannelURL:: " + IMSLog.checker(mChannelURL) + ",ReSyncParam: mChannelResUrl:: " + IMSLog.checker(mChannelResUrl));
    }
