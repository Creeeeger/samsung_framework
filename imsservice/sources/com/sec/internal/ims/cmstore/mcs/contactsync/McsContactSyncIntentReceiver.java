...
public class McsContactSyncIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (("android.intent.action.PACKAGE_ADDED".equals(intent.getAction()) || "android.intent.action.PACKAGE_DATA_CLEARED".equals(intent.getAction())) && McsContactSyncConstants.Packages.CS_PACKAGE_NAME.equals(intent.getData().getSchemeSpecificPart())) {
            EventLogHelper.infoLogAndAdd(this.LOG_TAG, this.mPhoneId, "onReceive: " + intent.getAction());
