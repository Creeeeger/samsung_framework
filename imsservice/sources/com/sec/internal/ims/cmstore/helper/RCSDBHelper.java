...
public class RCSDBHelper {
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        Log.d(TAG, "query uri=" + IMSLog.checker(uri.toString()) + " projections:" + Arrays.toString(strArr) + " whereClaus: " + str + " selectionArgs: " + Arrays.toString(strArr2) + " sortOrder: " + str2);
        try {
    ...
    public int update(Uri uri, ContentValues contentValues, String str, String[] strArr) {
        try {
            ...
            Log.i(TAG, "update success rowsupdated: " + update);
            return update;
        } catch (SQLiteException e) {
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        try {
            ...
            Log.i(TAG, "update success rowsupdated: " + delete);
            return delete;
        } catch (SQLiteException e) {
