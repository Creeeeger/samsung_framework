...
public class ParamOMAObject {
    ...
    public String DISPOSITION_ORIGINAL_MESSAGEID;
    public String DISPOSITION_ORIGINAL_TO;
    public String DISPOSITION_STATUS;
    public String EXTENDEDRCS;
    public String FROM;
    public String IMPORTANCE;
    public boolean IS_CPM_GROUP;
    ...
    private CloudMessageBufferDBConstants.ActionStatusFlag getCloudActionPerFlag(FlagList flagList) {
        ...
        Log.i(this.TAG, "getCloudActionPerFlag: " + Arrays.toString(flagList.flag));
        int i = 0;
    ...
    private Map<String, NotificationStatus> getCloudActionPerImdn(ImdnList imdnList) {
        ...
        for (ImdnObject imdnObject : imdnList.imdn) {
            ...
            while (true) {
                ...
                if ("displayed".equalsIgnoreCase(imdnInfoArr[i].type)) {
    ...
    public ParamOMAObject(Object object, boolean z, int i, ICloudMessageManagerHelper iCloudMessageManagerHelper, MessageStoreClient messageStoreClient) {
        int i2;
        this.TAG = ParamOMAObject.class.getSimpleName();
        ...
        this.PARTICIPATING_DEVICE = null;
        this.X_CNS_Greeting_Type = null;
        this.DISPOSITION_STATUS = null;
        this.DISPOSITION_ORIGINAL_MESSAGEID = null;
        this.DISPOSITION_ORIGINAL_TO = null;
        this.IS_OPEN_GROUP = false;
        this.IS_CPM_GROUP = false;
        this.MULTIPARTCONTENTTYPE = null;
        this.CONTENT_TYPE = null;
        this.MESSAGE_ID = null;
        this.IMPORTANCE = null;
        this.SENSITIVITY = null;
        this.P_ASSERTED_SERVICE = null;
        this.MESSAGEBODY = null;
        this.EXTENDEDRCS = null;
        this.CHIPLIST = null;
        this.TRAFFICTYPE = null;
        this.SAFE_MESSAGE = 0;
        this.mLine = null;
        this.mReassembled = false;
        this.mIsFromChangedObj = false;
        this.mFlagList = null;
        this.sFlags = null;
        this.mRawFromString = null;
    ...
    private Set<ImsUri> getNormalizedParticipantsExcludeOwn() {
        ...
        while (it.hasNext()) {
            ...
            IMSLog.i(this.TAG, "getNormalizedParticipantsExcludeOwn uri: " + IMSLog.numberChecker(next) + ", value: " + IMSLog.numberChecker(parse));
            if (parse != null) {
                hashSet.add(parse);
            }
        }
    ...
    private int getMessageContextType(String str) {
        Log.d(this.TAG, "getMessageContextType: " + str);
    ...
    public ParamOMAObject(ChangedObject changedObject, boolean z, int i, String str, MessageStoreClient messageStoreClient) {
        ...
        this.mReassembled = str2 != null && CloudMessageProviderContract.JsonData.TRUE.equalsIgnoreCase(str2);
    ...
    public String toString() {
        return "OMAConvertedObjectParam [mObjectType=" + this.mObjectType + ", mLine= " + IMSLog.checker(this.mLine) + ", correlationId= " + this.correlationId + ", correlationTag=" + this.correlationTag + ", resourceURL=" + IMSLog.checker(this.resourceURL) + ", mFlag=" + this.mFlag + " , mFlagList = " + Arrays.toString(this.sFlags) + ", DISPOSITION_STATUS=" + this.DISPOSITION_STATUS + ", mIsGoforwardSync=" + this.mIsGoforwardSync + ", TEXT_CONTENT=" + IMSLog.checker(this.TEXT_CONTENT) + ", DIRECTION=" + this.DIRECTION + ", DATE=" + this.DATE + ", MESSAGE_ID=" + this.MESSAGE_ID + ", CONTENT_TYPE=" + this.CONTENT_TYPE + ", X_CNS_Greeting_Type=" + this.X_CNS_Greeting_Type + ", mReassembled=" + this.mReassembled + ", mIsFromChangeObj=" + this.mIsFromChangedObj + " mNomalizedOtherParticipants=" + IMSLog.numberChecker(this.mNomalizedOtherParticipants) + ", SUBJECT=" + this.SUBJECT + ", IS_CPM_GROUP=" + this.IS_CPM_GROUP + ", IS_OPEN_GROUP=" + this.IS_OPEN_GROUP + ", Importance= " + this.IMPORTANCE + ", SENSITIVITY=" + this.SENSITIVITY + ", protocol=" + this.protocol + "]";
    }
}
