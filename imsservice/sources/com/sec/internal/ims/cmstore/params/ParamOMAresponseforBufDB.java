...
public class ParamOMAresponseforBufDB {
    ...
    private List<BodyPart> mAllPayloads;
    private BufferDBChangeParam mBufferDbParam;
    private BufferDBChangeParamList mBufferDbParamList;
    private BulkResponseList mBulkResponseList;
    private byte[] mDataString;
    private String mFilePath;
    private boolean mIsFullSync;
    private String mLine;
    private NmsEventList mMcsNmsEventList;
    private NotificationList[] mNotificaitonList;
    private OMASyncEventType mOMASyncEventType;
    ...
    private SyncMsgType mType;
    private VvmFolders mVvmFolders;
    private VvmServiceProfile mVvmServiceProfile;
