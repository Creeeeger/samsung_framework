...
public class CloudMessageRCSStorageAdapter {
    ...
    public Cursor queryAllSession() {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/session"), null, null, null, null);
    }

    public Cursor queryAllSession(String[] strArr) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/session"), strArr, null, null, null);
    }
    ...
    public Cursor queryAllSessionWithIMSI(String str) {
        ...
        return this.mRCSDBHelper.query(parse, null, "sim_imsi=?", new String[]{str}, null);
    }

    public Cursor queryAllMessage() {
        Uri parse = Uri.parse("content://com.samsung.rcs.im/message");
        Log.d(LOG_TAG, "queryAllMessage");
        return this.mRCSDBHelper.query(parse, null, null, null, null);
    }

    public Cursor queryAllMessage(String[] strArr) {
        Uri parse = Uri.parse("content://com.samsung.rcs.im/message");
        Log.d(LOG_TAG, "queryAllMessage");
        return this.mRCSDBHelper.query(parse, strArr, null, null, null);
    }

    public Cursor queryIMFTUsingChatId(String str) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudquerymessagechatid/" + str), null, null, null, null);
    }

    public Cursor queryParticipantsUsingChatId(String str) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudqueryparticipant/" + str), null, null, null, null);
    }
    ...
    public Cursor queryNotificationUsingImdn(String str) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/messagenotifications/" + str), null, null, null, null);
    }

    public Cursor queryIMFTUsingRowId(long j) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudquerymessagerowid/" + j), null, null, null, null);
    }

    public Cursor queryRcsDBMessageUsingImdnId(String str) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudquerymessageimdnid/" + str), null, null, null, null);
    }
    ...
    public Cursor querySessionUsingId(int i) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudquerysessionid/" + i), null, null, null, null);
    }

    public Cursor querySessionUsingChatId(String str) {
        return this.mRCSDBHelper.query(Uri.parse("content://com.samsung.rcs.im/cloudquerysessionchatid/" + str), null, null, null, null);
    }
    ...
    public void insertSystemUserMessage(ContentValues contentValues) {
        this.mRCSDBHelper.insert(Uri.parse("content://com.samsung.rcs.im/cloudmakenewsystemusermessage"), contentValues);
    }
}
