...
public class NSDSResponseHandler extends Handler {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            case NSDSNamespaces.NSDSResponseCode.ERROR_MAX_SERVICE_REACHED /* 1040 */:
                                return "ERROR_MAX_SERVICE_REACHED";
                            case NSDSNamespaces.NSDSResponseCode.ERROR_INVALID_FINGERPRINT /* 1041 */:
                                return "ERROR_INVALID_FINGERPRINT";
                            case 1042:
                                return "ERROR_INVALID_TARGET_DEVICEID";
                            case 1043:
                                return "ERROR_INVALID_TARGET_USER";
                            case NSDSNamespaces.NSDSResponseCode.ERROR_MAX_SERVICE_INSTANCE_REACHED /* 1044 */:
                                return "ERROR_MAX_SERVICE_INSTANCE_REACHED";
                            case 1045:
                                return "ERROR_COPY_FORBIDDEN";
                            case NSDSNamespaces.NSDSResponseCode.ERROR_INVALID_SERVICE_NAME /* 1046 */:
    ...
    private Bundle parseHttpErrorResponse(HttpResponseParams httpResponseParams) {
        IMSLog.i(LOG_TAG, "parseHttpErrorResponse: status code " + httpResponseParams.getStatusCode());
