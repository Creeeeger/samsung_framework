...
public class SIMDeviceDeactivationFlow extends NSDSAppFlowBase implements ISIMDeviceDeactivation {
    ...
    @Override // com.sec.internal.interfaces.ims.entitlement.nsds.ISIMDeviceDeactivation
    ...
    private void handleResponseDeactivation(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            if (responseManageConnectivity != null) {
                ...
                if (i2 == 1000) {
                    IMSLog.i(LOG_TAG, "ResponseManageConnectivity content : messageId: " + responseManageConnectivity.messageId + ", responseCode: " + responseManageConnectivity.responseCode);
                    z = true;
                } else {
                    i = i2;
                }
    ...
    private void performDeactivation(int i) {
        mDeactivateCause = i;
        IMSLog.i(LOG_TAG, "deactivateDevice: deactivationCause" + i);
    ...
    protected void notifyNSDSFlowResponse(boolean z, String str, int i, int i2) {
        IMSLog.i(LOG_TAG, "notifyNSDSFlowResponse: success " + z + " errorcode " + i2);
