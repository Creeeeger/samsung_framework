...
public class AkaTokenRetrievalFlow extends NSDSAppFlowBase implements IAkaTokenRetrievalFlow {
    ...
    protected NSDSAppFlowBase.NSDSResponseStatus handleAkaTokenRetrievalResponse(Bundle bundle) {
    ...
    @Override // com.sec.internal.interfaces.ims.entitlement.nsds.IAkaTokenRetrievalFlow
    ...
    protected void queueOperation(int i, Bundle bundle) {
        Log.i(LOG_TAG, "queueOperation: " + i);
        int i2 = i != 15 ? -1 : 1;
        if (i2 != -1) {
    ...
    private void startAkaTokenretrieval() {
        ...
        new RetrieveAkaToken(getLooper(), this.mContext, this.mBaseFlowImpl, new Messenger(this), "1.0").retrieveAkaToken(null, null, mnoNsdsStrategy != null ? mnoNsdsStrategy.getRetryInterval() : 0L);
    }
    ...
    public void handleMessage(Message message) {
        Log.i(LOG_TAG, "msg:" + message.what);
        int i = message.what;
        if (i == 1) {
            ...
            performNextOperationIf(15, handleAkaTokenRetrievalResponse(message.getData()), null);
        }
    }
