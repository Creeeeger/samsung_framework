...
public class NSDSContentProvider extends ContentProvider {
    ...
    private static final String LOG_TAG = NSDSContentProvider.class.getSimpleName();
    ...
    protected static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
            IMSLog.i(NSDSContentProvider.LOG_TAG, "onUpgrade: oldVersion " + i + " newVersion " + i2);
            if (i2 == 2 && i == 1) {
        ...
        public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
            IMSLog.i(NSDSContentProvider.LOG_TAG, "onDowngrade: oldVersion " + i + " newVersion " + i2);
        }
    }
    ...
    */
    public int delete(android.net.Uri r7, java.lang.String r8, java.lang.String[] r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.internal.ims.entitlement.nsds.ericssonnsds.persist.NSDSContentProvider.delete(android.net.Uri, java.lang.String, java.lang.String[]):int");
    }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(asString)) {
                    try {
                        ...
                        IMSLog.s(LOG_TAG, "Lines resource package not found: " + asString + e.getMessage());
                    }
                }
                ...
                if (resourceName == null) {
                    ...
                    IMSLog.e(LOG_TAG, "Color resource is null, removing: " + asInteger + " from values");
                }
                Integer asInteger2 = contentValues.getAsInteger("icon");
                String resourceName2 = getResourceName(resources, "drawable", asInteger2);
                if (resourceName2 == null) {
                    IMSLog.e(LOG_TAG, "Icon resource is null, removing: " + asInteger2 + " from values");
                ...
                if (resourceName == null && resourceName2 == null) {
                    ...
                    IMSLog.e(LOG_TAG, "Both color and icon resource are null, removing: " + asString + " from values");
                }
                j = writableDatabase.insert(LINES_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e2) {
                IMSLog.s(LOG_TAG, "Could not insert into LINES:" + e2.getMessage());
            }
            return j;
        } finally {
    ...
    private long insertIntoDevices(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert(DEVICES_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into DEVICES table:" + e.getMessage());
            }
            return j;
        } finally {
            writableDatabase.endTransaction();
    ...
    private long insertIntoAccounts(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert(ACCOUNTS_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into DEVICES table:" + e.getMessage());
            }
    ...
    private long insertIntoServices(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert("services", null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into SERVICES table:" + e.getMessage());
            }
            return j;
        } finally {
            writableDatabase.endTransaction();
    ...
    private long insertIntoGcmTokens(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert(GCM_TOKENS_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into GCM Tokens table:" + e.getMessage());
            }
            return j;
        } finally {
            writableDatabase.endTransaction();
    ...
    private int deleteFromServices(String str, String str2) {
        ...
        try {
            try {
                ...
                IMSLog.s(LOG_TAG, "Could not delete from Services table:" + e.getMessage());
            }
            return i;
        } finally {
            writableDatabase.endTransaction();
    ...
    private long insertDeviceConfig(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert("device_config", null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
    ...
    private int updateDeviceConfig(ContentValues contentValues) {
        ...
        try {
            try {
                i = writableDatabase.update("device_config", contentValues, null, null);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
    ...
    private long insertIntoNsdsConfig(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert(NSDS_CONFIG_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into nsds_configs table:" + e.getMessage());
            }
            return j;
        } finally {
            writableDatabase.endTransaction();
    ...
    private long insertIntoSimSwapNsdsConfig(ContentValues contentValues) {
        ...
        try {
            try {
                j = writableDatabase.insert(SIM_SWAP_NSDS_CONFIG_TABLE, null, contentValues);
                writableDatabase.setTransactionSuccessful();
            } catch (SQLiteException e) {
                IMSLog.s(LOG_TAG, "Could not insert into nsds_configs table:" + e.getMessage());
            }
    ...
    private synchronized void connectToNSDSMultiSimService() {
        ...
        ServiceConnection serviceConnection = new ServiceConnection() { // from class: com.sec.internal.ims.entitlement.nsds.ericssonnsds.persist.NSDSContentProvider.1
        ...
        this.mNsdsSvcConn = serviceConnection;
        ContextExt.bindServiceAsUser(this.mContext, intent, serviceConnection, 1, ContextExt.CURRENT_OR_SELF);
    }
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        if (match != 0) {
            ...
            if (match == 29) {
                ...
                return sQLiteQueryBuilder.query(readableDatabase, strArr, str, insertSelectionArg(insertSelectionArg(strArr2, "1"), getDeviceUidFromQueryParam(uri)), null, null, str2);
            }
            if (match == 67) {
            ...
            if (match != 63) {
                switch (match) {
                    ...
                    case 8:
                        ...
                        return sQLiteQueryBuilder.query(readableDatabase, strArr, (TextUtils.isEmpty(str) || !str3.startsWith("_id")) ? str3 : str3.replace("_id", LinesColumns.CONCRETE_ID), insertSelectionArg(insertSelectionArg(strArr2, "1"), getDeviceUidFromQueryParam(uri)), null, null, str2);
                    case 9:
                        sQLiteQueryBuilder.setTables(ACCOUNTS_TABLE);
                        return sQLiteQueryBuilder.query(readableDatabase, strArr, str, strArr2, null, null, str2);
                    default:
                        switch (match) {
                            case 43:
                                ...
                                return sQLiteQueryBuilder.query(readableDatabase, strArr, str, insertSelectionArg(strArr2, uri.getPathSegments().get(1)), null, null, str2);
                            case 44:
                                break;
                            case 45:
                                sQLiteQueryBuilder.setTables(TABLE_JOIN_FOR_ALL_LINES);
                            ...
                            default:
                                switch (match) {
                                    case 70:
                                        ...
                                        sQLiteQueryBuilder.appendWhere(SQL_WHERE_LOCAL_LINES_WITH_SERVICES);
                                        sQLiteQueryBuilder.setProjectionMap(sLineWithServicesProjectionMap);
                                        return sQLiteQueryBuilder.query(readableDatabase, strArr, str, insertSelectionArg(insertSelectionArg(strArr2, "0"), getDeviceUidFromQueryParam(uri)), null, null, str2);
                                    case 71:
                                    ...
                                    case 72:
                                        ...
                                        return sQLiteQueryBuilder.query(readableDatabase, strArr, str, strArr2, null, null, str2);
                                    default:
                                        return queryInternalWithService(readableDatabase, uri);
                                }
                        }
                }
            } else {
        ...
        sQLiteQueryBuilder.setProjectionMap(sLineWithServicesProjectionMap);
        return sQLiteQueryBuilder.query(readableDatabase, strArr, (TextUtils.isEmpty(str) || !str3.startsWith("_id")) ? str3 : str3.replace("_id", LinesColumns.CONCRETE_ID), insertSelectionArg(strArr2, getDeviceUidFromQueryParam(uri)), null, null, str2);
    }

    private int getSlotIdFromUri(Uri uri) {
        try {
            return Integer.parseInt(uri.getQueryParameter("slot"));
    ...
    private int disableActiveAccount(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        contentValues.put(NSDSContractExt.AccountColumns.IS_ACTIVE, (Integer) 0);
    ...
    private void disableLinesAndServices(SQLiteDatabase sQLiteDatabase) {
        ...
        int update = sQLiteDatabase.update(LINES_TABLE, contentValues, null, null);
        String str = LOG_TAG;
        ...
        sQLiteDatabase.delete("services", null, null);
    }
    ...
    private Cursor getDeviceOwnActivationStatus(int i) {
        ...
        String str = isSimSwapPending ? NSDSNamespaces.NSDSDeviceState.ACTIVATION_IN_PROGRESS : NSDSSharedPrefHelper.get(this.mContext, deviceIdIfExists, NSDSNamespaces.NSDSSharedPref.PREF_DEVICE_STATE);
        IMSLog.i(LOG_TAG, "getDeviceState: onSimSwapEvt " + isSimSwapPending + " state " + str);
    ...
    */
    private android.database.Cursor getDeviceConfigElement(android.net.Uri r10) {
        /*
            ...
            boolean r1 = android.text.TextUtils.isEmpty(r10)     // Catch: java.lang.Exception -> L4a
            if (r1 == 0) goto L16
            java.lang.String r9 = com.sec.internal.ims.entitlement.nsds.ericssonnsds.persist.NSDSContentProvider.LOG_TAG     // Catch: java.lang.Exception -> L4a
            java.lang.String r1 = "Empty tag name. Return null"
            com.sec.internal.log.IMSLog.e(r9, r1)     // Catch: java.lang.Exception -> L4a
            return r0
        L16:
            r1 = 1
            java.lang.String[] r4 = new java.lang.String[r1]     // Catch: java.lang.Exception -> L4a
            java.lang.String r1 = "device_config"
            r8 = 0
            r4[r8] = r1     // Catch: java.lang.Exception -> L4a
            android.content.Context r9 = r9.mContext     // Catch: java.lang.Exception -> L4a
            android.content.ContentResolver r2 = r9.getContentResolver()     // Catch: java.lang.Exception -> L4a
            android.net.Uri r3 = com.sec.internal.constants.ims.entitilement.EntitlementConfigContract.DeviceConfig.CONTENT_URI     // Catch: java.lang.Exception -> L4a
            r5 = 0
            r6 = 0
            r7 = 0
            ...
            if (r1 == 0) goto L44
            java.lang.String r0 = r9.getString(r8)     // Catch: java.lang.Throwable -> L3a
            goto L44
        L3a:
            r1 = move-exception
        ...
        L3f:
            r9 = move-exception
            r1.addSuppressed(r9)     // Catch: java.lang.Exception -> L4a
        L43:
        ...
        L4c:
            ...
            r10 = r0
        L4e:
            java.lang.String r1 = com.sec.internal.ims.entitlement.nsds.ericssonnsds.persist.NSDSContentProvider.LOG_TAG
        ...
        L83:
            ...
            goto L83
        L9d:
            java.lang.String r10 = com.sec.internal.ims.entitlement.nsds.ericssonnsds.persist.NSDSContentProvider.LOG_TAG
    ...
    private void updateE911Address(int i) {
        try {
            ...
            IMSLog.s(LOG_TAG, "openLoginPage: failed to open login page" + e.getMessage());
        }
    }
    ...
    private void activateSimDevice(int i) {
        ...
        try {
            ...
            IMSLog.s(LOG_TAG, "activateSIMDevice: failed to activate" + e.getMessage());
        }
    }
    ...
    private void handleVoWiFiToggleOnEvent(int i) {
        ...
        try {
            ...
            IMSLog.s(LOG_TAG, "handleVoWiFiToggleOnEvent: failed to toggle on" + e.getMessage());
        }
    }
    ...
    private void handleVoWiFiToggleOffEvent(int i) {
        ...
        try {
            ...
            IMSLog.s(LOG_TAG, "handleVoWiFiToggleOffEvent: failed to toggle off" + e.getMessage());
        }
    }
    ...
    private void retrieveAkaToken(Uri uri) {
        try {
            ...
            IMSLog.s(LOG_TAG, "retrieveAkaToken: failed to retrieve aka" + e.getMessage());
        }
    }
    ...
    public Cursor getDevicePushToken(Uri uri) {
        ...
        IMSLog.s(LOG_TAG, "getDevicePushToken: " + pushToken);
        return matrixCursor;
    }
    ...
    private int updateCabStatus(SQLiteDatabase sQLiteDatabase, Uri uri, int i) {
        ...
        if (update > 0) {
            IMSLog.i(LOG_TAG, "updateCabStatus: cab status successfully updated for lineId :" + str + " to :" + i);
        }
        return update;
    }
    ...
    private int removeServicesFromLine(Uri uri) {
        ...
        int deleteFromServices = deleteFromServices(str, str2);
        if (deleteFromServices == 0) {
            IMSLog.e(LOG_TAG, "Could not delete services for device Id" + str2);
        }
    ...
    private int updateServicesStatusForLine(Uri uri, boolean z) {
        ...
        for (String str3 : queryParameter.split(" ")) {
            i += updateStatusInServices(str, str2, str3, z ? 1 : 0);
        }
        if (i == 0) {
    ...
    private int updateStatusInServices(String str, String str2, String str3, int i) {
        ...
        try {
            try {
                ...
                IMSLog.s(LOG_TAG, "updateStatusInServices: Could not update Services table:" + e.getMessage());
            }
            return i2;
        } finally {
            writableDatabase.endTransaction();
        ...
        if (num != null) {
            try {
                if (num.intValue() != 0) {
                    ...
                    IMSLog.e(LOG_TAG, "Resource " + num + " (" + resourceEntryName + ") is of type " + resourceTypeName + " but " + str + " is required.");
                    return null;
                }
    ...
    public int bulkInsert(Uri uri, ContentValues[] contentValuesArr) {
        ...
        if (match == 40) {
            ...
            IMSLog.i(LOG_TAG, "None of the Uri's match for bulkInsert:" + uri);
            str = null;
        } else {
        ...
        if (str != null && (databaseHelper = this.mDatabaseHelper) != null) {
            ...
            try {
                ...
                while (i < length) {
                    if (writableDatabase.insertOrThrow(str, null, contentValuesArr[i]) <= 0) {
