...
public class RetrieveAkaToken extends NSDSBaseProcedure {
    ...
    public NSDSRequest[] buildRequests(NSDSCommonParameters nSDSCommonParameters) {
        return new NSDSRequest[]{this.mBaseFlowImpl.getNSDSClient().buildAuthenticationRequest(new AtomicInteger().incrementAndGet(), true, nSDSCommonParameters.getChallengeResponse(), nSDSCommonParameters.getAkaToken(), null, nSDSCommonParameters.getImsiEap(), nSDSCommonParameters.getDeviceId())};
    }
