...
public class P2pUtils {
    ...
    public static boolean isWifiConnected(Context context) {
        ...
        return (context == null || !((WifiManager) context.getSystemService("wifi")).isWifiEnabled() || (localIpAddress = getLocalIpAddress(context)) == null || localIpAddress.isEmpty()) ? false : true;
    }
