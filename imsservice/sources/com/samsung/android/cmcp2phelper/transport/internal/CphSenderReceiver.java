...
public class CphSenderReceiver implements Runnable {
    ...
    protected void handleReceivedMessage(CphMessage cphMessage) {
        ...
        if (cphMessage.getMsgType() == 1) {
            if (this.mLocalBindingIP.equalsIgnoreCase(cphMessage.getResponderIP())) {
                ...
                Log.d(LOG_TAG, "local binding ip(" + this.mLocalBindingIP + ") equals with response ip(" + cphMessage.getResponderIP() + "), DO NOT NEED TO RESPONSE");
                return;
            }
