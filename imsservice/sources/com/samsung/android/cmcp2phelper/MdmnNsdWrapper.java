...
public class MdmnNsdWrapper {
    ...
    private final ConnectivityManager.NetworkCallback wifiNetworkStateListener = new ConnectivityManager.NetworkCallback() { // from class: com.samsung.android.cmcp2phelper.MdmnNsdWrapper.1
