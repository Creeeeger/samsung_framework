...
public interface ISehChannelCallback extends IHwInterface {
    ...
    public static abstract class Stub extends HwBinder implements ISehChannelCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList("vendor.samsung.hardware.radio.channel@2.0::ISehChannelCallback", "android.hidl.base@1.0::IBase"));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{27, -119, -42, -91, 77, 80, 14, -37, ReqMsg.request_xdm_update_aka_resp, ReqMsg.request_alarm_wake_up, ReqMsg.request_update_cmc_hotspot_state, 48, 44, 36, -108, -61, -81, -114, -57, -36, 32, -118, 55, -98, -106, 49, 76, 78, 37, 53, 46, -113}, new byte[]{-20, ReqMsg.request_update_sign_digest_response, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, ReqMsg.request_send_sip, ReqMsg.request_xdm_update_gba_key, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
