.class public final Lcom/android/systemui/volume/view/VolumeSeekBar;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/android/systemui/volume/view/VolumeSeekBar$Companion;
    ...
    .line 4
    invoke-direct {v0, v1}, Lcom/android/systemui/volume/view/VolumeSeekBar$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->storeInteractor:Lcom/android/systemui/volume/store/StoreInteractor;

    const/4 p1, -0x1

    .line 3
    iput p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->stream:I

    const/4 p1, 0x1

    .line 4
    iput-boolean p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->enabled:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->storeInteractor:Lcom/android/systemui/volume/store/StoreInteractor;

    const/4 p2, -0x1

    .line 7
    iput p2, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->stream:I

    const/4 p2, 0x1

    .line 8
    iput-boolean p2, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->enabled:Z
    ...
    iput p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->scaledTouchSlop:F
    ...
    invoke-direct {p1, p0}, Lcom/android/systemui/volume/view/VolumeSeekBar$VolumeSeekbarChangeListener;-><init>(Lcom/android/systemui/volume/view/VolumeSeekBar;)V
...
.method public final onChanged(Ljava/lang/Object;)V
    ...
    .line 7
    sget-object v0, Lcom/android/systemui/volume/view/VolumeSeekBar$WhenMappings;->$EnumSwitchMapping$0:[I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    iget-boolean v0, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->enabled:Z
    ...
    .line 31
    iget v0, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->touchedX:F
    ...
    .line 34
    iget-boolean v0, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->isTracking:Z
    ...
    .line 37
    .line 38
    invoke-virtual {p0, p1}, Lcom/android/systemui/volume/view/VolumeSeekBar;->trackTouchEvent(F)V
    ...
    .line 46
    iget v3, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->scaledTouchSlop:F
    ...
    .line 54
    .line 55
    iget-object p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->storeInteractor:Lcom/android/systemui/volume/store/StoreInteractor;
    ...
    .line 78
    :cond_4
    iput-boolean v2, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->isTracking:Z

    .line 79
    .line 80
    iget-object p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->seekbarChangeListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
    ...
    .line 114
    iput p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->touchedX:F
    ...
    .line 120
    iput p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->currentProgress:I
...
.method public final setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->seekbarChangeListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
...
.method public final trackTouchEvent(F)V
    ...
    .line 11
    :cond_0
    iput-boolean v1, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->isTracking:Z
    ...
    .line 40
    iget v0, p0, Lcom/android/systemui/volume/view/VolumeSeekBar;->currentProgress:I
