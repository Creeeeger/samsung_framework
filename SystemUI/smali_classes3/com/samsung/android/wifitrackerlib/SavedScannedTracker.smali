.class public Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;
...
# direct methods
.method public constructor <init>(Landroidx/lifecycle/Lifecycle;Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/ConnectivityManager;Landroid/os/Handler;Landroid/os/Handler;Ljava/time/Clock;JJLcom/samsung/android/wifitrackerlib/SavedScannedTracker$SavedScannedTrackerCallback;)V
    .locals 14
    ...
    invoke-direct/range {v0 .. v13}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;-><init>(Lcom/android/wifitrackerlib/WifiTrackerInjector;Landroidx/lifecycle/Lifecycle;Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/ConnectivityManager;Landroid/os/Handler;Landroid/os/Handler;Ljava/time/Clock;JJLcom/samsung/android/wifitrackerlib/SavedScannedTracker$SavedScannedTrackerCallback;)V
...
.method public final conditionallyUpdateScanResults(Z)V
    ...
    .line 14
    invoke-virtual {p0, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updateStandardWifiEntryScans(Ljava/util/List;)V
    ...
    .line 21
    invoke-virtual {p0, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updatePasspointWifiEntryScans(Ljava/util/List;)V
...
.method public final handleConfiguredNetworksChangedAction(Landroid/content/Intent;)V
    ...
    .line 12
    invoke-virtual {p0, v0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updateStandardWifiEntryConfigs(Ljava/util/List;)V
    ...
    .line 19
    invoke-virtual {p0, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updatePasspointWifiEntryConfigs(Ljava/util/List;)V

    .line 20
    .line 21
    .line 22
    invoke-virtual {p0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updateWifiEntries()V
...
.method public final handleNetworkCapabilitiesChanged(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->getAllWifiEntries()Ljava/util/List;
...
.method public final handleOnStart()V
    ...
    .line 17
    invoke-virtual {p0, v1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updateStandardWifiEntryConfigs(Ljava/util/List;)V
    ...
    .line 24
    invoke-virtual {p0, v1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->updatePasspointWifiEntryConfigs(Ljava/util/List;)V
    ...
    .line 37
    invoke-virtual {p0, v1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->conditionallyUpdateScanResults(Z)V
    ...
    .line 71
    invoke-virtual {p0, v1, v0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->handleNetworkCapabilitiesChanged(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    .line 79
    .line 80
    invoke-virtual {p0, v1, v0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->handleLinkPropertiesChanged(Landroid/net/Network;Landroid/net/LinkProperties;)V
...
.method public final handleScanResultsAvailableAction(Landroid/content/Intent;)V
    ...
    .line 13
    invoke-virtual {p0, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->conditionallyUpdateScanResults(Z)V
...
.method public final handleWifiStateChangedAction()V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->conditionallyUpdateScanResults(Z)V
...
.method public final updatePasspointWifiEntryConfigs(Ljava/util/List;)V
    ...
    .line 13
    invoke-direct {v0, v1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda0;-><init>(I)V
    ...
    .line 38
    new-instance v2, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda2;
    ...
    .line 41
    invoke-direct {v2, v3, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda2;-><init>(ILjava/util/Map;)V
...
.method public final updateStandardWifiEntryConfigs(Ljava/util/List;)V
    ...
    .line 11
    .line 12
    invoke-direct {v0}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda3;-><init>()V
    ...
    .line 34
    .line 35
    new-instance v0, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda2;
    ...
    .line 38
    invoke-direct {v0, v1, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda2;-><init>(ILjava/util/Map;)V
...
.method public final updateStandardWifiEntryScans(Ljava/util/List;)V
    ...
    .line 25
    .line 26
    new-instance v0, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda1;

    .line 27
    .line 28
    invoke-direct {v0, p1}, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker$$ExternalSyntheticLambda1;-><init>(Ljava/util/Map;)V
...
.method public final updateWifiEntries()V
    ...
    .line 113
    .line 114
    iget-object p0, p0, Lcom/samsung/android/wifitrackerlib/SavedScannedTracker;->mSubscriptionWifiEntries:Ljava/util/List;
