...
public abstract class DelayKt {
    ...
    */
    ...
    public static final Object m2580delayVtjQ1oo(long j, Continuation continuation) {
        Duration.Companion.getClass();
        long j2 = 0;
        if (Duration.m2574compareToLRDsOJo(j, 0L) > 0) {
            j2 = Duration.m2575getInWholeMillisecondsimpl(j);
            if (j2 < 1) {
                j2 = 1;
            }
        }
