...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromDreamingTransitionInteractor$listenForDreamingToDozing$1", f = "FromDreamingTransitionInteractor.kt", l = {132}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class FromDreamingTransitionInteractor$listenForDreamingToDozing$1 extends SuspendLambda implements Function2 {
    int label;
    ...
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3 {
        ...
        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return new Pair((DozeTransitionModel) obj, (KeyguardState) obj2);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((FromDreamingTransitionInteractor$listenForDreamingToDozing$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i != 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromDreamingTransitionInteractor$listenForDreamingToDozing$1.3
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    if (dozeTransitionModel.to == DozeStateModel.DOZE && keyguardState2 == (keyguardState = KeyguardState.DREAMING)) {
                        ...
                        KeyguardState keyguardState3 = KeyguardState.DOZING;
                        ...
                        ((KeyguardTransitionRepositoryImpl) keyguardTransitionRepository).startTransition(new TransitionInfo(fromDreamingTransitionInteractor3.name, keyguardState, keyguardState3, valueAnimator), false);
                    }
