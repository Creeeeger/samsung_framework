...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$5", f = "KeyguardTransitionAuditLogger.kt", l = {64}, m = "invokeSuspend")
...
final class KeyguardTransitionAuditLogger$start$5 extends SuspendLambda implements Function2 {
    ...
    public KeyguardTransitionAuditLogger$start$5(KeyguardTransitionAuditLogger keyguardTransitionAuditLogger, Continuation<? super KeyguardTransitionAuditLogger$start$5> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            Flow flow = keyguardTransitionAuditLogger.keyguardInteractor.isAbleToDream;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$5.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    KeyguardTransitionAuditLogger.this.logger.log(KeyguardTransitionAuditLoggerKt.TAG, LogLevel.VERBOSE, "isAbleToDream", Boolean.valueOf(((Boolean) obj2).booleanValue()));
