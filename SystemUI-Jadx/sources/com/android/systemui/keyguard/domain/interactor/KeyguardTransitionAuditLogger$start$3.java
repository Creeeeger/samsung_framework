...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$3", f = "KeyguardTransitionAuditLogger.kt", l = {54}, m = "invokeSuspend")
...
final class KeyguardTransitionAuditLogger$start$3 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((KeyguardTransitionAuditLogger$start$3) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            StateFlow stateFlow = keyguardTransitionAuditLogger.keyguardInteractor.alternateBouncerShowing;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$3.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    KeyguardTransitionAuditLogger.this.logger.log(KeyguardTransitionAuditLoggerKt.TAG, LogLevel.VERBOSE, "Alternate bouncer showing", Boolean.valueOf(((Boolean) obj2).booleanValue()));
