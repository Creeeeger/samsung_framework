...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1", f = "FromOccludedTransitionInteractor.kt", l = {180}, m = "invokeSuspend")
...
final class FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1 extends SuspendLambda implements Function2 {
    ...
    /* compiled from: qb/87000731 7862a37e62df4d72b2921859baacdc80ea0c935793521606c8e11db53cc87e4f */
    /* renamed from: com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1$2, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1(FromOccludedTransitionInteractor fromOccludedTransitionInteractor, Continuation<? super FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            SafeFlow sample = FlowKt.sample(fromOccludedTransitionInteractor.keyguardInteractor.alternateBouncerShowing, fromOccludedTransitionInteractor.keyguardTransitionInteractor.startedKeyguardTransitionStep, AnonymousClass2.INSTANCE);
            final FromOccludedTransitionInteractor fromOccludedTransitionInteractor2 = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToAlternateBouncer$1.3
