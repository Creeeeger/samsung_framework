...
public final class KeyguardBottomAreaViewModel$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            if (((KeyguardBottomAreaViewModel.PreviewMode) this.L$1).isInPreviewMode) {
                distinctUntilChanged = new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(new Float(1.0f));
            } else {
                distinctUntilChanged = FlowKt.distinctUntilChanged(this.this$0.bottomAreaInteractor.alpha);
            }
            this.label = 1;
