...
public final class SinVerificationCodeParser extends VerificationCodeParserBase {
    ...
    public final String getVerificationCode(String str) {
        ...
        return VerificationCodeParserBase.getVerificationCode(context, str, context.getResources().getStringArray(R.array.verification_code_strong_sin), context.getResources().getStringArray(R.array.verification_code_weak_sin));
    }
}
