...
public final class MymVerificationCodeParser extends VerificationCodeParserBase {
    ...
    public final String getVerificationCode(String str) {
        ...
        return VerificationCodeParserBase.getVerificationCode(context, str, context.getResources().getStringArray(R.array.verification_code_strong_mym), context.getResources().getStringArray(R.array.verification_code_weak_mym));
    }
}
