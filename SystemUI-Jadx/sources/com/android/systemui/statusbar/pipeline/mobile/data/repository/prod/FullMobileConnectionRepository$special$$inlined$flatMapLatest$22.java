...
@DebugMetadata(c = "com.android.systemui.statusbar.pipeline.mobile.data.repository.prod.FullMobileConnectionRepository$special$$inlined$flatMapLatest$22", f = "FullMobileConnectionRepository.kt", l = {190}, m = "invokeSuspend")
...
public final class FullMobileConnectionRepository$special$$inlined$flatMapLatest$22 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            StateFlow mobileServiceState = ((MobileConnectionRepository) this.L$1).getMobileServiceState();
            this.label = 1;
            if (FlowKt.emitAll(this, mobileServiceState, flowCollector) == coroutineSingletons) {
