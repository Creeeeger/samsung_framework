...
@DebugMetadata(c = "com.android.systemui.user.domain.interactor.GuestUserInteractor$remove$4", f = "GuestUserInteractor.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class GuestUserInteractor$remove$4 extends SuspendLambda implements Function2 {
    final /* synthetic */ UserInfo $currentUser;
    int label;
    final /* synthetic */ GuestUserInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuestUserInteractor$remove$4(GuestUserInteractor guestUserInteractor, UserInfo userInfo, Continuation<? super GuestUserInteractor$remove$4> continuation) {
