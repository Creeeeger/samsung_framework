...
public final class ResourceBooleanFlag implements Flag {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.id == resourceBooleanFlag.id && Intrinsics.areEqual(this.name, resourceBooleanFlag.name) && Intrinsics.areEqual(this.namespace, resourceBooleanFlag.namespace) && this.resourceId == resourceBooleanFlag.resourceId && this.teamfood == resourceBooleanFlag.teamfood) {
            return true;
        }
        return false;
    }
