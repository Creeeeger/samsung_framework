    ...
    */
    public final void handleClick(android.view.View r3) {
        ...
        L21:
            ...
            boolean r3 = r3.value
            r3 = r3 ^ r0
            com.android.systemui.qs.tiles.ColorCorrectionTile$1 r2 = r2.mSetting
            r2.setValue(r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.qs.tiles.ColorCorrectionTile.handleClick(android.view.View):void");
    }
    ...
    */
    public final void handleSecondaryClick(android.view.View r3) {
        ...
        L21:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.qs.tiles.ColorCorrectionTile.handleSecondaryClick(android.view.View):void");
    }
    ...
    public final boolean isAvailable() {
        ...
        boolean isDesktopDualModeMonitorDisplay = WindowUtils.isDesktopDualModeMonitorDisplay(context);
        if (Settings.Secure.getInt(context.getContentResolver(), "shopdemo", 0) == 1) {
            z = true;
        } else {
            z = false;
        }
        if (i >= 33 && !isDesktopDualModeMonitorDisplay && !z) {
            return true;
        }
        return false;
    }
