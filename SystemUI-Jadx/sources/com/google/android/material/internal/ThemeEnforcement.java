    ...
    */
    ...
    public static void checkTheme(Context context, int[] iArr, String str) {
        ...
        if (z) {
            ...
            throw new IllegalArgumentException(PathParser$$ExternalSyntheticOutline0.m("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
