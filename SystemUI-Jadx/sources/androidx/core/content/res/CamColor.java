...
public final class CamColor {
    ...
    public static CamColor fromColor(int i) {
        ...
        float sqrt = (4.0f / f22) * ((float) Math.sqrt(pow4 / 100.0f)) * (f20 + 4.0f);
        float f23 = viewingConditions.mFlRoot;
        float f24 = sqrt * f23;
        if (f17 < 20.14d) {
            f = 360.0f + f17;
        } else {
        ...
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, viewingConditions.mN), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * viewingConditions.mNc) * viewingConditions.mNcb) * ((float) Math.sqrt((f13 * f13) + (f12 * f12)))) / (f15 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow4 / 100.0d));
        float f25 = pow5 * f23;
        float sqrt2 = ((float) Math.sqrt((r0 * f22) / r1)) * 50.0f;
        float f26 = (1.7f * pow4) / ((0.007f * pow4) + 1.0f);
        float log = ((float) Math.log((0.0228f * f25) + 1.0f)) * 43.85965f;
        double d3 = f18;
        return new CamColor(f17, pow5, pow4, f24, f25, sqrt2, f26, log * ((float) Math.cos(d3)), log * ((float) Math.sin(d3)));
    }
    ...
    public static CamColor fromJch(float f, float f2, float f3) {
        ...
        return new CamColor(f3, f2, f, f6, f7, sqrt2, f8, log * ((float) Math.cos(d)), log * ((float) Math.sin(d)));
    }
