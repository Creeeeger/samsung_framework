...
public class FileProvider extends ContentProvider {
    ...
    public static Uri getUriForFile(Context context, String str, File file) {
        ...
        try {
            ...
            if (entry != null) {
                ...
                return new Uri.Builder().scheme("content").authority(pathStrategy.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
            }
            throw new IllegalArgumentException(KeyAttributes$$ExternalSyntheticOutline0.m("Failed to find configured root that contains ", canonicalPath));
        } catch (IOException unused) {
    ...
    public static SimplePathStrategy parsePathStrategy(Context context, String str, int i) {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(KeyAttributes$$ExternalSyntheticOutline0.m("Couldn't find meta-data for provider with authority ", str));
        }
    }
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            if ("wa".equals(str)) {
                ...
                throw new IllegalArgumentException(KeyAttributes$$ExternalSyntheticOutline0.m("Invalid mode: ", str));
            }
        } else {
            i = 738197504;
        }
