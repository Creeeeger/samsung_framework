...
public class AllAppsSelectableItem extends SelectableItem implements DisposableHandle {
    ...
    private final void bindSelectableItemList() {
        ...
        this.disposableHandle = new DisposableHandle() { // from class: androidx.picker.loader.select.AllAppsSelectableItem$$ExternalSyntheticLambda0
            ...
            public final void dispose() {
                AllAppsSelectableItem.m38bindSelectableItemList$lambda4(DisposableHandle.this, arrayList);
            }
        };
    }
    ...
    public static final void m38bindSelectableItemList$lambda4(DisposableHandle disposableHandle, List list) {
        disposableHandle.dispose();
        Iterator it = list.iterator();
        while (it.hasNext()) {
    ...
    */
    public AllAppsSelectableItem(java.util.List<? extends androidx.picker.loader.select.SelectableItem> r4, kotlin.jvm.functions.Function1 r5) {
        /*
            r3 = this;
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.picker.loader.select.AllAppsSelectableItem.<init>(java.util.List, kotlin.jvm.functions.Function1):void");
    }
}
