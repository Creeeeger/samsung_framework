...
public class AES256SHA256Decoder extends CoderBase {
    ...
    public InputStream decode(final String str, final InputStream inputStream, long j, final Coder coder, final byte[] bArr) {
        return new InputStream() { // from class: org.apache.commons.compress.archivers.sevenz.AES256SHA256Decoder.1
            ...
            public final CipherInputStream init() {
                ...
                int i = bArr2[0] & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT;
                int i2 = i & 63;
                int i3 = bArr2[1] & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT;
                int i4 = ((i >> 6) & 1) + (i3 & 15);
                int i5 = ((i >> 7) & 1) + (i3 >> 4);
                int i6 = i5 + 2;
                ...
                if (i2 == 63) {
                    ...
                    byte[] bArr5 = bArr;
                    System.arraycopy(bArr5, 0, digest, i5, Math.min(bArr5.length, 32 - i5));
                } else {
                    try {
