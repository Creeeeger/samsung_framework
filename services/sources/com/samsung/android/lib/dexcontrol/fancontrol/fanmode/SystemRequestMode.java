...
public class SystemRequestMode implements IFanMode {
    ...
    public final Map getFanLevelTable() {
        if (this.mFanLevelTable == null) {
            ...
            if (this.mDexModel == 40992) {
                ...
                DexFanControlManager.FAN_LEVEL fan_level3 = DexFanControlManager.FAN_LEVEL.WEAK;
                map.put(siop_level3, fan_level3);
    ...
    public SystemRequestMode(IDexFanModeControl iDexFanModeControl, int i) {
    ...
    public DexFanControlManager.FAN_LEVEL getCurrentFanLevel() {
        SLog.d("ScreenRequestMode", "curFanLevel" + this.mIDexFanModeControl.getSiopLevel());
