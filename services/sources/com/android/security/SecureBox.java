...
public abstract class SecureBox {
    ...
    public static byte[] dhComputeSecret(PrivateKey privateKey, PublicKey publicKey) {
    ...
    public static byte[] aesGcmEncrypt(SecretKey secretKey, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        try {
    ...
    public static byte[] aesGcmDecrypt(SecretKey secretKey, byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    public static void validateEcPoint(BigInteger bigInteger, BigInteger bigInteger2) {
    ...
    public static byte[] genRandomNonce() {
