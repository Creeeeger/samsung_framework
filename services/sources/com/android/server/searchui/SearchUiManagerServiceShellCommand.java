...
public final class SearchUiManagerServiceShellCommand extends ShellCommand {
    ...
    public final int onCommand(String str) {
        ...
        if (nextArgRequired.equals("temporary-service")) {
            ...
            outPrintWriter.println(ActiveServices$$ExternalSyntheticOutline0.m(parseInt2, nextArg, " for ", "ms", new StringBuilder("SearchUiService temporarily set to ")));
        }
        return 0;
    }
