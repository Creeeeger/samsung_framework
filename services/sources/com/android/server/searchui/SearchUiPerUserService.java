...
public class SearchUiPerUserService extends AbstractPerUserSystemService implements RemoteSearchUiService.RemoteSearchUiServiceCallbacks {
    ...
    public boolean resolveService(SearchSessionId searchSessionId, AbstractRemoteService.AsyncRequest asyncRequest) {
        RemoteSearchUiService remoteServiceLocked = getRemoteServiceLocked();
        if (remoteServiceLocked != null) {
