...
public class AppBindingService extends Binder {
    ...
    public AppBindingService(Injector injector, Context context) {
        ...
        arrayList.add(new CarrierMessagingClientServiceFinder(context, new BiConsumer() { // from class: com.android.server.appbinding.AppBindingService$$ExternalSyntheticLambda3
    ...
    public final void bindServicesLocked(int i, AppServiceFinder appServiceFinder, String str) {
        for (int i2 = 0; i2 < this.mApps.size(); i2++) {
            AppServiceFinder appServiceFinder2 = (AppServiceFinder) this.mApps.get(i2);
