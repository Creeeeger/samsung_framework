...
public class CarrierMessagingClientServiceFinder extends AppServiceFinder {
    ...
    public CarrierMessagingClientServiceFinder(Context context, BiConsumer biConsumer, Handler handler) {
    ...
    public boolean isEnabled(AppBindingConstants appBindingConstants) {
        return appBindingConstants.SMS_SERVICE_ENABLED && this.mContext.getResources().getBoolean(17891899);
    }
