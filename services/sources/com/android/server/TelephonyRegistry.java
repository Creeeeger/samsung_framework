...
public class TelephonyRegistry extends ITelephonyRegistry.Stub {
    ...
    public ArrayList mCallStateLists;
    public boolean[] mCarrierNetworkChangeState;
    public List mCarrierPrivilegeStates;
    public boolean[] mCarrierRoamingNtnMode;
    public List mCarrierServiceStates;
    public CellIdentity[] mCellIdentity;
    public ArrayList mCellInfo;
    ...
    public List mImsReasonInfo;
    public boolean[] mIsDataEnabled;
    public List mLinkCapacityEstimateLists;
    public List mMediaQualityStatus;
    ...
    public List mPhysicalChannelConfigs;
    public PreciseCallState[] mPreciseCallState;
    public List mPreciseDataConnectionStates;
    ...
    public final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() { // from class: com.android.server.TelephonyRegistry.2
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.telephony.action.DEFAULT_SUBSCRIPTION_CHANGED")) {
                ...
                if (TelephonyRegistry.this.validatePhoneId(intExtra2) && (intExtra != TelephonyRegistry.this.mDefaultSubId || intExtra2 != TelephonyRegistry.this.mDefaultPhoneId)) {
                    TelephonyRegistry.this.mHandler.sendMessage(TelephonyRegistry.this.mHandler.obtainMessage(2, intExtra2, intExtra));
                    return;
                } else {
                    if (TelephonyRegistry.this.getPhoneIdFromSubId(intExtra) == -1) {
                        TelephonyRegistry.this.mDefaultSubId = -1;
                        TelephonyRegistry.this.mDefaultPhoneId = -1;
                        return;
                    }
                    return;
                }
    ...
    public class ConfigurationProvider {
        ...
        public static /* synthetic */ Integer lambda$getRegistrationLimit$0() {
            return Integer.valueOf(DeviceConfig.getInt("telephony", "phone_state_listener_per_pid_registration_limit", 50));
        }

        public static /* synthetic */ Boolean lambda$isRegistrationLimitEnabledInPlatformCompat$1(int i) {
        ...
        public static /* synthetic */ Boolean lambda$isCallStateReadPhoneStateEnforcedInPlatformCompat$2(String str, UserHandle userHandle) {
        ...
        public static /* synthetic */ Boolean lambda$isActiveDataSubIdReadPhoneStateEnforcedInPlatformCompat$3(String str, UserHandle userHandle) {
        ...
        public static /* synthetic */ Boolean lambda$isCellInfoReadPhoneStateEnforcedInPlatformCompat$4(String str, UserHandle userHandle) {
        ...
        public static /* synthetic */ Boolean lambda$isDisplayInfoReadPhoneStateEnforcedInPlatformCompat$5(String str, UserHandle userHandle) {
        ...
        public static /* synthetic */ Boolean lambda$isDisplayInfoNrAdvancedSupported$6(String str, UserHandle userHandle) {
    ...
    public final boolean isLocationPermissionRequired(Set set) {
        return set.contains(5) || set.contains(11);
    }

    public final boolean isPhoneStatePermissionRequired(Set set, String str, UserHandle userHandle) {
    ...
    public final boolean isPrecisePhoneStatePermissionRequired(Set set) {
        Iterator it = REQUIRE_PRECISE_PHONE_STATE_PERMISSION.iterator();
        while (it.hasNext()) {
    ...
    public final boolean isActiveEmergencySessionPermissionRequired(Set set) {
        return set.contains(29) || set.contains(30);
    }

    public final boolean isPrivilegedPhoneStatePermissionRequired(Set set) {
    ...
    public void notifyOpportunisticSubscriptionInfoChanged() {
        if (checkNotifyPermission("notifyOpportunisticSubscriptionInfoChanged()")) {
            synchronized (this.mRecords) {
                ...
                while (it.hasNext()) {
                    Record record = (Record) it.next();
                    if (record.matchOnOpportunisticSubscriptionsChangedListener()) {
                        try {
                            record.onOpportunisticSubscriptionsChangedListenerCallback.onSubscriptionsChanged();
                        } catch (RemoteException unused) {
                            this.mRemoveList.add(record.binder);
                        }
                    }
        ...
        if (checkListenerPermission(set, i, str, str2, "listen")) {
            synchronized (this.mRecords) {
                ...
                if (z3 && validatePhoneId(phoneIdFromSubId)) {
                    ...
                    if (set.contains(28) && (imsReasonInfo = (ImsReasonInfo) this.mImsReasonInfo.get(add.phoneId)) != null) {
                        try {
                    ...
                    if (set.contains(13)) {
                        try {
                            Iterator it = ((Map) this.mPreciseDataConnectionStates.get(add.phoneId)).values().iterator();
                            while (it.hasNext()) {
                    ...
                    if (set.contains(32) && (barringInfo = (BarringInfo) this.mBarringInfo.get(add.phoneId)) != null) {
                    ...
                    if (set.contains(33)) {
                        try {
                            ...
                            if (shouldSanitizeLocationForPhysicalChannelConfig(add)) {
                                list = getLocationSanitizedConfigs((List) this.mPhysicalChannelConfigs.get(add.phoneId));
                            } else {
                                list = (List) this.mPhysicalChannelConfigs.get(add.phoneId);
                            }
                    ...
                    if (set.contains(37)) {
                        try {
                            if (this.mLinkCapacityEstimateLists.get(add.phoneId) != null) {
                                add.callback.onLinkCapacityEstimateChanged((List) this.mLinkCapacityEstimateLists.get(add.phoneId));
                            }
                    ...
                    if (set.contains(39)) {
                        ...
                        if (callState != null) {
                            ...
                            try {
                                MediaQualityStatus mediaQualityStatus = (MediaQualityStatus) ((SparseArray) this.mMediaQualityStatus.get(add.phoneId)).get(1);
                                ...
                                MediaQualityStatus mediaQualityStatus2 = (MediaQualityStatus) ((SparseArray) this.mMediaQualityStatus.get(add.phoneId)).get(2);
                ...
                if (validatePhoneId(i)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (record.matchTelephonyCallbackEvent(36) && (i5 = record.subId) == i2 && i5 != Integer.MAX_VALUE) {
                            try {
                                record.callback.onLegacyCallStateChanged(i3, getCallIncomingNumber(record, i));
                            } catch (RemoteException unused) {
                                this.mRemoveList.add(record.binder);
                            }
                        }
                        ...
                        while (it.hasNext()) {
                            ...
                            if (record.matchTelephonyCallbackEvent(1) && idMatch(record, i2, i)) {
                                try {
                                    ...
                                    record.callback.onServiceStateChanged(createLocationInfoSanitizedCopy);
                                } catch (RemoteException unused) {
                                    this.mRemoveList.add(record.binder);
                                }
                            }
                ...
                if (validatePhoneId(i)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (record.matchTelephonyCallbackEvent(21) && idMatch(record, i2, i)) {
                            try {
                                if (!this.mConfigurationProvider.isDisplayInfoNrAdvancedSupported(record.callingPackage, Binder.getCallingUserHandle())) {
                                    record.callback.onDisplayInfoChanged(getBackwardCompatibleTelephonyDisplayInfo(telephonyDisplayInfo));
                                } else {
        ...
        if (checkNotifyPermission("notifyDataConnection()")) {
            synchronized (this.mRecords) {
                if (validatePhoneId(i) && preciseDataConnectionState.getApnSetting() != null) {
                    ...
                    if (!Objects.equals((PreciseDataConnectionState) ((Map) this.mPreciseDataConnectionStates.get(i)).remove(create), preciseDataConnectionState)) {
                        Iterator it = this.mRecords.iterator();
                        while (it.hasNext()) {
                            Record record = (Record) it.next();
                    ...
                    if (preciseDataConnectionState.getState() != 0) {
                        ((Map) this.mPreciseDataConnectionStates.get(i)).put(create, preciseDataConnectionState);
                    }
                    ...
                    for (Map.Entry entry : ((Map) this.mPreciseDataConnectionStates.get(i)).entrySet()) {
            ...
            synchronized (this.mRecords) {
                if (validatePhoneId(i)) {
                    ...
                    if (this.mCallQuality == null) {
                        ...
                        if (!z2) {
                            ((SparseArray) this.mMediaQualityStatus.get(i)).clear();
                        }
                        z2 = z3;
                    }
                ...
                if (validatePhoneId(phoneIdFromSubId)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (record.matchTelephonyCallbackEvent(28) && idMatch(record, i, phoneIdFromSubId)) {
                            try {
                                record.callback.onImsCallDisconnectCauseChanged((ImsReasonInfo) this.mImsReasonInfo.get(phoneIdFromSubId));
                            } catch (RemoteException unused) {
                                this.mRemoveList.add(record.binder);
                            }
                        }
        ...
        if (checkNotifyPermission("notifyRadioPowerStateChanged()")) {
            synchronized (this.mRecords) {
                if (validatePhoneId(i)) {
                    ...
                    while (it.hasNext()) {
                        Record record = (Record) it.next();
                        if (record.matchTelephonyCallbackEvent(24) && idMatch(record, i2, i)) {
                            try {
                                record.callback.onRadioPowerStateChanged(i3);
                            } catch (RemoteException unused) {
                                this.mRemoveList.add(record.binder);
                            }
                        }
        ...
        if (checkNotifyPermission("notifyCallQualityChanged()")) {
            synchronized (this.mRecords) {
                if (validatePhoneId(i)) {
                    ...
                    arrayList.addAll((Collection) this.mCallStateLists.get(i));
                    ((List) this.mCallStateLists.get(i)).clear();
                    for (CallState callState : arrayList) {
    ...
    public void notifyPhysicalChannelConfigForSubscriber(int i, int i2, List list) {
                ...
                if (validatePhoneId(i)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (record.matchTelephonyCallbackEvent(33) && idMatch(record, i2, i)) {
                            try {
                                record.callback.onPhysicalChannelConfigChanged(shouldSanitizeLocationForPhysicalChannelConfig(record) ? locationSanitizedConfigs : list);
                            } catch (RemoteException unused) {
                                this.mRemoveList.add(record.binder);
                            }
                        }
    ...
    public void notifyLinkCapacityEstimateChanged(int i, int i2, List list) {
    ...
    public void addCarrierPrivilegesCallback(int i, ICarrierPrivilegesCallback iCarrierPrivilegesCallback, String str, String str2) {
        ...
        synchronized (this.mRecords) {
            ...
            add.phoneId = i;
            add.eventList = new ArraySet();
            Pair pair = (Pair) this.mCarrierPrivilegeStates.get(i);
            Pair pair2 = (Pair) this.mCarrierServiceStates.get(i);
            try {
    ...
    public void notifyCarrierPrivilegesChanged(int i, List list, int[] iArr) {
        if (checkNotifyPermission("notifyCarrierPrivilegesChanged")) {
            ...
            synchronized (this.mRecords) {
                ...
                while (it.hasNext()) {
                    Record record = (Record) it.next();
                    if (record.matchCarrierPrivilegesCallback() && idMatch(record, -1, i)) {
                        try {
    ...
    public void notifyCarrierConfigChanged(int i, int i2, int i3, int i4) {
        ...
        synchronized (this.mRecords) {
            ...
            while (it.hasNext()) {
                Record record = (Record) it.next();
                if (record.matchCarrierConfigChangeListener()) {
                    try {
                        record.carrierConfigChangeListener.onCarrierConfigChanged(i, i2, i3, i4);
                    } catch (RemoteException unused) {
                        this.mRemoveList.add(record.binder);
                    }
                }
                    ...
                    if (((List) this.mCallStateLists.get(i)).size() > 0) {
                        ...
                        if (callState != null) {
                            ...
                            if (imsCallSessionId != null && imsCallSessionId.equals(mediaQualityStatus.getCallSessionId())) {
                                ((SparseArray) this.mMediaQualityStatus.get(i)).put(mediaQualityStatus.getMediaSessionType(), mediaQualityStatus);
                            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ String[] lambda$broadcastServiceStateChanged$1() {
    ...
    public final BroadcastOptions createServiceStateBroadcastOptions(int i, int i2, String str) {
    ...
    public final void broadcastCallStateChanged(int i, String str, int i2, int i3) {
        ...
        intent.putExtra(LauncherConfigurationInternal.KEY_STATE_BOOLEAN, callStateToString(i));
        if (i3 != -1) {
    ...
    public final boolean checkListenerPermission(Set set, int i, String str, String str2, String str3) {
        boolean z = true;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$checkFineLocationAccess$2(LocationAccessPolicy.LocationPermissionQuery locationPermissionQuery) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$checkCoarseLocationAccess$3(LocationAccessPolicy.LocationPermissionQuery locationPermissionQuery) {
        return Boolean.valueOf(LocationAccessPolicy.checkLocationPermission(this.mContext, locationPermissionQuery) == LocationAccessPolicy.LocationPermissionResult.ALLOWED);
    }
        ...
        if (validateEventAndUserLocked(record, 11)) {
            try {
                if (checkCoarseLocationAccess(record, 1) && checkFineLocationAccess(record, 29)) {
                    record.callback.onCellInfoChanged((List) this.mCellInfo.get(i));
                }
            } catch (RemoteException unused4) {
                this.mRemoveList.add(record.binder);
            }
    ...
    public void clearPreciseDataConnectionStates(int i) {
        synchronized (this.mRecords) {
            ((Map) this.mPreciseDataConnectionStates.get(i)).clear();
        }
    }
}
