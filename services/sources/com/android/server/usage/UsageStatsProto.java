...
public abstract class UsageStatsProto {
    ...
    public static void loadUsageStats(ProtoInputStream protoInputStream, long j, IntervalStats intervalStats, List list) {
        UsageStats usageStats;
        UsageStats orCreateUsageStats;
        long start = protoInputStream.start(j);
        if (protoInputStream.nextField(1120986464258L)) {
            usageStats = intervalStats.getOrCreateUsageStats((String) list.get(protoInputStream.readInt(1120986464258L) - 1));
    ...
    public static void loadCountsForAction(ProtoInputStream protoInputStream, ArrayMap arrayMap) {
        String str = null;
        int i = 0;
        while (true) {
            int nextField = protoInputStream.nextField();
    ...
    public static void loadConfigStats(ProtoInputStream protoInputStream, long j, IntervalStats intervalStats) {
    ...
    public static void loadEvent(ProtoInputStream protoInputStream, long j, IntervalStats intervalStats, List list) {
        long start = protoInputStream.start(j);
    ...
    public static void writeStringPool(ProtoOutputStream protoOutputStream, IntervalStats intervalStats) {
        long start = protoOutputStream.start(1146756268034L);
        int size = intervalStats.mStringCache.size();
        protoOutputStream.write(1120986464257L, size);
        for (int i = 0; i < size; i++) {
            protoOutputStream.write(2237677961218L, (String) intervalStats.mStringCache.valueAt(i));
        }
        protoOutputStream.end(start);
    }

    public static void writeUsageStats(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, UsageStats usageStats) {
    ...
    public static void writeCountsForAction(ProtoOutputStream protoOutputStream, ArrayMap arrayMap) {
    ...
    public static void writeConfigStats(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, ConfigurationStats configurationStats, boolean z) {
        long start = protoOutputStream.start(j);
    ...
    public static void writeEvent(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, UsageEvents.Event event) {
        int indexOf;
        String str;
        int indexOf2;
        int indexOf3;
    ...
    public static void write(OutputStream outputStream, IntervalStats intervalStats) {
        ...
        for (int i = 0; i < size; i++) {
            try {
                writeUsageStats(protoOutputStream, 2246267895828L, intervalStats, (UsageStats) intervalStats.packageStats.valueAt(i));
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            try {
                writeConfigStats(protoOutputStream, 2246267895829L, intervalStats, (ConfigurationStats) intervalStats.configurations.valueAt(i2), intervalStats.activeConfiguration.equals((Configuration) intervalStats.configurations.keyAt(i2)));
