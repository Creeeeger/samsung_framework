...
public class StorageStatsService extends IStorageStatsManager.Stub {
        ...
        try {
            try {
                ...
                if (isQuotaSupported(str, "android")) {
                    return findPathForUuid.getUsableSpace() + Math.max(0L, getCacheBytes(str, "android") - this.mStorage.getStorageCacheBytes(findPathForUuid, 0));
                }
    ...
    public long getCacheQuotaBytes(String str, int i, String str2) {
        ...
        if (this.mCacheQuotas.containsKey(str)) {
            return ((SparseLongArray) this.mCacheQuotas.get(str)).get(i, DEFAULT_QUOTA);
        }
    ...
    public final int[] getAppIds(int i) {
        Iterator it = this.mPackage.getInstalledApplicationsAsUser(IInstalld.FLAG_FORCE, i).iterator();
        int[] iArr = null;
        while (it.hasNext()) {
    ...
    public final ParceledListSlice getAppCrates(String str, String[] strArr, int i) {
        try {
    ...
    public ParceledListSlice queryCratesForPackage(String str, String str2, int i, String str3) {
        checkCratesEnable();
        if (i != UserHandle.getCallingUserId()) {
            this.mContext.enforceCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS", "StorageStatsService");
        }
    ...
    public ParceledListSlice queryCratesForUid(String str, int i, String str2) {
        checkCratesEnable();
        int userId = UserHandle.getUserId(i);
        if (userId != UserHandle.getCallingUserId()) {
            this.mContext.enforceCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS", "StorageStatsService");
    ...
    public ParceledListSlice queryCratesForUser(String str, int i, String str2) {
        checkCratesEnable();
        if (i != UserHandle.getCallingUserId()) {
            this.mContext.enforceCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS", "StorageStatsService");
        }
    ...
    public void forEachStorageStatsAugmenter(Consumer consumer, String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Trace.traceBegin(524288L, str + XmlUtils.STRING_ARRAY_SEPARATOR + str2);
            try {
