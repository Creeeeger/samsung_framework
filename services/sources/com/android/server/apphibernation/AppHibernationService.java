...
public final class AppHibernationService extends SystemService {
    ...
    public interface Injector {
        ...
        HibernationStateDiskStore getGlobalLevelDiskStore();
        ...
        HibernationStateDiskStore getUserLevelDiskStore(int i);
    ...
    public /* synthetic */ void lambda$onBootPhase$0() {
        List readHibernationStates = this.mGlobalLevelHibernationDiskStore.readHibernationStates();
    ...
    public boolean isHibernatingGlobally(String str) {
        ...
        getContext().enforceCallingOrSelfPermission("android.permission.MANAGE_APP_HIBERNATION", "Caller does not have MANAGE_APP_HIBERNATION permission.");
        synchronized (this.mLock) {
            GlobalLevelState globalLevelState = (GlobalLevelState) this.mGlobalHibernationStates.get(str);
    ...
    public void setHibernatingGlobally(final String str, boolean z) {
        if (sIsServiceEnabled) {
            getContext().enforceCallingOrSelfPermission("android.permission.MANAGE_APP_HIBERNATION", "Caller does not have MANAGE_APP_HIBERNATION permission.");
            synchronized (this.mLock) {
                final GlobalLevelState globalLevelState = (GlobalLevelState) this.mGlobalHibernationStates.get(str);
                if (globalLevelState != null && this.mPackageManagerInternal.canQueryPackage(Binder.getCallingUid(), str)) {
    ...
    public List getHibernatingPackagesForUser(int i) {
    ...
    public Map getHibernationStatsForUser(Set set, int i) {
        ...
        synchronized (this.mLock) {
            ...
            Map map = (Map) this.mUserStates.get(handleIncomingUser);
            if (set == null) {
                set = map.keySet();
            }
            for (String str : set) {
                if (this.mPackageManagerInternal.canQueryPackage(Binder.getCallingUid(), str)) {
                    if (this.mGlobalHibernationStates.containsKey(str) && map.containsKey(str)) {
                        arrayMap.put(str, new HibernationStats(((GlobalLevelState) this.mGlobalHibernationStates.get(str)).savedByte + ((UserLevelState) map.get(str)).savedByte));
                    }
        ...
        try {
            try {
                try {
                    ...
                    Slog.e("AppHibernationService", "Package name not found when querying storage stats", e);
                } catch (RemoteException e2) {
                    throw new IllegalStateException("Failed to hibernate due to manager not being available", e2);
                }
            } catch (IOException e3) {
                Slog.e("AppHibernationService", "Storage device not found", e3);
            }
        } finally {
    ...
    public void onUserUnlocking(SystemService.TargetUser targetUser) {
        ...
        final HibernationStateDiskStore userLevelDiskStore = this.mInjector.getUserLevelDiskStore(userIdentifier);
    ...
    public /* synthetic */ void lambda$onUserUnlocking$5(HibernationStateDiskStore hibernationStateDiskStore, int i) {
        ...
        synchronized (this.mLock) {
            if (this.mUserManager.isUserUnlockingOrUnlocked(i)) {
                ...
                for (UserLevelState userLevelState : ((Map) this.mUserStates.get(i)).values()) {
                    String str = userLevelState.packageName;
                    if (((GlobalLevelState) this.mGlobalHibernationStates.get(str)).hibernated && !userLevelState.hibernated) {
    ...
    public final void onPackageAdded(String str, int i) {
        synchronized (this.mLock) {
            if (this.mUserStates.contains(i)) {
                UserLevelState userLevelState = new UserLevelState();
                userLevelState.packageName = str;
                ((Map) this.mUserStates.get(i)).put(str, userLevelState);
    ...
    public final void onPackageRemoved(String str, int i) {
        synchronized (this.mLock) {
            if (this.mUserStates.contains(i)) {
                ((Map) this.mUserStates.get(i)).remove(str);
            }
        }
    }
        ...
        if (DumpUtils.checkDumpAndUsageStatsPermission(getContext(), "AppHibernationService", printWriter)) {
            ...
            synchronized (this.mLock) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    Map map = (Map) this.mUserStates.get(keyAt);
                ...
                indentingPrintWriter.println();
                Iterator it2 = this.mGlobalHibernationStates.values().iterator();
                while (it2.hasNext()) {
    ...
    /* loaded from: classes.dex */
    public final class LocalService extends AppHibernationManagerInternal {
    ...
    public final class AppHibernationServiceStub extends IAppHibernationService.Stub {
        ...
        public Map getHibernationStatsForUser(List list, int i) {
    ...
    public final class InjectorImpl implements Injector {
        ...
        @Override // com.android.server.apphibernation.AppHibernationService.Injector
        public HibernationStateDiskStore getGlobalLevelDiskStore() {
        ...
        @Override // com.android.server.apphibernation.AppHibernationService.Injector
        public HibernationStateDiskStore getUserLevelDiskStore(int i) {
        ...
        @Override // com.android.server.apphibernation.AppHibernationService.Injector
        public boolean isOatArtifactDeletionEnabled() {
            return this.mContext.getResources().getBoolean(17891721);
        }
    }
