...
public final class UsbDescriptorParser {
        ...
        while (it.hasNext()) {
            ...
            if (usbDescriptor.getType() == 4) {
                if (usbDescriptor instanceof UsbInterfaceDescriptor) {
                    ...
                    Log.w("UsbDescriptorParser", "Unrecognized Interface l: " + usbDescriptor.getLength() + " t:0x" + Integer.toHexString(usbDescriptor.getType()));
                }
            }
        }
        return arrayList;
        ...
        while (it.hasNext()) {
            ...
            if (usbDescriptor.getType() == 36) {
                if (usbDescriptor instanceof UsbACInterface) {
                    ...
                    Log.w("UsbDescriptorParser", "Unrecognized Audio Interface len: " + usbDescriptor.getLength() + " type:0x" + Integer.toHexString(usbDescriptor.getType()));
                }
            }
        }
        return arrayList;
    ...
    public boolean hasInput() {
        ...
        while (it.hasNext()) {
            ...
            if (usbDescriptor instanceof UsbACTerminal) {
                ...
                Log.w("UsbDescriptorParser", "Undefined Audio Input terminal l: " + usbDescriptor.getLength() + " t:0x" + Integer.toHexString(usbDescriptor.getType()));
            }
        }
        return false;
    }
    ...
    public boolean hasSpeaker() {
        ...
        while (it.hasNext()) {
            ...
            if (usbDescriptor instanceof UsbACTerminal) {
                ...
                Log.w("UsbDescriptorParser", "Undefined Audio Output terminal l: " + usbDescriptor.getLength() + " t:0x" + Integer.toHexString(usbDescriptor.getType()));
            }
        }
        return false;
    }
    ...
    public boolean hasAudioPlayback() {
        return hasAudioTerminalExcludeType(3, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP) && hasAudioTerminal(2, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP);
    }

    public boolean hasAudioCapture() {
        return hasAudioTerminalExcludeType(2, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP) && hasAudioTerminal(3, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP);
    }
    ...
    public boolean hasMIDIInterface() {
        ...
        while (it.hasNext()) {
            ...
            if (usbDescriptor instanceof UsbInterfaceDescriptor) {
                ...
                Log.w("UsbDescriptorParser", "Undefined Audio Class Interface l: " + usbDescriptor.getLength() + " t:0x" + Integer.toHexString(usbDescriptor.getType()));
            }
        }
        return false;
    }
    ...
    public final int calculateNumLegacyMidiPorts(boolean z) {
        ...
        while (true) {
            ...
            if (usbDescriptor.getType() == 2) {
                ...
                Log.w("UsbDescriptorParser", "Unrecognized Config l: " + usbDescriptor.getLength() + " t:0x" + Integer.toHexString(usbDescriptor.getType()));
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (usbInterfaceDescriptor.getUsbClass() == 1 && usbInterfaceDescriptor.getUsbSubclass() == 3 && (midiHeaderInterfaceDescriptor = usbInterfaceDescriptor.getMidiHeaderInterfaceDescriptor()) != null && (midiHeaderInterfaceDescriptor instanceof UsbMSMidiHeader) && ((UsbMSMidiHeader) midiHeaderInterfaceDescriptor).getMidiStreamingClass() == 256) {
                arrayList.add(usbInterfaceDescriptor);
            }
        }
    ...
    public boolean isDock() {
        if (!hasMIDIInterface() && !hasHIDInterface()) {
            ...
            if (aCInterfaceDescriptors.get(0) instanceof UsbACTerminal) {
                ...
                Log.w("UsbDescriptorParser", "Undefined Audio Output terminal l: " + ((UsbDescriptor) aCInterfaceDescriptors.get(0)).getLength() + " t:0x" + Integer.toHexString(((UsbDescriptor) aCInterfaceDescriptors.get(0)).getType()));
            }
        }
        return false;
    }
