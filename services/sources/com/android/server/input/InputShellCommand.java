...
public class InputShellCommand extends ShellCommand {
    ...
    public final void sendTap(int i, float f, float f2, int i2) {
        ...
        injectMotionEvent(i, 1, uptimeMillis, uptimeMillis, f, f2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
    }

    public final void runPress(int i, int i2) {
        sendTap(getSource(i, 65540), DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
    }
    ...
    public final void sendSwipe(int i, int i2, boolean z) {
        ...
        injectMotionEvent(i, 1, uptimeMillis, uptimeMillis2, parseFloat3, parseFloat4, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
    }
    ...
    public final void sendMove(int i, float f, float f2, int i2) {
        long uptimeMillis = SystemClock.uptimeMillis();
        injectMotionEvent(i, 2, uptimeMillis, uptimeMillis, f, f2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
    }
    ...
    public final void sendMotionEvent(int i, int i2, float f, float f2, int i3) {
        float f3 = (i2 == 0 || i2 == 2) ? 1.0f : DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
        long uptimeMillis = SystemClock.uptimeMillis();
    ...
    public final void sendKeyCombination(int i, IntArray intArray, int i2, long j) {
        ...
        while (i3 < size) {
            ...
            i4 |= ((Integer) MODIFIER.getOrDefault(Integer.valueOf(i5), num2)).intValue();
            i3 = i6 + 1;
            size = size;
            num = num2;
        ...
        for (int i9 = 0; i9 < i7; i9++) {
            ...
            i4 &= ~((Integer) MODIFIER.getOrDefault(Integer.valueOf(keyCode), num3)).intValue();
        }
    }
