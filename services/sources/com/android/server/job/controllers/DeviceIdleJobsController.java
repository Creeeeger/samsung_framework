...
public final class DeviceIdleJobsController extends StateController {
    ...
    public final Predicate mShouldRushEvaluation;

    static {
        DEBUG = JobSchedulerService.DEBUG || Log.isLoggable("JobScheduler.DeviceIdle", 3);
    }

    /* renamed from: com.android.server.job.controllers.DeviceIdleJobsController$1 */
    /* loaded from: classes2.dex */
    ...
    public DeviceIdleJobsController(JobSchedulerService jobSchedulerService) {
        ...
        AnonymousClass1 anonymousClass1 = new BroadcastReceiver() { // from class: com.android.server.job.controllers.DeviceIdleJobsController.1
            public AnonymousClass1() {
            }
