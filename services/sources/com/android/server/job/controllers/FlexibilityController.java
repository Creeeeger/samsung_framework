...
public final class FlexibilityController extends StateController {
    ...
    /* renamed from: com.android.server.job.controllers.FlexibilityController$1 */
    /* loaded from: classes2.dex */
    public class AnonymousClass1 implements PrefetchController.PrefetchChangedListener {
            ...
            synchronized (FlexibilityController.this.mLock) {
                ...
                for (int i2 = 0; i2 < arraySet.size(); i2++) {
                    ...
                    if (jobStatus.hasFlexibilityConstraint()) {
                        FlexibilityController.this.mFlexibilityTracker.resetJobNumDroppedConstraints(jobStatus, j3);
    ...
    public FlexibilityController(JobSchedulerService jobSchedulerService, PrefetchController prefetchController) {
        ...
        AnonymousClass1 anonymousClass1 = new PrefetchController.PrefetchChangedListener() { // from class: com.android.server.job.controllers.FlexibilityController.1
            public AnonymousClass1() {
            }
        ...
        this.mPrefetchChangedListener = anonymousClass1;
        ...
        if (this.mFlexibilityEnabled) {
            prefetchController.registerPrefetchChangedListener(anonymousClass1);
        }
    }
        ...
        if (i2 == 40 || i3 == 40) {
            ...
            if (z && i2 == 40) {
                ...
                for (int i5 = 0; i5 < packagesForUidLocked.size(); i5++) {
                    ...
                    sparseArrayMap.add(userId, str, Long.valueOf(Math.max(((Long) sparseArrayMap.getOrDefault(userId, str, 0L)).longValue(), millis)));
                }
            }
        }
    }
    ...
    public class FlexibilityAlarmQueue extends AlarmQueue {
        public /* synthetic */ FlexibilityAlarmQueue(FlexibilityController flexibilityController, Context context, Looper looper, FlexibilityAlarmQueueIA flexibilityAlarmQueueIA) {
            this(context, looper);
        }
        ...
        public void processExpiredAlarms(ArraySet arraySet) {
            synchronized (FlexibilityController.this.mLock) {
                ...
                for (int i = 0; i < arraySet.size(); i++) {
                    ...
                    if (FlexibilityController.this.mFlexibilityTracker.adjustJobsRequiredConstraints(jobStatus, -1, millis)) {
