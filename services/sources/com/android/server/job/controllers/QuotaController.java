...
public final class QuotaController extends StateController {
    ...
    public class QcUidObserver extends UidObserver {
        public /* synthetic */ QcUidObserver(QuotaController quotaController, QcUidObserverIA qcUidObserverIA) {
            this();
        }
    ...
    public final class EarliestEndTimeFunctor implements Consumer {
        ...
        public /* synthetic */ EarliestEndTimeFunctor(QuotaController quotaController, EarliestEndTimeFunctorIA earliestEndTimeFunctorIA) {
            this();
        }
    ...
    public class TimerChargingUpdateFunctor implements Consumer {
        ...
        public /* synthetic */ TimerChargingUpdateFunctor(QuotaController quotaController, TimerChargingUpdateFunctorIA timerChargingUpdateFunctorIA) {
            this();
        }
    ...
    public class UidConstraintUpdater implements Consumer {
        ...
        public /* synthetic */ UidConstraintUpdater(QuotaController quotaController, UidConstraintUpdaterIA uidConstraintUpdaterIA) {
            this();
        }
    ...
    */
    public void maybeScheduleStartAlarmLocked(int r21, java.lang.String r22, int r23) {
        /*
    ...
    /* loaded from: classes2.dex */
    public final class QuotaBump implements TimedEvent {
    ...
    public final class TimedEventTooOldPredicate implements Predicate {
        ...
        public /* synthetic */ TimedEventTooOldPredicate(TimedEventTooOldPredicateIA timedEventTooOldPredicateIA) {
            this();
        }
    ...
    public class InQuotaAlarmQueue extends AlarmQueue {
        public /* synthetic */ InQuotaAlarmQueue(QuotaController quotaController, Context context, Looper looper, InQuotaAlarmQueueIA inQuotaAlarmQueueIA) {
            this(context, looper);
        }
    ...
    public class QcConstants {
        ...
        public void processConstantLocked(DeviceConfig.Properties properties, String str) {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    QuotaController.this.mEJRewardNotificationSeenMs = Math.min(BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS, Math.max(0L, j));
                    return;
                case '\b':
                ...
                case 28:
                    ...
                    QuotaController.this.mEJGracePeriodTopAppMs = Math.min(ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS, Math.max(0L, j4));
                    return;
                case 31:
                ...
                case '\"':
                    ...
                    QuotaController.this.mEJGracePeriodTempAllowlistMs = Math.min(ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS, Math.max(0L, j5));
                    return;
                case '#':
        ...
        public final void updateExecutionPeriodConstantsLocked() {
            ...
            long max5 = Math.max(QuotaController.this.mAllowedTimePerPeriodMs[1], Math.min(BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS, this.WINDOW_SIZE_WORKING_MS));
        ...
        public final void updateEJLimitConstantsLocked() {
            ...
            long j = properties.getLong(KEY_EJ_WINDOW_SIZE_MS, BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS);
        ...
        public final void updateQuotaBumpConstantsLocked() {
            ...
            long max = Math.max(ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS, Math.min(BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS, this.QUOTA_BUMP_WINDOW_SIZE_MS));
