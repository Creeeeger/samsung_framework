...
public abstract class StateController {
    ...
    public abstract void dumpControllerStateLocked(IndentingPrintWriter indentingPrintWriter, Predicate predicate);
    ...
    public void logDeviceWideConstraintStateToStatsd(int i, boolean z) {
        FrameworkStatsLog.write(FrameworkStatsLog.DEVICE_WIDE_JOB_CONSTRAINT_CHANGED, JobStatus.getProtoConstraint(i), z ? 2 : 1);
    }
