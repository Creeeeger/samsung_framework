            ...
            while (size >= 0) {
                ...
                if (arraySet2 != null) {
                    ...
                    while (i2 < arraySet2.size()) {
                        ...
                        ArraySet arraySet3 = packagesForUidLocked;
            ...
            if (arraySet != null) {
                ...
                if (!arraySet.isEmpty()) {
                    ...
                    while (i2 < this.mPrefetchChangedListeners.size()) {
                        ((PrefetchChangedListener) this.mPrefetchChangedListeners.valueAt(i2)).onPrefetchCacheUpdated(arraySet, i, str, longValue, j, millis2);
                        i2++;
                        arraySet = arraySet;
                    }
            ...
            synchronized (PrefetchController.this.mLock) {
                ...
                while (i < arraySet.size()) {
                    ...
                    if (!PrefetchController.this.willBeLaunchedSoonLocked(userPackage.userId, userPackage.packageName, millis)) {
                        ...
                        PrefetchController.this.updateThresholdAlarmLocked(userPackage.userId, userPackage.packageName, millis, millis2);
                        j = millis;
                    } else {
                        j = millis;
                        if (PrefetchController.this.maybeUpdateConstraintForPkgLocked(millis, millis2, userPackage.userId, userPackage.packageName)) {
