...
public class CountQuotaTracker extends QuotaTracker {
    public static final String ALARM_TAG_CLEANUP = "*" + CountQuotaTracker.class.getSimpleName() + ".cleanup*";
    ...
    public boolean noteEvent(int i, String str, String str2) {
        synchronized (this.mLock) {
            if (isEnabledLocked() && !isQuotaFreeLocked(i, str)) {
                ...
                LongArrayQueue longArrayQueue = (LongArrayQueue) this.mEventTimes.getOrCreate(i, str, str2, this.mCreateLongArrayQueue);
                ...
                if (i2 == i3) {
                    ...
                    executionStatsLocked.inQuotaTimeElapsed = longArrayQueue.peekFirst() + executionStatsLocked.windowSizeMs;
    ...
    public final ExecutionStats getExecutionStatsLocked(int i, String str, String str2, boolean z) {
        ExecutionStats executionStats = (ExecutionStats) this.mExecutionStatsCache.getOrCreate(i, str, str2, this.mCreateExecutionStats);
        if (z) {
            ...
            if (executionStats.expirationTimeElapsed <= this.mInjector.getElapsedRealtime() || executionStats.windowSizeMs != longValue || executionStats.countLimit != intValue) {
