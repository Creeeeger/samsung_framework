...
public class UnderlyingNetworkController {
    ...
    public static Set dedupAndGetCapRequirementsForCell(VcnGatewayConnectionConfig vcnGatewayConnectionConfig) {
    ...
    public class UnderlyingNetworkListener extends ConnectivityManager.NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            UnderlyingNetworkRecord.Builder builder = (UnderlyingNetworkRecord.Builder) this.mUnderlyingNetworkRecordBuilders.get(network);
            if (builder == null) {
