...
public class UnderlyingNetworkRecord {
    ...
    public void dump(VcnContext vcnContext, IndentingPrintWriter indentingPrintWriter, List list, ParcelUuid parcelUuid, TelephonySubscriptionTracker.TelephonySubscriptionSnapshot telephonySubscriptionSnapshot, UnderlyingNetworkRecord underlyingNetworkRecord, PersistableBundleUtils.PersistableBundleWrapper persistableBundleWrapper) {
    ...
    public class Builder {
        ...
        public UnderlyingNetworkRecord build(VcnContext vcnContext, List list, ParcelUuid parcelUuid, TelephonySubscriptionTracker.TelephonySubscriptionSnapshot telephonySubscriptionSnapshot, UnderlyingNetworkRecord underlyingNetworkRecord, PersistableBundleUtils.PersistableBundleWrapper persistableBundleWrapper) {
            if (!isValid()) {
