...
public class VcnGatewayConnection extends StateMachine {
    ...
    /* loaded from: classes3.dex */
    public class EventUnderlyingNetworkChangedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventSessionLostInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventTransformCreatedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventSetupCompletedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventDisconnectRequestedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventMigrationCompletedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventIkeConnectionInfoChangedInfo implements EventInfo {
    ...
    /* loaded from: classes3.dex */
    public class EventDataStallSuspectedInfo implements EventInfo {
    ...
    */
    public VcnGatewayConnection(com.android.server.vcn.VcnContext r17, android.os.ParcelUuid r18, com.android.server.vcn.TelephonySubscriptionTracker.TelephonySubscriptionSnapshot r19, android.net.vcn.VcnGatewayConnectionConfig r20, com.android.server.vcn.Vcn.VcnGatewayStatusCallback r21, boolean r22, com.android.server.vcn.VcnGatewayConnection.Dependencies r23) {
        /*
            Method dump skipped, instructions count: 272
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.vcn.VcnGatewayConnection.<init>(com.android.server.vcn.VcnContext, android.os.ParcelUuid, com.android.server.vcn.TelephonySubscriptionTracker$TelephonySubscriptionSnapshot, android.net.vcn.VcnGatewayConnectionConfig, com.android.server.vcn.Vcn$VcnGatewayStatusCallback, boolean, com.android.server.vcn.VcnGatewayConnection$Dependencies):void");
    }
    ...
    public LinkProperties buildConnectedLinkProperties(VcnGatewayConnectionConfig vcnGatewayConnectionConfig, IpSecManager.IpSecTunnelInterface ipSecTunnelInterface, VcnChildSessionConfiguration vcnChildSessionConfiguration, UnderlyingNetworkRecord underlyingNetworkRecord, IkeSessionConnectionInfo ikeSessionConnectionInfo) {
        ...
        Iterator it = vcnChildSessionConfiguration.getInternalAddresses().iterator();
        while (it.hasNext()) {
            linkProperties.addLinkAddress((LinkAddress) it.next());
        }
        Iterator it2 = vcnChildSessionConfiguration.getInternalDnsServers().iterator();
        while (it2.hasNext()) {
    ...
    public class Dependencies {
        ...
        public VcnNetworkAgent newNetworkAgent(VcnContext vcnContext, String str, NetworkCapabilities networkCapabilities, LinkProperties linkProperties, NetworkScore networkScore, NetworkAgentConfig networkAgentConfig, NetworkProvider networkProvider, Consumer consumer, Consumer consumer2) {
    ...
    public class VcnNetworkAgent {
        ...
        public VcnNetworkAgent(VcnContext vcnContext, String str, NetworkCapabilities networkCapabilities, LinkProperties linkProperties, NetworkScore networkScore, NetworkAgentConfig networkAgentConfig, NetworkProvider networkProvider, final Consumer consumer, final Consumer consumer2) {
        ...
        public void setUnderlyingNetworks(List list) {
