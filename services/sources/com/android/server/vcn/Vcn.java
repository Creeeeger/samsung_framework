...
public class Vcn extends Handler {
    ...
    public final void handleTeardown() {
        ...
        while (it2.hasNext()) {
            getTelephonyManager().unregisterTelephonyCallback((VcnUserMobileDataStateListener) it2.next());
        }
    ...
    public final Set getExposedCapabilitiesForMobileDataState(VcnGatewayConnectionConfig vcnGatewayConnectionConfig) {
