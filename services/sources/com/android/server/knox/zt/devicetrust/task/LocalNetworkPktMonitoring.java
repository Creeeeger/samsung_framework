...
public final class LocalNetworkPktMonitoring extends NetworkEventMonitoring {
    public LocalNetworkPktMonitoring(int i, int i2, int i3, int i4, int i5, IEndpointMonitorListener iEndpointMonitorListener, EndpointMonitorImpl.Injector injector) {
