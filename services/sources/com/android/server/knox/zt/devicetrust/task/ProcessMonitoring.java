...
public final class ProcessMonitoring extends ReschedulableMonitoringTask {
    public ProcessMonitoring(int i, int i2, int i3, int i4, IEndpointMonitorListener iEndpointMonitorListener, Predicate predicate, EndpointMonitorImpl.Injector injector) {
