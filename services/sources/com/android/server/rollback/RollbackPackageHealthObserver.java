...
public final class RollbackPackageHealthObserver implements PackageWatchdog.PackageHealthObserver {
    ...
    public final void lambda$onBootCompletedAsync$4() {
        ...
        for (int i = 0; i < popLastStagedRollbackIds.size(); i++) {
            WatchdogRollbackLogger.logRollbackStatusOnBoot(this.mContext, popLastStagedRollbackIds.keyAt(i), (String) popLastStagedRollbackIds.valueAt(i), rollbackManager.getRecentlyCommittedRollbacks());
        }
    }
    ...
    public final void lambda$execute$1(final RollbackInfo rollbackInfo, VersionedPackage versionedPackage, int i) {
        ...
        final Consumer consumer = new Consumer() { // from class: com.android.server.rollback.RollbackPackageHealthObserver$$ExternalSyntheticLambda5
        ...
        rollbackManager.commitRollback(rollbackInfo.getRollbackId(), Collections.singletonList(versionedPackage), new LocalIntentReceiver(new Consumer() { // from class: com.android.server.rollback.RollbackPackageHealthObserver$$ExternalSyntheticLambda6
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$rollbackPackage$5(RollbackInfo rollbackInfo, VersionedPackage versionedPackage, int i, String str, Intent intent) {
        ...
        if (rollbackInfo.isStaged()) {
            ...
            if (isPendingStagedSessionsEmpty()) {
                ...
                PmLog.logCriticalInfoAndLogcat("Rollback staged install. id: " + rollbackInfo.getRollbackId());
