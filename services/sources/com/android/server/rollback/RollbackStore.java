...
public class RollbackStore {
    ...
    public void saveRollbackToHistory(Rollback rollback) {
        ...
        saveRollback(rollback, new File(this.mRollbackHistoryDir, num + PackageManagerShellCommandDataLoader.STDIN_PATH + hexString));
    }
