...
public class LocationTimeZoneProviderController implements Dumpable {
    ...
    public final LocationTimeZoneAlgorithmStatus generateCurrentAlgorithmStatus() {
        return createAlgorithmStatus((String) this.mState.get(), this.mPrimaryProvider.getCurrentState(), this.mSecondaryProvider.getCurrentState());
    }
    ...
    public LocationTimeZoneManagerServiceState getStateForTests() {
        ...
        synchronized (this.mSharedLock) {
            ...
            builder.setControllerState((String) this.mState.get()).setStateChanges(this.mRecordedStates).setPrimaryProviderStateChanges(this.mPrimaryProvider.getRecordedStates()).setSecondaryProviderStateChanges(this.mSecondaryProvider.getRecordedStates());
            build = builder.build();
        }
        return build;
    }
