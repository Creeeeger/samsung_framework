...
public final class MetricsTimeZoneDetectorState {
    ...
    public static MetricsTimeZoneSuggestion createMetricsTimeZoneSuggestion(OrdinalGenerator ordinalGenerator, ManualTimeZoneSuggestion manualTimeZoneSuggestion, boolean z) {
    ...
    public static MetricsTimeZoneSuggestion createMetricsTimeZoneSuggestion(OrdinalGenerator ordinalGenerator, TelephonyTimeZoneSuggestion telephonyTimeZoneSuggestion, boolean z) {
    ...
    public static MetricsTimeZoneSuggestion createMetricsTimeZoneSuggestion(OrdinalGenerator ordinalGenerator, GeolocationTimeZoneSuggestion geolocationTimeZoneSuggestion, boolean z) {
        if (geolocationTimeZoneSuggestion == null) {
            return null;
        }
        List zoneIds = geolocationTimeZoneSuggestion.getZoneIds();
        if (zoneIds == null) {
            return MetricsTimeZoneSuggestion.createUncertain();
        }
