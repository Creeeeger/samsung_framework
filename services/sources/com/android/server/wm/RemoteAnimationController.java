...
public class RemoteAnimationController implements IBinder.DeathRecipient {
    ...
    public RemoteAnimationRecord createRemoteAnimationRecord(WindowContainer windowContainer, Point point, Rect rect, Rect rect2, Rect rect3, boolean z, boolean z2) {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 2022422429, 0, "createAnimationAdapter(): container=%s", new Object[]{String.valueOf(windowContainer)});
        }
    ...
    public void goodToGo(final int i) {
        if (ProtoLogCache.WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS, -1061122674, 0, "goodToGo(%s)", new Object[]{String.valueOf(this)});
        }
        if (this.mCanceled) {
            if (ProtoLogCache.WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS, -1621026117, 0, "goodToGo(%s): Animation canceled already", new Object[]{String.valueOf(this)});
            }
            onAnimationFinished();
        ...
        if (createAppAnimations.length == 0 && !AppTransition.isKeyguardOccludeTransitOld(i)) {
            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -1777196134, 1, "goodToGo(): No apps to animate, mPendingAnimations=%d", new Object[]{Long.valueOf(this.mPendingAnimations.size())});
            }
            onAnimationFinished();
        ...
        if (CoreRune.FW_MERGE_REMOTE_ANIMATION && this.mRemoteAnimationAdapter.getMergeCallback() != null) {
            ...
            if (remoteAnimationAdapter.getMergeDurationHint() > 0) {
                this.mHandler.postDelayed(new Runnable() { // from class: com.android.server.wm.RemoteAnimationController$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        RemoteAnimationController.this.lambda$goodToGo$1();
                    }
                }, ((float) this.mRemoteAnimationAdapter.getMergeDurationHint()) * this.mService.getCurrentAnimatorScale());
            }
        }
        this.mService.mAnimator.addAfterPrepareSurfacesRunnable(new Runnable() { // from class: com.android.server.wm.RemoteAnimationController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                RemoteAnimationController.this.lambda$goodToGo$2(i, createAppAnimations, createWallpaperAnimations, createNonAppWindowAnimations);
            }
        });
    ...
    public /* synthetic */ void lambda$goodToGo$1() {
        ...
        Slog.d(StartingSurfaceController.TAG, "mergeAnimation is timeout, durationHint=" + this.mRemoteAnimationAdapter.getMergeDurationHint());
        this.mRemoteAnimationAdapter.mMergedState = -1;
    }

    public /* synthetic */ void lambda$goodToGo$2(int i, RemoteAnimationTarget[] remoteAnimationTargetArr, RemoteAnimationTarget[] remoteAnimationTargetArr2, RemoteAnimationTarget[] remoteAnimationTargetArr3) {
        try {
            linkToDeathOfRunner();
            if (ProtoLogCache.WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS, 1853433901, 336, "goodToGo(%s): onAnimationStart, transit=%s, apps=%d, wallpapers=%d, nonApps=%d", new Object[]{String.valueOf(this), String.valueOf(AppTransition.appTransitionOldToString(i)), Long.valueOf(remoteAnimationTargetArr.length), Long.valueOf(remoteAnimationTargetArr2.length), Long.valueOf(remoteAnimationTargetArr3.length)});
            }
        ...
        if (ProtoLogImpl.isEnabled(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS)) {
            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -2012562539, 0, "startAnimation(): Notify animation start:", (Object[]) null);
            }
    ...
    public void cancelAnimation(String str) {
        if (ProtoLogCache.WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS, 235463101, 0, "cancelAnimation(%s): reason=%s", new Object[]{String.valueOf(this), String.valueOf(str)});
        }
    ...
    public final void writeStartDebugStatement() {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.i(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 1964565370, 0, "Starting remote animation", (Object[]) null);
        }
        ...
        for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
            ((RemoteAnimationRecord) this.mPendingAnimations.get(size)).mAdapter.dump(fastPrintWriter, "");
        }
        fastPrintWriter.close();
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.i(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 835814848, 0, "%s", new Object[]{String.valueOf(stringWriter.toString())});
        }
    }

    public final RemoteAnimationTarget[] createAppAnimations() {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -653156702, 0, "createAppAnimations()", (Object[]) null);
        }
        ...
        for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
            ...
            if (createRemoteAnimationTarget != null) {
                if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                    ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -1248645819, 0, "\tAdd container=%s", new Object[]{String.valueOf(remoteAnimationRecord.mWindowContainer)});
                }
                arrayList.add(createRemoteAnimationTarget);
            } else {
                if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                    ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 638429464, 0, "\tRemove container=%s", new Object[]{String.valueOf(remoteAnimationRecord.mWindowContainer)});
                }
    ...
    public final RemoteAnimationTarget[] createWallpaperAnimations() {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 594260577, 0, "createWallpaperAnimations()", (Object[]) null);
        }
        return WallpaperAnimationAdapter.startWallpaperAnimations(this.mDisplayContent, this.mRemoteAnimationAdapter.getDuration(), this.mRemoteAnimationAdapter.getStatusBarTransitionDelay(), new Consumer() { // from class: com.android.server.wm.RemoteAnimationController$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                RemoteAnimationController.this.lambda$createWallpaperAnimations$3((WallpaperAnimationAdapter) obj);
            }
        }, this.mPendingWallpaperAnimations);
    }

    public /* synthetic */ void lambda$createWallpaperAnimations$3(WallpaperAnimationAdapter wallpaperAnimationAdapter) {
    ...
    public final RemoteAnimationTarget[] createNonAppWindowAnimations(int i) {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -1834214907, 0, "createNonAppWindowAnimations()", (Object[]) null);
        }
    ...
    public final void onAnimationFinished() {
        ...
        if (ProtoLogCache.WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS, 923903658, 4, "onAnimationFinished(%s): mPendingAnimations=%d, caller=%s", new Object[]{String.valueOf(this), Long.valueOf(this.mPendingAnimations.size()), String.valueOf(CoreRune.SAFE_DEBUG ? Debug.getCallers(3) : "")});
        }
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                ...
                try {
                    try {
                        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 557227556, 0, "onAnimationFinished(): Notify animation finished:", (Object[]) null);
                        }
                        for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
                            RemoteAnimationRecord remoteAnimationRecord = (RemoteAnimationRecord) this.mPendingAnimations.get(size);
                            RemoteAnimationAdapterWrapper remoteAnimationAdapterWrapper = remoteAnimationRecord.mAdapter;
                            ...
                            if (!CoreRune.MW_MULTI_SPLIT && remoteAnimationRecord.mWindowContainer.asTask() != null && remoteAnimationRecord.mWindowContainer.inSplitScreenWindowingMode() && (topChild = remoteAnimationRecord.mWindowContainer.getTopChild()) != null && topChild.asTask() != null && !topChild.asTask().canAffectSystemUiFlags()) {
                                topChild.asTask().setCanAffectSystemUiFlags(true);
                            }
                            this.mPendingAnimations.remove(size);
                            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 972354148, 0, "\tcontainer=%s", new Object[]{String.valueOf(remoteAnimationRecord.mWindowContainer)});
                            }
                        }
                        for (int size2 = this.mPendingWallpaperAnimations.size() - 1; size2 >= 0; size2--) {
                            ...
                            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -853404763, 0, "\twallpaper=%s", new Object[]{String.valueOf(wallpaperAnimationAdapter.getToken())});
                            }
                        }
                        for (int size3 = this.mPendingNonAppAnimations.size() - 1; size3 >= 0; size3--) {
                            ...
                            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 1931178855, 0, "\tnonApp=%s", new Object[]{String.valueOf(nonAppWindowAnimationAdapter.getWindowContainer())});
                            }
                        }
        ...
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.i(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 248210157, 0, "Finishing remote animation", (Object[]) null);
        }
    }

    public final void invokeAnimationCancelled(String str) {
        if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
            ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, 1891501279, 0, "cancelAnimation(): reason=%s", new Object[]{String.valueOf(str)});
        }
        try {
    ...
    public final class FinishedCallback extends IRemoteAnimationFinishedCallback.Stub {
        ...
        public void onAnimationFinished() {
            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -2024464438, 0, "app-onAnimationFinished(): mOuter=%s", new Object[]{String.valueOf(this.mOuter)});
            }
        ...
        public void release() {
            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -2109864870, 0, "app-release(): mOuter=%s", new Object[]{String.valueOf(this.mOuter)});
            }
            this.mOuter = null;
        }
    }
    ...
    public class RemoteAnimationRecord {
        ...
        public boolean hasAnimatingParent() {
            for (int size = RemoteAnimationController.this.mDisplayContent.mChangingContainers.size() - 1; size >= 0; size--) {
                if (this.mWindowContainer.isDescendantOf((WindowContainer) RemoteAnimationController.this.mDisplayContent.mChangingContainers.valueAt(size))) {
                    return true;
                }
            }
            return false;
    ...
    public class RemoteAnimationAdapterWrapper implements AnimationAdapter {
        ...
        public void startAnimation(SurfaceControl surfaceControl, SurfaceControl.Transaction transaction, int i, SurfaceAnimator.OnAnimationFinishedCallback onAnimationFinishedCallback) {
            if (ProtoLogCache.WM_DEBUG_REMOTE_ANIMATIONS_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS, -1596995693, 0, "startAnimation", (Object[]) null);
            }
