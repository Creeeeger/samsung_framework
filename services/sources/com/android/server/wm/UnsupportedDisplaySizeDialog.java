...
public class UnsupportedDisplaySizeDialog extends AppWarnings.BaseDialog {
    public UnsupportedDisplaySizeDialog(final AppWarnings appWarnings, Context context, ApplicationInfo applicationInfo) {
        ...
        AlertDialog create = new AlertDialog.Builder(context).setPositiveButton(R.string.ok, (DialogInterface.OnClickListener) null).setMessage(context.getString(17043093, applicationInfo.loadSafeLabel(context.getPackageManager(), 1000.0f, 5))).setView(17367507).create();
        this.mDialog = create;
        create.create();
