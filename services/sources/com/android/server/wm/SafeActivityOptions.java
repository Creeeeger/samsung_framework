...
public class SafeActivityOptions {
    ...
    public SafeActivityOptions selectiveCloneLaunchOptions() {
        ...
        if (this.mShouldCheckFreeform) {
            ...
            ActivityOptions activityOptions2 = this.mOriginalOptions;
            ...
            int launchWindowingMode2 = activityOptions3 != null ? activityOptions3.getLaunchWindowingMode() : 0;
            ActivityOptions activityOptions4 = this.mCallerOptions;
            Rect launchBounds2 = activityOptions4 != null ? activityOptions4.getLaunchBounds() : null;
            if (launchWindowingMode == 5) {
                cloneLaunchingOptions.setLaunchWindowingMode(5);
            }
            if (launchBounds != null) {
                cloneLaunchingOptions.setLaunchBounds(launchBounds);
            }
            if (launchWindowingMode2 == 5) {
                cloneLaunchingOptions2.setLaunchWindowingMode(5);
            }
            if (launchBounds2 != null) {
                cloneLaunchingOptions2.setLaunchBounds(launchBounds2);
            }
            this.mShouldCheckFreeform = false;
        }
    ...
    public SafeActivityOptions selectiveCloneLaunchOptions(boolean z) {
        this.mShouldCheckFreeform = z;
        return selectiveCloneLaunchOptions();
    }
    ...
    public ActivityOptions getOptions(ActivityRecord activityRecord) {
        return getOptions(activityRecord.intent, activityRecord.info, activityRecord.app, activityRecord.mTaskSupervisor);
    }

    public ActivityOptions getOptions(ActivityTaskSupervisor activityTaskSupervisor) {
        return getOptions(null, null, null, activityTaskSupervisor);
    }

    public ActivityOptions getOptions(Intent intent, ActivityInfo activityInfo, WindowProcessController windowProcessController, ActivityTaskSupervisor activityTaskSupervisor) {
        ActivityOptions activityOptions = this.mOriginalOptions;
        if (activityOptions != null) {
    ...
    public final void checkPermissions(Intent intent, ActivityInfo activityInfo, WindowProcessController windowProcessController, ActivityTaskSupervisor activityTaskSupervisor, ActivityOptions activityOptions, int i, int i2) {
        ...
        if (((CoreRune.FW_CUSTOM_SHELL_TRANSITION_LATE_TRANSIENT_LAUNCH && activityOptions.getLateTransientLaunch()) || activityOptions.getTransientLaunch()) && !activityTaskSupervisor.mRecentTasks.isCallerRecents(i2) && ActivityTaskManagerService.checkPermission("android.permission.MANAGE_ACTIVITY_TASKS", i, i2) == -1) {
        ...
        Slog.w("ActivityTaskManager", str11);
