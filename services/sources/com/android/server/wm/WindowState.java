...
public class WindowState extends WindowContainer implements WindowManagerPolicy.WindowState, InputTarget {
    ...
    /* loaded from: classes3.dex */
    public class AnonymousClass2 implements PowerManagerWrapper {
        public AnonymousClass2() {
        }

        @Override // com.android.server.wm.WindowState.PowerManagerWrapper
        public void wakeUp(long j, int i, String str) {
            WindowManagerService.this.mPowerManager.wakeUp(j, i, str);
        }
    ...
    */
    public WindowState(com.android.server.wm.WindowManagerService r23, com.android.server.wm.Session r24, android.view.IWindow r25, com.android.server.wm.WindowToken r26, com.android.server.wm.WindowState r27, int r28, android.view.WindowManager.LayoutParams r29, int r30, int r31, int r32, boolean r33, com.android.server.wm.WindowState.PowerManagerWrapper r34) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void getVisibleBounds(android.graphics.Rect r9) {
        /*
            r8 = this;
    ...
    public class DeathRecipient implements IBinder.DeathRecipient {
        public /* synthetic */ DeathRecipient(WindowState windowState, DeathRecipientIA deathRecipientIA) {
            this();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0040 A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean showForAllUsers() {
        ...
        L2b:
            com.android.server.wm.WindowManagerService r1 = r2.mWmService
            com.android.server.wm.WindowManagerServiceExt r1 = r1.mExt
            boolean r0 = r1.showForAllUsers(r0)
            if (r0 == 0) goto L36
            goto L40
        L36:
            android.view.WindowManager$LayoutParams r0 = r2.mAttrs
            ...
            return r2
        L40:
            boolean r2 = r2.mOwnerCanAddInternalSystemWindow
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wm.WindowState.showForAllUsers():boolean");
    }
    ...
    public final class WindowId extends IWindowId.Stub {
        ...
        public /* synthetic */ WindowId(WindowState windowState, WindowIdIA windowIdIA) {
            this(windowState);
        }
    ...
    public final class MoveAnimationSpec implements LocalAnimationAdapter.AnimationSpec {
        ...
        public /* synthetic */ MoveAnimationSpec(WindowState windowState, int i, int i2, int i3, int i4, MoveAnimationSpecIA moveAnimationSpecIA) {
            this(i, i2, i3, i4);
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean finishDrawing(android.view.SurfaceControl.Transaction r14, int r15) {
        /*
    ...
    public final int getSamsungAnimResId() {
        ...
        if (!CoreRune.SAFE_DEBUG) {
            return R.anim.ft_avd_tooverflow_rectangle_1_animation;
        }
