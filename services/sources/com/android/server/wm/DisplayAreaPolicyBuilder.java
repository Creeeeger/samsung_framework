...
class DisplayAreaPolicyBuilder {
    ...
    private void validate() {
        ...
        for (int i = 0; i < this.mDisplayAreaGroupHierarchyBuilders.size(); i++) {
            HierarchyBuilder hierarchyBuilder = (HierarchyBuilder) this.mDisplayAreaGroupHierarchyBuilders.get(i);
    ...
    /* loaded from: classes3.dex */
    public class DefaultSelectRootForWindowFunction implements BiFunction {
    ...
    /* loaded from: classes3.dex */
    public class DefaultSelectTaskDisplayAreaFunction implements Function {
    ...
    public class HierarchyBuilder {
        ...
        public HierarchyBuilder setTaskDisplayAreas(List list) {
        ...
        public final void build(List list) {
            ...
            for (int i2 = 0; i2 < this.mFeatures.size(); i2++) {
                arrayMap.put((Feature) this.mFeatures.get(i2), new ArrayList());
            }
            ...
            int i3 = 0;
            while (i3 < size) {
                Feature feature = (Feature) this.mFeatures.get(i3);
        ...
        public final void addTaskDisplayAreasToApplicationLayer(PendingArea pendingArea) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                pendingArea2.mExisting = (DisplayArea) this.mTaskDisplayAreas.get(i);
                pendingArea2.mMaxLayer = 2;
                pendingArea.mChildren.add(pendingArea2);
            }
        }

        public final void addDisplayAreaGroupsToApplicationLayer(PendingArea pendingArea, List list) {
            if (list == null) {
                return;
            }
            int size = list.size();
            for (int i = 0; i < size; i++) {
                PendingArea pendingArea2 = new PendingArea(null, 2, pendingArea);
                pendingArea2.mExisting = ((HierarchyBuilder) list.get(i)).mRoot;
                pendingArea2.mMaxLayer = 2;
                pendingArea.mChildren.add(pendingArea2);
            }
        }
    ...
    public class Feature {
        ...
        public /* synthetic */ Feature(String str, int i, boolean[] zArr, NewDisplayAreaSupplier newDisplayAreaSupplier, FeatureIA featureIA) {
            this(str, i, zArr, newDisplayAreaSupplier);
        }
    ...
    /* loaded from: classes3.dex */
    public class Result extends DisplayAreaPolicy {
        public final TaskDisplayArea mDefaultTaskDisplayArea;
        public final List mDisplayAreaGroupRoots;
        public final BiFunction mSelectRootForWindowFunc;
        public final Function mSelectTaskDisplayAreaFunc;

        public Result(WindowManagerService windowManagerService, RootDisplayArea rootDisplayArea, List list, BiFunction biFunction, Function function) {
        ...
        public DisplayArea.Tokens findAreaForWindowType(int i, Bundle bundle, boolean z, boolean z2) {
            return ((RootDisplayArea) this.mSelectRootForWindowFunc.apply(Integer.valueOf(i), bundle)).findAreaForWindowTypeInLayer(i, z, z2);
        }
        ...
        @Override // com.android.server.wm.DisplayAreaPolicy
        public List getDisplayAreas(int i) {
            ArrayList arrayList = new ArrayList();
            getDisplayAreas(this.mRoot, i, arrayList);
            for (int i2 = 0; i2 < this.mDisplayAreaGroupRoots.size(); i2++) {
                getDisplayAreas((RootDisplayArea) this.mDisplayAreaGroupRoots.get(i2), i, arrayList);
            }
            return arrayList;
        }

        public static void getDisplayAreas(RootDisplayArea rootDisplayArea, int i, List list) {
            List list2 = rootDisplayArea.mFeatures;
            for (int i2 = 0; i2 < list2.size(); i2++) {
                Feature feature = (Feature) list2.get(i2);
                if (feature.mId == i) {
                    list.addAll((Collection) rootDisplayArea.mFeatureToDisplayAreas.get(feature));
                }
            }
        }
        ...
        public TaskDisplayArea getTaskDisplayArea(Bundle bundle) {
            return (TaskDisplayArea) this.mSelectTaskDisplayAreaFunc.apply(bundle);
        }
    }

    /* loaded from: classes3.dex */
    public class PendingArea {
        ...
        public void instantiateChildren(DisplayArea displayArea, DisplayArea.Tokens[] tokensArr, int i, Map map) {
            ...
            for (int i2 = 0; i2 < this.mChildren.size(); i2++) {
                ...
                if (createArea != null) {
                    ...
                    if (feature != null) {
                        ((List) map.get(feature)).add(createArea);
                    }
        ...
        public final DisplayArea createArea(DisplayArea displayArea, DisplayArea.Tokens[] tokensArr) {
            ...
            if (feature == null) {
                DisplayArea.Tokens tokens = new DisplayArea.Tokens(displayArea.mWmService, type, "Leaf:" + this.mMinLayer + XmlUtils.STRING_ARRAY_SEPARATOR + this.mMaxLayer);
                fillAreaForLayers(tokens, tokensArr);
                return tokens;
            }
            return feature.mNewDisplayAreaSupplier.create(displayArea.mWmService, type, this.mFeature.mName + XmlUtils.STRING_ARRAY_SEPARATOR + this.mMinLayer + XmlUtils.STRING_ARRAY_SEPARATOR + this.mMaxLayer, this.mFeature.mId);
        }
