...
public class UnsupportedCompileSdkDialog extends AppWarnings.BaseDialog {
    public UnsupportedCompileSdkDialog(final AppWarnings appWarnings, final Context context, ApplicationInfo applicationInfo) {
        ...
        AlertDialog.Builder view = new AlertDialog.Builder(context).setPositiveButton(R.string.ok, (DialogInterface.OnClickListener) null).setMessage(context.getString(17043091, applicationInfo.loadSafeLabel(context.getPackageManager(), 1000.0f, 5))).setView(17367506);
        final Intent createIntent = AppInstallerUtil.createIntent(context, applicationInfo.packageName);
        if (createIntent != null) {
            view.setNeutralButton(17043090, new DialogInterface.OnClickListener() { // from class: com.android.server.wm.UnsupportedCompileSdkDialog$$ExternalSyntheticLambda0
        ...
        CheckBox checkBox = (CheckBox) this.mDialog.findViewById(R.id.button5);
