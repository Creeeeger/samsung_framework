...
public final class ImeInsetsSourceProvider extends InsetsSourceProvider {
    ...
    public void setClientVisible(boolean z) {
        ...
        if (displayContent.isDefaultDisplay && displayContent.mAtmService.mDexController.getDexModeLocked() == 2) {
            this.mDisplayContent.mAtmService.mDexController.onDexImeClientVisibleChangedLocked(z);
        }
    }
    ...
    public void scheduleShowImePostLayout(InsetsControlTarget insetsControlTarget, ImeTracker.Token token) {
        ...
        if (isTargetChangedWithinActivity) {
            ...
            if (this.mImeRequester.getWindow() != null && this.mImeRequester.getWindow().inFreeformWindowingMode() && this.mImeRequester.getWindow().isGoneForLayout()) {
