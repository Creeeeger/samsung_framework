...
public class AppTransitionController {
    ...
    public final WindowState getOldWallpaper() {
        ...
        boolean z = true;
        ArraySet animationTargets = getAnimationTargets(displayContent.mOpeningApps, displayContent.mClosingApps, true);
        if (wallpaperTarget == null || (!wallpaperTarget.hasWallpaper() && ((firstAppTransition != 1 && firstAppTransition != 3) || animationTargets.isEmpty() || ((WindowContainer) animationTargets.valueAt(0)).asTask() == null || !this.mWallpaperControllerLocked.isWallpaperVisible()))) {
            z = false;
        }
    ...
    public void handleAppTransitionReady() {
        ...
        if (transitionGoodToGo(this.mDisplayContent.mOpeningApps, this.mTempTransitionReasons) && transitionGoodToGo(this.mDisplayContent.mChangingContainers, this.mTempTransitionReasons) && transitionGoodToGoForTaskFragments()) {
            ...
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS, -240296576, 1, (String) null, new Object[]{Long.valueOf(r2.mDisplayId), String.valueOf(appTransition.toString()), String.valueOf(arraySet), String.valueOf(arraySet2), String.valueOf(AppTransition.appTransitionOldToString(transitCompatType))});
            }
            ...
            try {
                if (AppTransition.isKeyguardGoingAwayTransitOld(transitCompatType)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (activityRecord.mPopOverState.isActivated() && activityRecord.getTask() != null) {
                            activityRecord.getTask().forAllActivities(new Consumer() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda2
                                @Override // java.util.function.Consumer
                                public final void accept(Object obj) {
                                    AppTransitionController.lambda$handleAppTransitionReady$0(arraySet8, arraySet9, (ActivityRecord) obj);
                                }
                            });
                        }
                    }
                ...
                if (CoreRune.FW_CUSTOM_BASIC_ANIM_WITH_DIM && topApp2 != null && topApp != null && (!topApp2.isAppTransitioning() || !topApp.isAppTransitioning())) {
    ...
    public static /* synthetic */ void lambda$handleAppTransitionReady$0(ArraySet arraySet, ArraySet arraySet2, ActivityRecord activityRecord) {
        if (!activityRecord.isVisible() || arraySet.contains(activityRecord) || arraySet2.contains(activityRecord)) {
            return;
        }
    ...
    public static int getTransitCompatType(AppTransition appTransition, ArraySet arraySet, ArraySet arraySet2, ArraySet arraySet3, WindowState windowState, WindowState windowState2, boolean z) {
        ...
        WindowContainer windowContainer = !animationTargets.isEmpty() ? (WindowContainer) animationTargets.valueAt(0) : null;
        WindowContainer windowContainer2 = animationTargets2.isEmpty() ? null : (WindowContainer) animationTargets2.valueAt(0);
    ...
    public final ITaskFragmentOrganizer findTaskFragmentOrganizer(Task task) {
        ...
        if (!task.forAllLeafTaskFragments(new Predicate() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda9
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$findTaskFragmentOrganizer$1;
                lambda$findTaskFragmentOrganizer$1 = AppTransitionController.lambda$findTaskFragmentOrganizer$1(iTaskFragmentOrganizerArr, (TaskFragment) obj);
    ...
    public static /* synthetic */ boolean lambda$findTaskFragmentOrganizer$1(ITaskFragmentOrganizer[] iTaskFragmentOrganizerArr, TaskFragment taskFragment) {
    ...
    public final boolean overrideWithTaskFragmentRemoteAnimation(int i, ArraySet arraySet) {
        ...
        if (z && remoteAnimationController != null) {
            remoteAnimationController.setOnRemoteAnimationReady(new Runnable() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda7
    ...
    public static /* synthetic */ void lambda$overrideWithTaskFragmentRemoteAnimation$3(Task task) {
        task.forAllActivities(new Consumer() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda8
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public final ActivityRecord findAnimLayoutParamsToken(final int i, final ArraySet arraySet, ArraySet arraySet2, ArraySet arraySet3, ArraySet arraySet4) {
        ActivityRecord lookForHighestTokenWithFilter = lookForHighestTokenWithFilter(arraySet3, arraySet2, arraySet4, new Predicate() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$findAnimLayoutParamsToken$4;
                lambda$findAnimLayoutParamsToken$4 = AppTransitionController.lambda$findAnimLayoutParamsToken$4(i, arraySet, (ActivityRecord) obj);
        ...
        ActivityRecord lookForHighestTokenWithFilter2 = lookForHighestTokenWithFilter(arraySet3, arraySet2, arraySet4, new Predicate() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda5
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
        ...
        return lookForHighestTokenWithFilter2 != null ? lookForHighestTokenWithFilter2 : lookForHighestTokenWithFilter(arraySet3, arraySet2, arraySet4, new Predicate() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$findAnimLayoutParamsToken$6;
                lambda$findAnimLayoutParamsToken$6 = AppTransitionController.lambda$findAnimLayoutParamsToken$6((ActivityRecord) obj);
                return lambda$findAnimLayoutParamsToken$6;
            }
        });
    }

    public static /* synthetic */ boolean lambda$findAnimLayoutParamsToken$4(int i, ArraySet arraySet, ActivityRecord activityRecord) {
    ...
    public static ArraySet getAnimationTargets(ArraySet arraySet, ArraySet arraySet2, boolean z) {
        ...
        for (int i = 0; i < arraySet3.size(); i++) {
            ...
            if (activityRecord.shouldApplyAnimation(z)) {
                ...
                if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
                    ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS, 1967975839, 60, (String) null, new Object[]{String.valueOf(activityRecord), Boolean.valueOf(activityRecord.isVisible()), Boolean.FALSE});
                }
            }
        }
        if (z) {
    ...
    public final void applyAnimations(ArraySet arraySet, ArraySet arraySet2, int i, WindowManager.LayoutParams layoutParams, boolean z) {
        ...
        ArraySet animationTargets = getAnimationTargets(arraySet, arraySet2, true);
        applyAnimations(getAnimationTargets(arraySet, arraySet2, false), arraySet2, i, false, layoutParams, z);
    ...
    public final void handleOpeningApps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS, 1628345525, 0, (String) null, new Object[]{String.valueOf(activityRecord)});
            }
    ...
    public final void handleClosingApps() {
        ...
        for (int i = 0; i < size; i++) {
            ActivityRecord activityRecord = (ActivityRecord) arraySet.valueAt(i);
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS, 794570322, 0, (String) null, new Object[]{String.valueOf(activityRecord)});
            }
    ...
    public final void handleChangingApps(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            WindowContainer windowContainer = (WindowContainer) arraySet.valueAt(i2);
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS, 186668272, 0, (String) null, new Object[]{String.valueOf(windowContainer)});
            }
    ...
    public final boolean transitionGoodToGo(ArraySet arraySet, ArrayMap arrayMap) {
        ...
        if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED && CustomLetterboxConfiguration.isWaitingForEnhancedEnabled(this.mDisplayContent)) {
            return false;
        }
    ...
    public final boolean transitionGoodToGoForTaskFragments() {
        ...
        for (int size4 = arraySet.size() - 1; size4 >= 0; size4--) {
            ...
            if (task != null && task.forAllLeafTaskFragments(new Predicate() { // from class: com.android.server.wm.AppTransitionController$$ExternalSyntheticLambda3
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    boolean lambda$transitionGoodToGoForTaskFragments$7;
                    lambda$transitionGoodToGoForTaskFragments$7 = AppTransitionController.lambda$transitionGoodToGoForTaskFragments$7((TaskFragment) obj);
    ...
    public static /* synthetic */ boolean lambda$transitionGoodToGoForTaskFragments$7(TaskFragment taskFragment) {
