...
public final class VrController {
    ...
    public VrManagerInternal mVrService;
    ...
    /* renamed from: com.android.server.wm.VrController$1 */
    /* loaded from: classes3.dex */
    public class AnonymousClass1 extends IPersistentVrStateCallbacks.Stub {
        public AnonymousClass1() {
        }
    ...
    public final int setVrRenderThreadLocked(int i, int i2, boolean z) {
        ...
        if (!inVrMode || hasPersistentVrFlagSet || i2 != 3) {
            if (!z) {
                Slog.w("VrController", "Failed to set VR thread, " + (!inVrMode ? "system not in VR mode." : hasPersistentVrFlagSet ? "system in persistent VR mode." : "caller is not the current top application."));
            }
            return this.mVrRenderThreadTid;
        }
        return updateVrRenderThreadLocked(i, z);
