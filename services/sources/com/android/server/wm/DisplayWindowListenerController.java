...
public class DisplayWindowListenerController {
    public RemoteCallbackList mDisplayListeners = new RemoteCallbackList();
    ...
    public void dispatchKeepClearAreasChanged(DisplayContent displayContent, Set set, Set set2) {
        int beginBroadcast = this.mDisplayListeners.beginBroadcast();
        for (int i = 0; i < beginBroadcast; i++) {
            try {
