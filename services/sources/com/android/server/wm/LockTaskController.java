...
public class LockTaskController {
    ...
    public boolean activityBlockedFromFinish(final ActivityRecord activityRecord) {
        ...
        if (task.mLockTaskAuth != 4 && isRootTask(task)) {
            ...
            if (activityRecord != task.getRootActivity() || activityRecord != topNonFinishingActivity) {
                ...
                if (taskFragment.asTask() == null && ((taskFragment.isDelayLastActivityRemoval() || (CoreRune.MW_EMBED_ACTIVITY && taskFragment.isEmbedded())) && adjacentTaskFragment != null)) {
    ...
    public Task getRootTask() {
        ...
        return (Task) this.mLockTaskModeTasks.get(0);
    }
    ...
    public final boolean isEmergencyCallIntent(Intent intent) {
        ...
        return (systemDialerPackage == null || intent.getComponent() == null || !systemDialerPackage.equals(intent.getComponent().getPackageName())) ? false : true;
    }

    public void stopLockTaskMode(Task task, boolean z, int i) {
        if (i != 0) {
            this.mWindowManager.mExt.takeLockTaskLog(task, i, z, this.mLockTaskModeState);
        }
    ...
    public final void performStopLockTask(int i) {
        ...
        boolean z = this.mInteractionControlEnabled;
        this.mInteractionControlEnabled = false;
    ...
    public final void setLockTaskMode(final Task task, final int i, String str, boolean z) {
        ...
        this.mSupervisor.mService.mMultiWindowEnableController.dismissMultiWindowMode(0);
        if (!z) {
            if (i != 0) {
    ...
    public final void performStartLockTask(String str, int i, int i2) {
        IStatusBarService statusBarService;
        try {
            boolean isInteractionControlEnabled = this.mWindowManager.mExt.mPolicyExt.isInteractionControlEnabled();
            this.mInteractionControlEnabled = isInteractionControlEnabled;
            if (i2 == 2 && !isInteractionControlEnabled && (statusBarService = getStatusBarService()) != null) {
    ...
    public void updateLockTaskFeatures(final int i, int i2) {
        ...
        notifyLockTaskFeaturesChanged(this.mLockTaskFeatures);
    ...
    public final void setStatusBarState(int i, int i2) {
        ...
        if (i == 2) {
            ...
            Pair statusBarDisableFlags = getStatusBarDisableFlags(getLockTaskFeaturesForUser(i2));
    ...
    public final boolean shouldLockKeyguard(int i) {
        try {
            ...
            if (Settings.System.getInt(this.mContext.getContentResolver(), "access_control_use", 0) != 0) {
                return Settings.System.getInt(this.mContext.getContentResolver(), "interaction_control_exit_locked", 0) != 0;
            }
    ...
    public boolean isBaseOfLockedTask(String str) {
        for (int i = 0; i < this.mLockTaskModeTasks.size(); i++) {
            if (str.equals(((Task) this.mLockTaskModeTasks.get(i)).getBasePackageName())) {
                return true;
            }
        }
        return false;
    ...
    public void dump(PrintWriter printWriter, String str) {
        ...
        for (int i2 = 0; i2 < this.mLockTaskPackages.size(); i2++) {
            printWriter.println(str2 + "  u" + this.mLockTaskPackages.keyAt(i2) + XmlUtils.STRING_ARRAY_SEPARATOR + Arrays.toString((Object[]) this.mLockTaskPackages.valueAt(i2)));
        }
        printWriter.println();
    }
    ...
    /* loaded from: classes3.dex */
    public class LockTaskToken extends Binder {
        public LockTaskToken() {
        }
    }

    public final void notifyLockTaskStateChanged(int i) {
        this.mSupervisor.mService.mExt.onLockTaskStateChanged(i);
    }

    public final void notifyLockTaskFeaturesChanged(SparseIntArray sparseIntArray) {
        this.mWindowManager.mExt.onLockTaskFeaturesChanged(sparseIntArray);
    }
}
