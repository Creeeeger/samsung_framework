...
public class DisplayContent extends RootDisplayArea implements WindowManagerPolicy.DisplayContentInfo {
    ...
    public static /* synthetic */ boolean lambda$removeImeSurfaceByTarget$31(WindowState windowState, Object obj) {
    ...
    /* renamed from: com.android.server.wm.DisplayContent$1 */
    /* loaded from: classes3.dex */
    public class AnonymousClass1 implements InsetsState.OnTraverseCallbacks {
        public void onIdMatch(InsetsSource insetsSource, InsetsSource insetsSource2) {
            insetsSource.setVisible(insetsSource2.isVisible());
        }
    }
    ...
    public /* synthetic */ boolean lambda$new$3(WindowState windowState) {
        ...
        if (activityRecord2 != null && activityRecord2.getLastParentBeforePip() != null && activityRecord2 != this.mFocusedApp) {
            return false;
        }
        ...
        if (task != null && task.inFreeformWindowingMode() && ((task.isAlwaysOnTopFreeform() || task.isDexMode() || (CoreRune.MT_NEW_DEX_TASK_ORDERING && task.isNewDexMode())) && activityRecord2.compareTo((WindowContainer) activityRecord) > 0)) {
            if (ProtoLogCache.WM_DEBUG_FOCUS_LIGHT_enabled) {
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_FOCUS_LIGHT, 1644213761, 0, (String) null, new Object[]{String.valueOf(activityRecord2)});
            }
            this.mTmpWindow = null;
            return false;
        }
    ...
    public /* synthetic */ void lambda$new$8(WindowState windowState) {
        ...
        if (!z2) {
            ...
            if (windowState.mHasSurface && isDisplayed) {
                ...
                if (applySurfaceChangesTransactionState3.preferredRefreshRate == DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
                ...
                if (windowState.getWindowingMode() != 2) {
                    ...
                    if (applySurfaceChangesTransactionState4.preferredModeId == 0 && preferredModeId != 0) {
                        ...
                        if (CoreRune.FW_VRR_SYSTEM_HISTORY) {
                            getDisplayPolicy().getRefreshRatePolicy().updateLog(windowState, preferredModeId, -1.0f, 0);
                        }
                    }
                }
                ...
                if (applySurfaceChangesTransactionState5.preferredMinRefreshRate == DisplayPowerController2.RATE_FROM_DOZE_TO_ON && preferredMinRefreshRate != DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
                    applySurfaceChangesTransactionState5.preferredMinRefreshRate = preferredMinRefreshRate;
                    if (CoreRune.FW_VRR_SYSTEM_HISTORY) {
                        getDisplayPolicy().getRefreshRatePolicy().updateLog(windowState, -1, preferredMinRefreshRate, 1);
                    }
                }
                ...
                if (applySurfaceChangesTransactionState6.preferredMaxRefreshRate == DisplayPowerController2.RATE_FROM_DOZE_TO_ON && preferredMaxRefreshRate != DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
                    applySurfaceChangesTransactionState6.preferredMaxRefreshRate = preferredMaxRefreshRate;
                    if (CoreRune.FW_VRR_SYSTEM_HISTORY) {
                        getDisplayPolicy().getRefreshRatePolicy().updateLog(windowState, -1, preferredMaxRefreshRate, 2);
                    }
                }
            }
        }
    ...
    public DisplayContent(Display display, RootWindowContainer rootWindowContainer, DeviceStateController deviceStateController) {
        ...
        this.mUpdateAboveInsetsStateRunnable = new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda2
        ...
        this.mDisplayCutoutCache = new RotationCache(new RotationCache.RotationDependentComputation() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda7
        ...
        this.mRoundedCornerCache = new RotationCache(new RotationCache.RotationDependentComputation() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda9
            @Override // com.android.server.wm.utils.RotationCache.RotationDependentComputation
            public final Object compute(Object obj, int i) {
        ...
        this.mPrivacyIndicatorBoundsCache = new RotationCache(new RotationCache.RotationDependentComputation() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda10
            @Override // com.android.server.wm.utils.RotationCache.RotationDependentComputation
            public final Object compute(Object obj, int i) {
        ...
        this.mDisplayShapeCache = new RotationCache(new RotationCache.RotationDependentComputation() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda11
            @Override // com.android.server.wm.utils.RotationCache.RotationDependentComputation
            public final Object compute(Object obj, int i) {
        ...
        this.mRemoteInsetsControlTarget = null;
        this.mRemoteInsetsDeath = new IBinder.DeathRecipient() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda12
        ...
        this.mUpdateWindowsForAnimator = new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda13
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DisplayContent.this.lambda$new$1((WindowState) obj);
            }
        };
        this.mScheduleToastTimeout = new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda14
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DisplayContent.this.lambda$new$2((WindowState) obj);
            }
        };
        this.mFindFocusedWindow = new ToBooleanFunction() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda15
        ...
        this.mPerformLayout = new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda16
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DisplayContent.this.lambda$new$4((WindowState) obj);
            }
        };
        this.mPerformLayoutAttached = new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
        ...
        if (this.isDefaultDisplay && !TextUtils.isEmpty(this.mWmService.mContext.getString(R.string.fingerprint_name_template))) {
            this.mUdcCutoutPolicy = new UdcCutoutPolicy(this, new RotationCache(new RotationCache.RotationDependentComputation() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda7
                @Override // com.android.server.wm.utils.RotationCache.RotationDependentComputation
                public final Object compute(Object obj, int i) {
                    WmDisplayCutout calculateDisplayCutoutForRotationUncached;
                    calculateDisplayCutoutForRotationUncached = DisplayContent.this.calculateDisplayCutoutForRotationUncached((DisplayCutout) obj, i);
        ...
        if (displayId == 2) {
            this.mHoldScreenWakeLock = this.mWmService.mPowerManager.newWakeLock(536870922, "WindowManager(DexScreen)", displayId);
        } else {
            this.mHoldScreenWakeLock = this.mWmService.mPowerManager.newWakeLock(536870922, "WindowManager/displayId:" + displayId, displayId);
        }
        ...
        Consumer consumer = new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda8
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
        ...
        this.mCloseToSquareMaxAspectRatio = this.mWmService.mContext.getResources().getFloat(R.dimen.config_screenBrightnessSettingForVrMaximumFloat);
        ...
        if (CoreRune.FW_FLIP_RESTORE_DEFAULT_DISPLAY_DENSITY_IN_BOOT && !CoreRune.SAFE_DEBUG && displayId == 1) {
        ...
        if (this.isDefaultDisplay) {
            registerPointerEventListener(new SystemPerformancePointerEventListener(this.mWmService.mContext));
        }
        boolean z = this.mWmService.mContext.getResources().getBoolean(R.bool.kg_top_align_page_shrink_on_bouncer_visible);
        this.mInTouchMode = z;
        this.mWmService.mInputManager.setInTouchMode(z, WindowManagerService.MY_PID, WindowManagerService.MY_UID, true, displayId);
        if (displayId == 4 && (defaultDisplay = this.mRootWindowContainer.getDefaultDisplay()) != null && (coverPolicy = defaultDisplay.mDisplayPolicy.mExt.mCoverPolicy) != null) {
            coverPolicy.addViewCoverDisplay(this);
        }
        if (this.isDefaultDisplay) {
            MultiWindowPointerEventListener multiWindowPointerEventListener = new MultiWindowPointerEventListener(this.mWmService, this);
        ...
        if (applicationPolicy != null) {
            try {
                ...
                if (applicationPolicy.isApplicationFocusMonitoredAsUser(str2, i)) {
                    sendApplicationFocusMonitoringIntent(activityRecord.mActivityComponent.flattenToString(), str, i, isDexMode());
                }
    ...
    public final void sendApplicationFocusMonitoringIntent(String str, String str2, int i, boolean z) {
        Intent intent = new Intent("com.samsung.android.knox.intent.action.APPLICATION_FOCUS_CHANGE");
        ...
        this.mWmService.mH.post(new Runnable() { // from class: com.android.server.wm.DisplayContent.2
            public final /* synthetic */ Intent val$focusMonitorIntent;
            ...
            @Override // java.lang.Runnable
            public void run() {
                DisplayContent.this.mWmService.mContext.sendBroadcastAsUser(r2, UserHandle.ALL, "com.samsung.android.knox.permission.KNOX_APP_MGMT");
            }
        });
    }

    /* renamed from: com.android.server.wm.DisplayContent$2 */
    /* loaded from: classes3.dex */
    ...
    public final void configureSurfaces(SurfaceControl.Transaction transaction) {
        ...
        this.mWmService.mInputManager.configureGestureMonitorSurfaces(this.mDisplayId, this.mSurfaceControl);
    }
    ...
    public final int getMinimalTaskSizeDp() {
        ...
        resources.getValue(R.dimen.highlight_alpha_material_dark, typedValue, true);
        int i = typedValue.data;
        int i2 = (i >> 0) & 15;
        if (typedValue.type != 5 || i2 != 1) {
            throw new IllegalArgumentException("Resource ID #0x" + Integer.toHexString(R.dimen.highlight_alpha_material_dark) + " is not in valid type or unit");
        }
    ...
    public int rotationForActivityInDifferentOrientation(ActivityRecord activityRecord) {
        ...
        if (!WindowManagerService.ENABLE_FIXED_ROTATION_TRANSFORM || shouldIgnoreOrientationRequest(overrideOrientation) || (this.isDefaultDisplay && isDexMode())) {
            return -1;
        }
        if (overrideOrientation == 3 && (activity = getActivity(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda29
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
        ...
        if ((CoreRune.FW_ORIENTATION_CONTROL && activityRecord.mCompatRecord.mIsIgnoreOrientationRequest) || (!activityRecord.inMultiWindowMode() && activityRecord.getRequestedConfigurationOrientation(true) != getConfiguration().orientation)) {
            if (CoreRune.BAIDU_CARLIFE && isCarLifeDisplay()) {
                return -1;
            }
            if (CoreRune.FW_ORIENTATION_CONTROL && (adjustedOrientation = this.mAtmService.mExt.mOrientationController.getAdjustedOrientation(activityRecord, 0, true)) != -2) {
                int rotation = getRotation();
                int rotationForOrientation = this.mDisplayRotation.rotationForOrientation(adjustedOrientation, rotation);
                ...
                if (task != null && task.mOrientationControlEnabledAsAspectRatio) {
                    ...
                    if (i != this.mAtmService.mExt.mOrientationController.getPreferredConfigurationOrientation(activityRecord, i)) {
                        return -1;
                    }
                }
            ...
            int rotationForOrientation2 = this.mDisplayRotation.rotationForOrientation(activityRecord.getRequestedOrientation(), rotation2);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0069, code lost:
        ...
        if (r5.getTask().mInResumeTopActivity == false) goto L104;
     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x0058, code lost:
    
        if (r4.mOpeningApps.contains(r5) != false) goto L100;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean handleTopActivityLaunchingInDifferentOrientation(com.android.server.wm.ActivityRecord r5, com.android.server.wm.ActivityRecord r6, boolean r7) {
        /*
            r4 = this;
            boolean r0 = com.android.server.wm.WindowManagerService.ENABLE_FIXED_ROTATION_TRANSFORM
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            boolean r0 = r5.isFinishingFixedRotationTransform()
            if (r0 == 0) goto Ld
            return r1
        Ld:
            boolean r0 = r5.hasFixedRotationTransform()
            r2 = 1
            if (r0 == 0) goto L15
            return r2
        L15:
            boolean r0 = r5.occludesParent()
            if (r0 == 0) goto L21
            boolean r0 = r5.isReportedDrawn()
            if (r0 == 0) goto L37
        L21:
            com.android.server.wm.PopOverState r0 = r5.mPopOverState
            boolean r0 = r0.isActivated()
            if (r0 == 0) goto Lc7
            com.android.server.wm.ActivityRecord r0 = r4.mFixedRotationLaunchingApp
            if (r0 == 0) goto Lc7
            com.android.server.wm.Task r0 = r0.getTask()
            com.android.server.wm.Task r3 = r5.getTask()
            if (r0 != r3) goto Lc7
        L37:
            if (r7 == 0) goto L6c
            com.android.server.wm.TransitionController r7 = r4.mTransitionController
            boolean r7 = r7.isShellTransitionsEnabled()
            if (r7 == 0) goto L4a
            com.android.server.wm.TransitionController r7 = r4.mTransitionController
            boolean r7 = r7.isCollecting(r5)
            if (r7 != 0) goto L5b
            return r1
        L4a:
            com.android.server.wm.AppTransition r7 = r4.mAppTransition
            boolean r7 = r7.isTransitionSet()
            if (r7 == 0) goto L6b
            android.util.ArraySet r7 = r4.mOpeningApps
            boolean r7 = r7.contains(r5)
            if (r7 != 0) goto L5b
            goto L6b
        L5b:
            com.android.server.wm.ActivityRecord$State r7 = com.android.server.wm.ActivityRecord.State.RESUMED
            boolean r7 = r5.isState(r7)
            if (r7 == 0) goto L73
            com.android.server.wm.Task r7 = r5.getTask()
            boolean r7 = r7.mInResumeTopActivity
            if (r7 != 0) goto L73
        L6b:
            return r1
        L6c:
            com.android.server.wm.ActivityRecord r7 = r4.topRunningActivity()
            if (r5 == r7) goto L73
            return r1
        L73:
            boolean r7 = r4.mLastWallpaperVisible
            if (r7 == 0) goto La9
            boolean r7 = r5.windowsCanBeWallpaperTarget()
            if (r7 == 0) goto La9
            com.android.server.wm.DisplayContent$FixedRotationTransitionListener r7 = r4.mFixedRotationTransitionListener
            com.android.server.wm.ActivityRecord r7 = com.android.server.wm.DisplayContent.FixedRotationTransitionListener.m13093$$Nest$fgetmAnimatingRecents(r7)
            if (r7 != 0) goto La9
            com.android.server.wm.TransitionController r7 = r4.mTransitionController
            boolean r7 = r7.isTransientLaunch(r5)
            if (r7 != 0) goto La9
            boolean r7 = com.samsung.android.rune.CoreRune.FW_CUSTOM_SHELL_TRANSITION_LATE_TRANSIENT_LAUNCH
            if (r7 == 0) goto L99
            com.android.server.wm.TransitionController r7 = r4.mTransitionController
            boolean r7 = r7.isLateTransientLaunch(r5)
            if (r7 != 0) goto La9
        L99:
            com.android.server.wm.WindowManagerService r7 = r4.mWmService
            com.android.server.wm.ActivityTaskManagerService r7 = r7.mAtmService
            com.android.server.wm.KeyguardController r7 = r7.mKeyguardController
            int r0 = r4.mDisplayId
            boolean r7 = r7.isKeyguardGoingAway(r0)
            if (r7 == 0) goto La8
            goto La9
        La8:
            return r1
        La9:
            int r6 = r4.rotationForActivityInDifferentOrientation(r6)
            r7 = -1
            if (r6 != r7) goto Lb1
            return r1
        Lb1:
            boolean r7 = r4.handleFixedRotationForMultiWindow(r5)
            if (r7 == 0) goto Lb8
            return r1
        Lb8:
            com.android.server.wm.TaskDisplayArea r7 = r5.getDisplayArea()
            boolean r7 = r7.matchParentBounds()
            if (r7 != 0) goto Lc3
            return r1
        Lc3:
            r4.setFixedRotationLaunchingApp(r5, r6)
            return r2
        Lc7:
            return r1
        */
    ...
    public boolean mayImeShowOnLaunchingActivity(ActivityRecord activityRecord) {
        ...
        if (activityRecord.getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda68
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$mayImeShowOnLaunchingActivity$11;
                lambda$mayImeShowOnLaunchingActivity$11 = DisplayContent.lambda$mayImeShowOnLaunchingActivity$11((WindowState) obj);
    ...
    public static /* synthetic */ boolean lambda$mayImeShowOnLaunchingActivity$11(WindowState windowState) {
    ...
    public void setFixedRotationLaunchingAppUnchecked(ActivityRecord activityRecord, int i) {
        ...
        Slog.d(StartingSurfaceController.TAG, "setFixedRotationLaunchingAppUnchecked, rotation=" + i + ", r=" + activityRecord + ", caller=" + Debug.getCallers(5));
    ...
    public final void lambda$applyRotationAndFinishFixedRotation$49(final int i, final int i2) {
        ...
        if (!z2) {
            forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda61
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        scheduleAnimation();
        if (!z2) {
            forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda62
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$applyRotation$13(SurfaceControl.Transaction transaction, int i, int i2, boolean z, WindowState windowState) {
    ...
    public DisplayCutout calculateDisplayCutoutForRotation(int i, boolean z) {
        ...
        return ((WmDisplayCutout) this.mDisplayCutoutCache.getOrCompute(this.mBaseDisplayCutout, i)).getDisplayCutout();
    }
    ...
    public final WmDisplayCutout calculateDisplayCutoutForRotationUncached(DisplayCutout displayCutout, int i) {
        return calculateDisplayCutoutForRotationAndDisplaySizeUncached(displayCutout, i, this.mBaseDisplayWidth, this.mBaseDisplayHeight);
    }

    public RoundedCorners calculateRoundedCornersForRotation(int i) {
        return (RoundedCorners) this.mRoundedCornerCache.getOrCompute(this.mIsSizeForced ? this.mBaseRoundedCorners : this.mInitialRoundedCorners, i);
    }
    ...
    public PrivacyIndicatorBounds calculatePrivacyIndicatorBoundsForRotation(int i) {
        return (PrivacyIndicatorBounds) this.mPrivacyIndicatorBoundsCache.getOrCompute(this.mCurrentPrivacyIndicatorBounds, i);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void computeScreenConfiguration(android.content.res.Configuration r15) {
        /*
    ...
    public static /* synthetic */ void lambda$getRootTasks$18(boolean z, int i, List list, int i2, Task task) {
        if (z) {
    ...
    public int getOrientation() {
        ...
        if (this.isDefaultDisplay && isDexMode() && (orientationForDexStandalone = getOrientationForDexStandalone()) != -2) {
    ...
    public void setForcedSize(int i, int i2) {
        setForcedSize(i, i2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
    }
    ...
    public void setForcedSize(int i, int i2, float f, float f2, boolean z, boolean z2, boolean z3) {
        ...
        final IBinder displayToken = (CoreRune.FW_VRR_RESOLUTION_POLICY_FOR_SHELL_TRANSITION && this.isDefaultDisplay) ? SurfaceControl.getDisplayToken(this.mDisplayInfo.address) : null;
        if (CoreRune.FW_VRR_RESOLUTION_POLICY_FOR_SHELL_TRANSITION && displayToken != null && (i4 != this.mBaseDisplayWidth || i9 != this.mBaseDisplayHeight)) {
        ...
        updateBaseDisplayMetrics(i4, i9, this.mBaseDisplayDensity, f != DisplayPowerController2.RATE_FROM_DOZE_TO_ON ? f : this.mBaseDisplayPhysicalXDpi, f2 != DisplayPowerController2.RATE_FROM_DOZE_TO_ON ? f2 : this.mBaseDisplayPhysicalYDpi);
        reconfigureDisplayLocked();
        if (z3) {
        ...
        if (CoreRune.FW_VRR_RESOLUTION_POLICY_FOR_SHELL_TRANSITION && displayToken != null) {
            SurfaceControl.TransactionCommittedListener transactionCommittedListener = new SurfaceControl.TransactionCommittedListener() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda19
    ...
    public /* synthetic */ void lambda$setForcedSize$20(IBinder iBinder) {
        ((SurfaceControl.Transaction) this.mWmService.mTransactionFactory.get()).startChangeResolution(iBinder, false).apply();
    }
    ...
    public Task findTaskForResizePoint(final int i, final int i2) {
        final int dipToPixel = WindowManagerService.dipToPixel(WindowState.RESIZE_HANDLE_WIDTH_IN_DP, this.mDisplayMetrics);
        return (Task) getItemFromTaskDisplayAreas(new Function() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda64
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Task lambda$findTaskForResizePoint$22;
                lambda$findTaskForResizePoint$22 = DisplayContent.this.lambda$findTaskForResizePoint$22(i, i2, dipToPixel, (TaskDisplayArea) obj);
                return lambda$findTaskForResizePoint$22;
            }
        });
    }

    public /* synthetic */ Task lambda$findTaskForResizePoint$22(int i, int i2, int i3, TaskDisplayArea taskDisplayArea) {
    ...
    public void updateTouchExcludeRegion() {
        ...
        forAllWindows(new ToBooleanFunction() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda51
            public final boolean apply(Object obj) {
                boolean lambda$updateTouchExcludeRegion$24;
                lambda$updateTouchExcludeRegion$24 = DisplayContent.this.lambda$updateTouchExcludeRegion$24((WindowState) obj);
    ...
    public /* synthetic */ boolean lambda$updateTouchExcludeRegion$24(WindowState windowState) {
        ...
        if (windowState.mActivityRecord == null && ((i = windowState.mAttrs.type) < 1 || i > 99)) {
            ...
            if (windowState.isVisible() && (windowState.mAttrs.flags & 16) == 0) {
                ...
                if ((windowState2 != null && windowState2 == windowState) || this.mTapExcludedWindows.contains(windowState)) {
                    return false;
                }
    ...
    public final void lambda$updateTouchExcludeRegion$23(Task task, Task task2, int i) {
        ...
        if (!inFreeformWindowingMode() || ((findMainWindow = topVisibleActivity.findMainWindow()) != null && findMainWindow.isVisibleByPolicy())) {
    ...
    public void removeImmediately() {
        ...
        try {
            ...
            if (this.mDisplayId == 4 && (defaultDisplay = this.mRootWindowContainer.getDefaultDisplay()) != null && (coverPolicy = defaultDisplay.mDisplayPolicy.mExt.mCoverPolicy) != null) {
    ...
    public void requestChangeTransitionIfNeeded(int i, TransitionRequestInfo.DisplayChange displayChange) {
        ...
        if (this.mLastHasContent) {
            ...
            if (transitionController.isCollecting()) {
                ...
                if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && (asyncRotationController = this.mAsyncRotationController) != null && asyncRotationController.shouldFinishAsyncRotationForSameChanges(transitionController.getCollectingTransition())) {
                    Slog.d(StartingSurfaceController.TAG, "Call finishAsyncRotationIfPossible, if final changes are the same as the start changes in transition");
                    finishAsyncRotationIfPossible();
                    this.mDisplaySwitchTransitionLauncher.unsetFoldChanging("finishAsyncRotationForSameChanges");
                    return;
                }
                return;
            }
            ...
            if (requestTransitionIfNeeded != null) {
                ...
                if (this.mFixedRotationLaunchingApp != null) {
                    ...
                    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_DISPLAY_CHANGE && displayChange != null && ((i2 = (selectDisplayChangeAnimation = selectDisplayChangeAnimation(displayChange)).mEnter) != 0 || selectDisplayChangeAnimation.mExit != 0)) {
                        transitionController.setOverrideAnimation(TransitionInfo.AnimationOptions.makeCustomDisplayChangeAnimOptions(i2, selectDisplayChangeAnimation.mExit), null, null);
                    }
                }
    ...
    public void dumpDebug(ProtoOutputStream protoOutputStream, long j, int i) {
        if (i != 2 || isVisible()) {
            ...
            for (int i2 = 0; i2 < this.mAllSleepTokens.size(); i2++) {
                ((RootWindowContainer.SleepToken) this.mAllSleepTokens.get(i2)).writeTagToProto(protoOutputStream, 2237677961253L);
            }
    ...
    public void dump(final PrintWriter printWriter, final String str, final boolean z) {
        ...
        if (CoreRune.MW_MULTI_SPLIT_TASK_ORGANIZER && (rootCellStageTask = getDefaultTaskDisplayArea().getRootCellStageTask()) != null) {
    ...
    public static /* synthetic */ void lambda$dump$26(PrintWriter printWriter, String str, boolean z, TaskDisplayArea taskDisplayArea) {
    ...
    public WindowState getTouchableWinAtPointLocked(float f, float f2) {
        final int i = (int) f;
        final int i2 = (int) f2;
        return getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda37
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getTouchableWinAtPointLocked$27;
                lambda$getTouchableWinAtPointLocked$27 = DisplayContent.this.lambda$getTouchableWinAtPointLocked$27(i, i2, (WindowState) obj);
                return lambda$getTouchableWinAtPointLocked$27;
            }
        });
    }

    public /* synthetic */ boolean lambda$getTouchableWinAtPointLocked$27(int i, int i2, WindowState windowState) {
    ...
    public boolean canAddToastWindowForUid(final int i) {
        return getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda45
            ...
            public final boolean test(Object obj) {
                ...
                lambda$canAddToastWindowForUid$28 = DisplayContent.lambda$canAddToastWindowForUid$28(i, (WindowState) obj);
            ...
            public final boolean test(Object obj) {
                ...
                lambda$canAddToastWindowForUid$29 = DisplayContent.lambda$canAddToastWindowForUid$29(i, (WindowState) obj);
                return lambda$canAddToastWindowForUid$29;
            }
        }) == null;
    }

    public static /* synthetic */ boolean lambda$canAddToastWindowForUid$28(int i, WindowState windowState) {
        return windowState.mOwnerUid == i && windowState.isFocused();
    }

    public static /* synthetic */ boolean lambda$canAddToastWindowForUid$29(int i, WindowState windowState) {
    ...
    public boolean updateFocusedWindowLocked(int i, boolean z, int i2) {
        ...
        if (ProtoLogCache.WM_FORCE_DEBUG_FOCUS_LIGHT_enabled) {
            ProtoLogImpl.v(ProtoLogGroup.WM_FORCE_DEBUG_FOCUS_LIGHT, 1885212618, 16, "Changing focus from %s to %s displayId=%d Callers=%s", new Object[]{String.valueOf(this.mCurrentFocus), String.valueOf(findFocusedWindowIfNeeded), Long.valueOf(getDisplayId()), String.valueOf(Debug.getCallers(4))});
        }
        WindowState windowState2 = this.mCurrentFocus;
        this.mCurrentFocus = findFocusedWindowIfNeeded;
        if (findFocusedWindowIfNeeded != null && (layoutParams2 = findFocusedWindowIfNeeded.mAttrs) != null && (str2 = layoutParams2.packageName) != null) {
            try {
                this.mAtmService.mAmInternal.onPackageResumedFG((List) null, str2, (String) null, false, (Intent) null, findFocusedWindowIfNeeded.mShowUserId);
            } catch (Exception e) {
                Slog.e("MARs", "Error occurred in updateFocusedWindowLocked()" + e);
            }
        } else if (windowState2 != null && (layoutParams = windowState2.mAttrs) != null && (str = layoutParams.packageName) != null) {
            try {
                this.mAtmService.mAmInternal.onPackageResumedFG((List) null, str, (String) null, false, (Intent) null, windowState2.mShowUserId);
            } catch (Exception e2) {
        ...
        if ((this.mDisplayId == 2 || (CoreRune.MT_NEW_DEX_TASK_ORDERING && !this.isDefaultDisplay && isNewDexMode())) && this.mInputMethodWindow == null && findFocusedWindowIfNeeded != null && windowState2 != null && findFocusedWindowIfNeeded.getTask() != null && !findFocusedWindowIfNeeded.getTask().equals(windowState2.getTask())) {
            assignWindowLayers(false);
        }
        if (i != 1) {
    ...
    public boolean setFocusedApp(ActivityRecord activityRecord) {
        ...
        this.mWmService.mExt.mPolicyExt.updateTopActivity(convertActivityResultToComponentName(activityRecord));
    ...
    public boolean destroyLeakedSurfaces() {
        this.mTmpWindow = null;
        final SurfaceControl.Transaction transaction = (SurfaceControl.Transaction) this.mWmService.mTransactionFactory.get();
        forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda60
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$destroyLeakedSurfaces$30(SurfaceControl.Transaction transaction, WindowState windowState) {
        WindowStateAnimator windowStateAnimator = windowState.mWinAnimator;
    ...
    public void setImeInputTarget(InputTarget inputTarget) {
        ...
        if (inputTarget != null && (windowState = inputTarget.getWindowState()) != null) {
            Pair pair2 = new Pair(windowState.mToken.token, new WindowContainerListener() { // from class: com.android.server.wm.DisplayContent.3
                public final /* synthetic */ WindowState val$targetWin;

                public AnonymousClass3(WindowState windowState2) {
                    r2 = windowState2;
                }
                ...
                public void onVisibleRequestedChanged(boolean z) {
                    ...
                    IBinder asBinder = r2.mClient.asBinder();
                    ActivityRecord activityRecord = r2.mActivityRecord;
            ...
            windowState2.mToken.registerWindowContainerListener((WindowContainerListener) pair2.second);
            this.mWmService.dispatchImeInputTargetVisibilityChanged(windowState2.mClient.asBinder(), windowState2.isVisible(), false);
        }
    ...
    /* renamed from: com.android.server.wm.DisplayContent$3 */
    /* loaded from: classes3.dex */
    public class AnonymousClass3 implements WindowContainerListener {
        public final /* synthetic */ WindowState val$targetWin;
    ...
    public final void attachImeScreenshotOnTarget(WindowState windowState, boolean z) {
        ...
        ImeScreenshot imeScreenshot = new ImeScreenshot((SurfaceControl.Builder) this.mWmService.mSurfaceControlFactory.apply(null), windowState);
    ...
    public void removeImeSurfaceByTarget(WindowContainer windowContainer) {
        ...
        if (windowContainer.asWindowState() == null || windowContainer.asWindowState().mAttrs.type != 3) {
            ...
            if (windowContainer == imeTarget || windowContainer.getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda28
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    boolean lambda$removeImeSurfaceByTarget$31;
                    lambda$removeImeSurfaceByTarget$31 = DisplayContent.lambda$removeImeSurfaceByTarget$31(WindowState.this, obj);
    ...
    public boolean onImeInsetsClientVisibilityUpdate() {
        ...
        if ((this.mImeInputTarget != this.mLastImeInputTarget) || (activityRecord != null && activityRecord.isVisibleRequested() && activityRecord.mImeInsetsFrozenUntilStartInput)) {
            forAllActivities(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda59
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    DisplayContent.lambda$onImeInsetsClientVisibilityUpdate$32(zArr, (ActivityRecord) obj);
                }
            });
        }
        return zArr[0];
    ...
    public static /* synthetic */ void lambda$onImeInsetsClientVisibilityUpdate$32(boolean[] zArr, ActivityRecord activityRecord) {
    ...
    public void updateImeControlTarget(boolean z) {
        ...
        if ((insetsControlTarget != this.mImeControlTarget) || z) {
            ...
            updateImeParent();
            if (surfaceControl != null && surfaceControl == this.mInputMethodSurfaceParent && shouldBeRelativeLayer(this.mImeLayeringTarget)) {
                if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && this.mTransitionController.inPlayingTransition(this)) {
                    this.mTransitionController.mStateValidators.add(new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda17
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        this.mWmService.mH.post(new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void updateImeParent() {
        ...
        if (computeImeParent == null && this.isDefaultDisplay && this.mImeWindowsContainer.getParent() != null && this.mInputMethodSurfaceParent != null && (windowContainer = this.mInputMethodSurfaceParentContainer) != null && windowContainer.getDisplayContent() != null) {
            if (this.mInputMethodSurfaceParentContainer.getDisplayContent() != this) {
                ...
                Slog.w(StartingSurfaceController.TAG, "updateImeParent: reset surface parent(d#" + this.mDisplayId + ") surface is moved to other display, r= " + this.mInputMethodSurfaceParentContainer);
            } else if (this.mAtmService.mDexController.shouldShowDexImeInDefaultDisplayLocked()) {
                computeImeParent = this.mImeWindowsContainer.getParent().getSurfaceControl();
                Slog.w(StartingSurfaceController.TAG, "updateImeParent: reset surface parent(d#" + this.mDisplayId + ") by DeX IME policy, r= " + this.mInputMethodSurfaceParentContainer);
            }
        }
        ...
        WindowState windowState = this.mImeLayeringTarget;
        SurfaceControl surfaceControl = (windowState == null || (activityRecord = windowState.mActivityRecord) == null) ? null : activityRecord.getSurfaceControl();
    ...
    public void setLayoutNeeded() {
        ...
        if (windowSurfacePlacer.mPrintLayoutCaller) {
            ...
            Slog.w(StartingSurfaceController.TAG, "setLayoutNeeded: d" + this.mDisplayId + ", callers=" + Debug.getCallers(3));
        }
    ...
    public void dumpWindowAnimators(final PrintWriter printWriter, final String str) {
        final int[] iArr = new int[1];
        forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda70
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$dumpWindowAnimators$36(PrintWriter printWriter, String str, int[] iArr, WindowState windowState) {
    ...
    public boolean shouldWaitForSystemDecorWindowsOnBoot() {
        ...
        if (getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda52
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$shouldWaitForSystemDecorWindowsOnBoot$38;
                lambda$shouldWaitForSystemDecorWindowsOnBoot$38 = DisplayContent.this.lambda$shouldWaitForSystemDecorWindowsOnBoot$38(sparseBooleanArray, (WindowState) obj);
                return lambda$shouldWaitForSystemDecorWindowsOnBoot$38;
            }
        }) != null) {
            return true;
        }
        boolean z = this.mWmService.mContext.getResources().getBoolean(17891688) && this.mWmService.mContext.getResources().getBoolean(R.bool.config_windowOverscanByDefault);
    ...
    public /* synthetic */ boolean lambda$shouldWaitForSystemDecorWindowsOnBoot$38(SparseBooleanArray sparseBooleanArray, WindowState windowState) {
    ...
    public boolean hasSecureWindowOnScreen() {
        return getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda48
            ...
            public final boolean test(Object obj) {
                ...
                lambda$hasSecureWindowOnScreen$39 = DisplayContent.lambda$hasSecureWindowOnScreen$39((WindowState) obj);
        ...
        try {
            ...
            try {
                ...
                if (isWallpaperVisible != this.mLastWallpaperVisible) {
                    ...
                    if (this.isDefaultDisplay) {
                        this.mWmService.mAtmService.mMultiTaskingController.notifyWallpaperVisibilityChanged(this);
                    }
                }
    ...
    public Bitmap screenshotDisplayLocked(boolean z) {
        ...
        ScreenCapture.captureLayers(new ScreenCapture.LayerCaptureArgs.Builder(getSurfaceControl()).setExcludeLayers((CoreRune.FW_SUPPORT_SEARCLE_HOME_LONG && z) ? getSystemWindowLayersLocked() : null).setSourceCrop(this.mTmpRect).build(), createSyncCaptureListener);
    ...
    public /* synthetic */ void lambda$getSystemWindowLayersLocked$41(ArrayList arrayList, WindowState windowState) {
        int i;
        if (!canBeScreenshotTarget(windowState) || !windowState.isVisible() || windowState.mIsWallpaper || (i = windowState.mAttrs.type) < 2000 || i > 2999) {
            return;
        }
    ...
    public ScreenCapture.LayerCaptureArgs getLayerCaptureArgs(boolean z) {
        ...
        getBounds(this.mTmpRect);
        this.mTmpRect.offsetTo(0, 0);
        return new ScreenCapture.LayerCaptureArgs.Builder(getSurfaceControl()).setExcludeLayers(surfaceControlArr).setSourceCrop(this.mTmpRect).build();
    }
    ...
    public final class TaskForResizePointSearchResult implements Predicate {
        ...
        public boolean test(Task task) {
            ...
            if (task.inFreeformWindowingMode() && (topVisibleActivity = task.getTopVisibleActivity()) != null && topVisibleActivity.getTopFullscreenOpaqueWindow() == null) {
                return false;
            }
            task.getDimBounds(this.mTmpRect);
            Rect rect = this.mTmpRect;
    ...
    public final class ApplySurfaceChangesTransactionState {
        ...
        public /* synthetic */ ApplySurfaceChangesTransactionState(ApplySurfaceChangesTransactionStateIA applySurfaceChangesTransactionStateIA) {
            this();
        }
    ...
    public final void assignRelativeLayerForIme(SurfaceControl.Transaction transaction, boolean z) {
        ...
        if (this.isDefaultDisplay && this.mAtmService.mDexController.shouldShowDexImeInDefaultDisplayLocked()) {
            if (!getDisplayPolicy().hasNavigationBar() && assignImeLayer(transaction, getSurfaceControl(), 1)) {
                return;
            }
    ...
    public boolean assignImeLayer(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, int i) {
    ...
    public void executeAppTransition() {
        ...
        if (this.mAppTransition.isTransitionSet()) {
            if (ProtoLogCache.WM_FORCE_DEBUG_APP_TRANSITIONS_enabled) {
                ProtoLogImpl.w(ProtoLogGroup.WM_FORCE_DEBUG_APP_TRANSITIONS, 1235864419, 4, "Execute app transition: %s, displayId: %d Callers=%s", new Object[]{String.valueOf(this.mAppTransition), Long.valueOf(this.mDisplayId), String.valueOf(Debug.getCallers(5))});
            }
    ...
    public void handleAnimatingStoppedAndTransition() {
        ...
        for (int size = this.mNoAnimationNotifyOnTransitionFinished.size() - 1; size >= 0; size--) {
            this.mAppTransition.notifyAppTransitionFinishedLocked((IBinder) this.mNoAnimationNotifyOnTransitionFinished.get(size));
        }
    ...
    public boolean calculateSystemGestureExclusion(final Region region, final Region region2) {
        ...
        forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda33
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DisplayContent.this.lambda$calculateSystemGestureExclusion$42(recentsAnimationController, obtain, obtain2, obtain3, iArr, region, region2, (WindowState) obj);
            }
        }, true);
        obtain3.recycle();
        obtain2.recycle();
    ...
    public /* synthetic */ void lambda$calculateSystemGestureExclusion$42(RecentsAnimationController recentsAnimationController, Region region, Region region2, Region region3, int[] iArr, Region region4, Region region5, WindowState windowState) {
    ...
    public static int addToGlobalAndConsumeLimit(Region region, final Region region2, Rect rect, int i, WindowState windowState, int i2) {
        ...
        final int[] iArr = {i};
        final int[] iArr2 = {0};
        RegionUtils.forEachRectReverse(obtain, new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda66
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$addToGlobalAndConsumeLimit$43(int[] iArr, int[] iArr2, Region region, Rect rect) {
        if (iArr[0] <= 0) {
            return;
        }
    ...
    public void getKeepClearAreas(final Set set, final Set set2) {
        ...
        forAllWindows(new ToBooleanFunction() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda40
            public final boolean apply(Object obj) {
                ...
                lambda$getKeepClearAreas$45 = DisplayContent.lambda$getKeepClearAreas$45(RecentsAnimationController.this, set, set2, matrix, fArr, (WindowState) obj);
                return lambda$getKeepClearAreas$45;
            }
        }, true);
    }

    public static /* synthetic */ boolean lambda$getKeepClearAreas$45(RecentsAnimationController recentsAnimationController, Set set, final Set set2, Matrix matrix, float[] fArr, WindowState windowState) {
        ...
        if (windowState.isVisible() && !windowState.inPinnedWindowingMode()) {
            ...
            if (windowState.mIsImWindow) {
                ...
                RegionUtils.forEachRect(obtain, new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda63
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        set2.add((Rect) obj);
                    }
    ...
    public static /* synthetic */ void lambda$removeRootTasksInWindowingModes$46(int[] iArr, ArrayList arrayList, Task task) {
        for (int i : iArr) {
    ...
    public static /* synthetic */ void lambda$removeRootTasksWithActivityTypes$47(int[] iArr, ArrayList arrayList, Task task) {
        for (int i : iArr) {
    ...
    public ActivityRecord topRunningActivity(final boolean z) {
        return (ActivityRecord) getItemFromTaskDisplayAreas(new Function() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda58
            ...
            public final Object apply(Object obj) {
                ...
                lambda$topRunningActivity$48 = DisplayContent.lambda$topRunningActivity$48(z, (TaskDisplayArea) obj);
                return lambda$topRunningActivity$48;
            }
        });
    }

    public static /* synthetic */ ActivityRecord lambda$topRunningActivity$48(boolean z, TaskDisplayArea taskDisplayArea) {
    ...
    public boolean updateDisplayOverrideConfigurationLocked() {
        ...
        this.mAtmService.mH.sendMessage(PooledLambda.obtainMessage(new ActivityTaskManagerService$$ExternalSyntheticLambda9(), this.mAtmService.mAmInternal, Integer.valueOf(this.mDisplayId)));
        if (isDexMode()) {
    ...
    public int performDisplayOverrideConfigUpdate(Configuration configuration) {
        ...
        boolean checkScreenDpSizeChanges = this.mAtmService.mExt.checkScreenDpSizeChanges(this.mTempConfig, configuration);
        float width = configuration.windowConfiguration.getBounds().width() / this.mTempConfig.windowConfiguration.getBounds().width();
        float height = configuration.windowConfiguration.getBounds().height() / this.mTempConfig.windowConfiguration.getBounds().height();
        ...
        if (updateFrom != 0) {
            Slog.i(StartingSurfaceController.TAG, "[d" + this.mDisplayId + "] Override config changes=" + Integer.toHexString(updateFrom) + " " + this.mTempConfig + ", callers=" + Debug.getCallers(5));
            if (isReady() && this.mTransitionController.isShellTransitionsEnabled()) {
                if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_DISPLAY_CHANGE && !this.mTransitionController.isCollecting()) {
                    TransitionRequestInfo.DisplayChange createDisplayChangeIfNeeded = createDisplayChangeIfNeeded(getRequestedOverrideConfiguration(), configuration);
                    requestChangeTransitionIfNeeded(updateFrom, createDisplayChangeIfNeeded);
                    boolean z = (createDisplayChangeIfNeeded == null && (Integer.MIN_VALUE & updateFrom) == 0) ? false : true;
                    DisplayContent displayContent = this.mRootWindowContainer.getDisplayContent(2);
                    if (z && this.mTransitionController.isCollecting() && this.isDefaultDisplay && displayContent != null && this.mAtmService.mDexController.getDexModeLocked() == 2) {
            ...
            if (DesktopModeFeature.SUPPORT_STANDALONE && this.mDisplayId == 0 && getDesktopModeManagerInternal() != null && (z2 || z3)) {
            ...
            if (z2 && this.mDisplayId == 0) {
                ...
                if (!checkScreenDpSizeChanges) {
                    obtainMessage = PooledLambda.obtainMessage(new QuadConsumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda34
                    ...
                    }, this.mAtmService.mAmInternal, 24, 6, (Object) null);
                } else {
                    obtainMessage = PooledLambda.obtainMessage(new TriConsumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda35
                ...
                this.mAtmService.mH.sendMessage(obtainMessage);
            }
            this.mAtmService.mMultiTaskingController.performDisplayOverrideConfigUpdate(updateFrom, this.mDisplayId, width, height, this.mTmpPrevBounds, this.mTempConfig.windowConfiguration.getBounds());
            if (DesktopModeFeature.SUPPORT_STANDALONE && this.mDisplayId == 0 && getDesktopModeManagerInternal() != null) {
    ...
    public final DesktopModeManagerInternal getDesktopModeManagerInternal() {
        if (this.mDesktopModeManagerInternal == null) {
            this.mDesktopModeManagerInternal = (DesktopModeManagerInternal) LocalServices.getService(DesktopModeManagerInternal.class);
        }
    ...
    public void handleActivitySizeCompatModeIfNeeded(ActivityRecord activityRecord) {
        ...
        if (CoreRune.FW_FIXED_ASPECT_RATIO_MODE && this.isDefaultDisplay && activityRecord.isState(ActivityRecord.State.RESUMED) && activityRecord.mCompatRecord.isFixedAspectRatioModeEnabled()) {
        ...
        if (CoreRune.FW_ORIENTATION_CONTROL_WITH_ROTATION_COMPAT && this.isDefaultDisplay && activityRecord.isState(ActivityRecord.State.RESUMED)) {
            BoundsCompatRecord boundsCompatRecord = activityRecord.mCompatRecord;
            if (boundsCompatRecord.mCanRotationCompatMode && boundsCompatRecord.getController() == this.mAtmService.mExt.mOrientationController && activityRecord.getCompatDisplayInsets() != null && activityRecord.getCompatDisplayInsets().mCanRotationCompatMode) {
    ...
    public boolean isUidPresent(int i) {
        Predicate obtainPredicate = PooledLambda.obtainPredicate(new DisplayContent$$ExternalSyntheticLambda24(), PooledLambda.__(ActivityRecord.class), Integer.valueOf(i));
    ...
    public void remove() {
        ...
        try {
            Task task = (Task) reduceOnAllTaskDisplayAreas(new BiFunction() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda20
                @Override // java.util.function.BiFunction
                public final Object apply(Object obj, Object obj2) {
                    Task lambda$remove$50;
                    lambda$remove$50 = DisplayContent.lambda$remove$50((TaskDisplayArea) obj, (Task) obj2);
            ...
            this.mAllSleepTokens.forEach(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda21
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
            ...
            if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
                ProtoLogImpl.d(ProtoLogGroup.WM_DEBUG_STATES, -1716263676, 0, (String) null, (Object[]) null);
            }
        ...
        if (this.mRemoved) {
            ...
            if (!forAllRootTasks(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda53
                ...
                public final boolean test(Object obj) {
                    ...
                    lambda$releaseSelfIfNeeded$52 = DisplayContent.lambda$releaseSelfIfNeeded$52((Task) obj);
    ...
    public void removeAllTasks() {
        forAllTasks(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda41
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    /* renamed from: com.android.server.wm.DisplayContent$4 */
    /* loaded from: classes3.dex */
    public class AnonymousClass4 implements Predicate {
        public boolean behindTopWindow;
        public final /* synthetic */ WindowState val$searchBehind;
        public final /* synthetic */ int val$taskId;

        public AnonymousClass4(WindowState windowState, int i) {
        ...
        @Override // java.util.function.Predicate
        public boolean test(WindowState windowState) {
            if (!this.behindTopWindow) {
                if (windowState == this.val$searchBehind) {
    ...
    public WindowState findScrollCaptureTargetWindow(WindowState windowState, int i) {
        return getWindow(new Predicate(windowState, i) { // from class: com.android.server.wm.DisplayContent.4
            public boolean behindTopWindow;
            public final /* synthetic */ WindowState val$searchBehind;
            public final /* synthetic */ int val$taskId;

            public AnonymousClass4(WindowState windowState2, int i2) {
                this.val$searchBehind = windowState2;
                this.val$taskId = i2;
                this.behindTopWindow = windowState2 == null;
            }
    ...
    public class FixedRotationTransitionListener extends WindowManagerInternal.AppTransitionListener {
        ...
        public void onFinishRecentsAnimation() {
            ...
            Slog.d(StartingSurfaceController.TAG, "onFinishRecentsAnimation, animatingRecents=" + activityRecord);
            if (z) {
                return;
            }
                ...
                if (DisplayContent.this.mFixedRotationLaunchingApp.hasFixedRotationTransform(activityRecord2)) {
                    if (DisplayContent.this.mFixedRotationLaunchingApp.hasAnimatingFixedRotationTransition()) {
                        if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX) {
                            DisplayContent.this.mTransitionController.mStateValidators.add(new Runnable() { // from class: com.android.server.wm.DisplayContent$FixedRotationTransitionListener$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    DisplayContent.FixedRotationTransitionListener.this.lambda$onAppTransitionFinishedLocked$0(activityRecord2);
                                }
                            });
                            return;
                        }
                    ...
                    if (task == null || task != DisplayContent.this.mFixedRotationLaunchingApp.getTask() || task.getActivity(new Predicate() { // from class: com.android.server.wm.DisplayContent$FixedRotationTransitionListener$$ExternalSyntheticLambda1
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
        ...
        public /* synthetic */ void lambda$onAppTransitionFinishedLocked$0(ActivityRecord activityRecord) {
            if (DisplayContent.this.isFixedRotationLaunchingApp(activityRecord)) {
                Slog.e(StartingSurfaceController.TAG, "Need to clear fixed rotation transform, r=" + activityRecord);
                DisplayContent.this.continueUpdateOrientationForDiffOrienLaunchingApp();
            }
        }
    ...
    public class RemoteInsetsControlTarget implements InsetsControlTarget {
        ...
        public RemoteInsetsControlTarget(IDisplayWindowInsetsController iDisplayWindowInsetsController) {
            ...
            this.mCanShowTransient = DisplayContent.this.mWmService.mContext.getResources().getBoolean(17891805);
        }
        ...
        public void clearImeRequestedVisibleTypes(String str) {
            ...
            Slog.d(StartingSurfaceController.TAG, "clearImeRequestedVisibleTypes: vis=0x" + Integer.toHexString(i) + ", reason=" + str);
    ...
    public DisplayArea findAreaForToken(WindowToken windowToken) {
        if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_AS_CAPTURED_BLUR && CustomLetterboxConfiguration.isEnhancedControllerToken(windowToken.token)) {
            return findAreaForWindowType(2013, windowToken.mOptions, windowToken.mOwnerCanManageAppTokens, windowToken.mRoundedCornerOverlay);
        }
    ...
    public List getVisibleWindowInfoList() {
        final ArrayList arrayList = new ArrayList();
        forAllWindows(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda27
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$getVisibleWindowInfoList$57(ArrayList arrayList, WindowState windowState) {
    ...
    public WindowState getSecureWindowOnScreen() {
        return getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda69
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getSecureWindowOnScreen$58;
                lambda$getSecureWindowOnScreen$58 = DisplayContent.lambda$getSecureWindowOnScreen$58((WindowState) obj);
    ...
    public final boolean shouldUseRemoteInsetsControlTarget() {
        if (this.mInputMethodWindow == null || this.mRemoteInsetsControlTarget == null || this.mImeInputTarget != null || isImeControlledByApp()) {
            return false;
        }
        ...
        return this.isDefaultDisplay && getParent().getTopChild().asDisplayContent().isAppCastingDisplay();
    }

    public boolean isInputMethodTargetTaskAndShowing(Task task) {
        InputTarget inputTarget;
        WindowState windowState = this.mInputMethodWindow;
        return windowState != null && windowState.isVisible() && (inputTarget = this.mImeInputTarget) != null && inputTarget.getWindowState() != null && this.mImeInputTarget.getWindowState().getTask() == task && this.mInsetsStateController.getImeSourceProvider().isImeShowing();
    }

    public WindowState getWindowEavesdropDragEvent() {
        return getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda49
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public void setForcedSizeDensity(int i, int i2, int i3, boolean z, boolean z2, int i4) {
        ...
        this.mBaseDisplayDensity = i3;
        Slog.i(StartingSurfaceController.TAG, "Using new display size & density : " + i + "x" + i2 + " " + i3 + "dp saveSize=" + z + " saveDensity=" + z2 + " forcedHideCutout=" + i4);
        try {
            ...
            setForcedSize(i, i2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, z, true, true);
            if (z2) {
    ...
    public void updateBaseDisplayCutout(int i, int i2) {
        ...
        this.mBaseDisplayCutout = DisplayCutout.fromResourcesRectApproximation(systemUiContext.getResources(), this.mNonOverrideDisplayInfo.uniqueId, i, i2, i, i2, getProportionalDensity(this.mNonOverrideDisplayInfo.getNaturalWidth(), i, this.mNonOverrideDisplayInfo.logicalDensityDpi), false);
    }
    ...
    public final void updateIsOverlappingWithCutoutAsDefault() {
        ...
        int dimensionPixelSize = this.mDisplayPolicy.getCurrentUserResources().getDimensionPixelSize(17105702);
        ...
        Slog.i(StartingSurfaceController.TAG, "updateIsOverlappingWithCutoutAsDefault: largeCutoutSize=" + max + ", minimumSizeForOverlappingWithCutoutAsDefault=" + dimensionPixelSize + ", isDexMode=" + isDexMode());
    }

    public final int getOrientationForDexStandalone() {
        WindowManagerService windowManagerService = this.mWmService;
        if ((windowManagerService.mDisplayFrozen && windowManagerService.mPolicy.isKeyguardLocked()) || !this.mAtmService.mDexController.isDexStandaloneRotationEnabledLocked()) {
            return 11;
        }
        super.getOrientation();
        WindowContainer lastOrientationSource = getLastOrientationSource();
        ActivityRecord asActivityRecord = lastOrientationSource != null ? lastOrientationSource.asActivityRecord() : null;
        return (asActivityRecord == null || !asActivityRecord.isActivityTypeStandardOrUndefined() || asActivityRecord.inMultiWindowMode()) ? 11 : 2;
    }

    public TransitionRequestInfo.DisplayChange createDisplayChangeIfNeeded(Configuration configuration, Configuration configuration2) {
        if (!CoreRune.FW_UI_MODE_ANIMATION || configuration.isNightModeActive() == configuration2.isNightModeActive()) {
            return null;
        }
        TransitionRequestInfo.DisplayChange displayChange = new TransitionRequestInfo.DisplayChange(this.mDisplayId, this.mDisplayRotation.getRotation(), this.mDisplayRotation.getRotation());
        displayChange.setUiModeChanged(true);
        return displayChange;
    }

    public DisplayAnimationPair selectDisplayChangeAnimation(TransitionRequestInfo.DisplayChange displayChange) {
        ...
        if (CoreRune.FW_UI_MODE_ANIMATION && displayChange.isUiModeChanged()) {
            displayAnimationPair.mEnter = R.anim.wallpaper_intra_close_exit;
            displayAnimationPair.mExit = R.anim.wallpaper_intra_open_enter;
        }
    ...
    public void requestBlackSnapshotIfNeeded(int i, int i2) {
        boolean z = false;
        if (i > 0 && i2 > 0 && Math.abs((i / i2) - (this.mBaseDisplayWidth / this.mBaseDisplayHeight)) > 0.001f) {
            z = true;
        }
    ...
    public final boolean handleFixedRotationForMultiWindow(ActivityRecord activityRecord) {
        ...
        if (this.mIsInExitingRecents && hasFreeformForceHideTransientOverlay()) {
            Slog.d(StartingSurfaceController.TAG, "handleFixedRotationForMultiWindow: allow fixed-rotation, reason=recents_overlay");
            return false;
        }
        ...
        if (taskBehindHome != null && taskSnapshotController.isInSkipClosingAppSnapshotTasks(taskBehindHome)) {
            ArraySet arraySet = new ArraySet();
    ...
    public final boolean hasFreeformForceHideTransientOverlay() {
        ...
        while (it.hasNext()) {
            if (((TransientLaunchOverlayToken) it.next()).getWindow(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda67
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    boolean lambda$hasFreeformForceHideTransientOverlay$59;
                    lambda$hasFreeformForceHideTransientOverlay$59 = DisplayContent.lambda$hasFreeformForceHideTransientOverlay$59((WindowState) obj);
    ...
    public static /* synthetic */ boolean lambda$hasFreeformForceHideTransientOverlay$59(WindowState windowState) {
    ...
    public boolean hasVisibleFreeformTask() {
        return getRootTask(new Predicate() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda38
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$hasVisibleFreeformTask$60;
                lambda$hasVisibleFreeformTask$60 = DisplayContent.lambda$hasVisibleFreeformTask$60((Task) obj);
    ...
    public void setFadeInOutAnimationNeeded(boolean z, String str) {
        if (this.mFadeInOutAnimationNeeded != z) {
            ...
            Slog.d(StartingSurfaceController.TAG, "setFadeInOutAnimationNeeded: " + z + ", reason=" + str);
        }
    }
    ...
    public final boolean shouldBeRelativeLayer(WindowState windowState) {
        if (windowState != null && windowState.getSurfaceControl() != null && this.isDefaultDisplay) {
            ...
            DisplayContent topFocusedDisplayContent = this.mRootWindowContainer.getTopFocusedDisplayContent();
            if (topFocusedDisplayContent != null && topFocusedDisplayContent.isAppCastingDisplay() && topFocusedDisplayContent.mImeInputTarget != null) {
                return true;
            }
        }
        return false;
    ...
    public boolean isInSidesGestureArea(int i, int i2) {
        return this.mSystemGestureFrameLeft.contains(i, i2) || this.mSystemGestureFrameRight.contains(i, i2);
    }

    public void addTransientLaunchOverlayToken(TransientLaunchOverlayToken transientLaunchOverlayToken) {
        this.mTransientLaunchOverlayTokens.add(transientLaunchOverlayToken);
    }

    public void removeTransientLaunchOverlayToken(TransientLaunchOverlayToken transientLaunchOverlayToken) {
