...
public class Watermark {
    ...
    public Watermark(DisplayContent displayContent, DisplayMetrics displayMetrics, String[] strArr, SurfaceControl.Transaction transaction) {
        ...
        try {
            ...
            transaction.setLayer(surfaceControl, 1000000).setPosition(surfaceControl, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON).show(surfaceControl);
