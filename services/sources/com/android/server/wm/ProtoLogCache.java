...
public abstract class ProtoLogCache {
    ...
    public static boolean WM_DEBUG_INPUT_enabled = false;
    ...
    public static boolean WM_FORCE_DEBUG_ADD_REMOVE_enabled = false;
    public static boolean WM_FORCE_DEBUG_ANIM_enabled = false;
    public static boolean WM_FORCE_DEBUG_APP_TRANSITIONS_ANIM_enabled = false;
    public static boolean WM_FORCE_DEBUG_APP_TRANSITIONS_enabled = false;
    public static boolean WM_FORCE_DEBUG_BOOT_enabled = false;
    public static boolean WM_FORCE_DEBUG_CONFIGURATION_enabled = false;
    public static boolean WM_FORCE_DEBUG_DRAW_enabled = false;
    public static boolean WM_FORCE_DEBUG_FOCUS_LIGHT_enabled = false;
    public static boolean WM_FORCE_DEBUG_FOCUS_enabled = false;
    public static boolean WM_FORCE_DEBUG_IME_enabled = false;
    public static boolean WM_FORCE_DEBUG_KEEP_SCREEN_ON_enabled = false;
    public static boolean WM_FORCE_DEBUG_ORIENTATION_enabled = false;
    public static boolean WM_FORCE_DEBUG_RECENTS_ANIMATIONS_enabled = false;
    public static boolean WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled = false;
    public static boolean WM_FORCE_DEBUG_RESIZE_enabled = false;
    public static boolean WM_FORCE_DEBUG_SCREEN_ON_enabled = false;
    public static boolean WM_FORCE_DEBUG_STARTING_WINDOW_enabled = false;
    public static boolean WM_FORCE_DEBUG_SYNC_ENGINE_enabled = false;
    public static boolean WM_FORCE_DEBUG_WINDOW_MOVEMENT_enabled = false;
    public static boolean WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled = false;
    public static boolean WM_FORCE_SHOW_SURFACE_ALLOC_enabled = false;
    public static boolean WM_FORCE_SHOW_TRANSACTIONS_enabled = false;
    ...
    public static void update() {
        ...
        WM_FORCE_DEBUG_ORIENTATION_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_ORIENTATION);
        WM_FORCE_DEBUG_FOCUS_LIGHT_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_FOCUS_LIGHT);
        WM_FORCE_DEBUG_BOOT_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_BOOT);
        WM_FORCE_DEBUG_RESIZE_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_RESIZE);
        WM_FORCE_DEBUG_ADD_REMOVE_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_ADD_REMOVE);
        WM_FORCE_DEBUG_CONFIGURATION_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_CONFIGURATION);
        WM_FORCE_DEBUG_FOCUS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_FOCUS);
        WM_FORCE_DEBUG_STARTING_WINDOW_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_STARTING_WINDOW);
        WM_FORCE_SHOW_TRANSACTIONS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_SHOW_TRANSACTIONS);
        WM_FORCE_SHOW_SURFACE_ALLOC_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_SHOW_SURFACE_ALLOC);
        WM_FORCE_DEBUG_APP_TRANSITIONS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_APP_TRANSITIONS);
        WM_FORCE_DEBUG_APP_TRANSITIONS_ANIM_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_APP_TRANSITIONS_ANIM);
        WM_FORCE_DEBUG_RECENTS_ANIMATIONS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_RECENTS_ANIMATIONS);
        WM_FORCE_DEBUG_DRAW_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_DRAW);
        WM_FORCE_DEBUG_REMOTE_ANIMATIONS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_REMOTE_ANIMATIONS);
        WM_FORCE_DEBUG_SCREEN_ON_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_SCREEN_ON);
        WM_FORCE_DEBUG_KEEP_SCREEN_ON_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_KEEP_SCREEN_ON);
        WM_FORCE_DEBUG_WINDOW_MOVEMENT_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_WINDOW_MOVEMENT);
        WM_FORCE_DEBUG_IME_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_IME);
        WM_FORCE_DEBUG_ANIM_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_ANIM);
        WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_WINDOW_TRANSITIONS);
        WM_FORCE_DEBUG_SYNC_ENGINE_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_FORCE_DEBUG_SYNC_ENGINE);
        WM_DEBUG_INPUT_enabled = ProtoLogImpl.isEnabled(ProtoLogGroup.WM_DEBUG_INPUT);
