...
public class TaskChangeNotificationController {
    ...
    public final TaskStackConsumer mNotifyActivityDismissingDockedTask = new TaskStackConsumer() { // from class: com.android.server.wm.TaskChangeNotificationController$$ExternalSyntheticLambda3
        @Override // com.android.server.wm.TaskChangeNotificationController.TaskStackConsumer
        public final void accept(ITaskStackListener iTaskStackListener, Message message) {
            TaskChangeNotificationController.lambda$new$12(iTaskStackListener, message);
        }
    };
    ...
    public final TaskStackConsumer mNotifyOccludeChangeNotice = new TaskStackConsumer() { // from class: com.android.server.wm.TaskChangeNotificationController$$ExternalSyntheticLambda17
        @Override // com.android.server.wm.TaskChangeNotificationController.TaskStackConsumer
        public final void accept(ITaskStackListener iTaskStackListener, Message message) {
            TaskChangeNotificationController.lambda$new$25(iTaskStackListener, message);
        }
    };
    public final TaskStackConsumer mNotifyTaskWindowingModeChanged = new TaskStackConsumer() { // from class: com.android.server.wm.TaskChangeNotificationController$$ExternalSyntheticLambda18
        @Override // com.android.server.wm.TaskChangeNotificationController.TaskStackConsumer
        public final void accept(ITaskStackListener iTaskStackListener, Message message) {
    ...
    public static /* synthetic */ void lambda$new$12(ITaskStackListener iTaskStackListener, Message message) {
        Object obj = message.obj;
        if (obj instanceof String) {
            iTaskStackListener.onActivityDismissingSplitTask((String) obj);
        } else {
    ...
    public static /* synthetic */ void lambda$new$19(ITaskStackListener iTaskStackListener, Message message) {
    ...
    public static /* synthetic */ void lambda$new$25(ITaskStackListener iTaskStackListener, Message message) {
        iTaskStackListener.onOccludeChangeNotice((ComponentName) SemWindowManager.castOrNull(message.obj, ComponentName.class), message.arg1 != 0);
    }
            ...
            switch (message.what) {
                ...
                case 29:
                    if (CoreRune.FW_SUPPORT_OCCLUDES_PARENT_CHANGE_CALLBACK) {
                        TaskChangeNotificationController taskChangeNotificationController26 = TaskChangeNotificationController.this;
                        taskChangeNotificationController26.forAllRemoteListeners(taskChangeNotificationController26.mNotifyOccludeChangeNotice, message);
                        break;
                    }
                    break;
                case 30:
                    TaskChangeNotificationController taskChangeNotificationController27 = TaskChangeNotificationController.this;
                    taskChangeNotificationController27.forAllRemoteListeners(taskChangeNotificationController27.mNotifyTaskWindowingModeChanged, message);
                    break;
            }
            Object obj = message.obj;
    ...
    public void notifyActivityDismissingDockedRootTask(String str) {
    ...
    public void notifyOccludeChangeNotice(ComponentName componentName, boolean z) {
        Message obtainMessage = this.mHandler.obtainMessage(29, z ? 1 : 0, 0, componentName);
        forAllLocalListeners(this.mNotifyOccludeChangeNotice, obtainMessage);
        obtainMessage.sendToTarget();
    }

    public void notifyTaskWindowingModeChanged(int i) {
        Message obtainMessage = this.mHandler.obtainMessage(30, i, 0);
        forAllLocalListeners(this.mNotifyTaskWindowingModeChanged, obtainMessage);
        obtainMessage.sendToTarget();
    }
}
