...
public class NavBarFadeAnimationController extends FadeAnimationController {
    public static final Interpolator FADE_IN_INTERPOLATOR = new PathInterpolator(DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f);
    public static final Interpolator FADE_OUT_INTERPOLATOR = new PathInterpolator(0.2f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f, 1.0f);
    ...
    public NavBarFadeAnimationController(DisplayContent displayContent) {
        ...
        AlphaAnimation alphaAnimation2 = new AlphaAnimation(1.0f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
