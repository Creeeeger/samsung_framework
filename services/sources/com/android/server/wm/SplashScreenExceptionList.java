...
public class SplashScreenExceptionList {
    ...
    public static boolean isOptedOut(Supplier supplier) {
        ...
        Bundle bundle;
        return (supplier == null || (applicationInfo = (ApplicationInfo) supplier.get()) == null || (bundle = applicationInfo.metaData) == null || !bundle.getBoolean("android.splashscreen.exception_opt_out", false)) ? false : true;
    }
