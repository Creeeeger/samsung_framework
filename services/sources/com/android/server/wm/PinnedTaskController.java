...
public class PinnedTaskController {
    ...
    public class PinnedTaskListenerDeathHandler implements IBinder.DeathRecipient {
        public /* synthetic */ PinnedTaskListenerDeathHandler(PinnedTaskController pinnedTaskController, PinnedTaskListenerDeathHandlerIA pinnedTaskListenerDeathHandlerIA) {
            this();
        }
    ...
    public final void reloadResources() {
        ...
        this.mMinAspectRatio = resources.getFloat(R.dimen.conversation_face_pile_protection_width_expanded);
        this.mMaxAspectRatio = resources.getFloat(R.dimen.conversation_face_pile_protection_width);
    }
