...
public class TaskPositioner implements IBinder.DeathRecipient {
        ...
        if (this.mDragEnded) {
            ...
            if (z && !this.mTmpRect.equals(this.mWindowDragBounds)) {
                ...
                synchronized (windowManagerGlobalLock3) {
                    try {
                        ActivityTaskManagerService activityTaskManagerService = this.mService.mAtmService;
    ...
    public CompletableFuture register(final DisplayContent displayContent, final WindowState windowState) {
        if (this.mClientChannel != null) {
            Slog.e("TaskPositioner", "Task positioner already registered");
            return CompletableFuture.completedFuture(null);
        }
        this.mDisplayContent = displayContent;
        this.mClientChannel = this.mService.mInputManager.createInputChannel("TaskPositioner");
        ...
        this.mDragApplicationHandle = new InputApplicationHandle(new Binder(), "TaskPositioner", InputConstants.DEFAULT_DISPATCHING_TIMEOUT_MILLIS);
    ...
    public /* synthetic */ void lambda$register$0(DisplayContent displayContent, WindowState windowState) {
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                ...
                this.mMinVisibleWidth = WindowManagerService.dipToPixel(WindowState.MINIMUM_VISIBLE_WIDTH_IN_DP, displayMetrics);
