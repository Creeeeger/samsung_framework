        ...
        while (!arrayList.isEmpty()) {
            ...
            if (!activityRecord.finishing) {
                ...
                if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
                    ProtoLogImpl.w(ProtoLogGroup.WM_DEBUG_TASKS, -1704402370, 0, (String) null, new Object[]{String.valueOf(activityRecord)});
                }
        ...
        while (!this.mResultActivities.isEmpty()) {
            ...
            if (!z || !activityRecord2.finishing) {
                ...
                if (ProtoLogCache.WM_DEBUG_ADD_REMOVE_enabled) {
                    ProtoLogImpl.i(ProtoLogGroup.WM_DEBUG_ADD_REMOVE, -1638958146, 0, (String) null, new Object[]{String.valueOf(activityRecord2), String.valueOf(this.mTask), String.valueOf(task), String.valueOf(Debug.getCallers(4))});
                }
                if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
                    ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_TASKS, -1198579104, 0, (String) null, new Object[]{String.valueOf(activityRecord2), String.valueOf(activityRecord)});
                }
    ...
    public final void processPendingReparentActivities() {
        ...
        while (!this.mPendingReparentActivities.isEmpty()) {
            ...
            if (bottomMostTask == null || !activityRecord.taskAffinity.equals(bottomMostTask.affinity)) {
                ...
                ProtoLogImpl.v(ProtoLogGroup.WM_DEBUG_TASKS, -877494781, 0, (String) null, new Object[]{String.valueOf(activityRecord), String.valueOf(bottomMostTask)});
            }
            if (bottomMostTask == null) {
                if (alwaysCreateRootTask) {
                    ...
                    reuseOrCreateTask = this.mTargetRootTask.reuseOrCreateTask(activityRecord.info, null, false);
                }
