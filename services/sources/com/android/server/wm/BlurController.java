...
public final class BlurController {
    ...
    public TunnelModeEnabledListener mTunnelModeListener = new TunnelModeEnabledListener(new SystemServerInitThreadPool$$ExternalSyntheticLambda1()) { // from class: com.android.server.wm.BlurController.1
