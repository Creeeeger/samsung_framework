...
public class LaunchObserverRegistryImpl extends ActivityMetricsLaunchObserver implements ActivityMetricsLaunchObserverRegistry {
    ...
    public void onActivityLaunchCancelled(long j) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda7
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void onActivityLaunchFinished(long j, ComponentName componentName, long j2) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(new QuadConsumer() { // from class: com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda2
            public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
    ...
    public void onReportFullyDrawn(long j, long j2) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(new TriConsumer() { // from class: com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda1
            public final void accept(Object obj, Object obj2, Object obj3) {
    ...
    public final void handleUnregisterLaunchObserver(ActivityMetricsLaunchObserver activityMetricsLaunchObserver) {
    ...
    public final void handleOnActivityLaunched(long j, ComponentName componentName, int i) {
        for (int i2 = 0; i2 < this.mList.size(); i2++) {
            ((ActivityMetricsLaunchObserver) this.mList.get(i2)).onActivityLaunched(j, componentName, i);
        }
    }
    ...
    public final void handleOnActivityLaunchFinished(long j, ComponentName componentName, long j2) {
        for (int i = 0; i < this.mList.size(); i++) {
            ((ActivityMetricsLaunchObserver) this.mList.get(i)).onActivityLaunchFinished(j, componentName, j2);
        }
    }
