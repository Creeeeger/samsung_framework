...
public final class TranslationManagerService extends AbstractMasterSystemService {
    ...
    public TranslationManagerService(Context context) {
        super(context, new FrameworkResourcesServiceNameResolver(context, R.string.face_acquired_too_right), null, 4);
    }
    ...
    public final class TranslationManagerServiceStub extends ITranslationManager.Stub {
        ...
        public void onTranslationCapabilitiesRequest(int i, int i2, ResultReceiver resultReceiver, int i3) {
        ...
        public void onSessionCreated(TranslationContext translationContext, int i, IResultReceiver iResultReceiver, int i2) {
            synchronized (TranslationManagerService.this.mLock) {
        ...
        public void updateUiTranslationState(int i, TranslationSpec translationSpec, TranslationSpec translationSpec2, List list, IBinder iBinder, int i2, UiTranslationSpec uiTranslationSpec, int i3) {
