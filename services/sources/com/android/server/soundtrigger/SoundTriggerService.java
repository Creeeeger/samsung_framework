...
public class SoundTriggerService extends SystemService {
    ...
    public final SoundTriggerHelper newSoundTriggerHelper(SoundTrigger.ModuleProperties moduleProperties, EventLogger eventLogger) {
        return newSoundTriggerHelper(moduleProperties, eventLogger, false);
    }

    public final SoundTriggerHelper newSoundTriggerHelper(SoundTrigger.ModuleProperties moduleProperties, EventLogger eventLogger, final boolean z) {
    ...
    public class SoundTriggerServiceStub extends ISoundTriggerService.Stub {
        ...
        public List listModuleProperties(Identity identity) {
            ...
            SafeCloseable establishIdentityDirect = PermissionUtil.establishIdentityDirect(identity);
            try {
                List lambda$newSoundTriggerHelper$2 = SoundTriggerService.this.lambda$newSoundTriggerHelper$2(identity);
                if (establishIdentityDirect != null) {
                    establishIdentityDirect.close();
                }
    ...
    public class SoundTriggerSessionStub extends ISoundTriggerSession.Stub {
        ...
        public int startRecognition(SoundTrigger.GenericSoundModel genericSoundModel, IRecognitionStatusCallback iRecognitionStatusCallback, SoundTrigger.RecognitionConfig recognitionConfig, boolean z) {
            ...
            try {
                ...
                if (genericSoundModel == null) {
                    this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid((SoundTrigger.SoundModel) genericSoundModel), "Invalid sound model").printLog(2, "SoundTriggerService"));
                    if (create == null) {
        ...
        public int loadKeyphraseSoundModel(SoundTrigger.KeyphraseSoundModel keyphraseSoundModel) {
            ...
            try {
                ...
                if (keyphraseSoundModel != null && keyphraseSoundModel.getUuid() != null) {
                    ...
                    this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid((SoundTrigger.SoundModel) keyphraseSoundModel), "Only one keyphrase supported").printLog(2, "SoundTriggerService"));
                    if (create != null) {
                        create.close();
                    }
                    return Integer.MIN_VALUE;
                }
                this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid((SoundTrigger.SoundModel) keyphraseSoundModel), "Invalid sound model").printLog(2, "SoundTriggerService"));
                if (create != null) {
                    create.close();
                }
                return Integer.MIN_VALUE;
        ...
        public int startRecognitionForService(ParcelUuid parcelUuid, Bundle bundle, ComponentName componentName, SoundTrigger.RecognitionConfig recognitionConfig) {
            ...
            try {
                ...
                synchronized (SoundTriggerService.this.mLock) {
                    ...
                    if (genericSoundModel == null) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Model not loaded").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
                    ...
                    if (iRecognitionStatusCallback != null) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Model already running").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
                    ...
                    if (genericSoundModel.getType() != 1) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Unsupported model type").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
                    ...
                    if (startGenericRecognition != 0) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Model start fail").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return startGenericRecognition;
        ...
        public int stopRecognitionForService(ParcelUuid parcelUuid) {
            ...
            try {
                ...
                synchronized (SoundTriggerService.this.mLock) {
                    ...
                    if (iRecognitionStatusCallback == null) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Model not running").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
                    ...
                    if (soundModel.getType() != 1) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Unknown model type").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
                    ...
                    if (stopGenericRecognition != 0) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Failed to stop model").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return stopGenericRecognition;
            ...
            try {
                ...
                synchronized (SoundTriggerService.this.mLock) {
                    ...
                    if (unloadKeyphraseSoundModel != 0) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Failed to unload model").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
        ...
        public int getModelState(ParcelUuid parcelUuid) {
            ...
            try {
                ...
                synchronized (SoundTriggerService.this.mLock) {
                    ...
                    if (soundModel == null) {
                        this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(type, getUuid(parcelUuid), "Model is not loaded").printLog(2, "SoundTriggerService"));
                        if (create != null) {
                            create.close();
                        }
                        return Integer.MIN_VALUE;
        ...
        public final void lambda$new$0() {
            ...
            SoundTriggerService.this.mServiceEventLogger.enqueue(new SoundTriggerEvent.ServiceEvent(SoundTriggerEvent.ServiceEvent.Type.DETACH, this.mOriginatorIdentity.packageName, "Client died").printLog(2, "SoundTriggerService"));
            detach();
        }
        ...
        public class RemoteSoundTriggerDetectionService extends IRecognitionStatusCallback.Stub implements ServiceConnection {
            ...
            */
            public final void runOrAddOperation(com.android.server.soundtrigger.SoundTriggerService.Operation r8) {
                /*
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onGenericSoundTriggerDetected$1(SoundTrigger.GenericRecognitionEvent genericRecognitionEvent, int i, ISoundTriggerDetectionService iSoundTriggerDetectionService) {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onError$4(int i, int i2, ISoundTriggerDetectionService iSoundTriggerDetectionService) {
    ...
    public final class LocalSoundTriggerService implements SoundTriggerInternal {
        ...
        public class SessionImpl implements SoundTriggerInternal.Session {
            ...
            public synchronized int stopRecognition(int i, IRecognitionStatusCallback iRecognitionStatusCallback) {
                this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(SoundTriggerEvent.SessionEvent.Type.STOP_RECOGNITION, (UUID) this.mModelUuid.get(i)));
            ...
            public int setParameter(int i, int i2, int i3) {
                this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(SoundTriggerEvent.SessionEvent.Type.SET_PARAMETER, (UUID) this.mModelUuid.get(i)));
            ...
            public int unloadKeyphraseModel(int i) {
                this.mEventLogger.enqueue(new SoundTriggerEvent.SessionEvent(SoundTriggerEvent.SessionEvent.Type.UNLOAD_MODEL, (UUID) this.mModelUuid.get(i)));
