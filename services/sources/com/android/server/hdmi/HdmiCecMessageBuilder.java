...
public abstract class HdmiCecMessageBuilder {
    ...
    public static HdmiCecMessage buildFeatureAbortCommand(int i, int i2, int i3, int i4) {
        return HdmiCecMessage.build(i, i2, 0, new byte[]{(byte) (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT), (byte) (i4 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)});
    }
    ...
    public static HdmiCecMessage buildCecVersion(int i, int i2, int i3) {
        return HdmiCecMessage.build(i, i2, FrameworkStatsLog.DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_NO_SHARING_TO_PERSONAL, new byte[]{(byte) (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)});
    }
    ...
    public static HdmiCecMessage buildRequestShortAudioDescriptor(int i, int i2, int[] iArr) {
        ...
        return HdmiCecMessage.build(i, i2, FrameworkStatsLog.DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_ADMIN_RESTRICTED, bArr);
    }
    ...
    public static HdmiCecMessage buildInactiveSource(int i, int i2) {
        return HdmiCecMessage.build(i, 0, FrameworkStatsLog.DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_WORK_APPS_DISABLED, physicalAddressToParam(i2));
    }
    ...
    public static HdmiCecMessage buildReportPowerStatus(int i, int i2, int i3) {
        return HdmiCecMessage.build(i, i2, 144, new byte[]{(byte) (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)});
    }

    public static HdmiCecMessage buildReportMenuStatus(int i, int i2, int i3) {
        return HdmiCecMessage.build(i, i2, 142, new byte[]{(byte) (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)});
    }
    ...
    public static HdmiCecMessage buildReportShortAudioDescriptor(int i, int i2, byte[] bArr) {
        return HdmiCecMessage.build(i, i2, FrameworkStatsLog.DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_LAUNCHED_FROM_SETTINGS, bArr);
    }
    ...
    public static HdmiCecMessage buildUserControlPressed(int i, int i2, int i3) {
        return buildUserControlPressed(i, i2, new byte[]{(byte) (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)});
    }
    ...
    public static HdmiCecMessage buildGiveFeatures(int i, int i2) {
        return HdmiCecMessage.build(i, i2, FrameworkStatsLog.DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_MISSING_WORK_APP);
    }
