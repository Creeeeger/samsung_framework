...
public final class HdmiControlShellCommand extends ShellCommand {
    ...
    public final int deviceSelect(PrintWriter printWriter) {
    ...
    public final int oneTouchPlay(PrintWriter printWriter) {
    ...
    public final int vendorCommand(PrintWriter printWriter) {
        char c;
    ...
    public final int cecSetting(PrintWriter printWriter) {
        if (getRemainingArgsCount() < 1) {
    ...
    public final int setSystemAudioMode(PrintWriter printWriter) {
    ...
    public final int setArcMode(PrintWriter printWriter) {
        if (1 > getRemainingArgsCount()) {
    ...
    public final int historySize(PrintWriter printWriter) {
        if (1 > getRemainingArgsCount()) {
