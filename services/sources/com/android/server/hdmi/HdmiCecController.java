...
public final class HdmiCecController {
    ...
    public void allocateLogicalAddress(int i, int i2, AllocateAddressCallback allocateAddressCallback) {
        assertRunOnServiceThread();
        this.mIoHandler.postDelayed(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.3
            public final /* synthetic */ AllocateAddressCallback val$callback;
            public final /* synthetic */ int val$deviceType;
            public final /* synthetic */ int val$preferredAddress;

            public AnonymousClass3(int i3, int i22, AllocateAddressCallback allocateAddressCallback2) {
                r2 = i3;
                r3 = i22;
                r4 = allocateAddressCallback2;
            }

            @Override // java.lang.Runnable
            public void run() {
                HdmiCecController.this.handleAllocateLogicalAddress(r2, r3, r4);
            }
    ...
    public final void handleAllocateLogicalAddress(int i, int i2, AllocateAddressCallback allocateAddressCallback) {
        int i3;
        boolean z;
        assertRunOnIoThread();
        ...
        if (allocateAddressCallback != null) {
            runOnServiceThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.4
                ...
                public AnonymousClass4(AllocateAddressCallback allocateAddressCallback2, int i6, int i32) {
                    r2 = allocateAddressCallback2;
                    r3 = i6;
                    r4 = i32;
                }
    ...
    public final void runDevicePolling(int i, List list, int i2, HdmiControlService.DevicePollingCallback devicePollingCallback, List list2) {
        assertRunOnServiceThread();
        if (!list.isEmpty()) {
            runOnIoThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.5
                public final /* synthetic */ List val$allocated;
                public final /* synthetic */ HdmiControlService.DevicePollingCallback val$callback;
                public final /* synthetic */ Integer val$candidate;
                public final /* synthetic */ List val$candidates;
                public final /* synthetic */ int val$retryCount;
                public final /* synthetic */ int val$sourceAddress;

                public AnonymousClass5(int i3, Integer num, int i22, List list22, List list3, HdmiControlService.DevicePollingCallback devicePollingCallback2) {
                    r2 = i3;
                    r3 = num;
                    r4 = i22;
                    r5 = list22;
                    r6 = list3;
                    r7 = devicePollingCallback2;
                }

                @Override // java.lang.Runnable
                public void run() {
                    if (HdmiCecController.this.sendPollMessage(r2, r3.intValue(), r4)) {
                        r5.add(r3);
                    }
                    HdmiCecController.this.runOnServiceThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.5.1
                        ...
                        public void run() {
                            ...
                            HdmiCecController.this.runDevicePolling(r2, r6, r4, r7, r5);
                        }
                    });
                }
        ...
        } else if (devicePollingCallback2 != null) {
            HdmiLogger.debug("[P]:AllocatedAddress=%s", list22.toString());
            devicePollingCallback2.onPollingFinished(list22);
        }
    }
    ...
    public void sendCommand(HdmiCecMessage hdmiCecMessage, HdmiControlService.SendMessageCallback sendMessageCallback) {
        assertRunOnServiceThread();
        ArrayList arrayList = new ArrayList();
        runOnIoThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.7
            ...
            public AnonymousClass7(HdmiCecMessage hdmiCecMessage2, List arrayList2, HdmiControlService.SendMessageCallback sendMessageCallback2) {
                r2 = hdmiCecMessage2;
                r3 = arrayList2;
            ...
            public void run() {
                ...
                int i = 0;
                HdmiLogger.debug("[S]:" + r2, new Object[0]);
                byte[] buildBody = HdmiCecController.buildBody(r2.getOpcode(), r2.getParams());
                while (true) {
                    nativeSendCecCommand = HdmiCecController.this.mNativeWrapperImpl.nativeSendCecCommand(r2.getSource(), r2.getDestination(), buildBody);
                    if (nativeSendCecCommand == 0) {
                        r3.add("ACK");
                ...
                if (nativeSendCecCommand != 0) {
                    Slog.w("HdmiCecController", "Failed to send " + r2 + " with errorCode=" + nativeSendCecCommand);
                }
                HdmiCecController.this.runOnServiceThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.7.1
                    public final /* synthetic */ int val$finalError;

                    public AnonymousClass1(int nativeSendCecCommand2) {
                        r2 = nativeSendCecCommand2;
                    }
                    ...
                    public void run() {
                        ...
                        hdmiCecAtomWriter.messageReported(r2, 2, HdmiCecController.this.getCallingUid(), r2);
                        HdmiControlService.SendMessageCallback sendMessageCallback2 = r4;
                        if (sendMessageCallback2 != null) {
                            sendMessageCallback2.onSendCompleted(r2);
                        }
                    }
                });
            }
        ...
        addCecMessageToHistory(false, hdmiCecMessage2, arrayList2);
    }
    ...
    public class AnonymousClass7 implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            int nativeSendCecCommand2;
            int i = 0;
            HdmiLogger.debug("[S]:" + r2, new Object[0]);
            byte[] buildBody = HdmiCecController.buildBody(r2.getOpcode(), r2.getParams());
            while (true) {
                nativeSendCecCommand2 = HdmiCecController.this.mNativeWrapperImpl.nativeSendCecCommand(r2.getSource(), r2.getDestination(), buildBody);
                if (nativeSendCecCommand2 == 0) {
                    r3.add("ACK");
                } else if (nativeSendCecCommand2 == 1) {
                    r3.add("NACK");
                } else if (nativeSendCecCommand2 == 2) {
                    r3.add("BUSY");
                } else if (nativeSendCecCommand2 == 3) {
                    r3.add("FAIL");
                }
                if (nativeSendCecCommand2 == 0) {
                    break;
            ...
            if (nativeSendCecCommand2 != 0) {
                Slog.w("HdmiCecController", "Failed to send " + r2 + " with errorCode=" + nativeSendCecCommand2);
            }
            HdmiCecController.this.runOnServiceThread(new Runnable() { // from class: com.android.server.hdmi.HdmiCecController.7.1
                public final /* synthetic */ int val$finalError;

                public AnonymousClass1(int nativeSendCecCommand22) {
                    r2 = nativeSendCecCommand22;
                }
    ...
    public final class NativeWrapperImplAidl implements NativeWrapper, IBinder.DeathRecipient {
        ...
        public /* synthetic */ NativeWrapperImplAidl(NativeWrapperImplAidlIA nativeWrapperImplAidlIA) {
            this();
        }
    ...
    public final class NativeWrapperImpl11 implements NativeWrapper, IHwBinder.DeathRecipient, IHdmiCec.getPhysicalAddressCallback {
        ...
        public /* synthetic */ NativeWrapperImpl11(NativeWrapperImpl11IA nativeWrapperImpl11IA) {
            this();
        }
    ...
    public final class NativeWrapperImpl implements NativeWrapper, IHwBinder.DeathRecipient, IHdmiCec.getPhysicalAddressCallback {
        ...
        public /* synthetic */ NativeWrapperImpl(NativeWrapperImplIA nativeWrapperImplIA) {
            this();
        }
