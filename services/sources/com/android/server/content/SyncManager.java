...
public class SyncManager {
    ...
    public static final Comparator sOpDumpComparator = new Comparator() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda1
    ...
    public static final Comparator sOpRuntimeComparator = new Comparator() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda2
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            int lambda$static$7;
    ...
    public final boolean isJobIdInUseLockedH(int i, List list) {
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (((JobInfo) list.get(i2)).getId() == i) {
                return true;
            }
        }
        int size2 = this.mActiveSyncContexts.size();
        for (int i3 = 0; i3 < size2; i3++) {
            if (((ActiveSyncContext) this.mActiveSyncContexts.get(i3)).mSyncOperation.jobId == i) {
                return true;
            }
        }
        return false;
    ...
    public boolean isContactSharingAllowedForCloneProfile() {
        return this.mContext.getResources().getBoolean(17891655) && this.mAppCloningDeviceConfigHelper.getEnableAppCloningBuildingBlocks();
    }
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:80:0x02ba A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:94:0x02a9 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void scheduleSync(android.accounts.Account r44, final int r45, final int r46, java.lang.String r47, android.os.Bundle r48, final int r49, final long r50, boolean r52, final int r53, final int r54, final int r55, final java.lang.String r56) {
        /*
    ...
    public List getPeriodicSyncs(SyncStorageEngine.EndPoint endPoint) {
    ...
    /* loaded from: classes.dex */
    public class ScheduleSyncMessagePayload {
    ...
    public final void clearBackoffSetting(SyncStorageEngine.EndPoint endPoint, String str) {
        Pair backoff = this.mSyncStorageEngine.getBackoff(endPoint);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void scheduleSyncOperationH(com.android.server.content.SyncOperation r20, long r21) {
        /*
    ...
    public static Intent getAdapterBindIntent(Context context, ComponentName componentName, int i) {
        ...
        intent.putExtra("android.intent.extra.client_label", 17042978);
    ...
    public void dumpSyncState(PrintWriter printWriter, SyncAdapterStateFetcher syncAdapterStateFetcher) {
        ...
        while (it.hasNext()) {
            ...
            long j = elapsedRealtime - activeSyncContext.mStartTime;
            printWriter.print("  ");
            sb.setLength(0);
            printWriter.print(formatDurationHMS(sb, j));
            printWriter.print(" - ");
            printWriter.print(activeSyncContext.mSyncOperation.dump(packageManager, false, syncAdapterStateFetcher, false));
            printWriter.println();
        }
        printWriter.println();
        ...
        while (i2 < length) {
            ...
            Collections.sort(newArrayList, new Comparator() { // from class: com.android.server.content.SyncManager.12
                @Override // java.util.Comparator
                public int compare(RegisteredServicesCache.ServiceInfo serviceInfo, RegisteredServicesCache.ServiceInfo serviceInfo2) {
            ...
            while (it2.hasNext()) {
                ...
                if (((SyncAdapterType) serviceInfo.type).accountType.equals(accountAndUser.account.type)) {
                    ...
                    Iterator it3 = it2;
                    Pair copyOfAuthorityWithSyncStatus = this.mSyncStorageEngine.getCopyOfAuthorityWithSyncStatus(new SyncStorageEngine.EndPoint(accountAndUser.account, ((SyncAdapterType) serviceInfo.type).authority, accountAndUser.userId));
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void dumpRecentHistory(java.io.PrintWriter r34) {
        /*
    ...
    /* loaded from: classes.dex */
    public class AuthoritySyncStats {
    ...
    public static void sendOnUnsyncableAccount(final Context context, RegisteredServicesCache.ServiceInfo serviceInfo, int i, OnReadyCallback onReadyCallback) {
    ...
    /* loaded from: classes.dex */
    public class OnUnsyncableAccountCheck implements ServiceConnection {
        ...
        public OnUnsyncableAccountCheck(RegisteredServicesCache.ServiceInfo serviceInfo, OnReadyCallback onReadyCallback) {
    ...
    public class SyncHandler extends Handler {
        ...
        public final PowerManager.WakeLock getSyncWakeLock(SyncOperation syncOperation) {
            ...
            PowerManager.WakeLock wakeLock = (PowerManager.WakeLock) this.mWakeLocks.get(wakeLockName);
            if (wakeLock != null) {
                return wakeLock;
            }
        ...
        public final void startSyncH(SyncOperation syncOperation) {
            ...
            if (syncOperation.isPeriodic) {
                ...
                while (it2.hasNext()) {
                    int i3 = ((ActiveSyncContext) it2.next()).mSyncOperation.sourcePeriodicId;
            ...
            Iterator it3 = SyncManager.this.mActiveSyncContexts.iterator();
            while (true) {
                if (!it3.hasNext()) {
                    break;
                }
                ActiveSyncContext activeSyncContext = (ActiveSyncContext) it3.next();
                if (activeSyncContext.mSyncOperation.isConflict(syncOperation)) {
                    if (activeSyncContext.mSyncOperation.getJobBias() >= syncOperation.getJobBias()) {
                        if (isLoggable) {
                    ...
                    deferActiveSyncH(activeSyncContext, "preempted");
                }
            }
        ...
        public final void installHandleTooManyDeletesNotification(Account account, String str, long j, int i) {
            ...
            CharSequence text = SyncManager.this.mContext.getResources().getText(R.string.importance_from_user);
            Context contextForUser = SyncManager.this.getContextForUser(userHandle);
            Notification build = new Notification.Builder(contextForUser, SystemNotificationChannels.ACCOUNT).setSmallIcon(17304216).setTicker(SyncManager.this.mContext.getString(R.string.immersive_cling_title)).setWhen(System.currentTimeMillis()).setColor(contextForUser.getColor(R.color.system_notification_accent_color)).setContentTitle(contextForUser.getString(R.string.importance_from_person)).setContentText(String.format(text.toString(), loadLabel)).setContentIntent(activityAsUser).build();
            build.flags |= 2;
    ...
    public class PrintTable {
        ...
        public ArrayList mTable = Lists.newArrayList();
        ...
        public void writeTo(PrintWriter printWriter) {
            ...
            while (true) {
                ...
                int i4 = 0;
                while (it.hasNext()) {
                    int length = ((Object[]) it.next())[i2].toString().length();
                    if (length > i4) {
                        i4 = length;
                    }
                }
            ...
            strArr[i - 1] = "%s";
            printRow(printWriter, strArr, (Object[]) this.mTable.get(0));
            ...
            for (int i7 = 1; i7 < size; i7++) {
                printRow(printWriter, strArr, (Object[]) this.mTable.get(i7));
            }
        }
