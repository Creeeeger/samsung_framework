    ...
    public boolean onCleanupApplicationRecordLocked(boolean z) {
        ...
        if (!this.mConProviders.isEmpty()) {
            for (int size2 = this.mConProviders.size() - 1; size2 >= 0; size2--) {
                ...
                activityManagerService.stopAssociationLocked(i, str, contentProviderRecord2.uid, contentProviderRecord2.appInfo.longVersionCode, contentProviderRecord2.name, contentProviderRecord2.info.processName);
            }
