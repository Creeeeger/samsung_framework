...
public class BroadcastConstants {
    ...
    public static final int MAX_HISTORY_DELAYED_BROADCAST;
    ...
    static {
        MAX_HISTORY_DELAYED_BROADCAST = ActivityManager.isLowRamDeviceStatic() ? 1 : 3;
    ...
    public final void updateDeviceConfigConstants() {
        synchronized (this) {
            ...
            this.MAX_HISTORY_SUMMARY_SIZE = ActivityManager.isLowRamDeviceStatic() ? 512 : IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES;
