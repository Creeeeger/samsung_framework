...
public final class IntentBindRecord {
    ...
    public void dumpInService(PrintWriter printWriter, String str) {
        ...
        for (int i = 0; i < this.apps.size(); i++) {
            AppBindRecord appBindRecord = (AppBindRecord) this.apps.valueAt(i);
            printWriter.print(str);
    ...
    public long collectFlags() {
        ...
        for (int size = this.apps.size() - 1; size >= 0; size--) {
            ...
            for (int size2 = arraySet.size() - 1; size2 >= 0; size2--) {
                j |= ((ConnectionRecord) arraySet.valueAt(size2)).getFlags();
            }
        }
        return j;
    }
    ...
    public void dumpDebug(ProtoOutputStream protoOutputStream, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (appBindRecord != null) {
                appBindRecord.dumpDebug(protoOutputStream, 2246267895816L);
            }
        }
