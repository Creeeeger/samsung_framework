...
public final class AppBroadcastEventsTracker extends BaseAppStateTimeSlotEventsTracker implements ActivityManagerInternal.BroadcastEventListener {
    ...
    public AppBroadcastEventsTracker(Context context, AppRestrictionController appRestrictionController, Constructor constructor, Object obj) {
    ...
    public final class AppBroadcastEventsPolicy extends BaseAppStateTimeSlotEventsTracker.BaseAppStateTimeSlotEventsPolicy {
        public AppBroadcastEventsPolicy(BaseAppStateTracker.Injector injector, AppBroadcastEventsTracker appBroadcastEventsTracker) {
            super(injector, appBroadcastEventsTracker, "bg_broadcast_monitor_enabled", true, "bg_broadcast_window", BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS, "bg_ex_broadcast_threshold", 10000);
        }
