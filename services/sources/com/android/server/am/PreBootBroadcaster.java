...
public abstract class PreBootBroadcaster extends IIntentReceiver.Stub {
    ...
    public Handler mHandler = new Handler(UiThread.get().getLooper(), null, true) { // from class: com.android.server.am.PreBootBroadcaster.1
        ...
        public void handleMessage(Message message) {
            ...
            if (i3 != 1) {
                ...
                CharSequence text = context.getText(R.string.car_mode_disable_notification_title);
    ...
    public void sendNext() {
        ...
        if (this.mProgress != null) {
            this.mProgress.setProgress(this.mIndex, this.mTargets.size(), this.mService.mContext.getString(R.string.capability_title_canTakeScreenshot, resolveInfo.activityInfo.loadLabel(this.mService.mContext.getPackageManager())));
        }
