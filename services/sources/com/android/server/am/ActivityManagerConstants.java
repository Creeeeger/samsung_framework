...
public final class ActivityManagerConstants extends ContentObserver {
    ...
    public ArraySet IMPERCEPTIBLE_KILL_EXEMPT_PACKAGES;
    public ArraySet IMPERCEPTIBLE_KILL_EXEMPT_PROC_STATES;
    ...
    public List mDefaultImperceptibleKillExemptPackages;
    public List mDefaultImperceptibleKillExemptProcStates;
    ...
    /* renamed from: com.android.server.am.ActivityManagerConstants$1 */
    /* loaded from: classes.dex */
    ...
    /* renamed from: com.android.server.am.ActivityManagerConstants$2 */
    /* loaded from: classes.dex */
    ...
    public ActivityManagerConstants(Context context, ActivityManagerService activityManagerService, Handler handler) {
        ...
        this.mSystemServerAutomaticHeapDumpEnabled = Build.IS_DEBUGGABLE && context.getResources().getBoolean(R.bool.editable_voicemailnumber);
        this.mSystemServerAutomaticHeapDumpPackageName = context.getPackageName();
        this.mSystemServerAutomaticHeapDumpPssThresholdBytes = Math.max(102400L, context.getResources().getInteger(R.integer.config_globalActionsKeyTimeout));
        this.mDefaultImperceptibleKillExemptPackages = Arrays.asList(context.getResources().getStringArray(17236157));
        this.mDefaultImperceptibleKillExemptProcStates = (List) Arrays.stream(context.getResources().getIntArray(17236158)).boxed().collect(Collectors.toList());
        ...
        boolean z = context.getResources().getBoolean(R.bool.kg_enable_camera_default_widget);
        this.mDefaultBinderHeavyHitterWatcherEnabled = z;
        int integer = context.getResources().getInteger(R.integer.config_lidKeyboardAccessibility);
        this.mDefaultBinderHeavyHitterWatcherBatchSize = integer;
        float f = context.getResources().getFloat(R.dimen.config_screenBrightnessSettingMaximumFloat);
        this.mDefaultBinderHeavyHitterWatcherThreshold = f;
        boolean z2 = context.getResources().getBoolean(R.bool.kg_center_small_widgets_vertically);
        this.mDefaultBinderHeavyHitterAutoSamplerEnabled = z2;
        int integer2 = context.getResources().getInteger(R.integer.config_keepPreloadsMinDays);
        this.mDefaultBinderHeavyHitterAutoSamplerBatchSize = integer2;
        float f2 = context.getResources().getFloat(R.dimen.config_screenBrightnessSettingForVrMinimumFloat);
        ...
        arraySet.addAll((Collection) Arrays.stream(context.getResources().getStringArray(17236231)).map(new Function() { // from class: com.android.server.am.ActivityManagerConstants$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return ComponentName.unflattenFromString((String) obj);
            }
        }).collect(Collectors.toSet()));
        this.mCustomizedMaxCachedProcesses = context.getResources().getInteger(R.integer.config_dreamsBatteryLevelMinimumWhenPowered);
    ...
    public final void updateConstants() {
        ...
        synchronized (activityManagerService) {
            try {
                ...
                this.FULL_PSS_LOWERED_INTERVAL = this.mParser.getLong("full_pss_lowered_interval", BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS);
                this.POWER_CHECK_INTERVAL = this.mParser.getLong("power_check_interval", BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS);
                ...
                this.MEMORY_INFO_THROTTLE_TIME = this.mParser.getLong("memory_info_throttle_time", BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS);
    ...
    public final void updateNoKillCachedProcessesUntilBootCompleted() {
        this.mNoKillCachedProcessesUntilBootCompleted = DeviceConfig.getBoolean("activity_manager", "no_kill_cached_processes_until_boot_completed", false);
    }

    public final void updateNoKillCachedProcessesPostBootCompletedDurationMillis() {
        this.mNoKillCachedProcessesPostBootCompletedDurationMillis = DeviceConfig.getLong("activity_manager", "no_kill_cached_processes_post_boot_completed_duration_millis", 0L);
    }

    public final void updateMaxEmptyTimeMillis() {
        this.mMaxEmptyTimeMillis = DeviceConfig.getLong("activity_manager", "max_empty_time_millis", 3600000000L);
    }
    ...
    public final void updateServiceStartForegroundAnrDealyMs() {
        this.mServiceStartForegroundAnrDelayMs = DeviceConfig.getInt("activity_manager", "service_start_foreground_anr_delay_ms", 10000);
    }
    ...
    public void setCurTrimEmptyProcesses(int i) {
        if (i != 0) {
            this.CUSTOM_CUR_TRIM_EMPTY_PROCESSES = i;
        }
    }

    public void setCurTrimCachedProcesses(int i) {
        if (i != 0) {
            this.CUSTOM_CUR_TRIM_CACHED_PROCESSES = i;
        }
    }

    public void updateMaxCachedProcessesNum() {
        this.MAX_CACHED_PROCESSES = DEFAULT_MAX_CACHED_PROCESSES;
        updateMaxCachedProcesses();
    }

    public void updateMaxCachedProcessesNumFHA(int i) {
        this.MAX_CACHED_PROCESSES = i;
        updateMaxCachedProcesses();
    }
        ...
        try {
            ...
            if (i < 0) {
                if (TextUtils.isEmpty(property)) {
                    i = DEFAULT_MAX_CACHED_PROCESSES;
                } else {
    ...
    public final void updateMinAssocLogDuration() {
        MIN_ASSOC_LOG_DURATION = DeviceConfig.getLong("activity_manager", "min_assoc_log_duration", BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS);
    }
    ...
    public final void updateUseModernTrim() {
        this.USE_MODERN_TRIM = DeviceConfig.getBoolean("activity_manager", "use_modern_trim", true);
    }

    public final void updateFGSPermissionEnforcementFlagsIfNecessary(String str) {
