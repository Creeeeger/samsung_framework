...
public abstract class EventLogTags {
    ...
    public static void writeAmProcDied(int i, int i2, String str, int i3, int i4, int i5, int i6) {
        EventLog.writeEvent(30011, Integer.valueOf(i), Integer.valueOf(i2), str, Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6));
    }
    ...
    public static void writeAmCrash(int i, int i2, String str, int i3, String str2, String str3, String str4, int i4, int i5) {
        EventLog.writeEvent(30039, Integer.valueOf(i), Integer.valueOf(i2), str, Integer.valueOf(i3), str2, str3, str4, Integer.valueOf(i4), Integer.valueOf(i5));
    }
    ...
    public static void writeAmKillBgProc(String str, int i, int i2) {
        EventLog.writeEvent(1000101, str, Integer.valueOf(i), Integer.valueOf(i2));
    }
}
