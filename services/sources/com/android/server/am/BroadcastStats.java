...
public final class BroadcastStats {
    public static final Comparator ACTIONS_COMPARATOR = new Comparator() { // from class: com.android.server.am.BroadcastStats.1
    ...
    public void addBackgroundCheckViolation(String str, String str2) {
        ...
        ViolationEntry violationEntry = (ViolationEntry) actionEntry.mBackgroundCheckViolations.get(str2);
