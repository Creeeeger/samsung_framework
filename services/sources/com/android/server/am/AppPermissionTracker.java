...
public final class AppPermissionTracker extends BaseAppStateTracker implements PackageManager.OnPermissionsChangedListener {
    ...
    public SparseArray mUidGrantedPermissionsInMonitor;
    ...
    public AppPermissionTracker(Context context, AppRestrictionController appRestrictionController, Constructor constructor, Object obj) {
    ...
    public final void handlePermissionsInit() {
        ...
        for (int i4 : userIds) {
            List installedApplications = packageManagerInternal.getInstalledApplications(0L, i4, 1000);
    ...
    public final void handlePermissionsDestroy() {
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (((ArraySet) sparseArray.valueAt(i)).size() > 0) {
