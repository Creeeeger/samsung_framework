...
public final class AppRestrictionController {
    ...
    public final class RestrictionSettings {
        ...
        public void forEachPackageInUidLocked(int i, TriConsumer triConsumer) {
            int indexOfKey = this.mRestrictionLevels.indexOfKey(i);
            if (indexOfKey < 0) {
                return;
            }
        ...
        public void forEachUidLocked(Consumer consumer) {
        ...
        public void loadFromXml(int i, boolean z) {
            ...
            try {
                ...
                AppRestrictionController.this.errorMsg = e.getMessage();
            }
        }
            ...
            if (i3 != 0) {
                synchronized (AppRestrictionController.this.mSettingsLock) {
                    ...
                    if (z) {
                        ...
                        appRestrictionController.applyRestrictionLevel(str, i3, i4, appRestrictionController.mEmptyTrackerInfo, appStandbyBucket, true, 65280 & i2, i2 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                    } else {
                        restrictionSettingsLocked.update(i4, 65280 & i2, i2 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                    }
                    synchronized (AppRestrictionController.this.mSettingsLock) {
    ...
    public final class ConstantsObserver implements DeviceConfig.OnPropertiesChangedListener {
        ...
        public ConstantsObserver(Handler handler, Context context) {
            this.mDefaultBgPromptFgsWithNotiToBgRestricted = context.getResources().getBoolean(R.bool.config_defaultInTouchMode);
            this.mDefaultBgPromptAbusiveAppToBgRestricted = context.getResources().getBoolean(R.bool.config_debugEnableAutomaticSystemServerHeapDumps);
        }
    ...
    public AppRestrictionController(Injector injector, ActivityManagerService activityManagerService) {
        ...
        this.mRoleHolderChangedListener = new OnRoleHoldersChangedListener() { // from class: com.android.server.am.AppRestrictionController$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$onSystemReady$0() {
        ...
        for (int i = 0; i < size; i++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i)).onSystemReady();
        }
    }
    ...
    public final boolean isExemptedFromSysConfig(String str) {
        ArraySet arraySet = this.mBgRestrictionExemptioFromSysConfig;
    ...
    */
    public final boolean isSystemModule(java.lang.String r6) {
        /*
            r5 = this;
            java.lang.Object r0 = r5.mLock
            monitor-enter(r0)
            java.util.HashMap r1 = r5.mSystemModulesCache     // Catch: java.lang.Throwable -> L53
            java.lang.Object r1 = r1.get(r6)     // Catch: java.lang.Throwable -> L53
            java.lang.Boolean r1 = (java.lang.Boolean) r1     // Catch: java.lang.Throwable -> L53
            if (r1 == 0) goto L13
            boolean r5 = r1.booleanValue()     // Catch: java.lang.Throwable -> L53
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L53
            return r5
        L13:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L53
            com.android.server.am.AppRestrictionController$Injector r0 = r5.mInjector
            android.content.pm.PackageManager r0 = r0.getPackageManager()
            r1 = 1
            r2 = 0
            android.content.pm.ModuleInfo r3 = r0.getModuleInfo(r6, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L24
            if (r3 == 0) goto L24
            r3 = r1
            goto L25
        L24:
        ...
        L25:
            if (r3 != 0) goto L42
            android.content.pm.PackageInfo r0 = r0.getPackageInfo(r6, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            if (r0 == 0) goto L40
            android.content.pm.ApplicationInfo r0 = r0.applicationInfo     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            java.lang.String r0 = r0.sourceDir     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            java.io.File r4 = android.os.Environment.getApexDirectory()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            java.lang.String r4 = r4.getAbsolutePath()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            boolean r0 = r0.startsWith(r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L42
            if (r0 == 0) goto L40
            goto L41
        L40:
            r1 = r2
        ...
        L42:
            ...
            monitor-enter(r1)
            java.util.HashMap r5 = r5.mSystemModulesCache     // Catch: java.lang.Throwable -> L50
            java.lang.Boolean r0 = java.lang.Boolean.valueOf(r3)     // Catch: java.lang.Throwable -> L50
            r5.put(r6, r0)     // Catch: java.lang.Throwable -> L50
    ...
    public final void refreshAppRestrictionLevelForUser(int i, int i2, int i3) {
        ...
        for (AppStandbyInfo appStandbyInfo : appStandbyBuckets) {
            ...
            if (packageUid < 0) {
                ...
                Pair calcAppRestrictionLevel = calcAppRestrictionLevel(i, packageUid, appStandbyInfo.mPackageName, appStandbyInfo.mStandbyBucket, false, false);
    ...
    public void refreshAppRestrictionLevelForUid(int i, int i2, int i3, boolean z) {
        ...
        for (int length = packagesForUid.length; i4 < length; length = length) {
            ...
            Pair calcAppRestrictionLevel = calcAppRestrictionLevel(userId, i, str, appStandbyBucket, z, true);
    ...
    public final Pair calcAppRestrictionLevel(int i, int i2, String str, int i3, boolean z, boolean z2) {
        ...
        if (i3 != 5) {
            if (i3 == 50) {
                ...
                int i5 = i3 == 45 ? 40 : 30;
                if (z2) {
                    Pair calcAppRestrictionLevelFromTackers = calcAppRestrictionLevelFromTackers(i2, str, 100);
                    ...
                    if (i4 == 50) {
                        ...
                        Pair calcAppRestrictionLevelFromTackers2 = calcAppRestrictionLevelFromTackers(i2, str, 50);
    ...
    public final Pair calcAppRestrictionLevelFromTackers(int i, String str, int i2) {
        TrackerInfo trackerInfo;
        int i3 = 0;
        BaseAppStateTracker baseAppStateTracker = null;
        int i4 = 0;
        for (int size = this.mAppStateTrackers.size() - 1; size >= 0; size--) {
            i3 = Math.max(i3, ((BaseAppStateTracker) this.mAppStateTrackers.get(size)).getPolicy().getProposedRestrictionLevel(str, i, i2));
            if (i3 != i4) {
    ...
    public void dump(PrintWriter printWriter, String str) {
        ...
        for (int i = 0; i < size; i++) {
            printWriter.println();
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i)).dump(printWriter, str2);
        }
        if (this.errorMsg != null) {
            printWriter.print(str2);
            printWriter.println("App Restrictions have changed due to an exception while parsing XML " + this.errorMsg);
        }
    }
    ...
    public void dumpAsProto(ProtoOutputStream protoOutputStream, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).dumpAsProto(protoOutputStream, i);
        }
    }
    ...
    public void applyRestrictionLevel(final String str, final int i, final int i2, TrackerInfo trackerInfo, int i3, boolean z, int i4, int i5) {
        ...
        synchronized (this.mSettingsLock) {
            ...
            if (i2 < 40 || restrictionLevel >= 40) {
                ...
                appStandbyInternal.maybeUnrestrictApp(str, UserHandle.getUserId(i), reason & 65280, reason & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT, i10, i9);
                    ...
                    synchronized (obj2) {
                        ...
                        try {
                            if (this.mActiveUids.indexOfKey(i, str) >= 0) {
                                ...
                                this.mActiveUids.add(i, str, new Runnable() { // from class: com.android.server.am.AppRestrictionController$$ExternalSyntheticLambda1
                                    @Override // java.lang.Runnable
                                    public final void run() {
    ...
    public final void handleBackgroundRestrictionChanged(int i, String str, boolean z) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i3)).onBackgroundRestrictionChanged(i, str, z);
        }
        ...
        if (appStandbyBucket != 5) {
            ...
            if (lastRestrictionLevel == 40) {
                i2 = 45;
                Pair calcAppRestrictionLevel = calcAppRestrictionLevel(UserHandle.getUserId(i), i, str, i2, false, true);
        ...
        i2 = i4;
        Pair calcAppRestrictionLevel2 = calcAppRestrictionLevel(UserHandle.getUserId(i), i, str, i2, false, true);
    ...
    public static /* synthetic */ void lambda$dispatchAutoRestrictedBucketFeatureFlagChanged$3(AppStandbyInternal appStandbyInternal, String str, Integer num, Integer num2) {
        appStandbyInternal.restrictApp(str, UserHandle.getUserId(num.intValue()), num2.intValue() & 65280, num2.intValue() & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
    }
    ...
    public static /* synthetic */ void lambda$dispatchAutoRestrictedBucketFeatureFlagChanged$4(AppStandbyInternal appStandbyInternal, String str, Integer num, Integer num2) {
        appStandbyInternal.maybeUnrestrictApp(str, UserHandle.getUserId(num.intValue()), num2.intValue() & 65280, num2.intValue() & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT, FrameworkStatsLog.APP_STANDBY_BUCKET_CHANGED__MAIN_REASON__MAIN_USAGE, 6);
    }
    ...
    public final void handleAppStandbyBucketChanged(int i, String str, int i2) {
        ...
        Pair calcAppRestrictionLevel = calcAppRestrictionLevel(i2, packageUid, str, i, false, false);
    ...
    public void handleUidProcStateChanged(int i, int i2) {
        int size = this.mAppStateTrackers.size();
        for (int i3 = 0; i3 < size; i3++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i3)).onUidProcStateChanged(i, i2);
        }
    }
    ...
    public void handleUidGone(int i) {
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUidGone(i);
        }
    }
    ...
    public class NotificationHelper {
        ...
        public void postRequestBgRestrictedIfNecessary(String str, int i) {
            if (this.mBgController.mConstantsObserver.mBgPromptAbusiveAppsToBgRestricted) {
                ...
                PendingIntent.getActivityAsUser(this.mContext, 0, intent, 201326592, null, UserHandle.of(UserHandle.getUserId(i)));
                this.mBgController.hasForegroundServices(str, i);
                this.mBgController.hasForegroundServiceNotifications(str, i);
                boolean z = this.mBgController.mConstantsObserver.mBgPromptFgsWithNotiToBgRestricted;
            }
        }
        ...
        public void postLongRunningFgsIfNecessary(String str, int i) {
            ...
            if (this.mBgController.mConstantsObserver.mBgPromptFgsOnLongRunning) {
                ...
                postNotificationIfNecessary(1, 17041588, 17041570, PendingIntent.getBroadcastAsUser(this.mContext, 0, intent, 201326592, UserHandle.SYSTEM), str, i, null);
            }
        }
        ...
        public void postNotification(int i, String str, int i2, String str2, String str3, Icon icon, PendingIntent pendingIntent, Notification.Action[] actionArr) {
            ...
            Notification.Builder contentIntent = new Notification.Builder(this.mContext, SystemNotificationChannels.ABUSIVE_BACKGROUND_APPS).setAutoCancel(true).setGroup("com.android.app.abusive_bg_apps").setWhen(this.mInjector.currentTimeMillis()).setSmallIcon(R.drawable.stat_sys_warning).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).setContentTitle(str2).setContentText(str3).setContentIntent(pendingIntent);
            if (icon != null) {
        ...
        public final void postSummaryNotification(UserHandle userHandle) {
            this.mNotificationManager.notifyAsUser(null, 203105544, new Notification.Builder(this.mContext, SystemNotificationChannels.ABUSIVE_BACKGROUND_APPS).setGroup("com.android.app.abusive_bg_apps").setGroupSummary(true).setStyle(new Notification.BigTextStyle()).setSmallIcon(R.drawable.stat_sys_warning).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).build(), userHandle);
        }
    ...
    public static /* synthetic */ void lambda$handleUidActive$8(AppStandbyInternal appStandbyInternal, String str, int i, Integer num) {
        appStandbyInternal.restrictApp(str, i, num.intValue() & 65280, num.intValue() & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
    }
    ...
    public int getPotentialSystemExemptionReason(int i, String str) {
        ...
        return appStandbyInternal.isActiveDeviceAdmin(str, userId) ? FrameworkStatsLog.APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACTIVE_DEVICE_ADMIN : (activityManagerService.mConstants.mFlagSystemExemptPowerRestrictionsEnabled && appOpsManager.checkOpNoThrow(128, i, str) == 0) ? FrameworkStatsLog.TIF_TUNE_CHANGED : MARsExemptionManager.getInstance().isFgExemptedFromMars(str) ? 350 : -1;
    }
    ...
    public final boolean isCarrierApp(String str) {
        synchronized (this.mCarrierPrivilegedLock) {
            SparseArray sparseArray = this.mCarrierPrivilegedApps;
            if (sparseArray != null) {
                for (int size = sparseArray.size() - 1; size >= 0; size--) {
                    if (((Set) this.mCarrierPrivilegedApps.valueAt(size)).contains(str)) {
                        return true;
                    }
                }
            }
    ...
    public final void unregisterCarrierPrivilegesCallbacks() {
        ...
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            telephonyManager.unregisterCarrierPrivilegesCallback((TelephonyManager.CarrierPrivilegesCallback) arrayList.get(size));
        }
    ...
    public BaseAppStateTracker getAppStateTracker(Class cls) {
        Iterator it = this.mAppStateTrackers.iterator();
        while (it.hasNext()) {
            BaseAppStateTracker baseAppStateTracker = (BaseAppStateTracker) it.next();
            if (cls.isAssignableFrom(baseAppStateTracker.getClass())) {
                return baseAppStateTracker;
            }
        }
        return null;
    }
    ...
    public void forEachTracker(Consumer consumer) {
        int size = this.mAppStateTrackers.size();
        for (int i = 0; i < size; i++) {
            consumer.accept((BaseAppStateTracker) this.mAppStateTrackers.get(i));
        }
    }
    ...
    public final void onUserAdded(int i) {
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUserAdded(i);
        }
    }
    ...
    public final void onUserStarted(int i) {
        ...
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUserStarted(i);
        }
    }
    ...
    public final void onUserStopped(int i) {
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUserStopped(i);
        }
    }
    ...
    public final void onUserRemoved(int i) {
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUserRemoved(i);
        }
    ...
    public final void onUidAdded(int i) {
        ...
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUidAdded(i);
        }
    }
    ...
    public final void onUidRemoved(int i) {
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUidRemoved(i);
        }
    ...
    public final void onLockedBootCompleted() {
        int size = this.mAppStateTrackers.size();
        for (int i = 0; i < size; i++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i)).onLockedBootCompleted();
        }
    }
    ...
    public final void onPropertiesChanged(String str) {
        int size = this.mAppStateTrackers.size();
        for (int i = 0; i < size; i++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i)).onPropertiesChanged(str);
        }
    }
    ...
    public final void onUserInteractionStarted(String str, int i) {
        ...
        int size = this.mAppStateTrackers.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((BaseAppStateTracker) this.mAppStateTrackers.get(i2)).onUserInteractionStarted(str, packageUid);
        }
    }
}
