...
public class OomAdjProfiler {
    ...
    public final RingBuffer mOomAdjRunTimesHist = new RingBuffer(CpuTimes.class, 10);
    public final RingBuffer mSystemServerCpuTimesHist = new RingBuffer(CpuTimes.class, 10);
