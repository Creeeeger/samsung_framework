...
public class HealthStatsBatteryStatsWriter {
    ...
    public void writeUid(HealthStatsWriter healthStatsWriter, BatteryStats batteryStats, BatteryStats.Uid uid) {
        healthStatsWriter.addMeasurement(10001, batteryStats.computeBatteryRealtime(this.mNowRealtimeMs * 1000, 0) / 1000);
        healthStatsWriter.addMeasurement(10002, batteryStats.computeBatteryUptime(this.mNowUptimeMs * 1000, 0) / 1000);
        healthStatsWriter.addMeasurement(10003, batteryStats.computeBatteryScreenOffRealtime(this.mNowRealtimeMs * 1000, 0) / 1000);
        healthStatsWriter.addMeasurement(10004, batteryStats.computeBatteryScreenOffUptime(this.mNowUptimeMs * 1000, 0) / 1000);
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (keyAt == -10000) {
                ...
                addTimer(healthStatsWriter, 10065, ((BatteryStats.Uid.Sensor) sensorStats.valueAt(i)).getSensorTime());
            } else {
