...
public final class RadioModule {
    ...
    public final Set mAidlTunerSessions = new HashSet();

    /* loaded from: classes.dex */
    public interface AidlCallbackRunnable {
        void run(android.hardware.radio.ITunerCallback iTunerCallback);
    }
    ...
    public class AnonymousClass1 extends ITunerCallback.Stub {
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback
        public void onParametersUpdated(final ArrayList arrayList) {
        ...
        public /* synthetic */ void lambda$onParametersUpdated$8(ArrayList arrayList) {
            final Map vendorInfoFromHal = Convert.vendorInfoFromHal(arrayList);
            synchronized (RadioModule.this.mLock) {
    ...
    public final ProgramList.Filter buildUnionOfTunerSessionFiltersLocked() {
        Iterator it = this.mAidlTunerSessions.iterator();
        boolean z = false;
        boolean z2 = true;
        HashSet hashSet = null;
        HashSet hashSet2 = null;
        while (it.hasNext()) {
            ProgramList.Filter programListFilter = ((TunerSession) it.next()).getProgramListFilter();
    ...
    public ICloseHandle addAnnouncementListener(int[] iArr, IAnnouncementListener iAnnouncementListener) {
        ...
        final Mutable mutable = new Mutable();
        this.mService.registerAnnouncementListener(arrayList, new AnonymousClass2(iAnnouncementListener), new IBroadcastRadio.registerAnnouncementListenerCallback() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda2
    ...
    public class AnonymousClass2 extends IAnnouncementListener.Stub {
        ...
        public AnonymousClass2(android.hardware.radio.IAnnouncementListener iAnnouncementListener) {
            this.val$listener = iAnnouncementListener;
        }

        @Override // android.hardware.broadcastradio.V2_0.IAnnouncementListener
        public void onListUpdated(ArrayList arrayList) {
            this.val$listener.onListUpdated((List) arrayList.stream().map(new Function() { // from class: com.android.server.broadcastradio.hal2.RadioModule$2$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    Announcement announcementFromHal;
                    announcementFromHal = Convert.announcementFromHal((android.hardware.broadcastradio.V2_0.Announcement) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ ArrayList lambda$getImage$6(int i) {
