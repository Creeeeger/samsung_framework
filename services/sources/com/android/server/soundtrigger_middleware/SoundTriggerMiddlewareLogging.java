...
public class SoundTriggerMiddlewareLogging implements ISoundTriggerMiddlewareInternal, Dumpable {
    ...
    public SoundTriggerModuleDescriptor[] listModules() {
        try {
            ...
            }), new Object[0]).printLog(0, "SoundTriggerMiddlewareLogging"));
            return listModules;
        } catch (Exception e) {
            this.mServiceEventLogger.enqueue(ServiceEvent.createForException(ServiceEvent.Type.LIST_MODULE, IdentityContext.get().packageName, e, new Object[0]).printLog(2, "SoundTriggerMiddlewareLogging"));
            throw e;
        }
    }
    ...
    public ISoundTriggerModule attach(int i, ISoundTriggerCallback iSoundTriggerCallback, boolean z) {
        try {
            ...
            this.mServiceEventLogger.enqueue(ServiceEvent.createForReturn(ServiceEvent.Type.ATTACH, sb2, moduleLogging, Integer.valueOf(i), iSoundTriggerCallback, Boolean.valueOf(z)).printLog(0, "SoundTriggerMiddlewareLogging"));
            this.mSessionEventLoggers.add(eventLogger);
            return moduleLogging;
        } catch (Exception e) {
            this.mServiceEventLogger.enqueue(ServiceEvent.createForException(ServiceEvent.Type.ATTACH, IdentityContext.get().packageName, e, Integer.valueOf(i), iSoundTriggerCallback).printLog(2, "SoundTriggerMiddlewareLogging"));
            throw e;
        }
    }
    ...
    public class ModuleLogging implements ISoundTriggerModule {
        ...
        public int loadModel(SoundModel soundModel) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.LOAD_MODEL, Integer.valueOf(loadModel), soundModel.uuid).printLog(0, "SoundTriggerMiddlewareLogging"));
                return loadModel;
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.LOAD_MODEL, e, soundModel.uuid).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public int loadPhraseModel(PhraseSoundModel phraseSoundModel) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.LOAD_PHRASE_MODEL, Integer.valueOf(loadPhraseModel), phraseSoundModel.common.uuid).printLog(0, "SoundTriggerMiddlewareLogging"));
                return loadPhraseModel;
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.LOAD_PHRASE_MODEL, e, phraseSoundModel.common.uuid).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void unloadModel(int i) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.UNLOAD_MODEL, Integer.valueOf(i)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.UNLOAD_MODEL, e, Integer.valueOf(i)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public IBinder startRecognition(int i, RecognitionConfig recognitionConfig) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.START_RECOGNITION, startRecognition, Integer.valueOf(i), recognitionConfig).printLog(0, "SoundTriggerMiddlewareLogging"));
                return startRecognition;
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.START_RECOGNITION, e, Integer.valueOf(i), recognitionConfig).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void stopRecognition(int i) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.STOP_RECOGNITION, Integer.valueOf(i)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.STOP_RECOGNITION, e, Integer.valueOf(i)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void forceRecognitionEvent(int i) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.FORCE_RECOGNITION, Integer.valueOf(i)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.FORCE_RECOGNITION, e, Integer.valueOf(i)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void setModelParameter(int i, int i2, int i3) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.SET_MODEL_PARAMETER, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.SET_MODEL_PARAMETER, e, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public int getModelParameter(int i, int i2) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.GET_MODEL_PARAMETER, Integer.valueOf(modelParameter), Integer.valueOf(i), Integer.valueOf(i2)).printLog(0, "SoundTriggerMiddlewareLogging"));
                return modelParameter;
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.GET_MODEL_PARAMETER, e, Integer.valueOf(i), Integer.valueOf(i2)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public ModelParameterRange queryModelParameterSupport(int i, int i2) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForReturn(SessionEvent.Type.QUERY_MODEL_PARAMETER, queryModelParameterSupport, Integer.valueOf(i), Integer.valueOf(i2)).printLog(0, "SoundTriggerMiddlewareLogging"));
                return queryModelParameterSupport;
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.QUERY_MODEL_PARAMETER, e, Integer.valueOf(i), Integer.valueOf(i2)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void detach() {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.DETACH, new Object[0]).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.DETACH, e, new Object[0]).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
    ...
    public class CallbackLogging implements ISoundTriggerCallback {
        ...
        public void onRecognition(int i, RecognitionEventSys recognitionEventSys, int i2) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.RECOGNITION, Integer.valueOf(i), recognitionEventSys, Integer.valueOf(i2)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.RECOGNITION, e, Integer.valueOf(i), recognitionEventSys, Integer.valueOf(i2)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void onPhraseRecognition(int i, PhraseRecognitionEventSys phraseRecognitionEventSys, int i2) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.RECOGNITION, Integer.valueOf(i), phraseRecognitionEventSys, Integer.valueOf(i2)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.RECOGNITION, e, Integer.valueOf(i), phraseRecognitionEventSys, Integer.valueOf(i2)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void onModelUnloaded(int i) {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.MODEL_UNLOADED, Integer.valueOf(i)).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.MODEL_UNLOADED, e, Integer.valueOf(i)).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void onResourcesAvailable() {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.RESOURCES_AVAILABLE, new Object[0]).printLog(0, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.RESOURCES_AVAILABLE, e, new Object[0]).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
        ...
        public void onModuleDied() {
            try {
                ...
                this.mEventLogger.enqueue(SessionEvent.createForVoid(SessionEvent.Type.MODULE_DIED, new Object[0]).printLog(2, "SoundTriggerMiddlewareLogging"));
            } catch (Exception e) {
                this.mEventLogger.enqueue(SessionEvent.createForException(SessionEvent.Type.MODULE_DIED, e, new Object[0]).printLog(2, "SoundTriggerMiddlewareLogging"));
                throw e;
            }
        }
