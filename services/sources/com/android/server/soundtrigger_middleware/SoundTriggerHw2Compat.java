...
public final class SoundTriggerHw2Compat implements ISoundTriggerHal {
    ...
    public final int loadPhraseSoundModel_2_0(ISoundTriggerHw.PhraseSoundModel phraseSoundModel, ISoundTriggerHal.ModelCallback modelCallback) {
    ...
    public final void startRecognition_2_1(int i, android.hardware.soundtrigger.V2_3.RecognitionConfig recognitionConfig) {
        try {
            try {
                handleHalStatus(as2_1().startRecognition_2_1(i, Hw2CompatUtil.convertRecognitionConfig_2_3_to_2_1(recognitionConfig), new ModelCallbackWrapper((ISoundTriggerHal.ModelCallback) this.mModelCallbacks.get(Integer.valueOf(i))), 0), "startRecognition_2_1");
            } catch (NotSupported unused) {
    ...
    public final void startRecognition_2_0(int i, android.hardware.soundtrigger.V2_3.RecognitionConfig recognitionConfig) {
        handleHalStatus(as2_0().startRecognition(i, Hw2CompatUtil.convertRecognitionConfig_2_3_to_2_0(recognitionConfig), new ModelCallbackWrapper((ISoundTriggerHal.ModelCallback) this.mModelCallbacks.get(Integer.valueOf(i))), 0), "startRecognition");
    }
    ...
    public final android.hardware.soundtrigger.V2_1.ISoundTriggerHw as2_1() {
    ...
    public final android.hardware.soundtrigger.V2_2.ISoundTriggerHw as2_2() {
    ...
    public final android.hardware.soundtrigger.V2_3.ISoundTriggerHw as2_3() {
    ...
    /* loaded from: classes3.dex */
    public class ModelCallbackWrapper extends ISoundTriggerHwCallback.Stub {
