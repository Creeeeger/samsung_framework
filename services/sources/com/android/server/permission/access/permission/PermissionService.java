...
import com.android.server.permission.jarjar.kotlin.collections.CollectionsKt__CollectionsJVMKt;
...
public final class PermissionService implements PermissionManagerServiceInterface {
    ...
    public PermissionService(AccessCheckingService accessCheckingService) {
        ...
        SchemePolicy schemePolicy$frameworks__base__services__permission__android_common__services_permission = accessCheckingService.getSchemePolicy$frameworks__base__services__permission__android_common__services_permission("uid", "permission");
    ...
    public final List toLegacyPermissions(ArrayMap arrayMap) {
        ArrayList arrayList = new ArrayList();
        int size = arrayMap.size();
        for (int i = 0; i < size; i++) {
            Object keyAt = arrayMap.keyAt(i);
            Permission permission = (Permission) arrayMap.valueAt(i);
    ...
    public List getAllPermissionGroups(int i) {
        ...
        try {
            ...
            if (!isUidInstantApp(withUnfilteredSnapshot, callingUid)) {
                ...
                ArrayMap permissionGroups = this.policy.getPermissionGroups(new GetStateScope(accessState));
                ArrayList arrayList = new ArrayList();
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    PermissionGroupInfo generatePermissionGroupInfo = isPackageVisibleToUid(withUnfilteredSnapshot, permissionGroupInfo.packageName, callingUid) ? generatePermissionGroupInfo(permissionGroupInfo, i) : null;
    ...
    public PermissionGroupInfo getPermissionGroupInfo(String str, int i) {
        ...
        try {
            ...
            if (!isUidInstantApp(withUnfilteredSnapshot, callingUid)) {
                ...
                PermissionGroupInfo permissionGroupInfo = (PermissionGroupInfo) this.policy.getPermissionGroups(new GetStateScope(accessState)).get(str);
    ...
    public List queryPermissionsByGroup(String str, int i) {
        ...
        try {
            ...
            if (str != null) {
                PermissionGroupInfo permissionGroupInfo = (PermissionGroupInfo) this.policy.getPermissionGroups(getStateScope).get(str);
                if (permissionGroupInfo == null) {
                    AutoCloseableKt.closeFinally(withUnfilteredSnapshot, null);
                    return null;
                }
            ...
            ArrayMap permissions = this.policy.getPermissions(getStateScope);
            ref$ObjectRef.element = permissions;
            ArrayMap arrayMap = permissions;
            ArrayList arrayList = new ArrayList();
    ...
    public List getAllPermissionsWithProtection(int i) {
        ...
        ArrayMap permissions = this.policy.getPermissions(new GetStateScope(accessState));
        ArrayList arrayList = new ArrayList();
        int size = permissions.size();
        for (int i2 = 0; i2 < size; i2++) {
            Object keyAt = permissions.keyAt(i2);
    ...
    public Set getGrantedPermissions(String str, int i) {
        ...
        try {
            ...
            if (packageState != null) {
                ...
                GetStateScope getStateScope = new GetStateScope(accessState);
                ArrayMap uidPermissionFlags = this.policy.getUidPermissionFlags(getStateScope, packageState.getAppId(), i);
                if (uidPermissionFlags != null) {
                    ArraySet arraySet = new ArraySet();
                    int size = uidPermissionFlags.size();
                    for (int i2 = 0; i2 < size; i2++) {
                        Object keyAt = uidPermissionFlags.keyAt(i2);
                        ((Number) uidPermissionFlags.valueAt(i2)).intValue();
    ...
    public int[] getGidsForUid(int i) {
        ...
        GetStateScope getStateScope = new GetStateScope(accessState);
        ArrayMap uidPermissionFlags = this.policy.getUidPermissionFlags(getStateScope, appId, userId);
        if (uidPermissionFlags == null) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (PermissionFlags.INSTANCE.isPermissionGranted(((Number) uidPermissionFlags.valueAt(i2)).intValue()) && (permission = (Permission) this.policy.getPermissions(getStateScope).get(str)) != null) {
    ...
    */
    public final void setRuntimePermissionGranted(java.lang.String r16, int r17, java.lang.String r18, boolean r19, boolean r20, java.lang.String r21) {
        /*
    ...
    public final void setRequestedPermissionStates(PackageState packageState, int i, ArrayMap arrayMap) {
        ...
        synchronized (accessCheckingService.stateLock) {
            ...
            int i4 = 0;
            while (i4 < size) {
                Object keyAt = arrayMap.keyAt(i4);
                int intValue = ((Number) arrayMap.valueAt(i4)).intValue();
                ...
                if (intValue != 1 && intValue != 2) {
                    ...
                    if (androidPackage.getRequestedPermissions().contains(str) && (permission = (Permission) this.policy.getPermissions(mutateStateScope).get(str)) != null) {
    ...
    public boolean isPermissionsReviewRequired(String str, int i) {
        ...
        try {
            ...
            ArrayMap uidPermissionFlags = this.policy.getUidPermissionFlags(new GetStateScope(accessState), packageState.getAppId(), i);
            if (uidPermissionFlags == null) {
                return false;
            }
            int size = uidPermissionFlags.size();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void updatePermissionFlags(java.lang.String r17, java.lang.String r18, int r19, int r20, boolean r21, int r22) {
        /*
            Method dump skipped, instructions count: 365
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.permission.access.permission.PermissionService.updatePermissionFlags(java.lang.String, java.lang.String, int, int, boolean, int):void");
    }
            ...
            synchronized (accessCheckingService.stateLock) {
                ...
                for (Map.Entry entry : packageStates.entrySet()) {
                    ...
                    if (androidPackage != null) {
                        ...
                        while (it.hasNext()) {
                            updatePermissionFlags(mutateStateScope, packageState.getAppId(), i3, (String) it.next(), i, i2, false, true, "updatePermissionFlagsForAllApps", str);
    ...
    public final ArrayList getAllowlistedRestrictedPermissionsUnchecked(int i, int i2, int i3) {
        ...
        ArrayMap uidPermissionFlags = this.policy.getUidPermissionFlags(new GetStateScope(accessState), i, i3);
        if (uidPermissionFlags == null) {
            return null;
        }
    ...
    public final void addAllowlistedRestrictedPermissionsUnchecked(AndroidPackage androidPackage, int i, List list, int i2) {
        List list2;
        ArrayList allowlistedRestrictedPermissionsUnchecked = getAllowlistedRestrictedPermissionsUnchecked(i, 2, i2);
        if (allowlistedRestrictedPermissionsUnchecked != null) {
            ...
            List list3 = CollectionsKt___CollectionsKt.toList(arraySet);
            if (list3 != null) {
                list2 = list3;
    ...
    public final void setAllowlistedRestrictedPermissionsUnchecked(AndroidPackage androidPackage, int i, List list, int i2, int i3) {
        ...
        synchronized (accessCheckingService.stateLock) {
            ...
            ArrayMap uidPermissionFlags = uidPermissionPolicy.getUidPermissionFlags(mutateStateScope, i, i3);
            if (uidPermissionFlags != null) {
                ArrayMap permissions = uidPermissionPolicy.getPermissions(mutateStateScope);
                List requestedPermissions = androidPackage.getRequestedPermissions();
                int size = requestedPermissions.size();
                int i8 = 0;
                while (i8 < size) {
                    String str = (String) requestedPermissions.get(i8);
                    ...
                    if (permission != null && IntExtensionsKt.hasBits(permission.getPermissionInfo().flags, 12)) {
                        Integer num = (Integer) uidPermissionFlags.get(str);
                        if (num == null) {
                            num = 0;
                        }
                        ...
                        while (i9 != 0) {
                            int i13 = size;
                            List list4 = requestedPermissions;
                        ...
                        int i14 = size;
                        List list5 = requestedPermissions;
                        if (intValue == i10) {
                            i4 = i11;
                            i5 = i14;
                            list2 = list5;
    ...
    public String[] getAppOpPermissionPackages(String str) {
        ...
        try {
            ...
            while (it.hasNext()) {
                AndroidPackage androidPackage = ((PackageState) ((Map.Entry) it.next()).getValue()).getAndroidPackage();
    ...
    public LegacyPermissionState getLegacyPermissionState(int i) {
        ...
        GetStateScope getStateScope = new GetStateScope(accessState);
        ArrayMap permissions = permissionService.policy.getPermissions(getStateScope);
        int length = userIdsIncludingPreCreated.length;
        int i2 = 0;
        while (i2 < length) {
            int i3 = userIdsIncludingPreCreated[i2];
            ArrayMap uidPermissionFlags = permissionService.policy.getUidPermissionFlags(getStateScope, i, i3);
            if (uidPermissionFlags != null) {
                int size = uidPermissionFlags.size();
                int i4 = 0;
                while (i4 < size) {
                    Object keyAt = uidPermissionFlags.keyAt(i4);
                    int intValue = ((Number) uidPermissionFlags.valueAt(i4)).intValue();
                    String str = (String) keyAt;
                    Permission permission = (Permission) permissions.get(str);
                    if (permission == null) {
    ...
    public final PackageState getPackageState(PackageManagerLocal.UnfilteredSnapshot unfilteredSnapshot, String str) {
        return (PackageState) unfilteredSnapshot.getPackageStates().get(str);
    }
    ...
    public final class OnPermissionFlagsChangedListener extends UidPermissionPolicy.OnPermissionFlagsChangedListener {
        ...
        public void onPermissionFlagsChanged(int i, int i2, String str, int i3, int i4) {
            ...
            Permission permission = (Permission) permissionService.policy.getPermissions(new GetStateScope(accessState)).get(str);
            if (permission == null) {
                return;
            }
            PermissionFlags permissionFlags = PermissionFlags.INSTANCE;
    ...
    public void revokeInstallPermission(String str, String str2) {
        Log.w(this.TAG_SPEG, "Empty revokeInstallPermission(packageName = " + str + ", permissionName = " + str2 + ")");
    }

    @Override // com.android.server.pm.permission.PermissionManagerServiceInterface
    public void grantInstallPermission(String str, String str2) {
        Log.w(this.TAG_SPEG, "Empty grantInstallPermission(packageName = " + str + ", permissionName = " + str2 + ")");
    }
