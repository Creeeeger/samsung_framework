...
public final class UserState implements RemotePrintSpooler.PrintSpoolerCallbacks, RemotePrintService.PrintServiceCallbacks, RemotePrintServiceRecommendationService.RemotePrintServiceRecommendationServiceCallbacks {
    ...
    public void onPrintJobQueued(PrintJobInfo printJobInfo) {
        ...
        if (remotePrintService != null) {
            ...
            this.mSpooler.setPrintJobState(printJobInfo.getId(), 6, this.mContext.getString(17042361));
        }
    }
    ...
    */
    public java.util.List getPrintServices(int r9) {
        /*
            ...
            monitor-enter(r0)
            java.util.List r1 = r8.mInstalledServices     // Catch: java.lang.Throwable -> L52
            int r1 = r1.size()     // Catch: java.lang.Throwable -> L52
            r2 = 0
            r3 = 0
        Lb:
            if (r3 >= r1) goto L50
            java.util.List r4 = r8.mInstalledServices     // Catch: java.lang.Throwable -> L52
            java.lang.Object r4 = r4.get(r3)     // Catch: java.lang.Throwable -> L52
            android.printservice.PrintServiceInfo r4 = (android.printservice.PrintServiceInfo) r4     // Catch: java.lang.Throwable -> L52
            android.content.ComponentName r5 = new android.content.ComponentName     // Catch: java.lang.Throwable -> L52
            android.content.pm.ResolveInfo r6 = r4.getResolveInfo()     // Catch: java.lang.Throwable -> L52
            android.content.pm.ServiceInfo r6 = r6.serviceInfo     // Catch: java.lang.Throwable -> L52
            java.lang.String r6 = r6.packageName     // Catch: java.lang.Throwable -> L52
            android.content.pm.ResolveInfo r7 = r4.getResolveInfo()     // Catch: java.lang.Throwable -> L52
            android.content.pm.ServiceInfo r7 = r7.serviceInfo     // Catch: java.lang.Throwable -> L52
            java.lang.String r7 = r7.name     // Catch: java.lang.Throwable -> L52
            r5.<init>(r6, r7)     // Catch: java.lang.Throwable -> L52
            android.util.ArrayMap r6 = r8.mActiveServices     // Catch: java.lang.Throwable -> L52
            boolean r5 = r6.containsKey(r5)     // Catch: java.lang.Throwable -> L52
            r4.setIsEnabled(r5)     // Catch: java.lang.Throwable -> L52
            boolean r5 = r4.isEnabled()     // Catch: java.lang.Throwable -> L52
            if (r5 == 0) goto L3e
            r5 = r9 & 1
            if (r5 != 0) goto L43
            goto L4d
    ...
    public final void failScheduledPrintJobsForServiceInternal(ComponentName componentName) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                this.mSpooler.setPrintJobState(((PrintJobInfo) printJobInfos.get(i)).getId(), 6, this.mContext.getString(17042361));
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    ...
    public abstract class PrinterDiscoverySessionMediator {
        ...
        public void onPrintersRemovedLocked(List list) {
            ...
            if (arrayList != null) {
                Handler.getMain().sendMessage(PooledLambda.obtainMessage(new UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda7(), this, arrayList));
            }
        }
        ...
        public void dumpLocked(DualDumpOutputStream dualDumpOutputStream) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                com.android.internal.print.DumpUtils.writePrinterId(dualDumpOutputStream, "tracked_printer_requests", 2246267895813L, (PrinterId) this.mStateTrackedPrinters.get(i3));
            }
            int size3 = this.mPrinters.size();
            for (int i4 = 0; i4 < size3; i4++) {
                com.android.internal.print.DumpUtils.writePrinterInfo(UserState.this.mContext, dualDumpOutputStream, "printer", 2246267895814L, (PrinterInfo) this.mPrinters.valueAt(i4));
            }
        }
    ...
    public final class PrintJobForAppCache {
        ...
        public /* synthetic */ PrintJobForAppCache(UserState userState, PrintJobForAppCacheIA printJobForAppCacheIA) {
            this();
        }
        ...
        public void dumpLocked(DualDumpOutputStream dualDumpOutputStream) {
            ...
            while (i < size) {
                ...
                while (i2 < size2) {
                    ...
                    com.android.internal.print.DumpUtils.writePrintJobInfo(UserState.this.mContext, dualDumpOutputStream, "print_job", 1146756268034L, (PrintJobInfo) list.get(i2));
                    dualDumpOutputStream.end(start);
                    i2++;
                    i = i;
                }
