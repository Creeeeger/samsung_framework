...
public final class PrintManagerService extends SystemService {
    ...
    public class PrintManagerImpl extends IPrintManager.Stub {
        ...
        public List getPrintJobInfos(int i, int i2) {
            int resolveCallingUserEnforcingPermissions = resolveCallingUserEnforcingPermissions(i2);
            synchronized (this.mLock) {
                if (resolveCallingProfileParentLocked(resolveCallingUserEnforcingPermissions) != getCurrentUserId()) {
                    return null;
        ...
        public final Icon validateIconUserBoundary(Icon icon) {
        ...
        public List getPrintServices(int i, int i2) {
        ...
        public void addPrintJobStateChangeListener(IPrintJobStateChangeListener iPrintJobStateChangeListener, int i, int i2) {
        ...
        public final void dump(DualDumpOutputStream dualDumpOutputStream, ArrayList arrayList) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                long start = dualDumpOutputStream.start("user_states", 2246267895809L);
                ((UserState) arrayList.get(i)).dump(dualDumpOutputStream);
