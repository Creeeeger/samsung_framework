            ...
            synchronized (TextToSpeechManagerService.this.mLock) {
                if (str != null) {
                    ...
                    if (textToSpeechManagerPerUserService != null) {
                        ...
                        TextToSpeechManagerPerUserService.runSessionCallbackMethod(new TextToSpeechManagerPerUserService.ThrowingRunnable() { // from class: com.android.server.texttospeech.TextToSpeechManagerService$TextToSpeechManagerServiceStub$$ExternalSyntheticLambda1
