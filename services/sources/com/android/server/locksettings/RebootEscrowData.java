...
public class RebootEscrowData {
    ...
    public static byte[] decryptBlobCurrentVersion(SecretKey secretKey, RebootEscrowKey rebootEscrowKey, DataInputStream dataInputStream) {
        if (secretKey == null) {
    ...
    public static RebootEscrowData fromSyntheticPassword(RebootEscrowKey rebootEscrowKey, byte b, byte[] bArr, SecretKey secretKey) {
        Objects.requireNonNull(bArr);
