...
public class RecoverableKeyStoreDb {
    ...
    public Map getStatusForAllKeys(int i) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("keys", new String[]{KnoxCustomManagerService.ID, "alias", "recovery_status"}, "uid = ?", new String[]{Integer.toString(i)}, null, null, null);
        try {
    ...
    public Map getAllKeys(int i, int i2, int i3) {
    ...
    public Map getUserSerialNumbers() {
    ...
    public long setRecoveryServiceCertPath(int i, int i2, String str, CertPath certPath) {
    ...
    public List getRecoveryAgents(int i) {
    ...
    public final byte[] getBytes(int i, int i2, String str, String str2) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("root_of_trust", new String[]{KnoxCustomManagerService.ID, "user_id", "uid", "root_alias", str2}, "user_id = ? AND uid = ? AND root_alias = ?", new String[]{Integer.toString(i), Integer.toString(i2), this.mTestOnlyInsecureCertificateHelper.getDefaultCertificateAliasIfEmpty(str)}, null, null, null);
        try {
            int count = query.getCount();
            if (count == 0) {
                query.close();
    ...
    public static PublicKey decodeX509Key(byte[] bArr) {
        try {
    ...
    public static CertPath decodeCertPath(byte[] bArr) {
        try {
