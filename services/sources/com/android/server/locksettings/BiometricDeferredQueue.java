...
public class BiometricDeferredQueue {
    ...
    public class FaceResetLockoutTask implements FaceManager.GenerateChallengeCallback {
        ...
        public FaceResetLockoutTask(FinishCallback finishCallback, FaceManager faceManager, SyntheticPasswordManager syntheticPasswordManager, Set set, List list) {
        ...
        if (fingerprintManager != null) {
            for (FingerprintSensorPropertiesInternal fingerprintSensorPropertiesInternal : fingerprintManager.getSensorPropertiesInternal()) {
                if (!fingerprintSensorPropertiesInternal.resetLockoutRequiresHardwareAuthToken) {
                    ...
                    while (it.hasNext()) {
                        this.mFingerprintManager.resetLockout(fingerprintSensorPropertiesInternal.sensorId, ((UserAuthInfo) it.next()).userId, null);
                    }
                    ...
                    while (it2.hasNext()) {
                        ...
                        Slog.d("BiometricDeferredQueue", "Resetting fingerprint lockout for sensor: " + fingerprintSensorPropertiesInternal.sensorId + ", user: " + userAuthInfo.userId);
                ...
                if (faceSensorPropertiesInternal.resetLockoutRequiresHardwareAuthToken) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (faceSensorPropertiesInternal.resetLockoutRequiresChallenge) {
                            Slog.d("BiometricDeferredQueue", "Generating challenge for sensor: " + faceSensorPropertiesInternal.sensorId + ", user: " + userAuthInfo.userId);
                            this.mFaceManager.generateChallenge(faceSensorPropertiesInternal.sensorId, userAuthInfo.userId, this.mFaceResetLockoutTask);
                        } else {
                            Slog.d("BiometricDeferredQueue", "Resetting face lockout for sensor: " + faceSensorPropertiesInternal.sensorId + ", user: " + userAuthInfo.userId);
                            byte[] requestHatFromGatekeeperPassword = requestHatFromGatekeeperPassword(this.mSpManager, userAuthInfo, 0L);
                            if (requestHatFromGatekeeperPassword != null) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        Slog.d("BiometricDeferredQueue", "Resetting face lockout for sensor: " + faceSensorPropertiesInternal.sensorId + ", user: " + userAuthInfo2.userId);
                        this.mFaceManager.resetLockout(faceSensorPropertiesInternal.sensorId, userAuthInfo2.userId, (byte[]) null);
                    }
                }
            }
        }
