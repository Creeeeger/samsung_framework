...
public class TestHarnessModeService extends SystemService {
    ...
    public final void showNotificationIfEnabled() {
        if (SystemProperties.getBoolean("persist.sys.test_harness", false)) {
            String string = getContext().getString(17042991);
            ((NotificationManager) getContext().getSystemService(NotificationManager.class)).notifyAsUser(null, 54, new Notification.Builder(getContext(), SystemNotificationChannels.DEVELOPER).setSmallIcon(17304219).setWhen(0L).setOngoing(true).setTicker(string).setDefaults(0).setColor(getContext().getColor(R.color.system_notification_accent_color)).setContentTitle(string).setContentText(getContext().getString(17042990)).setVisibility(1).build(), UserHandle.ALL);
        }
    }
    ...
    /* loaded from: classes3.dex */
    public class SetUpTestHarnessModeException extends Exception {
