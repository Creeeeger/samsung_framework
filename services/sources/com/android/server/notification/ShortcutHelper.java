...
public class ShortcutHelper {
    ...
    public HashMap mActiveShortcutBubbles = new HashMap();
                ...
                for (String str2 : new HashSet(hashMap.keySet())) {
                    ...
                    while (true) {
                        if (i >= list.size()) {
                            ...
                            if (((ShortcutInfo) list.get(i)).getId().equals(str2)) {
                                z = true;
                                break;
                            }
                            i++;
    ...
    public void maybeListenForShortcutChangesForBubbles(NotificationRecord notificationRecord, boolean z, Handler handler) {
        ...
        if (!z && !TextUtils.isEmpty(shortcutId) && notificationRecord.getShortcutInfo() != null && notificationRecord.getShortcutInfo().getId().equals(shortcutId)) {
            HashMap hashMap = (HashMap) this.mActiveShortcutBubbles.get(notificationRecord.getSbn().getPackageName());
            if (hashMap == null) {
                hashMap = new HashMap();
            }
        ...
        HashMap hashMap2 = (HashMap) this.mActiveShortcutBubbles.get(notificationRecord.getSbn().getPackageName());
        if (hashMap2 != null) {
