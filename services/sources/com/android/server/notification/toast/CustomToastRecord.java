...
public class CustomToastRecord extends ToastRecord {
    ...
    public CustomToastRecord(NotificationManagerService notificationManagerService, int i, int i2, String str, boolean z, IBinder iBinder, ITransientNotification iTransientNotification, int i3, Binder binder, int i4, String str2) {
