...
public abstract class ToastRecord {
    ...
    public ToastRecord(NotificationManagerService notificationManagerService, int i, int i2, String str, boolean z, IBinder iBinder, int i3, Binder binder, int i4, String str2) {
