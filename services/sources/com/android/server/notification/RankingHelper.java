    ...
    public void sort(ArrayList arrayList) {
        ...
        synchronized (this.mProxyByGroupTmp) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                NotificationRecord notificationRecord2 = (NotificationRecord) arrayList.get(i3);
                NotificationRecord notificationRecord3 = (NotificationRecord) this.mProxyByGroupTmp.get(notificationRecord2.getGroupKey());
