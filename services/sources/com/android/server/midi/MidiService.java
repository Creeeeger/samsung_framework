...
public class MidiService extends IMidiManager.Stub {
    ...
    public final class Client implements IBinder.DeathRecipient {
        ...
        public void removeDeviceConnection(IBinder iBinder) {
            DeviceConnection deviceConnection = (DeviceConnection) this.mDeviceConnections.remove(iBinder);
        ...
        public void deviceAdded(Device device) {
            if (device.isUidAllowed(this.mUid)) {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ((IMidiDeviceListener) it.next()).onDeviceAdded(deviceInfo);
                    }
        ...
        public void deviceRemoved(Device device) {
            if (device.isUidAllowed(this.mUid)) {
                ...
                try {
                    Iterator it = this.mListeners.values().iterator();
                    while (it.hasNext()) {
                        ((IMidiDeviceListener) it.next()).onDeviceRemoved(deviceInfo);
                    }
                } catch (RemoteException e) {
                    Log.e("MidiService.Client", "remote exception", e);
                }
    ...
    public final void closeBluetoothDevice(BluetoothDevice bluetoothDevice) {
        ...
        synchronized (this.mBleMidiDeviceMap) {
            midiDevice = (MidiDevice) this.mBleMidiDeviceMap.remove(bluetoothDevice);
        }
        if (midiDevice != null) {
            try {
                midiDevice.close();
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:86:? -> B:82:0x01d8). Please report as a decompilation issue!!! */
    ...
    public final void removePackageDeviceServers(String str) {
        synchronized (this.mDevicesByInfo) {
            ...
            while (it.hasNext()) {
                ...
                if (str.equals(device.getPackageName())) {
                    it.remove();
    ...
    public void addUsbMidiDeviceLocked(MidiDeviceInfo midiDeviceInfo) {
        ...
        if (extractUsbDeviceTag.equals("MIDI 2.0")) {
            ...
            this.mUsbMidiLegacyDeviceOpenCount.put(extractUsbDeviceName, Integer.valueOf(((Integer) this.mUsbMidiLegacyDeviceOpenCount.getOrDefault(extractUsbDeviceName, 0)).intValue() + 1));
        }
    }
    ...
    public void removeUsbMidiDeviceLocked(MidiDeviceInfo midiDeviceInfo) {
        ...
        if (extractUsbDeviceTag.equals("MIDI 1.0") && this.mUsbMidiLegacyDeviceOpenCount.containsKey(extractUsbDeviceName)) {
            int intValue = ((Integer) this.mUsbMidiLegacyDeviceOpenCount.get(extractUsbDeviceName)).intValue();
            if (intValue > 1) {
