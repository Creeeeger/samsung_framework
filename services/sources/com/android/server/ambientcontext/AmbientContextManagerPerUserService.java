...
public abstract class AmbientContextManagerPerUserService extends AbstractPerUserSystemService {
    ...
    public void sendStatusCallback(RemoteCallback remoteCallback, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt("android.app.ambientcontext.AmbientContextStatusBundleKey", i);
        remoteCallback.sendResult(bundle);
    }

    public void sendDetectionResultIntent(PendingIntent pendingIntent, List list) {
        Intent intent = new Intent();
    ...
    public abstract /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$android$server$ambientcontext$AmbientContextManagerPerUserService$ServiceType;
    ...
    public final RemoteCallback getServerStatusCallback(final Consumer consumer) {
