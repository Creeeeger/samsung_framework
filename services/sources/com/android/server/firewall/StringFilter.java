...
public abstract class StringFilter implements Filter {
    ...
    public static StringFilter readFromXml(ValueProvider valueProvider, XmlPullParser xmlPullParser) {
    ...
    /* loaded from: classes2.dex */
    public abstract class ValueProvider extends FilterFactory {
    ...
    /* loaded from: classes2.dex */
    public class EqualsFilter extends StringFilter {
    ...
    /* loaded from: classes2.dex */
    public class PatternStringFilter extends StringFilter {
    ...
    /* loaded from: classes2.dex */
    public class IsNullFilter extends StringFilter {
