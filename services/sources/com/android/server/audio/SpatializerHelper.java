...
public class SpatializerHelper {
    ...
    public final ArrayList mSADevices = new ArrayList(0);
    ...
    public synchronized List getCompatibleAudioDevices() {
        ...
        Iterator it = this.mSADevices.iterator();
        while (it.hasNext()) {
            SADeviceState sADeviceState = (SADeviceState) it.next();
            if (sADeviceState.mEnabled) {
                arrayList.add(sADeviceState.getAudioDeviceAttributes());
            }
        }
        return arrayList;
    }
    ...
    public final SADeviceState findDeviceStateForAudioDeviceAttributes(AudioDeviceAttributes audioDeviceAttributes) {
        ...
        while (it.hasNext()) {
            SADeviceState sADeviceState = (SADeviceState) it.next();
            if (sADeviceState.mDeviceType == canonicalDeviceType && (!isWireless || audioDeviceAttributes.getAddress().equals(sADeviceState.mDeviceAddress))) {
    ...
    public final synchronized Pair evaluateState(AudioDeviceAttributes audioDeviceAttributes) {
        int type = audioDeviceAttributes.getType();
    ...
    public synchronized boolean isHeadTrackerAvailable() {
        return this.mGlobalHeadTrackerAvailable;
    }
    ...
    public synchronized void onInitSensors() {
        ...
        try {
            ...
            if (this.mHeadTrackerAvailable != (i != -1)) {
                boolean z3 = i != -1;
                this.mHeadTrackerAvailable = z3;
                if (!this.mSecHeadTrackerAvailable && !z3) {
                    z = false;
                }
                if (this.mGlobalHeadTrackerAvailable != z) {
                    this.mGlobalHeadTrackerAvailable = z;
    ...
    public void dump(PrintWriter printWriter) {
        ...
        printWriter.println("\tsec headtracker available:" + this.mSecHeadTrackerAvailable);
        printWriter.println("\tglobal headtracker available:" + this.mGlobalHeadTrackerAvailable);
        ...
        Iterator it = this.mSADevices.iterator();
        while (it.hasNext()) {
            printWriter.println("\t\t" + ((SADeviceState) it.next()));
        }
    }

    /* loaded from: classes.dex */
    public final class SADeviceState {
        public static boolean sBinauralEnabledDefault = true;
        public static boolean sHeadTrackingEnabledDefault = false;
        public static boolean sTransauralEnabledDefault = true;
    ...
    public synchronized String getSADeviceSettings() {
        ...
        for (int i = 0; i < this.mSADevices.size(); i++) {
            sb.append(((SADeviceState) this.mSADevices.get(i)).toPersistableString());
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x0034 A[Catch: all -> 0x003b, TRY_LEAVE, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:9:0x000d, B:11:0x0034), top: B:2:0x0001 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public synchronized void setSecHeadTrackerAvailable(boolean r4) {
        /*
            r3 = this;
            monitor-enter(r3)
            r3.mSecHeadTrackerAvailable = r4     // Catch: java.lang.Throwable -> L3b
            if (r4 != 0) goto Lc
            boolean r4 = r3.mHeadTrackerAvailable     // Catch: java.lang.Throwable -> L3b
            if (r4 == 0) goto La
            goto Lc
        La:
            r4 = 0
        ...
        Ld:
            ...
            java.lang.String r2 = "setSecHeadTrackerAvailable:"
            r1.append(r2)     // Catch: java.lang.Throwable -> L3b
            boolean r2 = r3.mSecHeadTrackerAvailable     // Catch: java.lang.Throwable -> L3b
            r1.append(r2)     // Catch: java.lang.Throwable -> L3b
            java.lang.String r2 = " mHeadTrackerAvailable:"
            r1.append(r2)     // Catch: java.lang.Throwable -> L3b
            boolean r2 = r3.mHeadTrackerAvailable     // Catch: java.lang.Throwable -> L3b
            r1.append(r2)     // Catch: java.lang.Throwable -> L3b
            java.lang.String r1 = r1.toString()     // Catch: java.lang.Throwable -> L3b
            android.util.Log.i(r0, r1)     // Catch: java.lang.Throwable -> L3b
            boolean r0 = r3.mGlobalHeadTrackerAvailable     // Catch: java.lang.Throwable -> L3b
            if (r0 == r4) goto L39
            r3.mGlobalHeadTrackerAvailable = r4     // Catch: java.lang.Throwable -> L3b
            r3.dispatchHeadTrackerAvailable(r4)     // Catch: java.lang.Throwable -> L3b
        L39:
            monitor-exit(r3)
            return
        L3b:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.audio.SpatializerHelper.setSecHeadTrackerAvailable(boolean):void");
    }
}
