...
public final class RemoteFillService extends ServiceConnector.Impl {
    ...
    public void addLast(ServiceConnector.Job job) {
        cancelPendingJobs();
        super.addLast(job);
    }
    ...
    public /* synthetic */ CompletableFuture lambda$onFillRequest$0(FillRequest fillRequest, final AtomicReference atomicReference, final AtomicReference atomicReference2, IAutoFillService iAutoFillService) {
        if (Helper.sVerbose) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ CompletableFuture lambda$onSaveRequest$3(SaveRequest saveRequest, IAutoFillService iAutoFillService) {
        if (Helper.sVerbose) {
