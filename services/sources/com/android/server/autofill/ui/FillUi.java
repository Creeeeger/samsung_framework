...
public final class FillUi {
    ...
    public FillUi(Context context, final FillResponse fillResponse, AutofillId autofillId, String str, OverlayControl overlayControl, CharSequence charSequence, Drawable drawable, boolean z, Callback callback) {
        ...
        int i2 = z ? R.style.Theme.Holo.CompactMenu : R.style.Theme.Holo.SearchBar;
        this.mThemeId = i2;
        ...
        if (isFullScreen) {
            viewGroup = (ViewGroup) from.inflate(R.layout.character_picker_button, (ViewGroup) null);
        } else if (sanitizeRemoteView != null || sanitizeRemoteView2 != null) {
            viewGroup = (ViewGroup) from.inflate(R.layout.choose_account, (ViewGroup) null);
        } else {
            viewGroup = (ViewGroup) from.inflate(R.layout.character_picker, (ViewGroup) null);
        }
        viewGroup.setClipToOutline(true);
        TextView textView = (TextView) viewGroup.findViewById(R.id.by_org_unit);
        if (textView != null) {
            textView.setText(contextThemeWrapper.getString(R.string.config_foldedArea, charSequence));
        }
        ImageView imageView = (ImageView) viewGroup.findViewById(R.id.by_common_header);
        if (imageView != null) {
        ...
        if (AutofillManagerService.getVisibleDatasetsMaxCount() > 0) {
            ...
            this.mVisibleDatasetsMaxCount = contextThemeWrapper.getResources().getInteger(R.integer.config_MaxConcurrentDownloadsAllowed);
        }
        ...
        if (fillResponse.getAuthentication() != null) {
            ...
            this.mFooter = null;
            this.mAdapter = null;
            ViewGroup viewGroup3 = (ViewGroup) viewGroup.findViewById(R.id.by_org_header);
            try {
        ...
        if (sanitizeRemoteView != null) {
            ...
            LinearLayout linearLayout = (LinearLayout) viewGroup.findViewById(R.id.by_common);
        ...
        if (sanitizeRemoteView2 != null) {
            LinearLayout linearLayout2 = (LinearLayout) viewGroup.findViewById(R.id.buttons);
        ...
        ListView listView = (ListView) viewGroup.findViewById(R.id.by_org);
    ...
    public /* synthetic */ void lambda$applyNewFilterText$6(int i, int i2) {
        ...
        if (i2 <= 0) {
            if (Helper.sDebug) {
                ...
                Slog.d("FillUi", "No dataset matches filter with " + (str != null ? str.length() : 0) + " chars");
            }
    ...
    public final class AnchoredWindow {
        ...
        public void show(WindowManager.LayoutParams layoutParams) {
            ...
            try {
                ...
                if (!this.mShowing) {
                    layoutParams.accessibilityTitle = this.mContentView.getContext().getString(R.string.config_defaultNearbySharingComponent);
    ...
    public final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                format = FillUi.this.mContext.getString(R.string.config_defaultNetworkRecommendationProviderPackage);
            } else {
                HashMap hashMap = new HashMap();
                hashMap.put("count", Integer.valueOf(count));
                format = PluralsMessageFormatter.format(FillUi.this.mContext.getResources(), hashMap, R.string.config_defaultNetworkScorerPackageName);
            }
