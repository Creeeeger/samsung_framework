...
public final class FieldClassificationStrategy {
    ...
    public interface Command {
        void run(IAutofillFieldClassificationService iAutofillFieldClassificationService);
    }

    /* loaded from: classes.dex */
    public interface MetadataParser {
        Object get(Resources resources, int i);
    }
    ...
    public final Object getMetadataValue(String str, MetadataParser metadataParser) {
        ServiceInfo serviceInfo = getServiceInfo();
        if (serviceInfo == null) {
            return null;
        }
    ...
    public void calculateScores(final RemoteCallback remoteCallback, final List list, final String[] strArr, final String[] strArr2, final String str, final Bundle bundle, final ArrayMap arrayMap, final ArrayMap arrayMap2) {
