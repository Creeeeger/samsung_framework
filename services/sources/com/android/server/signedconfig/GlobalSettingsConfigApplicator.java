...
public class GlobalSettingsConfigApplicator {
    ...
    public static final Map HIDDEN_API_POLICY_KEY_MAP;
    public static final Map KEY_VALUE_MAPPERS;
    ...
    static {
        Map makeMap = makeMap("DEFAULT", String.valueOf(-1), "DISABLED", String.valueOf(0), "JUST_WARN", String.valueOf(1), "ENABLED", String.valueOf(2));
    ...
    public final void updateCurrentConfig(int i, Map map) {
