...
public class ShortcutRequestPinProcessor {
    ...
    public abstract class PinItemRequestInner extends IPinItemRequest.Stub {
        ...
        public /* synthetic */ PinItemRequestInner(ShortcutRequestPinProcessor shortcutRequestPinProcessor, IntentSender intentSender, int i, PinItemRequestInnerIA pinItemRequestInnerIA) {
    ...
    public class PinAppWidgetRequestInner extends PinItemRequestInner {
        ...
        public /* synthetic */ PinAppWidgetRequestInner(ShortcutRequestPinProcessor shortcutRequestPinProcessor, IntentSender intentSender, int i, AppWidgetProviderInfo appWidgetProviderInfo, Bundle bundle, PinAppWidgetRequestInnerIA pinAppWidgetRequestInnerIA) {
    ...
    public class PinShortcutRequestInner extends PinItemRequestInner {
        ...
        public /* synthetic */ PinShortcutRequestInner(ShortcutRequestPinProcessor shortcutRequestPinProcessor, ShortcutInfo shortcutInfo, ShortcutInfo shortcutInfo2, IntentSender intentSender, String str, int i, int i2, boolean z, PinShortcutRequestInnerIA pinShortcutRequestInnerIA) {
    ...
    public boolean requestPinItemLocked(ShortcutInfo shortcutInfo, AppWidgetProviderInfo appWidgetProviderInfo, Bundle bundle, int i, IntentSender intentSender, int i2) {
        ...
        if (i2 == 2) {
            ...
            ComponentName injectGetPinConfirmationActivity = this.mService.injectGetPinConfirmationActivity("com.sec.android.app.desktoplauncher", parentOrSelfUserId, i3);
            requestPinConfirmationActivity = injectGetPinConfirmationActivity == null ? null : Pair.create(injectGetPinConfirmationActivity, Integer.valueOf(parentOrSelfUserId));
        } else {
        ...
        if (shortcutInfo != null) {
            pinItemRequest = requestPinShortcutLocked(shortcutInfo, intentSender, ((ComponentName) pair.first).getPackageName(), ((Integer) pair.second).intValue());
        } else {
            pinItemRequest = new LauncherApps.PinItemRequest(new PinAppWidgetRequestInner(intentSender, this.mService.injectGetPackageUid(((ComponentName) pair.first).getPackageName(), intValue), appWidgetProviderInfo, bundle), 2);
        }
        return startRequestConfirmActivity((ComponentName) pair.first, intValue, pinItemRequest, i3, i2);
    }
    ...
    public final boolean startRequestConfirmActivity(ComponentName componentName, int i, LauncherApps.PinItemRequest pinItemRequest, int i2, int i3) {
        ...
        try {
            if (i3 == 2) {
                ...
                try {
                    this.mService.mContext.startActivityAsUser(intent, makeBasic.toBundle(), UserHandle.of(i));
                } catch (RuntimeException e) {
        ...
        synchronized (this.mLock) {
            if (this.mService.isUserUnlockedL(userId) && this.mService.isUserUnlockedL(pinShortcutRequestInner.launcherUserId)) {
                ...
                if (launcherShortcutsLocked.hasPinned(shortcutInfo)) {
                    if (this.mService.getPackageShortcutsForPublisherLocked(str, userId).findShortcutById(id) != null) {
                        return true;
                    }
                    Slog.d("ShortcutService", "Shortcut already pinned. But, it doesn't exist. Pinning " + id + " of " + str);
                }
