...
public final class PackageRemovedInfo {
    ...
    public final void sendPackageRemovedBroadcastInternal(boolean z, boolean z2) {
        ...
        bundle.putBoolean("android.intent.extra.HIDDEN", this.mHidden);
        ...
        if (str3 != null) {
            ...
            this.mPackageSender.sendPackageBroadcast("android.intent.action.PACKAGE_REMOVED_INTERNAL", this.mRemovedPackage, bundle, 0, "android", null, this.mBroadcastUsers, this.mInstantUserIds, this.mBroadcastAllowList, null);
