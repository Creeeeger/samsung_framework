...
public final class RemovePackageHelper {
    ...
    public final void removeSdpPackageDir(PackageRemovedInfo packageRemovedInfo) {
    }
    ...
    public final void removePackageLI(String str, boolean z) {
        synchronized (this.mPm.mLock) {
            ...
            this.mPermissionManager.removePackageGrantedPermissionsForMDM(str);
            if (androidPackage != null) {
                cleanPackageDataStructuresLILPw(androidPackage, AndroidPackageUtils.isSystem(androidPackage), z);
            }
        }
    }
    ...
    public void removePackageDataLIF(PackageSetting packageSetting, int[] iArr, PackageRemovedInfo packageRemovedInfo, int i, boolean z) {
        ...
        removeSdpPackageDir(packageRemovedInfo);
        if (i4 == 0) {
    ...
    public void cleanUpResources(File file, String[] strArr) {
        synchronized (this.mPm.mInstallLock) {
            if (file != null) {
                if (AsecInstallHelper.isExternalAsecPath(file.getAbsolutePath())) {
                    this.mPm.getAsecInstallHelper().cleanUpAsecResources(file, strArr);
                }
            }
    ...
    public final void removeDexFilesLI(List list, String[] strArr) {
        if (list.isEmpty()) {
            return;
        }
        if (strArr == null) {
