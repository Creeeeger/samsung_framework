    ...
    public final int runList() {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                List users = userManagerServiceShellCommand.mService.getUsers(!z2, false, !z2);
                if (users == null) {
    ...
    */
    public final int runIsUserVisible() {
        ...
        L4f:
            ...
            int r1 = r1.intValue()
            boolean r5 = r5.isUserVisibleOnDisplay(r2, r1)
            goto L64
        L5c:
            android.os.UserManager r5 = r5.getUserManagerForUser(r2)
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(17891772)));
                }
                return 0;
            }
        }
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersOnDefaultDisplayEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(17891773)));
                }
                return 0;
            }
        }
