...
public final class PackageManagerNative extends IPackageManagerNative.Stub {
    ...
    public long getVersionCodeForPackage(String str) {
        try {
    ...
    public int getTargetSdkVersionForPackage(String str) {
    ...
    public boolean isPackageDebuggable(String str) {
    ...
    public boolean[] isAudioPlaybackCaptureAllowed(String[] strArr) {
        int userId = UserHandle.getUserId(Binder.getCallingUid());
        Computer snapshotComputer = this.mPm.snapshotComputer();
    ...
    public int getLocationFlags(String str) {
    ...
    public boolean hasSha256SigningCertificate(String str, byte[] bArr) {
