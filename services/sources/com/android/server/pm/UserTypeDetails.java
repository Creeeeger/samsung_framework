...
public final class UserTypeDetails {
    ...
    public UserTypeDetails(String str, boolean z, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, int[] iArr3, Bundle bundle, Bundle bundle2, Bundle bundle3, List list, UserProperties userProperties) {
        this.mName = str;
        this.mEnabled = z;
        this.mMaxAllowed = i;
    ...
    public List getDefaultCrossProfileIntentFilters() {
    ...
    public void dump(PrintWriter printWriter, String str) {
        ...
        if (isSystem()) {
            ...
            try {
                ...
                for (String str3 : Resources.getSystem().getStringArray(17236156)) {
    ...
    public final class Builder {
        ...
        public Builder setDefaultCrossProfileIntentFilters(List list) {
            this.mDefaultCrossProfileIntentFilters = list;
            return this;
        }
        ...
        public UserTypeDetails createUserTypeDetails() {
            ...
            if (!isProfile()) {
                List list = this.mDefaultCrossProfileIntentFilters;
