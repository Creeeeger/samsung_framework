...
public abstract class PackageInfoUtils {
    ...
    public static PackageInfo generate(AndroidPackage androidPackage, int[] iArr, long j, long j2, long j3, Set set, Set set2, PackageUserStateInternal packageUserStateInternal, int i, PackageStateInternal packageStateInternal) {
        return generateWithComponents(androidPackage, iArr, j, j2, j3, set, set2, packageUserStateInternal, i, packageStateInternal);
    }

    public static PackageInfo generateWithComponents(AndroidPackage androidPackage, int[] iArr, long j, long j2, long j3, Set set, Set set2, PackageUserStateInternal packageUserStateInternal, int i, PackageStateInternal packageStateInternal) {
        int size;
        int size2;
        int size3;
        int size4;
        ...
        if ((4096 & j) != 0) {
            ...
            if (size9 > 0) {
                ...
                for (int i5 = 0; i5 < size9; i5++) {
                    ParsedPermission parsedPermission = (ParsedPermission) androidPackage.getPermissions().get(i5);
            ...
            if (size10 > 0) {
                ...
                for (int i6 = 0; i6 < size10; i6++) {
                    ParsedUsesPermission parsedUsesPermission = (ParsedUsesPermission) usesPermissions.get(i6);
        ...
        if ((2147483648L & j) != 0) {
            ...
            if (size11 > 0) {
                ...
                for (int i7 = 0; i7 < size11; i7++) {
                    ParsedAttribution parsedAttribution = (ParsedAttribution) androidPackage.getAttributions().get(i7);
        ...
        if ((1 & j) != 0 && (size5 = androidPackage.getActivities().size()) > 0) {
            ...
            int i9 = 0;
            while (i9 < size5) {
                ParsedActivity parsedActivity = (ParsedActivity) androidPackage.getActivities().get(i9);
        ...
        if ((2 & j) != 0 && (size4 = androidPackage.getReceivers().size()) > 0) {
            ...
            for (int i11 = 0; i11 < size4; i11++) {
                ParsedActivity parsedActivity2 = (ParsedActivity) androidPackage.getReceivers().get(i11);
        ...
        if ((4 & j) != 0 && (size3 = androidPackage.getServices().size()) > 0) {
            ...
            for (int i13 = 0; i13 < size3; i13++) {
                ParsedService parsedService = (ParsedService) androidPackage.getServices().get(i13);
        ...
        if ((8 & j) != 0 && (size2 = androidPackage.getProviders().size()) > 0) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ParsedProvider parsedProvider = (ParsedProvider) androidPackage.getProviders().get(i15);
        ...
        if ((16 & j) != 0 && (size = androidPackage.getInstrumentations().size()) > 0) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                packageInfo.instrumentation[i16] = generateInstrumentationInfo((ParsedInstrumentation) androidPackage.getInstrumentations().get(i16), androidPackage, j, packageUserStateInternal, i, packageStateInternal);
            }
        }
        return packageInfo;
    }
    ...
    public static ApplicationInfo generateApplicationInfo(AndroidPackage androidPackage, long j, PackageUserStateInternal packageUserStateInternal, int i, PackageStateInternal packageStateInternal) {
        ...
        List usesLibraryFiles = transientState.getUsesLibraryFiles();
        List usesLibraryInfos = transientState.getUsesLibraryInfos();
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < usesLibraryInfos.size(); i2++) {
            arrayList.add(((SharedLibraryWrapper) usesLibraryInfos.get(i2)).getInfo());
        }
    ...
    public static ArrayMap generateProcessInfo(Map map, long j) {
        if (map == null) {
            return null;
        }
    ...
    public static void assignFieldsPackageItemInfoParsedComponent(PackageItemInfo packageItemInfo, ParsedComponent parsedComponent, PackageStateInternal packageStateInternal, int i) {
        ...
        Pair nonLocalizedLabelAndIcon = ParsedComponentStateUtils.getNonLocalizedLabelAndIcon(parsedComponent, packageStateInternal, i);
    ...
    /* loaded from: classes3.dex */
    public class CachedApplicationInfoGenerator {
        public ArrayMap mCache = new ArrayMap();
        ...
        public ApplicationInfo generate(AndroidPackage androidPackage, long j, PackageUserStateInternal packageUserStateInternal, int i, PackageStateInternal packageStateInternal) {
            ApplicationInfo applicationInfo = (ApplicationInfo) this.mCache.get(androidPackage.getPackageName());
            if (applicationInfo != null) {
