...
public class PackageImpl implements ParsedPackage, AndroidPackageInternal, AndroidPackageHidden, ParsingPackage, ParsingPackageHidden, Parcelable {
    ...
    public List adoptPermissions;
    public Boolean anyDensity;
    public List apexSystemServices;
    public String appComponentFactory;
    public List attributions;
    ...
    public List configPreferences;
    public int dataExtractionRules;
    public int descriptionRes;
    public List featureGroups;
    public int fullBackupContent;
    public int gwpAsanMode;
    public int iconRes;
    public List implicitPermissions;
    public int installLocation;
    public List instrumentations;
    public Map keySetMapping;
    public int labelRes;
    public int largestWidthLimitDp;
    public List libraryNames;
    public int logo;
    ...
    public Set mKnownActivityEmbeddingCerts;
    ...
    public List originalPackages;
    public String overlayCategory;
    public int overlayPriority;
    public String overlayTarget;
    public String overlayTargetOverlayableName;
    public Map overlayables;
    public String packageName;
    public String permission;
    public List permissionGroups;
    public List permissions;
    public List preferredActivityFilters;
    public String primaryCpuAbi;
    public String processName;
    public Map processes;
    public List protectedBroadcasts;
    public List providers;
    public List queriesIntents;
    public List queriesPackages;
    public Set queriesProviders;
    public List receivers;
    public List reqFeatures;
    public Boolean requestRawExternalStorageAccess;
    public List requestedPermissions;
    ...
    public int uid;
    public Set upgradeKeySets;
    public List usesLibraries;
    public List usesNativeLibraries;
    public List usesOptionalLibraries;
    public List usesOptionalNativeLibraries;
    public List usesPermissions;
    public List usesSdkLibraries;
    public String[][] usesSdkLibrariesCertDigests;
    public long[] usesSdkLibrariesVersionsMajor;
    public List usesStaticLibraries;
    ...
    public static final SparseArray EMPTY_INT_ARRAY_SPARSE_ARRAY = new SparseArray();
    public static final Comparator ORDER_COMPARATOR = new Comparator() { // from class: com.android.server.pm.parsing.pkg.PackageImpl$$ExternalSyntheticLambda0
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: com.android.server.pm.parsing.pkg.PackageImpl.1
    ...
    public PackageImpl addKeySet(String str, PublicKey publicKey) {
        ArraySet arraySet = (ArraySet) this.keySetMapping.get(str);
        if (arraySet == null) {
    ...
    public final void addMimeGroupsFromComponent(ParsedComponent parsedComponent) {
        for (int size = parsedComponent.getIntents().size() - 1; size >= 0; size--) {
            IntentFilter intentFilter = ((ParsedIntentInfo) parsedComponent.getIntents().get(size)).getIntentFilter();
            for (int countMimeGroups = intentFilter.countMimeGroups() - 1; countMimeGroups >= 0; countMimeGroups--) {
                Set set = this.mimeGroups;
    ...
    @Override // com.android.server.pm.pkg.parsing.ParsingPackage
    public PackageImpl asSplit(String[] strArr, String[] strArr2, int[] iArr, SparseArray sparseArray) {
    ...
    public final ArrayMap buildAppClassNamesByProcess() {
        if (ArrayUtils.size(this.processes) == 0) {
            return null;
        }
        ArrayMap arrayMap = new ArrayMap(4);
        for (String str : this.processes.keySet()) {
            ArrayMap appClassNamesByPackage = ((ParsedProcess) this.processes.get(str)).getAppClassNamesByPackage();
            for (int i = 0; i < appClassNamesByPackage.size(); i++) {
                if (this.packageName.equals((String) appClassNamesByPackage.keyAt(i))) {
                    String str2 = (String) appClassNamesByPackage.valueAt(i);
        ...
        if (this.mSplits == null) {
            ...
            if (this.splitDependencies != null) {
                for (int i2 = 0; i2 < this.splitDependencies.size(); i2++) {
                    ...
                    int[] iArr = (int[]) this.splitDependencies.valueAt(i2);
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getAdoptPermissions() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getConfigPreferences() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getImplicitPermissions() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    public Map getKeySetMapping() {
        return this.keySetMapping;
    }

    @Override // com.android.server.pm.pkg.AndroidPackage
    public Set getKnownActivityEmbeddingCerts() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getOriginalPackages() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getPreferredActivityFilters() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getProtectedBroadcasts() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getQueriesIntents() {
        return this.queriesIntents;
    }

    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getQueriesPackages() {
        return this.queriesPackages;
    }

    @Override // com.android.server.pm.pkg.AndroidPackage
    public Set getQueriesProviders() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getRequestedFeatures() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public SparseArray getSplitDependencies() {
        SparseArray sparseArray = this.splitDependencies;
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public Set getUpgradeKeySets() {
        return this.upgradeKeySets;
    }

    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    public List getUsesLibraries() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    public List getUsesNativeLibraries() {
        return this.usesNativeLibraries;
    }

    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getUsesOptionalLibraries() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage
    public List getUsesOptionalNativeLibraries() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    public List getUsesSdkLibraries() {
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    public List getUsesStaticLibraries() {
    ...
    @Override // com.android.server.pm.pkg.parsing.ParsingPackage
    public ParsingPackage setKnownActivityEmbeddingCerts(Set set) {
    ...
    @Override // com.android.server.pm.pkg.parsing.ParsingPackage
    public PackageImpl setProcesses(Map map) {
        this.processes = map;
        return this;
    }
    ...
    @Override // com.android.server.pm.pkg.parsing.ParsingPackage
    public PackageImpl setUpgradeKeySets(Set set) {
    ...
    public static String[] sortLibraries(List list) {
        if (list.size() == 0) {
    ...
    public PackageImpl setPackageName(String str) {
        ...
        for (int i = 0; i < size; i++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.permissions.get(i), this.packageName);
        }
        int size2 = this.permissionGroups.size();
        for (int i2 = 0; i2 < size2; i2++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.permissionGroups.get(i2), this.packageName);
        }
        int size3 = this.activities.size();
        for (int i3 = 0; i3 < size3; i3++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.activities.get(i3), this.packageName);
        }
        int size4 = this.receivers.size();
        for (int i4 = 0; i4 < size4; i4++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.receivers.get(i4), this.packageName);
        }
        int size5 = this.providers.size();
        for (int i5 = 0; i5 < size5; i5++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.providers.get(i5), this.packageName);
        }
        int size6 = this.services.size();
        for (int i6 = 0; i6 < size6; i6++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.services.get(i6), this.packageName);
        }
        int size7 = this.instrumentations.size();
        for (int i7 = 0; i7 < size7; i7++) {
            ComponentMutateUtils.setPackageName((ParsedComponent) this.instrumentations.get(i7), this.packageName);
        }
        return this;
    }
    ...
    public PackageImpl setAllComponentsDirectBootAware(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ComponentMutateUtils.setDirectBootAware((ParsedMainComponent) this.activities.get(i), z);
        }
        int size2 = this.receivers.size();
        for (int i2 = 0; i2 < size2; i2++) {
            ComponentMutateUtils.setDirectBootAware((ParsedMainComponent) this.receivers.get(i2), z);
        }
        int size3 = this.providers.size();
        for (int i3 = 0; i3 < size3; i3++) {
            ComponentMutateUtils.setDirectBootAware((ParsedMainComponent) this.providers.get(i3), z);
        }
        int size4 = this.services.size();
        for (int i4 = 0; i4 < size4; i4++) {
            ComponentMutateUtils.setDirectBootAware((ParsedMainComponent) this.services.get(i4), z);
        }
        return this;
    }
    ...
    public PackageImpl capPermissionPriorities() {
        for (int size = this.permissionGroups.size() - 1; size >= 0; size--) {
            ComponentMutateUtils.setPriority((ParsedPermissionGroup) this.permissionGroups.get(size), 0);
        }
        return this;
    }
    ...
    public PackageImpl markNotActivitiesAsNotExportedIfSingleUser() {
        ...
        for (int i = 0; i < size; i++) {
            ParsedActivity parsedActivity = (ParsedActivity) this.receivers.get(i);
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ParsedService parsedService = (ParsedService) this.services.get(i2);
        ...
        int size3 = this.providers.size();
        for (int i3 = 0; i3 < size3; i3++) {
            ParsedProvider parsedProvider = (ParsedProvider) this.providers.get(i3);
    ...
    public PackageImpl(Parcel parcel) {
        ...
        Parcelable.Creator creator = ParsedActivityImpl.CREATOR;
