...
public class PackageParser2 implements AutoCloseable {
    ...
    public ThreadLocal mSharedAppInfo = ThreadLocal.withInitial(new Supplier() { // from class: com.android.server.pm.parsing.PackageParser2$$ExternalSyntheticLambda0
    ...
    public ThreadLocal mSharedResult;
    ...
    public /* synthetic */ boolean lambda$new$1(Callback callback, long j, String str, int i) {
        ApplicationInfo applicationInfo = (ApplicationInfo) this.mSharedAppInfo.get();
    ...
    public ParsedPackage parsePackage(File file, int i, boolean z) {
        ...
        ParseResult parsePackage = this.parsingUtils.parsePackage(((ParseTypeImpl) this.mSharedResult.get()).reset(), file, i);
    ...
    /* loaded from: classes3.dex */
    public abstract class Callback implements ParsingPackageUtils.Callback {
