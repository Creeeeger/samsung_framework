...
public class PackageSetting extends SettingBase implements PackageStateInternal {
    ...
    public final SnapshotCache makeCache() {
        return new SnapshotCache(this, this) { // from class: com.android.server.pm.PackageSetting.1
    ...
    public PackageSetting(String str, String str2, File file, String str3, String str4, String str5, String str6, long j, int i, int i2, int i3, String[] strArr, long[] jArr, String[] strArr2, long[] jArr2, Map map, UUID uuid) {
        super(i, i2);
    ...
    public void dumpDebug(ProtoOutputStream protoOutputStream, long j, List list, LegacyPermissionDataProvider legacyPermissionDataProvider) {
    ...
    public PackageSetting setFirstInstallTime(long j, int i) {
        if (i == -1) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ((PackageUserStateImpl) this.mUserStates.valueAt(i2)).setFirstInstallTime(j);
            }
        } else {
    ...
    public boolean setMimeGroup(String str, ArraySet arraySet) {
        Map map = this.mimeGroups;
    ...
    public PackageSetting setPkgStateLibraryFiles(Collection collection) {
        List usesLibraryFiles = getUsesLibraryFiles();
    ...
    public void copyMimeGroups(Map map) {
        if (map == null) {
    ...
    public PackageSetting updateMimeGroups(Set set) {
        if (set == null) {
            this.mimeGroups = null;
            return this;
        }
    ...
    public void copyPackageSetting(PackageSetting packageSetting, boolean z) {
        ...
        for (int i = 0; i < packageSetting.mUserStates.size(); i++) {
            if (z) {
                this.mUserStates.put(packageSetting.mUserStates.keyAt(i), ((PackageUserStateImpl) packageSetting.mUserStates.valueAt(i)).snapshot());
            } else {
                PackageUserStateImpl packageUserStateImpl = (PackageUserStateImpl) packageSetting.mUserStates.valueAt(i);
                packageUserStateImpl.setWatchable(this);
                this.mUserStates.put(packageSetting.mUserStates.keyAt(i), packageUserStateImpl);
            }
        }
        Set set = this.mOldCodePaths;
        if (set != null) {
    ...
    public void setUserState(int i, long j, int i2, boolean z, boolean z2, boolean z3, boolean z4, int i3, ArrayMap arrayMap, boolean z5, boolean z6, String str, ArraySet arraySet, ArraySet arraySet2, int i4, int i5, String str2, String str3, long j2) {
    ...
    public WatchedArraySet getEnabledComponents(int i) {
        return readUserState(i).getEnabledComponentsNoCopy();
    }

    public WatchedArraySet getDisabledComponents(int i) {
        return readUserState(i).getDisabledComponentsNoCopy();
    }

    public void setEnabledComponentsCopy(WatchedArraySet watchedArraySet, int i) {
        modifyUserState(i).setEnabledComponents(watchedArraySet != null ? watchedArraySet.untrackedStorage() : null);
        onChanged();
    }

    public void setDisabledComponentsCopy(WatchedArraySet watchedArraySet, int i) {
    ...
    public int[] getNotInstalledUserIds() {
        ...
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            if (!((PackageUserStateImpl) this.mUserStates.valueAt(i2)).isInstalled()) {
                i++;
            }
        }
        if (i == 0) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (!((PackageUserStateImpl) this.mUserStates.valueAt(i4)).isInstalled()) {
    ...
    public void writePackageUserPermissionsProto(ProtoOutputStream protoOutputStream, long j, List list, LegacyPermissionDataProvider legacyPermissionDataProvider) {
    ...
    public void writeUsersInfoToProto(ProtoOutputStream protoOutputStream, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            PackageUserStateInternal packageUserStateInternal = (PackageUserStateInternal) this.mUserStates.valueAt(i2);
            protoOutputStream.write(1120986464257L, keyAt);
            if (packageUserStateInternal.isInstantApp()) {
                i = 2;
            } else {
                i = packageUserStateInternal.isInstalled() ? 1 : 0;
            }
            ...
            if (packageUserStateInternal.isSuspended()) {
                for (int i3 = 0; i3 < packageUserStateInternal.getSuspendParams().size(); i3++) {
                    protoOutputStream.write(2237677961225L, (String) packageUserStateInternal.getSuspendParams().keyAt(i3));
                }
            }
    ...
    @Override // com.android.server.pm.pkg.PackageState
    public List getSharedLibraryDependencies() {
    ...
    public PackageSetting setOldCodePaths(Set set) {
    ...
    public PackageSetting addMimeTypes(String str, Set set) {
        if (this.mimeGroups == null) {
            this.mimeGroups = new ArrayMap();
        }
        Set set2 = (Set) this.mimeGroups.get(str);
        if (set2 == null) {
            set2 = new ArraySet();
    ...
    public PackageUserState getStateForUser(UserHandle userHandle) {
        PackageUserState packageUserState = (PackageUserState) getUserStates().get(userHandle.getIdentifier());
