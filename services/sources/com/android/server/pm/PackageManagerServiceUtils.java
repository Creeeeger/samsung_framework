...
public abstract class PackageManagerServiceUtils {
    ...
    public static final ThreadLocal DISABLE_ENFORCE_INTENTS_TO_MATCH_INTENT_FILTERS = ThreadLocal.withInitial(new Supplier() { // from class: com.android.server.pm.PackageManagerServiceUtils$$ExternalSyntheticLambda2
    ...
    public static boolean isActiveInForegroundWithinThresholdTime(long j, long j2, long j3) {
        return j - j3 < j2;
    }
    ...
    public static void applyEnforceIntentFilterMatching(PlatformCompat platformCompat, ComponentResolverApi componentResolverApi, List list, boolean z, Intent intent, String str, int i) {
        ParsedComponent service;
        if (((Boolean) DISABLE_ENFORCE_INTENTS_TO_MATCH_INTENT_FILTERS.get()).booleanValue()) {
            return;
        }
            ...
            if (ActivityManager.checkComponentPermission(null, i, componentInfo.applicationInfo.uid, false) != 0) {
                ...
                if (service != null && !service.getIntents().isEmpty()) {
                    ...
                    while (true) {
                        ...
                        if (IntentResolver.intentMatchesFilter(((ParsedIntentInfo) service.getIntents().get(i2)).getIntentFilter(), intent, str)) {
                            z2 = true;
                            break;
                        }
                        i2++;
