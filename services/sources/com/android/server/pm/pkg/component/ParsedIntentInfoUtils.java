...
public abstract class ParsedIntentInfoUtils {
    public static final RestrictedReceiverFilter sRRFilter = RestrictedReceiverFilter.getInstance();

    /* JADX WARN: Failed to find 'out' block for switch in B:46:0x0089. Please report as an issue. */
    public static ParseResult parseIntentInfo(String str, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, boolean z, boolean z2, ParseInput parseInput) {
        ParseResult success;
        ...
        try {
                            ...
                            case 0:
                                ...
                                if (attributeValue == null) {
                                    ...
                                    if (restrictedReceiverFilter != null) {
                                        ...
                                        if (restrictedReceiverFilter.filterReceiver(packageName, baseApkPath, attributeValue)) {
            ...
            for (RestrictedReceiverFilter.RestrictedAction restrictedAction : arrayList) {
                if ((BroadcastReceiverListParser.isPackageXXXIntent(restrictedAction.mAction) && BroadcastReceiverListParser.hasPackageSSP(intentFilter)) ? false : true) {
    ...
    public static ParseResult parseData(ParsedIntentInfo parsedIntentInfo, Resources resources, XmlResourceParser xmlResourceParser, boolean z, ParseInput parseInput) {
