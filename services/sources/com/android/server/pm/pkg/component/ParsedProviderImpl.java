...
public class ParsedProviderImpl extends ParsedMainComponentImpl implements ParsedProvider {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: com.android.server.pm.pkg.component.ParsedProviderImpl.1
    ...
    public List pathPermissions;
    public String readPermission;
    public boolean syncable;
    public List uriPermissionPatterns;
    ...
    @Override // com.android.server.pm.pkg.component.ParsedProvider
    public List getUriPermissionPatterns() {
