...
public final class DefaultCrossProfileResolver extends CrossProfileResolver {
    ...
    public final CrossProfileDomainInfo querySkipCurrentProfileIntents(Computer computer, List list, Intent intent, String str, long j, int i, Function function) {
    ...
    public final CrossProfileDomainInfo queryCrossProfileIntents(Computer computer, List list, Intent intent, String str, long j, int i, boolean z, Function function) {
    ...
    public CrossProfileDomainInfo createForwardingResolveInfo(Computer computer, CrossProfileIntentFilter crossProfileIntentFilter, Intent intent, String str, long j, int i, Function function) {
        ...
        List queryActivities = this.mComponentResolver.queryActivities(computer, intent, str, j, targetUserId);
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            if (!resolveInfo2.handleAllWebDataURI && (packageStateInternal = (PackageStateInternal) function.apply(resolveInfo2.activityInfo.packageName)) != null) {
                i2 = Math.max(i2, this.mDomainVerificationManager.approvalLevelForDomain(packageStateInternal, intent, j, targetUserId));
            }
        }
