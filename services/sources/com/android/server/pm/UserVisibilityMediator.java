...
public final class UserVisibilityMediator implements Dumpable {
    ...
    */
    public int assignUserToDisplayOnStart(int r18, int r19, int r20, int r21) {
        /*
            Method dump skipped, instructions count: 317
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.pm.UserVisibilityMediator.assignUserToDisplayOnStart(int, int, int, int):int");
    }
