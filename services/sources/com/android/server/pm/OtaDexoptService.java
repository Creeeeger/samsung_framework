...
public class OtaDexoptService extends IOtaDexopt.Stub {
    ...
    public synchronized void prepare() {
        ...
        Predicate predicate = new Predicate() { // from class: com.android.server.pm.OtaDexoptService$$ExternalSyntheticLambda0
        ...
        try {
            ...
            for (PackageStateInternal packageStateInternal3 : arrayList) {
                Log.d("OTADexopt", "  " + packageStateInternal3.getPackageName() + " - " + packageStateInternal3.getTransientState().getLatestForegroundPackageUseTimeInMills());
            }
    ...
    public static /* synthetic */ boolean lambda$prepare$0(PackageStateInternal packageStateInternal) {
        return "android".equals(packageStateInternal.getPkg().getPackageName());
    }
    ...
    public final synchronized List generatePackageDexopts(AndroidPackage androidPackage, PackageStateInternal packageStateInternal, int i) {
        ...
        try {
            new OTADexoptPackageDexOptimizer(new Installer(this.mContext, true) { // from class: com.android.server.pm.OtaDexoptService.1
                ...
                public boolean dexopt(String str, int i2, String str2, String str3, int i3, String str4, int i4, String str5, String str6, String str7, String str8, boolean z, int i5, String str9, String str10, String str11) {
    ...
    /* loaded from: classes3.dex */
    public class OTADexoptPackageDexOptimizer extends PackageDexOptimizer.ForcedUpdatePackageDexOptimizer {
