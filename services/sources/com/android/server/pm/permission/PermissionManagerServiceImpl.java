...
public class PermissionManagerServiceImpl implements PermissionManagerServiceInterface {
    ...
    public static /* bridge */ /* synthetic */ void m9872$$Nest$smkillUid(int i, int i2, String str) {
        killUid(i, i2, str);
    }
        ...
        public void onGidsChanged(final int i, final int i2) {
            PermissionManagerServiceImpl.this.mHandler.post(new Runnable() { // from class: com.android.server.pm.permission.PermissionManagerServiceImpl$1$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    PermissionManagerServiceImpl.m9872$$Nest$smkillUid(i, i2, "permission grant or revoke changed gids");
                }
            });
        }
    ...
    */
    public final void grantRuntimePermissionInternal(java.lang.String r17, java.lang.String r18, boolean r19, int r20, int r21, com.android.server.pm.permission.PermissionManagerServiceImpl.PermissionCallback r22) {
        /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public int setLicensePermissionsForMDM(java.lang.String r13, java.util.Set r14) {
        /*
            ...
            synchronized (this.mLock) {
                ...
                if (permission != null && (permission.isInternal() || permission.isRuntime())) {
                    ...
                    this.mPackageManagerInt.forEachPackage(new Consumer() { // from class: com.android.server.pm.permission.PermissionManagerServiceImpl$$ExternalSyntheticLambda22
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            PermissionManagerServiceImpl.this.lambda$revokeRuntimePermissionsIfPermissionDefinitionChangedInternal$10(userIds, str, isInternal, callingUid, (AndroidPackage) obj);
                        }
                    });
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$revokeRuntimePermissionsIfPermissionDefinitionChangedInternal$10(int[] iArr, String str, boolean z, int i, AndroidPackage androidPackage) {
        String str2;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void restorePermissionState(com.android.server.pm.pkg.AndroidPackage r43, boolean r44, java.lang.String r45, com.android.server.pm.permission.PermissionManagerServiceImpl.PermissionCallback r46, int r47) {
        /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final android.util.Pair mergePermissionState(int r10, com.android.server.pm.permission.PermissionState r11, com.android.server.pm.permission.PermissionState r12) {
        /*
            r9 = this;
            int r0 = r12.getFlags()
            boolean r12 = r9.isEffectivelyGranted(r12)
            int r1 = r11.getFlags()
            boolean r2 = r9.isEffectivelyGranted(r11)
            r3 = r0 | r1
            r4 = 524291(0x80003, float:7.34688E-40)
            r4 = r4 & r0
            r5 = 0
            r4 = r4 | r5
            r6 = r3 & 14336(0x3800, float:2.0089E-41)
            r4 = r4 | r6
            r6 = r4 & 14336(0x3800, float:2.0089E-41)
            if (r6 != 0) goto L21
            r4 = r4 | 16384(0x4000, float:2.2959E-41)
        L21:
            r6 = 32820(0x8034, float:4.599E-41)
            r7 = r3 & r6
            r4 = r4 | r7
            if (r7 != 0) goto L2c
        ...
        L2c:
            r7 = r4 & 20
            if (r7 != 0) goto L4b
            r7 = 557091(0x88023, float:7.80651E-40)
            r7 = r7 & r4
            if (r7 != 0) goto L45
            java.util.List r7 = com.android.server.pm.permission.PermissionManagerServiceImpl.NOTIFICATION_PERMISSIONS
        ...
        L60:
            ...
            goto L89
        L65:
            r6 = 32800(0x8020, float:4.5963E-41)
            r8 = r0 & r6
            if (r8 == 0) goto L6d
            goto L88
        L6d:
        ...
        L94:
            if (r5 == r12) goto L9a
            r12 = -524292(0xfffffffffff7fffc, float:NaN)
            r0 = r0 & r12
        L9a:
            if (r5 != 0) goto Laf
            java.lang.String r11 = r11.getName()
            android.content.pm.PackageManagerInternal r12 = r9.mPackageManagerInt
            int r10 = r12.getUidTargetSdkVersion(r10)
            boolean r9 = r9.isPermissionSplitFromNonRuntime(r11, r10)
            if (r9 == 0) goto Laf
            r0 = r0 | 8
            goto Lb0
        Laf:
        ...
        Lb0:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.pm.permission.PermissionManagerServiceImpl.mergePermissionState(int, com.android.server.pm.permission.PermissionState, com.android.server.pm.permission.PermissionState):android.util.Pair");
    }
