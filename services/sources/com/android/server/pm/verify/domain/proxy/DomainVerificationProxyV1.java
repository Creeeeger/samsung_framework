...
public class DomainVerificationProxyV1 implements DomainVerificationProxy {
    ...
    public static void queueLegacyVerifyResult(Context context, Connection connection, int i, int i2, List list, int i3) {
    ...
    public final void sendBroadcasts(ArrayMap arrayMap) {
        ...
        this.mConnection.getDeviceIdleInternal().addPowerSaveTempWhitelistApp(Process.myUid(), this.mVerifierComponent.getPackageName(), powerSaveTempWhitelistAppDuration, 0, true, FrameworkStatsLog.APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DOMAIN_VERIFICATION_V1, "domain verification agent");
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (androidPackage != null) {
                ...
                makeBasic.setTemporaryAppAllowlist(powerSaveTempWhitelistAppDuration, 0, FrameworkStatsLog.APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DOMAIN_VERIFICATION_V1, "");
