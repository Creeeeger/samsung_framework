...
public class UserSystemPackageInstaller {
    ...
    public boolean installWhitelistedSystemPackages(final boolean z, boolean z2, final ArraySet arraySet) {
    ...
    public static boolean shouldChangeInstallationState(PackageStateInternal packageStateInternal, boolean z, int i, boolean z2, boolean z3, ArraySet arraySet) {
        if (z) {
    ...
    public final int getDeviceDefaultWhitelistMode() {
        return Resources.getSystem().getInteger(17695029);
    }
