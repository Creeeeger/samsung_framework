...
public class CrossProfileAppsServiceImpl extends ICrossProfileApps.Stub {
    ...
    public List getTargetUserProfiles(String str) {
    ...
    public void startActivityAsUser(IApplicationThread iApplicationThread, String str, String str2, ComponentName componentName, int i, boolean z, IBinder iBinder, Bundle bundle) {
    ...
    public void startActivityAsUserByIntent(IApplicationThread iApplicationThread, String str, String str2, Intent intent, int i, IBinder iBinder, Bundle bundle) {
        Objects.requireNonNull(str);
        ...
        int callingUserId = this.mInjector.getCallingUserId();
        int callingUid = this.mInjector.getCallingUid();
        List targetUserProfilesUnchecked = getTargetUserProfilesUnchecked(str, callingUserId);
    ...
    public boolean canInteractAcrossProfiles(String str) {
        Objects.requireNonNull(str);
        verifyCallingPackage(str);
        List targetUserProfilesUnchecked = getTargetUserProfilesUnchecked(str, this.mInjector.getCallingUserId());
    ...
    public final boolean haveProfilesGotInteractAcrossProfilesPermission(final String str, List list) {
        Iterator it = list.iterator();
        while (it.hasNext()) {
            final UserHandle userHandle = (UserHandle) it.next();
    ...
    public /* synthetic */ Integer lambda$haveProfilesGotInteractAcrossProfilesPermission$0(String str, UserHandle userHandle) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isCrossProfilePackageAllowlisted$1(int i, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isCrossProfilePackageAllowlistedByDefault$2(String str) {
        return Boolean.valueOf(this.mInjector.getDevicePolicyManagerInternal().getDefaultCrossProfilePackages().contains(str));
    }

    public final List getTargetUserProfilesUnchecked(final String str, final int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ List lambda$getTargetUserProfilesUnchecked$3(int i, String str) {
        int[] enabledProfileIds = this.mInjector.getUserManager().getEnabledProfileIds(i);
        ArrayList arrayList = new ArrayList();
        for (int i2 : enabledProfileIds) {
            if (i2 != i && isPackageEnabled(str, i2) && !SemPersonaManager.isSecureFolderId(i2) && !SemDualAppManager.isDualAppId(i2)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isPackageEnabled$4(String str, int i, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$verifyActivityCanHandleIntent$5(Intent intent, int i, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$verifyActivityCanHandleIntentAndExported$6(Intent intent, int i, int i2, ComponentName componentName) {
    ...
    public void lambda$clearInteractAcrossProfilesAppOps$12(int i, String str, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isPackageInstalled$7(String str, int i) {
    ...
    public final void setInteractAcrossProfilesAppOpForProfileOrThrow(String str, final int i, int i2, boolean z) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setInteractAcrossProfilesAppOpForProfileOrThrow$8(int i, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$currentModeEquals$9(int i, String str, int i2, String str2) {
    ...
    public final void sendCanInteractAcrossProfilesChangedBroadcast(String str, UserHandle userHandle) {
        ...
        Iterator it = findBroadcastReceiversForUser(intent, userHandle).iterator();
        while (it.hasNext()) {
    ...
    public final List findBroadcastReceiversForUser(Intent intent, UserHandle userHandle) {
    ...
    public final boolean canUserAttemptToConfigureInteractAcrossProfiles(String str, int i) {
        int[] filterWorkProfileIdOnly = filterWorkProfileIdOnly(this.mInjector.getUserManager().getProfileIds(i, false));
        if (filterWorkProfileIdOnly.length >= 2 && !isProfileOwner(str, filterWorkProfileIdOnly) && hasRequestedAppOpPermission(AppOpsManager.opToPermission(93), str, i)) {
            return !isPlatformSignedAppWithNonUserConfigurablePermission(str, filterWorkProfileIdOnly);
        }
        return false;
    }

    public final int[] filterWorkProfileIdOnly(int[] iArr) {
        ArrayList arrayList = new ArrayList();
        for (int i : iArr) {
            if (!SemDualAppManager.isDualAppId(i) && !SemPersonaManager.isSecureFolderId(i)) {
                arrayList.add(Integer.valueOf(i));
            }
        }
        return arrayList.stream().mapToInt(new ToIntFunction() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda10
    ...
    public final boolean hasOtherProfileWithPackageInstalled(final String str, final int i) {
        return ((Boolean) this.mInjector.withCleanCallingIdentity(new FunctionalUtils.ThrowingSupplier() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda12
            public final Object getOrThrow() {
                Boolean lambda$hasOtherProfileWithPackageInstalled$11;
                lambda$hasOtherProfileWithPackageInstalled$11 = CrossProfileAppsServiceImpl.this.lambda$hasOtherProfileWithPackageInstalled$11(i, str);
                return lambda$hasOtherProfileWithPackageInstalled$11;
            }
        })).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$hasOtherProfileWithPackageInstalled$11(int i, String str) {
    ...
    public void resetInteractAcrossProfilesAppOps(int i, List list) {
        Iterator it = list.iterator();
        while (it.hasNext()) {
            resetInteractAcrossProfilesAppOp(i, (String) it.next());
        }
    }
    ...
    public final void resetInteractAcrossProfilesAppOp(int i, String str) {
        ...
        lambda$clearInteractAcrossProfilesAppOps$12(i, str, AppOpsManager.opToDefaultMode(AppOpsManager.permissionToOp("android.permission.INTERACT_ACROSS_PROFILES")));
    }
    ...
    public void clearInteractAcrossProfilesAppOps(final int i) {
        ...
        findAllPackageNames().forEach(new Consumer() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda7
            ...
            public final void accept(Object obj) {
                CrossProfileAppsServiceImpl.this.lambda$clearInteractAcrossProfilesAppOps$12(i, opToDefaultMode, (String) obj);
            }
        });
    }

    public final List findAllPackageNames() {
        return (List) this.mInjector.getPackageManagerInternal().getInstalledApplications(0L, this.mInjector.getCallingUserId(), this.mInjector.getCallingUid()).stream().map(new Function() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda15
    ...
    public final boolean isSameProfileGroup(final int i, final int i2) {
        return ((Boolean) this.mInjector.withCleanCallingIdentity(new FunctionalUtils.ThrowingSupplier() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda3
            public final Object getOrThrow() {
                Boolean lambda$isSameProfileGroup$14;
                lambda$isSameProfileGroup$14 = CrossProfileAppsServiceImpl.this.lambda$isSameProfileGroup$14(i, i2);
                return lambda$isSameProfileGroup$14;
            }
        })).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isSameProfileGroup$14(int i, int i2) {
    ...
    public final boolean isManagedProfile(final int i) {
        return ((Boolean) this.mInjector.withCleanCallingIdentity(new FunctionalUtils.ThrowingSupplier() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda13
            public final Object getOrThrow() {
                Boolean lambda$isManagedProfile$15;
                lambda$isManagedProfile$15 = CrossProfileAppsServiceImpl.this.lambda$isManagedProfile$15(i);
                return lambda$isManagedProfile$15;
            }
        })).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$isManagedProfile$15(int i) {
    ...
    public final boolean isProfileOwner(String str, final int i) {
        ComponentName componentName = (ComponentName) this.mInjector.withCleanCallingIdentity(new FunctionalUtils.ThrowingSupplier() { // from class: com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda6
            public final Object getOrThrow() {
                ComponentName lambda$isProfileOwner$16;
                lambda$isProfileOwner$16 = CrossProfileAppsServiceImpl.this.lambda$isProfileOwner$16(i);
                return lambda$isProfileOwner$16;
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ ComponentName lambda$isProfileOwner$16(int i) {
    ...
    public class LocalService extends CrossProfileAppsInternal {
        ...
        public boolean verifyPackageHasInteractAcrossProfilePermission(String str, int i) {
        ...
        public List getTargetUserProfiles(String str, int i) {
