...
public final class VoiceInteractionSessionConnection implements ServiceConnection, AssistDataRequester.AssistDataRequesterCallbacks {
    ...
    public ArrayList mPendingShowCallbacks;
    ...
    public boolean showLocked(Bundle bundle, int i, String str, int i2, IVoiceInteractionSessionShowCallback iVoiceInteractionSessionShowCallback, List list) {
        ...
        if (z3) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                arrayList.add(((ActivityAssistInfo) list.get(i4)).getActivityToken());
            }
            this.mAssistDataRequester.requestAssistData(arrayList, z, z2, (userDisabledShowContextLocked & 1) == 0, (userDisabledShowContextLocked & 2) == 0, this.mCallingUid, this.mSessionComponentName.getPackageName(), str, CoreRune.FW_SUPPORT_SEARCLE_HOME_LONG && ((i3 = this.mShowArgs.getInt("omni.entry_point")) == 65537 || i3 == 65538));
