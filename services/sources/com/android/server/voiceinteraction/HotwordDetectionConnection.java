...
public final class HotwordDetectionConnection {
    ...
    public HotwordDetectionConnection(Object obj, Context context, int i, Identity identity, ComponentName componentName, ComponentName componentName2, int i2, boolean z, int i3, VoiceInteractionManagerServiceImpl.DetectorRemoteExceptionListener detectorRemoteExceptionListener) {
        ...
        if (i4 <= 0) {
            ...
            this.mCancellationTaskFuture = scheduledThreadPoolExecutor.scheduleAtFixedRate(new Runnable() { // from class: com.android.server.voiceinteraction.HotwordDetectionConnection$$ExternalSyntheticLambda7
    ...
    /* loaded from: classes3.dex */
    public class ServiceConnection extends ServiceConnector.Impl {
    ...
    public static /* synthetic */ void lambda$updateContentCaptureManager$8(IContentCaptureManager iContentCaptureManager, ISandboxedDetectionService iSandboxedDetectionService) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateServiceIdentity$10(ISandboxedDetectionService iSandboxedDetectionService) {
