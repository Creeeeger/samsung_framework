...
public class VoiceInteractionManagerService extends SystemService {
    ...
    public class VoiceInteractionManagerServiceStub extends IVoiceInteractionManagerService.Stub {
        ...
        public PackageMonitor mPackageMonitor = new AnonymousClass2();
        ...
        public final String getForceVoiceInteractionServicePackage(Resources resources) {
            String string = resources.getString(R.string.fileSizeSuffix);
        ...
        */
        public void switchImplementationIfNeededNoTracingLocked(boolean r10) {
            /*
                r9 = this;
                boolean r0 = r9.mSafeMode
                if (r0 != 0) goto Lcb
                ...
                android.content.ContentResolver r0 = r0.mResolver
                java.lang.String r1 = "voice_interaction_service"
                int r2 = r9.mCurUser
                java.lang.String r0 = android.provider.Settings.Secure.getStringForUser(r0, r1, r2)
                java.lang.String r1 = "VoiceInteractionManager"
                r2 = 0
                if (r0 == 0) goto L43
                boolean r3 = r0.isEmpty()
                if (r3 != 0) goto L43
                android.content.ComponentName r3 = android.content.ComponentName.unflattenFromString(r0)     // Catch: java.lang.Throwable -> L2e
                android.content.pm.IPackageManager r4 = android.app.AppGlobals.getPackageManager()     // Catch: java.lang.Throwable -> L2e
                int r5 = r9.mCurUser     // Catch: java.lang.Throwable -> L2e
                r6 = 0
                android.content.pm.ServiceInfo r0 = r4.getServiceInfo(r3, r6, r5)     // Catch: java.lang.Throwable -> L2e
                r8 = r3
                goto L45
            L2e:
                r3 = move-exception
                ...
                r4.<init>()
                java.lang.String r5 = "Bad voice interaction service name "
                r4.append(r5)
                r4.append(r0)
                java.lang.String r0 = r4.toString()
                android.util.Slog.wtf(r1, r0, r3)
            L43:
                r0 = r2
                r8 = r0
            L45:
            ...
            L4b:
                r3 = 0
            L4c:
                com.android.server.voiceinteraction.VoiceInteractionManagerService r4 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                com.android.server.pm.UserManagerInternal r4 = r4.mUserManagerInternal
                int r5 = r9.mCurUser
                boolean r4 = r4.isUserUnlockingOrUnlocked(r5)
                if (r4 == 0) goto L88
                if (r3 == 0) goto L75
                com.android.server.voiceinteraction.VoiceInteractionManagerService r4 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                android.content.pm.ShortcutServiceInternal r4 = r4.mShortcutServiceInternal
                java.lang.String r5 = r8.getPackageName()
                int r6 = r9.mCurUser
                r4.setShortcutHostPackage(r1, r5, r6)
                com.android.server.voiceinteraction.VoiceInteractionManagerService r4 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                com.android.server.wm.ActivityTaskManagerInternal r4 = r4.mAtmInternal
                android.content.pm.ApplicationInfo r0 = r0.applicationInfo
                int r0 = r0.uid
                int r5 = r9.mCurUser
                r4.setAllowAppSwitches(r1, r0, r5)
                goto L88
            L75:
                com.android.server.voiceinteraction.VoiceInteractionManagerService r0 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                android.content.pm.ShortcutServiceInternal r0 = r0.mShortcutServiceInternal
                int r4 = r9.mCurUser
                r0.setShortcutHostPackage(r1, r2, r4)
                com.android.server.voiceinteraction.VoiceInteractionManagerService r0 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                com.android.server.wm.ActivityTaskManagerInternal r0 = r0.mAtmInternal
                r4 = -1
                int r5 = r9.mCurUser
                r0.setAllowAppSwitches(r1, r4, r5)
            L88:
                if (r10 != 0) goto La0
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = r9.mImpl
                if (r10 == 0) goto La0
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = r9.mImpl
                int r10 = r10.mUser
                int r0 = r9.mCurUser
                if (r10 != r0) goto La0
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = r9.mImpl
                android.content.ComponentName r10 = r10.mComponent
                boolean r10 = r10.equals(r8)
                if (r10 != 0) goto Lcb
            La0:
                r9.unloadAllKeyphraseModels()
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = r9.mImpl
                if (r10 == 0) goto Lac
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = r9.mImpl
                r10.shutdownLocked()
            Lac:
                if (r3 == 0) goto Lc8
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r10 = new com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl
                com.android.server.voiceinteraction.VoiceInteractionManagerService r0 = com.android.server.voiceinteraction.VoiceInteractionManagerService.this
                android.content.Context r4 = r0.mContext
                android.os.Handler r5 = com.android.server.UiThread.getHandler()
                int r7 = r9.mCurUser
                r3 = r10
                r6 = r9
                r3.<init>(r4, r5, r6, r7, r8)
                r9.setImplLocked(r10)
                com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl r9 = r9.mImpl
                r9.startLocked()
                goto Lcb
            Lc8:
                r9.setImplLocked(r2)
            Lcb:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.voiceinteraction.VoiceInteractionManagerService.VoiceInteractionManagerServiceStub.switchImplementationIfNeededNoTracingLocked(boolean):void");
        }
        ...
        public ComponentName findAvailRecognizer(String str, int i) {
            ...
            List availableServices = RecognitionServiceInfo.getAvailableServices(VoiceInteractionManagerService.this.mContext, i);
            ...
            if (str != null) {
                for (int i2 = 0; i2 < size; i2++) {
                    ServiceInfo serviceInfo = ((RecognitionServiceInfo) availableServices.get(i2)).getServiceInfo();
            ...
            ServiceInfo serviceInfo2 = ((RecognitionServiceInfo) availableServices.get(0)).getServiceInfo();
        ...
        public boolean showSessionFromSession(IBinder iBinder, Bundle bundle, int i, String str) {
            ...
            synchronized (this) {
                String string = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.ext_media_status_unsupported);
                String string2 = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.ext_media_status_unmounted);
                if (bundle != null && bundle.containsKey(string)) {
                    ...
                    if (!bundle.getBoolean(VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.ext_media_unmount_action), true)) {
                        return false;
                    }
                    if (!VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.ext_media_unmountable_notification_message).equals(getCurInteractor(Binder.getCallingUserHandle().getIdentifier()).getPackageName())) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$updateState$3(PersistableBundle persistableBundle, SharedMemory sharedMemory, IBinder iBinder) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$initAndVerifyDetector$4(Identity identity, PersistableBundle persistableBundle, SharedMemory sharedMemory, IBinder iBinder, IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback, int i) {
        ...
        public void startPerceiving(IVisualQueryDetectionVoiceInteractionCallback iVisualQueryDetectionVoiceInteractionCallback) {
        ...
        public void startListeningFromExternalSource(ParcelFileDescriptor parcelFileDescriptor, AudioFormat audioFormat, PersistableBundle persistableBundle, IBinder iBinder, IMicrophoneHotwordDetectionVoiceInteractionCallback iMicrophoneHotwordDetectionVoiceInteractionCallback) {
            synchronized (this) {
                enforceIsCurrentVoiceInteractionService();
                if (this.mImpl == null) {
        ...
        public void triggerHardwareRecognitionEventForTest(SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEvent, IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback) {
            enforceCallingPermission("android.permission.RECORD_AUDIO");
            enforceCallingPermission("android.permission.CAPTURE_AUDIO_HOTWORD");
            synchronized (this) {
                enforceIsCurrentVoiceInteractionService();
        ...
        public final synchronized void unloadAllKeyphraseModels() {
            for (int i = 0; i < VoiceInteractionManagerService.this.mLoadedKeyphraseIds.size(); i++) {
                ...
                int unloadKeyphraseModel = ((SoundTriggerSession) VoiceInteractionManagerService.this.mLoadedKeyphraseIds.valueAt(i)).unloadKeyphraseModel(intValue);
        ...
        public final IRecognitionStatusCallback createSoundTriggerCallbackLocked(IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback, Identity identity) {
            if (this.mImpl == null) {
                return null;
            }
        ...
        public final Intent getContextualSearchIntent(Bundle bundle) {
            String string = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.ext_media_unmountable_notification_message);
            if (string.isEmpty()) {
                return null;
            }
            ...
            for (ActivityAssistInfo activityAssistInfo : topVisibleActivities) {
                ...
                if (devicePolicyManagerInternal != null && devicePolicyManagerInternal.isUserOrganizationManaged(activityAssistInfo.getUserId())) {
                    z = true;
                }
            }
            WindowManagerInternal windowManagerInternal = VoiceInteractionManagerService.this.mWmInternal;
            ScreenCapture.ScreenshotHardwareBuffer takeAssistScreenshot = windowManagerInternal != null ? windowManagerInternal.takeAssistScreenshot() : null;
            Bitmap asBitmap = takeAssistScreenshot != null ? takeAssistScreenshot.asBitmap() : null;
            if (asBitmap != null) {
                intent.putExtra("com.android.contextualsearch.flag_secure_found", takeAssistScreenshot.containsSecureLayers());
                if (isAssistDataAllowed) {
        ...
        public final boolean startContextualSearch(Intent intent) {
            ...
            VoiceInteractionManagerService voiceInteractionManagerService = VoiceInteractionManagerService.this;
            return voiceInteractionManagerService.mAtmInternal.startActivityWithScreenshot(intent, voiceInteractionManagerService.mContext.getPackageName(), Binder.getCallingUid(), Binder.getCallingPid(), null, makeCustomTaskAnimation.toBundle(), Binder.getCallingUserHandle().getIdentifier()) == 0;
        }
    }
}
