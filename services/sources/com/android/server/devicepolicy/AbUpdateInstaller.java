...
public class AbUpdateInstaller extends UpdateInstaller {
    public static final Map errorCodesMap = buildErrorCodesMap();
    public static final Map errorStringsMap = buildErrorStringsMap();
    ...
    public static Map buildErrorCodesMap() {
    ...
    public static Map buildErrorStringsMap() {
        HashMap hashMap = new HashMap();
    ...
    public final boolean updateStateForPayload() {
        ...
        while (this.mEntries.hasMoreElements()) {
            ...
            if (zipEntry.isDirectory()) {
                ...
                updatePropertiesForEntry(zipEntry);
            }
        }
        return true;
    }
    ...
    public final void updatePropertiesForEntry(ZipEntry zipEntry) {
    ...
    /* loaded from: classes2.dex */
    public class DelegatingUpdateEngineCallback extends UpdateEngineCallback {
        ...
        public void onPayloadApplicationComplete(int i) {
            ...
            this.mUpdateInstaller.notifyCallbackOnError(((Integer) AbUpdateInstaller.errorCodesMap.getOrDefault(Integer.valueOf(i), 1)).intValue(), (String) AbUpdateInstaller.errorStringsMap.getOrDefault(Integer.valueOf(i), "Unknown error with error code = " + i));
        }
    }
}
