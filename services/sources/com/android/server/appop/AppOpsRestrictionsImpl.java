...
public class AppOpsRestrictionsImpl implements AppOpsRestrictions {
    ...
    public boolean setGlobalRestriction(Object obj, int i, boolean z) {
        if (z) {
            ...
            SparseBooleanArray sparseBooleanArray = (SparseBooleanArray) this.mGlobalRestrictions.get(obj);
            Objects.requireNonNull(sparseBooleanArray);
            boolean z2 = !sparseBooleanArray.get(i);
            sparseBooleanArray.put(i, true);
            return z2;
        }
        SparseBooleanArray sparseBooleanArray2 = (SparseBooleanArray) this.mGlobalRestrictions.get(obj);
    ...
    public final boolean getUserRestriction(Object obj, int i, int i2) {
        ...
        if (sparseArray == null || (sparseBooleanArray = (SparseBooleanArray) sparseArray.get(i)) == null) {
            return false;
        }
    ...
    public boolean clearUserRestrictions(Object obj, Integer num) {
        ...
        SparseArray sparseArray2 = (SparseArray) this.mUserRestrictionExcludedPackageTags.get(obj);
    ...
    public final boolean putUserRestriction(Object obj, int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            SparseBooleanArray sparseBooleanArray2 = (SparseBooleanArray) sparseArray.get(i);
            boolean z2 = !sparseBooleanArray2.get(i2);
            sparseBooleanArray2.put(i2, z);
            return z2;
        }
        SparseArray sparseArray2 = (SparseArray) this.mUserRestrictions.get(obj);
        if (sparseArray2 == null || (sparseBooleanArray = (SparseBooleanArray) sparseArray2.get(i)) == null) {
            return false;
        }
    ...
    public PackageTagsList getUserRestrictionExclusions(Object obj, int i) {
        SparseArray sparseArray = (SparseArray) this.mUserRestrictionExcludedPackageTags.get(obj);
        if (sparseArray == null) {
            return null;
        }
        return (PackageTagsList) sparseArray.get(i);
    }
