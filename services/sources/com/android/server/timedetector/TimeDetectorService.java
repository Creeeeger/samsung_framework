...
public final class TimeDetectorService extends ITimeDetectorService.Stub implements IBinder.DeathRecipient {
    ...
    public TimeDetectorService(Context context, Handler handler, CallerIdentityInjector callerIdentityInjector, TimeDetectorStrategy timeDetectorStrategy, NtpTrustedTime ntpTrustedTime) {
        ...
        TimeDetectorStrategy timeDetectorStrategy2 = timeDetectorStrategy;
        this.mTimeDetectorStrategy = timeDetectorStrategy2;
        Objects.requireNonNull(ntpTrustedTime);
        this.mNtpTrustedTime = ntpTrustedTime;
        timeDetectorStrategy2.addChangeListener(new StateChangeListener() { // from class: com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda2
    ...
    public boolean updateConfiguration(int i, TimeConfiguration timeConfiguration) {
        ...
        long clearCallingIdentity = this.mCallerIdentityInjector.clearCallingIdentity();
        try {
            return this.mTimeDetectorStrategy.updateConfiguration(handleIncomingUser, timeConfiguration, false);
        } finally {
            this.mCallerIdentityInjector.restoreCallingIdentity(clearCallingIdentity);
        }
    }
