...
public class DiskStatsLoggingService extends JobService {
    public static ComponentName sDiskStatsLoggingService = new ComponentName("android", DiskStatsLoggingService.class.getName());
    ...
    class LogRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                List packageStats = this.mCollector.getPackageStats(TIMEOUT_MILLIS);
        ...
        public final void logToFile(FileCollector.MeasurementResult measurementResult, FileCollector.MeasurementResult measurementResult2, List list, long j) {
