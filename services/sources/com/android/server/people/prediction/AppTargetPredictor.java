...
public class AppTargetPredictor {
    ...
    public static AppTargetPredictor create(AppPredictionContext appPredictionContext, Consumer consumer, DataManager dataManager, int i, Context context) {
    ...
    public AppTargetPredictor(AppPredictionContext appPredictionContext, Consumer consumer, DataManager dataManager, int i) {
