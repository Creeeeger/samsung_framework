...
public class ShareTargetPredictor extends AppTargetPredictor {
    ...
    public ShareTargetPredictor(AppPredictionContext appPredictionContext, Consumer consumer, DataManager dataManager, int i, Context context) {
    ...
    public void predictTargets() {
        ...
        List directShareTargets = getDirectShareTargets();
        ...
        for (int i = 0; i < Math.min(getPredictionContext().getPredictedTargetCount(), directShareTargets.size()); i++) {
            arrayList.add(((ShareTarget) directShareTargets.get(i)).getAppTarget());
        }
    ...
    public void lambda$onSortAppTargets$1(List list, Consumer consumer) {
        ...
        for (ShareTarget shareTarget : appShareTargets) {
            ...
            arrayList.add(new AppTarget.Builder(appTarget.getId(), appTarget.getPackageName(), appTarget.getUser()).setClassName(appTarget.getClassName()).setRank(shareTarget.getScore() > DisplayPowerController2.RATE_FROM_DOZE_TO_ON ? (int) (shareTarget.getScore() * 1000.0f) : 0).build());
        }
    ...
    public final List getDirectShareTargets() {
    ...
    public final List getAppShareTargets(List list) {
        ArrayList arrayList = new ArrayList();
    ...
    public class ShareTarget {
        ...
        public float mScore = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
