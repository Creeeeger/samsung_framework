...
public class EventHistoryImpl implements EventHistory {
    ...
    public static Map eventHistoriesImplFromDisk(File file, ScheduledExecutorService scheduledExecutorService) {
        ...
        synchronized (this) {
            ...
            if (loadIndexesFromDisk != null) {
                for (int i = 0; i < loadIndexesFromDisk.size(); i++) {
                    this.mEventIndexArray.put(loadIndexesFromDisk.keyAt(i), (EventIndex) loadIndexesFromDisk.valueAt(i));
                }
            }
        }
    }
    ...
    public synchronized EventIndex getEventIndex(Set set) {
        ...
        while (it.hasNext()) {
            EventIndex eventIndex = (EventIndex) this.mEventIndexArray.get(((Integer) it.next()).intValue());
            if (eventIndex != null) {
