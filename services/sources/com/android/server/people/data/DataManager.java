...
public class DataManager {
    ...
    public void forPackagesInProfile(int i, Consumer consumer) {
    ...
    public ShortcutInfo getShortcut(String str, int i, String str2) {
        List shortcuts = getShortcuts(str, i, Collections.singletonList(str2));
    ...
    public List getShareShortcuts(IntentFilter intentFilter, int i) {
    ...
    public List getRecentConversations(int i) {
    ...
    public /* synthetic */ void lambda$getRecentConversations$4(final List list, final PackageData packageData) {
        ...
        packageData.forAllConversations(new Consumer() { // from class: com.android.server.people.data.DataManager$$ExternalSyntheticLambda8
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$pruneOldRecentConversations$6(final long j, int i, PackageData packageData) {
        ...
        final ArrayList arrayList = new ArrayList();
        packageData.forAllConversations(new Consumer() { // from class: com.android.server.people.data.DataManager$$ExternalSyntheticLambda7
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public List getStatuses(String str, int i, String str2) {
        return getStatuses(getConversationInfoOrThrow(getConversationStoreOrThrow(str, i), str2));
    }

    public final List getStatuses(ConversationInfo conversationInfo) {
        Collection statuses = conversationInfo.getStatuses();
        if (statuses != null) {
    ...
    public List queryAppMovingToForegroundEvents(int i, long j, long j2) {
        return UsageStatsQueryHelper.queryAppMovingToForegroundEvents(i, j, j2);
    }

    public Map queryAppUsageStats(int i, long j, long j2, Set set) {
        ...
        synchronized (this.mLock) {
            ...
            if (userData != null && !userData.isUnlocked()) {
                ...
                if (this.mUsageStatsQueryFutures.indexOfKey(i) >= 0) {
                    ((ScheduledFuture) this.mUsageStatsQueryFutures.get(i)).cancel(true);
                }
                if (this.mBroadcastReceivers.indexOfKey(i) >= 0) {
                    this.mContext.unregisterReceiver((BroadcastReceiver) this.mBroadcastReceivers.get(i));
                }
                if (this.mContactsContentObservers.indexOfKey(i) >= 0) {
                    contentResolver.unregisterContentObserver((ContentObserver) this.mContactsContentObservers.get(i));
                }
                if (this.mNotificationListeners.indexOfKey(i) >= 0) {
                    try {
                        ((NotificationListener) this.mNotificationListeners.get(i)).unregisterAsSystemService();
                    } catch (RemoteException unused) {
                    }
                }
                if (this.mPackageMonitors.indexOfKey(i) >= 0) {
                    ((PackageMonitor) this.mPackageMonitors.get(i)).unregister();
                }
                if (i == 0) {
    ...
    public final List getShortcuts(String str, int i, List list) {
    ...
    public final void forAllUnlockedUsers(Consumer consumer) {
        for (int i = 0; i < this.mUserDataArray.size(); i++) {
            UserData userData = (UserData) this.mUserDataArray.get(this.mUserDataArray.keyAt(i));
    ...
    public final PackageData getPackageIfConversationExists(StatusBarNotification statusBarNotification, Consumer consumer) {
        PackageData packageData;
    ...
    public final void cleanupCachedShortcuts(int i, int i2) {
        ...
        unlockedUserData.forAllPackages(new Consumer() { // from class: com.android.server.people.data.DataManager$$ExternalSyntheticLambda9
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
        ...
        PriorityQueue priorityQueue = new PriorityQueue(size + 1, Comparator.comparingLong(new ToLongFunction() { // from class: com.android.server.people.data.DataManager$$ExternalSyntheticLambda10
    ...
    /* loaded from: classes2.dex */
    public class CallLogContentObserver extends ContentObserver implements BiConsumer {
    ...
    /* loaded from: classes2.dex */
    public class MmsSmsContentObserver extends ContentObserver implements BiConsumer {
    ...
    public class ShortcutServiceCallback implements LauncherApps.ShortcutChangeCallback {
        ...
        public void onShortcutsAddedOrUpdated(final String str, final List list, final UserHandle userHandle) {
        ...
        public void onShortcutsRemoved(final String str, final List list, final UserHandle userHandle) {
    ...
    public final void removeConversations(String str, int i, Set set) {
        PackageData packageData = getPackage(str, i);
        if (packageData != null) {
            Iterator it = set.iterator();
            while (it.hasNext()) {
                packageData.deleteDataForConversation((String) it.next());
            }
        }
        try {
    ...
    public class NotificationListener extends NotificationListenerService {
        public final Map mActiveNotifKeys;
        ...
        public /* synthetic */ void lambda$onNotificationPosted$1(StatusBarNotification statusBarNotification, String str, ConversationInfo conversationInfo) {
            synchronized (this) {
                ((Set) this.mActiveNotifKeys.computeIfAbsent(Pair.create(statusBarNotification.getPackageName(), str), new Function() { // from class: com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda3
        ...
        public /* synthetic */ void lambda$onNotificationRemoved$3(StatusBarNotification statusBarNotification, String str, ConversationInfo conversationInfo) {
            ...
            synchronized (this) {
                Set set = (Set) this.mActiveNotifKeys.computeIfAbsent(create, new Function() { // from class: com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda2
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
    ...
    public void addConversationsListener(PeopleService.ConversationsListener conversationsListener) {
        synchronized (this.mLock) {
            List list = this.mConversationsListeners;
    ...
    public class Injector {
        ...
        public CallLogQueryHelper createCallLogQueryHelper(Context context, BiConsumer biConsumer) {
            return new CallLogQueryHelper(context, biConsumer);
        }

        public MmsQueryHelper createMmsQueryHelper(Context context, BiConsumer biConsumer) {
            return new MmsQueryHelper(context, biConsumer);
        }

        public SmsQueryHelper createSmsQueryHelper(Context context, BiConsumer biConsumer) {
            return new SmsQueryHelper(context, biConsumer);
        }

        public UsageStatsQueryHelper createUsageStatsQueryHelper(int i, Function function, UsageStatsQueryHelper.EventListener eventListener) {
    ...
    public void dump(String[] strArr, IndentingPrintWriter indentingPrintWriter) {
        ...
        for (int i = 0; i < this.mUserDataArray.size(); i++) {
            int keyAt = this.mUserDataArray.keyAt(i);
            indentingPrintWriter.print("UserId : " + keyAt);
            UserData userData = (UserData) this.mUserDataArray.get(keyAt);
            if (userData.isUnlocked()) {
                userData.dump(strArr, indentingPrintWriter);
            }
        }
    }
}
