...
public class ConversationInfo {
    ...
    public static int maybeReadVersion(DataInputStream dataInputStream) {
        try {
    ...
    public class Builder {
        ...
        public Builder setStatuses(List list) {
            this.mCurrStatuses.clear();
            if (list != null) {
                Iterator it = list.iterator();
                while (it.hasNext()) {
                    ConversationStatus conversationStatus = (ConversationStatus) it.next();
