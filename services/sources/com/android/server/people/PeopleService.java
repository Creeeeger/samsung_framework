...
public class PeopleService extends SystemService {
    ...
    public static /* bridge */ /* synthetic */ boolean m9208$$Nest$smisSystemOrRoot() {
    ...
    public PeopleService(Context context) {
        ...
        this.mService = new IPeopleManager.Stub() { // from class: com.android.server.people.PeopleService.1
            ...
            public ParceledListSlice getStatuses(String str, int i, String str2) {
                PeopleService.this.handleIncomingUser(i);
                if (!PeopleService.m9208$$Nest$smisSystemOrRoot()) {
                    PeopleService.this.checkCallerIsSameApp(str);
                }
            ...
            public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
                if (DumpUtils.checkDumpAndUsageStatsPermission(PeopleService.this.getContext(), "PeopleService", printWriter)) {
                    PeopleService.this.dump(strArr, printWriter);
                }
            }
        };
    ...
    public void dump(String[] strArr, PrintWriter printWriter) {
        this.mDataManager.dump(strArr, new IndentingPrintWriter(printWriter, "  "));
    }
