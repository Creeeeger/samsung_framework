...
public class BatteryUsageStatsProvider {
    ...
    public final List getPowerCalculators() {
        synchronized (this.mLock) {
            if (this.mPowerCalculators == null) {
                ...
                this.mPowerCalculators.add(new ScreenPowerCalculator(this.mPowerProfile, this.mStats.hasDisplayPowerReporting()));
                ...
                this.mPowerCalculators.add(new PowerSharingCalculator(this.mPowerProfile));
    ...
    public boolean shouldUpdateStats(List list, long j) {
    ...
    public List getBatteryUsageStats(List list) {
        ...
        synchronized (this.mStats) {
            ...
            for (int i = 0; i < list.size(); i++) {
                arrayList.add(getBatteryUsageStats((BatteryUsageStatsQuery) list.get(i), currentTimeMillis));
            }
        }
        return arrayList;
    }
    ...
    public final BatteryUsageStats getCurrentBatteryUsageStats(BatteryUsageStatsQuery batteryUsageStatsQuery, long j) {
        ...
        int i5 = 0;
        while (i5 < size2) {
            PowerCalculator powerCalculator = (PowerCalculator) powerCalculators.get(i5);
