...
public class BatteryUsageStatsStore {
    public static final List BATTERY_USAGE_STATS_QUERY = List.of(new BatteryUsageStatsQuery.Builder().setMaxStatsAgeMs(0).includePowerModels().includeProcessStateData().build());
    ...
    public final void prepareForBatteryStatsReset(int i) {
        ...
        final List batteryUsageStats = this.mBatteryUsageStatsProvider.getBatteryUsageStats(BATTERY_USAGE_STATS_QUERY);
    ...
    public final File makeSnapshotFilename(long j) {
        return new File(this.mStoreDir, String.format(Locale.ENGLISH, "%019d", Long.valueOf(j)) + ".bus");
    }

    public final void writeXmlFileLocked(BatteryUsageStats batteryUsageStats, File file) {
    ...
    public final BatteryUsageStats readXmlFileLocked(File file) {
