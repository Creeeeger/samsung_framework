...
public final class HintManagerService extends SystemService {
    ...
    final class BinderService extends IHintManager.Stub {
        ...
        public final void logPerformanceHintSessionAtom(int i, long j, long j2, int[] iArr) {
            FrameworkStatsLog.write(FrameworkStatsLog.PERFORMANCE_HINT_SESSION_REPORTED, i, j, j2, iArr.length);
        }
    }
        ...
        public void close() {
            synchronized (HintManagerService.this.mLock) {
                ...
                try {
                    ...
                    Slogf.w("HintManagerService", "Error during unlinkToDeath, UID %d, PID %d", Integer.valueOf(this.mUid), Integer.valueOf(this.mPid));
                }
