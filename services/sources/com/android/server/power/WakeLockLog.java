...
public final class WakeLockLog {
        ...
        try {
            synchronized (this.mLock) {
                ...
                while (allItems.hasNext()) {
                    LogEntry logEntry = (LogEntry) allItems.next();
                    if (logEntry != null) {
                        if (logEntry.type == 0) {
                            i2++;
                        } else {
    ...
    public final void onWakeLockEvent(int i, String str, int i2, int i3) {
        if (str == null) {
            android.util.Slog.w("PowerManagerService.WLLog", "Insufficient data to log wakelock [tag: " + str + ", ownerUid: " + i2 + ", flags: 0x" + Integer.toHexString(i3));
            return;
        }
    ...
    public int translateFlagsFromPowerManager(int i) {
        ...
        if (i2 != 1) {
            ...
            if (i2 == 6) {
                ...
                if (i2 != 128) {
                    android.util.Slog.w("PowerManagerService.WLLog", "Unsupported lock level for logging, flags: " + i);
                    i3 = 0;
                } else {
                    i3 = 7;
                }
    ...
    public class EntryByteTranslator {
            ...
            if (i2 != 0) {
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        android.util.Slog.w("PowerManagerService.WLLog", "Type not recognized [" + i2 + "]", new Exception());
                    }
        ...
        public int toBytes(LogEntry logEntry, byte[] bArr, long j) {
            ...
            if (i == 1) {
                ...
                bArr[2] = (byte) (relativeTime & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                return 3;
            }
            if (i == 2) {
                if (bArr != null && bArr.length >= 2) {
                    ...
                    bArr[1] = (byte) (relativeTime2 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                }
                return 2;
            }
    ...
    public class TheLog {
        ...
        public void addEntry(LogEntry logEntry) {
            ...
            if (bytes > 9 || bytes <= 0) {
                android.util.Slog.w("PowerManagerService.WLLog", "Log entry size is out of expected range: " + bytes);
                return;
            }
            if (makeSpace(bytes)) {
        ...
        public final void removeTagIndex(int i) {
            ...
            while (i2 != this.mEnd) {
                ...
                if (readEntryAt == null) {
                    android.util.Slog.w("PowerManagerService.WLLog", "Entry is unreadable - Unexpected @ " + i2);
                    return;
                }
