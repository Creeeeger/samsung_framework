...
public final /* synthetic */ class ThermalManagerService$ThermalHal10Wrapper$$ExternalSyntheticLambda1 implements IThermal.getTemperaturesCallback {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ boolean f$0;
    public final /* synthetic */ int f$1;
    public final /* synthetic */ List f$2;

    public /* synthetic */ ThermalManagerService$ThermalHal10Wrapper$$ExternalSyntheticLambda1(List list, int i, boolean z, int i2) {
        this.$r8$classId = i2;
        this.f$0 = z;
        this.f$1 = i;
        this.f$2 = list;
                ...
                if (thermalStatus.code != 0) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (!z2 || i2 == temperature2.type) {
                            list2.add(new android.os.Temperature(temperature2.currentValue, temperature2.type, temperature2.name, 0));
                        }
                    }
                    break;
                }
