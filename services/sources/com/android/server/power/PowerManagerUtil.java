...
public abstract class PowerManagerUtil {
    public static final boolean A23X_PROJECT;
    public static final boolean A53X_PROJECT;
    public static final int AUTO_BRIGHTNESS_TYPE;
    public static boolean CAMERA_ADAPTIVE_BRIGHTNESS_SUPPORTED;
    public static final boolean DEBUG_LOW;
    public static final boolean DEBUG_UNKNOWN;
    public static final boolean DIAMOND_PROJECT;
    public static final boolean EUREKA_PROJECT;
    public static final int HBM_LUX;
    public static final boolean PALETTE_PROJECT;
    public static final boolean RAINBOW_PROJECT;
    ...
    public static final boolean SEC_FEATURE_BATTERY_SIMULATION;
    ...
    public static final boolean SEC_FEATURE_FLICKERING_PANEL_WHEN_WAKINGUP_FROM_DOZE;
    ...
    public static final boolean SEC_FEATURE_LCD_SUPPORT_AMOLED_DISPLAY;
    public static final boolean SEC_FEATURE_PAPAYA_DQE;
    public static final boolean SEC_FEATURE_RESTRICTED_DEBUG_LEVEL;
    ...
    public static final boolean USE_PERSONAL_AUTO_BRIGHTNESS;
    ...
    public static final boolean USE_SLOW_AUTO_BRIGHTNESS_CHANGE;
    public static final CharSequence YUVA_FEATURE_ADAPTIVE_BRIGHTNESS_NAME;
    public static final String deviceType;
    public static final String homeHubFeature;
    ...
    public static String displayTypeToString(boolean z) {
        return z ? "main" : "sub";
    }

    public static int getDualScreenPolicy(int i) {
        if (i == 0 || i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    static {
        ...
        A53X_PROJECT = startsWith;
        A23X_PROJECT = trim.startsWith("a23xq");
        ...
        USE_PERSONAL_AUTO_BRIGHTNESS = z5;
        USE_PERSONAL_AUTO_BRIGHTNESS_V3 = parseInt == 4;
        USE_PERSONAL_AUTO_BRIGHTNESS_V4 = parseInt == 5;
        USE_SLOW_AUTO_BRIGHTNESS_CHANGE = z5;
        USE_PERMISSIBLE_RATIO_FOR_LONGTERM_MODEL = !z2;
        boolean equalsIgnoreCase = "Unknown".equalsIgnoreCase(SystemProperties.get("ro.boot.debug_level"));
        DEBUG_UNKNOWN = equalsIgnoreCase;
        boolean equalsIgnoreCase2 = "0x4f4c".equalsIgnoreCase(SystemProperties.get("ro.boot.debug_level"));
        DEBUG_LOW = equalsIgnoreCase2;
        boolean equals = "true".equals(SystemProperties.get("ro.product_ship", "true").trim());
        SHIP_BUILD = equals;
        SEC_FEATURE_USE_PMS_LOG = (equalsIgnoreCase || equalsIgnoreCase2) ? false : true;
        SEC_FEATURE_BATTERY_SIMULATION = (equalsIgnoreCase || equalsIgnoreCase2 || equals) ? false : true;
        SEC_FEATURE_RESTRICTED_DEBUG_LEVEL = (equalsIgnoreCase || equalsIgnoreCase2 || equals) ? false : true;
        ...
        SEC_FEATURE_FLICKERING_PANEL_WHEN_WAKINGUP_FROM_DOZE = contains;
        ...
        SEC_FEATURE_LCD_SUPPORT_AMOLED_DISPLAY = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_LCD_SUPPORT_AMOLED_DISPLAY");
        ...
        boolean z6 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_FRAMEWORK_SUPPORT_FOLDABLE_TYPE_FOLD");
        SEC_FEATURE_FOLD_COVER_DISPLAY = z6;
        boolean z7 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_FRAMEWORK_SUPPORT_FOLDABLE_TYPE_FLIP");
        SEC_FEATURE_FLIP_COVER_DISPLAY = z7;
        ...
        boolean z8 = z6 || z7;
        SEC_FEATURE_DUAL_DISPLAY = z8;
        SEC_FEATURE_HQM_SEND_DPUC = z8 || z || z2 || z3 || z4;
        ...
        YUVA_FEATURE_ADAPTIVE_BRIGHTNESS_NAME = "ADAPTIVE_BRIGHTNESS";
        CAMERA_ADAPTIVE_BRIGHTNESS_SUPPORTED = false;
        ...
        SEC_FEATURE_PAPAYA_DQE = Resources.getSystem().getBoolean(17891662);
        ...
        homeHubFeature = string;
        SEC_FEATURE_HOMEHUB = (string == null || string.isEmpty()) ? false : true;
        SEC_FEATURE_BATTERY_NOTIFY_SCREEN_STATE = Integer.parseInt("33") >= 33;
        ...
        SEC_FEATURE_SUPPORT_HBM = Resources.getSystem().getInteger(R.integer.config_debugSystemServerPssThresholdBytes) != -1;
        HBM_LUX = Resources.getSystem().getInteger(R.integer.config_debugSystemServerPssThresholdBytes);
        USE_SEC_LONG_TERM_MODEL = true;
        sScreenOffProfilers = new RingBuffer(ScreenOffProfiler.class, 100);
        sCurrentScreenOffProfiler = new ScreenOffProfiler();
    ...
    public static void fileWriteInt(String str, int i) {
        Slog.d("PowerManagerUtil", "fileWriteInt to " + str + ", " + i);
        try {
    ...
    public static String callerInfoToString(boolean z) {
        ...
        sb.append(" (uid: " + Binder.getCallingUid() + " pid: " + Binder.getCallingPid() + ")");
        ...
        while (true) {
            if (i < stackTrace.length) {
                if (!stackTrace[i].getClassName().contains("dalvik.system.VMStack") && !stackTrace[i].getClassName().contains("java.lang.Thread") && !stackTrace[i].getClassName().contains("com.android.server.power.PowerManagerUtil") && !stackTrace[i].getClassName().contains("com.android.server.power.PowerManagerService") && !stackTrace[i].getClassName().contains("android.os.PowerManager")) {
                    sb.append(" <- " + stackTrace[i].getMethodName() + "() in " + stackTrace[i].getClassName() + XmlUtils.STRING_ARRAY_SEPARATOR + stackTrace[i].getLineNumber());
                    break;
                }
                i++;
            } else {
    ...
    public static String callerInfoToString() {
        return callerInfoToString(false);
    }
    ...
    public static String floatArrayPairToString(float[] fArr, float[] fArr2) {
    ...
    public final class StopwatchLogger {
        ...
        public static StopwatchLogger start() {
        ...
        public void dk(String str, String str2) {
            Slog.dk(str, formatTookTime(str2, elapsedTimeMillis()));
        }

        public void d(String str, String str2) {
            Slog.d(str, formatTookTime(str2, elapsedTimeMillis()));
        }

        public final String formatTookTime(String str, long j) {
            return str + " took " + j + " ms";
        }
    ...
    public abstract class Country {
        ...
        static {
            String upperCase = SystemProperties.get("ro.csc.countryiso_code", "NONE").trim().toUpperCase();
            COUNTRY_CODE = upperCase;
            CHINA = "CN".equals(upperCase);
            US = "US".equals(upperCase);
        }
    }

    /* loaded from: classes3.dex */
    public class ScreenOffProfiler {
        public int mCfAnimationDuration;
        public long mCfAnimationEndTime;
        public long mCfAnimationStartTime;
        public int mCfPrepareDuration;
        public long mCfPrepareEndTime;
        ...
        public long mGoToSleepEndTime;
        public long mGoToSleepStartTime;
        public String mGoToSleepTimeStr;
        public int mOrder;
        public boolean mSaved;

        public ScreenOffProfiler() {
            clearAll();
        }

        public ScreenOffProfiler(ScreenOffProfiler screenOffProfiler) {
            this.mOrder = screenOffProfiler.mOrder;
            this.mDone = screenOffProfiler.mDone;
            this.mGoToSleepDiff = screenOffProfiler.mGoToSleepDiff;
            this.mGoToSleepTimeStr = screenOffProfiler.mGoToSleepTimeStr;
            this.mGoToSleepStartTime = screenOffProfiler.mGoToSleepStartTime;
            this.mGoToSleepEndTime = screenOffProfiler.mGoToSleepEndTime;
            this.mGoToSleepDuration = screenOffProfiler.mGoToSleepDuration;
            this.mCfPrepareStartTime = screenOffProfiler.mCfPrepareStartTime;
            this.mCfPrepareEndTime = screenOffProfiler.mCfPrepareEndTime;
            this.mCfPrepareDuration = screenOffProfiler.mCfPrepareDuration;
            this.mCfAnimationStartTime = screenOffProfiler.mCfAnimationStartTime;
            this.mCfAnimationEndTime = screenOffProfiler.mCfAnimationEndTime;
            this.mCfAnimationDuration = screenOffProfiler.mCfAnimationDuration;
            this.mDisplayStartTime = screenOffProfiler.mDisplayStartTime;
            this.mDisplayEndTime = screenOffProfiler.mDisplayEndTime;
            this.mDisplayDuration = screenOffProfiler.mDisplayDuration;
            this.mSaved = screenOffProfiler.mSaved;
        }
        ...
        public void clearAll() {
            ...
            this.mGoToSleepEndTime = 0L;
            this.mGoToSleepDuration = 0;
            this.mCfPrepareStartTime = 0L;
            this.mCfPrepareEndTime = 0L;
            this.mCfPrepareDuration = 0;
            this.mCfAnimationStartTime = 0L;
            this.mCfAnimationEndTime = 0L;
            this.mCfAnimationDuration = 0;
            this.mDisplayStartTime = 0L;
            this.mDisplayEndTime = 0L;
            this.mDisplayDuration = 0;
            this.mSaved = false;
        }

        public boolean isStarted() {
            return this.mGoToSleepStartTime != 0;
        }

        public void noteGoToSleepDiff(int i) {
            this.mGoToSleepDiff = i;
        }

        public void noteGoToSleepStart(int i) {
            this.mOrder = i;
            this.mGoToSleepStartTime = SystemClock.uptimeMillis();
            this.mGoToSleepTimeStr = PowerManagerUtil.getCurrentTimeAsString();
        }

        public void noteGoToSleepEnd() {
            this.mDone = true;
            this.mGoToSleepEndTime = SystemClock.uptimeMillis();
            calcGoToSleepDuration();
        }

        public void calcGoToSleepDuration() {
            this.mGoToSleepDuration = (int) (this.mGoToSleepEndTime - this.mGoToSleepStartTime);
        }

        public void noteCfPrepareStart() {
            this.mCfPrepareStartTime = SystemClock.uptimeMillis();
        }

        public void noteCfPrepareEnd() {
            this.mCfPrepareEndTime = SystemClock.uptimeMillis();
            calcCfPrepareDuration();
        }

        public void calcCfPrepareDuration() {
            this.mCfPrepareDuration = (int) (this.mCfPrepareEndTime - this.mCfPrepareStartTime);
        }

        public void noteCfAnimationStart() {
            this.mCfAnimationStartTime = SystemClock.uptimeMillis();
        }

        public void noteCfAnimationEnd() {
            this.mCfAnimationEndTime = SystemClock.uptimeMillis();
            calcCfAnimationDuration();
            if (this.mDone) {
                return;
            }
            noteGoToSleepEnd();
        ...
        public void calcCfAnimationDuration() {
            this.mCfAnimationDuration = (int) (this.mCfAnimationEndTime - this.mCfAnimationStartTime);
        }

        public void noteDisplayStart() {
            this.mDisplayStartTime = SystemClock.uptimeMillis();
        }

        public void noteDisplayEnd() {
            this.mDisplayEndTime = SystemClock.uptimeMillis();
            calcDisplayDuration();
            if (this.mDone) {
                return;
            }
        ...
        public void calcDisplayDuration() {
            this.mDisplayDuration = (int) (this.mDisplayEndTime - this.mDisplayStartTime);
        }
    ...
    public class ScreenOnProfiler {
        ...
        public static HandlerThread mHandlerThread = null;
        public static boolean sInitialized = false;
        public int mDisplayDuration;
        public long mDisplayEndTime;
        public long mDisplayStartTime;
        public final Runnable mFrameCheckerRunnable = new Runnable() { // from class: com.android.server.power.PowerManagerUtil.ScreenOnProfiler.1
            @Override // java.lang.Runnable
            public void run() {
                long frameTimeFromDriver = ScreenOnProfiler.this.getFrameTimeFromDriver();
                ...
                ScreenOnProfiler.this.mFrameEndTime = frameTimeFromDriver;
                ScreenOnProfiler.this.noteFrameEnd();
            }
        };
        ...
        public ScreenOnProfiler(ScreenOnProfiler screenOnProfiler) {
            ...
            this.mWmsEndTime = screenOnProfiler.mWmsEndTime;
        ...
        public boolean isStarted() {
            return this.mWakeUpStartTime != 0;
        }

        public void noteWakeupDiff(int i) {
            this.mWakeUpDiff = i;
        }

        public void noteWakeupStart(int i) {
            this.mOrder = i;
            this.mWakeUpStartTime = SystemClock.uptimeMillis();
            this.mWakeUpTimeStr = PowerManagerUtil.getCurrentTimeAsString();
        }

        public void noteWakeupEnd() {
            this.mWakeUpEndTime = SystemClock.uptimeMillis();
            calcWakeupDuration();
            ScreenOnProfiler screenOnProfiler = PowerManagerUtil.sCurrentScreenOnProfiler;
            if (!screenOnProfiler.isStarted() || screenOnProfiler.mSaved) {
                return;
            }
        ...
        public void calcWakeupDuration() {
            this.mWakeUpDuration = (int) (this.mWakeUpEndTime - this.mWakeUpStartTime);
        }

        public void noteWmsStart() {
            this.mWmsStartTime = SystemClock.uptimeMillis();
        }

        public void noteWmsEnd() {
            this.mWmsEndTime = SystemClock.uptimeMillis();
            this.mWmsDone = true;
            calcWmsDuration();
            if (this.mFrameDone) {
                noteWakeupEnd();
        ...
        public void calcWmsDuration() {
            if (this.mWmsStartTime == 0) {
                this.mWmsStartTime = this.mWakeUpStartTime;
            }
            this.mWmsDuration = (int) (this.mWmsEndTime - this.mWmsStartTime);
        }

        public void noteDisplayStart(int i) {
            this.mDisplayStartTime = SystemClock.uptimeMillis();
            if (CHECK_FRAME) {
                mFramePrevTime = getFrameTimeFromDriver();
            }
            if (i != 1) {
                mFramePass = true;
            }
        ...
        public void calcDisplayDuration() {
            if (this.mDisplayStartTime == 0) {
                this.mDisplayStartTime = this.mWakeUpStartTime;
            }
            this.mDisplayDuration = (int) (this.mDisplayEndTime - this.mDisplayStartTime);
        }

        public void noteListenerStart() {
            this.mListenerStartTime = SystemClock.uptimeMillis();
        }

        public void noteListenerEnd() {
            this.mListenerEndTime = SystemClock.uptimeMillis();
            calcListenerDuration();
        }

        public void calcListenerDuration() {
            this.mListenerDuration = (int) (this.mListenerEndTime - this.mListenerStartTime);
        }

        public void noteFrameStart(int i) {
        ...
        public void noteFrameEnd() {
            ...
            if (j >= j2) {
                this.mFrameDuration = (int) (j - j2);
            } else {
                this.mFrameDuration = -2;
            }
            if (this.mWmsDone || this.mWmsStartTime == 0) {
                noteWakeupEnd();
            }
        ...
        public long getFrameTimeFromDriver() {
            String readFromFile;
            int i = mDisplayType;
            if (i == 1) {
                ...
                Slog.d("PowerManagerUtil", "Display Type err = " + mDisplayType);
                readFromFile = "";
            }
            if (readFromFile == null) {
                ...
                try {
                    ...
                    Slog.d("PowerManagerUtil", "/sys/class/lcd/panel/display_on or /sys/class/lcd/panel1/display_on data is " + readFromFile);
                }
            }
            return -1L;
        }

        public void disableFrameCheck() {
            CHECK_FRAME = false;
