...
public abstract class InputMethodUtils {
    ...
    public static void setNonSelectedSystemImesDisabledUntilUsed(PackageManager packageManager, List list) {
        boolean z;
        String[] stringArray = Resources.getSystem().getStringArray(17236173);
    ...
    public class InputMethodSettings {
        ...
        public static List buildInputMethodsAndSubtypeList(String str, TextUtils.SimpleStringSplitter simpleStringSplitter, TextUtils.SimpleStringSplitter simpleStringSplitter2) {
        ...
        public List getEnabledInputMethodSubtypeListLocked(InputMethodInfo inputMethodInfo, boolean z) {
            List enabledInputMethodSubtypeListLocked = getEnabledInputMethodSubtypeListLocked(inputMethodInfo);
        ...
        public boolean buildAndPutEnabledInputMethodsStrRemovingIdLocked(StringBuilder sb, List list, String str) {
        ...
        public final ArrayList createEnabledInputMethodListLocked(List list, Predicate predicate) {
            ...
            Iterator it = list.iterator();
            while (it.hasNext()) {
                InputMethodInfo inputMethodInfo = (InputMethodInfo) this.mMethodMap.get(((Pair) it.next()).first);
        ...
        public InputMethodSubtype getLastInputMethodSubtypeLocked() {
            ...
            if (lastInputMethodAndSubtypeLocked == null || TextUtils.isEmpty((CharSequence) lastInputMethodAndSubtypeLocked.first) || TextUtils.isEmpty((CharSequence) lastInputMethodAndSubtypeLocked.second) || (inputMethodInfo = (InputMethodInfo) this.mMethodMap.get(lastInputMethodAndSubtypeLocked.first)) == null) {
                return null;
            }
            try {
        ...
        public String getLastSubtypeForInputMethodLocked(String str) {
            Pair lastSubtypeForInputMethodLockedInternal = getLastSubtypeForInputMethodLockedInternal(str);
        ...
        public final String getEnabledSubtypeHashCodeForInputMethodAndSubtypeLocked(List list, String str, String str2) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                Pair pair = (Pair) it.next();
                if (((String) pair.first).equals(str)) {
                    ...
                    if (arrayList.size() == 0) {
                        if (inputMethodInfo != null && inputMethodInfo.getSubtypeCount() > 0) {
                            ArrayList implicitlyApplicableSubtypesLocked = SubtypeUtils.getImplicitlyApplicableSubtypesLocked(this.mRes, inputMethodInfo);
        ...
        public void putSelectedInputMethod(String str) {
            Slog.d("InputMethodUtils", "putSelectedInputMethodStr: " + str + ", userId : " + this.mCurrentUserId + ", callers : " + Debug.getCallers(10));
        ...
        public boolean isShowImeWithHardKeyboardEnabled() {
            ...
            if (this.mCurrentUserId == 0) {
                return Settings.Secure.getIntForUser(this.mResolver, "show_ime_with_hard_keyboard", i, 0) == 1;
            }
            return getBoolean("show_ime_with_hard_keyboard", false);
        }

        public void setShowImeWithHardKeyboard(boolean z) {
            Slog.i("InputMethodUtils", "setShowImeWithHardKeyboard show = " + z + ", callers= " + Debug.getCallers(3));
        ...
        public InputMethodSubtype getCurrentInputMethodSubtypeForNonCurrentUsers() {
            ...
            if (selectedInputMethod == null || (inputMethodInfo = (InputMethodInfo) this.mMethodMap.get(selectedInputMethod)) == null || inputMethodInfo.getSubtypeCount() == 0) {
                return null;
            }
            ...
            List enabledInputMethodSubtypeListLocked = getEnabledInputMethodSubtypeListLocked(inputMethodInfo, true);
        ...
        public boolean setAdditionalInputMethodSubtypes(String str, ArrayList arrayList, ArrayMap arrayMap, PackageManagerInternal packageManagerInternal, int i) {
            InputMethodInfo inputMethodInfo = (InputMethodInfo) this.mMethodMap.get(str);
