    ...
    public static BlobAccessMode createFromXml(XmlPullParser xmlPullParser) {
        ...
        while (XmlUtils.nextElementWithin(xmlPullParser, depth)) {
            if ("wl".equals(xmlPullParser.getName())) {
                blobAccessMode.allowPackageAccess(XmlUtils.readStringAttribute(xmlPullParser, KnoxAnalyticsDataConverter.PAYLOAD), XmlUtils.readByteArrayAttribute(xmlPullParser, "ct"));
            }
        }
