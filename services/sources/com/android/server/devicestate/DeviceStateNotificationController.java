...
public class DeviceStateNotificationController extends BroadcastReceiver {
    ...
    public void showStateActiveNotificationIfNeeded(int i, int i2) {
        ...
        if (applicationLabel != null) {
            showNotification(notificationInfo.name, notificationInfo.activeNotificationTitle, String.format(notificationInfo.activeNotificationContent, applicationLabel), true, R.drawable.ic_lockscreen_emergencycall_normal, PendingIntent.getBroadcast(this.mContext, 0, new Intent(INTENT_ACTION_CANCEL_STATE).setPackage(this.mContext.getPackageName()), 67108864), this.mContext.getString(R.string.locale_search_menu));
        } else {
    ...
    public void showThermalCriticalNotificationIfNeeded(int i) {
        ...
        showNotification(notificationInfo.name, notificationInfo.thermalCriticalNotificationTitle, notificationInfo.thermalCriticalNotificationContent, false, R.drawable.list_choice_background_material, null, null);
    }
    ...
    public void showPowerSaveNotificationIfNeeded(int i) {
        ...
        showNotification(notificationInfo.name, notificationInfo.powerSaveModeNotificationTitle, notificationInfo.powerSaveModeNotificationContent, false, R.drawable.list_choice_background_material, PendingIntent.getActivity(this.mContext, 0, new Intent("android.settings.BATTERY_SAVER_SETTINGS"), 67108864), this.mContext.getString(R.string.locale_replacement));
    }
