...
public class WallpaperEffectsGenerationManagerService extends AbstractMasterSystemService {
    ...
    public WallpaperEffectsGenerationManagerService(Context context) {
        super(context, new FrameworkResourcesServiceNameResolver(context, R.string.face_authenticated_confirmation_required), null, 17);
    ...
    public void onServicePackageUpdatedLocked(int i) {
        ...
        if (wallpaperEffectsGenerationPerUserService != null) {
            wallpaperEffectsGenerationPerUserService.onPackageUpdatedLocked();
        }
    }
    ...
    public void onServicePackageRestartedLocked(int i) {
        WallpaperEffectsGenerationPerUserService wallpaperEffectsGenerationPerUserService = (WallpaperEffectsGenerationPerUserService) peekServiceForUserLocked(i);
        if (wallpaperEffectsGenerationPerUserService != null) {
            wallpaperEffectsGenerationPerUserService.onPackageRestartedLocked();
        }
    }
