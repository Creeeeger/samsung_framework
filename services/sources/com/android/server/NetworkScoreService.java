...
public class NetworkScoreService extends INetworkScoreService.Stub {
    ...
    static {
        ...
        VERBOSE = Build.IS_DEBUGGABLE && Log.isLoggable("NetworkScoreService", 2);
    }
    ...
    public class DispatchingContentObserver extends ContentObserver {
        ...
        public void onChange(boolean z, Uri uri) {
            ...
            Integer num = (Integer) this.mUriEventMap.get(uri);
            if (num != null) {
        ...
        try {
            ...
            while (true) {
                ...
                synchronized (this.mScoreCaches) {
                    remoteCallbackList = (RemoteCallbackList) this.mScoreCaches.get(entry.getKey());
    ...
    class FilteringCacheUpdatingConsumer implements BiConsumer {
        ...
        public static FilteringCacheUpdatingConsumer create(Context context, List list, int i) {
        ...
        public void accept(INetworkScoreCache iNetworkScoreCache, Object obj) {
            try {
                List filterScores = filterScores(this.mScoredNetworkList, obj instanceof Integer ? ((Integer) obj).intValue() : 0);
        ...
        public final List filterScores(List list, int i) {
            if (i == 0) {
                return list;
            }
            if (i == 1) {
    ...
    /* loaded from: classes.dex */
    public class WifiInfoSupplier implements Supplier {
        public final Context mContext;
    ...
    /* loaded from: classes.dex */
    public class ScanResultsSupplier implements Supplier {
        public final Context mContext;
    ...
    /* loaded from: classes.dex */
    public class CurrentNetworkScoreCacheFilter implements UnaryOperator {
        public final NetworkKey mCurrentNetwork;

        public CurrentNetworkScoreCacheFilter(Supplier supplier) {
            this.mCurrentNetwork = NetworkKey.createFromWifiInfo((WifiInfo) supplier.get());
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public class ScanResultsScoreCacheFilter implements UnaryOperator {
        public final Set mScanResultKeys;

        public ScanResultsScoreCacheFilter(Supplier supplier) {
    ...
    public final void enforceSystemOnly() {
    ...
    public final void enforceSystemOrHasScoreNetworks() {
    ...
    public final void enforceSystemOrIsActiveScorer(int i) {
    ...
    public final void clearInternal() {
        sendCacheUpdateCallback(new BiConsumer() { // from class: com.android.server.NetworkScoreService.4
            @Override // java.util.function.BiConsumer
            public void accept(INetworkScoreCache iNetworkScoreCache, Object obj) {
                try {
    ...
    public void registerNetworkScoreCache(int i, INetworkScoreCache iNetworkScoreCache, int i2) {
        ...
        try {
            synchronized (this.mScoreCaches) {
                RemoteCallbackList remoteCallbackList = (RemoteCallbackList) this.mScoreCaches.get(Integer.valueOf(i));
    ...
    public final Collection getScoreCacheLists() {
        ArrayList arrayList;
        synchronized (this.mScoreCaches) {
    ...
    public final void sendCacheUpdateCallback(BiConsumer biConsumer, Collection collection) {
