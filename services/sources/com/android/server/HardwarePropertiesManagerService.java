...
public class HardwarePropertiesManagerService extends IHardwarePropertiesManager.Stub {
    ...
    public float[] getDeviceTemperatures(String str, int i, int i2) {
    ...
    public CpuUsageInfo[] getCpuUsages(String str) {
    ...
    public float[] getFanSpeeds(String str) {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        if (DumpUtils.checkDumpPermission(this.mContext, "HardwarePropertiesManagerService", printWriter)) {
            ...
            printWriter.println("Fan speed: " + Arrays.toString(getFanSpeeds(callingPackageName)) + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
