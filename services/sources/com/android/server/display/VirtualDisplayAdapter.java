...
public class VirtualDisplayAdapter extends DisplayAdapter {
    ...
    public final class VirtualDisplayDevice extends DisplayDevice implements IBinder.DeathRecipient {
        ...
        public Point getDisplaySurfaceDefaultSizeLocked() {
            ...
            if (!surface.isValid()) {
                Slog.e("VirtualDisplayAdapter", "getDisplaySurfaceDefaultSizeLocked: failed, invalid surface, info=" + this.mInfo);
                return null;
            }
        ...
        public void setSurfaceLocked(Surface surface) {
            ...
            if (displayLocked != null) {
                VirtualDisplayAdapter.this.mHandler.sendMessage(VirtualDisplayAdapter.this.mHandler.obtainMessage(30, displayLocked.getDisplayIdLocked(), 0));
            }
        }
            ...
            if (this.mInfo == null) {
                ...
                if ((i8 & 262144) != 0) {
                    ...
                    if (VirtualDisplayAdapter.this.mDefaultDeviceInfo != null) {
                        this.mInfo.hdrCapabilities = VirtualDisplayAdapter.this.mDefaultDeviceInfo.hdrCapabilities;
                        this.mInfo.supportedColorModes = VirtualDisplayAdapter.this.mDefaultDeviceInfo.supportedColorModes;
                    }
                }
                ...
                displayDeviceInfo9.displayShape = DisplayShape.createDefaultDisplayShape(displayDeviceInfo9.width, displayDeviceInfo9.height, false);
            }
            return this.mInfo;
        }
