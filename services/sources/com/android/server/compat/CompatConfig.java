...
public final class CompatConfig {
    ...
    public final boolean addOverrideUnsafe(final long j, String str, PackageOverride packageOverride) {
        ...
        ((CompatChange) this.mChanges.computeIfAbsent(Long.valueOf(j), new Function() { // from class: com.android.server.compat.CompatConfig$$ExternalSyntheticLambda0
    ...
    public boolean registerListener(final long j, CompatChange.ChangeListener changeListener) {
        final AtomicBoolean atomicBoolean = new AtomicBoolean(true);
        ((CompatChange) this.mChanges.computeIfAbsent(Long.valueOf(j), new Function() { // from class: com.android.server.compat.CompatConfig$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    public void dumpConfig(PrintWriter printWriter) {
        ...
        Iterator it = this.mChanges.values().iterator();
        while (it.hasNext()) {
            printWriter.println(((CompatChange) it.next()).toString());
        }
    }
    ...
    public void initOverrides(File file, File file2) {
        Iterator it = this.mChanges.values().iterator();
        while (it.hasNext()) {
            ((CompatChange) it.next()).clearOverrides();
        }
        loadOverrides(file2);
            ...
            try {
                ...
                try {
                    ...
                    for (ChangeOverrides changeOverrides : read.getChangeOverrides()) {
                        ...
                        CompatChange compatChange = (CompatChange) this.mChanges.get(Long.valueOf(changeId));
                        if (compatChange == null) {
