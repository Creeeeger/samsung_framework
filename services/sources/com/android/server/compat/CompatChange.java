...
public final class CompatChange extends CompatibilityChangeInfo {
    public ConcurrentHashMap mEvaluatedOverrides;
    public ChangeListener mListener;
    public ConcurrentHashMap mRawOverrides;
    ...
    public boolean willBeEnabled(String str) {
        ...
        PackageOverride packageOverride = (PackageOverride) this.mRawOverrides.get(str);
    ...
    public synchronized ChangeOverrides saveOverrides() {
        ...
        for (Map.Entry entry : this.mRawOverrides.entrySet()) {
            ...
            rawOverrideValue2.setPackageName((String) entry.getKey());
            rawOverrideValue2.setMinVersionCode(((PackageOverride) entry.getValue()).getMinVersionCode());
            rawOverrideValue2.setMaxVersionCode(((PackageOverride) entry.getValue()).getMaxVersionCode());
            rawOverrideValue2.setEnabled(((PackageOverride) entry.getValue()).isEnabled());
        ...
        List overrideValue = validated.getOverrideValue();
        for (Map.Entry entry2 : this.mEvaluatedOverrides.entrySet()) {
            OverrideValue overrideValue2 = new OverrideValue();
            overrideValue2.setPackageName((String) entry2.getKey());
            overrideValue2.setEnabled(((Boolean) entry2.getValue()).booleanValue());
