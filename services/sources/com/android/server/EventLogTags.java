...
public abstract class EventLogTags {
    ...
    public static void writeNotificationEnqueue(int i, int i2, String str, int i3, String str2, int i4, String str3, int i5, String str4) {
        EventLog.writeEvent(2750, Integer.valueOf(i), Integer.valueOf(i2), str, Integer.valueOf(i3), str2, Integer.valueOf(i4), str3, Integer.valueOf(i5), str4);
    }
    ...
    public static void writeNotificationEnqueueToast(int i, String str, String str2) {
        EventLog.writeEvent(275535, Integer.valueOf(i), str, str2);
    }
    ...
    public static void writeSecDisableNet() {
        EventLog.writeEvent(40201, new Object[0]);
    }

    public static void writeSecEnableNet() {
        EventLog.writeEvent(40202, new Object[0]);
    }

    public static void writeSecEnableNetByCharging() {
        EventLog.writeEvent(40204, new Object[0]);
    }

    public static void writeSecDisableNetByUncharging() {
        EventLog.writeEvent(40205, new Object[0]);
    }
}
