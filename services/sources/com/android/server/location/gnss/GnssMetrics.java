...
public class GnssMetrics {
    ...
    public final void registerGnssStats() {
        ...
        this.mStatsManager.setPullAtomCallback(FrameworkStatsLog.GNSS_STATS, (StatsManager.PullAtomMetadata) null, ConcurrentUtils.DIRECT_EXECUTOR, statsPullAtomCallbackImpl);
        this.mStatsManager.setPullAtomCallback(FrameworkStatsLog.GNSS_POWER_STATS, (StatsManager.PullAtomMetadata) null, ConcurrentUtils.DIRECT_EXECUTOR, statsPullAtomCallbackImpl);
    }
