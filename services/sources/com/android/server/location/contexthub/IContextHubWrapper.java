...
public abstract class IContextHubWrapper {
    ...
    public interface ICallback {
        ...
        void handleNanoappInfo(List list);

        void handleNanoappMessage(short s, NanoAppMessage nanoAppMessage, List list, List list2);
    ...
    public abstract int disableNanoapp(int i, long j, int i2);

    public abstract int enableNanoapp(int i, long j, int i2);
    ...
    public abstract void registerCallback(int i, ICallback iCallback);
    ...
    public abstract int unloadNanoapp(int i, long j, int i2);
    ...
    */
    public static com.android.server.location.contexthub.IContextHubWrapper maybeConnectTo1_0() {
        /*
            java.lang.String r0 = "IContextHubWrapper"
            r1 = 1
            r2 = 0
            android.hardware.contexthub.V1_0.IContexthub r0 = android.hardware.contexthub.V1_0.IContexthub.getService(r1)     // Catch: java.util.NoSuchElementException -> L9 android.os.RemoteException -> Lf
            goto L16
        L9:
            java.lang.String r1 = "Context Hub HAL service not found"
            android.util.Log.i(r0, r1)
            goto L15
        Lf:
            r1 = move-exception
            java.lang.String r3 = "RemoteException while attaching to Context Hub HAL proxy"
        ...
        L16:
            ...
            goto L1e
        L19:
            com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_0 r2 = new com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_0
            r2.<init>(r0)
        L1e:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.location.contexthub.IContextHubWrapper.maybeConnectTo1_0():com.android.server.location.contexthub.IContextHubWrapper");
    }
    ...
    */
    public static com.android.server.location.contexthub.IContextHubWrapper maybeConnectTo1_1() {
        /*
            ...
            r1 = 1
            r2 = 0
            android.hardware.contexthub.V1_1.IContexthub r0 = android.hardware.contexthub.V1_1.IContexthub.getService(r1)     // Catch: java.util.NoSuchElementException -> L9 android.os.RemoteException -> Lf
            goto L16
        L9:
            java.lang.String r1 = "Context Hub HAL service not found"
            android.util.Log.i(r0, r1)
        ...
        L16:
            ...
            goto L1e
        L19:
            com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_1 r2 = new com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_1
            r2.<init>(r0)
        L1e:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.location.contexthub.IContextHubWrapper.maybeConnectTo1_1():com.android.server.location.contexthub.IContextHubWrapper");
    }
    ...
    */
    public static com.android.server.location.contexthub.IContextHubWrapper maybeConnectTo1_2() {
        /*
            ...
            r1 = 1
            r2 = 0
            android.hardware.contexthub.V1_2.IContexthub r0 = android.hardware.contexthub.V1_2.IContexthub.getService(r1)     // Catch: java.util.NoSuchElementException -> L9 android.os.RemoteException -> Lf
            goto L16
        L9:
            java.lang.String r1 = "Context Hub HAL service not found"
            android.util.Log.i(r0, r1)
        ...
        L16:
            ...
            goto L1e
        L19:
            com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_2 r2 = new com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperV1_2
            r2.<init>(r0)
        L1e:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.location.contexthub.IContextHubWrapper.maybeConnectTo1_2():com.android.server.location.contexthub.IContextHubWrapper");
    }
    ...
    /* loaded from: classes2.dex */
    public class ContextHubWrapperAidl extends IContextHubWrapper implements IBinder.DeathRecipient {
        ...
        public class ContextHubAidlCallback extends IContextHubCallback.Stub {
            ...
            public void handleNanoappInfo(NanoappInfo[] nanoappInfoArr) {
                final List createNanoAppStateList = ContextHubServiceUtil.createNanoAppStateList(nanoappInfoArr);
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int sendMessageToContextHub(short s, int i, NanoAppMessage nanoAppMessage) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int loadNanoapp(int i, NanoAppBinary nanoAppBinary, int i2) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int unloadNanoapp(int i, long j, int i2) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int enableNanoapp(int i, long j, int i2) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int disableNanoapp(int i, long j, int i2) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public int queryNanoapps(int i) {
            IContextHub hub = getHub();
            if (hub == null) {
                return 2;
            }
        ...
        public void registerExistingCallback(int i) {
            ...
            ContextHubAidlCallback contextHubAidlCallback = (ContextHubAidlCallback) this.mAidlCallbackMap.get(Integer.valueOf(i));
    ...
    public abstract class ContextHubWrapperHidl extends IContextHubWrapper {
        ...
        public class ContextHubWrapperHidlCallback extends IContexthubCallback.Stub {
            ...
            public void handleAppsInfo(ArrayList arrayList) {
                handleAppsInfo_1_2(ContextHubServiceUtil.toHubAppInfo_1_2(arrayList));
            }

            public void handleClientMsg_1_2(android.hardware.contexthub.V1_2.ContextHubMsg contextHubMsg, ArrayList arrayList) {
            ...
            public void handleAppsInfo_1_2(ArrayList arrayList) {
        ...
        public void registerCallback(int i, ICallback iCallback) {
            ...
            this.mHub.registerCallback(i, (android.hardware.contexthub.V1_0.IContexthubCallback) this.mHidlCallbackMap.get(Integer.valueOf(i)));
        }

        @Override // com.android.server.location.contexthub.IContextHubWrapper
        public void registerExistingCallback(int i) {
            ContextHubWrapperHidlCallback contextHubWrapperHidlCallback = (ContextHubWrapperHidlCallback) this.mHidlCallbackMap.get(Integer.valueOf(i));
    ...
    /* loaded from: classes2.dex */
    public class ContextHubWrapperV1_0 extends ContextHubWrapperHidl {
        public IContexthub mHub;
    ...
    /* loaded from: classes2.dex */
    public class ContextHubWrapperV1_1 extends ContextHubWrapperHidl {
    ...
    /* loaded from: classes2.dex */
    public class ContextHubWrapperV1_2 extends ContextHubWrapperHidl implements IContexthub.getHubs_1_2Callback {
        ...
        public void onValues(ArrayList arrayList, ArrayList arrayList2) {
        ...
        public void registerCallback(int i, ICallback iCallback) {
            ...
            this.mHub.registerCallback_1_2(i, (IContexthubCallback) this.mHidlCallbackMap.get(Integer.valueOf(i)));
        }
