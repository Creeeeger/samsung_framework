...
public class ContextHubService extends IContextHubService.Stub {
    ...
    public Set mMetricQueryPendingContextHubIds = Collections.newSetFromMap(new ConcurrentHashMap());
    ...
    public class ContextHubServiceCallback implements IContextHubWrapper.ICallback {
        ...
        @Override // com.android.server.location.contexthub.IContextHubWrapper.ICallback
        public void handleNanoappMessage(short s, NanoAppMessage nanoAppMessage, List list, List list2) {
