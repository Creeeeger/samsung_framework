...
public class ProxyLocationProvider extends AbstractLocationProvider implements ServiceWatcher.ServiceListener {
    ...
    public ProxyLocationProvider(Context context, String str, String str2, int i, int i2, Injector injector) {
        ...
        this.mServiceWatcher = ServiceWatcher.create(context, str, CurrentUserServiceSupplier.createFromConfig(context, str2, i, i2), this, injector);
        this.mName = str;
        this.mProxy = null;
    ...
    public static /* synthetic */ void lambda$onSetRequest$0(ProviderRequest providerRequest, IBinder iBinder) {
    ...
    public static /* synthetic */ void lambda$onExtraCommand$1(String str, Bundle bundle, IBinder iBinder) {
