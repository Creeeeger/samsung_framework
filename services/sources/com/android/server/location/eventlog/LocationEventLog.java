...
public class LocationEventLog extends LocalEventLog {
    ...
    public ArrayMap copyAggregateStats() {
        ArrayMap arrayMap;
        synchronized (this.mAggregateStats) {
            arrayMap = new ArrayMap(this.mAggregateStats);
            for (int i = 0; i < arrayMap.size(); i++) {
                arrayMap.setValueAt(i, new ArrayMap((ArrayMap) arrayMap.valueAt(i)));
            }
        }
        return arrayMap;
    }
    ...
    public synchronized void iterate(LocalEventLog.LogConsumer logConsumer) {
    ...
    public void iterate(final Consumer consumer, final String str) {
    ...
    /* loaded from: classes2.dex */
    public final class ProviderClientForegroundEvent extends ProviderEvent {
    ...
    /* loaded from: classes2.dex */
    public final class ProviderStationaryThrottledEvent extends ProviderEvent {
        public final ProviderRequest mRequest;
    ...
    /* loaded from: classes2.dex */
    public final class LocationAdasEnabledEvent {
        public final boolean mEnabled;
        public final int mUserId;
