...
public abstract class SettingsHelper {
    ...
    public abstract Set getBackgroundThrottlePackageWhitelist();
    ...
    public abstract boolean isBackgroundThrottlingAllowlistByNsflp(String str);
    ...
    public abstract void updateBackgroundThrottlingAllowlist(List list);
