...
public interface EconomyManagerInternal {
    ...
    /* loaded from: classes3.dex */
    public final class AnticipatedAction {
    ...
    /* loaded from: classes3.dex */
    public final class ActionBill {
        public static final Comparator sAnticipatedActionComparator = Comparator.comparingInt(new ToIntFunction() { // from class: com.android.server.tare.EconomyManagerInternal$ActionBill$$ExternalSyntheticLambda0
        ...
        public final List mAnticipatedActions;
        public final int mHashCode;

        public ActionBill(List list) {
            ...
            for (int i2 = 0; i2 < this.mAnticipatedActions.size(); i2++) {
                i = (i * 31) + ((AnticipatedAction) this.mAnticipatedActions.get(i2)).hashCode();
            }
            this.mHashCode = i;
        }

        public List getAnticipatedActions() {
