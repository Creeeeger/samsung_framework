...
public class InternalResourceService extends SystemService {
    ...
    public ArraySet mExemptedApps;
    public final Handler mHandler;
    public volatile boolean mHasBattery;
    public final SparseArrayMap mInstallers;
    public final Object mLock;
    public final PackageManager mPackageManager;
    public final PackageManagerInternal mPackageManagerInternal;
    public final SparseArrayMap mPackageToUidCache;
    public final SparseArrayMap mPkgCache;
    public final SparseSetArray mRestrictedApps;
    public final Scribe mScribe;
    public final SparseSetArray mStateChangeListeners;
    public final UsageStatsManagerInternal.UsageEventListener mSurveillanceAgent;
    public int mTargetBackgroundBatteryLifeHours;
    public final SparseArrayMap mTemporaryVips;
    public final SparseSetArray mUidToPackageCache;
    public final AlarmManager.OnAlarmListener mUnusedWealthReclamationListener;
    public final SparseArrayMap mVipOverrides;
    public String mWellbeingPackage;
    ...
    public SparseArrayMap getInstalledPackages() {
    ...
    public boolean isHeadlessSystemApp(int i, String str) {
        if (str == null) {
            Slog.wtfStack("TARE-IRS", "isHeadlessSystemApp called with null package");
            return false;
        }
        synchronized (this.mLock) {
    ...
    public void onExemptionListChanged() {
        ...
        synchronized (this.mLock) {
            ArraySet arraySet = this.mExemptedApps;
            ...
            for (int size = this.mExemptedApps.size() - 1; size >= 0; size--) {
                String str = (String) this.mExemptedApps.valueAt(size);
            ...
            for (int size2 = arraySet2.size() - 1; size2 >= 0; size2--) {
                ...
                for (int i : userIds) {
                    if (getUid(i, str2) >= 0) {
                        this.mAgent.onAppExemptedLocked(i, str2);
                    }
                }
            }
            for (int size3 = arraySet.size() - 1; size3 >= 0; size3--) {
                String str3 = (String) arraySet.valueAt(size3);
                for (int i2 : userIds) {
                    if (getUid(i2, str3) >= 0) {
                        this.mAgent.onAppUnexemptedLocked(i2, str3);
                    }
                }
            }
        }
    ...
    public void onUidStateChanged(int i) {
        synchronized (this.mLock) {
            ArraySet packagesForUidLocked = getPackagesForUidLocked(i);
    ...
    public void maybePerformQuantitativeEasingLocked() {
        ...
        if (getRealtimeSinceFirstSetupMs() < 432000000) {
            return;
        }
        ...
        public long getMaxDurationMs(int i, String str, EconomyManagerInternal.ActionBill actionBill) {
            ...
            synchronized (InternalResourceService.this.mLock) {
                ...
                for (int i2 = 0; i2 < anticipatedActions.size(); i2++) {
                    j += InternalResourceService.this.mCompleteEconomicPolicy.getCostOfAction(((EconomyManagerInternal.AnticipatedAction) anticipatedActions.get(i2)).actionId, i, str).price;
                }
                if (j == 0) {
                    return 851472000000L;
                }
    ...
    public class ConfigObserver extends ContentObserver implements DeviceConfig.OnPropertiesChangedListener {
        ...
        */
        public void onPropertiesChanged(android.provider.DeviceConfig.Properties r10) {
            /*
                r9 = this;
                com.android.server.tare.InternalResourceService r0 = com.android.server.tare.InternalResourceService.this
                java.lang.Object r0 = com.android.server.tare.InternalResourceService.m11635$$Nest$fgetmLock(r0)
                monitor-enter(r0)
                java.util.Set r1 = r10.getKeyset()     // Catch: java.lang.Throwable -> La9
                java.util.Iterator r1 = r1.iterator()     // Catch: java.lang.Throwable -> La9
                r2 = 0
                r3 = r2
            L11:
                boolean r4 = r1.hasNext()     // Catch: java.lang.Throwable -> La9
                if (r4 == 0) goto La7
                java.lang.Object r4 = r1.next()     // Catch: java.lang.Throwable -> La9
                java.lang.String r4 = (java.lang.String) r4     // Catch: java.lang.Throwable -> La9
                if (r4 != 0) goto L20
                goto L11
            L20:
                int r5 = r4.hashCode()     // Catch: java.lang.Throwable -> La9
                r6 = -1428824012(0xffffffffaad5e034, float:-3.7991973E-13)
                r7 = 2
                r8 = 1
                if (r5 == r6) goto L4b
                r6 = -300584602(0xffffffffee157166, float:-1.1562589E28)
                if (r5 == r6) goto L41
                r6 = 1536945124(0x5b9bebe4, float:8.7775972E16)
                if (r5 == r6) goto L36
                goto L55
            L36:
                java.lang.String r5 = "target_bg_battery_life_hrs"
                boolean r5 = r4.equals(r5)     // Catch: java.lang.Throwable -> La9
                if (r5 == 0) goto L55
                r5 = r7
                goto L56
            L41:
                java.lang.String r5 = "enable_tare_mode"
                boolean r5 = r4.equals(r5)     // Catch: java.lang.Throwable -> La9
                if (r5 == 0) goto L55
                r5 = r2
                goto L56
            L4b:
                java.lang.String r5 = "enable_tip3"
                boolean r5 = r4.equals(r5)     // Catch: java.lang.Throwable -> La9
                if (r5 == 0) goto L55
                r5 = r8
                goto L56
            ...
            L56:
                ...
                boolean r5 = r4.startsWith(r5)     // Catch: java.lang.Throwable -> La9
                if (r5 != 0) goto L76
                java.lang.String r5 = "js"
                boolean r5 = r4.startsWith(r5)     // Catch: java.lang.Throwable -> La9
                if (r5 != 0) goto L76
                java.lang.String r5 = "enable_policy"
                boolean r4 = r4.startsWith(r5)     // Catch: java.lang.Throwable -> La9
                if (r4 == 0) goto L11
            L76:
                r9.updateEconomicPolicy()     // Catch: java.lang.Throwable -> La9
                r3 = r8
                goto L11
            L7b:
                com.android.server.tare.InternalResourceService r5 = com.android.server.tare.InternalResourceService.this     // Catch: java.lang.Throwable -> La9
                java.lang.Object r5 = com.android.server.tare.InternalResourceService.m11635$$Nest$fgetmLock(r5)     // Catch: java.lang.Throwable -> La9
                monitor-enter(r5)     // Catch: java.lang.Throwable -> La9
                com.android.server.tare.InternalResourceService r6 = com.android.server.tare.InternalResourceService.this     // Catch: java.lang.Throwable -> L97
                int r7 = com.android.server.tare.InternalResourceService.m11631$$Nest$fgetmDefaultTargetBackgroundBatteryLifeHours(r6)     // Catch: java.lang.Throwable -> L97
                int r4 = r10.getInt(r4, r7)     // Catch: java.lang.Throwable -> L97
                com.android.server.tare.InternalResourceService.m11643$$Nest$fputmTargetBackgroundBatteryLifeHours(r6, r4)     // Catch: java.lang.Throwable -> L97
                com.android.server.tare.InternalResourceService r4 = com.android.server.tare.InternalResourceService.this     // Catch: java.lang.Throwable -> L97
                r4.maybeAdjustDesiredStockLevelLocked()     // Catch: java.lang.Throwable -> L97
            ...
            L9a:
                boolean r4 = r10.getBoolean(r4, r8)     // Catch: java.lang.Throwable -> La9
                r9.ENABLE_TIP3 = r4     // Catch: java.lang.Throwable -> La9
                goto L11
            La2:
                r9.updateEnabledStatus()     // Catch: java.lang.Throwable -> La9
                goto L11
            La7:
            ...
            La9:
                ...
                throw r9
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.tare.InternalResourceService.ConfigObserver.onPropertiesChanged(android.provider.DeviceConfig$Properties):void");
        }
