...
public class AlarmManagerEconomicPolicy extends EconomicPolicy {
    ...
    public long mMinSatiatedBalanceHeadlessSystemApp;
    ...
    public final void loadConstants(String str, DeviceConfig.Properties properties) {
        ...
        this.mActions.put(1342177286, new EconomicPolicy.Action(1342177286, getConstantAsCake(this.mParser, properties, "am_action_alarm_allow_while_idle_inexact_nonwakeup_ctp", EconomyManager.DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_NONWAKEUP_CTP_CAKES), constantAsCake5));
    ...
    public void dump(IndentingPrintWriter indentingPrintWriter) {
        ...
        for (int i = 0; i < this.mActions.size(); i++) {
            EconomicPolicy.dumpAction(indentingPrintWriter, (EconomicPolicy.Action) this.mActions.valueAt(i));
        }
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.println();
        ...
        for (int i2 = 0; i2 < this.mRewards.size(); i2++) {
            EconomicPolicy.dumpReward(indentingPrintWriter, (EconomicPolicy.Reward) this.mRewards.valueAt(i2));
        }
        indentingPrintWriter.decreaseIndent();
    }
}
