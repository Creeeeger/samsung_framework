...
public class TvInteractiveAppManagerService extends SystemService {
    ...
    public final int getInteractiveAppUid(TvInteractiveAppServiceInfo tvInteractiveAppServiceInfo) {
        try {
            ...
            Slogf.w("TvInteractiveAppManagerService", "Unable to get UID for  " + tvInteractiveAppServiceInfo, e);
            return -1;
        }
    }
    ...
    public final class BinderService extends ITvInteractiveAppManager.Stub {
        ...
        public List getTvInteractiveAppServiceList(int i) {
            ArrayList arrayList;
        ...
        public List getAppLinkInfoList(int i) {
            ArrayList arrayList;
        ...
        public void notifyTracksChanged(IBinder iBinder, List list, int i) {
            int callingUid = Binder.getCallingUid();
        ...
        public void sendTrackInfoList(IBinder iBinder, List list, int i) {
            int callingUid = Binder.getCallingUid();
        ...
        public void sendTvRecordingInfoList(IBinder iBinder, List list, int i) {
            int callingUid = Binder.getCallingUid();
    ...
    */
    public final com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState releaseSessionLocked(android.os.IBinder r5, int r6, int r7) {
        /*
            r4 = this;
            r0 = 0
            com.android.server.tv.interactive.TvInteractiveAppManagerService$SessionState r6 = r4.getSessionStateLocked(r5, r6, r7)     // Catch: java.lang.Throwable -> L2b java.lang.Throwable -> L2e
            r4.getOrCreateUserStateLocked(r7)     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            android.media.tv.interactive.ITvInteractiveAppSession r1 = com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState.m12084$$Nest$fgetmSession(r6)     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            if (r1 == 0) goto L21
            android.media.tv.interactive.ITvInteractiveAppSession r1 = com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState.m12084$$Nest$fgetmSession(r6)     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            android.os.IBinder r1 = r1.asBinder()     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            r2 = 0
            r1.unlinkToDeath(r6, r2)     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            android.media.tv.interactive.ITvInteractiveAppSession r1 = com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState.m12084$$Nest$fgetmSession(r6)     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
            r1.release()     // Catch: java.lang.Throwable -> L27 java.lang.Throwable -> L29
        L21:
            if (r6 == 0) goto L3a
        L23:
            com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState.m12088$$Nest$fputmSession(r6, r0)
            goto L3a
        L27:
            r4 = move-exception
            goto L3e
        ...
        L30:
            ...
            com.android.server.utils.Slogf.e(r2, r3, r1)     // Catch: java.lang.Throwable -> L27
            if (r6 == 0) goto L3a
            goto L23
        L3a:
            r4.removeSessionStateLocked(r5, r7)
            return r6
        L3e:
            if (r6 == 0) goto L43
            com.android.server.tv.interactive.TvInteractiveAppManagerService.SessionState.m12088$$Nest$fputmSession(r6, r0)
        L43:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.tv.interactive.TvInteractiveAppManagerService.releaseSessionLocked(android.os.IBinder, int, int):com.android.server.tv.interactive.TvInteractiveAppManagerService$SessionState");
    }
    ...
    public final class UserState {
        public final List mAppLinkInfoList;
        public final RemoteCallbackList mCallbacks;
        public final Map mClientStateMap;
        public Map mIAppMap;
        public final Set mPackageSet;
        public final Map mServiceStateMap;
        public final Map mSessionStateMap;
            ...
            synchronized (TvInteractiveAppManagerService.this.mLock) {
                ...
                if (clientState != null) {
                    while (clientState.mSessionTokens.size() > 0) {
                        IBinder iBinder = (IBinder) clientState.mSessionTokens.get(0);
    ...
    public final class ServiceState {
        ...
        public final String mIAppServiceId;
        public final List mPendingAppLinkCommand;
        public final List mPendingAppLinkInfo;
        public boolean mReconnecting;
        public ITvInteractiveAppService mService;
        public final List mSessionTokens;
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            try {
                                ...
                                Slogf.e("TvInteractiveAppManagerService", "error in notifyAppLinkInfo(" + pair + ") when onServiceConnected", e2);
                            }
                        } finally {
                        }
                    }
                    ...
                    while (it2.hasNext()) {
                        ...
                        try {
                            try {
                                ...
                                Slogf.e("TvInteractiveAppManagerService", "error in sendAppLinkCommand(" + bundle + ") when onServiceConnected", e3);
                            }
                        } finally {
                        }
                    }
