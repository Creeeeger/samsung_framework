...
public class TunerResourceManagerService extends SystemService implements IBinder.DeathRecipient {
    ...
    public Map mCasResources;
    public Map mCiCamResources;
    public Map mClientProfiles;
    public Map mDemuxResources;
    ...
    public final class BinderService extends ITunerResourceManager.Stub {
        ...
        public void registerClientProfile(ResourceClientProfile resourceClientProfile, IResourcesReclaimListener iResourcesReclaimListener, int[] iArr) {
        ...
        public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            synchronized (TunerResourceManagerService.this.mLock) {
                ...
                tunerResourceManagerService.dumpMap(tunerResourceManagerService.mClientProfiles, "ClientProfiles:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                TunerResourceManagerService tunerResourceManagerService2 = TunerResourceManagerService.this;
                tunerResourceManagerService2.dumpMap(tunerResourceManagerService2.mFrontendResources, "FrontendResources:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                ...
                tunerResourceManagerService6.dumpMap(tunerResourceManagerService6.mFrontendResourcesBackup, "FrontendResourcesBackUp:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                ...
                tunerResourceManagerService10.dumpMap(tunerResourceManagerService10.mDemuxResources, "DemuxResource:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                TunerResourceManagerService tunerResourceManagerService11 = TunerResourceManagerService.this;
                tunerResourceManagerService11.dumpMap(tunerResourceManagerService11.mLnbResources, "LnbResource:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                TunerResourceManagerService tunerResourceManagerService12 = TunerResourceManagerService.this;
                tunerResourceManagerService12.dumpMap(tunerResourceManagerService12.mCasResources, "CasResource:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                TunerResourceManagerService tunerResourceManagerService13 = TunerResourceManagerService.this;
                tunerResourceManagerService13.dumpMap(tunerResourceManagerService13.mCiCamResources, "CiCamResource:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
                TunerResourceManagerService tunerResourceManagerService14 = TunerResourceManagerService.this;
                tunerResourceManagerService14.dumpMap(tunerResourceManagerService14.mListeners, "Listners:", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, indentingPrintWriter);
            }
        }
    ...
    public boolean isLowestPriorityInternal(int i, int i2) {
        ClientProfile clientProfile = getClientProfile(i);
        if (clientProfile == null) {
            return true;
        }
    ...
    public boolean requestFrontendInternal(TunerFrontendRequest tunerFrontendRequest, int[] iArr) {
        ...
        while (true) {
            ...
            int resourceIdFromHandle = getResourceIdFromHandle(frontendResource.getHandle());
            if (frontendResource.getType() == tunerFrontendRequest.frontendType && (!z || resourceIdFromHandle == tunerFrontendRequest.desiredId)) {
                if (frontendResource.isInUse()) {
                    if (i2 == -1 && i > (frontendHighestClientPriority = getFrontendHighestClientPriority(frontendResource.getOwnerClientId()))) {
                        int handle = frontendResource.getHandle();
                        z2 = clientProfile.getProcessId() == getClientProfile(frontendResource.getOwnerClientId()).getProcessId();
                        i3 = handle;
                    ...
                    if (frontendResource.getExclusiveGroupMemberFeHandles().isEmpty()) {
                        i2 = frontendResource.getHandle();
                        break;
                    }
                    if (i2 == -1) {
                        i2 = frontendResource.getHandle();
    ...
    public void shareFrontendInternal(int i, int i2) {
        ...
        Iterator it = getClientProfile(i2).getInUseFrontendHandles().iterator();
        while (it.hasNext()) {
            getClientProfile(i).useFrontend(((Integer) it.next()).intValue());
        }
    ...
    public final boolean transferFeOwner(int i, int i2) {
        ...
        Iterator it = clientProfile2.getInUseFrontendHandles().iterator();
        while (it.hasNext()) {
            getFrontendResource(((Integer) it.next()).intValue()).setOwner(i2);
        }
        clientProfile2.setPrimaryFrontend(clientProfile.getPrimaryFrontend());
        clientProfile.setPrimaryFrontend(-1);
        Iterator it2 = clientProfile.getInUseFrontendHandles().iterator();
        while (it2.hasNext()) {
    ...
    public boolean requestLnbInternal(TunerLnbRequest tunerLnbRequest, int[] iArr) {
        ...
        while (true) {
            ...
            if (!lnbResource.isInUse()) {
                i = lnbResource.getHandle();
                break;
            }
            int updateAndGetOwnerClientPriority = updateAndGetOwnerClientPriority(lnbResource.getOwnerClientId());
            if (i2 > updateAndGetOwnerClientPriority) {
                i3 = lnbResource.getHandle();
                z = clientProfile.getProcessId() == getClientProfile(lnbResource.getOwnerClientId()).getProcessId();
    ...
    public void releaseFrontendInternal(FrontendResource frontendResource, int i) {
        ...
        if (i == frontendResource.getOwnerClientId() && (clientProfile = getClientProfile(frontendResource.getOwnerClientId())) != null) {
            Iterator it = clientProfile.getShareFeClientIds().iterator();
            while (it.hasNext()) {
    ...
    */
    public final boolean acquireLockInternal(int r21, long r22, long r24) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean releaseLockInternal(int r8, long r9, boolean r11, boolean r12) {
        /*
            Method dump skipped, instructions count: 281
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.tv.tunerresourcemanager.TunerResourceManagerService.releaseLockInternal(int, long, boolean, boolean):boolean");
    }
    ...
    public boolean reclaimResource(int i, int i2) {
        ...
        while (it.hasNext()) {
            int intValue = ((Integer) it.next()).intValue();
            try {
                ((ResourcesReclaimListenerRecord) this.mListeners.get(Integer.valueOf(intValue))).getListener().onReclaimResources();
        ...
        try {
            ((ResourcesReclaimListenerRecord) this.mListeners.get(Integer.valueOf(i))).getListener().onReclaimResources();
    ...
    public final void updateFrontendClientMappingOnNewGrant(int i, int i2) {
        ...
        Iterator it = frontendResource.getExclusiveGroupMemberFeHandles().iterator();
        while (it.hasNext()) {
            int intValue = ((Integer) it.next()).intValue();
    ...
    public final int getFrontendHighestClientPriority(int i) {
        ...
        Iterator it = clientProfile.getShareFeClientIds().iterator();
        while (it.hasNext()) {
            int updateAndGetOwnerClientPriority2 = updateAndGetOwnerClientPriority(((Integer) it.next()).intValue());
    ...
    public FrontendResource getFrontendResource(int i) {
        return (FrontendResource) this.mFrontendResources.get(Integer.valueOf(i));
    }
    ...
    public DemuxResource getDemuxResource(int i) {
        return (DemuxResource) this.mDemuxResources.get(Integer.valueOf(i));
    }
    ...
    public final void replaceFeResourceMap(Map map, Map map2) {
        if (map2 != null) {
            map2.clear();
    ...
    public final void addFrontendResource(FrontendResource frontendResource) {
        ...
        while (true) {
            ...
            if (frontendResource2.getExclusiveGroupId() == frontendResource.getExclusiveGroupId()) {
                frontendResource.addExclusiveGroupMemberFeHandle(frontendResource2.getHandle());
                frontendResource.addExclusiveGroupMemberFeHandles(frontendResource2.getExclusiveGroupMemberFeHandles());
                Iterator it2 = frontendResource2.getExclusiveGroupMemberFeHandles().iterator();
                while (it2.hasNext()) {
                    getFrontendResource(((Integer) it2.next()).intValue()).addExclusiveGroupMemberFeHandle(frontendResource.getHandle());
                }
                frontendResource2.addExclusiveGroupMemberFeHandle(frontendResource.getHandle());
            }
        }
    ...
    public final void removeFrontendResource(int i) {
        ...
        Iterator it2 = frontendResource.getExclusiveGroupMemberFeHandles().iterator();
        while (it2.hasNext()) {
            getFrontendResource(((Integer) it2.next()).intValue()).removeExclusiveGroupMemberFeId(frontendResource.getHandle());
        }
    ...
    public LnbResource getLnbResource(int i) {
        return (LnbResource) this.mLnbResources.get(Integer.valueOf(i));
    }
    ...
    public CasResource getCasResource(int i) {
        return (CasResource) this.mCasResources.get(Integer.valueOf(i));
    }

    public CiCamResource getCiCamResource(int i) {
        return (CiCamResource) this.mCiCamResources.get(Integer.valueOf(i));
    }
    ...
    public final void removeCasResource(int i) {
        ...
        Iterator it = casResource.getOwnerClientIds().iterator();
        while (it.hasNext()) {
            getClientProfile(((Integer) it.next()).intValue()).releaseCas();
        }
    ...
    public final void removeCiCamResource(int i) {
        ...
        Iterator it = ciCamResource.getOwnerClientIds().iterator();
        while (it.hasNext()) {
            getClientProfile(((Integer) it.next()).intValue()).releaseCiCam();
        }
        this.mCiCamResources.remove(Integer.valueOf(i));
    }

    public ClientProfile getClientProfile(int i) {
        return (ClientProfile) this.mClientProfiles.get(Integer.valueOf(i));
    }
    ...
    public final void removeClientProfile(int i) {
        Iterator it = getClientProfile(i).getShareFeClientIds().iterator();
        while (it.hasNext()) {
            clearFrontendAndClientMapping(getClientProfile(((Integer) it.next()).intValue()));
        }
        ...
        synchronized (this.mLock) {
            ResourcesReclaimListenerRecord resourcesReclaimListenerRecord = (ResourcesReclaimListenerRecord) this.mListeners.remove(Integer.valueOf(i));
            if (resourcesReclaimListenerRecord != null) {
                resourcesReclaimListenerRecord.getListener().asBinder().unlinkToDeath(resourcesReclaimListenerRecord, 0);
            }
        }
    }
    ...
    public final void clearFrontendAndClientMapping(ClientProfile clientProfile) {
        ...
        Iterator it = clientProfile.getInUseFrontendHandles().iterator();
        while (it.hasNext()) {
    ...
    public final void clearAllResourcesAndClientMapping(ClientProfile clientProfile) {
        ...
        Iterator it = clientProfile.getInUseLnbHandles().iterator();
        while (it.hasNext()) {
            getLnbResource(((Integer) it.next()).intValue()).removeOwner();
        }
        ...
        Iterator it2 = clientProfile.getInUseDemuxHandles().iterator();
        while (it2.hasNext()) {
            getDemuxResource(((Integer) it2.next()).intValue()).removeOwner();
        }
        clearFrontendAndClientMapping(clientProfile);
