...
public final class TvRemoteProviderWatcher {
    ...
    public TvRemoteProviderWatcher(Context context, Object obj, Handler handler) {
        ...
        simpleStringSplitter.setString(context.getString(R.string.httpErrorFile));
        ...
        if (this.mRunning) {
            ...
            while (it.hasNext()) {
                ...
                if (serviceInfo != null && verifyServiceTrusted(serviceInfo)) {
                    ...
                    if (findProvider < 0) {
                        ...
                        TvRemoteProviderProxy tvRemoteProviderProxy2 = (TvRemoteProviderProxy) this.mProviderProxies.get(findProvider);
            ...
            if (i2 < this.mProviderProxies.size()) {
                for (int size = this.mProviderProxies.size() - 1; size >= i2; size--) {
                    TvRemoteProviderProxy tvRemoteProviderProxy3 = (TvRemoteProviderProxy) this.mProviderProxies.get(size);
    ...
    public final int findProvider(String str, String str2) {
        ...
        for (int i = 0; i < size; i++) {
            if (((TvRemoteProviderProxy) this.mProviderProxies.get(i)).hasComponentName(str, str2)) {
                return i;
            }
        }
        return -1;
