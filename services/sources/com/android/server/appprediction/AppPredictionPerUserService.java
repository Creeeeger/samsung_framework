...
public class AppPredictionPerUserService extends AbstractPerUserSystemService implements RemoteAppPredictionService.RemoteAppPredictionServiceCallbacks {
    ...
    public void onDestroyPredictionSessionLocked(final AppPredictionSessionId appPredictionSessionId) {
        ...
        resolveService(appPredictionSessionId, false, appPredictionSessionInfo.mUsesPeopleService, new AbstractRemoteService.AsyncRequest() { // from class: com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda4
            public final void run(IInterface iInterface) {
    ...
    public boolean resolveService(AppPredictionSessionId appPredictionSessionId, boolean z, boolean z2, AbstractRemoteService.AsyncRequest asyncRequest) {
        if (z2) {
