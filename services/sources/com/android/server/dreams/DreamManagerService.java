...
public final class DreamManagerService extends SystemService {
    ...
    public DreamManagerService(Context context) {
        ...
        this.mDreamUiEventLogger = new DreamUiEventLoggerImpl(context.getResources().getStringArray(17236238));
        ...
        this.mDreamsOnlyEnabledForDockUser = context.getResources().getBoolean(17891643);
        this.mDismissDreamOnActivityStart = context.getResources().getBoolean(17891622);
        this.mDreamsEnabledByDefaultConfig = context.getResources().getBoolean(17891641);
        this.mDreamsActivatedOnChargeByDefault = context.getResources().getBoolean(17891639);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(17891638);
        this.mSettingsObserver = new SettingsObserver(dreamHandler);
        this.mKeepDreamingWhenUnpluggingDefault = context.getResources().getBoolean(17891738);
        this.mDreamsDisabledByAmbientModeSuppressionConfig = context.getResources().getBoolean(17891640);
    }
    ...
    public final void reportKeepDreamingWhenUnpluggingChanged(final boolean z) {
    ...
    public final void reportDreamingStarted() {
        notifyDreamStateListeners(new Consumer() { // from class: com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda7
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public final void reportDreamingStopped() {
    ...
    public final void notifyDreamStateListeners(final Consumer consumer) {
    ...
    public /* synthetic */ void lambda$notifyDreamStateListeners$4(Consumer consumer) {
        Iterator it = this.mDreamManagerStateListeners.iterator();
        while (it.hasNext()) {
    ...
    public final boolean canStartDreamingInternal(boolean z) {
        synchronized (this.mLock) {
            ...
            if (this.mDreamsDisabledByAmbientModeSuppressionConfig && this.mPowerManagerInternal.isAmbientDisplaySuppressed()) {
                Slog.i("DreamManagerService", "Can't start dreaming because ambient is suppressed.");
                return false;
            }
    ...
    public final void semStartDozingInternal(IBinder iBinder, int i, int i2, int i3, boolean z) {
        synchronized (this.mLock) {
            DreamRecord dreamRecord = this.mCurrentDream;
            if (dreamRecord != null && dreamRecord.token == iBinder && dreamRecord.canDoze) {
                dreamRecord.dozeScreenState = i;
                dreamRecord.dozeScreenBrightness = i2;
                this.mPowerManagerInternal.setDozeOverrideFromDreamManager(i, i2, i3, z);
                DreamRecord dreamRecord2 = this.mCurrentDream;
                if (!dreamRecord2.isDozing) {
                    dreamRecord2.isDozing = true;
                    this.mDozeWakeLock.acquire();
    ...
    public final boolean shouldKeepDreamingWhenUnplugging() {
    ...
    public final class BinderService extends IDreamManager.Stub {
        ...
        public void semStartDozing(IBinder iBinder, int i, int i2, int i3, boolean z) {
            if (iBinder == null) {
                throw new IllegalArgumentException("token must not be null");
            }
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                DreamManagerService.this.semStartDozingInternal(iBinder, i, i2, i3, z);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        }
