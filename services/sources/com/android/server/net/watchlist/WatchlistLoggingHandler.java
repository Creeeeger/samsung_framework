...
public class WatchlistLoggingHandler extends Handler {
    ...
    public final byte[] getDigestFromUid(final int i) {
        return (byte[]) this.mCachedUidDigestMap.computeIfAbsent(Integer.valueOf(i), new Function() { // from class: com.android.server.net.watchlist.WatchlistLoggingHandler$$ExternalSyntheticLambda0
