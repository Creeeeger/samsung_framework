...
public abstract class ProtoStreamUtils {
    public static final String TAG = "ProtoStreamUtils";

    /* loaded from: classes3.dex */
    public abstract class PowerEntityUtils {
    ...
    /* loaded from: classes3.dex */
    public abstract class StateResidencyResultUtils {
        ...
        public static StateResidencyResult[] unpackProtoMessage(byte[] bArr) {
    ...
    /* loaded from: classes3.dex */
    public abstract class EnergyMeasurementUtils {
        ...
        public static EnergyMeasurement[] unpackProtoMessage(byte[] bArr) {
            ProtoInputStream protoInputStream = new ProtoInputStream(new ByteArrayInputStream(bArr));
            ArrayList arrayList = new ArrayList();
            while (true) {
                try {
    ...
    /* loaded from: classes3.dex */
    public abstract class EnergyConsumerUtils {
    ...
    /* loaded from: classes3.dex */
    public abstract class EnergyConsumerResultUtils {
