...
public class PowerStatsService extends SystemService {
    ...
    public final class LocalService extends PowerStatsInternal {
        ...
        @Override // android.power.PowerStatsInternal
        public CompletableFuture getEnergyConsumedAsync(int[] iArr) {
        ...
        @Override // android.power.PowerStatsInternal
        public CompletableFuture getStateResidencyAsync(int[] iArr) {
            CompletableFuture completableFuture = new CompletableFuture();
            Handler handler = this.mHandler;
            final PowerStatsService powerStatsService = PowerStatsService.this;
        ...
        @Override // android.power.PowerStatsInternal
        public CompletableFuture readEnergyMeterAsync(int[] iArr) {
            CompletableFuture completableFuture = new CompletableFuture();
            Handler handler = this.mHandler;
            final PowerStatsService powerStatsService = PowerStatsService.this;
    ...
    public final void getEnergyConsumedAsync(CompletableFuture completableFuture, int[] iArr) {
        int length;
    ...
    public final void getStateResidencyAsync(CompletableFuture completableFuture, int[] iArr) {
        completableFuture.complete(getPowerStatsHal().getStateResidency(iArr));
    }

    public final void readEnergyMeterAsync(CompletableFuture completableFuture, int[] iArr) {
