...
public abstract class MetricUtilities {
    ...
    public static int getPackageUid(Context context, ComponentName componentName) {
        try {
            ...
            Slog.i("MetricUtilities", "Couldn't find required uid");
            return -1;
        }
    }
    ...
    public static int getMetricTimestampDifferenceMicroseconds(long j, long j2) {
        long j3 = j - j2;
        if (j3 > 2147483647L) {
            Slog.i("MetricUtilities", "Input timestamps are too far apart and unsupported, falling back to default int");
            return -1;
        }
        if (j < j2) {
            Slog.i("MetricUtilities", "The timestamps aren't in expected order, falling back to default int");
            return -1;
        }
        return (int) (j3 / 1000);
    }
    ...
    public static void logApiCalledFinalPhase(ChosenProviderFinalPhaseMetric chosenProviderFinalPhaseMetric, List list, int i, int i2) {
        try {
            ...
            int i3 = 0;
            while (it.hasNext()) {
                CandidateBrowsingPhaseMetric candidateBrowsingPhaseMetric = (CandidateBrowsingPhaseMetric) it.next();
            ...
            Slog.w("MetricUtilities", "Unexpected error during final provider uid emit: " + e);
        }
    }
    ...
    public static void logApiCalledAuthenticationMetric(BrowsedAuthenticationMetric browsedAuthenticationMetric, int i) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during candidate auth metric logging: " + e);
        }
    }

    public static void logApiCalledCandidateGetMetric(Map map, int i) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during candidate get metric logging: " + e);
        }
    }
    ...
    public static void logApiCalledCandidatePhase(Map map, int i, InitialPhaseMetric initialPhaseMetric) {
        try {
            ...
            int i3 = -1;
            while (it.hasNext()) {
                CandidatePhaseMetric candidatePhasePerProviderMetric = ((ProviderSession) it.next()).mProviderSessionMetric.getCandidatePhasePerProviderMetric();
                Iterator it2 = it;
                if (i3 == -1) {
            ...
            Slog.w("MetricUtilities", "Unexpected error during candidate provider uid metric emit: " + e);
        }
    }
    ...
    public static void logApiCalledSimpleV2(ApiName apiName, ApiStatus apiStatus, int i) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during simple v2 metric logging: " + e);
        }
    }
    ...
    public static void logApiCalledInitialPhase(InitialPhaseMetric initialPhaseMetric, int i) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during initial metric emit: " + e);
        }
    }
    ...
    public static void logApiCalledAggregateCandidate(CandidateAggregateMetric candidateAggregateMetric, int i) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during total candidate metric logging: " + e);
        }
    }
    ...
    public static void logApiCalledNoUidFinal(ChosenProviderFinalPhaseMetric chosenProviderFinalPhaseMetric, List list, int i, int i2) {
        try {
            ...
            Slog.w("MetricUtilities", "Unexpected error during final no uid metric logging: " + e);
        }
    }
}
