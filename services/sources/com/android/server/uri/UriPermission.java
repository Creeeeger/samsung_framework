...
public final class UriPermission {
    ...
    public boolean revokeModes(int i, boolean z) {
        ...
        if ((i2 & 1) != 0) {
            ...
            if (arraySet != null && z) {
                ...
                while (it.hasNext()) {
                    ...
                    if (uriPermissionOwner != null) {
                        uriPermissionOwner.removeReadPermission(this);
                    }
                }
        ...
        if ((i2 & 2) != 0) {
            ...
            ArraySet arraySet2 = this.mWriteOwners;
            if (arraySet2 != null && z) {
                this.ownedModeFlags &= -3;
                Iterator it2 = arraySet2.iterator();
                while (it2.hasNext()) {
                    ((UriPermissionOwner) it2.next()).removeWritePermission(this);
                }
    ...
    public void dump(PrintWriter printWriter, String str) {
        ...
        if (this.mWriteOwners != null) {
            ...
            Iterator it2 = this.mReadOwners.iterator();
            while (it2.hasNext()) {
    ...
    /* loaded from: classes3.dex */
    public class PersistedTimeComparator implements Comparator {
