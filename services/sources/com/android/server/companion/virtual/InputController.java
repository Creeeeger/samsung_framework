...
public class InputController {
    ...
    public final ArrayMap mInputDeviceDescriptors;
    ...
    public final void updateActivePointerDisplayIdLocked() {
        ...
        for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
            InputDeviceDescriptor inputDeviceDescriptor2 = (InputDeviceDescriptor) this.mInputDeviceDescriptors.valueAt(i);
    ...
    public final void validateDeviceName(String str) {
        ...
        synchronized (this.mLock) {
            for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
                if (((InputDeviceDescriptor) this.mInputDeviceDescriptors.valueAt(i)).mName.equals(str)) {
    ...
    public void dump(PrintWriter printWriter) {
        ...
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
                InputDeviceDescriptor inputDeviceDescriptor = (InputDeviceDescriptor) this.mInputDeviceDescriptors.valueAt(i);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public final class InputDeviceDescriptor {
    ...
    public class WaitForDevice implements AutoCloseable {
        ...
        public int waitForDeviceCreation() {
            try {
