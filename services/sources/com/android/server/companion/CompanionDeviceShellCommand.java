        ...
        try {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    return 0;
                case '\b':
                    this.mTransportManager.createEmulatedTransport(getNextIntArgRequired()).processMessage(1667729539, 0, CrossDeviceSyncController.createEmptyMessage());
                    return 0;
                case '\t':
                    this.mTransportManager.createEmulatedTransport(getNextIntArgRequired()).processMessage(1667729539, 0, CrossDeviceSyncController.createCallCreateMessage(getNextArgRequired(), getNextArgRequired(), getNextArgRequired()));
                    return 0;
                case '\n':
                    this.mTransportManager.createEmulatedTransport(getNextIntArgRequired()).processMessage(1667729539, 0, CrossDeviceSyncController.createCallControlMessage(getNextArgRequired(), getNextIntArgRequired()));
                    return 0;
                case 11:
                    ...
                    this.mTransportManager.createEmulatedTransport(nextIntArgRequired).processMessage(1667729539, 0, protoOutputStream.getBytes());
                    return 0;
                case '\f':
                    ...
                    this.mTransportManager.createEmulatedTransport(nextIntArgRequired3).processMessage(1667729539, 0, protoOutputStream2.getBytes());
                    return 0;
                case '\r':
