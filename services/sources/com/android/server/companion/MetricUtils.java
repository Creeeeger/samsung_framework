...
public abstract class MetricUtils {
    ...
    public static void logCreateAssociation(String str) {
        FrameworkStatsLog.write(FrameworkStatsLog.CDM_ASSOCIATION_ACTION, 1, ((Integer) METRIC_DEVICE_PROFILE.get(str)).intValue());
    }

    public static void logRemoveAssociation(String str) {
        FrameworkStatsLog.write(FrameworkStatsLog.CDM_ASSOCIATION_ACTION, 2, ((Integer) METRIC_DEVICE_PROFILE.get(str)).intValue());
    }
}
