...
public final class PinnerService extends SystemService {
    ...
    public final ArrayList mPinnedFiles;
    ...
    public PinnerService(Context context) {
        ...
        this.mConfiguredToPinCamera = context.getResources().getBoolean(17891793);
        this.mConfiguredToPinHome = context.getResources().getBoolean(17891794);
        this.mConfiguredToPinAssistant = context.getResources().getBoolean(17891792);
    ...
    public List dumpDataForStatsd() {
        ...
        synchronized (this) {
            Iterator it = this.mPinnedFiles.iterator();
            while (it.hasNext()) {
    ...
    public final void handlePinOnStart() {
        String[] strArr;
        for (String str : this.mContext.getResources().getStringArray(17236161)) {
    ...
    public static PinnedFile doPinFile(String str, int i, boolean z) {
        return pinFile(str, i, z);
    }
            ...
            if (DumpUtils.checkDumpPermission(PinnerService.this.mContext, "PinnerService", printWriter)) {
                synchronized (PinnerService.this) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        printWriter.println();
                        Iterator it3 = ((PinnedApp) PinnerService.this.mPinnedApps.get(Integer.valueOf(intValue))).mFiles.iterator();
                        while (it3.hasNext()) {
                            PinnedFile pinnedFile2 = (PinnedFile) it3.next();
                            printWriter.print("  ");
                            printWriter.format("%s %s\n", pinnedFile2.fileName, Integer.valueOf(pinnedFile2.bytesPinned));
