...
public class NetworkScorerAppManager {
    ...
    public void migrateNetworkScorerAppSettingIfNeeded() {
        ...
        if (z) {
            ...
            Log.d("NetworkScorerAppManager", "Settings.Global.USE_OPEN_WIFI_PACKAGE is: '" + this.mSettingsFacade.getString(this.mContext, "use_open_wifi_package") + "'.");
        }
    }

    public final String getDefaultPackageSetting() {
        return this.mContext.getResources().getString(R.string.face_acquired_recalibrate);
    }
