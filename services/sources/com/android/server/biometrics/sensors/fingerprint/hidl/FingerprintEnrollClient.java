...
public class FingerprintEnrollClient extends SemFpBaseEnrollClient implements Udfps {
    ...
    public void startHalOperation() {
        ...
        try {
            ((IBiometricsFingerprint) getFreshDaemon()).enroll(this.mHardwareAuthToken, getTargetUserId(), this.mTimeoutSec);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onAcquired$1(int i, int i2, IUdfpsOverlayController iUdfpsOverlayController) {
    ...
    public final void request(int i, int i2) {
        if (((IBiometricsFingerprint) getFreshDaemon()) instanceof ISehBiometricsFingerprint) {
            new SemFpBaseRequestClient.Builder(getContext(), getBiometricContext(), this.mLazyDaemon, getSensorId()).setCommand(i).setParam(i2).build().startWithoutScheduler();
        }
    }
}
