...
public class FingerprintInternalCleanupClient extends InternalCleanupClient {
    public FingerprintInternalCleanupClient(Context context, Supplier supplier, int i, String str, int i2, BiometricLogger biometricLogger, BiometricContext biometricContext, FingerprintUtils fingerprintUtils, Map map) {
