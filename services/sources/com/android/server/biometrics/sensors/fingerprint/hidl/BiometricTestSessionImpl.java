...
public class BiometricTestSessionImpl extends ITestSession.Stub {
    ...
    public void acceptAuthentication(int i) {
        ...
        List biometricsForUser = FingerprintUtils.getLegacyInstance(this.mSensorId).getBiometricsForUser(this.mContext, i);
        if (biometricsForUser.isEmpty()) {
            Slog.w("BiometricTestSessionImpl", "No fingerprints, returning");
            return;
        }
        this.mHalResultController.onAuthenticated(0L, ((Fingerprint) biometricsForUser.get(0)).getBiometricId(), i, new ArrayList(Collections.nCopies(69, (byte) 0)));
    }
    ...
    public void notifyVendorAcquired(int i, int i2) {
        ...
        this.mHalResultController.onAcquired(0L, 6, i2);
    }

    public void notifyVendorError(int i, int i2) {
        super.notifyVendorError_enforcePermission();
        this.mHalResultController.onError(0L, 8, i2);
    }
}
