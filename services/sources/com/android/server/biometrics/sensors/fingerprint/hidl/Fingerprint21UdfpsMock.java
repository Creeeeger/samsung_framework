...
public class Fingerprint21UdfpsMock extends Fingerprint21 implements TrustManager.TrustListener {
    ...
    /* loaded from: classes.dex */
    public class TestableBiometricScheduler extends BiometricScheduler {
    ...
    /* loaded from: classes.dex */
    public class MockHalResultController extends Fingerprint21.HalResultController {
        public Fingerprint21UdfpsMock mFingerprint21;
        public LastAuthArgs mLastAuthArgs;
        public RestartAuthRunnable mRestartAuthRunnable;

        /* loaded from: classes.dex */
        public class LastAuthArgs {
            public final long deviceId;
            public final int fingerId;
            public final int groupId;
            public final AuthenticationConsumer lastAuthenticatedClient;
            public final ArrayList token;

            public LastAuthArgs(AuthenticationConsumer authenticationConsumer, long j, int i, int i2, ArrayList arrayList) {
        ...
        public void sendAuthenticated(long j, int i, int i2, ArrayList arrayList) {
    ...
    /* loaded from: classes.dex */
    public abstract class FakeFingerRunnable implements Runnable {
        ...
        public /* synthetic */ FakeFingerRunnable(FakeFingerRunnableIA fakeFingerRunnableIA) {
            this();
        }
    ...
    public final class FakeRejectRunnable extends FakeFingerRunnable {
        public /* synthetic */ FakeRejectRunnable(Fingerprint21UdfpsMock fingerprint21UdfpsMock, FakeRejectRunnableIA fakeRejectRunnableIA) {
            this();
        }
    ...
    public final class FakeAcceptRunnable extends FakeFingerRunnable {
        public /* synthetic */ FakeAcceptRunnable(Fingerprint21UdfpsMock fingerprint21UdfpsMock, FakeAcceptRunnableIA fakeAcceptRunnableIA) {
            this();
        }
    ...
    /* loaded from: classes.dex */
    public final class RestartAuthRunnable implements Runnable {
    ...
    public Fingerprint21UdfpsMock(Context context, BiometricStateCallback biometricStateCallback, FingerprintSensorPropertiesInternal fingerprintSensorPropertiesInternal, TestableBiometricScheduler testableBiometricScheduler, Handler handler, LockoutResetDispatcher lockoutResetDispatcher, MockHalResultController mockHalResultController, BiometricContext biometricContext) {
        ...
        this.mSensorProperties = new FingerprintSensorPropertiesInternal(fingerprintSensorPropertiesInternal.sensorId, fingerprintSensorPropertiesInternal.sensorStrength, this.mContext.getResources().getInteger(R.integer.config_previousVibrationsDumpLimit), fingerprintSensorPropertiesInternal.componentInfo, 3, false, false, fingerprintSensorPropertiesInternal.getAllLocations());
    ...
    public void onTrustChanged(boolean z, boolean z2, int i, int i2, List list) {
    ...
    public final int getMatchingDuration() {
        return Math.max(Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "com.android.server.biometrics.sensors.fingerprint.test_udfps.auth_delay_pt2", 400, -2), 0);
    }
