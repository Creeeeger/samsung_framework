...
public class BiometricTestSessionImpl extends ITestSession.Stub {
    ...
    public final IFingerprintServiceReceiver mReceiver = new IFingerprintServiceReceiver.Stub() { // from class: com.android.server.biometrics.sensors.fingerprint.aidl.BiometricTestSessionImpl.1
    ...
    public void acceptAuthentication(int i) {
        ...
        if (biometricsForUser.isEmpty()) {
            ...
            this.mSensor.getSessionForUser(i).getHalSessionCallback().onAuthenticationSucceeded(((Fingerprint) biometricsForUser.get(0)).getBiometricId(), HardwareAuthTokenUtils.toHardwareAuthToken(new byte[69]));
        }
    }
