...
public interface ServiceProvider extends BiometricServiceProvider {
    ...
    long semScheduleAuthenticate(IBinder iBinder, long j, int i, ClientMonitorCallbackConverter clientMonitorCallbackConverter, FingerprintAuthenticateOptions fingerprintAuthenticateOptions, boolean z, int i2, boolean z2, Bundle bundle);

    void semScheduleSensorTest(int i, IBinder iBinder, int i2, int i3, ClientMonitorCallbackConverter clientMonitorCallbackConverter);

    void semScheduleUpdateTrustApp(int i, String str, ClientMonitorCallbackConverter clientMonitorCallbackConverter, String str2);
