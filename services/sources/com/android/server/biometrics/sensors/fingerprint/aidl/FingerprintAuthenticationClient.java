...
import com.android.server.biometrics.sensors.fingerprint.SemFpBaseAuthenticationClient;
...
public class FingerprintAuthenticationClient extends SemFpBaseAuthenticationClient implements Udfps, LockoutConsumer, PowerPressHandler {
    ...
    public FingerprintAuthenticationClient(Context context, Supplier supplier, IBinder iBinder, long j, ClientMonitorCallbackConverter clientMonitorCallbackConverter, long j2, boolean z, FingerprintAuthenticateOptions fingerprintAuthenticateOptions, int i, boolean z2, BiometricLogger biometricLogger, BiometricContext biometricContext, boolean z3, TaskStackListener taskStackListener, LockoutCache lockoutCache, IUdfpsOverlayController iUdfpsOverlayController, ISidefpsController iSidefpsController, IUdfpsOverlay iUdfpsOverlay, boolean z4, FingerprintSensorPropertiesInternal fingerprintSensorPropertiesInternal, Handler handler, int i2, Clock clock) {
        ...
        this.mWaitForAuthKeyguard = context.getResources().getInteger(17695010);
        this.mWaitForAuthBp = context.getResources().getInteger(17695009);
        this.mIgnoreAuthFor = context.getResources().getInteger(17695011);
        this.mSkipWaitForPowerAcquireMessage = context.getResources().getInteger(17695012);
        this.mSkipWaitForPowerVendorAcquireMessage = context.getResources().getInteger(17695013);
    ...
    public /* synthetic */ void lambda$onAcquired$0(int i, IUdfpsOverlayController iUdfpsOverlayController) {
    ...
    public final ICancellationSignal doAuthenticate() {
        ...
        if (aidlSession.hasContextMethods()) {
            authenticate = aidlSession.getSession().authenticateWithContext(this.mOperationId, operationContext.toAidlContext((FingerprintAuthenticateOptions) getOptions()));
        } else {
            authenticate = aidlSession.getSession().authenticate(this.mOperationId);
        }
