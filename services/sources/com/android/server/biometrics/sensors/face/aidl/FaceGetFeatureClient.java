...
public class FaceGetFeatureClient extends HalClientMonitor implements ErrorConsumer {
    ...
    public FaceGetFeatureClient(Context context, Supplier supplier, IBinder iBinder, ClientMonitorCallbackConverter clientMonitorCallbackConverter, int i, String str, int i2, BiometricLogger biometricLogger, BiometricContext biometricContext) {
    ...
    public void startHalOperation() {
        try {
            if (SemFaceServiceExImpl.getInstance().isUsingSehAPI()) {
                ...
                ((AidlSession) getFreshDaemon()).getSession().getFeatures();
            }
    ...
    public void onFeatureGet(boolean z, byte[] bArr) {
        try {
            HashMap featureMap = getFeatureMap();
            ...
            boolean booleanValue = ((Boolean) featureMap.get(1)).booleanValue();
    ...
    public final HashMap getFeatureMap() {
