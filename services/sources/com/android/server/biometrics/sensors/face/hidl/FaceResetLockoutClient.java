...
public abstract class FaceResetLockoutClient extends HalClientMonitor {
    ...
    public FaceResetLockoutClient(Context context, Supplier supplier, int i, String str, int i2, BiometricLogger biometricLogger, BiometricContext biometricContext, byte[] bArr) {
