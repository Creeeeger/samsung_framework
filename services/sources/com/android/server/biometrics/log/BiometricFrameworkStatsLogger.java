...
public class BiometricFrameworkStatsLogger {
    ...
    public static int sessionType(byte b) {
        if (b == 1) {
            return 2;
        }
        return b == 2 ? 1 : 0;
    ...
    public static int toProtoWakeReasonDetailsFromFace(int i) {
        switch (i) {
            case 1:
                return 1;
            case 2:
    ...
    public void authenticate(final OperationContextExt operationContextExt, final int i, final int i2, final int i3, final boolean z, final long j, final int i4, final boolean z2, final int i5, ALSProbe aLSProbe) {
        aLSProbe.awaitNextLux(new Consumer() { // from class: com.android.server.biometrics.log.BiometricFrameworkStatsLogger$$ExternalSyntheticLambda2
    ...
    public static int[] toProtoWakeReasonDetails(OperationContextExt operationContextExt) {
        return Stream.of(Integer.valueOf(toProtoWakeReasonDetails(operationContextExt.toAidlContext().authenticateReason))).mapToInt(new ToIntFunction() { // from class: com.android.server.biometrics.log.BiometricFrameworkStatsLogger$$ExternalSyntheticLambda0
        ...
        }).filter(new IntPredicate() { // from class: com.android.server.biometrics.log.BiometricFrameworkStatsLogger$$ExternalSyntheticLambda1
    ...
    public static int toProtoWakeReasonDetails(AuthenticateReason authenticateReason) {
