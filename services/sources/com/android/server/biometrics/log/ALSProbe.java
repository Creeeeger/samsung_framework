...
public final class ALSProbe implements Probe {
    ...
    public synchronized void awaitNextLux(Consumer consumer, Handler handler) {
    ...
    /* loaded from: classes.dex */
    public class NextConsumer {
        public final Consumer mConsumer;
        public final Handler mHandler;
        public final List mOthers;

        public NextConsumer(Consumer consumer, Handler handler) {
        ...
        public void consume(final float f) {
            ...
            Iterator it = this.mOthers.iterator();
            while (it.hasNext()) {
