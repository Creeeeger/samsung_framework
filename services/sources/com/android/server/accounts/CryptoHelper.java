...
public class CryptoHelper {
    ...
    public Bundle encryptBundle(Bundle bundle) {
    ...
    public Bundle decryptBundle(Bundle bundle) {
    ...
    public final boolean verifyMac(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    public final byte[] createMac(byte[] bArr, byte[] bArr2) {
