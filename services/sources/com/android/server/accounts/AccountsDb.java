...
public class AccountsDb implements AutoCloseable {
    ...
    /* loaded from: classes.dex */
    public class CeDatabaseHelper extends SQLiteOpenHelper {
    ...
    public Map findAuthTokensByAccount(Account account) {
    ...
    public Map findUserExtrasForAccount(Account account) {
        SQLiteDatabase readableDatabaseUserIsUnlocked = this.mDeDatabase.getReadableDatabaseUserIsUnlocked();
        HashMap hashMap = new HashMap();
    ...
    /* loaded from: classes.dex */
    public class DeDatabaseHelper extends SQLiteOpenHelper {
        ...
        public final void migratePreNDbToDe(File file) {
            ...
            writableDatabase.execSQL("INSERT INTO " + AccountsDb.TABLE_DEBUG + "(" + KnoxCustomManagerService.ID + "," + AccountsDb.DEBUG_TABLE_ACTION_TYPE + "," + AccountsDb.DEBUG_TABLE_TIMESTAMP + "," + AccountsDb.DEBUG_TABLE_CALLER_UID + "," + AccountsDb.DEBUG_TABLE_TABLE_NAME + "," + AccountsDb.DEBUG_TABLE_KEY + ") SELECT " + KnoxCustomManagerService.ID + "," + AccountsDb.DEBUG_TABLE_ACTION_TYPE + "," + AccountsDb.DEBUG_TABLE_TIMESTAMP + "," + AccountsDb.DEBUG_TABLE_CALLER_UID + "," + AccountsDb.DEBUG_TABLE_TABLE_NAME + "," + AccountsDb.DEBUG_TABLE_KEY + " FROM preNDb." + AccountsDb.TABLE_DEBUG);
    ...
    public boolean setAccountVisibility(long j, String str, int i) {
        ...
        return writableDatabase.replace(LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, "value", contentValues) != -1;
    }

    public Map findAllVisibilityValues() {
        SQLiteDatabase readableDatabase = this.mDeDatabase.getReadableDatabase();
        HashMap hashMap = new HashMap();
    ...
    public boolean deleteAccountVisibilityForPackage(String str) {
        return this.mDeDatabase.getWritableDatabase().delete(LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, "_package=? ", new String[]{str}) > 0;
    }
    ...
    public List findAllAccountGrants() {
    ...
    /* loaded from: classes.dex */
    public class PreNDatabaseHelper extends SQLiteOpenHelper {
        public final Context mContext;
        public final int mUserId;
        ...
        public final void populateMetaTableWithAuthTypeAndUID(SQLiteDatabase sQLiteDatabase, Map map) {
            for (Map.Entry entry : map.entrySet()) {
                insertMetaAuthTypeAndUid(sQLiteDatabase, (String) entry.getKey(), ((Integer) entry.getValue()).intValue());
            }
        }
    ...
    public List findCeAccountsNotInDe() {
