...
public class IncidentCompanionService extends SystemService {
    ...
    public final class BinderService extends IIncidentCompanion.Stub {
        ...
        public List getIncidentReportList(String str, String str2) {
        ...
        public void deleteIncidentReports(String str, String str2, String str3) {
        ...
        public void deleteAllIncidentReports(String str) {
        ...
        public IncidentManager.IncidentReport getIncidentReport(String str, String str2, String str3) {
            if (str == null || str2 == null || str3 == null || str.length() == 0 || str2.length() == 0 || str3.length() == 0) {
                throw new RuntimeException("Invalid pkg, cls or id");
            }
            enforceAccessReportsPermissions(str);
        ...
        public final void dumpRestrictedImages(FileDescriptor fileDescriptor) {
            if (Build.IS_ENG || Build.IS_USERDEBUG) {
                for (String str : IncidentCompanionService.this.getContext().getResources().getStringArray(17236280)) {
        ...
        public final void enforceCallerIsSameApp(String str) {
            try {
                ...
                throw new SecurityException("Unknown package " + str + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + e);
            }
        }
    }
    ...
    public final IIncidentManager getIIncidentManager() {
