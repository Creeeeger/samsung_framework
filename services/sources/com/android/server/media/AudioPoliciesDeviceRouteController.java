...
public final class AudioPoliciesDeviceRouteController implements DeviceRouteController {
    ...
    public final MediaRoute2Info createRouteFromAudioInfo(int i) {
        ...
        int i2 = (i == 3 || i == 4) ? R.string.kg_sim_pin_instructions : i != 9 ? i != 11 ? i != 13 ? R.string.kg_puk_enter_pin_hint : R.string.kg_puk_enter_puk_hint : R.string.kg_sim_unlock_progress_dialog_message : R.string.kg_reordering_delete_drop_target_text;
        synchronized (this) {
