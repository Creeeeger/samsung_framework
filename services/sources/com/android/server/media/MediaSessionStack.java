...
public class MediaSessionStack {
    ...
    public void onPlaybackStateChanged(MediaSessionRecordImpl mediaSessionRecordImpl, boolean z) {
        ...
        if (z) {
            ...
            if (this.mIsMultiSoundOn) {
                if (!mediaSessionRecordImpl.checkPlaybackActiveState(true) && this.mSessions.size() > 0 && ((MediaSessionRecordImpl) this.mSessions.get(0)).checkPlaybackActiveState(true)) {
    ...
    public void updateMediaButtonSessionIfNeeded() {
        ...
        List sortedAudioPlaybackClientUids = this.mAudioPlayerStateMonitor.getSortedAudioPlaybackClientUids();
    ...
    public List getActiveSessionsSortedPlayback(int i) {
        ...
        final ArrayList arrayList3 = new ArrayList(this.mAudioPlayerStateMonitor.getSortedAudioPlaybackClientUids());
        this.mPrevPlayedUids.stream().filter(new Predicate() { // from class: com.android.server.media.MediaSessionStack$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getActiveSessionsSortedPlayback$0;
                lambda$getActiveSessionsSortedPlayback$0 = MediaSessionStack.lambda$getActiveSessionsSortedPlayback$0(arrayList3, (Integer) obj);
    ...
    public static /* synthetic */ boolean lambda$getActiveSessionsSortedPlayback$0(ArrayList arrayList, Integer num) {
