...
public abstract class AppWidgetXmlUtil {
    public static void writeAppWidgetProviderInfoLocked(TypedXmlSerializer typedXmlSerializer, AppWidgetProviderInfo appWidgetProviderInfo) {
    ...
    public static AppWidgetProviderInfo readAppWidgetProviderInfoLocked(TypedXmlPullParser typedXmlPullParser) {
        ...
        String attributeValue2 = typedXmlPullParser.getAttributeValue((String) null, "semConfigure");
        if (!TextUtils.isEmpty(attributeValue2)) {
            appWidgetProviderInfo.semConfigure = ComponentName.unflattenFromString(attributeValue2);
        }
        appWidgetProviderInfo.label = typedXmlPullParser.getAttributeValue((String) null, "label");
        appWidgetProviderInfo.icon = typedXmlPullParser.getAttributeInt((String) null, KnoxCustomManagerService.ICON, 0);
