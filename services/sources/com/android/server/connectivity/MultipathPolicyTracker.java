...
public class MultipathPolicyTracker {
    ...
    public final ConcurrentHashMap mMultipathTrackers;
    ...
    public Integer getMultipathPreference(Network network) {
        ...
        if (network == null || (multipathTracker = (MultipathTracker) this.mMultipathTrackers.get(network)) == null) {
            return null;
        }
    ...
    public class MultipathTracker {
        ...
        public final long getRemainingDailyBudget(long j, Range range) {
    ...
    public final long getDefaultDailyMultipathQuotaBytes() {
        ...
        return this.mContext.getResources().getInteger(R.integer.leanback_setup_alpha_activity_in_bkg_delay);
    }
    ...
    public final void updateAllMultipathBudgets() {
        Iterator it = this.mMultipathTrackers.values().iterator();
        while (it.hasNext()) {
