...
public class Swipe extends GestureMatcher {
    ...
    public final void recognizeGesture(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
        ...
        for (int i3 = 1; i3 < this.mStrokeBuffer.size(); i3++) {
            pointF2 = (PointF) this.mStrokeBuffer.get(i3);
            if (i2 > 0) {
                float f4 = i2;
                float f5 = f / f4;
                float f6 = f2 / f4;
                ...
                if ((f5 * (f7 / sqrt)) + (f6 * (f8 / sqrt)) < DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
    ...
    public final void recognizeGesturePath(MotionEvent motionEvent, MotionEvent motionEvent2, int i, ArrayList arrayList) {
