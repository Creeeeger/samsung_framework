        ...
        synchronized (this.mLock) {
            ...
            try {
                ...
                if (mode == 2) {
                    ...
                    if (isActivated) {
                        windowMagnificationMgr.enableWindowMagnification(i, f, pointF.x, pointF.y, magnificationAnimationCallback, i2);
                    } else {
                    ...
                    if (isActivated) {
                        ...
                        fullScreenMagnificationController.setScaleAndCenter(i, f, pointF.x, pointF.y, magnificationAnimationCallback, i2);
