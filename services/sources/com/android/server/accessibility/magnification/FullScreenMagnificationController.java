...
public class FullScreenMagnificationController implements WindowManagerInternal.AccessibilityControllerInternal.UiChangesForAccessibilityCallbacks {
    ...
    public final class DisplayMagnification implements WindowManagerInternal.MagnificationCallbacks {
        ...
        public void onRectangleOnScreenRequested(int i, int i2, int i3, int i4) {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new QuintConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda4
        ...
        public void onUserContextChanged() {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda6
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
        ...
        public void onImeWindowVisibilityChanged(boolean z) {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new TriConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda5
        ...
        public void sendSpecToAnimation(MagnificationSpec magnificationSpec, MagnificationAnimationCallback magnificationAnimationCallback) {
            if (FullScreenMagnificationController.SEC_DEBUG) {
                Slog.i("FullScreenMagnificationController", "sendSpecToAnimation(spec = " + magnificationSpec + ", animationCallback = " + magnificationAnimationCallback + ")");
            }
        ...
        public final boolean setActivated(boolean z) {
            ...
            if (z2) {
                ...
                FullScreenMagnificationController.this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda3
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
        ...
        public boolean setScaleAndCenter(float f, float f2, float f3, MagnificationAnimationCallback magnificationAnimationCallback, int i) {
            ...
            if (FullScreenMagnificationController.SEC_DEBUG) {
                Slog.i("FullScreenMagnificationController", "setScaleAndCenterLocked(scale = " + f + ", centerX = " + f2 + ", centerY = " + f3 + ", endCallback = " + magnificationAnimationCallback + ", id = " + i + ")");
            }
    ...
    public FullScreenMagnificationController(Context context, AccessibilityTraceManager accessibilityTraceManager, Object obj, MagnificationInfoChangedCallback magnificationInfoChangedCallback, MagnificationScaleProvider magnificationScaleProvider, Executor executor) {
        this(new ControllerContext(context, accessibilityTraceManager, (WindowManagerInternal) LocalServices.getService(WindowManagerInternal.class), new Handler(context.getMainLooper()), context.getResources().getInteger(R.integer.config_longAnimTime)), obj, magnificationInfoChangedCallback, magnificationScaleProvider, (Supplier) null, executor);
    }

    public FullScreenMagnificationController(final ControllerContext controllerContext, Object obj, MagnificationInfoChangedCallback magnificationInfoChangedCallback, MagnificationScaleProvider magnificationScaleProvider, Supplier supplier, Executor executor) {
        ...
        magnificationThumbnailFeatureFlag.addOnChangedListener(executor, new Runnable() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda0
    ...
    public void setForceShowMagnifiableBounds(int i, boolean z) {
        synchronized (this.mLock) {
            ...
            if (z) {
                Settings.Secure.putIntForUser(this.mControllerCtx.mContext.getContentResolver(), "accessibility_magnification_activated", 1, -2);
            }
    ...
    public void notifyImeWindowVisibilityChanged(final int i, final boolean z) {
        synchronized (this.mLock) {
            this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public final void onScreenTurnedOff() {
        this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda2
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public final void unregisterCallbackLocked(int i, boolean z) {
        ...
        boolean z2 = false;
        for (int i2 = 0; i2 < this.mDisplays.size() && !(z2 = ((DisplayMagnification) this.mDisplays.valueAt(i2)).isRegistered()); i2++) {
        }
        if (z2) {
            return;
        }
    ...
    /* loaded from: classes.dex */
    public class SpecAnimationBridge implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
