...
public class AutoclickController extends BaseEventStreamTransformation {
    ...
    public final class ClickScheduler implements Runnable {
        ...
        public final void sendClick() {
            ...
            long uptimeMillis = SystemClock.uptimeMillis();
            MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 0, 1, this.mTempPointerProperties, this.mTempPointerCoords, this.mMetaState, 1, 1.0f, 1.0f, this.mLastMotionEvent.getDeviceId(), 0, this.mLastMotionEvent.getSource(), this.mLastMotionEvent.getDisplayId(), this.mLastMotionEvent.getFlags());
