...
public class MotionEventInjector extends BaseEventStreamTransformation implements Handler.Callback {
    ...
    public void injectEvents(List list, IAccessibilityServiceClient iAccessibilityServiceClient, int i, int i2) {
    ...
    public final void injectEventsMainThread(List list, IAccessibilityServiceClient iAccessibilityServiceClient, int i, int i2) {
        if (this.mIsDestroyed) {
            try {
                ...
                Slog.e("MotionEventInjector", "Null pointer exception in injectEventsMainThread");
                return;
            }
        }
        if (getNext() == null) {
        ...
        List motionEventsFromGestureSteps = getMotionEventsFromGestureSteps(list, this.mSequencesInProgress.size() == 0 ? uptimeMillis : this.mLastScheduledEventTime);
        ...
        while (i3 < motionEventsFromGestureSteps.size()) {
            MotionEvent motionEvent = (MotionEvent) motionEventsFromGestureSteps.get(i3);
    ...
    public final boolean newGestureTriesToContinueOldOne(List list) {
        if (list.isEmpty()) {
            return false;
        }
        GestureDescription.GestureStep gestureStep = (GestureDescription.GestureStep) list.get(0);
    ...
    public final boolean prepareToContinueOldGesture(List list) {
    ...
    public final void cancelAnyGestureInProgress(int i) {
        if (getNext() != null) {
            ...
            if (((Boolean) sparseArray.get(i, bool)).booleanValue()) {
                long uptimeMillis = SystemClock.uptimeMillis();
    ...
    public final List getMotionEventsFromGestureSteps(List list, long j) {
        ArrayList arrayList = new ArrayList();
        GestureDescription.TouchPoint[] lastTouchPoints = getLastTouchPoints();
        for (int i = 0; i < list.size(); i++) {
            GestureDescription.GestureStep gestureStep = (GestureDescription.GestureStep) list.get(i);
    ...
    public final void appendMoveEventIfNeeded(List list, GestureDescription.TouchPoint[] touchPointArr, int i, long j) {
        GestureDescription.TouchPoint[] lastTouchPoints = getLastTouchPoints();
        boolean z = false;
    ...
    public final void appendUpEvents(List list, GestureDescription.TouchPoint[] touchPointArr, int i, long j) {
    ...
    public final void appendDownEvents(List list, GestureDescription.TouchPoint[] touchPointArr, int i, long j) {
        GestureDescription.TouchPoint[] lastTouchPoints = getLastTouchPoints();
        for (int i2 = 0; i2 < i; i2++) {
