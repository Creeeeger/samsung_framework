...
public class XmlUtils {
    ...
    /* loaded from: classes.dex */
    public class ForcedTypedXmlSerializer extends XmlSerializerWrapper implements TypedXmlSerializer {
        ...
        public XmlSerializer attributeInt(String str, String str2, int i) {
            return attribute(str, str2, Integer.toString(i));
        }

        public XmlSerializer attributeIntHex(String str, String str2, int i) {
        ...
        public XmlSerializer attributeFloat(String str, String str2, float f) {
            return attribute(str, str2, Float.toString(f));
        }

        public XmlSerializer attributeDouble(String str, String str2, double d) {
            return attribute(str, str2, Double.toString(d));
        }

        public XmlSerializer attributeBoolean(String str, String str2, boolean z) {
    ...
    /* loaded from: classes.dex */
    public class ForcedTypedXmlPullParser extends XmlPullParserWrapper implements TypedXmlPullParser {
        public ForcedTypedXmlPullParser(XmlPullParser xmlPullParser) {
            super(xmlPullParser);
        }

        public byte[] getAttributeBytesHex(int i) {
            try {
        ...
        public byte[] getAttributeBytesBase64(int i) {
            try {
        ...
        public int getAttributeIntHex(int i) {
            try {
        ...
        public long getAttributeLongHex(int i) {
            try {
    ...
    public static final void writeValueXml(Object obj, String str, TypedXmlSerializer typedXmlSerializer, WriteMapCallback writeMapCallback) {
        if (obj == null) {
            typedXmlSerializer.startTag((String) null, "null");
            if (str != null) {
                typedXmlSerializer.attribute((String) null, "name", str);
    ...
    public static final HashMap readThisMapXml(TypedXmlPullParser typedXmlPullParser, String str, String[] strArr) {
        return readThisMapXml(typedXmlPullParser, str, strArr, null);
    }

    public static final HashMap readThisMapXml(TypedXmlPullParser typedXmlPullParser, String str, String[] strArr, ReadMapCallback readMapCallback) {
    ...
    public static final ArrayMap readThisArrayMapXml(TypedXmlPullParser typedXmlPullParser, String str, String[] strArr, ReadMapCallback readMapCallback) {
    ...
    public static final ArrayList readThisListXml(TypedXmlPullParser typedXmlPullParser, String str, String[] strArr, ReadMapCallback readMapCallback, boolean z) {
    ...
    public static final HashSet readThisSetXml(TypedXmlPullParser typedXmlPullParser, String str, String[] strArr, ReadMapCallback readMapCallback, boolean z) {
    ...
    public static final Object readThisValueXml(TypedXmlPullParser typedXmlPullParser, String[] strArr, ReadMapCallback readMapCallback, boolean z) {
        int next;
    ...
    public static final Object readThisPrimitiveValueXml(TypedXmlPullParser typedXmlPullParser, String str) {
        if (str.equals("int")) {
