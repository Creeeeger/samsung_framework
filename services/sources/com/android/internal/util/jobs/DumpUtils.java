...
public final class DumpUtils {
    ...
    public static boolean isSecMediaPackage(String str) {
    ...
    public static boolean isSecMediaPackage(ComponentName componentName) {
    ...
    public static boolean isRoutinePackage(String str) {
        return str != null && "com.samsung.android.app.routines".equals(str);
    }

    public static boolean isRoutinePackage(ComponentName componentName) {
    ...
    public static Predicate filterRecord(final String str) {
        ...
        if (unflattenFromString != null) {
            return new Predicate() { // from class: com.android.internal.util.jobs.DumpUtils$$ExternalSyntheticLambda8
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
    ...
    public static void dumpSparseArrayValues(final PrintWriter printWriter, final String str, SparseArray sparseArray, String str2) {
        dumpSparseArray(printWriter, str, sparseArray, str2, new KeyDumper() { // from class: com.android.internal.util.jobs.DumpUtils$$ExternalSyntheticLambda10
