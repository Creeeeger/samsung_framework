...
import com.android.internal.art.ArtStatsLog$$ExternalSyntheticOutline0;
...
public final class FrameworkStatsLog {
    ...
    public static final int ADPF_SESSION_SNAPSHOT__SESSION_STATE__DEFAULT_SESSION_STATE = 0;
    public static final int ADPF_SESSION_SNAPSHOT__SESSION_STATE__PAUSE = 1;
    public static final int ADPF_SESSION_SNAPSHOT__SESSION_STATE__RESUME = 2;
    ...
    public static final int ADPF_SESSION_SNAPSHOT__UID_STATE__BACKGROUND = 2;
    public static final int ADPF_SESSION_SNAPSHOT__UID_STATE__DEFAULT_UID_STATE = 0;
    public static final int ADPF_SESSION_SNAPSHOT__UID_STATE__FOREGROUND = 1;
    public static final int ADPF_SYSTEM_COMPONENT_INFO = 10173;
    public static final int AI_FEATURE_ACCOUNTING = 100404;
    public static final int AI_FUNCTION_ACCOUNTING = 100405;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_FGSFILTER = 25;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_SLOWDOWN = 24;
    ...
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AEB_HDR_MERGE = 200;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AEB_HYBRID_HDR_MERGE = 201;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AIF_MERGE = 110;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_CLEAR_ZOOM_MERGE_OIS_ANCHOR_6 = 271;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_CLEAR_ZOOM_MERGE_ZSL_ANCHOR_6 = 270;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_HDR = 183;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_LLS = 185;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_HDR = 181;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_LLS = 184;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_SINGLE = 180;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_SINGLE_FLASH = 186;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_SINGLE = 182;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_ASTRO = 220;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_HDR = 41;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_HDR_QM_LT = 48;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_LLHDR = 42;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_LLS = 40;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_NIGHT = 45;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_NIGHT_REMOSAIC = 280;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_QM_LT = 47;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SINGLE = 46;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SR = 43;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SR_HDR = 44;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SUB_NIGHT = 49;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXECUTOR_NIGHT = 1000;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXECUTOR_TETRA_SR = 1001;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXPERT_RAW_MFRP_MERGE = 170;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_FUSION_HIGHRES_LLHDR_MERGE = 211;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_FUSION_HIGHRES_MERGE = 210;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_DEBLUR = 11;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_FLASH = 15;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_OIS = 12;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_SR = 13;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_ZSL = 14;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_PICK = 10;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIGHRES_LLHDR_MERGE = 91;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIGHRES_MERGE = 90;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_LOIS = 196;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_LZ = 195;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_QOIS = 198;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_QZ = 197;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_LOIS = 191;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_LZ = 190;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_QOIS = 193;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_QZ = 192;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_LOIS = 242;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_LZ = 240;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_QOIS = 243;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_QZ = 241;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LITE_LLHDR_MERGE = 101;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LITE_MERGE = 100;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LDEBLURVEHDR_QZM = 39;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LDEBLURVENR = 60;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LZT = 30;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM3_LOIST = 31;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM4 = 32;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM5_LCREMOSAIC = 33;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM6 = 34;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM7 = 35;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QZM5 = 37;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QZM7 = 38;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MACRO_RAW_SR_MERGE = 250;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_LZT = 20;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM3_LOIST = 22;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM4_LCREMOSAIC = 23;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM5 = 24;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM6 = 25;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM7 = 26;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QZM5 = 28;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QZM7 = 29;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_REMOSAIC = 21;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE = 70;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE_HDR = 71;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE_REMOSAIC = 75;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_UW_SR_MERGE = 130;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_PRO_RGB_CONVERSION = 230;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE = 160;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE_BRIGHT_SKY_MOON_HYBRID = 161;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE_HYBRID = 162;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_LLHDR_MERGE = 121;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_MERGE = 120;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_MFHDR_MERGE = 122;
    ...
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_EXTREME_DARK = 83;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_EXTREME_DARK_MAX = 86;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD = 80;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_MAX = 84;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_MAX_REMOSAIC = 88;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_REMOSAIC = 87;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_EXTREME_DARK = 261;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_HANDHELD = 260;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_HANDHELD_REMOSAIC = 262;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD = 81;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD_LE = 82;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD_MAX = 85;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SW_ND_FILTER = 221;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_TETRA_SR_MERGE = 290;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_AI_HIGHRES_MAX_RESOLUTION_HDR_MERGE = 145;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_AI_HIGHRES_MAX_RESOLUTION_MERGE = 144;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_HDR_MERGE = 141;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_MERGE = 140;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_SAQE = 142;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_SAQE_QMLT = 143;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_FORCE_HIDE_SOFT_INPUT = 60;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_HW_KEYBOARD_CONNECTED = 56;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_SCREEN_OFF_SECURE_LOCK_SCREEN_STATE = 59;
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_SETTINGS_BUTTON_CLICKED = 58;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_STATUS_BAR_ANIMATION = 57;
    ...
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_CANT_SAVE_STATE = 350;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_EMPTY = 500;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_FOREGROUND = 100;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_FOREGROUND_SERVICE = 125;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_GONE = 1000;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_PERCEPTIBLE = 230;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_PERCEPTIBLE_PRE_26 = 130;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_SERVICE = 300;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_TOP_SLEEPING = 325;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_TOP_SLEEPING_PRE_28 = 150;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_VISIBLE = 200;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BACKUP = 9;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 5;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BOUND_TOP = 3;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_ACTIVITY = 16;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 17;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_EMPTY = 19;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_RECENT = 18;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_FOREGROUND_SERVICE = 4;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_HEAVY_WEIGHT = 13;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_HOME = 14;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_IMPORTANT_BACKGROUND = 7;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_IMPORTANT_FOREGROUND = 6;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_LAST_ACTIVITY = 15;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_PERSISTENT = 0;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_PERSISTENT_UI = 1;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_RECEIVER = 11;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_SERVICE = 10;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TOP = 2;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TOP_SLEEPING = 12;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TRANSIENT_BACKGROUND = 8;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_UNKNOWN = -1;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_OLAF = 13;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_EDGE_OPEN_PANEL = 10002;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_NOTIFICATION_SHADE_QS_SHOW_DETAIL = 10001;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_RESERVED3 = 10003;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_RESERVED4 = 10004;
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3) {
        StatsEvent.Builder m = FrameworkStatsLog$$ExternalSyntheticOutline0.m(i, i2);
        if (10148 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
        m.writeInt(i3);
        return m.build();
    }
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
        ...
        newBuilder.writeInt(i4);
        newBuilder.writeInt(i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i6, i7, i8, i9);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14) {
        ...
        newBuilder.writeInt(i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i6, i7, i8, i9);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i10, i11, i12, i13);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i6, i7, i8, i9);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i10, i11, i12, i13);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i14, i15, i16, i17);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i18, i19, i20, i21);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        StatsEvent.Builder m = FrameworkStatsLog$$ExternalSyntheticOutline0.m(i, i2);
        if (10218 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i3, i4, i5, i6);
        m.writeBoolean(z);
        return m.build();
    }
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, String str, String str2, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20) {
        ...
        m.writeString(str);
        m.writeString(str2);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i5, i6, i7, i8);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i9, i10, i11, i12);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i13, i14, i15, i16);
        m.writeInt(i17);
        m.writeInt(i18);
        m.writeInt(i19);
        m.writeInt(i20);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, String str, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13) {
        ...
        m.writeInt(i4);
        m.writeInt(i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i6, i7, i8, i9);
        m.writeInt(i10);
        m.writeInt(i11);
        m.writeInt(i12);
        m.writeInt(i13);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, String str, int i3, int i4, int i5, int i6, long j, long j2, long j3, long j4, long j5) {
        StatsEvent.Builder m = FrameworkStatsLog$$ExternalSyntheticOutline0.m(i, i2);
        if (150400 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
    ...
    public static void write(int i, int i2, int i3) {
        ...
        if (27 == i) {
            m.addBooleanAnnotation((byte) 1, true);
            m.addBooleanAnnotation((byte) 3, true);
        }
        if (276 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
        ...
        m.writeInt(i3);
        if (27 == i) {
            m.addBooleanAnnotation((byte) 4, true);
            m.addBooleanAnnotation((byte) 8, false);
        }
        if (282 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
    ...
    public static void write(int i, int i2, int i3, float f, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        newBuilder.writeFloat(f);
        newBuilder.writeInt(i4);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i5, i6, i7, i8);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i9, i10, i11, i12);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i13, i14, i15, i16);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i17);
    }
    ...
    public static void write(int i, int i2, int i3, int i4, float f, float f2, int i5, int i6) {
        ...
        m.writeFloat(f2);
        m.writeInt(i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i6);
    }
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, boolean z, int i13, int i14, int i15, int i16, int i17, boolean z2, boolean z3, boolean z4, int i18, int i19, long j, long j2, int i20, int i21, int i22, int i23, int i24, int i25, boolean z5, boolean z6, long j3, long j4, int i26, long j5, long j6, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
        ...
        newBuilder.writeLong(j);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j2, i20, i21);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i22, i23, i24, i25);
        if (469 == i) {
            newBuilder.addBooleanAnnotation((byte) 1, true);
        }
        newBuilder.writeBoolean(z5);
        ...
        newBuilder.writeLong(j5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j6, i27, i28);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i29, i30, i31, i32);
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, boolean z, boolean z2, boolean z3, int i6, long j, int i7, int i8) {
        ...
        newBuilder.writeBoolean(z3);
        newBuilder.writeInt(i6);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j, i7, i8);
        if (604 == i) {
            newBuilder.addBooleanAnnotation((byte) 1, true);
        }
        newBuilder.usePooledBuffer();
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, int i6, int i7, int i8, boolean z, int i9) {
        ...
        m.writeByteArray(bArr2);
        if (bArr3 == null) {
            bArr3 = new byte[0];
        }
        m.writeByteArray(bArr3);
        if (bArr4 == null) {
            bArr4 = new byte[0];
        }
        m.writeByteArray(bArr4);
        m.writeInt(i6);
        m.writeInt(i7);
        m.writeInt(i8);
        m.writeBoolean(z);
    ...
    public static void write(int i, int i2, int i3, int i4, String str, int i5) {
        ...
        newBuilder.writeInt(i4);
        newBuilder.writeString(str);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i5);
    }
    ...
    public static void write(int i, int i2, int i3, int i4, boolean z, boolean z2, boolean z3, int i5) {
        ...
        m.writeBoolean(z2);
        m.writeBoolean(z3);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i5);
    }
    ...
    public static void write(int i, int i2, int i3, long j, int i4, int i5, int i6) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j, i4, i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i6);
    }
    ...
    public static void write(int i, int i2, int i3, long j, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i12);
    }
    ...
    public static void write(int i, int i2, int i3, String str, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i9);
    }
    ...
    public static void write(int i, int i2, int i3, String str, int i4, int i5, int i6, int i7, int i8, boolean z, String str2, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, float f, boolean z2, boolean z3, long j, boolean z4, long j2, int i19, boolean z5, int i20) {
        ...
        newBuilder.writeInt(i19);
        newBuilder.writeBoolean(z5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i20);
    }
    ...
    public static void write(int i, int i2, int i3, String str, int i4, int i5, int i6, int i7, long j, int i8, int i9, int i10, int i11, String str2) {
        ...
        newBuilder.writeInt(i6);
        newBuilder.writeInt(i7);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j, i8, i9);
        newBuilder.writeInt(i10);
        newBuilder.writeInt(i11);
        newBuilder.writeString(str2);
        newBuilder.usePooledBuffer();
    ...
    public static void write(int i, int i2, int i3, String str, int i4, long j, int i5, int i6, String str2, String str3, String str4, int i7, int i8) {
        ...
        m.writeString(str);
        m.writeInt(i4);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j, i5, i6);
        m.writeString(str2);
        m.writeString(str3);
        m.writeString(str4);
        m.writeInt(i7);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i8);
    }
    ...
    public static void write(int i, int i2, int i3, boolean z, int i4, int i5, int i6, int i7, int i8, int i9, boolean z2, int[] iArr, int[] iArr2, String[] strArr, int[] iArr3, String str, int[] iArr4, int[] iArr5, int i10, boolean z3, int i11, int i12, int i13) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i13);
    }
    ...
    public static void write(int i, int i2, long j, int i3, int i4) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j, i3, i4);
        if (761 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
        m.usePooledBuffer();
    ...
    public static void write(int i, int i2, long j, String str, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, long j2, long j3, long j4, long j5, long j6, long j7, long j8, float f, float f2, float f3, long j9, float f4, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, long j10, float f5, int[] iArr5, int[] iArr6) {
        ...
        m.writeString(str);
        m.writeInt(i3);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i4, i5, i6, i7);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i8, i9, i10, i11);
        m.writeLong(j2);
        m.writeLong(j3);
        m.writeLong(j4);
        m.writeLong(j5);
        ...
        m.writeLong(j9);
        m.writeFloat(f4);
        m.writeIntArray(iArr == null ? new int[0] : iArr);
        m.writeIntArray(iArr2 == null ? new int[0] : iArr2);
        m.writeIntArray(iArr3 == null ? new int[0] : iArr3);
        m.writeIntArray(iArr4 == null ? new int[0] : iArr4);
        m.writeLong(j10);
        m.writeFloat(f5);
        m.writeIntArray(iArr5 == null ? new int[0] : iArr5);
        m.writeIntArray(iArr6 == null ? new int[0] : iArr6);
        m.usePooledBuffer();
        StatsLog.write(m.build());
    }
    ...
    public static void write(int i, int i2, long j, String str, int i3, boolean z, boolean z2, int i4, int i5, int i6, int i7, long j2, int i8, int i9, int i10, int i11, int i12) {
        ...
        m.writeLong(j2);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i8, i9, i10, i11);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i12);
    }
    ...
    public static void write(int i, int i2, String str, int i3, int i4, int i5, int i6, int i7) {
        StatsEvent.Builder m = FrameworkStatsLog$$ExternalSyntheticOutline0.m(i, i2);
        if (100405 == i) {
            m.addBooleanAnnotation((byte) 1, true);
        }
    ...
    public static void write(int i, int i2, String str, int i3, long j, int i4) {
        ...
        m.writeInt(i3);
        m.writeLong(j);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i4);
    }
    ...
    public static void write(int i, int i2, String str, int i3, long j, long j2, long j3, long j4, long j5, long j6, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
        ...
        m.writeLong(j4);
        m.writeLong(j5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j6, i4, i5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i6, i7, i8, i9);
        m.writeInt(i10);
        m.writeInt(i11);
        m.usePooledBuffer();
    ...
    public static void write(int i, int i2, String str, int i3, String str2, int i4, String str3, String str4) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeString(str);
    ...
    public static void write(int i, int i2, String str, int i3, String str2, boolean z, long j, int i4, int i5, int i6, int i7, boolean z2, boolean z3, int i8, long j2) {
        ...
        m.writeString(str2);
        m.writeBoolean(z);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j, i4, i5);
        m.writeInt(i6);
        m.writeInt(i7);
        m.writeBoolean(z2);
        m.writeBoolean(z3);
    ...
    public static void write(int i, int i2, String str, int i3, boolean z, int i4, int i5, int i6, int i7, int i8, boolean z2, boolean z3, int i9, int i10, int i11, boolean z4, int i12, int i13, boolean z5, int i14, int i15, int i16, int[] iArr, long[] jArr, int i17, int i18, int i19, int i20, long j, long j2, int i21, int i22, int i23, int i24, int i25, int i26, int i27, boolean z6) {
        ...
        m.writeInt(i16);
        m.writeIntArray(iArr == null ? new int[0] : iArr);
        m.writeLongArray(jArr == null ? new long[0] : jArr);
        m.writeInt(i17);
        m.writeInt(i18);
        m.writeInt(i19);
        m.writeInt(i20);
        m.writeLong(j);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j2, i21, i22);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, i23, i24, i25, i26);
        m.writeInt(i27);
        m.writeBoolean(z6);
        m.usePooledBuffer();
        StatsLog.write(m.build());
    ...
    public static void write(int i, int i2, String str, String str2, int i3, String str3, int i4, int i5, int i6, boolean z, float f, long j, int i7, int i8, boolean z2, long j2, long j3, int i9, int i10, int i11, long j4, int i12, long j5) {
        ...
        m.writeBoolean(z2);
        m.writeLong(j2);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j3, i9, i10);
        m.writeInt(i11);
        m.writeLong(j4);
        m.writeInt(i12);
        m.writeLong(j5);
    ...
    public static void write(int i, int i2, String str, String str2, String str3, int i3, int i4, int i5, String str4, boolean z, float f, long j, int i6, int i7, boolean z2, long j2, long j3, int i8, int i9, int i10, long j4, int i11, long j5) {
        ...
        m.writeBoolean(z2);
        m.writeLong(j2);
        ArtStatsLog$$ExternalSyntheticOutline0.m(m, j3, i8, i9);
        m.writeInt(i10);
        m.writeLong(j4);
        m.writeInt(i11);
        m.writeLong(j5);
    ...
    public static void write(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i3, int i4, boolean z, boolean z2) {
        ...
        m.writeIntArray(iArr3);
        if (iArr4 == null) {
            iArr4 = new int[0];
        }
        m.writeIntArray(iArr4);
        m.writeInt(i3);
        m.writeInt(i4);
        m.writeBoolean(z);
        m.writeBoolean(z2);
    ...
    public static void write(int i, long j, int i2, int i3, int i4) {
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i4);
    }
    ...
    public static void write(int i, long j, int i2, int i3, int i4, int i5, int i6) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeLong(j);
        newBuilder.writeInt(i2);
    ...
    public static void write(int i, long j, int i2, String str, int i3, String str2, int i4, boolean z, int i5, int i6, int i7, long j2, long j3, boolean z2, int i8, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, String str3, int i9, long j4, int i10, int i11, boolean z3, boolean z4, boolean z5, int i12, int i13, int i14) {
        ...
        newBuilder.writeString(str3);
        newBuilder.writeInt(i9);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j4, i10, i11);
        newBuilder.writeBoolean(z3);
        newBuilder.writeBoolean(z4);
        newBuilder.writeBoolean(z5);
        newBuilder.writeInt(i12);
    ...
    public static void write(int i, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, int i2, int i3, int i4) {
        ...
        newBuilder.writeLong(j14);
        newBuilder.writeLong(j15);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j16, i2, i3);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i4);
    }
    ...
    public static void write(int i, long j, String str, long j2, long j3, String str2, String str3, String str4, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, String str5, long j4, long j5, long j6, long j7, long j8, int i13, int i14, String str6, int i15, long j9, long j10, String str7, int i16, int i17, long j11, long j12, long j13, long j14, long j15, int i18, float f, float f2, float f3, int i19, int i20, int i21, int i22, int i23, int i24, int i25, int i26, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34, int i35, int i36, int i37, int i38, int i39, int i40, int i41, int i42, long j16, int i43, int i44, int i45, int i46, int i47, int i48, int i49, int i50, int i51, int i52, int i53, long j17) {
        ...
        newBuilder.writeLong(j6);
        newBuilder.writeLong(j7);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j8, i13, i14);
        newBuilder.writeString(str6);
        newBuilder.writeInt(i15);
        newBuilder.writeLong(j9);
        newBuilder.writeLong(j10);
        ...
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i21, i22, i23, i24);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i25, i26, i27, i28);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i29, i30, i31, i32);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i33, i34, i35, i36);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i37, i38, i39, i40);
        newBuilder.writeInt(i41);
        newBuilder.writeInt(i42);
        newBuilder.writeLong(j16);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i43, i44, i45, i46);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i47, i48, i49, i50);
    ...
    public static void write(int i, WorkSource workSource, int i2, int i3, int i4, boolean z, int i5, int i6, int i7, long j, long j2, long j3, long j4, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i15, int i16, float f) {
        for (int i17 = 0; i17 < workSource.size(); i17++) {
            write_non_chained(i, workSource.getUid(i17), workSource.getPackageName(i17), i2, i3, i4, z, i5, i6, i7, j, j2, j3, j4, i8, i9, i10, i11, i12, i13, i14, iArr, iArr2, iArr3, iArr4, i15, i16, f);
        }
        List<WorkSource.WorkChain> workChains = workSource.getWorkChains();
        if (workChains != null) {
            for (WorkSource.WorkChain workChain : workChains) {
                write(i, workChain.getUids(), workChain.getTags(), i2, i3, i4, z, i5, i6, i7, j, j2, j3, j4, i8, i9, i10, i11, i12, i13, i14, iArr, iArr2, iArr3, iArr4, i15, i16, f);
            }
        }
    }
    ...
    public static void write(int i, boolean z, boolean z2, boolean z3, boolean z4, int i2) {
        ...
        newBuilder.writeBoolean(z3);
        newBuilder.writeBoolean(z4);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i2);
    }
    ...
    public static void write(int i, int[] iArr, String[] strArr, int i2, int i3, int i4, boolean z, int i5, int i6, int i7, long j, long j2, long j3, long j4, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int i15, int i16, float f) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        ...
        newBuilder.writeLong(j2);
        newBuilder.writeLong(j3);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j4, i8, i9);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, i10, i11, i12, i13);
        newBuilder.writeInt(i14);
        newBuilder.writeIntArray(iArr2 == null ? new int[0] : iArr2);
        newBuilder.writeIntArray(iArr3 == null ? new int[0] : iArr3);
    ...
    public static void write(int i, int[] iArr, String[] strArr, String str, int i2, int i3, int i4, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, boolean z11, int i6, int i7, int i8, long j2, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, boolean z18, boolean z19, long j3, boolean z20, boolean z21, boolean z22, long j4, long j5, long j6, int i9, int i10, String str2, long j7, long j8, long j9, long j10, long j11, long j12, boolean z23, boolean z24, boolean z25, int i11, int i12, String str3, String[] strArr2) {
        ...
        newBuilder.writeLong(j4);
        newBuilder.writeLong(j5);
        ArtStatsLog$$ExternalSyntheticOutline0.m(newBuilder, j6, i9, i10);
        newBuilder.writeString(str2);
        newBuilder.writeLong(j7);
        newBuilder.writeLong(j8);
        newBuilder.writeLong(j9);
    ...
    public static void write_non_chained(int i, int i2, String str, int i3, int i4, int i5, boolean z, int i6, int i7, int i8, long j, long j2, long j3, long j4, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i16, int i17, float f) {
        write(i, new int[]{i2}, new String[]{str}, i3, i4, i5, z, i6, i7, i8, j, j2, j3, j4, i9, i10, i11, i12, i13, i14, i15, iArr, iArr2, iArr3, iArr4, i16, i17, f);
    }
