...
public class SpecialEncoder extends AbstractEncoder {
    ...
    public void encode(Special special) {
        switch (AnonymousClass1.$SwitchMap$co$nstant$in$cbor$model$SpecialType[special.getSpecialType().ordinal()]) {
            case 1:
                write(IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                return;
            case 2:
