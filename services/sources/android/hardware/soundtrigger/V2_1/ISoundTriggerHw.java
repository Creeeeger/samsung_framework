...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_0.ISoundTriggerHw {
    ...
    void loadPhraseSoundModel_2_1(PhraseSoundModel phraseSoundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadPhraseSoundModel_2_1Callback loadphrasesoundmodel_2_1callback);

    void loadSoundModel_2_1(SoundModel soundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadSoundModel_2_1Callback loadsoundmodel_2_1callback);

    int startRecognition_2_1(int i, RecognitionConfig recognitionConfig, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i2);

    static ISoundTriggerHw asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.soundtrigger@2.1::ISoundTriggerHw");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.soundtrigger@2.1::ISoundTriggerHw")) {
                    return proxy;
                }
            }
    ...
    public final class PhraseSoundModel {
        ...
        public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
            ...
            for (int i = 0; i < size; i++) {
                ((ISoundTriggerHw.Phrase) this.phrases.get(i)).writeEmbeddedToBlob(hwBlob2, i * 56);
            }
    ...
    public final class Proxy implements ISoundTriggerHw {
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public void loadSoundModel(ISoundTriggerHw.SoundModel soundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, ISoundTriggerHw.loadSoundModelCallback loadsoundmodelcallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.soundtrigger@2.0::ISoundTriggerHw");
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public void loadPhraseSoundModel(ISoundTriggerHw.PhraseSoundModel phraseSoundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, ISoundTriggerHw.loadPhraseSoundModelCallback loadphrasesoundmodelcallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.soundtrigger@2.0::ISoundTriggerHw");
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public int startRecognition(int i, ISoundTriggerHw.RecognitionConfig recognitionConfig, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i2) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.soundtrigger@2.0::ISoundTriggerHw");
            hwParcel.writeInt32(i);
        ...
        public void loadSoundModel_2_1(SoundModel soundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadSoundModel_2_1Callback loadsoundmodel_2_1callback) {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override // android.hardware.soundtrigger.V2_1.ISoundTriggerHw
        public void loadPhraseSoundModel_2_1(PhraseSoundModel phraseSoundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadPhraseSoundModel_2_1Callback loadphrasesoundmodel_2_1callback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.soundtrigger@2.1::ISoundTriggerHw");
            phraseSoundModel.writeToParcel(hwParcel);
            hwParcel.writeStrongBinder(iSoundTriggerHwCallback == null ? null : iSoundTriggerHwCallback.asBinder());
        ...
        @Override // android.hardware.soundtrigger.V2_1.ISoundTriggerHw
        public int startRecognition_2_1(int i, RecognitionConfig recognitionConfig, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i2) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.soundtrigger@2.1::ISoundTriggerHw");
            hwParcel.writeInt32(i);
            recognitionConfig.writeToParcel(hwParcel);
    ...
    public abstract class Stub extends HwBinder implements ISoundTriggerHw {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.soundtrigger@2.1::ISoundTriggerHw";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.soundtrigger@2.1::ISoundTriggerHw", "android.hardware.soundtrigger@2.0::ISoundTriggerHw", IBase.kInterfaceName));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.soundtrigger@2.1::ISoundTriggerHw".equals(str)) {
                return this;
            }
            return null;
        }
