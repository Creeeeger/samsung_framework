...
public class SensorProps implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: android.hardware.biometrics.face.SensorProps.1
    ...
    public float enrollTranslationX = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
    public float enrollTranslationY = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
    public float enrollPreviewScale = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
