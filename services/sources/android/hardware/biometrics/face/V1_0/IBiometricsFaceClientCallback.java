...
public interface IBiometricsFaceClientCallback extends IBase {
    ...
    void onAcquired(int i, int i2, int i3, long j);

    void onAuthenticated(long j, int i, int i2, ArrayList arrayList);

    void onEnrollResult(int i, int i2, int i3, long j);

    void onEnumerate(int i, long j, ArrayList arrayList);

    void onError(int i, int i2, int i3, long j);

    void onRemoved(int i, long j, ArrayList arrayList);
}
