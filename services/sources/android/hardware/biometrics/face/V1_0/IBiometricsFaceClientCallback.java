...
public interface IBiometricsFaceClientCallback extends IBase {
    ...
    void onEnumerate(long j, ArrayList arrayList, int i);

    void onError(long j, int i, int i2, int i3);

    void onLockoutChanged(long j);

    void onRemoved(long j, ArrayList arrayList, int i);

    static IBiometricsFaceClientCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback");
    ...
    /* loaded from: classes.dex */
    public final class Proxy implements IBiometricsFaceClientCallback {
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements IBiometricsFaceClientCallback {
        @Override // android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-74, -27, 93, 119, -107, -69, -81, -48, 17, -5, -107, -93, -74, -45, -107, 75, -10, 108, 52, -98, 20, -49, HwConstants.IQ_CONFIG_POS_NETWORK_ENABLED, Byte.MAX_VALUE, 59, 114, 3, 44, -29, -50, -76, 72}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback".equals(str)) {
                return this;
            }
            return null;
        }
