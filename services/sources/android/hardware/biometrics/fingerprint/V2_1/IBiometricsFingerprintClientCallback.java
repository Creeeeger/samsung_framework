...
public interface IBiometricsFingerprintClientCallback extends IBase {
    ...
    void onAcquired(long j, int i, int i2);

    void onAuthenticated(long j, int i, int i2, ArrayList arrayList);

    void onEnrollResult(long j, int i, int i2, int i3);

    void onEnumerate(long j, int i, int i2, int i3);

    void onError(long j, int i, int i2);

    void onRemoved(long j, int i, int i2, int i3);

    static IBiometricsFingerprintClientCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback")) {
                    return proxy;
                }
            }
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements IBiometricsFingerprintClientCallback {
        @Override // android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-86, -69, 92, 60, 88, 85, -110, -41, 30, -27, 123, 119, 41, -116, 20, -103, 61, 119, -111, 77, -34, -86, 100, -78, -59, HwConstants.IQ_CONFIG_POS_NETWORK_ENABLED, -102, 96, 43, 2, -22, 71}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
