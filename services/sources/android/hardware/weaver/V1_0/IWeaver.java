...
public interface IWeaver extends IBase {
    ...
    public abstract class Stub extends HwBinder implements IWeaver {
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.weaver@1.0::IWeaver", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-101, -60, 52, 19, -72, 12, -48, -59, -102, 2, 46, -109, -38, 20, 72, -36, -72, 45, -47, 12, 109, -45, 25, 50, -33, 70, 89, -28, -67, -53, 19, 104}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
