...
public interface IHdmiCecCallback extends IBase {
    ...
    void onHotplugEvent(HotplugEvent hotplugEvent);

    static IHdmiCecCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.tv.cec@1.0::IHdmiCecCallback");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.tv.cec@1.0::IHdmiCecCallback")) {
                    return proxy;
                }
            }
