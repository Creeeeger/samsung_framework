...
public interface IBootControl extends android.hardware.boot.V1_0.IBootControl {
    ...
    boolean setSnapshotMergeStatus(int i);

    static IBootControl asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.boot@1.1::IBootControl");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.boot@1.1::IBootControl")) {
                    return proxy;
                }
            }
    ...
    public abstract class Stub extends HwBinder implements IBootControl {
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.boot@1.1::IBootControl", "android.hardware.boot@1.0::IBootControl", IBase.kInterfaceName));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.boot@1.1::IBootControl".equals(str)) {
                return this;
            }
            return null;
        }
