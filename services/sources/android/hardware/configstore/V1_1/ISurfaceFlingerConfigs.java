...
public interface ISurfaceFlingerConfigs extends android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
    ...
    static ISurfaceFlingerConfigs asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.configstore@1.1::ISurfaceFlingerConfigs");
    ...
    static ISurfaceFlingerConfigs getService(String str) {
        return asInterface(HwBinder.getService("android.hardware.configstore@1.1::ISurfaceFlingerConfigs", str));
    }
    ...
    public final class Proxy implements ISurfaceFlingerConfigs {
        ...
        @Override // android.hardware.configstore.V1_1.ISurfaceFlingerConfigs, android.hidl.base.V1_0.IBase
    ...
    public abstract class Stub extends HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.configstore@1.1::ISurfaceFlingerConfigs", "android.hardware.configstore@1.0::ISurfaceFlingerConfigs", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-8, 88, 9, 27, HwConstants.IQ_CONFIG_POS_NETWORK_ENABLED, -9, -43, -110, 123, -26, 5, 115, -64, 109, -12, Byte.MIN_VALUE, 82, 117, -45, 114, 38, -69, -76, 26, 115, 33, -112, -65, -72, 20, 87, -20}, new byte[]{-38, 51, 35, 68, 3, -1, 93, 96, -13, 71, 55, 17, -111, 123, -103, 72, -26, 72, 74, 66, 96, -75, 36, 122, -51, -81, -79, 17, 25, 58, -99, -30}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
