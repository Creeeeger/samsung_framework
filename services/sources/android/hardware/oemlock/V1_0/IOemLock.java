...
public interface IOemLock extends IBase {
    ...
    void getName(getNameCallback getnamecallback);

    @Override // android.hidl.base.V1_0.IBase
    ArrayList interfaceChain();

    void isOemUnlockAllowedByCarrier(isOemUnlockAllowedByCarrierCallback isoemunlockallowedbycarriercallback);

    void isOemUnlockAllowedByDevice(isOemUnlockAllowedByDeviceCallback isoemunlockallowedbydevicecallback);

    int setOemUnlockAllowedByCarrier(boolean z, ArrayList arrayList);

    int setOemUnlockAllowedByDevice(boolean z);
    ...
    static IOemLock getService(String str, boolean z) {
        return asInterface(HwBinder.getService("android.hardware.oemlock@1.0::IOemLock", str, z));
    }

    static IOemLock getService(boolean z) {
    ...
    public final class Proxy implements IOemLock {
        ...
        public void getName(getNameCallback getnamecallback) {
        ...
        @Override // android.hardware.oemlock.V1_0.IOemLock
        public int setOemUnlockAllowedByCarrier(boolean z, ArrayList arrayList) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
        ...
        @Override // android.hardware.oemlock.V1_0.IOemLock
        public void isOemUnlockAllowedByCarrier(isOemUnlockAllowedByCarrierCallback isoemunlockallowedbycarriercallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        @Override // android.hardware.oemlock.V1_0.IOemLock
        public int setOemUnlockAllowedByDevice(boolean z) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
            hwParcel.writeBool(z);
            HwParcel hwParcel2 = new HwParcel();
        ...
        @Override // android.hardware.oemlock.V1_0.IOemLock
        public void isOemUnlockAllowedByDevice(isOemUnlockAllowedByDeviceCallback isoemunlockallowedbydevicecallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements IOemLock {
        @Override // android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{75, 101, 118, 54, 99, -87, 74, 57, HwConstants.IQ_CONFIG_POS_WIFI_ENABLED, 19, 64, 17, 105, 31, -113, -69, 66, -52, -73, -73, 121, 85, -119, -17, -35, -64, 73, -87, HwConstants.IQ_CONFIG_POS_NETWORK_ENABLED, 96, 71, -42}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
