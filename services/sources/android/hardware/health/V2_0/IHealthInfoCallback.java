...
public interface IHealthInfoCallback extends IBase {
    ...
    static IHealthInfoCallback asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.health@2.0::IHealthInfoCallback");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.health@2.0::IHealthInfoCallback")) {
                    return proxy;
                }
            }
    ...
    /* loaded from: classes.dex */
    public final class Proxy implements IHealthInfoCallback {
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements IHealthInfoCallback {
        @Override // android.hardware.health.V2_0.IHealthInfoCallback, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.health@2.0::IHealthInfoCallback";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.health@2.0::IHealthInfoCallback", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{67, 76, 76, 50, -64, MM05.IQ_SIP_CALL_STATE_DISCONNECTING, 14, 84, -69, 5, -28, 12, 121, 80, 50, 8, -76, 15, 120, 106, 49, Byte.MIN_VALUE, 41, -94, -92, -10, 110, 52, -15, 15, 42, 118}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.health@2.0::IHealthInfoCallback".equals(str)) {
                return this;
            }
            return null;
        }
