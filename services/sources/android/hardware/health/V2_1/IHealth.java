...
public interface IHealth extends android.hardware.health.V2_0.IHealth {
    ...
    void getHealthConfig(getHealthConfigCallback gethealthconfigcallback);

    void getHealthInfo_2_1(getHealthInfo_2_1Callback gethealthinfo_2_1callback);

    void shouldKeepScreenOn(shouldKeepScreenOnCallback shouldkeepscreenoncallback);
    ...
    public final class Proxy implements IHealth {
        ...
        public int registerCallback(android.hardware.health.V2_0.IHealthInfoCallback iHealthInfoCallback) {
        ...
        @Override // android.hardware.health.V2_0.IHealth
        public int unregisterCallback(android.hardware.health.V2_0.IHealthInfoCallback iHealthInfoCallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.health@2.0::IHealth");
            hwParcel.writeStrongBinder(iHealthInfoCallback == null ? null : iHealthInfoCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
