...
public interface IHealthInfoCallback extends android.hardware.health.V2_0.IHealthInfoCallback {
    void healthInfoChanged_2_1(HealthInfo healthInfo);
    ...
    public abstract class Stub extends HwBinder implements IHealthInfoCallback {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.health@2.1::IHealthInfoCallback";
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.health@2.1::IHealthInfoCallback".equals(str)) {
                return this;
            }
            return null;
        }
