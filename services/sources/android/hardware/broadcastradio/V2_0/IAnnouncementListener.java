...
public interface IAnnouncementListener extends IBase {
    ...
    static IAnnouncementListener asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.broadcastradio@2.0::IAnnouncementListener");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.broadcastradio@2.0::IAnnouncementListener")) {
                    return proxy;
                }
            }
    ...
    /* loaded from: classes.dex */
    public final class Proxy implements IAnnouncementListener {
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements IAnnouncementListener {
        @Override // android.hardware.broadcastradio.V2_0.IAnnouncementListener, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
