...
public interface ITunerCallback extends IBase {
    ...
    void onParametersUpdated(ArrayList arrayList);
    ...
    static ITunerCallback asInterface(IHwBinder iHwBinder) {
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.broadcastradio@2.0::ITunerCallback")) {
                    return proxy;
                }
            }
    ...
    /* loaded from: classes.dex */
    public final class Proxy implements ITunerCallback {
    ...
    /* loaded from: classes.dex */
    public abstract class Stub extends HwBinder implements ITunerCallback {
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
