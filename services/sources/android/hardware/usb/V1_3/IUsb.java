...
public interface IUsb extends android.hardware.usb.V1_2.IUsb {
    boolean enableUsbDataSignal(boolean z);
    ...
    static IUsb asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.usb@1.3::IUsb");
    ...
    public abstract class Stub extends HwBinder implements IUsb {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.usb@1.3::IUsb";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.usb@1.3::IUsb", "android.hardware.usb@1.2::IUsb", "android.hardware.usb@1.1::IUsb", "android.hardware.usb@1.0::IUsb", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-68, -21, -37, MM05.IQ_SIP_CALL_STATE_DISCONNECTING, 59, 89, -67, 20, 78, -17, -63, -79, 122, -87, 102, 9, -63, -78, 59, -55, -91, -9, -32, -41, 6, 13, -85, -41, -16, 110, -7, -64}, new byte[]{97, -68, 48, 46, 124, -105, 76, 89, -78, 88, -104, -59, -123, -58, -23, 104, 94, -118, -127, 2, 27, 27, -19, 62, -19, -11, 34, 65, -104, -14, 120, 90}, new byte[]{-82, -68, -39, -1, 45, -96, 92, -99, 76, 67, -103, 22, -12, 13, -3, 33, -101, -89, 98, -103, 25, 0, 124, -71, -127, -21, -15, 80, 6, 75, 79, -126}, new byte[]{78, -11, 116, -103, 39, 63, 56, -67, -67, -48, -63, 94, 86, -18, 122, 75, -59, -15, -118, 86, 68, 9, 33, 112, -91, 49, -33, 53, 65, -39, -32, 21}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.usb@1.3::IUsb".equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) {
            switch (i) {
                ...
                case 5:
                    ...
                    return;
                case 6:
                    hwParcel.enforceInterface("android.hardware.usb@1.3::IUsb");
