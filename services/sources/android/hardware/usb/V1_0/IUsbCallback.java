...
public interface IUsbCallback extends IBase {
    ...
    static IUsbCallback asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.usb@1.0::IUsbCallback");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("android.hardware.usb@1.0::IUsbCallback")) {
                    return proxy;
                }
            }
    ...
    public abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.usb@1.0::IUsbCallback";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.usb@1.0::IUsbCallback", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{75, -25, -120, 30, 65, 27, -92, 39, -124, -65, 91, 115, 84, -63, 74, -32, -49, 22, HwConstants.IQ_CONFIG_POS_NETWORK_ENABLED, 4, -45, -108, 51, -86, -20, -86, -80, -47, -98, -87, -109, 84}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.usb@1.0::IUsbCallback".equals(str)) {
                return this;
            }
            return null;
        }
