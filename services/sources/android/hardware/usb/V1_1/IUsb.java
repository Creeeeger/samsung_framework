...
public interface IUsb extends android.hardware.usb.V1_0.IUsb {
    ...
    static IUsb asInterface(IHwBinder iHwBinder) {
        ...
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.usb@1.1::IUsb");
    ...
    public abstract class Stub extends HwBinder implements IUsb {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.usb@1.1::IUsb";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.usb@1.1::IUsb", "android.hardware.usb@1.0::IUsb", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{-82, -68, -39, -1, 45, -96, 92, -99, 76, 67, -103, 22, -12, 13, -3, 33, -101, -89, 98, -103, 25, 0, 124, -71, -127, -21, -15, 80, 6, 75, 79, -126}, new byte[]{78, -11, 116, -103, 39, 63, 56, -67, -67, -48, -63, 94, 86, -18, 122, 75, -59, -15, -118, 86, 68, 9, 33, 112, -91, 49, -33, 53, 65, -39, -32, 21}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.usb@1.1::IUsb".equals(str)) {
                return this;
            }
            return null;
        }
