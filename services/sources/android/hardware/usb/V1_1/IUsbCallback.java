...
public interface IUsbCallback extends android.hardware.usb.V1_0.IUsbCallback {
    ...
    public abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final String interfaceDescriptor() {
            return "android.hardware.usb@1.1::IUsbCallback";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("android.hardware.usb@1.1::IUsbCallback", "android.hardware.usb@1.0::IUsbCallback", IBase.kInterfaceName));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("android.hardware.usb@1.1::IUsbCallback".equals(str)) {
                return this;
            }
            return null;
        }
