...
public class AddMslAltitudeToLocationRequest implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: android.frameworks.location.altitude.AddMslAltitudeToLocationRequest.1
    ...
    public float verticalAccuracyMeters = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
