...
public interface INetdEventListener extends IInterface {
    ...
    void onConnectEvent(int i, int i2, int i3, String str, int i4, int i5);

    void onDnsEvent(int i, int i2, int i3, int i4, String str, String[] strArr, int i5, int i6);

    void onNat64PrefixEvent(int i, boolean z, String str, int i2);
    ...
    void onWakeupEvent(String str, int i, int i2, int i3, byte[] bArr, String str2, String str3, int i4, int i5, long j);
    ...
    public abstract class Stub extends Binder implements INetdEventListener {
        ...
        /* loaded from: classes.dex */
        public class Proxy implements INetdEventListener {
