...
public interface IIpMemoryStore extends IInterface {
    ...
    public class Default implements IIpMemoryStore {
        ...
        public void delete(String str, boolean z, IOnStatusAndCountListener iOnStatusAndCountListener) {
        }
    ...
    void delete(String str, boolean z, IOnStatusAndCountListener iOnStatusAndCountListener);

    void deleteCluster(String str, boolean z, IOnStatusAndCountListener iOnStatusAndCountListener);

    void factoryReset();

    void findL2Key(NetworkAttributesParcelable networkAttributesParcelable, IOnL2KeyResponseListener iOnL2KeyResponseListener);

    String getInterfaceHash();

    int getInterfaceVersion();

    void isSameNetwork(String str, String str2, IOnSameL3NetworkResponseListener iOnSameL3NetworkResponseListener);

    void retrieveBlob(String str, String str2, String str3, IOnBlobRetrievedListener iOnBlobRetrievedListener);

    void retrieveNetworkAttributes(String str, IOnNetworkAttributesRetrievedListener iOnNetworkAttributesRetrievedListener);
    ...
    public abstract class Stub extends Binder implements IIpMemoryStore {
        ...
        /* loaded from: classes.dex */
        public class Proxy implements IIpMemoryStore {
