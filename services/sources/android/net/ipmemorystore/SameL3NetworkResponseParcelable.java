...
public class SameL3NetworkResponseParcelable implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: android.net.ipmemorystore.SameL3NetworkResponseParcelable.1
    ...
    public float confidence = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
