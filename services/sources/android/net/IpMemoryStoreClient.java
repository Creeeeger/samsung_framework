...
public abstract class IpMemoryStoreClient {
    ...
    public abstract void runWhenServiceReady(Consumer consumer);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$findL2Key$6(IIpMemoryStore iIpMemoryStore, NetworkAttributes networkAttributes, OnL2KeyResponseListener onL2KeyResponseListener) {
        iIpMemoryStore.findL2Key(networkAttributes.toParcelable(), OnL2KeyResponseListener.toAIDL(onL2KeyResponseListener));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$findL2Key$8(OnL2KeyResponseListener onL2KeyResponseListener) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$isSameNetwork$9(IIpMemoryStore iIpMemoryStore, String str, String str2, OnSameL3NetworkResponseListener onSameL3NetworkResponseListener) {
        iIpMemoryStore.isSameNetwork(str, str2, OnSameL3NetworkResponseListener.toAIDL(onSameL3NetworkResponseListener));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$isSameNetwork$11(OnSameL3NetworkResponseListener onSameL3NetworkResponseListener) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$delete$18(IIpMemoryStore iIpMemoryStore, String str, boolean z, OnDeleteStatusListener onDeleteStatusListener) {
        iIpMemoryStore.delete(str, z, OnDeleteStatusListener.toAIDL(onDeleteStatusListener));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$delete$20(OnDeleteStatusListener onDeleteStatusListener) {
