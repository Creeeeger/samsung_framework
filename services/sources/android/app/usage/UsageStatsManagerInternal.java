...
public abstract class UsageStatsManagerInternal {
    ...
    public abstract void deleteDailyStatsFiles();
    ...
    public abstract List queryUsageStatsForUser(int i, int i2, long j, long j2, boolean z);
    ...
    public abstract void reportEvent(ComponentName componentName, int i, int i2, int i3, ComponentName componentName2, Intent intent);
    ...
    public abstract void setActiveAdminApps(Set set, int i);

    public abstract void setAdminProtectedPackages(Set set, int i);
    ...
    /* loaded from: classes.dex */
    public class AppUsageLimitData {
