...
public interface ISehBiometricsFingerprint extends IBiometricsFingerprint {
    ...
    static ISehBiometricsFingerprint asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("vendor.samsung.hardware.biometrics.fingerprint@3.0::ISehBiometricsFingerprint");
    ...
    static ISehBiometricsFingerprint getService(String str) {
        return asInterface(HwBinder.getService("vendor.samsung.hardware.biometrics.fingerprint@3.0::ISehBiometricsFingerprint", str));
    }
    ...
    public final class Proxy implements ISehBiometricsFingerprint {
        ...
        public void sehRequest(int i, int i2, ArrayList arrayList, sehRequestCallback sehrequestcallback) {
            HwParcel hwParcel = new HwParcel();
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                sehrequestcallback.onValues(hwParcel2.readInt32(), hwParcel2.readInt8Vector());
            } finally {
                hwParcel2.release();
            }
        }

        @Override // vendor.samsung.hardware.biometrics.fingerprint.V3_0.ISehBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
    ...
    /* loaded from: classes2.dex */
    public abstract class Stub extends HwBinder implements ISehBiometricsFingerprint {
        @Override // android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
            switch (i) {
                ...
                case 11:
                    ...
                    sehRequest(hwParcel.readInt32(), hwParcel.readInt32(), hwParcel.readInt8Vector(), new sehRequestCallback() { // from class: vendor.samsung.hardware.biometrics.fingerprint.V3_0.ISehBiometricsFingerprint.Stub.1
