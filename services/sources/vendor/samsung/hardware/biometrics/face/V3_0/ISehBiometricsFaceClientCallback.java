...
public interface ISehBiometricsFaceClientCallback extends vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFaceClientCallback {
    ...
    void sehOnAuthenticatedFromMemory(long j, int i, int i2, ArrayList arrayList, HidlMemory hidlMemory);

    static ISehBiometricsFaceClientCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("vendor.samsung.hardware.biometrics.face@3.0::ISehBiometricsFaceClientCallback");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (((String) it.next()).equals("vendor.samsung.hardware.biometrics.face@3.0::ISehBiometricsFaceClientCallback")) {
                    return proxy;
                }
            }
    ...
    public final class Proxy implements ISehBiometricsFaceClientCallback {
        ...
        @Override // vendor.samsung.hardware.biometrics.face.V3_0.ISehBiometricsFaceClientCallback, vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFaceClientCallback, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.biometrics.face.V3_0.ISehBiometricsFaceClientCallback, vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFaceClientCallback, android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback, android.hidl.base.V1_0.IBase
    ...
    public abstract class Stub extends HwBinder implements ISehBiometricsFaceClientCallback {
        ...
        public static /* synthetic */ HidlMemory lambda$onTransact$1(HwParcel hwParcel) {
            try {
                return hwParcel.readHidlMemory().dup();
            } catch (IOException e) {
                throw new RuntimeException(e);
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) {
            switch (i) {
                ...
                case 10:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFaceClientCallback");
                    sehOnPreviewFrame((HidlMemory) new Function() { // from class: vendor.samsung.hardware.biometrics.face.V3_0.ISehBiometricsFaceClientCallback$Stub$$ExternalSyntheticLambda0
                ...
                case 11:
                    ...
                    sehOnAuthenticatedFromMemory(hwParcel.readInt64(), hwParcel.readInt32(), hwParcel.readInt32(), hwParcel.readInt8Vector(), (HidlMemory) new Function() { // from class: vendor.samsung.hardware.biometrics.face.V3_0.ISehBiometricsFaceClientCallback$Stub$$ExternalSyntheticLambda1
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                            HidlMemory lambda$onTransact$1;
                            lambda$onTransact$1 = ISehBiometricsFaceClientCallback.Stub.lambda$onTransact$1((HwParcel) obj);
                            return lambda$onTransact$1;
                        }
                    }.apply(hwParcel));
                    return;
                default:
