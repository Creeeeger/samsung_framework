...
public interface ISehBiometricsFace extends IBiometricsFace {
    ...
    /* loaded from: classes2.dex */
    public interface sehGetFaceTagCallback {
    }

    /* loaded from: classes2.dex */
    public interface sehGetFaceTagListCallback {
    }
    ...
    int sehAuthenticate(long j, int i, ArrayList arrayList);

    int sehCloseTaSession();

    int sehConfigurePreview(int i, ArrayList arrayList);

    int sehFinishTaInstallation(ArrayList arrayList);

    String sehGetEngineVersion();

    void sehGetFaceTag(int i, sehGetFaceTagCallback sehgetfacetagcallback);

    void sehGetFaceTagList(sehGetFaceTagListCallback sehgetfacetaglistcallback);

    void sehGetSecurityLevel(sehGetSecurityLevelCallback sehgetsecuritylevelcallback);

    int sehGetServicePid();

    String sehGetTaInfo();

    int sehInstallTaDataChunk(HidlMemory hidlMemory);
    ...
    int sehPrepareTaInstallation();

    int sehResumeEnrollment();

    OptionalUint64 sehSetCallback(ISehBiometricsFaceClientCallback iSehBiometricsFaceClientCallback);

    int sehSetFaceTag(int i, ArrayList arrayList);

    int sehSetRotation(int i);

    int sehSetSecurityLevel(int i);

    static ISehBiometricsFace asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
    ...
    static ISehBiometricsFace getService(String str) {
        return asInterface(HwBinder.getService("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace", str));
    }
    ...
    public final class Proxy implements ISehBiometricsFace {
        ...
        @Override // vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace
        public void sehGetSecurityLevel(sehGetSecurityLevelCallback sehgetsecuritylevelcallback) {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public abstract class Stub extends HwBinder implements ISehBiometricsFace {
        ...
        public final String interfaceDescriptor() {
            return "vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace";
        }
        ...
        public final ArrayList interfaceChain() {
            return new ArrayList(Arrays.asList("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace", "android.hardware.biometrics.face@1.0::IBiometricsFace", IBase.kInterfaceName));
        }

        @Override // android.hidl.base.V1_0.IBase
        public final ArrayList getHashChain() {
            return new ArrayList(Arrays.asList(new byte[]{8, 28, 96, -68, -101, -9, -80, 95, 53, -43, 71, -117, -62, 107, -63, 109, -95, Byte.MIN_VALUE, -3, -33, 119, -121, 64, 54, 118, 12, 79, 108, -14, 126, -22, 68}, new byte[]{-31, -113, -13, 24, -13, -4, 67, -37, 55, -11, 84, 105, 109, -60, -27, 81, -85, -71, -79, 25, -67, -27, 57, 80, -9, 62, 40, -50, 51, -87, 122, 64}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if ("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace".equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
            switch (i) {
                ...
                case 15:
                    ...
                    OptionalUint64 sehSetCallback = sehSetCallback(ISehBiometricsFaceClientCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 26:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
                    int sehInstallTaDataChunk = sehInstallTaDataChunk((HidlMemory) new Function() { // from class: vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace$Stub$$ExternalSyntheticLambda0
                ...
                case 30:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
                    sehGetSecurityLevel(new sehGetSecurityLevelCallback() { // from class: vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace.Stub.1
                ...
                case 32:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
                    sehGetFaceTagList(new sehGetFaceTagListCallback() { // from class: vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace.Stub.2
                    });
                    return;
                case 33:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
                    sehGetFaceTag(hwParcel.readInt32(), new sehGetFaceTagCallback() { // from class: vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace.Stub.3
                    });
                    return;
                case 34:
                    hwParcel.enforceInterface("vendor.samsung.hardware.biometrics.face@2.0::ISehBiometricsFace");
