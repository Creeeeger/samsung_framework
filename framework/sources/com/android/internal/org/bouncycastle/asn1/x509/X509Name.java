...
public class X509Name extends ASN1Object {
    ...
    static {
        DefaultSymbols.put(C, GnssSignalType.CODE_TYPE_C);
        DefaultSymbols.put(O, "O");
        DefaultSymbols.put(T, "T");
        DefaultSymbols.put(OU, "OU");
        DefaultSymbols.put(CN, "CN");
        DefaultSymbols.put(L, GnssSignalType.CODE_TYPE_L);
        ...
        RFC2253Symbols.put(C, GnssSignalType.CODE_TYPE_C);
        RFC2253Symbols.put(O, "O");
        RFC2253Symbols.put(OU, "OU");
        RFC2253Symbols.put(CN, "CN");
        RFC2253Symbols.put(L, GnssSignalType.CODE_TYPE_L);
        RFC2253Symbols.put(ST, "ST");
        RFC2253Symbols.put(STREET, "STREET");
        RFC2253Symbols.put(DC, "DC");
        RFC2253Symbols.put(UID, "UID");
        RFC1779Symbols.put(C, GnssSignalType.CODE_TYPE_C);
        RFC1779Symbols.put(O, "O");
        RFC1779Symbols.put(OU, "OU");
        RFC1779Symbols.put(CN, "CN");
        RFC1779Symbols.put(L, GnssSignalType.CODE_TYPE_L);
