...
public class AESEngine implements BlockCipher {
    ...
    private byte[] s;
    private static final byte[] S = {99, 124, 119, 123, MidiConstants.STATUS_SONG_POSITION, 107, 111, -59, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90, 1, 103, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT33, -2, -41, -85, 118, -54, -126, -55, 125, -6, 89, 71, -16, -83, -44, -94, -81, -100, -92, 114, MidiConstants.STATUS_PROGRAM_CHANGE, -73, -3, -109, 38, 54, 63, -9, -52, 52, -91, -27, MidiConstants.STATUS_MIDI_TIME_CODE, 113, -40, SprAnimatorBase.INTERPOLATOR_TYPE_SINEOUT33, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEINOUT, 4, -57, 35, -61, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT, -106, 5, -102, 7, SprAnimatorBase.INTERPOLATOR_TYPE_CIRCEASEINOUT, Byte.MIN_VALUE, -30, -21, SprAnimatorBase.INTERPOLATOR_TYPE_SINEEASEINOUT, -78, 117, 9, -125, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT50, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEOUT, 27, 110, 90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 82, 59, -42, -77, 41, -29, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, -124, 83, -47, 0, -19, 32, -4, -79, 91, 106, -53, -66, 57, 74, 76, 88, -49, MidiConstants.STATUS_CHANNEL_PRESSURE, -17, -86, -5, 67, 77, 51, -123, 69, -7, 2, Byte.MAX_VALUE, 80, 60, -97, -88, 81, -93, 64, -113, -110, -99, 56, -11, -68, -74, -38, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEINOUT, 16, -1, MidiConstants.STATUS_SONG_SELECT, -46, -51, 12, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEIN, -20, 95, -105, 68, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEOUT, -60, -89, 126, 61, 100, 93, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEIN, 115, SprAttributeBase.TYPE_DURATION, -127, 79, -36, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEIN, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, MidiConstants.STATUS_NOTE_ON, -120, 70, -18, -72, 20, -34, 94, 11, -37, MidiConstants.STATUS_PITCH_BEND, 50, 58, 10, 73, 6, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, 92, -62, -45, -84, 98, -111, -107, -28, 121, -25, -56, 55, 109, -115, -43, 78, -87, 108, 86, -12, -22, 101, 122, -82, 8, -70, 120, 37, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT70, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEIN, -90, -76, -58, -24, -35, 116, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEIN, 75, -67, -117, -118, SprAttributeBase.TYPE_SHADOW, 62, -75, 102, 72, 3, -10, 14, SprAttributeBase.TYPE_ANIMATOR_SET, 53, 87, -71, -122, -63, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEOUT, -98, -31, -8, -104, 17, 105, -39, -114, -108, -101, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEINOUT, -121, -23, -50, 85, 40, -33, -116, -95, -119, 13, -65, -26, 66, 104, 65, -103, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, 15, MidiConstants.STATUS_CONTROL_CHANGE, 84, -69, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEIN};
    private static final byte[] Si = {82, 9, 106, -43, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90, 54, -91, 56, -65, 64, -93, -98, -127, MidiConstants.STATUS_SONG_SELECT, -41, -5, 124, -29, 57, -126, -101, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, -1, -121, 52, -114, 67, 68, -60, -34, -23, -53, 84, 123, -108, 50, -90, -62, 35, 61, -18, 76, -107, 11, 66, -6, -61, 78, 8, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT70, -95, 102, 40, -39, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -78, 118, 91, -94, 73, 109, -117, -47, 37, 114, -8, -10, 100, -122, 104, -104, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEIN, -44, -92, 92, -52, 93, 101, -74, -110, 108, SprAttributeBase.TYPE_SHADOW, 72, 80, -3, -19, -71, -38, 94, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEINOUT, 70, 87, -89, -115, -99, -124, MidiConstants.STATUS_NOTE_ON, -40, -85, 0, -116, -68, -45, 10, -9, -28, 88, 5, -72, -77, 69, 6, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT50, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEINOUT, -113, -54, 63, 15, 2, -63, -81, -67, 3, 1, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEIN, -118, 107, 58, -111, 17, 65, 79, 103, -36, -22, -105, MidiConstants.STATUS_SONG_POSITION, -49, -50, -16, -76, -26, 115, -106, -84, 116, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEIN, -25, -83, 53, -123, -30, -7, 55, -24, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEIN, 117, -33, 110, 71, MidiConstants.STATUS_MIDI_TIME_CODE, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEOUT, 113, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEOUT, 41, -59, -119, 111, -73, 98, 14, -86, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT, -66, 27, -4, 86, 62, 75, -58, -46, 121, 32, -102, -37, MidiConstants.STATUS_PROGRAM_CHANGE, -2, 120, -51, 90, -12, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEIN, -35, -88, 51, -120, 7, -57, SprAnimatorBase.INTERPOLATOR_TYPE_SINEOUT33, -79, SprAnimatorBase.INTERPOLATOR_TYPE_CIRCEASEINOUT, 16, 89, SprAnimatorBase.INTERPOLATOR_TYPE_SINEEASEINOUT, Byte.MIN_VALUE, -20, 95, SprAttributeBase.TYPE_DURATION, 81, Byte.MAX_VALUE, -87, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEIN, -75, 74, 13, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -27, 122, -97, -109, -55, -100, -17, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, MidiConstants.STATUS_PITCH_BEND, 59, 77, -82, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, -11, MidiConstants.STATUS_CONTROL_CHANGE, -56, -21, -69, 60, -125, 83, -103, SprAttributeBase.TYPE_ANIMATOR_SET, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEOUT, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT33, 4, 126, -70, 119, -42, 38, -31, 105, 20, 99, 85, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEINOUT, 12, 125};
    ...
    private static int subWord(int x) {
        byte[] bArr = S;
        return (bArr[(x >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT) | (bArr[x & 255] & 255) | ((bArr[(x >> 8) & 255] & 255) << 8) | ((bArr[(x >> 16) & 255] & 255) << 16);
    }
    ...
    private int[][] generateWorkingKey(byte[] key, boolean forEncryption) {
        ...
        int i = KC + 6;
        this.ROUNDS = i;
        int[][] W = (int[][]) Array.newInstance((Class<?>) Integer.TYPE, i + 1, 4);
        int i2 = 8;
        int colx = 3;
        int colx2 = 0;
        switch (KC) {
    ...
    private void encryptBlock(int[][] KW) {
        ...
        byte[] bArr2 = this.s;
        this.C0 = ((i ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r34 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[r5][0];
        this.C1 = ((((bArr2[r13 & 255] & 255) ^ ((bArr[(r23 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r34 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r02 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[r5][1];
        this.C2 = ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r34 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r02 >> 16) & 255] & 255) << 16)) ^ (bArr[(r13 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[r5][2];
        this.C3 = ((bArr[(r23 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT) ^ (((bArr2[r34 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16))) ^ KW[r5][3];
    }
    ...
    private void decryptBlock(int[][] KW) {
        ...
        byte[] bArr = Si;
        int i3 = bArr[r02 & 255] & 255;
        byte[] bArr2 = this.s;
        this.C0 = (((((bArr2[(r34 >> 8) & 255] & 255) << 8) ^ i3) ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16)) ^ (bArr[(r13 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[0][0];
        this.C1 = ((((bArr2[r13 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r34 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r23 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[0][1];
        this.C2 = ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r13 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r02 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r34 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[0][2];
        this.C3 = ((((bArr[r34 & 255] & 255) ^ ((bArr2[(r23 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r02 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)) ^ KW[0][3];
    }
}
