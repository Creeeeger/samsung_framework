...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long w) {
        ...
        if (t == 0) {
            ...
            i = t2 == 0 ? bArr[u] : bArr[t2] + 8;
        } else {
            int k = t >>> 8;
            byte[] bArr2 = bitLengths;
            i = k == 0 ? bArr2[t] + 16 : bArr2[k] + 24;
        }
        return b + i;
    }
    ...
    private static long interleave7(long x) {
        long z = Long.MIN_VALUE & x;
        return INTERLEAVE7_TABLE[((int) x) & 511] | z | (INTERLEAVE7_TABLE[((int) (x >>> 9)) & 511] << 1) | (INTERLEAVE7_TABLE[((int) (x >>> 18)) & 511] << 2) | (INTERLEAVE7_TABLE[((int) (x >>> 27)) & 511] << 3) | (INTERLEAVE7_TABLE[((int) (x >>> 36)) & 511] << 4) | (INTERLEAVE7_TABLE[((int) (x >>> 45)) & 511] << 5) | (INTERLEAVE7_TABLE[((int) (x >>> 54)) & 511] << 6);
    }
