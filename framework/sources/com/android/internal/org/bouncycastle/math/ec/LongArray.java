    ...
    */
    ...
    private static int bitLength(long w) {
        ...
        if (t == 0) {
            ...
            i = k == 0 ? bArr2[t] + 16 : bArr2[k] + SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT;
        }
        return b + i;
    }
