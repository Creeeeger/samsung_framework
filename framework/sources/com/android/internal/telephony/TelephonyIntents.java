...
public class TelephonyIntents {
    ...
    public static final String ACTION_DATA_SELECTION_POPUP = "com.samsung.intent.action.ACTION_DATA_SELECTION_POPUP";
    public static final String ACTION_DATA_SELECTION_POPUP_FOR_EUR = "android.intent.action.ACTION_DATA_SELECTION_POPUP_FOR_EUR";
    ...
    public static final String ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_FAIL = "com.samsung.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_FAIL";
    public static final String ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_SUCCESS = "com.samsung.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_SUCCESS";
