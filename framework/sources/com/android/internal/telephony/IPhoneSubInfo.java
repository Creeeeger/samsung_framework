...
public interface IPhoneSubInfo extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPhoneSubInfo {
        ...
        static final int TRANSACTION_clearMwiNotificationAndVoicemailCount = 38;
        ...
        static final int TRANSACTION_setPcoValue = 39;
                ...
                default:
                    switch (code) {
                        ...
                        case 38:
                            ...
                            data.enforceNoDataAvail();
                            clearMwiNotificationAndVoicemailCount(_arg038, _arg130);
                            reply.writeNoException();
                            return true;
                        case 39:
                            ...
                            data.enforceNoDataAvail();
                            setPcoValue(_arg039, _arg131, _arg218);
                            reply.writeNoException();
                            return true;
                        default:
