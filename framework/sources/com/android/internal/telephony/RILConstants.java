...
public interface RILConstants {
    ...
    public static final int DIAL_STR_TOO_LONG = 1013;
    ...
    public static final int INVALID_CHARACTERS_IN_DIAL_STR = 1015;
    public static final int INVALID_CHARACTERS_IN_TEXT_STR = 1014;
    ...
    public static final int MAC_ADDRESS_FAIL = 1002;
    ...
    public static final int RIL_REQUEST_CANCEL_EMERGENCY_NETWORK_SCAN = 231;
    ...
    public static final int RIL_REQUEST_DEVICE_IMEI = 152;
    ...
    public static final int RIL_REQUEST_EXIT_EMERGENCY_MODE = 232;
    ...
    public static final int RIL_REQUEST_GET_LOCATION_PRIVACY_SETTING = 244;
    ...
    public static final int RIL_REQUEST_GET_SIMULTANEOUS_CALLING_SUPPORT = 250;
    ...
    public static final int RIL_REQUEST_GET_USAGE_SETTING = 228;
    ...
    public static final int RIL_REQUEST_IS_CELLULAR_IDENTIFIER_DISCLOSED_ENABLED = 246;
    public static final int RIL_REQUEST_IS_N1_MODE_ENABLED = 242;
    public static final int RIL_REQUEST_IS_NR_DUAL_CONNECTIVITY_ENABLED = 214;
    public static final int RIL_REQUEST_IS_NULL_CIPHER_AND_INTEGRITY_ENABLED = 245;
    public static final int RIL_REQUEST_IS_SECURITY_ALGORITHMS_UPDATED_ENABLED = 249;
    public static final int RIL_REQUEST_IS_VONR_ENABLED = 226;
    ...
    public static final int RIL_REQUEST_SEND_ANBR_QUERY = 237;
    ...
    public static final int RIL_REQUEST_SET_CELLULAR_IDENTIFIER_DISCLOSED_ENABLED = 247;
    ...
    public static final int RIL_REQUEST_SET_EMERGENCY_MODE = 229;
    ...
    public static final int RIL_REQUEST_SET_LOCATION_PRIVACY_SETTING = 243;
    ...
    public static final int RIL_REQUEST_SET_N1_MODE_ENABLED = 241;
    ...
    public static final int RIL_REQUEST_SET_NULL_CIPHER_AND_INTEGRITY_ENABLED = 239;
    ...
    public static final int RIL_REQUEST_SET_SECURITY_ALGORITHMS_UPDATED_ENABLED = 248;
    ...
    public static final int RIL_REQUEST_SET_SRVCC_CALL_INFO = 233;
    ...
    public static final int RIL_REQUEST_SET_USAGE_SETTING = 227;
    ...
    public static final int RIL_REQUEST_START_IMS_TRAFFIC = 235;
    ...
    public static final int RIL_REQUEST_STOP_IMS_TRAFFIC = 236;
    ...
    public static final int RIL_REQUEST_TRIGGER_EMERGENCY_NETWORK_SCAN = 230;
    public static final int RIL_REQUEST_TRIGGER_EPS_FALLBACK = 238;
    public static final int RIL_REQUEST_UDUB = 17;
    public static final int RIL_REQUEST_UPDATE_IMS_CALL_STATUS = 240;
    public static final int RIL_REQUEST_UPDATE_IMS_REGISTRATION_INFO = 234;
    ...
    public static final int RIL_UNSOL_CELLULAR_IDENTIFIER_DISCLOSED = 1056;
    public static final int RIL_UNSOL_CELL_INFO_LIST = 1036;
    public static final int RIL_UNSOL_CONNECTION_SETUP_FAILURE = 1108;
    public static final int RIL_UNSOL_DATA_CALL_LIST_CHANGED = 1010;
    public static final int RIL_UNSOL_DC_RT_INFO_CHANGED = 1041;
    public static final int RIL_UNSOL_EMERGENCY_NETWORK_SCAN_RESULT = 1106;
    ...
    public static final int RIL_UNSOL_IMEI_MAPPING_CHANGED = 1110;
    ...
    public static final int RIL_UNSOL_NOTIFY_ANBR = 1109;
    ...
    public static final int RIL_UNSOL_SECURITY_ALGORITHMS_UPDATED = 1057;
    public static final int RIL_UNSOL_SIGNAL_STRENGTH = 1009;
    public static final int RIL_UNSOL_SIMULTANEOUS_CALLING_SUPPORT_CHANGED = 1111;
    public static final int RIL_UNSOL_SIM_REFRESH = 1017;
    public static final int RIL_UNSOL_SIM_SMS_STORAGE_FULL = 1016;
    public static final int RIL_UNSOL_SLICING_CONFIG_CHANGED = 1055;
    ...
    public static final int RIL_UNSOL_TRIGGER_IMS_DEREGISTRATION = 1107;
    ...
    public static final int SMS_DSAC_FAILURE = 1003;
    ...
    public static final int TEXT_STR_TOO_LONG = 1012;
    public static final int THIRD_PARTY_PHONE = 4;
    public static final int UICC_IO_ERROR = 1001;
