...
public @interface SoftInputShowHideReason {
    ...
    public static final int FORCE_HIDE_SOFT_INPUT = 42;
    ...
    public static final int HIDE_DRAG_AND_DROP_VIEW = 44;
    public static final int HIDE_FREEFORM_GESTURE = 45;
    public static final int HIDE_FREEFORM_MINIMIZE = 43;
    public static final int HIDE_HW_KEYBOARD_CONNECTED = 38;
    ...
    public static final int HIDE_SCREEN_OFF_SECURE_LOCK_SCREEN_STATE = 41;
    public static final int HIDE_SETTINGS_BUTTON_CLICKED = 40;
    ...
    public static final int HIDE_STATUS_BAR_ANIMATION = 39;
