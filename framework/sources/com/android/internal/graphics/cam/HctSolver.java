...
public class HctSolver {
    ...
    static boolean isBounded(double x) {
        return SContextConstants.ENVIRONMENT_VALUE_UNKNOWN <= x && x <= 100.0d;
    }
    ...
    static double[][] bisectToSegment(double y, double targetHue) {
        ...
        for (int n = 0; n < 12; n++) {
            ...
            if (mid[0] >= SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
    ...
    static double inverseChromaticAdaptation(double adapted) {
        ...
        double base = Math.max(SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, (27.13d * adaptedAbs) / (400.0d - adaptedAbs));
    ...
    static int findResultByJ(double hueRadians, double chroma, double y) {
        ...
        while (iterationRound < 5) {
            ...
            double alpha = (chroma == SContextConstants.ENVIRONMENT_VALUE_UNKNOWN || j == SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) ? 0.0d : chroma / Math.sqrt(jNormalized);
            ...
            if (linrgbR < SContextConstants.ENVIRONMENT_VALUE_UNKNOWN || linrgbG < SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
                return 0;
            }
    ...
    public static double sanitizeDegreesDouble(double degrees) {
        ...
        if (degrees2 < SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
