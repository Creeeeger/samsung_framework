...
public class SystemNotificationChannels {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel physicalKeyboardChannel = new NotificationChannel(PHYSICAL_KEYBOARD, context.getString(R.string.notification_channel_physical_keyboard), 2);
        ...
        NotificationChannel developerImportant = new NotificationChannel(DEVELOPER_IMPORTANT, context.getString(R.string.notification_channel_developer_important), 4);
        developer.setBlockable(true);
        ...
        NotificationChannel systemChanges = new NotificationChannel(SYSTEM_CHANGES, context.getString(R.string.notification_channel_system_changes), 3);
        ...
        NotificationChannel newFeaturePrompt = new NotificationChannel(ACCESSIBILITY_MAGNIFICATION, context.getString(R.string.notification_channel_accessibility_magnification), 4);
        newFeaturePrompt.setBlockable(true);
        channelsList.add(newFeaturePrompt);
        NotificationChannel accessibilitySecurityPolicyChannel = new NotificationChannel(ACCESSIBILITY_SECURITY_POLICY, context.getString(R.string.notification_channel_accessibility_security_policy), 2);
        channelsList.add(accessibilitySecurityPolicyChannel);
        channelsList.add(new NotificationChannel(MDM_DEXPOLICY, context.getString(R.string.notification_channel_dex_policy), 4));
    ...
    public static void removeDeprecated(Context context) {
        ...
        nm.deleteNotificationChannel(RETAIL_MODE);
    }
