...
public interface SystemMessageProto {
    ...
    public static final class SystemMessage extends MessageNano {
        ...
        public static final int NOTE_BAD_REMOVAL_SDCARD = 121;
        public static final int NOTE_BAD_REMOVAL_USB = 122;
        ...
        public static final int NOTE_CERTI_HOST_RESOURCE_EXCEED = 118;
        public static final int NOTE_CERTI_HUB_DEPTH_EXCEED = 116;
        public static final int NOTE_CERTI_HUB_POWER_EXCEED = 117;
        public static final int NOTE_CERTI_NO_RESPONSE = 115;
        public static final int NOTE_CERTI_UNSUPPORT_ACCESSORY = 114;
        public static final int NOTE_CSD_LOWER_AUDIO = 1007;
        public static final int NOTE_DUMP_HEAP_NOTIFICATION = 12;
        public static final int NOTE_EXT_STORAGE_READONLY = 106;
        ...
        public static final int NOTE_USB_ABNORMAL_RESET = 109;
        public static final int NOTE_USB_ACCESSORY = 30;
        public static final int NOTE_USB_AUDIO_ACCESSORY_NOT_SUPPORTED = 41;
        public static final int NOTE_USB_BATTERY_USAGE = 107;
        public static final int NOTE_USB_CHARGING = 32;
        public static final int NOTE_USB_CHARGING_ONLY = 101;
        public static final int NOTE_USB_CONTAMINANT_DETECTED = 52;
        public static final int NOTE_USB_CONTAMINANT_NOT_DETECTED = 53;
        public static final int NOTE_USB_DEBUGGING_ONLY = 110;
        public static final int NOTE_USB_HOST_DEVICE = 111;
        public static final int NOTE_USB_HOST_OVERCURRENT = 112;
        public static final int NOTE_USB_HOST_UNKNOWN = 113;
        public static final int NOTE_USB_MASS = 100;
        public static final int NOTE_USB_MEDIA_DEVICE = 124;
        public static final int NOTE_USB_MEMORY_READONLY = 120;
        ...
        public static final int NOTE_USB_NOT_SUPPORT_HOST_DEVICE = 108;
        ...
        public static final int NOTE_USB_WATER_DETECT = 102;
        public static final int NOTE_USER_SWITCHED = 123;
