...
public class PasswordValidationError {
    ...
    public static final int FORBIDDEN_CHARACTER_SEQUENCE = 16;
    public static final int FORBIDDEN_NUMERIC_SEQUENCE = 15;
    public static final int FORBIDDEN_STRING_DISTANCE = 17;
    public static final int MAX_REPEATED_CHARACTERS = 18;
    ...
    public static final int PASSWORD_PATTERN_MATCHED = 19;
    public static final int PASSWORD_REPEATED_CHARACTERS = 21;
    public static final int PASSWORD_SEQUENTIAL_CHARACTERS = 20;
    ...
    public static final int USE_BANNED_WORDS = 22;
