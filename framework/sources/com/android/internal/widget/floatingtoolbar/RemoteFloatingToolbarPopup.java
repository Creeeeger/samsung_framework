...
public final class RemoteFloatingToolbarPopup implements FloatingToolbarPopup {
    ...
    public void show(List<MenuItem> menuItems, MenuItem.OnMenuItemClickListener menuItemClickListener, Rect contentRect) {
        ...
        if (i > 0) {
            ...
            suggestWidth = this.mParent.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_preferred_width);
        }
    ...
    public /* synthetic */ void lambda$onWidgetUpdated$1(WidgetInfo info) {
        ...
        Point coords = getCoordinatesInWindow(contentRect.left, contentRect.top);
        if (DEBUG) {
            Log.v(FloatingToolbar.FLOATING_TOOLBAR_TAG, "PopupWindow x= " + coords.x + " y= " + coords.y + " w=" + contentRect.width() + " h=" + contentRect.height());
        }
    ...
    public /* synthetic */ void lambda$onMenuItemClicked$3(ToolbarMenuItem toolbarMenuItem) {
        ...
        if (DEBUG) {
            Log.v(FloatingToolbar.FLOATING_TOOLBAR_TAG, "SelectionToolbarCallbackImpl onMenuItemClicked. toolbarMenuItem=" + toolbarMenuItem + " item=" + item);
        }
        if (item != null) {
    ...
    public static class SelectionToolbarCallbackImpl extends ISelectionToolbarCallback.Stub {
        ...
        public void onShown(WidgetInfo info) {
            if (RemoteFloatingToolbarPopup.DEBUG) {
                Log.v(FloatingToolbar.FLOATING_TOOLBAR_TAG, "SelectionToolbarCallbackImpl onShown: " + info);
            }
        ...
        public void onWidgetUpdated(WidgetInfo info) {
            if (RemoteFloatingToolbarPopup.DEBUG) {
                Log.v(FloatingToolbar.FLOATING_TOOLBAR_TAG, "SelectionToolbarCallbackImpl onWidgetUpdated: info = " + info);
            }
            RemoteFloatingToolbarPopup remoteFloatingToolbarPopup = this.mRemotePopup.get();
            if (remoteFloatingToolbarPopup != null) {
        ...
        public void onError(int errorCode) {
            if (RemoteFloatingToolbarPopup.DEBUG) {
                Log.v(FloatingToolbar.FLOATING_TOOLBAR_TAG, "SelectionToolbarCallbackImpl onError: " + errorCode);
            }
        }
    }
