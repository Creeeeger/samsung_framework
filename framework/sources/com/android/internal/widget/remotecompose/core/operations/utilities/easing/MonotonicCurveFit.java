    ...
    public MonotonicCurveFit(double[] time, double[][] y) {
        ...
        for (int i3 = 0; i3 < n - 1; i3++) {
            for (int j2 = 0; j2 < dim; j2++) {
                if (slope[i3][j2] == SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
                    tangent[i3][j2] = 0.0d;
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            if (t < this.mT[i + 1]) {
                ...
                while (j6 < dim) {
                    ...
                    int j7 = j6;
                    v[j7] = interpolate(h, x, y1, y2, t1, t2);
                    j6 = j7 + 1;
                }
                return;
            }
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            if (t < this.mT[i + 1]) {
                ...
                while (j6 < dim) {
                    ...
                    double t2 = this.mTangent[i + 1][j6];
                    int j7 = j6;
                    v[j7] = (float) interpolate(h, x, y1, y2, t1, t2);
                    j6 = j7 + 1;
                }
                return;
            }
