...
public class TypedProperties extends HashMap<String, Object> {
    ...
    public float getFloat(String property, float def) {
        ...
        throw new TypeException(property, value, SemRemoteViewsValueAnimation.VALUE_TYPE_FLOAT);
    }
    ...
    public double getDouble(String property) {
        return getDouble(property, SContextConstants.ENVIRONMENT_VALUE_UNKNOWN);
    }
