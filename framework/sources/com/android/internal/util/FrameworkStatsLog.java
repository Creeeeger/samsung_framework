...
public final class FrameworkStatsLog {
    ...
    public static void write(int code, int[] uid, String[] tag, String arg2, int arg3, int arg4, int arg5, long arg6, boolean arg7, boolean arg8, boolean arg9, boolean arg10, boolean arg11, boolean arg12, boolean arg13, boolean arg14, boolean arg15, boolean arg16, int arg17, boolean arg18, int arg19, int arg20, int arg21, long arg22, boolean arg23, boolean arg24, boolean arg25, boolean arg26, boolean arg27, boolean arg28, boolean arg29, boolean arg30, long arg31, boolean arg32, boolean arg33, boolean arg34, long arg35, long arg36, long arg37, int arg38, int arg39, String arg40, long arg41, long arg42, long arg43, long arg44, long arg45, long arg46, boolean arg47, boolean arg48, boolean arg49, int arg50, int arg51, String arg52, String[] arg53) {
        ...
        builder.writeStringArray(arg53 == null ? new String[0] : arg53);
        builder.usePooledBuffer();
        StatsLog.write(builder.build());
    }
    ...
    public static void write(int code, boolean arg1, String[] arg2, String arg3, int[] arg4, String arg5, int[] arg6, String arg7, String arg8, boolean arg9) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeStringArray(arg2 == null ? new String[0] : arg2);
        builder.writeString(arg3);
    ...
    public static void write(int code, int arg1, boolean arg2, String arg3, int arg4, boolean arg5, boolean arg6, int arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (705 == code) {
    ...
    public static void write(int code, int arg1, int arg2, boolean arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, boolean arg10, int[] arg11, int[] arg12, String[] arg13, int[] arg14, String arg15, int[] arg16, int[] arg17, int arg18, boolean arg19, int arg20, int arg21, int arg22) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, boolean arg3, int arg4, String arg5, long arg6, int arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (866 == code) {
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, boolean arg5, boolean arg6, int arg7, int arg8, int arg9, boolean arg10, boolean arg11, boolean arg12, boolean arg13, boolean arg14, boolean arg15, boolean arg16, int arg17, int arg18, int[] arg19, int arg20, int arg21, int arg22, int[] arg23, byte[] arg24, int arg25, byte[] arg26, byte[] arg27) {
        ...
        builder.writeInt(arg17);
        builder.writeInt(arg18);
        builder.writeIntArray(arg19 == null ? new int[0] : arg19);
        builder.writeInt(arg20);
        builder.writeInt(arg21);
        builder.writeInt(arg22);
        if (arg23 == null) {
        ...
        builder.writeIntArray(iArr);
        builder.writeByteArray(arg24 == null ? new byte[i] : arg24);
        builder.writeInt(arg25);
        builder.writeByteArray(arg26 == null ? new byte[i] : arg26);
        builder.writeByteArray(arg27 == null ? new byte[i] : arg27);
        builder.usePooledBuffer();
        StatsLog.write(builder.build());
    }
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, String arg6, String arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, long arg5, int arg6, String[] arg7, int[] arg8, boolean arg9, int arg10, int arg11) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, String arg5, String arg6, int arg7, int arg8, boolean arg9, long arg10) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (477 == code) {
    ...
    public static void write(int code, int arg1, int arg2, int arg3, long arg4, String arg5, long arg6, long arg7, long arg8, long arg9, long arg10) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (754 == code) {
    ...
    public static void write(int code, int arg1, int arg2, String arg3, int arg4, boolean arg5, int arg6, String arg7, String arg8, int arg9, String arg10, String arg11, int arg12, int arg13, boolean arg14, long arg15) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (476 == code) {
    ...
    public static void write(int code, int arg1, int arg2, String arg3, int arg4, int arg5, long arg6, long arg7, long arg8, int arg9, String arg10, String arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, boolean arg18, long arg19) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (475 == code) {
    ...
    public static void write(int code, int arg1, String arg2, int arg3, long arg4, int arg5) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (900 == code) {
    ...
    public static void write(int code, int arg1, String arg2, int arg3, String arg4, boolean arg5, int arg6, String arg7, String arg8, int arg9, int arg10, int arg11, boolean arg12, int arg13, String arg14) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (495 == code) {
    ...
    public static void write(int code, String arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, boolean arg7, int arg8, boolean arg9, boolean arg10, int arg11, int arg12) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeString(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, boolean arg1, String arg2, int arg3, boolean arg4, boolean arg5) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeString(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, boolean arg2, boolean arg3, int arg4, String arg5, int arg6, byte[] arg7, int arg8, int arg9, int arg10, int arg11) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeBoolean(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (10218 == code) {
    ...
    public static void write(int code, WorkSource ws, int arg2, int arg3, int arg4, boolean arg5, int arg6, int arg7, int arg8, long arg9, long arg10, long arg11, long arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18, int arg19, int[] arg20, int[] arg21, int[] arg22, int[] arg23, int arg24, int arg25, float arg26) {
        for (int i = 0; i < ws.size(); i++) {
            write_non_chained(code, ws.getUid(i), ws.getPackageName(i), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23, arg24, arg25, arg26);
        }
        List<WorkSource.WorkChain> workChains = ws.getWorkChains();
        if (workChains != null) {
            for (WorkSource.WorkChain wc : workChains) {
                write(code, wc.getUids(), wc.getTags(), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23, arg24, arg25, arg26);
            }
        }
    }
