...
public class SemServiceAccessControl {
    ...
    /* renamed from: com.android.server.SemServiceAccessControl$1, reason: invalid class name */
    /* loaded from: classes5.dex */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$android$server$SemServiceAccessControl$PackageList;

        static {
            int[] iArr = new int[PackageList.values().length];
            $SwitchMap$com$android$server$SemServiceAccessControl$PackageList = iArr;
            try {
                iArr[PackageList.MScpKmPkgList.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MLccmPkgList.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MSKMSCardPkgList.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MFactoryPkgList.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MHWParamPkgList.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MCosPatchPkgList.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MFactoryResetList.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$android$server$SemServiceAccessControl$PackageList[PackageList.MGrdmPkgList.ordinal()] = 8;
    ...
    public void addAllowedPackage(String packageName, int uid, PackageList pkglist) {
        switch (AnonymousClass1.$SwitchMap$com$android$server$SemServiceAccessControl$PackageList[pkglist.ordinal()]) {
            case 1:
            ...
            try {
                if (CIPHER_KEY != null && CIPHER_AL != null) {
                    if (MAC_AL != null) {
                        ...
                        if (byteEncrypted != null && byteEncrypted.length >= 64) {
                            try {
                                Log.d(TAG, "GK");
    ...
    */
    ...
    public byte[] getScpkmTeeSigData() {
        ...
        byte[] teeSig = Base64.decode(str.getBytes(), 2);
        return teeSig;
    }
    ...
    public byte[] getScpkmTeeListData() {
        ...
        byte[] teeList = Base64.decode(str.getBytes(), 2);
        return teeList;
    }
}
