...
public final class ProductPackagesRune {
    ...
    public static final boolean LIBPERFLOG = true;
    ...
    public static final boolean SERVICE_SAMSUNG_BLOCKCHAIN = true;
    public static final boolean SERVICE_SAMSUNG_DESKTOPMODE = true;
    public static final boolean SERVICE_SAMSUNG_MULTICONTROL = true;
    ...
    public static final boolean SUPPORT_GALAXY_TIPS = false;
}
