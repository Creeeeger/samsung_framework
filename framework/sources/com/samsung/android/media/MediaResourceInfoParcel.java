...
public class MediaResourceInfoParcel implements Parcelable {
    ...
    /* renamed from: com.samsung.android.media.MediaResourceInfoParcel$1 */
    /* loaded from: classes5.dex */
    class AnonymousClass1 implements Parcelable.Creator<MediaResourceInfoParcel> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.totalSize);
        _aidl_parcel.writeTypedArray(this.resourceInfos, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.totalSize = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.resourceInfos);
        return _mask;
    }
