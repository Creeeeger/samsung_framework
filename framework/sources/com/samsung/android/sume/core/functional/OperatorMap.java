...
public class OperatorMap implements Operator {
    ...
    public MutableMediaBuffer run(MediaBuffer ibuf, final MutableMediaBuffer obuf) throws UnsupportedOperationException {
        ...
        if (!this.usePersistentFormat || this.processorList == null) {
            ...
            this.processorMap.values().forEach(new Consumer() { // from class: com.samsung.android.sume.core.functional.OperatorMap$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    OperatorMap.lambda$run$0(MutableMediaFormat.this, obuf, processorPriorityMap, (Operator) obj);
                }
            });
            this.processorList = (List) processorPriorityMap.entrySet().stream().sorted(Map.Entry.comparingByKey()).map(new OperatorMap$$ExternalSyntheticLambda1()).collect(Collectors.toList());
        }
    ...
    public static List<ImgpType> inferOperations(final MutableMediaFormat inputFormat, final MediaFormat outputFormat) {
        ...
        Map<ImgpType, Float> priorityMap = (Map) priorityCheckMap.entrySet().stream().collect(Collectors.toMap(new Function() { // from class: com.samsung.android.sume.core.functional.OperatorMap$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return (ImgpType) ((Map.Entry) obj).getKey();
            }
        }, new Function() { // from class: com.samsung.android.sume.core.functional.OperatorMap$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Float valueOf;
        ...
        return (List) priorityMap.entrySet().stream().filter(new Predicate() { // from class: com.samsung.android.sume.core.functional.OperatorMap$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return OperatorMap.lambda$inferOperations$4((Map.Entry) obj);
            }
        }).sorted(Map.Entry.comparingByValue()).map(new Function() { // from class: com.samsung.android.sume.core.functional.OperatorMap$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return (ImgpType) ((Map.Entry) obj).getKey();
            }
