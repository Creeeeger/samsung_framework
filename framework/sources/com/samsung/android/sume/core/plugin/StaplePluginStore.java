...
public class StaplePluginStore extends PluginStore {
    ...
    public PluginStore add(PluginFixture<?> fixture) {
        MFDescriptor descriptor = (MFDescriptor) Stream.of((Object[]) new Optional[]{Optional.ofNullable(fixture.getDescriptorLoader()).map(new Function() { // from class: com.samsung.android.sume.core.plugin.StaplePluginStore$$ExternalSyntheticLambda2
        ...
        }).findFirst().flatMap(Function.identity()).orElseThrow(new MutableMediaBuffer$$ExternalSyntheticLambda12());
    ...
    public PluginFixture<?> remove(final PluginFixture<?> fixture) {
        return (PluginFixture) this.registry.entrySet().stream().filter(new Predicate() { // from class: com.samsung.android.sume.core.plugin.StaplePluginStore$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
