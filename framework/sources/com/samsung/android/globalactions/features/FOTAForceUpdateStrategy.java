...
public class FOTAForceUpdateStrategy implements SoftwareUpdateStrategy {
    ...
    public boolean onUpdate() {
        return this.mConditionChecker.isEnabled(SystemConditions.IS_ATT_FOTA_CLIENT_PACKAGE_ENABLED) && this.mConditionChecker.isEnabled(SystemConditions.IS_FOTA_AVAILABLE_FOR_GLOBALACTIONS);
    }
