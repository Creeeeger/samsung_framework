...
public class SemAddDeleteHorizontalListAnimator extends SemAbsAddDeleteAnimator {
    ...
    /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$1 */
    /* loaded from: classes5.dex */
    ...
    private void prepareDelete(ArrayList<Integer> deletingItemPositions) {
        ...
        int childCountBefore = this.mHorizontalListView.getChildCount();
        int firstVisiblePosBefore = this.mHorizontalListView.getFirstVisiblePosition();
        ...
        if (semHorizontalListView.getChildAt(semHorizontalListView.getHeaderViewsCount()) != null) {
            ...
            int defaultHeight2 = semHorizontalListView2.getChildAt(semHorizontalListView2.getHeaderViewsCount()).getHeight();
            SemHorizontalListView semHorizontalListView3 = this.mHorizontalListView;
            defaultHeight = defaultHeight2;
            defaultTop = semHorizontalListView3.getChildAt(semHorizontalListView3.getHeaderViewsCount()).getTop();
        } else {
        ...
        this.mDeleteRunnable = new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator.2
            ...
            final /* synthetic */ int val$defaultTop;
            ...
            AnonymousClass2(ListAdapter adapter2, int defaultTop2, int defaultHeight4, int firstVisiblePosBefore2, int childCountBefore2, ArrayList deletedItems2, HashSet deletedItemPosHash2) {
                adapter = adapter2;
                i = defaultTop2;
                i2 = defaultHeight4;
            ...
            */
            ...
            /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$2$1 */
            /* loaded from: classes5.dex */
    ...
    /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$2 */
    /* loaded from: classes5.dex */
    ...
    /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$3 */
    /* loaded from: classes5.dex */
    ...
    private void prepareInsert(ArrayList<Integer> insertedItemPositions) {
        ...
        this.mInsertRunnable = new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator.4
            ...
            AnonymousClass4(ListAdapter adapter2, HashMap upcomingViewsStartCoords2, ArrayList insertedItems2, HashSet insertedItemPosHash2) {
                adapter = adapter2;
            ...
            /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$4$1 */
            /* loaded from: classes5.dex */
            class AnonymousClass1 extends AnimatorListenerAdapter {
                AnonymousClass1() {
                }
    ...
    /* renamed from: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator$4 */
    /* loaded from: classes5.dex */
