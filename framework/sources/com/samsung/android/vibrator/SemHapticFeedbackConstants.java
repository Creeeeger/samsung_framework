...
public class SemHapticFeedbackConstants {
    ...
    public static int semGetVibrationIndex(int index) {
        return INTERNAL_INDEX_OFFSET + index;
    }

    public static String getCategoryPath(int index) {
        if (index >= 100001 && index <= 110000) {
            return RINGTONE_PATH;
        }
        return NOTIFICATION_PATH;
    }

    public static int getDefaultSepIndex(int index) {
        if (index >= 100001 && index <= 110000) {
            return 50035;
        }
        return 50034;
    ...
    public static boolean isCustomIndexValid(int index) {
        return index >= 100001 && index <= 120000;
    }

    public static boolean isRamIndexValid(int index) {
        return index >= 50025 && index <= 50151;
    }

    public static boolean isResourceIndexValid(int index) {
        return index >= RESOURCE_INDEX_START && index <= RESOURCE_INDEX_END;
    }

    public static boolean isHybridIndexValid(int index) {
        return index >= HYBRID_INDEX_START && index <= HYBRID_INDEX_END;
    }

    public static String getPatternTitle(int index) {
        switch (index) {
            case 50025:
                return "EFFECT_CLICK";
