...
public class UserOpenCommand extends ICmdList {
    ...
    protected void addATCommands() {
        ...
        putAtCommands("AT+FRPUNLCK=3,0,0|SLO|ABO", this.cmdType);
        ...
        putAtCommands("AT+SVCIFPGM=1,3|SLO|ABO", this.cmdType);
        putAtCommands("AT+SVCIFPGM=1,7|SLO|ABO", this.cmdType);
        putAtCommands("AT+SVCIFPGM=*|SLO", this.cmdType);
        putAtCommands("AT+SYSSLEEP=*", this.cmdType);
        ...
        putAtCommands("AT+MIPITEST=*", this.cmdType);
        putAtCommands("AT+PARALLEL=*", this.cmdType);
        putAtCommands("AT+RFNVCHKS=*", this.cmdType);
        putAtCommands("AT+ACLTESTT=*", this.cmdType);
        putAtCommands("AT+ASDIVTES=*", this.cmdType);
        putAtCommands("AT+HOPATHCK=*", this.cmdType);
        putAtCommands("AT+RFBKOFFC=*", this.cmdType);
        putAtCommands("AT+LDUSTCHK=*", this.cmdType);
        putAtCommands("AT+RFMIPITT=*", this.cmdType);
        putAtCommands("AT+RFEVTAIT=*", this.cmdType);
        ...
        putAtCommands("AT+APCHIPTT=*", this.cmdType);
        putAtCommands("AT+RTSARCHK=*", this.cmdType);
        putAtCommands("AT+CPSTACHK=1,*", this.cmdType);
        putAtCommands("AT+SIMSWITC=*", this.cmdType);
        putAtCommands("AT+MSLSECUR=1,*", this.cmdType);
        putAtCommands("AT+IMEITEST=0,*", this.cmdType);
        putAtCommands("AT+IMEITEST=1,*", this.cmdType);
        putAtCommands("AT+IMEISIGN=0,*", this.cmdType);
        putAtCommands("AT+IMEISIGN=1,*", this.cmdType);
        putAtCommands("AT+DETALOCK=0,*", this.cmdType);
        putAtCommands("AT+DETALOCK=1,*", this.cmdType);
        putAtCommands("AT+LOCKINFO=0,*", this.cmdType);
        putAtCommands("AT+LOCKINFO=1,*", this.cmdType);
        putAtCommands("AT+RFBYCODE=0,*", this.cmdType);
        putAtCommands("AT+RFBYCODE=1,*", this.cmdType);
        putAtCommands("AT+CPLDUCFG=0,*", this.cmdType);
        putAtCommands("AT+CPLDUCFG=1,*", this.cmdType);
        putAtCommands("AT+BLOBSIGN=0,*", this.cmdType);
        putAtCommands("AT+BLOBSIGN=1,*", this.cmdType);
        putAtCommands("AT+LVOFLOCK=*", this.cmdType);
        putAtCommands("AT+SSUCONFG=1,*", this.cmdType);
        putAtCommands("AT+CHIPIDTT=1,*", this.cmdType);
        putAtCommands("AT+XOCALCHK=0,1", this.cmdType);
        putAtCommands("AT+XOCALCHK=1,0", this.cmdType);
        putAtCommands("AT+XOCALCHK=1,1", this.cmdType);
        putAtCommands("AT+COPS?", this.cmdType);
        ...
        putAtCommands("AT$QCPDPCFGE?", this.cmdType);
        putAtCommands("AT$QCPDPCFGE=*", this.cmdType);
        putAtCommands("AT$QCSIMAPP=*", this.cmdType);
        putAtCommands("AT+RFSARONOFF=1,*", this.cmdType);
    }
}
