...
public final class Style {
    ...
    static {
        ...
        TONAL_SPOT = new Style(WallpaperThemeConstants.DYNAMIC_COLOR_THEME_STYLE_DEFAULT, 1, new CoreSpec(tonalSpec, tonalSpec2, tonalSpec3, new TonalSpec(new Hue() { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSource
            @Override // com.samsung.android.wallpaper.colortheme.monet.Hue
            public double get(Cam sourceColor) {
                return sourceColor.getHue();
            }
