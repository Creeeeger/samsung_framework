...
public class Rune {
    ...
    public static final boolean SEC_AUDIO_CONTINUITY = false;
    ...
    public static final boolean SEC_AUDIO_DOLBY_PHRTF;
    ...
    public static final boolean SEC_AUDIO_SOUND_CRAFT = true;
    ...
    static {
        ...
        SEC_AUDIO_TRANSITION_EFFECT = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_AUDIO_SUPPORT_TRANSITION_EFFECT") || Build.VERSION.DEVICE_INITIAL_SDK_INT >= 30;
        ...
        boolean z = SemFloatingFeature.getInstance().getInteger("SEC_FLOATING_FEATURE_AUDIO_CONFIG_VOLUMEMONITOR_STAGE") >= 3;
        SEC_AUDIO_VOLUME_MONITOR_PHASE_3 = z;
        ...
        boolean z2 = SemFloatingFeature.getInstance().getInt("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_CHIP_VENDOR") != 0;
        SEC_AUDIO_FM_RADIO = z2;
        ...
        boolean z3 = SemCscFeature.getInstance().getBoolean("CscFeature_Audio_SupportSafeMediaVolumeDialog", false);
        SEC_AUDIO_SAFE_VOLUME_COUNTRY = z3;
        ...
        SEC_AUDIO_FM_RADIO_RECORDING = z2;
        SEC_AUDIO_SAFE_MEDIA_VOLUME = z3 || z;
    }
}
