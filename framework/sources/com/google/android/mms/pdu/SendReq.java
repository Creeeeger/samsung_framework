...
public class SendReq extends MultimediaMessagePdu {
    ...
    public long getDeliveryTime() {
        return this.mPduHeaders.getLongInteger(135);
    }

    public void setDeliveryTime(long value) {
        this.mPduHeaders.setLongInteger(value, 135);
    }

    public long getReserved() {
        return this.mPduHeaders.getLongInteger(192);
    }

    public void setReserved(long value) {
        this.mPduHeaders.setLongInteger(value, 192);
    }
}
