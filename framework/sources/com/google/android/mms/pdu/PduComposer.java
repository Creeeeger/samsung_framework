    ...
    private int appendHeader(int field) {
        switch (field) {
            ...
            case 155:
                ...
                return 0;
            case 135:
                long deliveryTime = this.mPduHeader.getLongInteger(field);
                if (-1 == deliveryTime) {
                    return 2;
                }
                appendOctet(field);
                this.mStack.newbuf();
                PositionMarker deliveryTimeStart = this.mStack.mark();
                append(129);
                appendLongInteger(deliveryTime);
                int deliveryTimeLength = deliveryTimeStart.getLength();
                this.mStack.pop();
                appendValueLength(deliveryTimeLength);
                this.mStack.copy();
                return 0;
            case 136:
