...
public class DateTimeView extends TextView {
    ...
    private void updateRelativeTime() {
        ...
        if (duration < 3600000) {
            ...
            if (past) {
                i4 = R.string.duration_minutes_shortest;
            } else {
                i4 = R.string.duration_minutes_shortest_future;
            }
            ...
            if (past) {
                i3 = R.string.duration_hours_shortest;
            } else {
                i3 = R.string.duration_hours_shortest_future;
            }
            ...
            if (past) {
                i2 = R.string.duration_days_shortest;
            } else {
                i2 = R.string.duration_days_shortest_future;
            }
            ...
            if (past) {
                i = R.string.duration_years_shortest;
            } else {
                i = R.string.duration_years_shortest_future;
            }
        ...
        void updateAll() {
            synchronized (this.mAttachedViews) {
                ...
                if (count > 0) {
                    ...
                    Context ctx = this.mAttachedViews.get(0).getContext();
                    DateTimeView.sTimeFormat = android.text.format.DateFormat.getTimeFormat(ctx);
                }
