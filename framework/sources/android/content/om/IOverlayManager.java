...
public interface IOverlayManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOverlayManager {
        ...
        static final int TRANSACTION_addOverlays = 15;
        static final int TRANSACTION_applyThemeParkWallpaperColor = 26;
        static final int TRANSACTION_applyWallpaperColor = 22;
        static final int TRANSACTION_applyWallpaperColors = 21;
        static final int TRANSACTION_changeOverlayState = 17;
        static final int TRANSACTION_commit = 13;
        static final int TRANSACTION_getAllOverlays = 1;
        static final int TRANSACTION_getAllOverlaysInCategory = 18;
        static final int TRANSACTION_getDefaultOverlayPackages = 11;
        static final int TRANSACTION_getLastPalette = 25;
        static final int TRANSACTION_getOverlayForPath = 19;
        ...
        static final int TRANSACTION_getOverlaysForTarget = 20;
        static final int TRANSACTION_getThemeParkOverlayNames = 27;
        static final int TRANSACTION_getWallpaperColors = 23;
        static final int TRANSACTION_invalidateCachesForOverlay = 12;
        static final int TRANSACTION_readLastPalette = 24;
        static final int TRANSACTION_removeOverlays = 16;
        static final int TRANSACTION_replaceOverlays = 14;
                ...
                default:
                    switch (code) {
                        ...
                        case 17:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result12 = changeOverlayState(_arg016, _arg114, _arg27);
                            reply.writeNoException();
                        ...
                        case 18:
                            ...
                            data.enforceNoDataAvail();
                            OverlayInfoExt[] _result13 = getAllOverlaysInCategory(_arg017, _arg115);
                            reply.writeNoException();
                        ...
                        case 19:
                            ...
                            data.enforceNoDataAvail();
                            OverlayInfoExt _result14 = getOverlayForPath(_arg018, _arg116);
                            reply.writeNoException();
                        ...
                        case 20:
                            ...
                            data.enforceNoDataAvail();
                            OverlayInfoExt[] _result15 = getOverlaysForTarget(_arg019, _arg117, _arg28);
                            reply.writeNoException();
                        ...
                        case 22:
                            ...
                            return true;
                        case 23:
                            List _result16 = getWallpaperColors();
                            reply.writeNoException();
                            reply.writeList(_result16);
                            return true;
                        case 24:
                            List _result17 = readLastPalette();
                            reply.writeNoException();
                            reply.writeList(_result17);
                            return true;
                        case 25:
                            List _arg022 = new ArrayList();
                            List _arg120 = new ArrayList();
                            data.enforceNoDataAvail();
                            boolean _result18 = getLastPalette(_arg022, _arg120);
                            reply.writeNoException();
                        ...
                        case 27:
                            ...
                            data.enforceNoDataAvail();
                            List<String> _result19 = getThemeParkOverlayNames(_arg024);
                            reply.writeNoException();
