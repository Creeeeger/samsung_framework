...
public interface IASKSManager extends IInterface {
    ...
    void applyScpmPolicyFromApp() throws RemoteException;

    void applyScpmPolicyFromService(String str) throws RemoteException;
    ...
    int checkUnknownSourcePackage(String str, String[] strArr, String[] strArr2, String str2, Signature[] signatureArr, String str3, String str4, String str5, int i, String str6, String str7, int i2) throws RemoteException;
    ...
    public static class Default implements IASKSManager {
        ...
        @Override // android.content.pm.IASKSManager
        public void applyScpmPolicyFromApp() throws RemoteException {
        }

        @Override // android.content.pm.IASKSManager
        public void applyScpmPolicyFromService(String serviceType) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IASKSManager {
        static final int TRANSACTION_applyScpmPolicyFromApp = 19;
        static final int TRANSACTION_applyScpmPolicyFromService = 20;
        ...
        static final int TRANSACTION_checkSecurityEnabled = 23;
        ...
        static final int TRANSACTION_isTrustedStore = 22;
                ...
                default:
                    switch (code) {
                        ...
                        case 13:
                            ...
                            data.enforceNoDataAvail();
                            int _result8 = checkUnknownSourcePackage(_arg08, _arg15, _arg23, _arg32, _arg42, _arg52, _arg62, _arg7, _arg8, _arg9, _arg10, _arg11);
                            reply.writeNoException();
                        ...
                        case 18:
                            ...
                            return true;
                        case 19:
                            applyScpmPolicyFromApp();
                            reply.writeNoException();
                            return true;
                        case 20:
                            String _arg013 = data.readString();
                            data.enforceNoDataAvail();
                            applyScpmPolicyFromService(_arg013);
                            reply.writeNoException();
                            return true;
                        case 21:
                            ...
                            data.enforceNoDataAvail();
                            String _result14 = readASKSFiles(_arg014, _arg18);
                            reply.writeNoException();
                        ...
                        case 22:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result15 = isTrustedStore(_arg015, _arg19);
                            reply.writeNoException();
                            reply.writeBoolean(_result15);
                            return true;
                        case 23:
                            int _result16 = checkSecurityEnabled();
                            reply.writeNoException();
