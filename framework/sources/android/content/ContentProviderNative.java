            ...
            switch (code) {
                case 1:
                    ...
                    if (cursor != null) {
                        ...
                        try {
                            CursorToBulkCursorAdaptor adaptor2 = new CursorToBulkCursorAdaptor(cursor, observer, getProviderName());
                            cursor = null;
                ...
                case 22:
                    ...
                    String[] types = getStreamTypes(attributionSource11, url9, mimeTypeFilter);
                    reply.writeNoException();
                ...
                case 23:
                    ...
                    AssetFileDescriptor fd3 = openTypedAssetFile(attributionSource12, url10, mimeType, opts, signal3);
                    reply.writeNoException();
                    if (fd3 != null) {
                        reply.writeInt(1);
                ...
                case 25:
                    ...
                    Uri out2 = canonicalize(attributionSource13, url11);
                    reply.writeNoException();
                ...
                case 26:
                    ...
                    Uri out3 = uncanonicalize(attributionSource14, url12);
                    reply.writeNoException();
                ...
                case 27:
                    ...
                    boolean out4 = refresh(attributionSource15, url13, extras5, signal4);
                    reply.writeNoException();
                    if (!out4) {
                        i = -1;
                    }
                ...
                case 28:
                    ...
                    int out5 = checkUriPermission(attributionSource16, uri, uid, modeFlags);
                    reply.writeNoException();
                    reply.writeInt(out5);
                    return true;
                case 29:
                    ...
                    getTypeAsync(attributionSource17, url14, callback);
                    return true;
                case 30:
                    data.enforceInterface(IContentProvider.descriptor);
                    ...
                    canonicalizeAsync(attributionSource18, uri2, callback2);
                    return true;
                case 31:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource19 = AttributionSource.CREATOR.createFromParcel(data);
                    Uri uri3 = Uri.CREATOR.createFromParcel(data);
                    RemoteCallback callback3 = RemoteCallback.CREATOR.createFromParcel(data);
                    uncanonicalizeAsync(attributionSource19, uri3, callback3);
                    return true;
                case 32:
                    data.enforceInterface(IContentProvider.descriptor);
