...
public class FontScaleConverterFactory {
    static final SparseArray<FontScaleConverter> LOOKUP_TABLES;
    private static final float SCALE_KEY_MULTIPLIER = 100.0f;
    private static float sMinScaleBeforeCurvesApplied;

    static {
        SparseArray<FontScaleConverter> sparseArray = new SparseArray<>();
        LOOKUP_TABLES = sparseArray;
        ...
        float scaleFromKey = getScaleFromKey(sparseArray.keyAt(0)) - 0.02f;
