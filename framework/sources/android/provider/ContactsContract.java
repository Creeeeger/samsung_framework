...
public final class ContactsContract {
    ...
    public static final class SimContacts {
        ...
        public static void addSimAccount(ContentResolver contentResolver, String accountName, String accountType, int simSlotIndex, int efType) {
            ...
            ContactsContract.nullSafeCall(contentResolver, ContactsContract.AUTHORITY_URI, ADD_SIM_ACCOUNT_METHOD, null, extras);
        }
        ...
        public static void removeSimAccounts(ContentResolver contentResolver, int simSlotIndex) {
            ...
            Bundle extras = new Bundle();
            extras.putInt(KEY_SIM_SLOT_INDEX, simSlotIndex);
            ContactsContract.nullSafeCall(contentResolver, ContactsContract.AUTHORITY_URI, REMOVE_SIM_ACCOUNT_METHOD, null, extras);
        }

        public static List<SimAccount> getSimAccounts(ContentResolver contentResolver) {
            Bundle response = ContactsContract.nullSafeCall(contentResolver, ContactsContract.AUTHORITY_URI, QUERY_SIM_ACCOUNTS_METHOD, null, null);
    ...
    public static final class PinnedPositions {
        ...
        public static void undemote(ContentResolver contentResolver, long contactId) {
            ContactsContract.nullSafeCall(contentResolver, ContactsContract.AUTHORITY_URI, UNDEMOTE_METHOD, String.valueOf(contactId), null);
        }
    ...
    public static Bundle nullSafeCall(ContentResolver resolver, Uri uri, String method, String arg, Bundle extras) {
        try {
            ...
            try {
                Bundle call = client.call(method, arg, extras);
                if (client != null) {
                    client.close();
                }
                return call;
