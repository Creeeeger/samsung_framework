...
public interface IWindow extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindow {
        ...
        static final int TRANSACTION_invalidateForScreenShot = 22;
        ...
        static final int TRANSACTION_windowFocusInTaskChanged = 21;
                ...
                default:
                    switch (code) {
                        ...
                        case 21:
                            ...
                            data.enforceNoDataAvail();
                            windowFocusInTaskChanged(_arg019);
                            return true;
                        case 22:
                            boolean _arg020 = data.readBoolean();
                            data.enforceNoDataAvail();
                            invalidateForScreenShot(_arg020);
                            return true;
                        default:
