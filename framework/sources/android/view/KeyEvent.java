...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public KeyEvent(int action, int code) {
        this(0L, 0L, action, code, 0, 0, -1, 0, 0, 0, (String) null);
    }
    ...
    public final void semSetDisplayId(int displayId) {
    ...
    public final void semSetShiftPressed(boolean pressed) {
        if (pressed) {
            this.mMetaState |= 1;
        } else {
            this.mMetaState &= -2;
    ...
    public final void semSetAltPressed(boolean pressed) {
        if (pressed) {
            this.mMetaState |= 2;
        } else {
            this.mMetaState &= -3;
    ...
    public final void semSetCtrlPressed(boolean pressed) {
        if (pressed) {
    ...
    public final void semSetMetaPressed(boolean pressed) {
        if (pressed) {
