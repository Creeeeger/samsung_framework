...
public interface ICreateCredentialCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICreateCredentialCallback {
        ...
        public static ICreateCredentialCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(ICreateCredentialCallback.DESCRIPTOR);
            if (iin != null && (iin instanceof ICreateCredentialCallback)) {
                return (ICreateCredentialCallback) iin;
            }
        ...
        private static class Proxy implements ICreateCredentialCallback {
            ...
            public void onPendingIntent(PendingIntent pendingIntent) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(ICreateCredentialCallback.DESCRIPTOR);
