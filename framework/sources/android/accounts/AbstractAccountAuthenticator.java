    ...
    public void handleException(IAccountAuthenticatorResponse response, String method, String data, Exception e) throws RemoteException {
        if (e instanceof NetworkErrorException) {
            if (Log.isLoggable(TAG, 2)) {
                Log.v(TAG, method + NavigationBarInflaterView.KEY_CODE_START + data + NavigationBarInflaterView.KEY_CODE_END, e);
            }
            ...
            Log.w(TAG, method + NavigationBarInflaterView.KEY_CODE_START + data + NavigationBarInflaterView.KEY_CODE_END, e);
