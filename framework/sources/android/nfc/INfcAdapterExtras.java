...
public interface INfcAdapterExtras extends IInterface {
    ...
    public static class Default implements INfcAdapterExtras {
        ...
        @Override // android.nfc.INfcAdapterExtras
        public Bundle openWithPackageName(String pkg, IBinder b, String callerPkgName) throws RemoteException {
            return null;
        }

        @Override // android.nfc.INfcAdapterExtras
        public Bundle closeWithPackageName(String pkg, IBinder b, String callerPkgName) throws RemoteException {
            return null;
        }

        @Override // android.nfc.INfcAdapterExtras
        public Bundle transceiveWithPackageName(String pkg, byte[] data_in, String callerPkgName) throws RemoteException {
            return null;
        }
