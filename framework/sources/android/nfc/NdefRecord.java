...
public final class NdefRecord implements Parcelable {
    ...
    public static final byte[] RTD_SMART_POSTER = {83, SprAttributeBase.TYPE_SHADOW};
    public static final byte[] RTD_ALTERNATIVE_CARRIER = {SprAttributeBase.TYPE_ANIMATOR_SET, 99};
    ...
    public static NdefRecord createUri(Uri uri) {
        ...
        while (true) {
            ...
            if (!uriString.startsWith(strArr[i])) {
                i++;
            } else {
                prefix = (byte) i;
    ...
    */
    ...
    private static void ensureSanePayloadSize(long size) throws FormatException {
        if (size > 10485760) {
            throw new FormatException("payload above max limit: " + size + " > 10485760");
        }
    }
