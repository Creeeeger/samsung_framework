...
public class EconomyManager {
    ...
    public static final String KEY_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_NONWAKEUP_BASE_PRICE = "am_action_alarm_allow_while_idle_inexact_nonwakeup_base_price";
    ...
    public static final long DEFAULT_AM_MAX_SATIATED_BALANCE_CAKES = arcToCake(EncodeConstants.Resolution.MM_360_EXPORT_HEIGHT_960);
    ...
    public static final long DEFAULT_AM_MAX_CONSUMPTION_LIMIT_CAKES = arcToCake(EncodeConstants.BitRate.MM_BITRATE_10_HEVC_HD_30);
    ...
    public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_EXEMPTED_CAKES = arcToCake(EncodeConstants.BitRate.MM_BITRATE_10_HEVC_HD_30);
    ...
    static {
        ...
        DEFAULT_JS_REWARD_TOP_ACTIVITY_MAX_CAKES = arcToCake(EncodeConstants.BitRate.MM_BITRATE_10_HEVC_HD_30);
