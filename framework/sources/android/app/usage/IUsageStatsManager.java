...
public interface IUsageStatsManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsageStatsManager {
        ...
        static final int TRANSACTION_deleteUsageStats = 40;
        ...
        static final int TRANSACTION_registerUsageStatsWatcher = 37;
        static final int TRANSACTION_registerUsageStatsWatcherWithComponent = 38;
        ...
        static final int TRANSACTION_unregisterUsageStatsWatcher = 39;
                ...
                default:
                    switch (code) {
                        ...
                        case 36:
                            ...
                            return true;
                        case 37:
                            IUsageStatsWatcher _arg033 = IUsageStatsWatcher.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            registerUsageStatsWatcher(_arg033);
                            reply.writeNoException();
                            return true;
                        case 38:
                            IUsageStatsWatcher _arg034 = IUsageStatsWatcher.Stub.asInterface(data.readStrongBinder());
                            List<ComponentName> _arg132 = data.createTypedArrayList(ComponentName.CREATOR);
                            data.enforceNoDataAvail();
                            registerUsageStatsWatcherWithComponent(_arg034, _arg132);
                            reply.writeNoException();
                            return true;
                        case 39:
                            IUsageStatsWatcher _arg035 = IUsageStatsWatcher.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            unregisterUsageStatsWatcher(_arg035);
                            reply.writeNoException();
                            return true;
                        case 40:
                            deleteUsageStats();
