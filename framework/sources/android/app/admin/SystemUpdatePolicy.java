...
public final class SystemUpdatePolicy implements Parcelable {
    ...
    public static class SemInstallationOption {
        ...
        SemInstallationOption(int type, long effectiveTime) {
            this.mType = type;
            this.mEffectiveTime = effectiveTime;
        }
    ...
    public SemInstallationOption semGetInstallationOptionAt(long when) {
        InstallationOption o = getInstallationOptionAt(when);
        return new SemInstallationOption(o.mType, o.mEffectiveTime);
    }
