...
public final class AppProtoEnums {
    ...
    public static final int APP_OP_CTA_ENABLE_BT = 137;
    public static final int APP_OP_CTA_ENABLE_DATA = 138;
    public static final int APP_OP_CTA_ENABLE_WIFI = 136;
    public static final int APP_OP_CTA_SEND_MMS = 139;
