...
public final class WearSettingsEnums {
    ...
    public static final int ACCESSIBILITY_COLOR_CORRECTION_ENABLED = 417;
    public static final int ACCESSIBILITY_COLOR_INVERSION = 103;
    public static final int ACCESSIBILITY_FONT_SIZE = 369;
    public static final int ACCESSIBILITY_GESTURES = 419;
    public static final int ACCESSIBILITY_GRAYSCALE_CORRECTION = 420;
    public static final int ACCESSIBILITY_LARGE_TEXT = 102;
    public static final int ACCESSIBILITY_MAGNIFICATION = 104;
    public static final int ACCESSIBILITY_MAGNIFICATION_EDGE_HAPTIC = 415;
    public static final int ACCESSIBILITY_MAGNIFICATION_SETTINGS = 414;
    public static final int ACCESSIBILITY_MAGNIFICATION_SIZE = 413;
    public static final int ACCESSIBILITY_PROTANOMALY_CORRECTION = 423;
    public static final int ACCESSIBILITY_REDUCE_ANIMATION = 412;
    public static final int ACCESSIBILITY_RTT = 455;
    public static final int ACCESSIBILITY_SERVICE = 314;
    public static final int ACCESSIBILITY_SERVICE_TALKBACK = 422;
    ...
    public static final int ACCESSIBILITY_TALKBACK_SETTINGS = 421;
    public static final int ACCESSIBILITY_TRIPLE_PRESS_GESTURE = 376;
    public static final int ACCESSIBILITY_TRITANOMALY_CORRECTION = 424;
    ...
    public static final int ACCESSIBILITY_VIBRATION_WATCH = 446;
    public static final int ACCESSIBILITY_VIBRATION_WATCH_SPEED = 450;
    public static final int ACCESSIBILITY_VIBRATION_WATCH_SWITCH = 447;
    public static final int ACCESSIBILITY_VIBRATION_WATCH_TYPE_DIGIT = 448;
    public static final int ACCESSIBILITY_VIBRATION_WATCH_TYPE_TERSE = 449;
    public static final int ACCOUNTS_ADD_ACCOUNT = 115;
    public static final int ACCOUNT_REMOVE_ACCOUNT = 230;
    public static final int ACCOUNT_SETTING = 435;
    ...
    public static final int ACTIVE_UNLOCK = 425;
    public static final int ADVANCE_PERMISSIONS_INSTALL_UNKNOWN = 483;
    ...
    public static final int APP_DETAILS_ADVANCED_PERMISSIONS_EXACT_ALARM = 507;
    ...
    public static final int APP_DETAILS_DATA_SOURCES = 500;
    public static final int APP_DETAILS_FORCE_STOP = 195;
    public static final int APP_DETAILS_LICENSES = 501;
    ...
    public static final int ASSISTANT_SETTING = 434;
    public static final int ASSISTANT_VOICE_ASSISTANT = 309;
    public static final int AUDIO_ADJUSTMENT = 409;
    public static final int AUDIO_BALANCE_LEFT_RIGHT_TEXT = 411;
    public static final int AUDIO_BALANCE_SLIDER_PREFERENCE = 410;
    public static final int AUTO_BEDTIME_MODE_SETTINGS_SWITCH = 505;
    public static final int BACKUP_SETTING = 482;
    public static final int BATTERY_SAVER_AUTO_BATTERY_SAVER_ENABLED = 324;
    public static final int BATTERY_SAVER_AUTO_BATTERY_SAVER_OFF = 494;
    public static final int BATTERY_SAVER_AUTO_BATTERY_SAVER_ON = 493;
    public static final int BATTERY_SAVER_BATTERY_SAVER = 315;
    public static final int BATTERY_SAVER_EXPLANATION_TEXT = 453;
    public static final int BATTERY_SAVER_SECTION_TITLE_TEXT = 452;
    public static final int BATTERY_SAVER_SETTINGS = 492;
    ...
    public static final int BLUETOOTH_LE_AUDIO = 502;
    ...
    public static final int CAMERA_ACCESS_PACKAGES = 441;
    ...
    public static final int CHARGING_SOUNDS = 428;
    ...
    public static final int CONNECTIVITY_CONNECTED_FITNESS = 496;
    public static final int CONNECTIVITY_NFC = 219;
    public static final int CONNECTIVITY_UWB = 499;
    ...
    public static final int DEFAULT_APPS = 456;
    public static final int DEFAULT_ASSIST = 457;
    ...
    public static final int DEVELOPER_SHOW_ROTARY_INPUT = 488;
    ...
    public static final int DEVELOPER_USE_DEVELOPER_OPTIONS = 489;
    public static final int DEVELOPER_VERBOSE_VENDOR_LOGGING = 510;
    ...
    public static final int DIAGNOSTICS = 485;
    ...
    public static final int DISPLAY_SETTINGS_RESET = 506;
    public static final int DISPLAY_SIZE = 503;
    public static final int DISPLAY_WRIST_ORIENTATION = 368;
    public static final int DIVIDER_PREFERENCE = 436;
    ...
    public static final int ENTERPRISE_INSTALLED_PACKAGES = 438;
    public static final int ENTERPRISE_PRIVACY = 442;
    public static final int ENTERPRISE_SET_DEFAULT_APPS = 437;
    ...
    public static final int ESIM_PROFILE_NICKNAME = 444;
    public static final int ESIM_SETTINGS = 443;
    ...
    public static final int FONT_BOLD_TEXT = 408;
    public static final int FONT_SLIDER = 433;
    public static final int FREE_MEM_OVERLAY = 475;
    ...
    public static final int GOOGLE_SPARKLING_WATER = 504;
    ...
    public static final int HIGH_BRIGHTNESS_KEY = 454;
    public static final int INPUT_ADD_VIRTUAL_KEYBOARD_SCREEN = 317;
    public static final int INPUT_SMART_REPLY = 253;
    public static final int LANGUAGE_PREFERENCE = 474;
    public static final int LOCATION_ACCESS_PACKAGES = 439;
    ...
    public static final int MAIN_SECURITY = 445;
    ...
    public static final int MANAGE_PERMISSIONS = 477;
    public static final int MICROPHONE_ACCESS_PACKAGES = 440;
    public static final int MONO_AUDIO = 429;
    public static final int NFC_TAP_AND_PAY = 258;
    public static final int OEM_UNLOCK_ENABLE = 481;
    public static final int PARENTAL_CONTROLS = 486;
    ...
    public static final int PRIVACY_DASHBOARD = 495;
    ...
    public static final int SMDP_ADDRESS = 471;
    ...
    public static final int SOUND_MUTE_ALARM_WITH_RINGER_MODE = 498;
    public static final int SOUND_MUTE_RINGER = 497;
    public static final int SOUND_NOTIFICATION_VOLUME = 508;
    public static final int SOUND_RING_AND_NOTIFICATIONS_VOLUME = 509;
    public static final int SOUND_RING_VOLUME = 233;
    public static final int SOUND_WATCH_RINGTONE = 271;
    public static final int STEM_1 = 478;
    public static final int STEM_2 = 479;
    public static final int STEM_3 = 480;
    ...
    public static final int SYSTEM_STATE_OVERLAY = 473;
    public static final int SYSTEM_STATE_OVERLAY_SETTINGS = 472;
    public static final int SYSTEM_SYSTEM_UPDATE = 257;
    public static final int SYSTEM_TTS = 490;
    public static final int UNKNOWN = 0;
    public static final int USAGE_ACCESS = 470;
    public static final int USE_SCREENSHOT = 460;
    public static final int USE_SCREENSHOT_SUMMARY = 461;
    public static final int USE_TEXT_CONTEXT = 458;
    public static final int USE_TEXT_CONTEXT_SUMMARY = 459;
    public static final int VIBRATION_LEVEL = 268;
    public static final int VIBRATION_MUTE_WHEN_OFF_BODY = 318;
    public static final int VIBRATION_SWITCH = 487;
    public static final int VIBRATION_VIBRATE_FOR_CALLS = 267;
    public static final int VIBRATION_VIBRATE_FOR_RSB = 389;
    public static final int WATCH_LICENSE = 431;
    public static final int WATCH_SYSTEM_LICENSES = 432;
    public static final int WEAR_BATTERY_SAVER_EXPLANATION_TEXT = 451;
    public static final int WEAR_POWER_ANOMALY_SERVICE = 491;
    public static final int WET_MODE = 484;
    ...
    public static final int WIRELESS_ADB_DEVICE_FINGERPRINT = 469;
    public static final int WIRELESS_ADB_DEVICE_NAME = 468;
    public static final int WIRELESS_DEBUG = 462;
    public static final int WIRELESS_DEBUG_DEVICE_NAME = 464;
    public static final int WIRELESS_DEBUG_IP_PORT = 465;
    public static final int WIRELESS_DEBUG_PAIRING = 467;
    public static final int WIRELESS_DEBUG_SUMMARY = 466;
    public static final int WIRELESS_DEBUG_TOGGLE = 463;
}
