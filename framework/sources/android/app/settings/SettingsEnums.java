...
public final class SettingsEnums {
    ...
    public static final int ACCESSIBILITY_HEARING_AID_SETTINGS = 2024;
    ...
    public static final int ACCOUNT_DETAIL = 2031;
    public static final int ACCOUNT_PERSONAL = 2030;
    public static final int ACCOUNT_PRIVATE = 2044;
    ...
    public static final int ACTION_ADAPTIVE_TIMEOUT_CHANGED = 1904;
    public static final int ACTION_ADAPTIVE_TOUCH_SENSITIVITY_CHANGED = 1921;
    public static final int ACTION_ADAPTIVE_VIBRATION_CHANGED = 1914;
    public static final int ACTION_ADB_WIRELESS_OFF = 1735;
    public static final int ACTION_ADB_WIRELESS_ON = 1734;
    public static final int ACTION_ADD_LANGUAGE = 1831;
    public static final int ACTION_ADD_SYSTEM_LOCALE_FROM_RECOMMENDATION = 1898;
    ...
    public static final int ACTION_APP_BATTERY_USAGE_ALLOW_BACKGROUND = 1881;
    public static final int ACTION_APP_BATTERY_USAGE_DISABLE_BACKGROUND = 1882;
    ...
    public static final int ACTION_APP_RESTRICTED_LIST_MANAGED = 1906;
    ...
    public static final int ACTION_AUDIO_SHARING_CHANGE_CALL_AUDIO = 1930;
    public static final int ACTION_AUDIO_SHARING_CHANGE_MEDIA_DEVICE_VOLUME = 1927;
    public static final int ACTION_AUDIO_SHARING_DEVICE_CLICK = 1935;
    public static final int ACTION_AUDIO_SHARING_DIALOG_AUTO_DISMISS = 1942;
    public static final int ACTION_AUDIO_SHARING_DIALOG_NEGATIVE_BTN_CLICKED = 1941;
    public static final int ACTION_AUDIO_SHARING_DIALOG_POSITIVE_BTN_CLICKED = 1940;
    public static final int ACTION_AUDIO_SHARING_IMPROVE_COMPATIBILITY = 1929;
    public static final int ACTION_AUDIO_SHARING_JOIN_FAILED = 1936;
    public static final int ACTION_AUDIO_SHARING_LEAVE_FAILED = 1937;
    public static final int ACTION_AUDIO_SHARING_MAIN_SWITCH_OFF = 1924;
    public static final int ACTION_AUDIO_SHARING_MAIN_SWITCH_ON = 1923;
    public static final int ACTION_AUDIO_SHARING_PLAY_TEST_SOUND = 1928;
    public static final int ACTION_AUDIO_SHARING_START_FAILED = 1925;
    public static final int ACTION_AUDIO_SHARING_STOP_FAILED = 1926;
    public static final int ACTION_AUDIO_STREAM_CONFIRM_LAUNCH_MAIN_BUTTON_CLICK = 1949;
    public static final int ACTION_AUDIO_STREAM_JOIN = 1945;
    public static final int ACTION_AUDIO_STREAM_JOIN_FAILED_BAD_CODE = 1953;
    public static final int ACTION_AUDIO_STREAM_JOIN_FAILED_OTHER = 1955;
    public static final int ACTION_AUDIO_STREAM_JOIN_FAILED_TIMEOUT = 1954;
    public static final int ACTION_AUDIO_STREAM_JOIN_FAILED_WAIT_FOR_SYNC_TIMEOUT = 1956;
    public static final int ACTION_AUDIO_STREAM_JOIN_SUCCEED = 1946;
    public static final int ACTION_AUDIO_STREAM_LEAVE_BUTTON_CLICK = 1947;
    public static final int ACTION_AUDIO_STREAM_LEAVE_FAILED = 1948;
    public static final int ACTION_AUDIO_STREAM_NAME_UPDATED = 1943;
    public static final int ACTION_AUDIO_STREAM_NOTIFICATION_LEAVE_BUTTON_CLICK = 1951;
    ...
    public static final int ACTION_BATTERY_HEALTH_TIP = 1883;
    ...
    public static final int ACTION_BATTERY_TIPS_CARD_ACCEPT = 1861;
    public static final int ACTION_BATTERY_TIPS_CARD_DISMISS = 1862;
    public static final int ACTION_BATTERY_TIPS_CARD_SHOW = 1860;
    ...
    public static final int ACTION_BLUETOOTH_DEVICE_DETAILS_HEAD_TRACKING_TOGGLE_CLICKED = 1913;
    public static final int ACTION_BLUETOOTH_DEVICE_DETAILS_HEAD_TRACKING_TRIGGERED = 1911;
    public static final int ACTION_BLUETOOTH_DEVICE_DETAILS_SPATIAL_AUDIO_TOGGLE_CLICKED = 1912;
    public static final int ACTION_BLUETOOTH_DEVICE_DETAILS_SPATIAL_AUDIO_TRIGGERED = 1910;
    ...
    public static final int ACTION_CANCEL_AUDIO_SHARING_NOTIFICATION = 1932;
    public static final int ACTION_CANCEL_SYSTEM_LOCALE_FROM_RECOMMENDATION = 1899;
    public static final int ACTION_CELL_DATA_TOGGLE = 178;
    public static final int ACTION_CHANGE_APP_LANGUAGE_FROM_SUGGESTED = 1837;
    public static final int ACTION_CHANGE_LANGUAGE = 1834;
    public static final int ACTION_CHOOSE_LANGUAGE_FOR_NUMBERS_PREFERENCES = 1828;
    ...
    public static final int ACTION_EASY_MODE_CHANGED = 1901;
    ...
    public static final int ACTION_FROM_ACTION_KEY_TO = 1843;
    public static final int ACTION_FROM_ALT_TO = 1844;
    public static final int ACTION_FROM_CAPS_LOCK_TO = 1841;
    public static final int ACTION_FROM_CTRL_TO = 1842;
    public static final int ACTION_GESTURE_BOTTOM_RIGHT_TAP_CHANGED = 1848;
    public static final int ACTION_GESTURE_GO_BACK_CHANGED = 1850;
    public static final int ACTION_GESTURE_GO_HOME_CHANGED = 1851;
    public static final int ACTION_GESTURE_NOTIFICATION_CHANGED = 1853;
    public static final int ACTION_GESTURE_POINTER_SPEED_CHANGED = 1849;
    public static final int ACTION_GESTURE_RECENT_APPS_CHANGED = 1852;
    public static final int ACTION_GESTURE_REVERSE_SCROLLING_CHANGED = 1847;
    public static final int ACTION_GESTURE_SWITCH_APPS_CHANGED = 1854;
    public static final int ACTION_GESTURE_TAP_DRAGGING_CHANGED = 1909;
    public static final int ACTION_GESTURE_TAP_TO_CLICK_CHANGED = 1846;
    ...
    public static final int ACTION_KEYBOARD_VIBRATION_CHANGED = 1900;
    public static final int ACTION_LANGUAGES_LEARN_MORE = 1830;
    public static final int ACTION_LEARN_TOUCHPAD_GESTURE_CLICK = 1855;
    public static final int ACTION_LONG_BACKGROUND_TASKS_TOGGLE = 1804;
    public static final int ACTION_LOW_BATTERY_TIP = 1352;
    public static final int ACTION_MEDIA_DEVICE_CLICK = 1934;
    ...
    public static final int ACTION_NOTIFICATION_CLICK_FOR_SYSTEM_LOCALE = 1896;
    public static final int ACTION_NOTIFICATION_FOR_SYSTEM_LOCALE = 1895;
    public static final int ACTION_NOTIFICATION_SWIPE_FOR_SYSTEM_LOCALE = 1897;
    public static final int ACTION_NOT_GRANT_ADMIN_FROM_SETTINGS_CREATION_DIALOG = 1819;
    public static final int ACTION_NOT_SUPPORTED_SYSTEM_LANGUAGE = 1836;
    public static final int ACTION_OPEN_APP_NOTIFICATION_SETTING = 1016;
    public static final int ACTION_OPEN_APP_SETTING = 1017;
    public static final int ACTION_OPEN_PK_SETTINGS_FROM = 1838;
    public static final int ACTION_PANEL_INTERACTION = 1658;
    public static final int ACTION_PK_LAYOUT_CHANGED = 1840;
    public static final int ACTION_PRIVATE_DNS_MODE = 1249;
    public static final int ACTION_PRIVATE_SPACE_SETUP_ACCOUNT_LOGIN_START = 1894;
    public static final int ACTION_PRIVATE_SPACE_SETUP_ACCOUNT_LOGIN_SUCCESS = 1889;
    public static final int ACTION_PRIVATE_SPACE_SETUP_CANCEL = 1885;
    public static final int ACTION_PRIVATE_SPACE_SETUP_CANCEL_CREATE_SPACE = 1888;
    public static final int ACTION_PRIVATE_SPACE_SETUP_DONE = 1893;
    public static final int ACTION_PRIVATE_SPACE_SETUP_NEW_LOCK = 1891;
    public static final int ACTION_PRIVATE_SPACE_SETUP_SKIP_ACCOUNT_LOGIN = 1902;
    public static final int ACTION_PRIVATE_SPACE_SETUP_SPACE_CREATED = 1886;
    public static final int ACTION_PRIVATE_SPACE_SETUP_START = 1884;
    public static final int ACTION_PRIVATE_SPACE_SETUP_TRY_CREATE_ACCOUNT_AGAIN = 1890;
    public static final int ACTION_PRIVATE_SPACE_SETUP_TRY_CREATE_SPACE_AGAIN = 1887;
    public static final int ACTION_PRIVATE_SPACE_SETUP_USE_SCREEN_LOCK = 1892;
    public static final int ACTION_PSD_LOADER = 1019;
    public static final int ACTION_REMOVE_GUEST_USER = 1810;
    public static final int ACTION_REMOVE_LANGUAGE = 1832;
    public static final int ACTION_REMOVE_RESTRICTED_USER = 1811;
    public static final int ACTION_REMOVE_USER = 1809;
    public static final int ACTION_REORDER_LANGUAGE = 1833;
    public static final int ACTION_RESET_ESIMS_RAC_CONNECTIVITY_WARNING = 1917;
    public static final int ACTION_RESET_MOBILE_NETWORK_RAC_CONNECTIVITY_WARNING = 1916;
    ...
    public static final int ACTION_RUN_BACKUP_TASKS_TOGGLE = 1907;
    ...
    public static final int ACTION_SETTINGS_BLUETOOTH_PAIR_FAST_PAIR_DEVICE = 1866;
    ...
    public static final int ACTION_SETTINGS_ESIM_RAC_CONNECTIVITY_WARNING = 1915;
    public static final int ACTION_SETTINGS_GROUP_TILE_ADDED_TO_SCREEN = 1835;
    ...
    public static final int ACTION_SETTINGS_PREVIOUSLY_USED_WITH_ACCOUNT_BLUETOOTH_PAIR = 1863;
    public static final int ACTION_SETTINGS_PREVIOUSLY_USED_WITH_ACCOUNT_BLUETOOTH_PAIR_ERROR = 1864;
    public static final int ACTION_SETTINGS_PREVIOUSLY_USED_WITH_ACCOUNT_BLUETOOTH_PAIR_NOT_FOUND = 1865;
    public static final int ACTION_SETTINGS_PREVIOUSLY_USED_WITH_ACCOUNT_LIST = 1918;
    public static final int ACTION_SETTINGS_PREVIOUSLY_USED_WITH_ACCOUNT_PAIR_SUCCEED = 1919;
    ...
    public static final int ACTION_SET_FIRST_DAY_OF_WEEK = 1827;
    public static final int ACTION_SET_NEW_PARENT_PROFILE_PASSWORD = 1646;
    public static final int ACTION_SET_NEW_PASSWORD = 1645;
    public static final int ACTION_SET_NUMBERS_PREFERENCES = 1829;
    public static final int ACTION_SET_PRIVATE_SPACE_AUTOLOCK = 1908;
    public static final int ACTION_SET_TEMPERATURE_UNIT = 1826;
    public static final int ACTION_SHOW_AUDIO_SHARING_DIALOG = 1939;
    public static final int ACTION_SHOW_AUDIO_SHARING_NOTIFICATION = 1931;
    public static final int ACTION_SMART_BATTERY_TIP = 1350;
    public static final int ACTION_STOP_AUDIO_SHARING_FROM_NOTIFICATION = 1933;
    ...
    public static final int ACTION_TERMS_OF_ADDRESS_FEMININE = 1857;
    public static final int ACTION_TERMS_OF_ADDRESS_MASCULINE = 1858;
    public static final int ACTION_TERMS_OF_ADDRESS_NEUTRAL = 1859;
    public static final int ACTION_TERMS_OF_ADDRESS_NOT_SPECIFIED = 1856;
    public static final int ACTION_TERMS_OF_ADDRESS_SPECIFIED = 1905;
    ...
    public static final int ACTION_TOUCH_SENSITIVITY_CHANGED = 1922;
    ...
    public static final int ACTION_USER_ASPECT_RATIO_16_9_SELECTED = 1875;
    public static final int ACTION_USER_ASPECT_RATIO_16_9_UNSELECTED = 1876;
    public static final int ACTION_USER_ASPECT_RATIO_3_2_SELECTED = 1877;
    public static final int ACTION_USER_ASPECT_RATIO_3_2_UNSELECTED = 1878;
    public static final int ACTION_USER_ASPECT_RATIO_4_3_SELECTED = 1873;
    public static final int ACTION_USER_ASPECT_RATIO_4_3_UNSELECTED = 1874;
    public static final int ACTION_USER_ASPECT_RATIO_APP_DEFAULT_SELECTED = 1867;
    public static final int ACTION_USER_ASPECT_RATIO_APP_DEFAULT_UNSELECTED = 1868;
    public static final int ACTION_USER_ASPECT_RATIO_DISPLAY_SIZE_SELECTED = 1879;
    public static final int ACTION_USER_ASPECT_RATIO_DISPLAY_SIZE_UNSELECTED = 1880;
    public static final int ACTION_USER_ASPECT_RATIO_FULL_SCREEN_SELECTED = 1869;
    public static final int ACTION_USER_ASPECT_RATIO_FULL_SCREEN_UNSELECTED = 1870;
    public static final int ACTION_USER_ASPECT_RATIO_HALF_SCREEN_SELECTED = 1871;
    public static final int ACTION_USER_ASPECT_RATIO_HALF_SCREEN_UNSELECTED = 1872;
    ...
    public static final int ACTION_USE_SPECIFIC_KEYBOARD = 1839;
    ...
    public static final int ACTION_WIRELESS_CHARGING_LEARN_MORE = 1920;
    public static final int ACTION_WIRELESS_CHARGING_TIP = 1903;
    ...
    public static final int ADAPTIVE_VIBRATION = 2074;
    ...
    public static final int APP_SPECIAL_PERMISSION_RECEIVE_SANDBOX_TRIGGER_AUDIO_ALLOW = 2046;
    public static final int APP_SPECIAL_PERMISSION_RECEIVE_SANDBOX_TRIGGER_AUDIO_DENY = 2047;
    ...
    public static final int AUDIO_STREAM_MAIN = 2093;
    public static final int AUDIO_STREAM_QR_CODE = 2094;
    public static final int AUDIO_STREAM_QR_CODE_SCAN = 2095;
    ...
    public static final int BLUETOOTH_A2DP_DUAL_AUDIO = 3039;
    ...
    public static final int CELLULAR_SECURITY_SETTINGS = 2075;
    ...
    public static final int CONNECTED_DEVICES_SETTINGS = 2;
    public static final int CONNECTED_DEVICE_PREFERENCES_THREAD = 2082;
    ...
    public static final int CONTENT_PROTECTION_PREFERENCE = 2045;
    ...
    public static final int DEVELOPMENT_APP_PICKER = 2057;
    ...
    public static final int DIALOG_ADD_FACE_ERROR_IN_SPLIT_MODE = 2029;
    public static final int DIALOG_ADD_FINGERPRINT_ERROR_IN_SPLIT_MODE = 2028;
    ...
    public static final int DIALOG_AUDIO_SHARING_ADD_DEVICE = 2086;
    public static final int DIALOG_AUDIO_SHARING_CALL_AUDIO = 2084;
    public static final int DIALOG_AUDIO_SHARING_CONFIRMATION = 2085;
    public static final int DIALOG_AUDIO_SHARING_SWITCH_ACTIVE = 2052;
    public static final int DIALOG_AUDIO_SHARING_SWITCH_DEVICE = 2051;
    public static final int DIALOG_AUDIO_STREAM_CONFIRM_DATA_ERROR = 2090;
    public static final int DIALOG_AUDIO_STREAM_CONFIRM_FEATURE_UNSUPPORTED = 2089;
    public static final int DIALOG_AUDIO_STREAM_CONFIRM_LISTEN = 2088;
    public static final int DIALOG_AUDIO_STREAM_CONFIRM_NO_LE_DEVICE = 2091;
    public static final int DIALOG_AUDIO_STREAM_MAIN_JOIN_FAILED_TIMEOUT = 2098;
    public static final int DIALOG_AUDIO_STREAM_MAIN_NO_LE_DEVICE = 2096;
    public static final int DIALOG_AUDIO_STREAM_MAIN_WAIT_FOR_SYNC_TIMEOUT = 2097;
    ...
    public static final int DIALOG_ENABLE_16K_PAGES = 2042;
    ...
    public static final int DIALOG_START_AUDIO_SHARING = 2049;
    public static final int DIALOG_STOP_AUDIO_SHARING = 2050;
    ...
    public static final int DIALOG_TEMPORARY_FILES_INFO = 2079;
    ...
    public static final int FAST_PAIR_DEVICES = 2039;
    ...
    public static final int FLASH_NOTIFICATION_SETTINGS = 2027;
    public static final int FOLD_LOCK_BEHAVIOR = 2038;
    ...
    public static final int FUELGAUGE_POWER_USAGE_MANAGE_BACKGROUND = 2055;
    ...
    public static final int HEARING_AID_AUDIO_ROUTING = 2026;
    public static final int HEARING_AID_PAIRING = 2025;
    ...
    public static final int KEYBOARD_CONFIGURED_NOTIFICATION = 0;
    public static final int KEYBOARD_SETTINGS = 1;
    public static final int LEAVE_APP_BATTERY_USAGE = 2067;
    public static final int LEAVE_POWER_USAGE_MANAGE_BACKGROUND = 2069;
    public static final int LE_AUDIO_BROADCAST_FIND_BROADCAST = 2019;
    public static final int LE_AUDIO_BROADCAST_LOCAL_BROADCAST = 3038;
    ...
    public static final int LOCATION_SERVICES_FOR_PRIVATE_PROFILE = 2081;
    ...
    public static final int MEDIA_DRM_SETTINGS = 2080;
    public static final int MEDIA_MANAGEMENT_APPS = 1874;
    public static final int MEDIA_ROUTING_CONTROL = 2064;
    ...
    public static final int NOTIFICATION_AUDIO_SHARING = 2087;
    ...
    public static final int OPEN_POWER_USAGE_MANAGE_BACKGROUND = 2068;
    ...
    public static final int PRIVATE_SPACE_SETTINGS = 2040;
    public static final int PRIVATE_SPACE_SETUP_ACCOUNT_LOGIN_ERROR = 2062;
    public static final int PRIVATE_SPACE_SETUP_EDUCATION = 2058;
    public static final int PRIVATE_SPACE_SETUP_FINISH = 2063;
    public static final int PRIVATE_SPACE_SETUP_LOCK = 2061;
    public static final int PRIVATE_SPACE_SETUP_PRE_FINISH = 2073;
    public static final int PRIVATE_SPACE_SETUP_SPACE_CREATION = 2059;
    public static final int PRIVATE_SPACE_SETUP_SPACE_CREATION_ERROR = 2060;
    ...
    public static final int QUARANTINED_APPS_DEV_CONTROL = 2041;
    ...
    public static final int RESET_DELETE_PRIVATE_SPACE_CANCEL = 2078;
    public static final int RESET_DELETE_PRIVATE_SPACE_CONFIRM = 2077;
    public static final int RESET_DELETE_PRIVATE_SPACE_DIALOG = 2076;
    ...
    public static final int SATELLITE_SETTING = 2071;
    ...
    public static final int SESSION_EXTERNAL = 3;
    public static final int SESSION_SEARCH = 2;
    public static final int SESSION_SLICE_TYPE = 4;
    ...
    public static final int SETTINGS_BATTERY_INFORMATION = 2032;
    ...
    public static final int SETTINGS_EASY_PRESET = 2070;
    ...
    public static final int SETTINGS_KEYBOARDS_LAYOUT_PICKER_TITLE = 1957;
    ...
    public static final int SETTINGS_WHEN_TO_DREAM = 2036;
    ...
    public static final int SUW_ACCESSIBILITY_AUTO_BRIGHTNESS = 2083;
    ...
    public static final int TERMS_OF_ADDRESS = 2034;
    ...
    public static final int TOUCH_SENSITIVITY_SETTINGS = 2065;
    ...
    public static final int USER_ASPECT_RATIO_APP_INFO_SETTINGS = 2054;
    public static final int USER_ASPECT_RATIO_APP_LIST_SETTINGS = 2056;
    ...
    public static final int VPN_APP_MANAGEMENT = 2033;
    ...
    public static final int WIDEVINE_SETTINGS = 2053;
