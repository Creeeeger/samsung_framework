...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public SuggestionSpan(Parcel src) {
        ...
        this.mGrammarSuggestionUnderlineColor = src.readInt();
        this.mGrammarSuggestionUnderlineThickness = src.readFloat();
        this.mTypoSuggestionUnderlineColor = src.readInt();
        this.mTypoSuggestionUnderlineThickness = src.readFloat();
    }
    ...
    public void writeToParcelInternal(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mGrammarSuggestionUnderlineColor);
        dest.writeFloat(this.mGrammarSuggestionUnderlineThickness);
        dest.writeInt(this.mTypoSuggestionUnderlineColor);
        dest.writeFloat(this.mTypoSuggestionUnderlineThickness);
    }
