...
public final class RemoteConnectionService {
    ...
    public final RemoteConnection createRemoteConnection(PhoneAccountHandle connectionManagerPhoneAccount, ConnectionRequest request, boolean isIncoming) {
        ...
        ConnectionRequest newRequest = new ConnectionRequest.Builder().setTelecomCallId(request.getTelecomCallId()).setAccountHandle(request.getAccountHandle()).setAddress(request.getAddress()).setExtras(extras).setVideoState(request.getVideoState()).setRttPipeFromInCall(request.getRttPipeFromInCall()).setRttPipeToInCall(request.getRttPipeToInCall()).build();
        try {
