...
public interface IGnssDebug extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssDebug {
        ...
        public static IGnssDebug asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IGnssDebug)) {
                return (IGnssDebug) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                default:
                    switch (code) {
                        case 1:
                            DebugData _result = getDebugData();
                            reply.writeNoException();
        ...
        /* loaded from: classes2.dex */
        public static class Proxy implements IGnssDebug {
            ...
            public DebugData getDebugData() throws RemoteException {
                ...
                try {
                    ...
                    DebugData _result = (DebugData) _reply.readTypedObject(DebugData.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
    ...
    public static class TimeDebug implements Parcelable {
        ...
        /* renamed from: android.hardware.gnss.IGnssDebug$TimeDebug$1 */
        /* loaded from: classes2.dex */
        class AnonymousClass1 implements Parcelable.Creator<TimeDebug> {
            AnonymousClass1() {
            }
        ...
        public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
            ...
            _aidl_parcel.writeLong(this.timeEstimateMs);
            _aidl_parcel.writeFloat(this.timeUncertaintyNs);
            _aidl_parcel.writeFloat(this.frequencyUncertaintyNsPerSec);
        ...
        public final void readFromParcel(Parcel _aidl_parcel) {
            ...
            try {
                ...
                this.timeEstimateMs = _aidl_parcel.readLong();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.timeUncertaintyNs = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    ...
                    this.frequencyUncertaintyNsPerSec = _aidl_parcel.readFloat();
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public static class PositionDebug implements Parcelable {
        ...
        /* renamed from: android.hardware.gnss.IGnssDebug$PositionDebug$1 */
        /* loaded from: classes2.dex */
        class AnonymousClass1 implements Parcelable.Creator<PositionDebug> {
            AnonymousClass1() {
            }
        ...
        public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
            int _aidl_start_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.writeInt(0);
            _aidl_parcel.writeBoolean(this.valid);
            _aidl_parcel.writeDouble(this.latitudeDegrees);
            _aidl_parcel.writeDouble(this.longitudeDegrees);
            _aidl_parcel.writeFloat(this.altitudeMeters);
            _aidl_parcel.writeFloat(this.speedMetersPerSec);
            _aidl_parcel.writeFloat(this.bearingDegrees);
            _aidl_parcel.writeDouble(this.horizontalAccuracyMeters);
            _aidl_parcel.writeDouble(this.verticalAccuracyMeters);
            _aidl_parcel.writeDouble(this.speedAccuracyMetersPerSecond);
            _aidl_parcel.writeDouble(this.bearingAccuracyDegrees);
            _aidl_parcel.writeFloat(this.ageSeconds);
            int _aidl_end_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.setDataPosition(_aidl_start_pos);
            _aidl_parcel.writeInt(_aidl_end_pos - _aidl_start_pos);
            _aidl_parcel.setDataPosition(_aidl_end_pos);
        ...
        public final void readFromParcel(Parcel _aidl_parcel) {
            ...
            try {
                ...
                this.valid = _aidl_parcel.readBoolean();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.altitudeMeters = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.speedMetersPerSec = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.bearingDegrees = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.horizontalAccuracyMeters = _aidl_parcel.readDouble();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.verticalAccuracyMeters = _aidl_parcel.readDouble();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.speedAccuracyMetersPerSecond = _aidl_parcel.readDouble();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.bearingAccuracyDegrees = _aidl_parcel.readDouble();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    ...
                    this.ageSeconds = _aidl_parcel.readFloat();
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public static class SatelliteData implements Parcelable {
        ...
        /* renamed from: android.hardware.gnss.IGnssDebug$SatelliteData$1 */
        /* loaded from: classes2.dex */
        class AnonymousClass1 implements Parcelable.Creator<SatelliteData> {
            AnonymousClass1() {
            }
        ...
        public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
            ...
            _aidl_parcel.writeInt(this.ephemerisType);
            _aidl_parcel.writeInt(this.ephemerisSource);
            _aidl_parcel.writeInt(this.ephemerisHealth);
            _aidl_parcel.writeFloat(this.ephemerisAgeSeconds);
            _aidl_parcel.writeBoolean(this.serverPredictionIsAvailable);
            _aidl_parcel.writeFloat(this.serverPredictionAgeSeconds);
            int _aidl_end_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.setDataPosition(_aidl_start_pos);
            _aidl_parcel.writeInt(_aidl_end_pos - _aidl_start_pos);
            _aidl_parcel.setDataPosition(_aidl_end_pos);
        ...
        public final void readFromParcel(Parcel _aidl_parcel) {
            ...
            try {
                ...
                this.ephemerisType = _aidl_parcel.readInt();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.ephemerisSource = _aidl_parcel.readInt();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.ephemerisHealth = _aidl_parcel.readInt();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.ephemerisAgeSeconds = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.serverPredictionIsAvailable = _aidl_parcel.readBoolean();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    ...
                    this.serverPredictionAgeSeconds = _aidl_parcel.readFloat();
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public static class DebugData implements Parcelable {
        ...
        /* renamed from: android.hardware.gnss.IGnssDebug$DebugData$1 */
        /* loaded from: classes2.dex */
        class AnonymousClass1 implements Parcelable.Creator<DebugData> {
            AnonymousClass1() {
            }
        ...
        public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
            ...
            _aidl_parcel.writeTypedObject(this.time, _aidl_flag);
            _aidl_parcel.writeTypedList(this.satelliteDataArray, _aidl_flag);
            int _aidl_end_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.setDataPosition(_aidl_start_pos);
            _aidl_parcel.writeInt(_aidl_end_pos - _aidl_start_pos);
            _aidl_parcel.setDataPosition(_aidl_end_pos);
        ...
        public final void readFromParcel(Parcel _aidl_parcel) {
            ...
            try {
                ...
                this.position = (PositionDebug) _aidl_parcel.readTypedObject(PositionDebug.CREATOR);
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.time = (TimeDebug) _aidl_parcel.readTypedObject(TimeDebug.CREATOR);
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
