...
public final class GnssSignalType {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != GnssSignalType.class) {
            return false;
        }
    ...
    public static final ArrayList<GnssSignalType> readVectorFromParcel(HwParcel parcel) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putDouble(8 + _hidl_offset, this.carrierFrequencyHz);
        _hidl_blob.putString(16 + _hidl_offset, this.codeType);
    }
}
