...
public interface IGnssNavigationMessageInterface extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssNavigationMessageInterface {
        ...
        public static IGnssNavigationMessageInterface asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IGnssNavigationMessageInterface)) {
                return (IGnssNavigationMessageInterface) iin;
            }
