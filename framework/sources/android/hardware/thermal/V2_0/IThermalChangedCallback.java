...
public interface IThermalChangedCallback extends IBase {
    ...
    static IThermalChangedCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IThermalChangedCallback)) {
            return (IThermalChangedCallback) iface;
        }
        IThermalChangedCallback proxy = new Proxy(binder);
        try {
    ...
    static IThermalChangedCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IThermalChangedCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Deprecated
    static IThermalChangedCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Deprecated
    static IThermalChangedCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements IThermalChangedCallback {
        ...
        public void notifyThrottling(Temperature temperature) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IThermalChangedCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IThermalChangedCallback {
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (IThermalChangedCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
