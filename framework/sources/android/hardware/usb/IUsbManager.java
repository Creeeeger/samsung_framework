...
public interface IUsbManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsbManager {
        ...
        static final int TRANSACTION_isSupportDexRestrict = 46;
        ...
        static final int TRANSACTION_restrictUsbHostInterface = 47;
        static final int TRANSACTION_semGetDataRoleStatus = 53;
        static final int TRANSACTION_semGetPowerRoleStatus = 52;
        static final int TRANSACTION_semGrantDevicePermission = 51;
        static final int TRANSACTION_semSetDevicePackage = 50;
        static final int TRANSACTION_semSetMode = 49;
        ...
        static final int TRANSACTION_setUsbHiddenMenuState = 48;
                ...
                default:
                    switch (code) {
                        ...
                        case 39:
                            ...
                            data.enforceNoDataAvail();
                            setPortRoles(_arg031, _arg124, _arg217);
                            reply.writeNoException();
                            return true;
                        case 40:
                            ...
                            data.enforceNoDataAvail();
                            enableLimitPowerTransfer(_arg032, _arg125, _arg218, _arg35);
                            reply.writeNoException();
                            return true;
                        case 41:
                            ...
                            data.enforceNoDataAvail();
                            enableContaminantDetection(_arg033, _arg126);
                            reply.writeNoException();
                            return true;
                        case 42:
                            ComponentName _arg034 = (ComponentName) data.readTypedObject(ComponentName.CREATOR);
                            data.enforceNoDataAvail();
                            setUsbDeviceConnectionHandler(_arg034);
                            reply.writeNoException();
                            return true;
                        case 43:
                            IDisplayPortAltModeInfoListener _arg035 = IDisplayPortAltModeInfoListener.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            boolean _result19 = registerForDisplayPortEvents(_arg035);
                            reply.writeNoException();
                        ...
                        case 44:
                            ...
                            data.enforceNoDataAvail();
                            unregisterForDisplayPortEvents(_arg036);
                            reply.writeNoException();
                            return true;
                        case 45:
                            boolean _result20 = isUsbBlocked();
                            reply.writeNoException();
                            reply.writeBoolean(_result20);
                            return true;
                        case 46:
                            boolean _result21 = isSupportDexRestrict();
                            reply.writeNoException();
                        ...
                        case 47:
                            ...
                            data.enforceNoDataAvail();
                            int _result22 = restrictUsbHostInterface(_arg037, _arg127);
                            reply.writeNoException();
                        ...
                        case 49:
                            ...
                            return true;
                        case 50:
                            UsbDevice _arg040 = (UsbDevice) data.readTypedObject(UsbDevice.CREATOR);
                            String _arg128 = data.readString();
                            int _arg219 = data.readInt();
                            data.enforceNoDataAvail();
                            semSetDevicePackage(_arg040, _arg128, _arg219);
                            reply.writeNoException();
                            return true;
                        case 51:
                            ...
                            data.enforceNoDataAvail();
                            semGrantDevicePermission(_arg041, _arg129);
                            reply.writeNoException();
                            return true;
                        case 52:
                            int _result23 = semGetPowerRoleStatus();
                            reply.writeNoException();
                            reply.writeInt(_result23);
                            return true;
                        case 53:
                            int _result24 = semGetDataRoleStatus();
                            reply.writeNoException();
