...
public class HardwareConfig implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedArray(this.modem, _aidl_flag);
        _aidl_parcel.writeTypedArray(this.sim, _aidl_flag);
    ...
    public String toString() {
        ...
        _aidl_sj.add("modem: " + Arrays.toString(this.modem));
        _aidl_sj.add("sim: " + Arrays.toString(this.sim));
        return "HardwareConfig" + _aidl_sj.toString();
    }

    @Override // android.os.Parcelable
    public int describeContents() {
        int _mask = 0 | describeContents(this.modem);
        return _mask | describeContents(this.sim);
    }
