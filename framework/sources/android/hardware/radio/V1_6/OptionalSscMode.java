...
public final class OptionalSscMode {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != OptionalSscMode.class) {
            return false;
        }
        OptionalSscMode other = (OptionalSscMode) otherObject;
    ...
    public final String toString() {
        ...
        switch (this.hidl_d) {
            ...
            case 1:
                ...
                builder.append(SscMode.toString(value()));
                break;
            default:
    ...
    public static final ArrayList<OptionalSscMode> readVectorFromParcel(HwParcel parcel) {
        ArrayList<OptionalSscMode> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 2, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            OptionalSscMode _hidl_vec_element = new OptionalSscMode();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<OptionalSscMode> _hidl_vec) {
