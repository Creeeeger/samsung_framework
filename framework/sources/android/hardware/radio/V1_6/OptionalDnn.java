    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        switch (int8) {
            case 0:
                ...
                monostate.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                return;
            case 1:
                this.hidl_o = new String();
                this.hidl_o = _hidl_blob.getString(_hidl_offset + 8);
                parcel.readEmbeddedBuffer(r4.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
                return;
            default:
