...
public final class MaybePort {
    ...
    public void range(PortRange range) {
        this.hidl_d = (byte) 1;
        this.hidl_o = range;
    }
    ...
    public PortRange range() {
        ...
        if (this.hidl_o != null && !PortRange.class.isInstance(this.hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return (PortRange) this.hidl_o;
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != MaybePort.class) {
            return false;
        }
        MaybePort other = (MaybePort) otherObject;
    ...
    public static final ArrayList<MaybePort> readVectorFromParcel(HwParcel parcel) {
        ArrayList<MaybePort> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 12, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            MaybePort _hidl_vec_element = new MaybePort();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new PortRange();
                ((PortRange) this.hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, 4 + _hidl_offset);
                return;
            default:
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<MaybePort> _hidl_vec) {
