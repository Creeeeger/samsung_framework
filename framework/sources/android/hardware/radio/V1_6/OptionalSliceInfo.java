...
public final class OptionalSliceInfo {
    ...
    public SliceInfo value() {
        ...
        if (this.hidl_o != null && !SliceInfo.class.isInstance(this.hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new SliceInfo();
                ((SliceInfo) this.hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, 4 + _hidl_offset);
                return;
            default:
