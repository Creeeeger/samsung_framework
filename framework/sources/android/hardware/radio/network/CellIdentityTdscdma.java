...
public class CellIdentityTdscdma implements Parcelable {
    ...
    /* renamed from: android.hardware.radio.network.CellIdentityTdscdma$1 */
    /* loaded from: classes2.dex */
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.cpid);
        _aidl_parcel.writeInt(this.uarfcn);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.cpid = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.uarfcn = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("lac: " + this.lac);
        _aidl_sj.add("cid: " + this.cid);
        _aidl_sj.add("cpid: " + this.cpid);
        _aidl_sj.add("uarfcn: " + this.uarfcn);
