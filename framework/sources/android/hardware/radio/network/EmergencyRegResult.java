...
public class EmergencyRegResult implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.emcDomain);
        _aidl_parcel.writeBoolean(this.isVopsSupported);
        _aidl_parcel.writeBoolean(this.isEmcBearerSupported);
        _aidl_parcel.writeByte(this.nwProvidedEmc);
        _aidl_parcel.writeByte(this.nwProvidedEmf);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.emcDomain = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.isVopsSupported = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.isEmcBearerSupported = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.nwProvidedEmc = _aidl_parcel.readByte();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.nwProvidedEmf = _aidl_parcel.readByte();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("regState: " + RegState$$.toString(this.regState));
        _aidl_sj.add("emcDomain: " + Domain$$.toString(this.emcDomain));
        _aidl_sj.add("isVopsSupported: " + this.isVopsSupported);
        _aidl_sj.add("isEmcBearerSupported: " + this.isEmcBearerSupported);
        _aidl_sj.add("nwProvidedEmc: " + ((int) this.nwProvidedEmc));
