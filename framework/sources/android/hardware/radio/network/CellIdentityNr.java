...
public class CellIdentityNr implements Parcelable {
    ...
    /* renamed from: android.hardware.radio.network.CellIdentityNr$1 */
    /* loaded from: classes2.dex */
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeLong(this.nci);
        _aidl_parcel.writeInt(this.pci);
        _aidl_parcel.writeInt(this.tac);
        _aidl_parcel.writeInt(this.nrarfcn);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.nci = _aidl_parcel.readLong();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.nrarfcn = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("nci: " + this.nci);
        _aidl_sj.add("pci: " + this.pci);
        _aidl_sj.add("tac: " + this.tac);
        _aidl_sj.add("nrarfcn: " + this.nrarfcn);
        ...
        _aidl_sj.add("bands: " + NgranBands$$.arrayToString(this.bands));
