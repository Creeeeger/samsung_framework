...
public class CellIdentityLte implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.ci);
        _aidl_parcel.writeInt(this.pci);
        _aidl_parcel.writeInt(this.tac);
        _aidl_parcel.writeInt(this.earfcn);
        _aidl_parcel.writeTypedObject(this.operatorNames, _aidl_flag);
        _aidl_parcel.writeInt(this.bandwidth);
        _aidl_parcel.writeStringArray(this.additionalPlmns);
        _aidl_parcel.writeTypedObject(this.csgInfo, _aidl_flag);
        _aidl_parcel.writeIntArray(this.bands);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.earfcn = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.additionalPlmns = _aidl_parcel.createStringArray();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                ...
                this.bands = _aidl_parcel.createIntArray();
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public String toString() {
        ...
        _aidl_sj.add("ci: " + this.ci);
        _aidl_sj.add("pci: " + this.pci);
        _aidl_sj.add("tac: " + this.tac);
        _aidl_sj.add("earfcn: " + this.earfcn);
        _aidl_sj.add("operatorNames: " + Objects.toString(this.operatorNames));
        _aidl_sj.add("bandwidth: " + this.bandwidth);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.operatorNames);
        return _mask | describeContents(this.csgInfo);
    }
