...
public class NetworkScanRequest implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.interval);
        _aidl_parcel.writeTypedArray(this.specifiers, _aidl_flag);
        _aidl_parcel.writeInt(this.maxSearchTime);
        _aidl_parcel.writeBoolean(this.incrementalResults);
        _aidl_parcel.writeInt(this.incrementalResultsPeriodicity);
        _aidl_parcel.writeStringArray(this.mccMncs);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.interval = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.maxSearchTime = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.incrementalResults = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.incrementalResultsPeriodicity = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.mccMncs = _aidl_parcel.createStringArray();
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public String toString() {
        ...
        _aidl_sj.add("interval: " + this.interval);
        _aidl_sj.add("specifiers: " + Arrays.toString(this.specifiers));
        _aidl_sj.add("maxSearchTime: " + this.maxSearchTime);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.specifiers);
        return _mask;
    }
