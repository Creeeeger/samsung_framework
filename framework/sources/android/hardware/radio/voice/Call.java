...
public class Call implements Parcelable {
    ...
    /* renamed from: android.hardware.radio.voice.Call$1 */
    /* loaded from: classes2.dex */
    class AnonymousClass1 implements Parcelable.Creator<Call> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.toa);
        _aidl_parcel.writeBoolean(this.isMpty);
        _aidl_parcel.writeBoolean(this.isMT);
        _aidl_parcel.writeByte(this.als);
        _aidl_parcel.writeBoolean(this.isVoice);
        _aidl_parcel.writeBoolean(this.isVoicePrivacy);
        _aidl_parcel.writeString(this.number);
        _aidl_parcel.writeInt(this.numberPresentation);
        _aidl_parcel.writeString(this.name);
        _aidl_parcel.writeInt(this.namePresentation);
        _aidl_parcel.writeTypedArray(this.uusInfo, _aidl_flag);
        _aidl_parcel.writeInt(this.audioQuality);
        _aidl_parcel.writeString(this.forwardedNumber);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.isMpty = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.isMT = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.als = _aidl_parcel.readByte();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.isVoice = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.isVoicePrivacy = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.namePresentation = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.audioQuality = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.forwardedNumber = _aidl_parcel.readString();
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public String toString() {
        ...
        _aidl_sj.add("state: " + this.state);
        _aidl_sj.add("index: " + this.index);
        _aidl_sj.add("toa: " + this.toa);
        _aidl_sj.add("isMpty: " + this.isMpty);
        _aidl_sj.add("isMT: " + this.isMT);
        _aidl_sj.add("als: " + ((int) this.als));
        _aidl_sj.add("isVoice: " + this.isVoice);
        _aidl_sj.add("isVoicePrivacy: " + this.isVoicePrivacy);
        ...
        _aidl_sj.add("audioQuality: " + AudioQuality$$.toString(this.audioQuality));
        _aidl_sj.add("forwardedNumber: " + Objects.toString(this.forwardedNumber));
