...
public interface UssdModeType$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? "NOTIFY" : _aidl_v == 1 ? "REQUEST" : _aidl_v == 2 ? "NW_RELEASE" : _aidl_v == 3 ? "LOCAL_CLIENT" : _aidl_v == 4 ? "NOT_SUPPORTED" : _aidl_v == 5 ? "NW_TIMEOUT" : Integer.toString(_aidl_v);
    }
