...
public class DataProfileInfo implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.profileId);
        _aidl_parcel.writeString(this.apn);
        _aidl_parcel.writeInt(this.protocol);
        _aidl_parcel.writeInt(this.roamingProtocol);
        _aidl_parcel.writeInt(this.authType);
        _aidl_parcel.writeString(this.user);
        _aidl_parcel.writeString(this.password);
        _aidl_parcel.writeInt(this.type);
        _aidl_parcel.writeInt(this.maxConnsTime);
        _aidl_parcel.writeInt(this.maxConns);
        _aidl_parcel.writeInt(this.waitTime);
        _aidl_parcel.writeBoolean(this.enabled);
        _aidl_parcel.writeInt(this.supportedApnTypesBitmap);
        _aidl_parcel.writeInt(this.bearerBitmap);
        _aidl_parcel.writeInt(this.mtuV4);
        _aidl_parcel.writeInt(this.mtuV6);
        _aidl_parcel.writeBoolean(this.preferred);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.profileId = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.roamingProtocol = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.authType = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.user = _aidl_parcel.readString();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.password = _aidl_parcel.readString();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.maxConnsTime = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.maxConns = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.waitTime = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.supportedApnTypesBitmap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.bearerBitmap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.preferred = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.persistent = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.alwaysOn = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("profileId: " + this.profileId);
        _aidl_sj.add("apn: " + Objects.toString(this.apn));
        _aidl_sj.add("protocol: " + PdpProtocolType$$.toString(this.protocol));
        _aidl_sj.add("roamingProtocol: " + PdpProtocolType$$.toString(this.roamingProtocol));
        _aidl_sj.add("authType: " + ApnAuthType$$.toString(this.authType));
        _aidl_sj.add("user: " + Objects.toString(this.user));
        _aidl_sj.add("password: " + Objects.toString(this.password));
        _aidl_sj.add("type: " + this.type);
        _aidl_sj.add("maxConnsTime: " + this.maxConnsTime);
        _aidl_sj.add("maxConns: " + this.maxConns);
        _aidl_sj.add("waitTime: " + this.waitTime);
        _aidl_sj.add("enabled: " + this.enabled);
        _aidl_sj.add("supportedApnTypesBitmap: " + this.supportedApnTypesBitmap);
        _aidl_sj.add("bearerBitmap: " + this.bearerBitmap);
        _aidl_sj.add("mtuV4: " + this.mtuV4);
        _aidl_sj.add("mtuV6: " + this.mtuV6);
        _aidl_sj.add("preferred: " + this.preferred);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.trafficDescriptor);
        return _mask;
    }
