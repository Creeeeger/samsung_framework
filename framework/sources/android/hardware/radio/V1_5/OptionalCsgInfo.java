...
public final class OptionalCsgInfo {
    ...
    public ClosedSubscriberGroupInfo csgInfo() {
        ...
        if (this.hidl_o != null && !ClosedSubscriberGroupInfo.class.isInstance(this.hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new ClosedSubscriberGroupInfo();
                ((ClosedSubscriberGroupInfo) this.hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, 8 + _hidl_offset);
                return;
            default:
