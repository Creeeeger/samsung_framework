...
public final class PhysicalSensor {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.sensorType == other.sensorType && HidlSupport.deepEquals(this.type, other.type) && HidlSupport.deepEquals(this.name, other.name) && HidlSupport.deepEquals(this.f3vendor, other.f3vendor) && this.version == other.version && this.fifoReservedCount == other.fifoReservedCount && this.fifoMaxCount == other.fifoMaxCount && this.minDelayMs == other.minDelayMs && this.maxDelayMs == other.maxDelayMs && this.peakPowerMw == other.peakPowerMw) {
            return true;
        }
        return false;
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(40 + _hidl_offset, this.f3vendor);
