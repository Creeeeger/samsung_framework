...
public interface ISensorPrivacyManager extends IInterface {
    ...
    void setToggleSensorPrivacyForProfileGroupWithConfirmPopup(int i, int i2, int i3, boolean z) throws RemoteException;
    ...
    public static class Default implements ISensorPrivacyManager {
        ...
        @Override // android.hardware.ISensorPrivacyManager
        public void setToggleSensorPrivacyForProfileGroupWithConfirmPopup(int userId, int source, int sensor, boolean enable) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ISensorPrivacyManager {
        ...
        static final int TRANSACTION_requiresAuthentication = 14;
        ...
        static final int TRANSACTION_showSensorUseDialog = 15;
        static final int TRANSACTION_supportsSensorToggle = 1;
        static final int TRANSACTION_suppressToggleSensorPrivacyReminders = 13;
                ...
                default:
                    switch (code) {
                        ...
                        case 12:
                            ...
                            data.enforceNoDataAvail();
                            setToggleSensorPrivacyForProfileGroupWithConfirmPopup(_arg011, _arg15, _arg23, _arg33);
                            reply.writeNoException();
                            return true;
                        case 13:
                            ...
                            data.enforceNoDataAvail();
                            suppressToggleSensorPrivacyReminders(_arg012, _arg16, _arg24, _arg34);
                            reply.writeNoException();
                            return true;
                        case 14:
