...
public final class FrontendGuardInterval implements Parcelable {
    ...
    private FrontendGuardInterval(Parcel _aidl_parcel) {
    ...
    public static FrontendGuardInterval dvbt(int _value) {
        return new FrontendGuardInterval(0, Integer.valueOf(_value));
    }
    ...
    public static FrontendGuardInterval isdbt(int _value) {
        return new FrontendGuardInterval(1, Integer.valueOf(_value));
    }
    ...
    public static FrontendGuardInterval dtmb(int _value) {
        return new FrontendGuardInterval(2, Integer.valueOf(_value));
    }
