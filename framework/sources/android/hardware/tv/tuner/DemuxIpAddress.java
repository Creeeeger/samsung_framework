...
public class DemuxIpAddress implements Parcelable {
    ...
    /* renamed from: android.hardware.tv.tuner.DemuxIpAddress$1 */
    /* loaded from: classes2.dex */
    class AnonymousClass1 implements Parcelable.Creator<DemuxIpAddress> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.srcIpAddress, _aidl_flag);
        _aidl_parcel.writeTypedObject(this.dstIpAddress, _aidl_flag);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.srcIpAddress);
        return _mask | describeContents(this.dstIpAddress);
    }
