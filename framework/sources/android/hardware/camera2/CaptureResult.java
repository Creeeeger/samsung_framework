...
public class CaptureResult extends CameraMetadata<Key<?>> {
    ...
    @PublicKey
    public static final Key<Rect> SCALER_RAW_CROP_REGION = new Key<>("android.scaler.rawCropRegion", Rect.class);
    ...
    @PublicKey
    public static final Key<Integer> EXTENSION_CURRENT_TYPE = new Key<>("android.extension.currentType", Integer.TYPE);
