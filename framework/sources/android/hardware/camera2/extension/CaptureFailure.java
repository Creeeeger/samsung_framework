...
public class CaptureFailure implements Parcelable {
    ...
    /* renamed from: android.hardware.camera2.extension.CaptureFailure$1 */
    /* loaded from: classes.dex */
    class AnonymousClass1 implements Parcelable.Creator<CaptureFailure> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.request, _aidl_flag);
        _aidl_parcel.writeInt(this.reason);
        _aidl_parcel.writeBoolean(this.dropped);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.request = (CaptureRequest) _aidl_parcel.readTypedObject(CaptureRequest.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.dropped = _aidl_parcel.readBoolean();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
