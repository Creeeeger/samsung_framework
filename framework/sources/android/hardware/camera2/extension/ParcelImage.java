...
public class ParcelImage implements Parcelable {
    ...
    /* renamed from: android.hardware.camera2.extension.ParcelImage$1 */
    /* loaded from: classes.dex */
    class AnonymousClass1 implements Parcelable.Creator<ParcelImage> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.crop, _aidl_flag);
        _aidl_parcel.writeTypedObject(this.buffer, _aidl_flag);
        _aidl_parcel.writeTypedObject(this.fence, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.crop = (Rect) _aidl_parcel.readTypedObject(Rect.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.buffer = (HardwareBuffer) _aidl_parcel.readTypedObject(HardwareBuffer.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
