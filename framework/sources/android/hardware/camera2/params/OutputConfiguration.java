...
public final class OutputConfiguration implements Parcelable {
    ...
    public static final int SEM_STREAM_OPTION_PICTURE = 2;

    @Deprecated(forRemoval = true, since = "15.5")
    public static final int SEM_STREAM_OPTION_PREVIEW = 1;

    @Deprecated(forRemoval = true, since = "15.5")
    public static final int SEM_STREAM_OPTION_THUMBNAIL = 4;
    ...
    public int hashCode() {
        if (this.mIsDeferredConfig) {
            ...
            fArr[7] = this.mPhysicalCameraId == null ? 0.0f : r10.hashCode();
        ...
        fArr2[8] = this.mPhysicalCameraId == null ? 0.0f : r10.hashCode();
