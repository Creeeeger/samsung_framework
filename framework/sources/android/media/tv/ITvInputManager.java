...
public interface ITvInputManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITvInputManager {
        ...
        static final int TRANSACTION_acquireTvInputHardware = 53;
        static final int TRANSACTION_addBlockedRating = 14;
        static final int TRANSACTION_addHardwareDevice = 62;
        static final int TRANSACTION_captureFrame = 56;
        ...
        static final int TRANSACTION_getAvailableTvStreamConfigList = 55;
        ...
        static final int TRANSACTION_getDvbDeviceList = 58;
        static final int TRANSACTION_getExtensionInterface = 6;
        static final int TRANSACTION_getHardwareList = 52;
        ...
        static final int TRANSACTION_isSingleSessionActive = 57;
        static final int TRANSACTION_notifyAdBufferReady = 49;
        static final int TRANSACTION_notifyTvMessage = 50;
        static final int TRANSACTION_openDvbDevice = 59;
        ...
        static final int TRANSACTION_releaseTvInputHardware = 54;
        static final int TRANSACTION_removeBlockedRating = 15;
        static final int TRANSACTION_removeBroadcastInfo = 47;
        static final int TRANSACTION_removeHardwareDevice = 63;
        ...
        static final int TRANSACTION_requestChannelBrowsable = 61;
        ...
        static final int TRANSACTION_sendTvInputNotifyIntent = 60;
        ...
        static final int TRANSACTION_setTvMessageEnabled = 51;
                ...
                default:
                    switch (code) {
                        ...
                        case 49:
                            ...
                            data.enforceNoDataAvail();
                            notifyAdBufferReady(_arg050, _arg143, _arg226);
                            reply.writeNoException();
                            return true;
                        case 50:
                        ...
                        case 51:
                            ...
                            data.enforceNoDataAvail();
                            setTvMessageEnabled(_arg052, _arg145, _arg228, _arg310);
                            reply.writeNoException();
                            return true;
                        case 52:
                        ...
                        case 53:
                            ...
                            ITvInputHardwareCallback _arg146 = ITvInputHardwareCallback.Stub.asInterface(data.readStrongBinder());
                            TvInputInfo _arg229 = (TvInputInfo) data.readTypedObject(TvInputInfo.CREATOR);
                            int _arg311 = data.readInt();
                            String _arg43 = data.readString();
                            int _arg52 = data.readInt();
                            data.enforceNoDataAvail();
                            ITvInputHardware _result14 = acquireTvInputHardware(_arg053, _arg146, _arg229, _arg311, _arg43, _arg52);
                            reply.writeNoException();
                            reply.writeStrongInterface(_result14);
                            return true;
                        case 54:
                            int _arg054 = data.readInt();
                            ITvInputHardware _arg147 = ITvInputHardware.Stub.asInterface(data.readStrongBinder());
                            int _arg230 = data.readInt();
                            data.enforceNoDataAvail();
                            releaseTvInputHardware(_arg054, _arg147, _arg230);
                            reply.writeNoException();
                            return true;
                        case 55:
                            ...
                            data.enforceNoDataAvail();
                            List<TvStreamConfig> _result15 = getAvailableTvStreamConfigList(_arg055, _arg148);
                            reply.writeNoException();
                            reply.writeTypedList(_result15, 1);
                            return true;
                        case 56:
                            String _arg056 = data.readString();
                            Surface _arg149 = (Surface) data.readTypedObject(Surface.CREATOR);
                            TvStreamConfig _arg231 = (TvStreamConfig) data.readTypedObject(TvStreamConfig.CREATOR);
                            int _arg312 = data.readInt();
                            data.enforceNoDataAvail();
                            boolean _result16 = captureFrame(_arg056, _arg149, _arg231, _arg312);
                            reply.writeNoException();
                        ...
                        case 57:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result17 = isSingleSessionActive(_arg057);
                            reply.writeNoException();
                        ...
                        case 58:
                            ...
                            return true;
                        case 59:
                            DvbDeviceInfo _arg058 = (DvbDeviceInfo) data.readTypedObject(DvbDeviceInfo.CREATOR);
                            int _arg150 = data.readInt();
                            data.enforceNoDataAvail();
                            ParcelFileDescriptor _result19 = openDvbDevice(_arg058, _arg150);
                            reply.writeNoException();
                            reply.writeTypedObject(_result19, 1);
                            return true;
                        case 60:
                            Intent _arg059 = (Intent) data.readTypedObject(Intent.CREATOR);
                            int _arg151 = data.readInt();
                            data.enforceNoDataAvail();
                            sendTvInputNotifyIntent(_arg059, _arg151);
                            reply.writeNoException();
                            return true;
                        case 61:
                            Uri _arg060 = (Uri) data.readTypedObject(Uri.CREATOR);
                            int _arg152 = data.readInt();
                            data.enforceNoDataAvail();
                            requestChannelBrowsable(_arg060, _arg152);
                            reply.writeNoException();
                            return true;
                        case 62:
                            int _arg061 = data.readInt();
                            data.enforceNoDataAvail();
                            addHardwareDevice(_arg061);
                            reply.writeNoException();
                            return true;
                        case 63:
                            int _arg062 = data.readInt();
                            data.enforceNoDataAvail();
                            removeHardwareDevice(_arg062);
                            reply.writeNoException();
                            return true;
                        default:
