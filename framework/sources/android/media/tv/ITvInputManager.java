        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 46:
                    ...
                    data.enforceNoDataAvail();
                    resumePlayback(_arg047, _arg140);
                    reply.writeNoException();
                    return true;
                case 47:
                    ...
                    data.enforceNoDataAvail();
                    stopPlayback(_arg048, _arg141, _arg223);
                    reply.writeNoException();
                    return true;
                case 48:
                ...
                case 49:
                    ...
                    data.enforceNoDataAvail();
                    removeBroadcastInfo(_arg050, _arg143, _arg225);
                    reply.writeNoException();
                    return true;
                case 50:
                    IBinder _arg051 = data.readStrongBinder();
                    AdRequest _arg144 = (AdRequest) data.readTypedObject(AdRequest.CREATOR);
                    int _arg226 = data.readInt();
                    data.enforceNoDataAvail();
                    requestAd(_arg051, _arg144, _arg226);
                    reply.writeNoException();
                    return true;
                case 51:
                    IBinder _arg052 = data.readStrongBinder();
                    AdBuffer _arg145 = (AdBuffer) data.readTypedObject(AdBuffer.CREATOR);
                    int _arg227 = data.readInt();
                    data.enforceNoDataAvail();
                    notifyAdBufferReady(_arg052, _arg145, _arg227);
                    reply.writeNoException();
                    return true;
                case 52:
                    ...
                    data.enforceNoDataAvail();
                    notifyTvMessage(_arg053, _arg146, _arg228, _arg39);
                    reply.writeNoException();
                    return true;
                case 53:
                    ...
                    data.enforceNoDataAvail();
                    setTvMessageEnabled(_arg054, _arg147, _arg229, _arg310);
                    reply.writeNoException();
                    return true;
                case 54:
                ...
                case 59:
                    ...
                    data.enforceNoDataAvail();
                    boolean _result17 = isSingleSessionActive(_arg059);
                    reply.writeNoException();
                ...
                case 62:
                    ...
                    data.enforceNoDataAvail();
                    sendTvInputNotifyIntent(_arg061, _arg153);
                    reply.writeNoException();
                    return true;
                case 63:
                    Uri _arg062 = (Uri) data.readTypedObject(Uri.CREATOR);
                    int _arg154 = data.readInt();
                    data.enforceNoDataAvail();
                    requestChannelBrowsable(_arg062, _arg154);
                    reply.writeNoException();
                    return true;
                case 64:
                    int _arg063 = data.readInt();
                    data.enforceNoDataAvail();
                    addHardwareDevice(_arg063);
                    reply.writeNoException();
                    return true;
                case 65:
                    int _arg064 = data.readInt();
                    data.enforceNoDataAvail();
                    removeHardwareDevice(_arg064);
                    reply.writeNoException();
                    return true;
                case 66:
                    ...
                    data.enforceNoDataAvail();
                    setVideoFrozen(_arg065, _arg155, _arg233);
                    reply.writeNoException();
                    return true;
                case 67:
                    IBinder _arg066 = data.readStrongBinder();
                    String _arg156 = data.readString();
                    Bundle _arg234 = (Bundle) data.readTypedObject(Bundle.CREATOR);
                    int _arg313 = data.readInt();
                    data.enforceNoDataAvail();
                    notifyTvAdSessionData(_arg066, _arg156, _arg234, _arg313);
                    reply.writeNoException();
                    return true;
                default:
