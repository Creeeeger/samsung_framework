...
public interface ITvInputSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITvInputSession {
        ...
        static final int TRANSACTION_notifyAdBufferReady = 30;
        ...
        static final int TRANSACTION_setTvMessageEnabled = 32;
                ...
                default:
                    switch (code) {
                        ...
                        case 32:
                            ...
                            data.enforceNoDataAvail();
                            setTvMessageEnabled(_arg027, _arg19);
                            return true;
                        default:
