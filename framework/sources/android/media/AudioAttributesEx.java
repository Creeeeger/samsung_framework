...
public class AudioAttributesEx implements Parcelable {
    ...
    public AudioAttributesInternal attributes;
    public int groupId = 0;
    public int streamType;

    /* renamed from: android.media.AudioAttributesEx$1 */
    /* loaded from: classes2.dex */
    class AnonymousClass1 implements Parcelable.Creator<AudioAttributesEx> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.attributes, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.attributes = (AudioAttributesInternal) _aidl_parcel.readTypedObject(AudioAttributesInternal.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
