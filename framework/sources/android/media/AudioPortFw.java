...
public class AudioPortFw implements Parcelable {
    ...
    /* renamed from: android.media.AudioPortFw$1 */
    /* loaded from: classes2.dex */
    class AnonymousClass1 implements Parcelable.Creator<AudioPortFw> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.hal, _aidl_flag);
        _aidl_parcel.writeTypedObject(this.sys, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                ...
                this.sys = (AudioPortSys) _aidl_parcel.readTypedObject(AudioPortSys.CREATOR);
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.hal);
        return _mask | describeContents(this.sys);
    }
