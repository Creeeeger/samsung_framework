...
public class ToneGenerator {
    ...
    private native void native_setup(int i, int i2, String str);

    public final native int getAudioSessionId();

    public native void release();

    public native void semSetSituationType(String str);

    public native void semSetVolume(float f);
    ...
    public void setVolume(float toneVolume) {
        semSetVolume(toneVolume);
    }
}
