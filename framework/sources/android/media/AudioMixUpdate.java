...
public class AudioMixUpdate implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.audioMix, _aidl_flag);
        _aidl_parcel.writeTypedArray(this.newCriteria, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.audioMix = (AudioMix) _aidl_parcel.readTypedObject(AudioMix.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.newCriteria = (AudioMixMatchCriterion[]) _aidl_parcel.createTypedArray(AudioMixMatchCriterion.CREATOR);
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.audioMix);
        return _mask | describeContents(this.newCriteria);
    }
