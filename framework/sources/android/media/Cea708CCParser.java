    ...
    private int parseC1(byte[] data, int pos) {
        switch (this.mCommand) {
            ...
            case 145:
                ...
                int red = (data[pos] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
                ...
                int red2 = (data[pos9] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
                int green2 = (data[pos9] & 12) >> 2;
                int blue2 = data[pos9] & 3;
                CaptionColor backgroundColor = new CaptionColor(opacity3, red2, green2, blue2);
                int pos10 = pos9 + 1;
                int red3 = (data[pos10] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
            ...
            case 151:
                ...
                int red4 = (data[pos] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
                ...
                int red5 = (data[pos + 1] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
                ...
                int printDirection = (data[pos + 2] & SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90) >> 4;
