                ...
                default:
                    switch (code) {
                        ...
                        case 48:
                            ...
                            return true;
                        case 49:
                            AudioPortConfigFw _arg048 = (AudioPortConfigFw) data.readTypedObject(AudioPortConfigFw.CREATOR);
                            data.enforceNoDataAvail();
                            setAudioPortConfig(_arg048);
                            reply.writeNoException();
                            return true;
                        case 50:
                            IAudioPolicyServiceClient _arg049 = IAudioPolicyServiceClient.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                        ...
                        case 60:
                            ...
                            return true;
                        case 61:
                            AudioPortConfigFw _arg058 = (AudioPortConfigFw) data.readTypedObject(AudioPortConfigFw.CREATOR);
                        ...
                        case 67:
                            ...
                            return true;
                        case 68:
                            AudioDeviceDescription _arg064 = (AudioDeviceDescription) data.readTypedObject(AudioDeviceDescription.CREATOR);
                            data.enforceNoDataAvail();
                            AudioFormatDescription[] _result31 = getHwOffloadFormatsSupportedForBluetoothMedia(_arg064);
                            reply.writeNoException();
                            reply.writeTypedArray(_result31, 1);
                            return true;
                        case 69:
                            AudioFormatDescription _arg065 = (AudioFormatDescription) data.readTypedObject(AudioFormatDescription.CREATOR);
                        ...
                        case 79:
                            ...
                            return true;
                        case 80:
                            AudioAttributesInternal _arg072 = (AudioAttributesInternal) data.readTypedObject(AudioAttributesInternal.CREATOR);
                        ...
                        case 91:
                            ...
                            return true;
                        case 92:
                            ICaptureStateListener _arg083 = ICaptureStateListener.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            ...
                            return true;
                        case 93:
                            INativeSpatializerCallback _arg084 = INativeSpatializerCallback.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                        ...
                        case 95:
                            ...
                            return true;
                        case 96:
                            AudioAttributesInternal _arg087 = (AudioAttributesInternal) data.readTypedObject(AudioAttributesInternal.CREATOR);
                            data.enforceNoDataAvail();
                            android.media.audio.common.AudioProfile[] _result46 = getDirectProfilesForAttributes(_arg087);
                            reply.writeNoException();
                        ...
                        case 99:
                            ...
                            data.enforceNoDataAvail();
                            AudioMixerAttributesInternal _result48 = getPreferredMixerAttributes(_arg090, _arg148);
                            reply.writeNoException();
                            reply.writeTypedObject(_result48, 1);
                            return true;
                        case 100:
                            AudioAttributesInternal _arg091 = (AudioAttributesInternal) data.readTypedObject(AudioAttributesInternal.CREATOR);
