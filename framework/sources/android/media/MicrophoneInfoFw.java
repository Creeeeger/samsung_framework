...
public class MicrophoneInfoFw implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.info, _aidl_flag);
        _aidl_parcel.writeTypedObject(this.dynamic, _aidl_flag);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.info);
        return _mask | describeContents(this.dynamic);
    }
