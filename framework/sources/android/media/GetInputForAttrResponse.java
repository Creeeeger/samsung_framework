...
public class GetInputForAttrResponse implements Parcelable {
    ...
    /* renamed from: android.media.GetInputForAttrResponse$1 */
    /* loaded from: classes2.dex */
    class AnonymousClass1 implements Parcelable.Creator<GetInputForAttrResponse> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.input);
        _aidl_parcel.writeInt(this.selectedDeviceId);
        _aidl_parcel.writeInt(this.portId);
        _aidl_parcel.writeTypedObject(this.config, _aidl_flag);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.input = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.config);
        return _mask;
    }
