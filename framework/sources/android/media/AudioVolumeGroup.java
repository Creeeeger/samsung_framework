...
public class AudioVolumeGroup implements Parcelable {
    ...
    public AudioAttributesInternal[] audioAttributes;
    public int groupId = 0;
    public String name;
    public int[] streams;

    /* renamed from: android.media.AudioVolumeGroup$1 */
    /* loaded from: classes2.dex */
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedArray(this.audioAttributes, _aidl_flag);
        _aidl_parcel.writeIntArray(this.streams);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.audioAttributes = (AudioAttributesInternal[]) _aidl_parcel.createTypedArray(AudioAttributesInternal.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.streams = _aidl_parcel.createIntArray();
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.audioAttributes);
        return _mask;
    }
