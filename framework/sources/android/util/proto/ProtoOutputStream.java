...
public final class ProtoOutputStream extends ProtoStream {
    ...
    public void write(long fieldId, double val) {
        ...
        switch ((int) ((17587891077120L & fieldId) >> 32)) {
            ...
            case 263:
                ...
                return;
            case 264:
                writeBoolImpl(id, val != SContextConstants.ENVIRONMENT_VALUE_UNKNOWN);
                return;
            case 269:
            ...
            case MetricsProto.MetricsEvent.ROTATION_SUGGESTION_SHOWN /* 1288 */:
                writeRepeatedBoolImpl(id, val != SContextConstants.ENVIRONMENT_VALUE_UNKNOWN);
                return;
            case 525:
            case 1293:
    ...
    private void writeDoubleImpl(int id, double val) {
        if (val != SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
            writeTag(id, 1);
