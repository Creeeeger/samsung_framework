...
class GLLogWrapper extends GLWrapperBase {
    ...
    private String toString(int n, float[] arr, int offset) {
        ...
        for (int i = 0; i < n; i++) {
            int index = offset + i;
            buf.append(NavigationBarInflaterView.SIZE_MOD_START + index + "] = ");
            if (index < 0 || index >= arrLen) {
                buf.append("out of bounds");
            } else {
    ...
    private void argPointer(int size, int type, int stride, Buffer pointer) {
        arg(Contract.DatabaseSize.PATH, size);
    ...
    */
    private char[] toCharIndices(int r7, int r8, java.nio.Buffer r9) {
        /*
            r6 = this;
            char[] r0 = new char[r7]
            switch(r8) {
        ...
        Le:
            int r1 = r7 * 2
            java.nio.ByteBuffer r1 = r6.toByteBuffer(r1, r9)
            java.nio.CharBuffer r2 = r1.asCharBuffer()
            r1 = r2
        L19:
            int r2 = r1.position()
            r3 = 0
            ...
            goto L44
        L28:
            java.nio.ByteBuffer r1 = r6.toByteBuffer(r7, r9)
            byte[] r2 = r1.array()
    ...
    public void glDepthMask(boolean flag) {
        begin("glDepthMask");
        arg(SemEmergencyConstants.EXTRA_EMERGENCY_START_SERVICE_FLAG, flag);
        end();
    ...
    public void glDrawArrays(int mode, int first, int count) {
        ...
        arg("mode", mode);
        arg("first", first);
        arg(Contract.Events.Projection.COUNT_ONLY, count);
        startLogIndices();
    ...
    public void glFrustumf(float left, float right, float bottom, float top, float near, float far) {
        ...
        arg("left", left);
        arg("right", right);
        arg(GenerateXML.BOTTOM, bottom);
        arg(GenerateXML.TOP, top);
        arg("near", near);
        arg("far", far);
        end();
