...
public class RequestNamespaceParcel implements Parcelable {
    ...
    /* renamed from: android.security.identity.RequestNamespaceParcel$1 */
    /* loaded from: classes3.dex */
    class AnonymousClass1 implements Parcelable.Creator<RequestNamespaceParcel> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedArray(this.entries, _aidl_flag);
