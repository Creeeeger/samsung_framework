...
public class KeystoreAtom implements Parcelable {
    ...
    /* renamed from: android.security.metrics.KeystoreAtom$1 */
    /* loaded from: classes3.dex */
    class AnonymousClass1 implements Parcelable.Creator<KeystoreAtom> {
        AnonymousClass1() {
        }
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.payload, _aidl_flag);
