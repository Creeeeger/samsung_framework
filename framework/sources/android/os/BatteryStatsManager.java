...
public final class BatteryStatsManager {
    ...
    public void reportBleDutyScanStarted(WorkSource ws, boolean isUnoptimized, int dutyCycle) {
        try {
            this.mBatteryStats.noteBleDutyScanStarted(ws, isUnoptimized, dutyCycle);
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }

    public void reportBleDutyScanStopped(WorkSource ws, boolean isUnoptimized, int dutyCycle) {
        try {
            this.mBatteryStats.noteBleDutyScanStopped(ws, isUnoptimized, dutyCycle);
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
