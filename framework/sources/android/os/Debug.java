...
public final class Debug {
    ...
    public static synchronized void saveResetReason(String reason, String extra_info) {
    ...
    public static synchronized void saveDump(BugreportParams params, String packageName) {
        String str;
        synchronized (Debug.class) {
            String dump_running = SystemProperties.get("dumpstate.is_running", "0");
            ...
            SystemProperties.set("bugreport.mode", nxt_brmode);
            if (packageName != null) {
                str = packageName.substring(0, Math.min(packageName.length(), 91));
            } else {
                str = null;
            }
