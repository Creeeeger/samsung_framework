...
public final class OsProtoEnums {
    ...
    public static final int TEMPERATURE_TYPE_AMBIENT = 18;
    ...
    public static final int TEMPERATURE_TYPE_CAMERA = 15;
    public static final int TEMPERATURE_TYPE_CPU = 0;
    public static final int TEMPERATURE_TYPE_DISPLAY = 11;
    public static final int TEMPERATURE_TYPE_FLASHLIGHT = 16;
    public static final int TEMPERATURE_TYPE_GPU = 1;
    public static final int TEMPERATURE_TYPE_MODEM = 12;
    public static final int TEMPERATURE_TYPE_NPU = 9;
    public static final int TEMPERATURE_TYPE_POGO = 19;
    public static final int TEMPERATURE_TYPE_POWER_AMPLIFIER = 5;
    public static final int TEMPERATURE_TYPE_SKIN = 3;
    public static final int TEMPERATURE_TYPE_SOC = 13;
    public static final int TEMPERATURE_TYPE_SPEAKER = 17;
    public static final int TEMPERATURE_TYPE_TPU = 10;
    public static final int TEMPERATURE_TYPE_UNKNOWN = -1;
    public static final int TEMPERATURE_TYPE_USB_PORT = 4;
    public static final int TEMPERATURE_TYPE_WIFI = 14;
