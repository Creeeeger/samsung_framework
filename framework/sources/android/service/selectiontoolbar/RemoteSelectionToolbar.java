...
public final class RemoteSelectionToolbar {
    ...
    public RemoteSelectionToolbar(Context context, long selectionToolbarToken, ShowInfo showInfo, SelectionToolbarRenderService.RemoteCallbackWrapper callbackWrapper, SelectionToolbarRenderService.TransferTouchListener transferTouchListener) {
        ...
        this.mMarginHorizontal = applyDefaultTheme.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_horizontal_margin);
        this.mMarginVertical = applyDefaultTheme.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_vertical_margin);
        this.mLineHeight = applyDefaultTheme.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_height);
        int dimensionPixelSize = applyDefaultTheme.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_icon_text_spacing);
    ...
    private int getAdjustedToolbarWidth(int suggestedWidth) {
        ...
        int maximumWidth = this.mViewPortOnScreen.width() - (this.mContext.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_horizontal_margin) * 2);
        if (width <= 0) {
            width = this.mContext.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_preferred_width);
        }
        ...
        public void onAnimationEnd(Animation animation) {
            RemoteSelectionToolbar.this.mContentContainer.post(new Runnable() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar$12$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RemoteSelectionToolbar.AnonymousClass12.this.lambda$onAnimationEnd$0();
                }
            });
        }
