...
public class ZenModeConfig implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        return other.allowAlarms == this.allowAlarms && other.allowMedia == this.allowMedia && other.allowSystem == this.allowSystem && other.allowCalls == this.allowCalls && other.allowRepeatCallers == this.allowRepeatCallers && other.allowMessages == this.allowMessages && other.allowCallsFrom == this.allowCallsFrom && other.allowMessagesFrom == this.allowMessagesFrom && other.allowReminders == this.allowReminders && other.allowEvents == this.allowEvents && other.user == this.user && Objects.equals(other.automaticRules, this.automaticRules) && Objects.equals(other.manualRule, this.manualRule) && other.suppressedVisualEffects == this.suppressedVisualEffects && other.areChannelsBypassingDnd == this.areChannelsBypassingDnd && other.allowConversations == this.allowConversations && other.allowConversationsFrom == this.allowConversationsFrom && (list = other.allowExceptionContacts) != null && list.equals(this.allowExceptionContacts) && (list2 = other.allowAppBypassDndList) != null && list2.equals(this.allowAppBypassDndList);
    }

    public int hashCode() {
        List<String> list = this.allowExceptionContacts;
        String exceptionContactsString = (list == null || list.isEmpty()) ? new String() : joinStrings(",", this.allowExceptionContacts);
        List<String> list2 = this.allowAppBypassDndList;
        String appBypassDndListString = (list2 == null || list2.isEmpty()) ? new String() : joinStrings(",", this.allowAppBypassDndList);
    ...
    public ZenPolicy toZenPolicy() {
        ...
        int i3 = this.suppressedVisualEffects;
        if (i3 == 0) {
            builder2.showAllVisualEffects();
        } else {
            builder2.showFullScreenIntent((i3 & 4) == 0);
    ...
    public NotificationManager.Policy toNotificationPolicy(ZenPolicy zenPolicy) {
        ...
        return new NotificationManager.Policy(priorityCategories, callSenders, messageSenders, suppressedVisualEffects, defaultPolicy.state, conversationSenders, consolidatedContacts, appBypassDndList);
    }
    ...
    public NotificationManager.Policy toNotificationPolicy() {
        ...
        return new NotificationManager.Policy(priorityCategories, priorityCallSenders, priorityMessageSenders, this.suppressedVisualEffects, this.areChannelsBypassingDnd ? 1 : 0, priorityConversationSenders, this.allowExceptionContacts, this.allowAppBypassDndList);
    }
    ...
    */
    ...
    public static class ZenRule implements Parcelable {
        ...
        public String toString() {
            StringBuilder append = new StringBuilder(ZenRule.class.getSimpleName()).append('[').append("id=").append(this.id).append(",state=");
    ...
    public static boolean areAllPriorityOnlyRingerSoundsMuted(NotificationManager.Policy policy) {
        ...
        boolean isExceptionContactsAllowed = (policy.getExceptionContacts() == null || policy.getExceptionContacts().isEmpty()) ? false : true;
        return (allowReminders || allowCalls || allowMessages || allowEvents || allowRepeatCallers || areChannelsBypassingDnd || allowSystem || allowConversations || isExceptionContactsAllowed) ? false : true;
    }
    ...
    public static boolean areAllPriorityOnlyRingerSoundsMuted(ZenModeConfig config) {
        List<String> list;
        return (config.allowReminders || config.allowCalls || config.allowMessages || config.allowEvents || config.allowRepeatCallers || config.areChannelsBypassingDnd || config.allowSystem || (list = config.allowExceptionContacts) == null || !list.isEmpty()) ? false : true;
    }
