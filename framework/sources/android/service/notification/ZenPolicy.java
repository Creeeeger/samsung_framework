...
public final class ZenPolicy implements Parcelable {
    ...
    private boolean mIsContactsOverridden = false;
    private boolean mIsAppBypassDndOverridden = false;
    ...
    private ArrayList<String> mAppsToBypassDnd = new ArrayList<>();
    private ArrayList<String> mExceptionContacts = new ArrayList<>();
    ...
    public void apply(ZenPolicy policyToApply) {
        ...
        Iterator<String> it = policyToApply.getAppsToBypassDnd().iterator();
        while (it.hasNext()) {
            String appName = it.next();
            this.mAppsToBypassDnd.add(appName);
        }
        Iterator<String> it2 = policyToApply.getExceptionContacts().iterator();
        while (it2.hasNext()) {
            String contactInfo = it2.next();
