...
public interface IClientCallback extends IBase {
    ...
    static IClientCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IClientCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IClientCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IClientCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Deprecated
    static IClientCallback getService(String serviceName) throws RemoteException {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    IBase registered = IBase.asInterface(_hidl_request.readStrongBinder());
                    boolean hasClients = _hidl_request.readBool();
