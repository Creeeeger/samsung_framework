package android.internal.hidl.manager.V1_1;
...
public interface IServiceManager extends android.internal.hidl.manager.V1_0.IServiceManager {
    ...
    public static abstract class Stub extends HwBinder implements IServiceManager {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IServiceManager.kInterfaceName, android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{11, -108, -36, -121, 111, 116, -98, -46, 74, -104, -10, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEIN, 65, -44, 106, -41, 90, SprAnimatorBase.INTERPOLATOR_TYPE_SINEEASEINOUT, 81, 17, 99, MidiConstants.STATUS_MIDI_TIME_CODE, -106, -118, 8, 66, 19, -93, 60, 104, 78, -10}, new byte[]{-123, 57, 79, -118, 13, 21, -25, -5, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT70, -28, 92, 82, -47, -5, -117, -113, -45, -63, 60, 51, 62, 99, -57, -116, 74, -95, -1, -122, -124, 12, -10, -36}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -72, 59, 24, -54, 76}));
        }
