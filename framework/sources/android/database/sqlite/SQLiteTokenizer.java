    ...
    public static boolean isKeyword(String token) {
        ...
        switch (upperCase.hashCode()) {
            ...
            case 64641:
                ...
                break;
            case 64897:
                if (upperCase.equals(SemInputDeviceManager.MOTION_CONTROL_TYPE_ALL)) {
                    c = 4;
                    break;
                }
                c = 65535;
    ...
    public static boolean isFunction(String token) {
        ...
        switch (lowerCase.hashCode()) {
            case -1191314396:
                ...
                break;
            case -1106363674:
                if (lowerCase.equals(Contract.CompressedEvents.Field.LENGTH)) {
                    c = '\n';
                    break;
                }
                c = 65535;
            ...
            case 3568674:
                ...
                break;
            case 94851343:
                if (lowerCase.equals(Contract.Events.Projection.COUNT_ONLY)) {
                    c = 4;
                    break;
                }
                c = 65535;
