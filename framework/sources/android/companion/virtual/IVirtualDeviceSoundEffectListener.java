...
public interface IVirtualDeviceSoundEffectListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVirtualDeviceSoundEffectListener {
        ...
        public static IVirtualDeviceSoundEffectListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(IVirtualDeviceSoundEffectListener.DESCRIPTOR);
            if (iin != null && (iin instanceof IVirtualDeviceSoundEffectListener)) {
                return (IVirtualDeviceSoundEffectListener) iin;
            }
        ...
        private static class Proxy implements IVirtualDeviceSoundEffectListener {
            ...
            public void onPlaySoundEffect(int effectType) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IVirtualDeviceSoundEffectListener.DESCRIPTOR);
