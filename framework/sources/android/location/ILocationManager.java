...
public interface ILocationManager extends IInterface {
    ...
    void notifyNSFLP(Message message) throws RemoteException;

    void onFreezeStateChanged(boolean z, int i) throws RemoteException;
    ...
    public static class Default implements ILocationManager {
        ...
        @Override // android.location.ILocationManager
        public void notifyNSFLP(Message msg) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ILocationManager {
        ...
        static final String[] PERMISSIONS_injectLocation = {Manifest.permission.LOCATION_HARDWARE, Manifest.permission.ACCESS_FINE_LOCATION};
        ...
        static final int TRANSACTION_getGPSUsingApps = 64;
        ...
        static final int TRANSACTION_notifyNSFLP = 63;
        static final int TRANSACTION_onFreezeStateChanged = 65;
                ...
                default:
                    switch (code) {
                        ...
                        case 62:
                            ...
                            return true;
                        case 63:
                            Message _arg047 = (Message) data.readTypedObject(Message.CREATOR);
                            data.enforceNoDataAvail();
                            notifyNSFLP(_arg047);
                            reply.writeNoException();
                            return true;
                        case 64:
                            Map _result26 = getGPSUsingApps();
                            reply.writeNoException();
                        ...
                        case 65:
                            ...
                            data.enforceNoDataAvail();
                            onFreezeStateChanged(_arg048, _arg127);
                            reply.writeNoException();
                            return true;
                        default:
        ...
        protected void injectLocation_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermissionAllOf(PERMISSIONS_injectLocation, getCallingPid(), getCallingUid());
        }
        ...
        protected void isAutomotiveGnssSuspended_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission(Manifest.permission.CONTROL_AUTOMOTIVE_GNSS, getCallingPid(), getCallingUid());
        }
