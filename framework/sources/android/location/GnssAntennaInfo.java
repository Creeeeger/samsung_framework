...
public final class GnssAntennaInfo implements Parcelable {
    ...
    public static final class SphericalCorrections implements Parcelable {
        ...
        private SphericalCorrections(Parcel in) {
            ...
            double[][] corrections = (double[][]) Array.newInstance((Class<?>) Double.TYPE, numRows, numColumns);
            double[][] correctionUncertainties = (double[][]) Array.newInstance((Class<?>) Double.TYPE, numRows, numColumns);
