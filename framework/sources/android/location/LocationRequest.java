...
public final class LocationRequest implements Parcelable {
    ...
    public static LocationRequest createFromDeprecatedProvider(String provider, long intervalMillis, float minUpdateDistanceMeters, boolean singleShot) {
        ...
        if (intervalMillis < 0) {
            ...
            intervalMillis = Telephony.Threads.TEMP_THREAD_ID;
        }
    ...
    public LocationRequest setInterval(long millis) {
        ...
        if (millis == Long.MAX_VALUE) {
            millis = Telephony.Threads.TEMP_THREAD_ID;
        }
    ...
    public String toString() {
        ...
        if (this.mMinUpdateDistanceMeters > SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
