...
public final class ProviderRequest implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        if (j == that.mIntervalMillis && this.mQuality == that.mQuality && this.mMaxUpdateDelayMillis == that.mMaxUpdateDelayMillis && this.mLowPower == that.mLowPower && this.mAdasGnssBypass == that.mAdasGnssBypass && this.mLocationSettingsIgnored == that.mLocationSettingsIgnored && this.mWorkSource.equals(that.mWorkSource)) {
            return true;
        }
        return false;
    }
