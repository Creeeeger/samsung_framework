...
public final class SehTemperature {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SehTemperature.class) {
            return false;
        }
        SehTemperature other = (SehTemperature) otherObject;
    ...
    public static final ArrayList<SehTemperature> readVectorFromParcel(HwParcel parcel) {
        ArrayList<SehTemperature> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 32, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            SehTemperature _hidl_vec_element = new SehTemperature();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SehTemperature> _hidl_vec) {
