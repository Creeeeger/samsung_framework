...
public interface SehSignalLevel$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? KeyProperties.DIGEST_NONE : _aidl_v == 1 ? "POOR" : _aidl_v == 2 ? "MODERATE" : _aidl_v == 3 ? "GOOD" : _aidl_v == 4 ? "GREAT" : _aidl_v == 5 ? "EXCELLLENT" : Integer.toString(_aidl_v);
    }
