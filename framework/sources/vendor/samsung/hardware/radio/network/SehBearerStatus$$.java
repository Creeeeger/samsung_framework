...
public interface SehBearerStatus$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? "NR_BEARER_STATUS_NOT_ALLOCATED" : _aidl_v == 1 ? "NR_BEARER_STATUS_ALLOCATED" : _aidl_v == 2 ? "NR_BEARER_STATUS_MMW_ALLOCATED" : Integer.toString(_aidl_v);
    }
