...
public class SehSatRegStateResult implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.beam_id);
        _aidl_parcel.writeInt(this.bm_long);
        _aidl_parcel.writeInt(this.bm_lat);
        _aidl_parcel.writeInt(this.reject_cause);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.beam_id = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.bm_long = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.bm_lat = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.reject_cause = _aidl_parcel.readInt();
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public String toString() {
        ...
        _aidl_sj.add("state: " + SehSatRegState$$.toString(this.state));
        _aidl_sj.add("lac: " + this.lac);
        _aidl_sj.add("ci: " + this.ci);
        _aidl_sj.add("arfcn: " + this.arfcn);
        _aidl_sj.add("beam_id: " + this.beam_id);
        _aidl_sj.add("bm_long: " + this.bm_long);
        _aidl_sj.add("bm_lat: " + this.bm_lat);
        _aidl_sj.add("reject_cause: " + this.reject_cause);
        return "SehSatRegStateResult" + _aidl_sj.toString();
    }
