...
public class SehSatSignalStrength implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.rssi);
        _aidl_parcel.writeInt(this.snr);
        _aidl_parcel.writeInt(this.tx_target);
        _aidl_parcel.writeInt(this.tx_pdet);
        _aidl_parcel.writeInt(this.vdet);
        _aidl_parcel.writeInt(this.satId);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.rssi = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.tx_target = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.tx_pdet = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.vdet = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.satId = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("rssi: " + this.rssi);
        _aidl_sj.add("snr: " + this.snr);
        _aidl_sj.add("tx_target: " + this.tx_target);
        _aidl_sj.add("tx_pdet: " + this.tx_pdet);
        _aidl_sj.add("vdet: " + this.vdet);
        _aidl_sj.add("satId: " + this.satId);
        _aidl_sj.add("ssRsrq: " + this.ssRsrq);
        _aidl_sj.add("ssRsrp: " + this.ssRsrp);
        _aidl_sj.add("ssSinr: " + this.ssSinr);
        return "SehSatSignalStrength" + _aidl_sj.toString();
    }
