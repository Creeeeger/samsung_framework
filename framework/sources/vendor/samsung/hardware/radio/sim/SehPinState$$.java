...
public interface SehPinState$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? "UNKNOWN" : _aidl_v == 1 ? "ENABLED_NOT_VERIFIED" : _aidl_v == 2 ? "ENABLED_VERIFIED" : _aidl_v == 3 ? "DISABLED" : _aidl_v == 4 ? "ENABLED_BLOCKED" : _aidl_v == 5 ? "ENABLED_PERM_BLOCKED" : Integer.toString(_aidl_v);
    }
