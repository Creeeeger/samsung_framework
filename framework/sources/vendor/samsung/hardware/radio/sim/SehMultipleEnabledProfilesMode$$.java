...
public interface SehMultipleEnabledProfilesMode$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? KeyProperties.DIGEST_NONE : _aidl_v == 1 ? "MEP_A1" : _aidl_v == 2 ? "MEP_A2" : _aidl_v == 3 ? "MEP_B" : Integer.toString(_aidl_v);
    }
