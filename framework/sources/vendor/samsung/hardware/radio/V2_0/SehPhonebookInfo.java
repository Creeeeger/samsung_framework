...
public final class SehPhonebookInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SehPhonebookInfo.class) {
            return false;
        }
    ...
    public static final ArrayList<SehPhonebookInfo> readVectorFromParcel(HwParcel parcel) {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.maxTextLength = _hidl_blob.getInt32(12 + _hidl_offset);
        this.maxNumberLength = _hidl_blob.getInt32(16 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(0 + _hidl_offset, this.totalCount);
        _hidl_blob.putInt32(4 + _hidl_offset, this.usedCount);
        _hidl_blob.putInt32(8 + _hidl_offset, this.firstIndex);
        _hidl_blob.putInt32(12 + _hidl_offset, this.maxTextLength);
        _hidl_blob.putInt32(16 + _hidl_offset, this.maxNumberLength);
    }
}
