...
public interface ISehRadio extends IBase {
    public static final String kInterfaceName = "vendor.samsung.hardware.radio@2.0::ISehRadio";
    ...
    void dial(int i, SehDial sehDial) throws RemoteException;
    ...
    void setImsCallList(int i, ArrayList<SehImsCall> arrayList) throws RemoteException;
    ...
    void setResponseFunctions(ISehRadioResponse iSehRadioResponse, ISehRadioIndication iSehRadioIndication) throws RemoteException;
    ...
    public static final class Proxy implements ISehRadio {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.samsung.hardware.radio@2.0::ISehRadio]@Proxy";
            }
        }
        ...
        public void setResponseFunctions(ISehRadioResponse radioResponse, ISehRadioIndication radioIndication) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements ISehRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehRadio.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{104, 75, -90, 79, 123, -108, 12, 62, 76, MidiConstants.STATUS_SONG_SELECT, 109, -52, 94, 108, 17, Byte.MIN_VALUE, -70, -93, 91, -108, -34, -100, MidiConstants.STATUS_CHANNEL_PRESSURE, -63, -28, -120, 93, 15, 32, -46, 125, 107}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    ISehRadioResponse radioResponse = ISehRadioResponse.asInterface(_hidl_request.readStrongBinder());
                    ISehRadioIndication radioIndication = ISehRadioIndication.asInterface(_hidl_request.readStrongBinder());
