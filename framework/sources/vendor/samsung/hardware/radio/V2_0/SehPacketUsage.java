...
public final class SehPacketUsage {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SehPacketUsage.class) {
            return false;
        }
        SehPacketUsage other = (SehPacketUsage) otherObject;
        if (this.rxBytes == other.rxBytes && this.txBytes == other.txBytes) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "{.rxBytes = " + this.rxBytes + ", .txBytes = " + this.txBytes + "}";
    }
    ...
    public static final ArrayList<SehPacketUsage> readVectorFromParcel(HwParcel parcel) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt64(0 + _hidl_offset, this.rxBytes);
        _hidl_blob.putInt64(8 + _hidl_offset, this.txBytes);
    }
}
