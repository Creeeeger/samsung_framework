...
public final class SehCallDetails {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SehCallDetails.class) {
            return false;
        }
        SehCallDetails other = (SehCallDetails) otherObject;
        if (this.callType == other.callType && HidlSupport.deepEquals(this.extras, other.extras)) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<SehCallDetails> readVectorFromParcel(HwParcel parcel) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(_hidl_offset + 0, this.callType);
        int _hidl_vec_size = this.extras.size();
        _hidl_blob.putInt32(_hidl_offset + 8 + 8, _hidl_vec_size);
        _hidl_blob.putBool(_hidl_offset + 8 + 12, false);
        HwBlob childBlob = new HwBlob(_hidl_vec_size * 16);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putString(_hidl_index_0 * 16, this.extras.get(_hidl_index_0));
        }
