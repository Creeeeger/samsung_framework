...
public interface ISehRadioIndication extends vendor.samsung.hardware.radio.V2_1.ISehRadioIndication {
    ...
    public static final class Proxy implements ISehRadioIndication {
        ...
        public void nrIconTypeChanged(int type, int nrIconType) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_1.ISehRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
        ...
        public void callDetailsChanged(int type, ArrayList<SehCallDetails> callDetails) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISehRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            SehCallDetails.writeVectorToParcel(_hidl_request, callDetails);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.samsung.hardware.radio.V2_2.ISehRadioIndication
        public void vendorConfigurationChanged(int type, ArrayList<SehVendorConfiguration> configurations) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISehRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
        ...
        public void eriInfoReceived(int type, SehEriInfo eriInfo) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(ISehRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            eriInfo.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements ISehRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-47, MidiConstants.STATUS_PROGRAM_CHANGE, 122, -121, -118, 76, -79, -105, 111, -127, 67, 69, -99, 119, 4, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEINOUT, -72, 60, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90, -28, 2, -110, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEOUT, 4, -1, -75, 118, 114, -101, 122, -65}, new byte[]{-92, 125, -7, -61, 7, 69, 122, -110, 75, MidiConstants.STATUS_PROGRAM_CHANGE, -106, 8, 89, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEIN, -103, 66, -3, -52, -16, 123, 5, -47, -120, -111, -75, -60, -116, SprAnimatorBase.INTERPOLATOR_TYPE_EXPOEASEIN, -59, 4, -35, -103}, new byte[]{120, 15, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, -11, -123, -62, 87, 84, -52, 99, 67, -65, 0, -34, -27, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEINOUT, 126, -4, -10, -8, 82, 107, -63, 121, 122, -84, -72, 126, -115, 55, 95, -92}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEIN, -109, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -72, 59, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 27:
                    ...
                    needPacketUsage(iface, new ISehRadioIndication.needPacketUsageCallback() { // from class: vendor.samsung.hardware.radio.V2_2.ISehRadioIndication.Stub.1
                    ...
                    return;
                case 28:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_1.ISehRadioIndication.kInterfaceName);
                ...
                case 29:
                    ...
                    ArrayList<SehCallDetails> callDetails = SehCallDetails.readVectorFromParcel(_hidl_request);
                    callDetailsChanged(type26, callDetails);
                ...
                case 30:
                    ...
                    vendorConfigurationChanged(type27, configurations);
                    _hidl_reply2.writeStatus(0);
                    _hidl_reply2.send();
                    return;
                case 31:
                    ...
                    SehEriInfo eriInfo = new SehEriInfo();
                    eriInfo.readFromParcel(_hidl_request);
                    eriInfoReceived(type28, eriInfo);
                    _hidl_reply2.writeStatus(0);
                    _hidl_reply2.send();
                    return;
                case 256067662:
        ...
        /* renamed from: vendor.samsung.hardware.radio.V2_2.ISehRadioIndication$Stub$1 */
        /* loaded from: classes6.dex */
        class AnonymousClass1 implements ISehRadioIndication.needPacketUsageCallback {
            final /* synthetic */ HwParcel val$_hidl_reply;
