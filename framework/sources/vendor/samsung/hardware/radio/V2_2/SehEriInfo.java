...
public final class SehEriInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SehEriInfo.class) {
            return false;
        }
    ...
    public static final ArrayList<SehEriInfo> readVectorFromParcel(HwParcel parcel) {
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SehEriInfo> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt8(0 + _hidl_offset, this.roamingIndicator);
        _hidl_blob.putInt8(1 + _hidl_offset, this.iconIndex);
        _hidl_blob.putInt8(2 + _hidl_offset, this.iconMode);
        _hidl_blob.putString(8 + _hidl_offset, this.eriText);
    }
}
