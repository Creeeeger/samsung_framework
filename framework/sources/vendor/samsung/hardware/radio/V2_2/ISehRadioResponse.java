...
public interface ISehRadioResponse extends vendor.samsung.hardware.radio.V2_1.ISehRadioResponse {
    ...
    public static abstract class Stub extends HwBinder implements ISehRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-93, 91, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEOUT, 5, SprAttributeBase.TYPE_SHADOW, 88, 35, -86, 109, 32, 88, -90, -4, 5, -122, -22, 8, -5, 8, -105, 79, 117, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90, -26, -17, -65, -63, -61, -46, 12, -115}, new byte[]{82, -116, 16, -3, -40, 72, MidiConstants.STATUS_SONG_SELECT, -31, -2, 55, -90, -118, -3, 0, 87, 85, SprAttributeBase.TYPE_ANIMATOR_SET, MidiConstants.STATUS_SONG_SELECT, 80, -107, 1, 106, 38, 78, -73, -49, 20, -123, 101, -108, -69, -117}, new byte[]{-109, -98, SprAnimatorBase.INTERPOLATOR_TYPE_SINEEASEINOUT, -18, -101, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -71, MidiConstants.STATUS_CHANNEL_PRESSURE, 68, MidiConstants.STATUS_SONG_SELECT, 66, 95, 109, -67, -27, -119, 107, -59, SprAttributeBase.TYPE_ANIMATOR_SET, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEINOUT, 81, 38, 85, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEIN, 37, 122, 14, 6, -34, 1, MidiConstants.STATUS_PITCH_BEND, -110}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEIN, -109, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -72, 59, SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT, -54, 76}));
        }
