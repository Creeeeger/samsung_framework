...
public interface ISehRadioResponse extends vendor.samsung.hardware.radio.V2_1.ISehRadioResponse {
    ...
    public static final class Proxy implements ISehRadioResponse {
        ...
        @Override // vendor.samsung.hardware.radio.V2_2.ISehRadioResponse, vendor.samsung.hardware.radio.V2_1.ISehRadioResponse, vendor.samsung.hardware.radio.V2_0.ISehRadioResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void getIccCardStatusResponse(RadioResponseInfo info, SehCardStatus cardStatus) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_0.ISehRadioResponse.kInterfaceName);
        ...
        public void setNrModeResponse(RadioResponseInfo info) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.samsung.hardware.radio.V2_1.ISehRadioResponse
        public void getNrModeResponse(RadioResponseInfo info, int nrMode) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            _hidl_request.writeInt32(nrMode);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.samsung.hardware.radio.V2_1.ISehRadioResponse
        public void getNrIconTypeResponse(RadioResponseInfo info, int nrIconType) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
        ...
        @Override // vendor.samsung.hardware.radio.V2_1.ISehRadioResponse
        public void getIccCardStatusResponse_2_1(RadioResponseInfo info, vendor.samsung.hardware.radio.V2_1.SehCardStatus cardStatus) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            cardStatus.writeToParcel(_hidl_request);
        ...
        public void setNrModeResponse_2_2(RadioResponseInfo info) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        @Override // vendor.samsung.hardware.radio.V2_2.ISehRadioResponse
        public void getVendorSpecificConfigurationResponse(RadioResponseInfo info, ArrayList<SehVendorConfiguration> configurations) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            SehVendorConfiguration.writeVectorToParcel(_hidl_request, configurations);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.samsung.hardware.radio.V2_2.ISehRadioResponse
        public void setVendorSpecificConfigurationResponse(RadioResponseInfo info) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISehRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // vendor.samsung.hardware.radio.V2_2.ISehRadioResponse, vendor.samsung.hardware.radio.V2_1.ISehRadioResponse, vendor.samsung.hardware.radio.V2_0.ISehRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements ISehRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehRadioResponse.kInterfaceName, vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName, vendor.samsung.hardware.radio.V2_0.ISehRadioResponse.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-93, 91, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEOUT, 5, SprAttributeBase.TYPE_SHADOW, 88, 35, -86, 109, 32, 88, -90, -4, 5, -122, -22, 8, -5, 8, -105, 79, 117, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90, -26, -17, -65, -63, -61, -46, 12, -115}, new byte[]{82, -116, 16, -3, -40, 72, MidiConstants.STATUS_SONG_SELECT, -31, -2, 55, -90, -118, -3, 0, 87, 85, SprAttributeBase.TYPE_ANIMATOR_SET, MidiConstants.STATUS_SONG_SELECT, 80, -107, 1, 106, 38, 78, -73, -49, 20, -123, 101, -108, -69, -117}, new byte[]{-109, -98, SprAnimatorBase.INTERPOLATOR_TYPE_SINEEASEINOUT, -18, -101, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -71, MidiConstants.STATUS_CHANNEL_PRESSURE, 68, MidiConstants.STATUS_SONG_SELECT, 66, 95, 109, -67, -27, -119, 107, -59, SprAttributeBase.TYPE_ANIMATOR_SET, 21, 81, 38, 85, SprAnimatorBase.INTERPOLATOR_TYPE_QUARTEASEIN, 37, 122, 14, 6, -34, 1, MidiConstants.STATUS_PITCH_BEND, -110}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT60, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_0.ISehRadioResponse.kInterfaceName);
                ...
                case 40:
                    ...
                    return;
                case 41:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
                    RadioResponseInfo info41 = new RadioResponseInfo();
                    info41.readFromParcel(_hidl_request);
                    setNrModeResponse(info41);
                    return;
                case 42:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
                    RadioResponseInfo info42 = new RadioResponseInfo();
                    info42.readFromParcel(_hidl_request);
                    int nrMode = _hidl_request.readInt32();
                    getNrModeResponse(info42, nrMode);
                    return;
                case 43:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
                    ...
                    getNrIconTypeResponse(info43, nrIconType);
                    return;
                case 44:
                    _hidl_request.enforceInterface(vendor.samsung.hardware.radio.V2_1.ISehRadioResponse.kInterfaceName);
                    RadioResponseInfo info44 = new RadioResponseInfo();
                    info44.readFromParcel(_hidl_request);
                    vendor.samsung.hardware.radio.V2_1.SehCardStatus cardStatus2 = new vendor.samsung.hardware.radio.V2_1.SehCardStatus();
                    cardStatus2.readFromParcel(_hidl_request);
                    getIccCardStatusResponse_2_1(info44, cardStatus2);
                    return;
                case 45:
                    ...
                    setNrModeResponse_2_2(info45);
                    return;
                case 46:
                    _hidl_request.enforceInterface(ISehRadioResponse.kInterfaceName);
                    RadioResponseInfo info46 = new RadioResponseInfo();
                    info46.readFromParcel(_hidl_request);
                    ArrayList<SehVendorConfiguration> configurations = SehVendorConfiguration.readVectorFromParcel(_hidl_request);
                    getVendorSpecificConfigurationResponse(info46, configurations);
                    return;
                case 47:
                    _hidl_request.enforceInterface(ISehRadioResponse.kInterfaceName);
                    RadioResponseInfo info47 = new RadioResponseInfo();
                    info47.readFromParcel(_hidl_request);
                    setVendorSpecificConfigurationResponse(info47);
                    return;
                case 256067662:
